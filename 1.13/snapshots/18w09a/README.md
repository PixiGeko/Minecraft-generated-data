...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/18w08b">18w08b</a>
## File structure
...
```diff
+ chests/underwater_ruin_big.json
+ chests/underwater_ruin_small.json
```
