...
```diff
+ blocks/banners.json
+ blocks/wooden_pressure_plates.json
+ blocks/wooden_slabs.json
+ blocks/wooden_stairs.json
+ items/banners.json
+ items/boats.json
+ items/wooden_pressure_plates.json
+ items/wooden_slabs.json
+ items/wooden_stairs.json
```
...
```diff
+ recipes/building_blocks/cracked_stone_bricks.json
+ recipes/building_blocks/glass.json
+ recipes/building_blocks/sponge.json
+ recipes/building_blocks/stone.json
+ recipes/building_blocks/terracotta.json
+ recipes/decorations/black_glazed_terracotta.json
+ recipes/decorations/blue_glazed_terracotta.json
+ recipes/decorations/brown_glazed_terracotta.json
+ recipes/decorations/cyan_glazed_terracotta.json
+ recipes/decorations/gray_glazed_terracotta.json
+ recipes/decorations/green_glazed_terracotta.json
+ recipes/decorations/light_blue_glazed_terracotta.json
+ recipes/decorations/light_gray_glazed_terracotta.json
+ recipes/decorations/lime_glazed_terracotta.json
+ recipes/decorations/magenta_glazed_terracotta.json
+ recipes/decorations/orange_glazed_terracotta.json
+ recipes/decorations/pink_glazed_terracotta.json
+ recipes/decorations/purple_glazed_terracotta.json
+ recipes/decorations/red_glazed_terracotta.json
+ recipes/decorations/white_glazed_terracotta.json
+ recipes/decorations/yellow_glazed_terracotta.json
+ recipes/food/baked_potato.json
+ recipes/food/cooked_beef.json
+ recipes/food/cooked_chicken.json
+ recipes/food/cooked_cod.json
+ recipes/food/cooked_mutton.json
+ recipes/food/cooked_porkchop.json
+ recipes/food/cooked_rabbit.json
+ recipes/food/cooked_salmon.json
+ recipes/misc/brick.json
+ recipes/misc/charcoal.json
...
+ recipes/misc/gold_nugget_from_smelting.json
+ recipes/misc/iron_ingot.json
+ recipes/misc/iron_nugget_from_smelting.json
+ recipes/misc/lapis_from_smelting.json
+ recipes/misc/nether_brick.json
+ recipes/misc/quartz.json
...
```diff
- gui/container/recipe_background.png
