...
```diff
- biome.minecraft.cold_deep_ocean
+ biome.minecraft.deep_cold_ocean
+ biome.minecraft.deep_frozen_ocean
+ biome.minecraft.deep_lukewarm_ocean
+ biome.minecraft.deep_warm_ocean
- biome.minecraft.frozen_deep_ocean
- biome.minecraft.lukewarm_deep_ocean
- biome.minecraft.warm_deep_ocean
- block.minecraft.sea_grass
+ block.minecraft.seagrass
- block.minecraft.tall_sea_grass
