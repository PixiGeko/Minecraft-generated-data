...
<tr><th>Asset index</th><td><a href="https://piston-meta.mojang.com/v1/packages/b79b292b2cc4ff0244477e9ea9b019b1bfa2ef5d/13.json">https://piston-meta.mojang.com/v1/packages/b79b292b2cc4ff0244477e9ea9b019b1bfa2ef5d/13.json</a></td></tr>
...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/24w06a">24w06a</a>
...
<details><summary>net.minecraft.core.RegistrySetBuilder</summary>
...
<details><summary>net.minecraft.core.RegistrySetBuilder$2</summary>
...
<details><summary>net.minecraft.resources.RegistryOps$RegistryInfo</summary>
...
<details><summary>net.minecraft.world.entity.monster.Strider$StriderPathNavigation</summary>
...
<details><summary>net.minecraft.world.item.EnderEyeItem</summary>
...
```diff
+ entities/bogged.json
+ gameplay/panda_sneeze.json
```
...
```diff
+ mob/bogged/ambient1.ogg
+ mob/bogged/ambient2.ogg
+ mob/bogged/ambient3.ogg
+ mob/bogged/ambient4.ogg
+ mob/bogged/death.ogg
+ mob/bogged/hurt1.ogg
+ mob/bogged/hurt2.ogg
+ mob/bogged/hurt3.ogg
+ mob/bogged/hurt4.ogg
+ mob/bogged/step1.ogg
+ mob/bogged/step2.ogg
+ mob/bogged/step3.ogg
+ mob/bogged/step4.ogg
```
...
```diff
+ entity/skeleton/bogged_overlay.png
+ entity/skeleton/bogged.png
```
