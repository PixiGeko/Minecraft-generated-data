...
<br/>
<table><tr><th></th><th align="left">23w42a</th><th>23w43a</th></tr><tr><td>DataPack version</td><td><pre>21</pre></td><td><pre>22</pre></td></tr><tr><td>ResourcePack version</td><td><pre>19</pre></td><td><pre>20</pre></td></tr><tr><td>World version</td><td><pre>3684</pre></td><td><pre>3686</pre></td></tr><tr><td>Protocol version</td><td><pre>1073741981</pre></td><td><pre>1073741983</pre></td></tr></table>
</details>
<hr/>
...
<br/>
<table>
<tr><th>Name</th><th>23w42a</th><th>23w43a</th></tr>
<tr><th align="left"><div style="width:290px">gamerule.commandModificationBlockLimit</div></th><td>Command Modification Block Limit</td><td>Command modification block limit</td></tr>
<tr><th align="left"><div style="width:290px">mco.snapshot.description</div></th><td>Paired with %s</td><td>Paired with "%s"</td></tr>
<tr><th align="left"><div style="width:290px">mco.snapshot.friendsRealm.upgrade</div></th><td>%s needs to upgrade their Realm before you can play from this Snapshot</td><td>%s needs to upgrade their Realm before you can play from this version</td></tr>
<tr><th align="left"><div style="width:290px">mco.snapshot.paired</div></th><td>This Snapshot Realm is paired with %s</td><td>This Snapshot Realm is paired with "%s"</td></tr>
<tr><th align="left"><div style="width:290px">recover_world.message</div></th><td>The following issues occured while trying to read world folder "%s".

It might be possible to restore the world from an older state or you can report this issue on the bug tracker.</td><td>The following issues occurred while trying to read world folder "%s".

It might be possible to restore the world from an older state or you can report this issue on the bug tracker.</td></tr>
<tr><th align="left"><div style="width:290px">recover_world.no_fallback</div></th><td>No state to recover from availible</td><td>No state to recover from available</td></tr>
<tr><th align="left"><div style="width:290px">selectWorld.incompatible.description</div></th><td>This world can not be opened in this version.

It was last played in version %s.</td><td>This world cannot be opened in this version.

It was last played in version %s.</td></tr>
<tr><th align="left"><div style="width:290px">selectWorld.incompatible.tooltip</div></th><td>This world can not be opened because it was created by an incompatible version.</td><td>This world cannot be opened because it was created by an incompatible version.</td></tr>
<tr><th align="left"><div style="width:290px">subtitles.block.crafter.craft</div></th><td>Crafter crafted</td><td>Crafter crafts</td></tr>
<tr><th align="left"><div style="width:290px">subtitles.block.crafter.fail</div></th><td>Crafter failed</td><td>Crafter fails crafting</td></tr>
<tr><th align="left"><div style="width:290px">telemetry_info.button.show_data</div></th><td>Open My Data</td><td>View My Data</td></tr>
</table>
<br/>
</details>
</details>
