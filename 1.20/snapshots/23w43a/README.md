...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/23w42a">23w42a</a>
...
<details><summary>net.minecraft.client.Timer</summary>
...
<details><summary>net.minecraft.client.gui.screens.telemetry.TelemetryEventWidget</summary>
...
<details><summary>net.minecraft.data.models.model.ModelTemplate</summary>
...
<details><summary>net.minecraft.server.gui.StatsComponent</summary>
...
<details><summary>net.minecraft.data.loot.packs.UpdateOneTwentyOneBlockLoot</summary>
...
<details><summary>net.minecraft.network.protocol.game.ServerboundSetJigsawBlockPacket</summary>
...
```diff
+ blocks/chiseled_copper.json
+ blocks/chiseled_tuff_bricks.json
+ blocks/chiseled_tuff.json
+ blocks/copper_bulb.json
+ blocks/copper_door.json
+ blocks/copper_grate.json
+ blocks/copper_trapdoor.json
+ blocks/exposed_chiseled_copper.json
+ blocks/exposed_copper_bulb.json
+ blocks/exposed_copper_door.json
+ blocks/exposed_copper_grate.json
+ blocks/exposed_copper_trapdoor.json
+ blocks/oxidized_chiseled_copper.json
+ blocks/oxidized_copper_bulb.json
+ blocks/oxidized_copper_door.json
+ blocks/oxidized_copper_grate.json
+ blocks/oxidized_copper_trapdoor.json
+ blocks/polished_tuff_slab.json
+ blocks/polished_tuff_stairs.json
+ blocks/polished_tuff_wall.json
+ blocks/polished_tuff.json
+ blocks/tuff_brick_slab.json
+ blocks/tuff_brick_stairs.json
+ blocks/tuff_brick_wall.json
+ blocks/tuff_bricks.json
+ blocks/tuff_slab.json
+ blocks/tuff_stairs.json
+ blocks/tuff_wall.json
+ blocks/waxed_chiseled_copper.json
+ blocks/waxed_copper_bulb.json
+ blocks/waxed_copper_door.json
+ blocks/waxed_copper_grate.json
+ blocks/waxed_copper_trapdoor.json
+ blocks/waxed_exposed_chiseled_copper.json
+ blocks/waxed_exposed_copper_bulb.json
+ blocks/waxed_exposed_copper_door.json
+ blocks/waxed_exposed_copper_grate.json
+ blocks/waxed_exposed_copper_trapdoor.json
+ blocks/waxed_oxidized_chiseled_copper.json
+ blocks/waxed_oxidized_copper_bulb.json
+ blocks/waxed_oxidized_copper_door.json
+ blocks/waxed_oxidized_copper_grate.json
+ blocks/waxed_oxidized_copper_trapdoor.json
+ blocks/waxed_weathered_chiseled_copper.json
+ blocks/waxed_weathered_copper_bulb.json
+ blocks/waxed_weathered_copper_door.json
+ blocks/waxed_weathered_copper_grate.json
+ blocks/waxed_weathered_copper_trapdoor.json
+ blocks/weathered_chiseled_copper.json
+ blocks/weathered_copper_bulb.json
+ blocks/weathered_copper_door.json
+ blocks/weathered_copper_grate.json
+ blocks/weathered_copper_trapdoor.json
```
...
```diff
+ block/copper_bulb/break1.ogg
+ block/copper_bulb/break2.ogg
+ block/copper_bulb/break3.ogg
+ block/copper_bulb/break4.ogg
+ block/copper_bulb/place1.ogg
+ block/copper_bulb/place2.ogg
+ block/copper_bulb/place3.ogg
+ block/copper_bulb/place4.ogg
+ block/copper_bulb/step1.ogg
+ block/copper_bulb/step2.ogg
+ block/copper_bulb/step3.ogg
+ block/copper_bulb/step4.ogg
+ block/copper_bulb/step5.ogg
+ block/copper_bulb/step6.ogg
+ block/copper_bulb/turn_off.ogg
+ block/copper_bulb/turn_on.ogg
+ block/copper_door/toggle1.ogg
+ block/copper_door/toggle2.ogg
+ block/copper_door/toggle3.ogg
+ block/copper_grate/break1.ogg
+ block/copper_grate/break2.ogg
+ block/copper_grate/break3.ogg
+ block/copper_grate/break4.ogg
+ block/copper_grate/step1.ogg
+ block/copper_grate/step2.ogg
+ block/copper_grate/step3.ogg
+ block/copper_grate/step4.ogg
+ block/copper_grate/step5.ogg
+ block/copper_grate/step6.ogg
+ block/copper_trapdoor/toggle1.ogg
+ block/copper_trapdoor/toggle2.ogg
+ block/copper_trapdoor/toggle3.ogg
+ block/copper_trapdoor/toggle4.ogg
+ block/tuff_bricks/place1.ogg
+ block/tuff_bricks/place2.ogg
+ block/tuff_bricks/place3.ogg
+ block/tuff_bricks/place4.ogg
+ block/tuff_bricks/place5.ogg
+ block/tuff_bricks/step1.ogg
+ block/tuff_bricks/step2.ogg
+ block/tuff_bricks/step3.ogg
+ block/tuff_bricks/step4.ogg
+ block/tuff_bricks/step5.ogg
+ block/tuff_bricks/step6.ogg
```
...
```diff
+ block/chiseled_copper.png
+ block/chiseled_tuff_bricks_top.png
+ block/chiseled_tuff_bricks.png
+ block/chiseled_tuff_top.png
+ block/chiseled_tuff.png
+ block/copper_bulb_lit_powered.png
+ block/copper_bulb_lit.png
+ block/copper_bulb_powered.png
+ block/copper_bulb.png
+ block/copper_door_bottom.png
+ block/copper_door_top.png
+ block/copper_grate.png
+ block/copper_trapdoor.png
+ block/exposed_chiseled_copper.png
+ block/exposed_copper_bulb_lit_powered.png
+ block/exposed_copper_bulb_lit.png
+ block/exposed_copper_bulb_powered.png
+ block/exposed_copper_bulb.png
+ block/exposed_copper_door_bottom.png
+ block/exposed_copper_door_top.png
+ block/exposed_copper_grate.png
+ block/exposed_copper_trapdoor.png
+ block/oxidized_chiseled_copper.png
+ block/oxidized_copper_bulb_lit_powered.png
+ block/oxidized_copper_bulb_lit.png
+ block/oxidized_copper_bulb_powered.png
+ block/oxidized_copper_bulb.png
+ block/oxidized_copper_door_bottom.png
+ block/oxidized_copper_door_top.png
+ block/oxidized_copper_grate.png
+ block/oxidized_copper_trapdoor.png
+ block/polished_tuff.png
+ block/tuff_bricks.png
+ block/weathered_chiseled_copper.png
+ block/weathered_copper_bulb_lit_powered.png
+ block/weathered_copper_bulb_lit.png
+ block/weathered_copper_bulb_powered.png
+ block/weathered_copper_bulb.png
+ block/weathered_copper_door_bottom.png
+ block/weathered_copper_door_top.png
+ block/weathered_copper_grate.png
+ block/weathered_copper_trapdoor.png
