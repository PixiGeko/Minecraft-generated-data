## Comparison with [23w51b](https://github.com/PixiGeko/Minecraft-generated-data/tree/23w51b)
...
<br/>
<table><tr><th></th><th align="left">23w51b</th><th>24w03a</th></tr><tr><td>DataPack version</td><td><pre>27</pre></td><td><pre>28</pre></td></tr><tr><td>ResourcePack version</td><td><pre>22</pre></td><td><pre>24</pre></td></tr><tr><td>World version</td><td><pre>3802</pre></td><td><pre>3804</pre></td></tr><tr><td>Protocol version</td><td><pre>1073741994</pre></td><td><pre>1073741995</pre></td></tr></table>
...
```diff
+ org.lwjgl:lwjgl-freetype (natives-linux) V3.3.2
+ org.lwjgl:lwjgl-freetype (natives-macos-arm64) V3.3.2
+ org.lwjgl:lwjgl-freetype (natives-macos) V3.3.2
+ org.lwjgl:lwjgl-freetype (natives-windows-arm64) V3.3.2
+ org.lwjgl:lwjgl-freetype (natives-windows-x86) V3.3.2
+ org.lwjgl:lwjgl-freetype (natives-windows) V3.3.2
+ org.lwjgl:lwjgl-freetype V3.3.2
```
...
<br/>
<table>
<tr><th>Name</th><th>23w51b</th><th>24w03a</th></tr>
<tr><th align="left"><div style="width:290px">argument.time.invalid_tick_count</div></th><td>Tick count must be non-negative</td><td>The tick count must be non-negative</td></tr>
<tr><th align="left"><div style="width:290px">argument.time.tick_count_too_low</div></th><td>Tick count must not be less than %s, found %s</td><td>The tick count must not be less than %s, found %s</td></tr>
<tr><th align="left"><div style="width:290px">commands.tick.sprint.stop.success</div></th><td>A tick sprint interrupted</td><td>Interrupted the current tick sprint</td></tr>
<tr><th align="left"><div style="width:290px">commands.tick.status.running</div></th><td>The game runs normally</td><td>The game is running normally</td></tr>
<tr><th align="left"><div style="width:290px">commands.tick.step.stop.success</div></th><td>A tick step interrupted</td><td>Interrupted the current tick step</td></tr>
<tr><th align="left"><div style="width:290px">subtitles.entity.armadillo.brush</div></th><td>Armadillo brushes</td><td>Scute is brushed off</td></tr>
<tr><th align="left"><div style="width:290px">subtitles.entity.armadillo.scute_drop</div></th><td>Scute drops</td><td>Armadillo sheds scute</td></tr>
<tr><th align="left"><div style="width:290px">subtitles.item.armor.equip_wolf</div></th><td>Wolf armor straps</td><td>Wolf Armor is fastened</td></tr>
<tr><th align="left"><div style="width:290px">subtitles.item.armor.unequip_wolf</div></th><td>Wolf armor slips off</td><td>Wolf Armor snips away</td></tr>
</table>
<br/>
</details>
</details>
...
```
```
XXX.minecraft.advancements.Advancement +3M -4M | +1P
```
```
XXX.minecraft.advancements.AdvancementHolder +1M -2M | +2P
```
```
XXX.minecraft.advancements.CriteriaTriggers +2P
```
```
XXX.minecraft.advancements.DisplayInfo +2M -2M | +1P
```
```
XXX.minecraft.core.BlockPos +1P
```
```
XXX.minecraft.core.BlockPos$2 +1M -1M | +10P -14P
```
```
XXX.minecraft.core.BlockPos$4 +2M -2M | +7P -12P
```
```
XXX.gametest.framework.GameTestBatch +7M -4M | +1P -1P
```
```
XXX.gametest.framework.GameTestListener +3P -2P
```
```
XXX.gametest.framework.GameTestRunner +15M -10M | +12P -3P
```
```
XXX.gametest.framework.MultipleTestTracker +1M
```
```
XXX.gametest.framework.ReportGameListener +5M -4M | -3P
```
```
XXX.minecraft.network.FriendlyByteBuf +26M -21M
```
```
XXX.minecraft.network.PacketBundlePacker +2M -1M | +1P -2P
```
```
XXX.minecraft.network.PacketDecoder +1M -1M | +1P -1P
```
```
XXX.protocol.common.ClientCommonPacketListener +2P
```
```
XXX.protocol.common.ClientboundDisconnectPacket +2M | +1P
```
```
XXX.protocol.common.ClientboundPingPacket +2M | +1P
```
```
XXX.protocol.common.ClientboundResourcePackPushPacket +2M | +1P
```
```
XXX.protocol.game.ClientboundChangeDifficultyPacket +2M | +1P
```
```
XXX.protocol.game.ClientboundChunkBatchStartPacket +2M -5M | +2P
```
```
XXX.protocol.game.ClientboundCommandSuggestionsPacket +2M | +1P
```
```
XXX.protocol.game.ClientboundContainerSetContentPacket +4M -2M | +1P
```
```
XXX.protocol.game.ClientboundContainerSetSlotPacket +4M -2M | +1P
```
```
XXX.protocol.game.ClientboundCustomChatCompletionsPacket +2M | +1P
```
```
XXX.protocol.game.ClientboundDamageEventPacket +2M | +1P
```
```
XXX.protocol.game.ClientboundDisguisedChatPacket +2M | +1P
```
```
XXX.protocol.game.ClientboundExplodePacket +6M -6M | +2P -1P
```
```
XXX.protocol.game.ClientboundGameEventPacket +1M | +1P
```
```
XXX.protocol.game.ClientboundHorseScreenOpenPacket +2M | +1P
```
```
XXX.protocol.game.ClientboundInitializeBorderPacket +2M | +1P
```
```
XXX.protocol.game.ClientboundLevelChunkPacketData$BlockEntityInfo +3M -2M | +2P
```
```
XXX.protocol.game.ClientboundLevelChunkWithLightPacket +4M -2M | +1P
```
```
XXX.protocol.game.ClientboundLevelParticlesPacket +4M -3M | +1P
```
```
XXX.protocol.game.ClientboundMapItemDataPacket +2M | +1P
```
```
XXX.protocol.game.ClientboundMoveEntityPacket +1P
```
```
XXX.protocol.game.ClientboundMoveEntityPacket$PosRot +2M | +1P
```
```
XXX.protocol.game.ClientboundMoveVehiclePacket +2M | +1P
```
```
XXX.protocol.game.ClientboundOpenScreenPacket +2M -2M | +1P
```
```
XXX.protocol.game.ClientboundPlaceGhostRecipePacket +2M | +1P
```
```
XXX.protocol.game.ClientboundPlayerChatPacket +2M | +1P
```
```
XXX.protocol.game.ClientboundPlayerCombatEnterPacket +2M -2M | +2P
```
```
XXX.protocol.game.ClientboundPlayerInfoRemovePacket +2M | +1P
```
```
XXX.protocol.game.ClientboundPlayerPositionPacket +2M | +1P
```
```
XXX.protocol.game.ClientboundRemoveMobEffectPacket +3M -2M | +1P
```
```
XXX.protocol.game.ClientboundRespawnPacket +2M | +1P
```
```
XXX.protocol.game.ClientboundSectionBlocksUpdatePacket +2M | +1P
```
```
XXX.protocol.game.ClientboundServerDataPacket +3M -2M | +1P -1P
```
```
XXX.protocol.game.ClientboundSetBorderCenterPacket +2M | +1P
```
```
XXX.protocol.game.ClientboundSetBorderSizePacket +2M | +1P
```
```
XXX.protocol.game.ClientboundSetBorderWarningDistancePacket +2M | +1P
```
```
XXX.protocol.game.ClientboundSetCarriedItemPacket +2M | +1P
```
```
XXX.protocol.game.ClientboundSetChunkCacheRadiusPacket +2M | +1P
```
```
XXX.protocol.game.ClientboundSetDisplayObjectivePacket +2M | +1P
```
```
XXX.protocol.game.ClientboundSetEntityLinkPacket +2M | +1P
```
```
XXX.protocol.game.ClientboundSetEquipmentPacket +4M -2M | +1P
```
```
XXX.protocol.game.ClientboundSetHealthPacket +2M | +1P
```
```
XXX.protocol.game.ClientboundSetPassengersPacket +2M | +1P
```
```
XXX.protocol.game.ClientboundSetScorePacket +6M -4M | +2P -1P
```
```
XXX.protocol.game.ClientboundSetSubtitleTextPacket +2M | +1P
```
```
XXX.protocol.game.ClientboundSetTitleTextPacket +2M | +1P
```
```
XXX.protocol.game.ClientboundSoundEntityPacket +4M -3M | +1P
```
```
XXX.protocol.game.ClientboundStartConfigurationPacket +3M -6M | +2P
```
```
XXX.protocol.game.ClientboundSystemChatPacket +2M | +1P
```
```
XXX.protocol.game.ClientboundTagQueryPacket +2M | +1P
```
```
XXX.protocol.game.ClientboundTeleportEntityPacket +2M | +1P
```
```
XXX.protocol.game.ClientboundTickingStepPacket +2M | +1P
```
```
XXX.protocol.game.ClientboundUpdateAttributesPacket +3M -6M | +1P
```
```
XXX.protocol.game.ClientboundUpdateMobEffectPacket +4M -2M | +1P
```
```
XXX.network.syncher.EntityDataSerializers -1M | +2P
```
```
XXX.network.syncher.EntityDataSerializers$2 +4M -4M
```
```
XXX.network.syncher.EntityDataSerializers$4 +4M -4M
```
```
XXX.profiling.jfr.JvmProfiler$NoOpProfiler +2M -2M
```
```
XXX.jfr.event.PacketEvent +1M -1M | +2P -1P
```
```
XXX.jfr.event.PacketReceivedEvent +1M -1M
```
```
XXX.world.entity.Entity +4M -2M | -1P
```
```
XXX.world.entity.EntityAttachment$Fallback +1M | +1P
```
```
XXX.world.entity.LivingEntity +13M -13M
```
```
XXX.world.entity.Mob +1M -1M
```
```
XXX.entity.raid.Raider +3M -4M
```
```
XXX.entity.vehicle.ContainerEntity +1P
```
```
XXX.world.inventory.MerchantMenu +1M -1M
```
```
XXX.world.item.CrossbowItem -1M
```
```
XXX.world.item.DiggerItem -2M
```
```
XXX.world.item.FlintAndSteelItem -2M
```
```
XXX.world.item.HoeItem +2M -3M
```
```
XXX.item.crafting.Ingredient +12M -12M | +1P
```
```
XXX.item.crafting.Recipe +1P
```
```
XXX.item.crafting.ShapedRecipe$Serializer +3M -4M | +1P
```
```
XXX.item.crafting.ShapelessRecipe$Serializer +4M -4M | +1P
```
```
XXX.item.crafting.SimpleCraftingRecipeSerializer +1M -4M | +1P
```
```
XXX.item.crafting.SingleItemRecipe$Serializer +4M -4M | +1P
```
```
XXX.item.crafting.SmithingTransformRecipe$Serializer +3M -4M | +1P
```
```
XXX.item.crafting.SmithingTrimRecipe$Serializer +3M -4M | +1P
```
```
XXX.item.enchantment.DamageEnchantment +2M -4M | +4P -8P
```
```
XXX.item.enchantment.DiggingEnchantment -1M
```
...
- Advancement read(RegistryFriendlyByteBuf)
...
```diff
+ AdvancementHolder read(FriendlyByteBuf)
- void <clinit>()
+ void write(FriendlyByteBuf)
```
...
```diff
+ DisplayInfo fromNetwork(FriendlyByteBuf)
- DisplayInfo fromNetwork(RegistryFriendlyByteBuf)
+ void serializeToNetwork(FriendlyByteBuf)
- void serializeToNetwork(RegistryFriendlyByteBuf)
```
...
+ BlockPos$MutableBlockPos computeNext()
+ void <init>(Direction,Direction,BlockPos,int)
...
+ Collection getTestFunctions()
- Consumer afterBatchFunction()
- Consumer beforeBatchFunction()
- int hashCode()
+ String getName()
- String name()
- String toString()
+ void runAfterBatchFunction(ServerLevel)
+ void runBeforeBatchFunction(ServerLevel)
```
...
- Collection createStructuresForBatch(Collection)
+ Collection groupTestsIntoBatches(Collection)
+ Collection runTestBatches(Collection,BlockPos,Rotation,ServerLevel,GameTestTicker,int)
+ Collection runTests(Collection,BlockPos,Rotation,ServerLevel,GameTestTicker,int)
+ GameTestBatch lambda$groupTestsIntoBatches$0(String,MutableInt,Consumer,Consumer,List)
- List getTestInfos()
- Optional spawn(GameTestInfo)
+ Stream lambda$groupTestsIntoBatches$1(Map$Entry)
- Stream lambda$new$0(GameTestBatch)
- void <clinit>()
+ void <init>()
- void <init>(GameTestRunner$GameTestBatcher,Collection,ServerLevel,GameTestTicker,GameTestRunner$StructureSpawner,GameTestRunner$StructureSpawner)
- void addListener(GameTestBatchListener)
+ void clearAllTests(ServerLevel,BlockPos,GameTestTicker,int)
+ void lambda$clearAllTests$3(ServerLevel,BlockPos)
- void lambda$new$1(GameTestInfo)
- void lambda$rerunTest$2(GameTestInfo,GameTestInfo,GameTestListener)
- void lambda$runBatch$3(GameTestBatchListener)
- void rerunTest(GameTestInfo)
- void runBatch(int)
- void runScheduledRerunTests()
+ void runTest(GameTestInfo,BlockPos,GameTestTicker)
- void start()
- void stop()
```
...
```diff
- void <init>()
+ void <init>(GameTestInfo,GameTestTicker,BlockPos)
- void handleRetry(GameTestInfo,GameTestRunner,boolean)
+ void rerunTest()
- void testAddedForRerun(GameTestInfo,GameTestInfo,GameTestRunner)
- void testFailed(GameTestInfo,GameTestRunner)
+ void testFailed(GameTestInfo)
- void testPassed(GameTestInfo,GameTestRunner)
+ void testPassed(GameTestInfo)
```
...
```diff
- BlockPos readBlockPos(ByteBuf)
+ Collection readCollection(IntFunction,FriendlyByteBuf$Reader)
- Collection readCollection(IntFunction,StreamDecoder)
- CompoundTag readNbt(ByteBuf)
...
- Map readMap(IntFunction,StreamDecoder,StreamDecoder)
- Map readMap(StreamDecoder,StreamDecoder)
+ Object readById(IdMap)
+ Object readNullable(FriendlyByteBuf$Reader)
- Object readNullable(StreamDecoder)
+ Optional readOptional(FriendlyByteBuf$Reader)
- Optional readOptional(StreamDecoder)
- Quaternionf readQuaternion(ByteBuf)
- Tag readNbt(ByteBuf,NbtAccounter)
- UUID readUUID(ByteBuf)
- Vector3f readVector3f(ByteBuf)
+ void lambda$writeEither$6(FriendlyByteBuf$Writer,Object)
- void lambda$writeEither$6(StreamEncoder,Object)
+ void lambda$writeEither$7(FriendlyByteBuf$Writer,Object)
- void lambda$writeEither$7(StreamEncoder,Object)
+ void lambda$writeMap$5(FriendlyByteBuf$Writer,FriendlyByteBuf$Writer,Object,Object)
- void lambda$writeMap$5(StreamEncoder,StreamEncoder,Object,Object)
- void writeBlockPos(ByteBuf,BlockPos)
+ void writeCollection(Collection,FriendlyByteBuf$Writer)
- void writeCollection(Collection,StreamEncoder)
...
+ void writeId(IdMap,Object)
+ void writeMap(Map,FriendlyByteBuf$Writer,FriendlyByteBuf$Writer)
- void writeMap(Map,StreamEncoder,StreamEncoder)
- void writeNbt(ByteBuf,Tag)
+ void writeNullable(Object,FriendlyByteBuf$Writer)
- void writeNullable(Object,StreamEncoder)
+ void writeOptional(Optional,FriendlyByteBuf$Writer)
- void writeOptional(Optional,StreamEncoder)
- void writeQuaternion(ByteBuf,Quaternionf)
- void writeUUID(ByteBuf,UUID)
- void writeVector3f(ByteBuf,Vector3f)
```
...
- void <init>(BundlerInfo)
- void verifyNonTerminalPacket(Packet)
```
...
+ void <init>(double,double,double,float,List,Vec3,Explosion$BlockInteraction,ParticleOptions,ParticleOptions,SoundEvent)
+ void <init>(FriendlyByteBuf)
- void <init>(RegistryFriendlyByteBuf)
+ void write(FriendlyByteBuf)
- void write(RegistryFriendlyByteBuf)
...
```diff
- Integer lambda$static$0(ClientboundRemoveMobEffectPacket)
- PacketType type()
- void <clinit>()
+ void <init>(FriendlyByteBuf)
+ void write(FriendlyByteBuf)
...
- PacketType type()
- void <clinit>()
+ void <init>(Component,Optional,boolean)
- void <init>(Component,Optional)
```
...
+ void <init>(FriendlyByteBuf)
- void <init>(RegistryFriendlyByteBuf)
+ void <init>(String,String,int,Component,NumberFormat)
...
+ void <init>(FriendlyByteBuf)
- void <init>(RegistryFriendlyByteBuf)
+ void lambda$write$0(FriendlyByteBuf,SoundEvent)
+ void write(FriendlyByteBuf)
- void write(RegistryFriendlyByteBuf)
```
...
```diff
+ void lambda$static$0(FriendlyByteBuf,Byte)
```
...
+ Object read(FriendlyByteBuf)
- Optional decode(ByteBuf)
+ Optional read(FriendlyByteBuf)
- void encode(ByteBuf,Optional)
- void encode(Object,Object)
+ void write(FriendlyByteBuf,Object)
+ void write(FriendlyByteBuf,Optional)
```
...
- Object decode(Object)
+ Object read(FriendlyByteBuf)
- OptionalInt decode(ByteBuf)
+ Rotations read(FriendlyByteBuf)
- void encode(ByteBuf,OptionalInt)
- void encode(Object,Object)
+ void write(FriendlyByteBuf,Object)
+ void write(FriendlyByteBuf,Rotations)
```
...
- void onPacketReceived(ConnectionProtocol,PacketType,SocketAddress,int)
+ void onPacketSent(ConnectionProtocol,int,SocketAddress,int)
- void onPacketSent(ConnectionProtocol,PacketType,SocketAddress,int)
```
...
- void <init>(String,String,String,SocketAddress,int)
```
...
```diff
- EntityAttachments getAttachments()
- ProjectileDeflection deflection(Projectile)
- void igniteForSeconds(int)
- void igniteForTicks(int)
...
```diff
- List lambda$static$2(float,float)
```
...
```diff
- Boolean lambda$checkBedExists$5(BlockPos)
+ Boolean lambda$checkBedExists$7(BlockPos)
+ boolean lambda$createEquipmentSlotAccess$10(EquipmentSlot,ItemStack)
- boolean lambda$createEquipmentSlotAccess$8(EquipmentSlot,ItemStack)
- boolean lambda$isHolding$3(Item,ItemStack)
+ boolean lambda$isHolding$4(Item,ItemStack)
- EquipmentSlot getSlotForHand(InteractionHand)
- float sanitizeScale(float)
+ MobType getMobType()
- Vec3 lambda$stopSleeping$6(BlockPos)
+ Vec3 lambda$stopSleeping$8(BlockPos)
+ void broadcastBreakEvent(InteractionHand)
- void igniteForTicks(int)
...
- void lambda$handleEquipmentChanges$4(List,EquipmentSlot,ItemStack)
+ void lambda$handleEquipmentChanges$5(List,EquipmentSlot,ItemStack)
- void lambda$stopSleeping$7(BlockPos)
...
+ void lambda$tryAddSoulSpeed$0(LivingEntity)
+ void lambda$updateFallFlying$6(LivingEntity)
- void makeSound(SoundEvent)
```
...
+ void maybeDisableShield(Player,ItemStack,ItemStack)
```
...
```diff
- boolean access$200(Raider)
+ boolean access$300(Raider)
+ float access$100(Raider)
- RandomSource access$100(Raider)
+ RandomSource access$200(Raider)
- RandomSource access$300(Raider)
+ RandomSource access$500(Raider)
```
...
```diff
- void moveFromInventoryToPaymentSlot(int,ItemStack,boolean)
+ void moveFromInventoryToPaymentSlot(int,ItemStack)
```
...
```diff
+ void lambda$shootProjectile$1(InteractionHand,LivingEntity)
```
...
```diff
+ void lambda$hurtEnemy$0(LivingEntity)
+ void lambda$mineBlock$1(LivingEntity)
```
...
```diff
- void lambda$changeIntoState$1(BlockState,UseOnContext)
+ void lambda$changeIntoState$2(BlockState,UseOnContext)
- void lambda$changeIntoStateAndDropItem$2(BlockState,ItemLike,UseOnContext)
+ void lambda$changeIntoStateAndDropItem$3(BlockState,ItemLike,UseOnContext)
+ void lambda$useOn$1(UseOnContext,Player)
```
...
+ DataResult lambda$codec$5(boolean,List)
- DataResult lambda$codec$7(boolean,List)
+ DataResult lambda$codec$9(boolean,Ingredient)
+ Ingredient fromNetwork(FriendlyByteBuf)
+ Ingredient lambda$codec$6(Ingredient$Value)
+ Ingredient lambda$codec$7(Either)
...
+ String lambda$codec$4()
- String lambda$codec$6()
+ String lambda$codec$8()
+ void toNetwork(FriendlyByteBuf)
```
...
```diff
+ Recipe fromNetwork(FriendlyByteBuf)
+ ShapedRecipe fromNetwork(FriendlyByteBuf)
- ShapedRecipe fromNetwork(RegistryFriendlyByteBuf)
- StreamCodec streamCodec()
+ void toNetwork(FriendlyByteBuf,Recipe)
+ void toNetwork(FriendlyByteBuf,ShapedRecipe)
- void toNetwork(RegistryFriendlyByteBuf,ShapedRecipe)
```
...
+ Recipe fromNetwork(FriendlyByteBuf)
+ ShapelessRecipe fromNetwork(FriendlyByteBuf)
- ShapelessRecipe fromNetwork(RegistryFriendlyByteBuf)
- StreamCodec streamCodec()
+ void toNetwork(FriendlyByteBuf,Recipe)
+ void toNetwork(FriendlyByteBuf,ShapelessRecipe)
...
```diff
+ CraftingRecipe fromNetwork(FriendlyByteBuf)
+ Recipe fromNetwork(FriendlyByteBuf)
- StreamCodec streamCodec()
+ void toNetwork(FriendlyByteBuf,CraftingRecipe)
+ void toNetwork(FriendlyByteBuf,Recipe)
```
...
```diff
- Ingredient lambda$new$5(SingleItemRecipe)
- ItemStack lambda$new$6(SingleItemRecipe)
+ Recipe fromNetwork(FriendlyByteBuf)
+ SingleItemRecipe fromNetwork(FriendlyByteBuf)
- StreamCodec streamCodec()
- String lambda$new$4(SingleItemRecipe)
+ void toNetwork(FriendlyByteBuf,Recipe)
+ void toNetwork(FriendlyByteBuf,SingleItemRecipe)
```
...
```diff
+ Recipe fromNetwork(FriendlyByteBuf)
+ SmithingTransformRecipe fromNetwork(FriendlyByteBuf)
- SmithingTransformRecipe fromNetwork(RegistryFriendlyByteBuf)
- StreamCodec streamCodec()
+ void toNetwork(FriendlyByteBuf,Recipe)
+ void toNetwork(FriendlyByteBuf,SmithingTransformRecipe)
...
```diff
+ Recipe fromNetwork(FriendlyByteBuf)
+ SmithingTrimRecipe fromNetwork(FriendlyByteBuf)
- SmithingTrimRecipe fromNetwork(RegistryFriendlyByteBuf)
- StreamCodec streamCodec()
+ void toNetwork(FriendlyByteBuf,Recipe)
+ void toNetwork(FriendlyByteBuf,SmithingTrimRecipe)
...
- float getDamageBonus(int,EntityType)
+ float getDamageBonus(int,MobType)
+ void <clinit>()
+ void <init>(Enchantment$Rarity,int,EquipmentSlot[])
- void <init>(Enchantment$Rarity,int,int,int,Optional,EquipmentSlot[])
```
...
+ XXX.client.particle.GustDustParticle$GustDustParticleProvider
...
```
XXX.blaze3d.font.SheetGlyphInfo +4M -4M
```
```
...
```
```
XXX.mojang.realmsclient.RealmsMainScreen$ServerEntry +1P -1P
```
```
XXX.realmsclient.client.FileUpload +1P -1P
```
```
XXX.realmsclient.client.RealmsClient +4M -4M
```
```
XXX.realmsclient.dto.PendingInvite +3P -3P
```
```
XXX.realmsclient.dto.PingResult +1P -1P
```
```
XXX.realmsclient.dto.RealmsServer +1P -1P
```
```
XXX.gui.screens.RealmsInviteScreen +1M
```
```
XXX.gui.screens.RealmsResetWorldScreen +3M -5M | +1P -2P
```
```
XXX.gui.screens.RealmsResetWorldScreen$FrameButton +2M -1M | +3P -2P
```
```
XXX.gui.screens.RealmsSettingsScreen +1M
```
```
XXX.gui.screens.RealmsUploadScreen +6M -4M | +3P -1P
```
```
XXX.util.task.CreateSnapshotRealmTask +1P -1P
```
```
...
```
```
XXX.gui.components.AbstractWidget +1M -1M | +1P -1P
```
```
XXX.gui.components.Tooltip -3M | -3P
```
```
XXX.gui.screens.AccessibilityOnboardingScreen +1M | +1P
```
```
XXX.gui.screens.ConnectScreen$1 +1M -1M | +1P
```
```
XXX.gui.screens.Screen +1M
```
```
XXX.screens.inventory.AbstractCommandBlockEditScreen +1M
```
```
XXX.screens.inventory.CraftingScreen +2M
```
```
XXX.screens.inventory.InventoryScreen +3M -1M
```
```
XXX.screens.inventory.JigsawBlockEditScreen +1M
```
```
XXX.screens.worldselection.EditWorldScreen +2M -1M | +1P
```
```
XXX.screens.worldselection.SelectWorldScreen +1M
```
```
XXX.screens.worldselection.WorldSelectionList -1P
```
```
XXX.client.model.ArmadilloModel -1P
```
```
XXX.client.multiplayer.ClientHandshakePacketListenerImpl +5M -3M | +2P
```
```
XXX.client.multiplayer.ClientLevel$ClientLevelData +1M -7M | +1P -3P
```
```
XXX.client.multiplayer.ClientPacketListener +1M -1M | +1P
```
```
XXX.client.multiplayer.PingDebugMonitor +1M -1M
```
```
XXX.client.multiplayer.ServerData -2M | -1P
```
```
XXX.client.multiplayer.ServerStatusPinger$1 +1M -1M
```
```
XXX.minecraft.core.Direction +2P
```
```
...
```
```
XXX.minecraft.core.Rotations +1M | +1P
```
```
XXX.core.dispenser.DispenseItemBehavior$26 +1M
```
```
XXX.core.particles.BlockParticleOption$1 -2M
```
```
XXX.core.particles.DustColorTransitionOptions$1 -2M
```
```
XXX.core.particles.DustParticleOptions$1 -2M
```
```
XXX.core.particles.ItemParticleOption +3M -1M
```
```
XXX.core.particles.ParticleOptions$Deserializer -1P
```
```
XXX.core.particles.ParticleTypes +8M -3M | +1P
```
```
XXX.core.particles.SculkChargeParticleOptions +1M -1M | +1P
```
```
XXX.core.particles.ShriekParticleOption +1M -1M | +1P
```
```
XXX.core.particles.SimpleParticleType +1M -1M | +1P
```
```
XXX.core.particles.VibrationParticleOption +1M -4M | +1P
```
```
XXX.minecraft.data.HashCache -1M
```
```
XXX.gametest.framework.TestCommand +29M -31M | +2P
```
```
XXX.gametest.framework.TestFunction +12M -9M
```
```
XXX.minecraft.network.Connection +16M -14M | +2P -2P
```
```
XXX.minecraft.network.Connection$2 +1M -1M | +1P -1P
```
```
XXX.minecraft.network.ConnectionProtocol +1M -4M | -2P
```
```
XXX.network.chat.CommonComponents +1P
```
```
XXX.network.chat.ComponentSerialization +1P
```
```
XXX.chat.numbers.BlankFormat$1 +1M -4M | +1P
```
```
XXX.chat.numbers.FixedFormat$1 +2M -4M | +1P
```
```
XXX.chat.numbers.NumberFormatType +1P -2P
```
```
XXX.network.protocol.BundlePacket -1M | +1P
```
```
XXX.network.protocol.BundlerInfo$1 +1M -1M | +3P
```
```
XXX.network.protocol.PacketFlow +2M -1M | +1P
```
```
XXX.protocol.common.ServerboundCustomPayloadPacket +2M -4M | +1P -1P
```
```
XXX.protocol.common.ServerboundPongPacket +2M | +1P
```
```
XXX.common.custom.BreezeDebugPayload +1M -1M | +2P -1P
```
```
XXX.common.custom.CustomPacketPayload +4M | +1P -2P
```
```
XXX.common.custom.GameEventDebugPayload +2M -2M | +3P -2P
```
```
XXX.common.custom.GameTestAddMarkerDebugPayload +1M -1M | +2P -1P
```
```
XXX.common.custom.GoalDebugPayload +1M -1M | +2P -1P
```
```
XXX.common.custom.HiveDebugPayload +1M -1M | +2P -1P
```
```
XXX.common.custom.NeighborUpdatesDebugPayload +1M -1M | +2P -1P
```
```
XXX.common.custom.PoiAddedDebugPayload +2M -2M | +3P -2P
```
```
XXX.common.custom.PoiTicketCountDebugPayload +1M -1M | +2P -1P
```
```
XXX.common.custom.StructuresDebugPayload +1M -1M | +2P -1P
```
```
XXX.common.custom.VillageSectionsDebugPayload +1M -1M | +2P -1P
```
```
XXX.protocol.configuration.ClientboundRegistryDataPacket +1M | +1P
```
```
XXX.protocol.game.ClientboundAddEntityPacket +4M -2M | +1P
```
```
XXX.protocol.game.ClientboundAnimatePacket +2M | +1P
```
```
XXX.protocol.game.ClientboundBlockChangedAckPacket +2M | +1P
```
```
XXX.protocol.game.ClientboundBlockEntityDataPacket +2M -2M | +1P
```
```
XXX.protocol.game.ClientboundBlockUpdatePacket +2M -2M | +1P
```
```
XXX.protocol.game.ServerboundAcceptTeleportationPacket +2M | +1P
```
```
XXX.protocol.game.ServerboundChangeDifficultyPacket +2M | +1P
```
```
XXX.protocol.game.ServerboundChatCommandPacket +2M | +1P
```
```
XXX.protocol.game.ServerboundChatSessionUpdatePacket +2M | +1P
```
```
XXX.protocol.game.ServerboundClientCommandPacket +2M | +1P
```
```
XXX.protocol.game.ServerboundCommandSuggestionPacket +2M | +1P
```
```
XXX.protocol.game.ServerboundContainerButtonClickPacket +2M | +1P
```
```
XXX.protocol.game.ServerboundContainerClosePacket +2M | +1P
```
```
XXX.protocol.game.ServerboundEditBookPacket +2M | +1P
```
```
XXX.protocol.game.ServerboundInteractPacket +1M | +1P
```
```
XXX.protocol.game.ServerboundLockDifficultyPacket +2M | +1P
```
```
XXX.protocol.game.ServerboundMovePlayerPacket$Pos +2M | +1P
```
```
XXX.protocol.game.ServerboundMovePlayerPacket$Rot +2M | +1P
```
```
XXX.protocol.game.ServerboundMoveVehiclePacket +2M | +1P
```
```
XXX.protocol.game.ServerboundPickItemPacket +2M | +1P
```
```
XXX.protocol.game.ServerboundPlayerAbilitiesPacket +2M | +1P
```
```
XXX.protocol.game.ServerboundRecipeBookChangeSettingsPacket +2M | +1P
```
```
XXX.protocol.game.ServerboundRenameItemPacket +2M | +1P
```
```
XXX.protocol.game.ServerboundSetBeaconPacket +2M -6M | +1P
```
```
XXX.protocol.game.ServerboundSetCommandBlockPacket +2M | +1P
```
```
XXX.protocol.game.ServerboundSetCreativeModeSlotPacket +4M -2M | +1P
```
```
XXX.protocol.game.ServerboundSetStructureBlockPacket +2M | +1P
```
```
XXX.protocol.game.ServerboundSwingPacket +2M | +1P
```
```
XXX.protocol.game.ServerboundUseItemOnPacket +2M | +1P
```
```
XXX.protocol.handshake.ClientIntent -1M | +2P
```
```
XXX.protocol.handshake.ClientIntentionPacket +3M -1M | +1P
```
```
XXX.protocol.login.ClientboundCustomQueryPacket +2M | +1P
```
```
XXX.protocol.login.ClientboundHelloPacket +4M -1M | +2P
```
```
XXX.protocol.login.ClientboundLoginDisconnectPacket +2M | +1P
```
```
XXX.protocol.login.ServerboundCustomQueryAnswerPacket +2M | +1P
```
```
XXX.protocol.login.ServerboundKeyPacket +2M | +1P
```
```
XXX.protocol.status.ServerboundStatusRequestPacket +2M -2M | +2P
```
```
XXX.network.syncher.SynchedEntityData$DataValue +3M -3M
```
```
XXX.server.level.ServerLevel +1M -1M | +1P
```
```
XXX.server.level.ServerPlayer -2M
```
```
XXX.level.progress.ProcessorChunkProgressListener +1P
```
```
XXX.server.network.ServerGamePacketListenerImpl +3M -3M
```
```
XXX.server.network.ServerHandshakePacketListenerImpl +1M
```
```
XXX.server.network.ServerLoginPacketListenerImpl +2M -1M | +1P -1P
```
```
XXX.server.network.ServerStatusPacketListenerImpl +1M -1M
```
```
XXX.minecraft.sounds.SoundEvent -2M | +2P
```
```
XXX.minecraft.tags.EntityTypeTags -1M | +11P -2P
```
```
XXX.world.entity.Pose +2M -1M | +3P
```
```
XXX.ai.attributes.AttributeModifier$Operation +1M -2M | +3P -2P
```
```
XXX.ai.behavior.BehaviorUtils +2M -2M
```
```
XXX.ai.behavior.VillagerGoalPackages +3P
```
```
XXX.entity.animal.Cat +1M -2M
```
```
...
```
```
XXX.animal.armadillo.Armadillo +3M -2M | +3P -1P
```
```
XXX.animal.armadillo.ArmadilloAi +2P
```
```
XXX.animal.camel.Camel -1M
```
```
XXX.animal.frog.FrogAi -1P
```
```
XXX.animal.goat.GoatAi -1P
```
```
XXX.animal.horse.SkeletonHorse -1M
```
```
XXX.animal.sniffer.Sniffer$State +2M -1M | +3P
```
```
XXX.entity.monster.AbstractSkeleton -1M
```
```
XXX.entity.monster.Endermite -1M
```
```
XXX.entity.monster.Illusioner -1M
```
```
XXX.entity.monster.Shulker +3M -2M | +1P
```
```
XXX.entity.monster.Vindicator -1M
```
```
XXX.entity.monster.Zombie -1M
```
```
XXX.entity.npc.VillagerTrades$ItemsAndEmeraldsToItems +2M | +1P
```
```
XXX.entity.player.Inventory -1M
```
```
XXX.world.item.SwordItem -2M
```
```
XXX.world.item.TridentItem -3M
```
```
XXX.item.enchantment.Enchantments +11P -11P
```
```
XXX.item.enchantment.FishingSpeedEnchantment +1M -1M
```
```
XXX.item.trading.MerchantOffers +1M -4M | +1P
```
```
XXX.world.level.GameRules +7M -6M | +1P
```
```
XXX.world.level.GameRules$IntegerValue +4M -1M
```
```
...
```
```
XXX.level.block.Block -3M
```
```
XXX.level.block.PlayerWallHeadBlock -1M
```
```
XXX.level.block.PumpkinBlock -1M
```
```
XXX.block.entity.AbstractFurnaceBlockEntity +1M | +1P
```
```
XXX.level.gameevent.BlockPositionSource +1M | +1P
```
```
XXX.level.gameevent.EntityPositionSource$Type +1M -4M
```
```
XXX.level.gameevent.PositionSourceType -2M | +1P -2P
```
```
XXX.level.storage.DerivedLevelData +1M -7M
```
```
XXX.level.storage.LevelSummary$SymlinkLevelSummary +1M
```
...
```diff
- void <init>(TrueTypeGlyphProvider,float,float,int,int,float,int)
+ void <init>(TrueTypeGlyphProvider,int,int,int,int,float,float,int)
```
...
```diff
- List getOwnedNonExpiredRealmIds()
+ List getOwnedNonExpiredWorldIds()
```
...
```diff
- RealmsServer getOwnRealm(long)
+ RealmsServer getOwnWorld(long)
- RealmsServerList listRealms()
+ RealmsServerList listWorlds()
- void deleteRealm(long)
+ void deleteWorld(long)
- void initializeRealm(long,String,String)
+ void initializeWorld(long,String,String)
```
...
```diff
+ int frame(int)
- RealmsResetWorldScreen forNewRealm(Screen,RealmsServer,RealmCreationTask,Runnable)
+ RealmsResetWorldScreen forNewRealm(Screen,RealmsServer,WorldCreationTask,Runnable)
- void <init>(Screen,RealmsServer,int,Component,Component,int,Component,RealmCreationTask,Runnable)
+ void <init>(Screen,RealmsServer,int,Component,Component,int,Component,WorldCreationTask,Runnable)
+ void lambda$switchSlot$9(Runnable)
...
```diff
- void <clinit>()
- void <init>(RealmsResetWorldScreen,Component,ResourceLocation,Button$OnPress)
...
```diff
+ void <init>(long,int,RealmsResetWorldScreen,LevelSummary)
- void <init>(RealmCreationTask,long,int,RealmsResetWorldScreen,LevelSummary)
+ void drawDots(GuiGraphics)
- void lambda$init$3()
- void lambda$init$4(RealmsUploadScreen,GuiEventListener)
+ void lambda$upload$3(long,UploadResult)
+ void lambda$upload$4()
- void lambda$upload$5(UploadResult)
- void lambda$upload$6()
- void repositionElements()
```
...
```diff
- void disconnect(Screen,boolean)
```
...
```diff
- boolean isExperienceBarVisible()
- void renderExperienceLevel(GuiGraphics,float)
```
...
```diff
- void setTooltipDelay(Duration)
+ void setTooltipDelay(int)
```
...
```diff
+ ClientTooltipPositioner createTooltipPositioner(boolean,boolean,ScreenRectangle)
...
```diff
- void <init>(ConnectScreen,String,ServerAddress,Minecraft,ServerData,TransferState)
+ void <init>(ConnectScreen,String,ServerAddress,Minecraft,ServerData)
```
...
- boolean charTyped(char,int)
- boolean keyPressed(int,int,int)
- void renderEntityInInventory(GuiGraphics,float,float,float,Vector3f,Quaternionf,Quaternionf,LivingEntity)
+ void renderEntityInInventory(GuiGraphics,float,float,int,Vector3f,Quaternionf,Quaternionf,LivingEntity)
```
...
+ void lambda$new$0(EditBox,Button)
- void setInitialFocus()
```
...
```diff
- void <init>(Connection,Minecraft,ServerData,Screen,boolean,Duration,Consumer,TransferState)
+ void <init>(Connection,Minecraft,ServerData,Screen,boolean,Duration,Consumer)
- void handleRequestCookie(ClientboundCookieRequestPacket)
...
- void lambda$setEncryption$2(Cipher,Cipher)
- void setEncryption(ServerboundKeyPacket,Cipher,Cipher)
```
...
```diff
+ void handlePongResponse(ClientboundPongResponsePacket)
- void handlePongResponse(ClientboundPongResponsePacket)
```
...
```diff
+ void onPongReceived(ClientboundPongResponsePacket)
- void onPongReceived(ClientboundPongResponsePacket)
```
...
- Optional lambda$getRandomElementOf$17(RandomSource,HolderSet$Named)
```
...
```diff
+ BlockParticleOption fromNetwork(ParticleType,FriendlyByteBuf)
+ ParticleOptions fromNetwork(ParticleType,FriendlyByteBuf)
```
...
```diff
+ DustColorTransitionOptions fromNetwork(ParticleType,FriendlyByteBuf)
+ ParticleOptions fromNetwork(ParticleType,FriendlyByteBuf)
```
...
```diff
+ DustParticleOptions fromNetwork(ParticleType,FriendlyByteBuf)
+ ParticleOptions fromNetwork(ParticleType,FriendlyByteBuf)
```
...
```diff
- ItemParticleOption lambda$streamCodec$2(ParticleType,ItemStack)
- ItemStack lambda$streamCodec$3(ItemParticleOption)
- StreamCodec streamCodec(ParticleType)
...
```diff
+ Codec lambda$static$1(ParticleType)
+ Codec lambda$static$3(ParticleType)
- Codec lambda$static$6(ParticleType)
- Codec lambda$static$8(ParticleType)
- ParticleType register(String,boolean,ParticleOptions$Deserializer,Function,Function)
+ ParticleType register(String,boolean,ParticleOptions$Deserializer,Function)
- StreamCodec lambda$static$1(ParticleType)
- StreamCodec lambda$static$3(ParticleType)
- StreamCodec lambda$static$5(ParticleType)
- StreamCodec lambda$static$7(ParticleType)
- StreamCodec lambda$static$9(ParticleType)
```
...
```diff
- Float lambda$static$2(SculkChargeParticleOptions)
+ void writeToNetwork(FriendlyByteBuf)
```
...
```diff
- Integer lambda$static$2(ShriekParticleOption)
+ void writeToNetwork(FriendlyByteBuf)
```
...
```diff
+ void lambda$purgeStaleAndWrite$2(MutableInt,Set,MutableInt,Path)
```
...
```diff
- ArgumentBuilder lambda$runWithRetryOptions$3(ArgumentBuilder)
- ArgumentBuilder lambda$runWithRetryOptionsAndBuildInfo$6(Function,ArgumentBuilder)
- ArgumentBuilder runWithRetryOptions(ArgumentBuilder,Function,Function)
- ArgumentBuilder runWithRetryOptions(ArgumentBuilder,Function)
- ArgumentBuilder runWithRetryOptionsAndBuildInfo(ArgumentBuilder,Function)
+ boolean lambda$say$31(ServerPlayer)
- boolean lambda$say$34(ServerPlayer)
- boolean lambda$toGameTestInfo$29(CommandSourceStack,TestFunction)
+ boolean verifyStructureExists(ServerLevel,GameTestInfo)
- boolean verifyStructureExists(ServerLevel,String)
+ Component lambda$say$30(String)
- Component lambda$say$33(String)
+ Component lambda$showPos$27(String,Component)
- Component lambda$showPos$31(String,Component)
- GameTestInfo lambda$toGameTestInfo$30(int,CommandSourceStack,RetryOptions,TestFunction)
+ int clearAllTests(CommandSourceStack,int)
+ int exportAllNearbyTests(CommandSourceStack)
+ int exportNearestTestStructure(CommandSourceStack)
...
- int lambda$runWithRetryOptions$0(Function,CommandContext)
- int lambda$runWithRetryOptions$1(Function,CommandContext)
- int lambda$runWithRetryOptions$2(Function,CommandContext)
- int lambda$runWithRetryOptionsAndBuildInfo$4(Function,CommandContext)
- int lambda$runWithRetryOptionsAndBuildInfo$5(Function,CommandContext)
- int resetGameTestInfo(GameTestInfo)
+ int resetNearbyTest(CommandSourceStack)
+ int runAllNearbyTests(CommandSourceStack,boolean)
+ int runAllTests(CommandSourceStack,int,int)
+ int runAllTestsInClass(CommandSourceStack,String,int,int)
+ int runLastFailedTests(CommandSourceStack,boolean,int,int)
+ int runNearbyTest(CommandSourceStack,boolean)
+ int runTest(CommandSourceStack,TestFunction,int)
- int stopTests()
- int trackAndStartRunner(CommandSourceStack,ServerLevel,GameTestRunner)
- Optional createGameTestInfo(BlockPos,ServerLevel,RetryOptions)
- Optional lambda$toGameTestInfos$28(CommandSourceStack,RetryOptions,BlockPos)
- Stream toGameTestInfo(CommandSourceStack,RetryOptions,TestFunctionFinder,int)
- Stream toGameTestInfos(CommandSourceStack,RetryOptions,StructureBlockPosFinder)
- TestCommand$Runner lambda$register$7(CommandContext)
- TestCommand$Runner lambda$register$8(CommandContext)
- TestCommand$Runner lambda$register$9(CommandContext)
+ void lambda$runAllNearbyTests$28(ServerLevel,MultipleTestTracker,boolean,BlockPos)
+ void lambda$runTests$29(GameTestInfo)
+ void lambda$say$32(String,ChatFormatting,ServerPlayer)
- void lambda$say$35(String,ChatFormatting,ServerPlayer)
- void lambda$trackAndStartRunner$32(GameTestInfo)
+ void runTest(ServerLevel,BlockPos,MultipleTestTracker,boolean)
+ void runTestPreparation(TestFunction,ServerLevel)
+ void runTests(CommandSourceStack,Collection,int,int)
+ void showTestSummaryIfAllDone(ServerLevel,MultipleTestTracker)
```
...
- String inboundHandlerName(boolean)
- String outboundHandlerName(boolean)
...
- void initiateServerboundConnection(String,int,ProtocolInfo,ProtocolInfo,ClientboundPacketListener,ClientIntent)
- void initiateServerboundPlayConnection(String,int,ProtocolInfo,ProtocolInfo,ClientboundPacketListener,boolean)
+ void lambda$doSendPacket$10(PacketSendListener,Future)
- void lambda$doSendPacket$13(PacketSendListener,Future)
+ void lambda$flush$11()
- void lambda$flush$14()
- void lambda$initiateServerboundConnection$10(ProtocolInfo,ClientboundPacketListener,String,int,ClientIntent,ProtocolInfo,Connection)
+ void lambda$initiateServerboundConnection$7(ClientIntent,PacketListener,String,int,Connection)
- void lambda$send$11(Packet,PacketSendListener,boolean,Connection)
+ void lambda$send$8(Packet,PacketSendListener,boolean,Connection)
- void lambda$sendPacket$12(Packet,PacketSendListener,boolean)
+ void lambda$sendPacket$9(Packet,PacketSendListener,boolean)
- void lambda$setupInboundProtocol$7(PacketBundlePacker,ChannelHandlerContext)
- void lambda$setupOutboundProtocol$8(PacketBundleUnpacker,ChannelHandlerContext)
- void lambda$setupOutboundProtocol$9(boolean,ChannelHandlerContext)
...
- void setupInboundProtocol(ProtocolInfo,PacketListener)
- void setupOutboundProtocol(ProtocolInfo)
+ void suspendInboundAfterProtocolChange()
- void validateListener(ProtocolInfo,PacketListener)
```
...
+ ConnectionProtocol$ProtocolBuilder protocol()
+ Int2ObjectMap getPacketsByIds(PacketFlow)
...
```diff
+ BlankFormat readFromStream(FriendlyByteBuf)
+ NumberFormat readFromStream(FriendlyByteBuf)
- StreamCodec streamCodec()
+ void writeToStream(FriendlyByteBuf,BlankFormat)
+ void writeToStream(FriendlyByteBuf,NumberFormat)
```
...
```diff
- Component lambda$$1(FixedFormat)
+ FixedFormat readFromStream(FriendlyByteBuf)
+ NumberFormat readFromStream(FriendlyByteBuf)
- StreamCodec streamCodec()
+ void writeToStream(FriendlyByteBuf,FixedFormat)
+ void writeToStream(FriendlyByteBuf,NumberFormat)
```
...
```diff
+ void <init>()
- void <init>(PacketType,BundleDelimiterPacket,Function)
```
...
```diff
+ CustomPacketPayload readPayload(ResourceLocation,FriendlyByteBuf)
+ DiscardedPayload readUnknownPayload(ResourceLocation,FriendlyByteBuf)
- PacketType type()
- StreamCodec lambda$static$0(ResourceLocation)
+ void <init>(FriendlyByteBuf)
+ void write(FriendlyByteBuf)
```
...
```diff
- CustomPacketPayload$Type createType(String)
- ResourceLocation lambda$codec$0(CustomPacketPayload$TypeAndCodec)
- StreamCodec codec(CustomPacketPayload$FallbackProvider,List)
- StreamCodec codec(StreamMemberEncoder,StreamDecoder)
```
...
- PacketType type()
- void <clinit>()
- void <init>(String,byte[],byte[],boolean)
+ void <init>(String,byte[],byte[])
```
...
```diff
+ SynchedEntityData$DataValue read(FriendlyByteBuf,int,EntityDataSerializer)
+ SynchedEntityData$DataValue read(FriendlyByteBuf,int)
- SynchedEntityData$DataValue read(RegistryFriendlyByteBuf,int,EntityDataSerializer)
- SynchedEntityData$DataValue read(RegistryFriendlyByteBuf,int)
+ void write(FriendlyByteBuf)
- void write(RegistryFriendlyByteBuf)
```
...
+ Explosion explode(Entity,DamageSource,ExplosionDamageCalculator,double,double,double,float,boolean,Level$ExplosionInteraction,ParticleOptions,ParticleOptions,SoundEvent)
```
...
- void handleBlockEntityTagQuery(ServerboundBlockEntityTagQueryPacket)
+ void handleEntityTagQuery(ServerboundEntityTagQuery)
- void handleEntityTagQuery(ServerboundEntityTagQueryPacket)
+ void handlePingRequest(ServerboundPingRequestPacket)
- void handlePingRequest(ServerboundPingRequestPacket)
```
...
```diff
- void beginLogin(ClientIntentionPacket,boolean)
```
...
+ void <init>(MinecraftServer,Connection)
...
```diff
+ AttributeModifier$Operation fromValue(int)
- int id()
+ int toValue()
```
...
```diff
- void lockGazeAndWalkToEachOther(LivingEntity,LivingEntity,float,int)
+ void lockGazeAndWalkToEachOther(LivingEntity,LivingEntity,float)
- void setWalkAndLookTargetMemoriesToEachOther(LivingEntity,LivingEntity,float,int)
...
+ void lambda$finalizeSpawn$1(Holder)
```
...
```diff
- DyeColor lambda$getOffspringColor$3(DyeColor,DyeColor)
+ DyeColor lambda$getOffspringColor$4(DyeColor,DyeColor)
- ItemStack lambda$getOffspringColor$2(CraftingContainer,RecipeHolder)
+ ItemStack lambda$getOffspringColor$3(CraftingContainer,RecipeHolder)
+ void lambda$mobInteract$2(InteractionHand,Player)
```
...
```diff
+ void lambda$mobInteract$1(InteractionHand,Player)
```
...
```diff
- boolean checkArmadilloSpawnRules(EntityType,LevelAccessor,MobSpawnType,BlockPos,RandomSource)
- int getMaxHeadYRot()
+ void lambda$mobInteract$0(InteractionHand,Player)
- void rollOut()
+ void rollOut(boolean)
```
...
```diff
+ void clampHeadRotationToBody(Entity,float)
```
...
```diff
+ AABB getProgressAabb(Direction,float)
- AABB getProgressAabb(float,Direction,float)
+ AABB getProgressDeltaAabb(Direction,float,float)
- AABB getProgressDeltaAabb(float,Direction,float,float)
- float sanitizeScale(float)
```
...
```diff
+ void lambda$hurtArmor$1(int,Player)
```
...
+ void lambda$mineBlock$2(LivingEntity)
+ void lambda$releaseUsing$0(LivingEntity,Player)
```
...
```diff
+ void <init>(Enchantment$Rarity,EnchantmentCategory,EquipmentSlot[])
- void <init>(Enchantment$Rarity,TagKey,EquipmentSlot[])
```
...
+ MerchantOffers createFromStream(FriendlyByteBuf)
- void <clinit>()
...
- GameRules$Value lambda$copy$8(Map$Entry)
+ GameRules$Value lambda$new$4(Map$Entry)
- GameRules$Value lambda$new$5(Map$Entry)
- void lambda$assignFrom$10(GameRules,MinecraftServer,GameRules$Key)
...
- void lambda$createTag$6(CompoundTag,GameRules$Key,GameRules$Value)
+ void lambda$loadFromTag$6(DynamicLike,GameRules$Key,GameRules$Value)
- void lambda$loadFromTag$7(DynamicLike,GameRules$Key,GameRules$Value)
- void lambda$static$4(MinecraftServer,GameRules$IntegerValue)
+ void lambda$visitGameRuleTypes$8(GameRules$GameRuleTypeVisitor,GameRules$Key,GameRules$Type)
- void lambda$visitGameRuleTypes$9(GameRules$GameRuleTypeVisitor,GameRules$Key,GameRules$Type)
```
...
```diff
- ArgumentType lambda$create$1(int,int)
- GameRules$IntegerValue lambda$create$2(int,GameRules$Type)
- GameRules$Type create(int,int,int,BiConsumer)
+ void lambda$create$1(MinecraftServer,GameRules$IntegerValue)
...
```diff
- Explosion explode(Entity,DamageSource,ExplosionDamageCalculator,double,double,double,float,boolean,Level$ExplosionInteraction,boolean,ParticleOptions,ParticleOptions,Holder)
+ Explosion explode(Entity,DamageSource,ExplosionDamageCalculator,double,double,double,float,boolean,Level$ExplosionInteraction,boolean,ParticleOptions,ParticleOptions,SoundEvent)
- Explosion explode(Entity,DamageSource,ExplosionDamageCalculator,double,double,double,float,boolean,Level$ExplosionInteraction,ParticleOptions,ParticleOptions,Holder)
+ Explosion explode(Entity,DamageSource,ExplosionDamageCalculator,double,double,double,float,boolean,Level$ExplosionInteraction,ParticleOptions,ParticleOptions,SoundEvent)
```
...
+ SoundType getSoundType(BlockState)
```
...
```diff
+ List getDrops(BlockState,LootParams$Builder)
```
...
```diff
- BlockPos lambda$static$2(BlockPositionSource)
```
...
```diff
+ EntityPositionSource read(FriendlyByteBuf)
+ PositionSource read(FriendlyByteBuf)
- StreamCodec streamCodec()
+ void write(FriendlyByteBuf,EntityPositionSource)
+ void write(FriendlyByteBuf,PositionSource)
```
...
```diff
+ PositionSource fromNetwork(FriendlyByteBuf)
+ void toNetwork(PositionSource,FriendlyByteBuf)
```
