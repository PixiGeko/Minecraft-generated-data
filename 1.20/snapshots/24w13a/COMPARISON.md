## Comparison with [24w12a](https://github.com/PixiGeko/Minecraft-generated-data/tree/24w12a)
...
<br/>
<table><tr><th></th><th align="left">24w12a</th><th>24w13a</th></tr><tr><td>DataPack version</td><td><pre>36</pre></td><td><pre>37</pre></td></tr><tr><td>ResourcePack version</td><td><pre>30</pre></td><td><pre>31</pre></td></tr><tr><td>World version</td><td><pre>3824</pre></td><td><pre>3826</pre></td></tr><tr><td>Protocol version</td><td><pre>1073742005</pre></td><td><pre>1073742006</pre></td></tr></table>
<h3>Libraries<a name="version-data-libraries"></a></h3>
<details>
<summary>
Versions
</summary>
<table><tr><th></th><th align="left">24w12a</th><th>24w13a</th></tr><tr><td>com.mojang:datafixerupper</td><td><pre>6.0.12</pre></td><td><pre>7.0.13</pre></td></tr></table>
</details>
</details>
<hr/>
...
<table><tr><th></th><th align="left">24w12a</th><th>24w13a</th></tr><tr><td>experience</td><td><pre>{
...
<br/>
<table>
<tr><th>Name</th><th>24w12a</th><th>24w13a</th></tr>
...
```
```
net.minecraft.Util +1M -3M
```
```
XXX.minecraft.advancements.CriteriaTriggers +1P -1P
```
```
XXX.advancements.critereon.PlayerPredicate$AdvancementPredicate +1M -4M
```
```
XXX.advancements.critereon.PlayerPredicate$StatMatcher +1M -1M
```
```
XXX.core.component.DataComponentPredicate +3M -2M
```
```
XXX.core.component.DataComponentType +2M | +2P
```
```
XXX.core.dispenser.DispenseItemBehavior$2 +2M -1M
```
```
...
```
```
XXX.minecraft.util.ExtraCodecs$StrictUnboundedMapCodec +1M -1M
```
```
XXX.minecraft.util.ParticleUtils +1M
```
```
XXX.util.datafix.ComponentDataFixUtils +1M
```
```
XXX.util.datafix.ExtraDataFixUtils -12M
```
```
XXX.datafix.fixes.RenameEnchantmentsFix +2M -2M
```
```
...
```
```
XXX.item.alchemy.Potion +2M | +1P
```
```
XXX.item.alchemy.Potions +4P
```
```
...
```
```
XXX.level.block.DispenserBlock +2M
```
```
XXX.block.entity.AbstractFurnaceBlockEntity +1M -1M
```
```
XXX.block.entity.BannerBlockEntity +5M -5M
```
```
XXX.block.entity.BarrelBlockEntity +1M -1M
```
```
XXX.block.entity.BaseContainerBlockEntity +3M -3M
```
```
XXX.block.entity.BlockEntity +18M -7M | +1P
```
```
XXX.entity.trialspawner.TrialSpawnerConfig +3M -3M | +2P -3P
```
```
XXX.entity.trialspawner.TrialSpawnerState +9M -1M
```
```
XXX.entity.vault.VaultBlockEntity +2M -2M
```
```
XXX.entity.vault.VaultState$1 +1M -1M
```
```
XXX.entity.vault.VaultState$3 +1M -1M
```
```
XXX.block.state.StateHolder +1M -1M
```
```
...
```
```
XXX.level.levelgen.NoiseSettings +1M -1M
```
```
...
```
```
XXX.levelgen.feature.Feature +1M -1M | +1P -1P
```
```
...
```
```
XXX.feature.treedecorators.BeehiveDecorator +1P -1P
```
```
...
```
```
XXX.levelgen.placement.CountOnEveryLayerPlacement +1P -1P
```
```
XXX.levelgen.placement.EnvironmentScanPlacement +1P -1P
```
```
XXX.levelgen.placement.HeightmapPlacement +1P -1P
```
```
XXX.levelgen.placement.NoiseBasedCountPlacement +1P -1P
```
```
XXX.levelgen.placement.PlacementModifierType +2M -2M | +1P -1P
```
```
XXX.levelgen.placement.RarityFilter +1P -1P
```
```
XXX.levelgen.placement.SurfaceRelativeThresholdFilter +1P -1P
```
```
...
```
```
XXX.structure.templatesystem.BlockAgeProcessor +1P -1P
```
```
...
```
```
XXX.storage.loot.BuiltInLootTables +8P
```
```
...
```
```
XXX.screens.worldselection.CreateWorldScreen +10M -9M
```
```
XXX.multiplayer.chat.LoggedChatEvent$Type +3M -3M
```
```
XXX.multiplayer.chat.LoggedChatMessage$Player +1P -1P
```
```
XXX.client.particle.TerrainParticle +1M
```
```
...
```
```
XXX.core.dispenser.DispenseItemBehavior$8 +2M -1M
```
```
...
```
```
XXX.server.network.ServerGamePacketListenerImpl +13M -8M | +1P
```
```
XXX.minecraft.tags.EntityTypeTags +2P
```
```
XXX.minecraft.util.ExtraCodecs +50M -85M
```
```
XXX.minecraft.util.ExtraCodecs$7 +4M -14M | +1P -2P
```
```
XXX.datafix.schemas.V1460 +1M -1M
```
```
...
```
```
XXX.world.entity.EntityType$Builder +1M | +1P
```
```
XXX.world.entity.EquipmentSlotGroup +1P
```
```
...
```
```
XXX.projectile.windcharge.AbstractWindCharge +1M | +1P
```
```
XXX.projectile.windcharge.BreezeWindCharge -1M | -1P
```
```
XXX.entity.raid.Raids +1M -1M
```
```
...
```
```
XXX.world.item.CreativeModeTabs +28M -24M
```
```
XXX.world.item.FireChargeItem +4M
```
```
XXX.world.item.ItemStack +5M -3M
```
```
XXX.block.entity.CampfireBlockEntity +3M -3M
```
```
...
```
```
XXX.block.entity.JigsawBlockEntity +2M -2M
```
```
XXX.block.entity.JukeboxBlockEntity +1M -1M
```
```
XXX.block.entity.RandomizableContainerBlockEntity +2M -2M
```
```
XXX.block.entity.SignBlockEntity +3M -3M
```
```
XXX.block.entity.SkullBlockEntity +4M -4M
```
```
XXX.entity.trialspawner.PlayerDetector +8M -4M | +1P -1P
```
```
XXX.entity.trialspawner.TrialSpawner +15M -6M | +9P -1P
```
```
...
```
```
XXX.loot.predicates.LootItemConditions +1M -1M
```
```
XXX.loot.predicates.LootItemKilledByPlayerCondition +1P -1P
```
```
XXX.loot.predicates.LootItemRandomChanceWithLootingCondition +1P -1P
```
```
XXX.loot.predicates.TimeCheck +1P -1P
```
```
XXX.loot.predicates.ValueCheckCondition +1P -1P
```
```
XXX.providers.nbt.ContextNbtProvider +1P -1P
```
```
XXX.providers.nbt.LootNbtProviderType +2M -2M | +1P -1P
```
```
XXX.providers.nbt.NbtProviders +3M -4M
```
```
XXX.providers.number.ConstantValue +1P -1P
```
```
XXX.providers.number.ScoreboardValue +1P -1P
```
```
XXX.providers.number.UniformGenerator +1P -1P
```
```
XXX.providers.score.ContextScoreboardNameProvider +1P -1P
```
```
XXX.providers.score.LootScoreProviderType +2M -2M | +1P -1P
```
```
XXX.providers.score.ScoreboardNameProviders +3M -4M
```
