## Comparison with [23w33a](https://github.com/PixiGeko/Minecraft-generated-data/tree/23w33a)
...
<br/>
<table><tr><th></th><th align="left">23w33a</th><th>23w35a</th></tr><tr><td>World version</td><td><pre>3570</pre></td><td><pre>3571</pre></td></tr><tr><td>Protocol version</td><td><pre>1073741970</pre></td><td><pre>1073741971</pre></td></tr></table>
<h3>Libraries<a name="version-data-libraries"></a></h3>
<details>
<summary>
Versions
</summary>
<table><tr><th></th><th align="left">23w33a</th><th>23w35a</th></tr><tr><td>com.github.oshi:oshi-core</td><td><pre>6.2.2</pre></td><td><pre>6.4.5</pre></td></tr><tr><td>com.google.code.gson:gson</td><td><pre>2.10</pre></td><td><pre>2.10.1</pre></td></tr><tr><td>com.google.guava:guava</td><td><pre>31.1-jre</pre></td><td><pre>32.1.2-jre</pre></td></tr><tr><td>com.ibm.icu:icu4j</td><td><pre>71.1</pre></td><td><pre>73.2</pre></td></tr><tr><td>commons-codec:commons-codec</td><td><pre>1.15</pre></td><td><pre>1.16.0</pre></td></tr><tr><td>commons-io:commons-io</td><td><pre>2.11.0</pre></td><td><pre>2.13.0</pre></td></tr><tr><td>io.netty:netty-buffer</td><td><pre>4.1.82.Final</pre></td><td><pre>4.1.97.Final</pre></td></tr><tr><td>io.netty:netty-codec</td><td><pre>4.1.82.Final</pre></td><td><pre>4.1.97.Final</pre></td></tr><tr><td>io.netty:netty-common</td><td><pre>4.1.82.Final</pre></td><td><pre>4.1.97.Final</pre></td></tr><tr><td>io.netty:netty-handler</td><td><pre>4.1.82.Final</pre></td><td><pre>4.1.97.Final</pre></td></tr><tr><td>io.netty:netty-resolver</td><td><pre>4.1.82.Final</pre></td><td><pre>4.1.97.Final</pre></td></tr><tr><td>io.netty:netty-transport-classes-epoll</td><td><pre>4.1.82.Final</pre></td><td><pre>4.1.97.Final</pre></td></tr><tr><td>io.netty:netty-transport-native-epoll (linux-aarch_64)</td><td><pre>4.1.82.Final</pre></td><td><pre>4.1.97.Final</pre></td></tr><tr><td>io.netty:netty-transport-native-epoll (linux-x86_64)</td><td><pre>4.1.82.Final</pre></td><td><pre>4.1.97.Final</pre></td></tr><tr><td>io.netty:netty-transport-native-unix-common</td><td><pre>4.1.82.Final</pre></td><td><pre>4.1.97.Final</pre></td></tr><tr><td>io.netty:netty-transport</td><td><pre>4.1.82.Final</pre></td><td><pre>4.1.97.Final</pre></td></tr><tr><td>it.unimi.dsi:fastutil</td><td><pre>8.5.9</pre></td><td><pre>8.5.12</pre></td></tr><tr><td>net.java.dev.jna:jna-platform</td><td><pre>5.12.1</pre></td><td><pre>5.13.0</pre></td></tr><tr><td>net.java.dev.jna:jna</td><td><pre>5.12.1</pre></td><td><pre>5.13.0</pre></td></tr><tr><td>org.apache.commons:commons-compress</td><td><pre>1.21</pre></td><td><pre>1.22</pre></td></tr><tr><td>org.apache.commons:commons-lang3</td><td><pre>3.12.0</pre></td><td><pre>3.13.0</pre></td></tr><tr><td>org.apache.httpcomponents:httpcore</td><td><pre>4.4.15</pre></td><td><pre>4.4.16</pre></td></tr><tr><td>org.lwjgl:lwjgl-glfw</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-glfw (natives-linux)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-glfw (natives-macos)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-glfw (natives-macos-arm64)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-glfw (natives-windows)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-glfw (natives-windows-arm64)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-glfw (natives-windows-x86)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc (natives-linux)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc (natives-macos)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc (natives-macos-arm64)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc (natives-windows)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc (natives-windows-arm64)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc (natives-windows-x86)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal (natives-linux)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal (natives-macos)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal (natives-macos-arm64)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal (natives-windows)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal (natives-windows-arm64)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal (natives-windows-x86)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl (natives-linux)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl (natives-macos)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl (natives-macos-arm64)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl (natives-windows)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl (natives-windows-arm64)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl (natives-windows-x86)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb (natives-linux)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb (natives-macos)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb (natives-macos-arm64)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb (natives-windows)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb (natives-windows-arm64)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb (natives-windows-x86)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd (natives-linux)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd (natives-macos)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd (natives-macos-arm64)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd (natives-windows)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd (natives-windows-arm64)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd (natives-windows-x86)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl (natives-linux)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl (natives-macos)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl (natives-macos-arm64)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl (natives-windows)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl (natives-windows-arm64)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.lwjgl:lwjgl (natives-windows-x86)</td><td><pre>3.3.1</pre></td><td><pre>3.3.2</pre></td></tr><tr><td>org.slf4j:slf4j-api</td><td><pre>2.0.1</pre></td><td><pre>2.0.7</pre></td></tr></table>
</details>
</details>
<hr/>
...
<br/>
<table>
<tr><th>Name</th><th>23w33a</th><th>23w35a</th></tr>
<tr><th align="left"><div style="width:290px">commands.random.error.range_too_large</div></th><td>Range of random value must be at most 2147483646</td><td>The range of the random value must be at most 2147483646</td></tr>
<tr><th align="left"><div style="width:290px">commands.random.error.range_too_small</div></th><td>Range of random value must be at least 2</td><td>The range of the random value must be at least 2</td></tr>
<tr><th align="left"><div style="width:290px">gui.abuseReport.type.chat</div></th><td>Chat messages</td><td>Chat Messages</td></tr>
<tr><th align="left"><div style="width:290px">gui.abuseReport.type.name</div></th><td>Player name</td><td>Player Name</td></tr>
<tr><th align="left"><div style="width:290px">gui.abuseReport.type.skin</div></th><td>Player skin</td><td>Player Skin</td></tr>
<tr><th align="left"><div style="width:290px">mco.selectServer.loading</div></th><td>Loading Realm list</td><td>Loading Realms List</td></tr>
...
<tr><th align="left"><div style="width:290px">pack.dropRejected.message</div></th><td>Following entries were not valid packs and were not copied:

 %s</td><td>The following entries were not valid packs and were not copied:

 %s</td></tr>
<tr><th align="left"><div style="width:290px">selectWorld.loading_list</div></th><td>Loading world list</td><td>Loading World List</td></tr>
<tr><th align="left"><div style="width:290px">symlink_warning.title.pack</div></th><td>Added pack(s) contain symbolic links</td><td>Added pack(s) contain(s) symbolic links</td></tr>
<tr><th align="left"><div style="width:290px">symlink_warning.title.world</div></th><td>World folder contains symbolic links</td><td>The world folder contains symbolic links</td></tr>
</table>
<br/>
</details>
</details>
...
```
XXX.minecraft.advancements.Advancement$Builder +8M -17M | +5P -6P
```
```
XXX.minecraft.advancements.TreeNodePosition +4M -3M | +1P -1P
```
```
XXX.advancements.critereon.BeeNestDestroyedTrigger +1M -3M | -1P
```
```
XXX.advancements.critereon.BlockPredicate -1M
```
```
XXX.advancements.critereon.BredAnimalsTrigger +1M -3M | -1P
```
```
XXX.advancements.critereon.BrewedPotionTrigger +1M -3M | -1P
```
```
XXX.advancements.critereon.ChangeDimensionTrigger +1M -3M | -1P
```
```
XXX.advancements.critereon.ChanneledLightningTrigger +1M -3M | -1P
```
```
XXX.advancements.critereon.ConstructBeaconTrigger +1M -3M | -1P
```
```
XXX.advancements.critereon.ConsumeItemTrigger +1M -3M | -1P
```
```
XXX.advancements.critereon.CuredZombieVillagerTrigger$TriggerInstance +1M -1M
```
```
XXX.advancements.critereon.DamagePredicate$Builder +1M -1M
```
```
XXX.advancements.critereon.DamageSourcePredicate$Builder +1M -1M
```
```
XXX.advancements.critereon.DistanceTrigger$TriggerInstance +4M -4M
```
```
XXX.advancements.critereon.EffectsChangedTrigger$TriggerInstance +2M -2M
```
```
XXX.advancements.critereon.EnchantedItemTrigger$TriggerInstance +1M -1M
```
```
XXX.advancements.critereon.EnterBlockTrigger +1M -3M | -1P
```
```
XXX.advancements.critereon.EntityEquipmentPredicate -1M
```
```
XXX.advancements.critereon.EntityFlagsPredicate -1M
```
```
XXX.advancements.critereon.EntityHurtPlayerTrigger +1M -3M | -1P
```
```
XXX.advancements.critereon.EntityPredicate +2M -4M
```
```
XXX.advancements.critereon.FilledBucketTrigger$TriggerInstance +1M -1M
```
```
XXX.advancements.critereon.FishingRodHookedTrigger +1M -3M | -1P
```
```
XXX.advancements.critereon.FluidPredicate -1M
```
```
XXX.advancements.critereon.ImpossibleTrigger -2M | -1P
```
```
XXX.advancements.critereon.InventoryChangeTrigger +1M -3M | -1P
```
```
XXX.advancements.critereon.ItemDurabilityTrigger +1M -3M | -1P
```
```
XXX.advancements.critereon.ItemPredicate -1M
```
```
XXX.advancements.critereon.ItemUsedOnLocationTrigger +2M -3M | -1P
```
```
XXX.advancements.critereon.KilledByCrossbowTrigger +1M -3M | -1P
```
```
XXX.advancements.critereon.KilledTrigger +2M -3M | -1P
```
```
XXX.advancements.critereon.LevitationTrigger +1M -3M | -1P
```
```
XXX.advancements.critereon.LightPredicate -1M
```
```
XXX.advancements.critereon.LightningStrikeTrigger$TriggerInstance +1M -1M
```
```
XXX.advancements.critereon.LocationPredicate$Builder +1M -1M
```
```
XXX.advancements.critereon.LootTableTrigger +1M -3M | -1P
```
```
XXX.advancements.critereon.PickedUpItemTrigger$TriggerInstance +3M -3M
```
```
XXX.advancements.critereon.PlayerHurtEntityTrigger$TriggerInstance +6M -6M
```
```
XXX.advancements.critereon.PlayerInteractTrigger$TriggerInstance +2M -2M
```
```
XXX.advancements.critereon.PlayerTrigger$TriggerInstance +9M -8M
```
```
XXX.advancements.critereon.RecipeCraftedTrigger$TriggerInstance +2M -3M
```
```
XXX.advancements.critereon.RecipeUnlockedTrigger$TriggerInstance +1M -1M
```
```
XXX.advancements.critereon.ShotCrossbowTrigger$TriggerInstance +2M -2M
```
```
XXX.data.recipes.RecipeProvider +64M -66M | +1P -1P
```
```
XXX.entity.player.Player +1M -1M
```
```
XXX.entity.player.StackedContents +2M -2M
```
```
XXX.world.inventory.AbstractFurnaceMenu +1M -1M
```
```
XXX.world.inventory.ResultContainer +2M -2M | +1P -1P
```
```
XXX.world.inventory.SmithingMenu +4M -4M | +1P -1P
```
```
XXX.item.crafting.AbstractCookingRecipe +1M -2M | -1P
```
```
XXX.item.crafting.BannerDuplicateRecipe +1M -1M
```
```
XXX.item.crafting.BookCloningRecipe +1M -1M
```
```
XXX.item.crafting.RecipeSerializer +2P -2P
```
```
XXX.item.crafting.ShapedRecipe +3M -10M | -1P
```
...
```
XXX.mojang.realmsclient.RealmsMainScreen$NotificationButton +1M
```
```
XXX.mojang.realmsclient.RealmsMainScreen$ServerEntry -2M
```
```
XXX.gui.screens.RealmsResetNormalWorldScreen +1P
```
```
XXX.gui.screens.RealmsSelectFileToUploadScreen +1M -1M | +1P -1P
```
```
XXX.util.task.ConnectTask +2M | +1P
```
```
XXX.util.task.GetServerDetailsTask +1M | +1P
```
```
XXX.util.task.OpenServerTask +1M | +1P
```
```
XXX.util.task.RestoreTask +1M | +1P
```
```
XXX.util.task.SwitchSlotTask +1M | +1P
```
```
XXX.minecraft.advancements.Advancement +20M -15M | +4P -6P
```
```
XXX.minecraft.advancements.AdvancementProgress +15M -4M | +5P -1P
```
```
XXX.advancements.critereon.AbstractCriterionTriggerInstance +2M -4M | -1P
```
```
XXX.advancements.critereon.BeeNestDestroyedTrigger$TriggerInstance +1M -1M
```
```
XXX.advancements.critereon.BlockPredicate$Builder +1M -1M
```
```
XXX.advancements.critereon.BredAnimalsTrigger$TriggerInstance +3M -3M
```
```
XXX.advancements.critereon.BrewedPotionTrigger$TriggerInstance +1M -1M
```
```
XXX.advancements.critereon.ChangeDimensionTrigger$TriggerInstance +4M -4M
```
```
XXX.advancements.critereon.ChanneledLightningTrigger$TriggerInstance +1M -1M
```
```
XXX.advancements.critereon.ConstructBeaconTrigger$TriggerInstance +2M -2M
```
```
XXX.advancements.critereon.ConsumeItemTrigger$TriggerInstance +3M -3M
```
```
XXX.advancements.critereon.CuredZombieVillagerTrigger +1M -3M | -1P
```
```
XXX.advancements.critereon.DamagePredicate -1M
```
```
XXX.advancements.critereon.DamageSourcePredicate -1M
```
```
XXX.advancements.critereon.DistanceTrigger +2M -3M | -1P
```
```
XXX.advancements.critereon.EffectsChangedTrigger +1M -3M | -1P
```
```
XXX.advancements.critereon.EnchantedItemTrigger +1M -3M | -1P
```
```
XXX.advancements.critereon.EnterBlockTrigger$TriggerInstance +1M -1M
```
```
XXX.advancements.critereon.EntityEquipmentPredicate$Builder +1M -1M
```
```
XXX.advancements.critereon.EntityFlagsPredicate$Builder +1M -1M
```
```
XXX.advancements.critereon.EntityHurtPlayerTrigger$TriggerInstance +3M -3M
```
```
XXX.advancements.critereon.EntityPredicate$Builder +1M -1M
```
```
XXX.advancements.critereon.FilledBucketTrigger +1M -3M | -1P
```
```
XXX.advancements.critereon.FishingRodHookedTrigger$TriggerInstance +1M -1M
```
```
XXX.advancements.critereon.FluidPredicate$Builder +1M -1M
```
```
XXX.advancements.critereon.ImpossibleTrigger$TriggerInstance -1M
```
```
XXX.advancements.critereon.InventoryChangeTrigger$TriggerInstance +5M -6M
```
```
...
```
```
XXX.advancements.critereon.ItemUsedOnLocationTrigger$TriggerInstance +6M -6M
```
```
XXX.advancements.critereon.KilledByCrossbowTrigger$TriggerInstance +2M -2M
```
```
XXX.advancements.critereon.KilledTrigger$TriggerInstance +16M -16M
```
```
XXX.advancements.critereon.LevitationTrigger$TriggerInstance +1M -1M
```
```
XXX.advancements.critereon.LightPredicate$Builder +1M -1M
```
```
XXX.advancements.critereon.LightningStrikeTrigger +1M -3M | -1P
```
```
XXX.advancements.critereon.LootTableTrigger$TriggerInstance +1M -1M
```
```
XXX.advancements.critereon.PickedUpItemTrigger +2M -3M | -1P
```
```
XXX.advancements.critereon.PlayerHurtEntityTrigger +1M -3M | -1P
```
```
XXX.advancements.critereon.PlayerInteractTrigger +1M -3M | -1P
```
```
XXX.advancements.critereon.PlayerPredicate$Builder +1M -1M
```
```
XXX.advancements.critereon.PlayerTrigger +2M -3M | -1P
```
```
XXX.advancements.critereon.RecipeCraftedTrigger +1M -3M | -1P
```
```
XXX.advancements.critereon.RecipeUnlockedTrigger +4M -6M | -1P
```
```
XXX.advancements.critereon.ShotCrossbowTrigger +1M -3M | -1P
```
```
XXX.advancements.critereon.SimpleCriterionTrigger +1M -1M | +1P -1P
```
```
XXX.entity.player.Player +1M -1M
```
