...
<tr><th>SHA1</th><td>4b75f702c335fa01346faba8ddbf2a00c2832a27</td></tr>
<tr><th>Url</th><td><a href="https://piston-meta.mojang.com/v1/packages/4b75f702c335fa01346faba8ddbf2a00c2832a27/1.20-pre5.json">https://piston-meta.mojang.com/v1/packages/4b75f702c335fa01346faba8ddbf2a00c2832a27/1.20-pre5.json</a></td></tr>
...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/1.20-pre4">1.20-pre4</a>
## Misc
...
+ C:\Users\pixig\Minecraft-generated-data\1.20\pre-releases\1.20-pre5\.data\server\data\minecraft\worldgen\world_preset\amplified.json
+ C:\Users\pixig\Minecraft-generated-data\1.20\pre-releases\1.20-pre5\.data\server\data\minecraft\worldgen\world_preset\debug_all_block_states.json
+ C:\Users\pixig\Minecraft-generated-data\1.20\pre-releases\1.20-pre5\.data\server\data\minecraft\worldgen\world_preset\flat.json
+ C:\Users\pixig\Minecraft-generated-data\1.20\pre-releases\1.20-pre5\.data\server\data\minecraft\worldgen\world_preset\large_biomes.json
+ C:\Users\pixig\Minecraft-generated-data\1.20\pre-releases\1.20-pre5\.data\server\data\minecraft\worldgen\world_preset\normal.json
+ C:\Users\pixig\Minecraft-generated-data\1.20\pre-releases\1.20-pre5\.data\server\data\minecraft\worldgen\world_preset\single_biome_surface.json
```
...
<details><summary>com.mojang.realmsclient.client.RealmsClient$Environment</summary>
...
```diff
+ Button inviteButton
+ Component INVITING_PLAYER_TEXT
+ Component message
- Component errorMsg
+ RealmsServer lambda$onInvite$5(String)
+ Style lambda$static$0(Style)
+ Style lambda$static$1(Style)
+ Style lambda$static$2(Style)
+ void lambda$init$3(Button)
+ void lambda$init$4(Button)
+ void lambda$onInvite$6(RealmsServer)
+ void showMessage(Component)
- void lambda$init$0(Button)
- void lambda$init$1(Button)
- void showError(Component)
```
...
```diff
+ void lambda$renderArmorPiece$0(ArmorTrim)
+ void renderGlint(HumanoidModel)
+ void renderModel(String)
+ void renderTrim(HumanoidModel,boolean)
- void lambda$renderArmorPiece$0(ArmorTrim)
- void renderModel(String)
- void renderTrim(HumanoidModel,boolean,float,float,float)
```
...
```diff
+ void assertRedstoneSignal(Supplier)
```
...
```diff
+ void checkSupportingBlock(Vec3)
+ void setOnGroundWithKnownMovement(Vec3)
...
```diff
+ void sendEffectToPassengers(MobEffectInstance)
...
```diff
+ boolean lambda$getEntityCount$0(Entity)
+ int getEntityCount(Class)
```
