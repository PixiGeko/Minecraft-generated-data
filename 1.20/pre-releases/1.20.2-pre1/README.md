...
<tr><th>SHA1</th><td>39b8ee6bd43752f3b5cf0405acc0ed686991a151</td></tr>
<tr><th>Url</th><td><a href="https://piston-meta.mojang.com/v1/packages/39b8ee6bd43752f3b5cf0405acc0ed686991a151/1.20.2-pre1.json">https://piston-meta.mojang.com/v1/packages/39b8ee6bd43752f3b5cf0405acc0ed686991a151/1.20.2-pre1.json</a></td></tr>
<tr><th>Asset index</th><td><a href="https://piston-meta.mojang.com/v1/packages/8e1a7019b9bd346efacc9dcba4977d1453e355e5/7.json">https://piston-meta.mojang.com/v1/packages/8e1a7019b9bd346efacc9dcba4977d1453e355e5/7.json</a></td></tr>
...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/23w35a">23w35a</a>
## File structure

<details><summary>data/</summary>

```diff
+  minecraft/datapacks/trade_rebalance/data
+  minecraft/datapacks/trade_rebalance/data/minecraft
+  minecraft/datapacks/trade_rebalance/data/minecraft/loot_tables
+  minecraft/datapacks/trade_rebalance/data/minecraft/loot_tables/chests
...
```diff
+ boolean lambda$updateCollections$4(String)
+ boolean lambda$updateCollections$5(RecipeHolder)
+ boolean lambda$updateCollections$6(RecipeCollection)
+ boolean lambda$updateCollections$8(RecipeCollection)
+ int lambda$updateCollections$7(RecipeCollection)
+ void lambda$updateCollections$1(RecipeCollection)
+ void lambda$updateNarration$9(AbstractWidget)
- boolean lambda$updateCollections$4(RecipeCollection)
- boolean lambda$updateCollections$5(RecipeCollection)
- void lambda$updateCollections$1(RecipeCollection)
- void lambda$updateNarration$6(AbstractWidget)
```
...
```diff
+ void canCraft(RecipeBook,boolean)
- void canCraft(RecipeBook)
```
...
<details><summary>net.minecraft.client.searchtree.SearchRegistry</summary>

```diff
- SearchRegistry$Key RECIPE_COLLECTIONS
```
...
<details><summary>net.minecraft.commands.CommandFunction$CommandMacro</summary>
...
```diff
+ CommandSourceStack withSigningContext(TaskChainer)
...
<details><summary>net.minecraft.world.entity.npc.VillagerTrades$ItemsForEmeralds</summary>
...
<details><summary>net.minecraft.world.entity.npc.VillagerTrades$TypeSpecificTrade</summary>
...
+ Map trades()
+ String toString()
+ VillagerTrades$ItemListing lambda$oneTradeInBiomes$1(VillagerType)
+ VillagerTrades$TypeSpecificTrade oneTradeInBiomes(VillagerType[])
+ VillagerType lambda$oneTradeInBiomes$0(VillagerType)
- boolean lambda$new$0(VillagerType)
...
```diff
+ HumanoidArm DEFAULT_MAIN_HAND
+ int DEFAULT_MODEL_CUSTOMIZATION
```
...
```diff
+ GameRules$Key RULE_ENDER_PEARLS_VANISH_ON_DEATH
+ GameRules$Value lambda$copy$7(Map$Entry)
+ GameRules$Value lambda$new$4(Map$Entry)
+ void lambda$assignFrom$9(GameRules$Key)
+ void lambda$createTag$5(GameRules$Value)
+ void lambda$loadFromTag$6(GameRules$Value)
+ void lambda$static$3(GameRules$BooleanValue)
+ void lambda$visitGameRuleTypes$8(GameRules$Type)
- GameRules$Value lambda$copy$6(Map$Entry)
- GameRules$Value lambda$new$3(Map$Entry)
- void lambda$assignFrom$8(GameRules$Key)
- void lambda$createTag$4(GameRules$Value)
...
```diff
+ boolean DEBUG_UNLOCK_ALL_TRADES
```
...
```diff
+ ClientboundGameEventPacket$Type LIMITED_CRAFTING
```
...
```diff
- void handleClientInformation(net.minecraft.network.protocol.game.ServerboundClientInformationPacket)
```
