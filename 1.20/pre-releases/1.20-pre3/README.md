...
<tr><th>SHA1</th><td>7c664c69aa55909d6fa3850e507b8c4012469844</td></tr>
<tr><th>Url</th><td><a href="https://piston-meta.mojang.com/v1/packages/7c664c69aa55909d6fa3850e507b8c4012469844/1.20-pre3.json">https://piston-meta.mojang.com/v1/packages/7c664c69aa55909d6fa3850e507b8c4012469844/1.20-pre3.json</a></td></tr>
...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/1.20-pre2">1.20-pre2</a>
## Misc
...
<details><summary>net.minecraft.world.entity.Interaction</summary>
...
```diff
+ void sendEffectToRider(MobEffectInstance)
```
...
<details><summary>net.minecraft.network.protocol.game.ClientboundPlayerCombatEndPacket</summary>
...
<details><summary>net.minecraft.network.protocol.game.ClientboundPlayerCombatKillPacket</summary>
...
<details><summary>net.minecraft.network.protocol.status.ServerStatus$Favicon</summary>
...
<details><summary>net.minecraft.world.damagesource.CombatEntry</summary>
...
+ int hashCode()
+ String toString()
+ void <init>(FallLocation,float)
- boolean isCombatRelated()
- Component getAttackerName()
...
```diff
- String nextLocation
+ boolean shouldEnterCombat(DamageSource)
+ Component getDisplayName(Entity)
+ Component getFallMessage(Entity)
+ Component getMessageForAssistedFall(String)
+ void recordDamage(DamageSource,float)
- boolean isInCombat()
- boolean isTakingDamage()
- CombatEntry getLastEntry()
- int getKillerId()
- LivingEntity getKiller()
- LivingEntity getMob()
- String getFallLocation(CombatEntry)
- void prepareForDamage()
- void recordDamage(DamageSource,float,float)
