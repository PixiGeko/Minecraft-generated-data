...
<br/>
<table><tr><th></th><th align="left">1.20-pre2</th><th>1.20-pre3</th></tr><tr><td>World version</td><td><pre>3455</pre></td><td><pre>3456</pre></td></tr><tr><td>Protocol version</td><td><pre>1073741959</pre></td><td><pre>1073741960</pre></td></tr></table>
</details>
<hr/>
...
<br/>
<table>
<tr><th>Name</th><th>1.20-pre2</th><th>1.20-pre3</th></tr>
<tr><th align="left"><div style="width:290px">commands.banlist.list</div></th><td>There is/are %s ban(s):</td><td>There are %s ban(s):</td></tr>
<tr><th align="left"><div style="width:290px">commands.bossbar.list.bars.some</div></th><td>There is/are %s custom bossbar(s) active: %s</td><td>There are %s custom bossbar(s) active: %s</td></tr>
<tr><th align="left"><div style="width:290px">commands.datapack.list.available.success</div></th><td>There is/are %s data pack(s) available: %s</td><td>There are %s data pack(s) available: %s</td></tr>
<tr><th align="left"><div style="width:290px">commands.datapack.list.enabled.success</div></th><td>There is/are %s data pack(s) enabled: %s</td><td>There are %s data pack(s) enabled: %s</td></tr>
<tr><th align="left"><div style="width:290px">commands.scoreboard.objectives.list.success</div></th><td>There is/are %s objective(s): %s</td><td>There are %s objective(s): %s</td></tr>
<tr><th align="left"><div style="width:290px">commands.scoreboard.players.list.success</div></th><td>There is/are %s tracked entity/entities: %s</td><td>There are %s tracked entity/entities: %s</td></tr>
<tr><th align="left"><div style="width:290px">commands.team.list.teams.success</div></th><td>There is/are %s team(s): %s</td><td>There are %s team(s): %s</td></tr>
<tr><th align="left"><div style="width:290px">commands.whitelist.list</div></th><td>There is/are %s whitelisted player(s): %s</td><td>There are %s whitelisted player(s): %s</td></tr>
<tr><th align="left"><div style="width:290px">key.keyboard.unknown</div></th><td>Not bound</td><td>Not Bound</td></tr>
<tr><th align="left"><div style="width:290px">mco.errorMessage.generic</div></th><td>An error occured: </td><td>An error occurred: </td></tr>
<tr><th align="left"><div style="width:290px">mco.errorMessage.realmsService</div></th><td>An error occured (%s):</td><td>An error occurred (%s):</td></tr>
</table>
<br/>
</details>
</details>
