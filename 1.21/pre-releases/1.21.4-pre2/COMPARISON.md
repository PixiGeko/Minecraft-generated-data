## Comparison with [1.21.4-pre1](https://github.com/PixiGeko/Minecraft-generated-data/tree/1.21.4-pre1)
...
<br/>
<table><tr><th></th><th align="left">1.21.4-pre1</th><th>1.21.4-pre2</th></tr><tr><td>DataPack version</td><td><pre>60</pre></td><td><pre>61</pre></td></tr><tr><td>World version</td><td><pre>4179</pre></td><td><pre>4182</pre></td></tr><tr><td>Protocol version</td><td><pre>1073742047</pre></td><td><pre>1073742048</pre></td></tr></table>
</details>
<hr/>
...
```
XXX.data.tags.VanillaItemTagsProvider +2M -1M
```
```
...
```diff
- ResourceLocation lambda$addTags$0(Holder$Reference)
+ void lambda$addTags$0(Holder$Reference)
- void lambda$addTags$1(Holder$Reference)
```
...
```diff
+ void doCheckFallDamage(double,double,double,boolean)
```
