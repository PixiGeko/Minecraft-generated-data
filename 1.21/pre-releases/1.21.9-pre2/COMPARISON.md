## Comparison with [1.21.9-pre1](https://github.com/PixiGeko/Minecraft-generated-data/tree/1.21.9-pre1)
...
<br/>
<table><tr><th></th><th align="left">1.21.9-pre1</th><th>1.21.9-pre2</th></tr><tr><td>DataPack version</td><td><pre>{
  "major": 87,
  "minor": 1
}</pre></td><td><pre>{
  "major": 88,
  ...
  "major": 69,
  "minor": 0
}</pre></td></tr><tr><td>World version</td><td><pre>4549</pre></td><td><pre>4550</pre></td></tr><tr><td>Protocol version</td><td><pre>1073742093</pre></td><td><pre>1073742094</pre></td></tr></table>
</details>
<hr/>
...
```
```
XXX.server.jsonrpc.OutgoingRpcMethod +4M -3M
```
...
```diff
+ OutgoingRpcMethod$Method lambda$request$2(Codec,Codec,MethodInfo,OutgoingRpcMethod$Attributes)
- OutgoingRpcMethod$Method lambda$request$3(Codec,Codec,MethodInfo,OutgoingRpcMethod$Attributes)
+ OutgoingRpcMethod$Notification lambda$notification$0(Codec,MethodInfo,OutgoingRpcMethod$Attributes)
- OutgoingRpcMethod$Notification lambda$notification$1(Codec,MethodInfo,OutgoingRpcMethod$Attributes)
+ OutgoingRpcMethod$ParameterlessMethod lambda$request$1(Codec,MethodInfo,OutgoingRpcMethod$Attributes)
- OutgoingRpcMethod$ParameterlessMethod lambda$request$2(Codec,MethodInfo,OutgoingRpcMethod$Attributes)
- OutgoingRpcMethod$ParmeterlessNotification lambda$notification$0(MethodInfo,OutgoingRpcMethod$Attributes)
```
