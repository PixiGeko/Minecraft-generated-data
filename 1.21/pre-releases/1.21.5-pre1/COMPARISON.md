## Comparison with [25w10a](https://github.com/PixiGeko/Minecraft-generated-data/tree/25w10a)
...
<br/>
<table><tr><th></th><th align="left">25w10a</th><th>1.21.5-pre1</th></tr><tr><td>ResourcePack version</td><td><pre>54</pre></td><td><pre>55</pre></td></tr><tr><td>World version</td><td><pre>4319</pre></td><td><pre>4320</pre></td></tr><tr><td>Protocol version</td><td><pre>1073742062</pre></td><td><pre>1073742063</pre></td></tr></table>
</details>
<hr/>
...
```
XXX.commands.arguments.ParticleArgument +1M -1M | +1P -1P
```
```
XXX.commands.arguments.StyleArgument +1P
```
```
XXX.core.component.DataComponentPatch +1M | +1P
```
```
XXX.network.chat.PlayerChatMessage +2M
```
```
XXX.network.codec.ByteBufCodecs$26 +3M -4M | +2P -2P
```
```
XXX.network.codec.ByteBufCodecs$28 +4M -3M | +2P -2P
```
```
XXX.network.codec.ByteBufCodecs$31 +5M -1M | -1P
```
```
XXX.world.item.ItemStack$1 +1M -1M | +1P
```
```
XXX.block.entity.BlockEntity +3M -2M
```
...
- ParticleOptions readParticle(TagParser,StringReader,ParticleType,HolderLookup$Provider)
```
...
```diff
- StreamCodec createStreamCodec(DataComponentPatch$CodecGetter)
```
...
```diff
- String describeSigned(PlayerChatMessage)
- String lambda$describeSigned$6(MessageSignature)
```
...
```diff
- BlockPos getPosFromTag(ChunkPos,CompoundTag)
+ BlockPos getPosFromTag(CompoundTag)
- String lambda$fillCrashReportCategory$0()
+ void lambda$parseCustomNameSafe$0(String)
- void lambda$parseCustomNameSafe$1(String)
```
...
```
```
XXX.blaze3d.systems.RenderSystem -1M | +1P
```
```
XXX.blaze3d.systems.RenderSystem$AutoStorageIndexBuffer +2M -3M
```
```
XXX.blaze3d.textures.GpuTexture +1P
```
```
net.minecraft.CrashReportCategory +2M -1M
```
```
XXX.data.models.BlockModelGenerators +59M -51M | +8P
```
```
XXX.renderer.entity.EnderDragonRenderer +2M
```
```
XXX.renderer.entity.EntityRenderer +4M
```
```
XXX.minecraft.nbt.TagParser +2M -1M | +1P
```
```
XXX.minecraft.network.SkipPacketException -1M
```
```
XXX.network.chat.LastSeenMessages +1M
```
```
XXX.network.chat.LastSeenMessages$Update +3M -1M | +2P
```
```
XXX.network.protocol.ProtocolInfoBuilder$1 +2M -3M | +2P -2P
```
```
XXX.protocol.game.ClientboundContainerSetContentPacket +8M -7M
```
```
XXX.protocol.game.GameProtocols +2M -1M | +3P -2P
```
```
XXX.protocol.game.ServerboundContainerClickPacket +11M -10M | +3P -3P
```
```
XXX.world.inventory.AbstractContainerMenu +6M -5M | +1P -1P
```
```
XXX.world.inventory.ClickType +2M -1M | +3P
```
```
XXX.world.inventory.ContainerSynchronizer +2P -1P
```
...
- String lambda$populateBlockLocationDetails$0(LevelHeightAccessor,BlockPos)
```
...
```diff
- ConditionBuilder lambda$static$1(ConditionBuilder)
- ConditionBuilder lambda$static$2(ConditionBuilder)
- ConditionBuilder lambda$static$3(ConditionBuilder)
- ConditionBuilder lambda$static$4(ConditionBuilder)
- ConditionBuilder lambda$static$5(ConditionBuilder)
- ConditionBuilder lambda$static$6(ConditionBuilder)
- ConditionBuilder lambda$static$7(ConditionBuilder)
- ConditionBuilder lambda$static$8(ConditionBuilder)
...
- MultiVariant lambda$createActiveRail$20(MultiVariant,MultiVariant,MultiVariant,MultiVariant,MultiVariant,MultiVariant,Boolean,RailShape)
- MultiVariant lambda$createBrushableBlock$15(Block,Integer)
...
- MultiVariant lambda$createCalibratedSculkSensor$36(MultiVariant,MultiVariant,SculkSensorPhase)
+ MultiVariant lambda$createCopperBulb$21(MultiVariant,MultiVariant,MultiVariant,MultiVariant,Boolean,Boolean)
- MultiVariant lambda$createCopperBulb$29(MultiVariant,MultiVariant,MultiVariant,MultiVariant,Boolean,Boolean)
+ MultiVariant lambda$createCropBlock$18(int[],Int2ObjectMap,Block,Integer)
- MultiVariant lambda$createCropBlock$26(int[],Int2ObjectMap,Block,Integer)
- MultiVariant lambda$createCrossBlock$17(int[],Block,BlockModelGenerators$PlantType,Integer)
...
- MultiVariant lambda$createEmptyOrFullDispatch$24(Comparable,MultiVariant,MultiVariant,Comparable)
...
- MultiVariant lambda$createMangrovePropagule$30(Block,MultiVariant,Boolean,Integer)
+ MultiVariant lambda$createPitcherCrop$11(Block,Integer,DoubleBlockHalf)
- MultiVariant lambda$createPitcherCrop$19(Block,Integer,DoubleBlockHalf)
+ MultiVariant lambda$createRepeater$29(Integer,Boolean,Boolean)
- MultiVariant lambda$createRepeater$37(Integer,Boolean,Boolean)
...
- MultiVariant lambda$createSculkSensor$35(MultiVariant,MultiVariant,SculkSensorPhase)
...
- MultiVariant lambda$createSnowBlocks$38(MultiVariant,Integer)
+ MultiVariant lambda$createStems$10(Block,TextureMapping,Integer)
- MultiVariant lambda$createStems$18(Block,TextureMapping,Integer)
+ MultiVariant lambda$createStructureBlock$31(StructureMode)
- MultiVariant lambda$createStructureBlock$39(StructureMode)
+ MultiVariant lambda$createSweetBerryBush$33(Integer)
- MultiVariant lambda$createSweetBerryBush$41(Integer)
+ MultiVariant lambda$createTestBlock$32(Map,TestBlockMode)
- MultiVariant lambda$createTestBlock$40(Map,TestBlockMode)
...
- MultiVariant lambda$createTrialSpawner$33(MultiVariant,MultiVariant,MultiVariant,MultiVariant,MultiVariant,MultiVariant,TrialSpawnerState,Boolean)
+ MultiVariant lambda$createTripwireHook$34(Boolean,Boolean)
- MultiVariant lambda$createTripwireHook$42(Boolean,Boolean)
+ MultiVariant lambda$createTurtleEgg$35(Integer,Integer)
- MultiVariant lambda$createTurtleEgg$43(Integer,Integer)
...
- MultiVariant lambda$createVault$34(MultiVariant,MultiVariant,MultiVariant,MultiVariant,MultiVariant,MultiVariant,MultiVariant,MultiVariant,VaultState,Boolean)
...
- ResourceLocation lambda$createCropBlock$25(Block,int)
+ TextureMapping lambda$createChorusFlower$20(TextureMapping,ResourceLocation)
- TextureMapping lambda$createChorusFlower$28(TextureMapping,ResourceLocation)
+ TextureMapping lambda$createCommandBlock$13(TextureMapping,ResourceLocation)
- TextureMapping lambda$createCommandBlock$21(TextureMapping,ResourceLocation)
+ void createSegmentedBlock(Block,IntegerProperty,MultiVariant,MultiVariant,MultiVariant,MultiVariant)
- void createSegmentedBlock(Block,MultiVariant,Function,MultiVariant,Function,MultiVariant,Function,MultiVariant,Function)
...
- void lambda$createBarrel$23(ResourceLocation,TextureMapping)
...
- void lambda$createCreakingHeartModel$16(Block,String,TextureMapping)
...
- void lambda$createFurnace$27(ResourceLocation,TextureMapping)
...
+ void lambda$createMossyCarpet$41(Block,TextureMapping)
...
- void lambda$static$10(TextureMapping)
- void lambda$static$11(TextureMapping)
- void lambda$static$12(TextureMapping)
- void lambda$static$13(TextureMapping)
- void lambda$static$14(TextureMapping)
+ void lambda$static$2(TextureMapping)
+ void lambda$static$3(TextureMapping)
+ void lambda$static$4(TextureMapping)
+ void lambda$static$5(TextureMapping)
+ void lambda$static$6(TextureMapping)
+ Weighted lambda$createBambooModels$14(String,int)
- Weighted lambda$createBambooModels$22(String,int)
+ Weighted lambda$variants$1(Variant)
- Weighted lambda$variants$9(Variant)
```
...
```diff
- void extractAdditionalHitboxes(EnderDragon,ImmutableList$Builder,float)
- void extractAdditionalHitboxes(Entity,ImmutableList$Builder,float)
```
...
```diff
- Entity getServerSideEntity(Entity)
- HitboxesRenderState extractHitboxes(Entity,float,boolean)
- void extractAdditionalHitboxes(Entity,ImmutableList$Builder,float)
- void extractHitboxes(Entity,EntityRenderState,float)
```
...
```diff
- boolean verifyChecksum(LastSeenMessages)
- byte checksum()
- void <init>(int,BitSet,byte)
...
```diff
+ ProtocolInfo bind(Function)
- void <init>(ConnectionProtocol,PacketFlow,List)
+ void <init>(ProtocolInfoBuilder,List,BundlerInfo)
- void listPackets(ProtocolInfo$Details$PacketVisitor)
+ void listPackets(ProtocolInfo$Unbound$PacketVisitor)
```
...
- List items()
- String toString()
- void <init>(int,int,List,ItemStack)
...
```diff
- StreamCodec lambda$static$0(StreamCodec,GameProtocols$Context)
+ void lambda$static$0(ProtocolInfoBuilder)
...
- void <init>(int,int,short,byte,ClickType,Int2ObjectMap,HashedStack)
+ void <init>(RegistryFriendlyByteBuf)
+ void write(RegistryFriendlyByteBuf)
```
...
```diff
- RemoteSlot lambda$setSynchronizer$1(ContainerSynchronizer,RemoteSlot)
+ String lambda$clicked$1()
- String lambda$clicked$3()
+ void lambda$doClick$3(Slot,Player,ItemStack)
+ void lambda$doClick$4(ItemStack,Slot,Player,ItemStack)
- void lambda$doClick$4(Slot,Player,ItemStack)
- void lambda$doClick$5(ItemStack,Slot,Player,ItemStack)
- void setRemoteCarried(HashedStack)
+ void setRemoteCarried(ItemStack)
+ void setRemoteSlotNoCopy(int,ItemStack)
- void setRemoteSlotUnsafe(int,HashedStack)
```
