## Comparison with [1.21.11-pre2](https://github.com/PixiGeko/Minecraft-generated-data/tree/1.21.11-pre2)
...
<br/>
<table><tr><th></th><th align="left">1.21.11-pre2</th><th>1.21.11-pre3</th></tr><tr><td>DataPack version</td><td><pre>{
  "major": 94,
  "minor": 0
}</pre></td><td><pre>{
  "major": 94,
  ...
  "major": 75,
  "minor": 0
}</pre></td></tr><tr><td>World version</td><td><pre>4664</pre></td><td><pre>4665</pre></td></tr><tr><td>Protocol version</td><td><pre>1073742104</pre></td><td><pre>1073742105</pre></td></tr></table>
</details>
<hr/>
...
```
XXX.world.entity.LivingEntity +2M -1M | +1P -1P
```
```
XXX.animal.nautilus.ZombieNautilus +1M
```
```
XXX.item.component.KineticWeapon +2M -2M | +1P
```
...
- float getTicksSinceLastKineticHitFeedback(float)
- void onKineticHit()
```
...
```diff
+ void lambda$makeHitSound$2(Entity,Holder)
- void lambda$makeLocalHitSound$2(Entity,Holder)
+ void makeHitSound(Entity)
- void makeLocalHitSound(Entity)
```
...
- XXX.renderer.special.CopperGolemStatueSpecialRenderer$1
...
```
XXX.mojang.blaze3d.TracyFrameCapture +1P -1P
```
```
XXX.blaze3d.buffers.GpuBufferSlice +4M -4M | +2P -2P
```
```
XXX.blaze3d.opengl.BufferStorage +2P -2P
```
```
XXX.blaze3d.opengl.BufferStorage$Mutable +2M -2M
```
```
XXX.blaze3d.opengl.DirectStateAccess$Core +4M -4M
```
```
XXX.blaze3d.opengl.GlBuffer +1M -1M
```
```
XXX.blaze3d.opengl.GlCommandEncoder +2M -2M
```
```
XXX.blaze3d.opengl.GlDevice +1M -1M
```
```
XXX.blaze3d.platform.Lighting +1P -1P
```
```
XXX.blaze3d.systems.GpuDevice +1P -1P
```
```
XXX.minecraft.client.Options +101M -99M
```
```
...
- GpuBufferSlice slice(long,long)
+ int length()
+ int offset()
- long length()
- long offset()
+ void <init>(GpuBuffer,int,int)
- void <init>(GpuBuffer,long,long)
```
...
```diff
+ GlBuffer createBuffer(DirectStateAccess,Supplier,int,int)
- GlBuffer createBuffer(DirectStateAccess,Supplier,int,long)
+ GlBuffer$GlMappedView mapBuffer(DirectStateAccess,GlBuffer,int,int,int)
- GlBuffer$GlMappedView mapBuffer(DirectStateAccess,GlBuffer,long,long,int)
```
...
- ByteBuffer mapBufferRange(int,long,long,int,int)
+ void bufferSubData(int,int,ByteBuffer,int)
- void bufferSubData(int,long,ByteBuffer,int)
+ void copyBufferSubData(int,int,int,int,int)
- void copyBufferSubData(int,int,long,long,long)
+ void flushMappedBufferRange(int,int,int,int)
- void flushMappedBufferRange(int,long,long,int)
```
...
```diff
+ void <init>(Supplier,DirectStateAccess,int,int,int,ByteBuffer)
- void <init>(Supplier,DirectStateAccess,int,long,int,ByteBuffer)
```
...
```diff
+ void copyTextureToBuffer(GpuTexture,GpuBuffer,int,Runnable,int,int,int,int,int)
+ void copyTextureToBuffer(GpuTexture,GpuBuffer,int,Runnable,int)
- void copyTextureToBuffer(GpuTexture,GpuBuffer,long,Runnable,int,int,int,int,int)
- void copyTextureToBuffer(GpuTexture,GpuBuffer,long,Runnable,int)
```
...
```diff
+ GpuBuffer createBuffer(Supplier,int,int)
- GpuBuffer createBuffer(Supplier,int,long)
```
...
- Component lambda$new$101(Component,Boolean)
+ Component lambda$new$108(Component,Double)
- Component lambda$new$109(Component,Double)
+ Component lambda$new$110(Component,Integer)
- Component lambda$new$111(Component,Integer)
+ Component lambda$new$113(Component,ParticleStatus)
- Component lambda$new$114(Component,ParticleStatus)
+ Component lambda$new$115(Component,NarratorStatus)
- Component lambda$new$116(Component,NarratorStatus)
+ Component lambda$new$117(Component,String)
- Component lambda$new$118(Component,String)
+ Component lambda$new$121(Component,MusicManager$MusicFrequency)
- Component lambda$new$122(Component,MusicManager$MusicFrequency)
+ Component lambda$new$124(Component,MusicToastDisplayState)
- Component lambda$new$125(Component,MusicToastDisplayState)
+ Component lambda$new$126(Component,Integer)
- Component lambda$new$127(Component,Integer)
+ Component lambda$new$128(Component,Integer)
- Component lambda$new$129(Component,Integer)
+ Component lambda$new$18(Component,Integer)
- Component lambda$new$19(Component,Integer)
...
- Component lambda$new$29(Component,PrioritizeChunkUpdates)
+ Component lambda$new$30(Component,ChatVisiblity)
- Component lambda$new$31(Component,ChatVisiblity)
+ Component lambda$new$32(Component,Double)
- Component lambda$new$33(Component,Double)
+ Component lambda$new$39(Component,HumanoidArm)
- Component lambda$new$40(Component,HumanoidArm)
...
- Component lambda$new$90(Component,Boolean)
+ Component lambda$new$91(Component,Boolean)
- Component lambda$new$92(Component,Boolean)
