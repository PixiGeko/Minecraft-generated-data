...
<br/>
<table><tr><th></th><th align="left">24w21b</th><th>1.21-pre1</th></tr><tr><td>DataPack version</td><td><pre>45</pre></td><td><pre>46</pre></td></tr><tr><td>World version</td><td><pre>3947</pre></td><td><pre>3948</pre></td></tr><tr><td>Protocol version</td><td><pre>1073742022</pre></td><td><pre>1073742023</pre></td></tr></table>
</details>
<hr/>
...
<table><tr><th></th><th align="left">24w21b</th><th>1.21-pre1</th></tr><tr><td>minecraft:attribute_modifiers</td><td><pre>{
  "modifiers": [
    {
...
<br/>
<table>
<tr><th>Name</th><th>24w21b</th><th>1.21-pre1</th></tr>
<tr><th align="left"><div style="width:290px">chat.disabled.profile</div></th><td>Chat not allowed by account settings. Press '%s' again for more information.</td><td>Chat is not allowed by account settings. Press '%s' again for more information.</td></tr>
<tr><th align="left"><div style="width:290px">chat.disabled.profile.moreInfo</div></th><td>Chat not allowed by account settings. Cannot send or view messages.</td><td>Chat is not allowed by account settings. Cannot send or view messages.</td></tr>
<tr><th align="left"><div style="width:290px">download.pack.failed</div></th><td>%s out of %s packs failed to download</td><td>%s out of %s pack(s) failed to download</td></tr>
<tr><th align="left"><div style="width:290px">gamerule.doVinesSpread.description</div></th><td>Controls whether or not the Vines block spreads randomly to adjacent blocks. Does not affect other type of vine blocks such as Weeping Vines, Twisting Vines, etc.</td><td>Controls whether or not the Vines block spreads randomly to adjacent blocks. Does not affect other types of vine blocks such as Weeping Vines, Twisting Vines, etc.</td></tr>
<tr><th align="left"><div style="width:290px">gamerule.enderPearlsVanishOnDeath</div></th><td>Thrown ender pearls vanish on death</td><td>Thrown Ender Pearls vanish on death</td></tr>
<tr><th align="left"><div style="width:290px">gamerule.enderPearlsVanishOnDeath.description</div></th><td>Whether ender pearls thrown by a player vanish when that player dies.</td><td>Whether Ender Pearls thrown by a player vanish when that player dies.</td></tr>
<tr><th align="left"><div style="width:290px">gamerule.entitiesWithPassengersCanUsePortals.description</div></th><td>Allow entities with passengers to teleport through nether portals, end portals and end gateways.</td><td>Allow entities with passengers to teleport through Nether Portals, End Portals, and End Gateways.</td></tr>
<tr><th align="left"><div style="width:290px">key.swapOffhand</div></th><td>Swap Item With Offhand</td><td>Swap Item With Off Hand</td></tr>
<tr><th align="left"><div style="width:290px">mco.compatibility.downgrade.description</div></th><td>This world was last played in version %s; you are on version %s. Downgrading a world could cause corruption - we cannot guarantee that it will load or work.



A backup of your world will be saved under "World backups". Please restore your world if needed.</td><td>This world was last played in version %s; you are on version %s. Downgrading a world could cause corruption - we cannot guarantee that it will load or work.



A backup of your world will be saved under "World Backups". Please restore your world if needed.</td></tr>
<tr><th align="left"><div style="width:290px">mco.compatibility.unverifiable.message</div></th><td>The version this world was last played in could not be verified. If the world gets upgraded or downgraded, a backup will be automatically created and saved under "World backups".</td><td>The version this world was last played in could not be verified. If the world gets upgraded or downgraded, a backup will be automatically created and saved under "World Backups".</td></tr>
<tr><th align="left"><div style="width:290px">mco.notification.visitUrl.buttonText.default</div></th><td>Open link</td><td>Open Link</td></tr>
<tr><th align="left"><div style="width:290px">options.accessibility.high_contrast.error.tooltip</div></th><td>High Contrast resource pack is not available</td><td>High Contrast resource pack is not available.</td></tr>
<tr><th align="left"><div style="width:290px">options.accessibility.high_contrast.tooltip</div></th><td>Enhances the contrast of UI elements</td><td>Enhances the contrast of UI elements.</td></tr>
<tr><th align="left"><div style="width:290px">options.accessibility.menu_background_blurriness.tooltip</div></th><td>Changes the blurriness of menu backgrounds</td><td>Changes the blurriness of menu backgrounds.</td></tr>
...
<tr><th align="left"><div style="width:290px">options.japaneseGlyphVariants.tooltip</div></th><td>Uses Japanese variants of CJK characters in the default font</td><td>Uses Japanese variants of CJK characters in the default font.</td></tr>
<tr><th align="left"><div style="width:290px">options.modelPart.left_pants_leg</div></th><td>Left Pants Leg</td><td>Left Pant Leg</td></tr>
<tr><th align="left"><div style="width:290px">options.modelPart.right_pants_leg</div></th><td>Right Pants Leg</td><td>Right Pant Leg</td></tr>
<tr><th align="left"><div style="width:290px">selectWorld.experimental.details.title</div></th><td>Experimental feature requirements</td><td>Experimental Feature Requirements</td></tr>
<tr><th align="left"><div style="width:290px">subtitles.block.vault.insert_item_fail</div></th><td>Vault fails unlocking</td><td>Vault rejects item</td></tr>
<tr><th align="left"><div style="width:290px">subtitles.block.vault.reject_rewarded_player</div></th><td>Vault rejects already rewarded player</td><td>Vault rejects player</td></tr>
</table>
<br/>
</details>
</details>
...
- XXX.resources.model.BlockStateModelLoader$LoadedJson
- XXX.resources.model.BlockStateModelLoader$ModelGroupKey
