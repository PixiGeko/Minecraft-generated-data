## Comparison with [24w40a](https://github.com/PixiGeko/Minecraft-generated-data/tree/24w40a)
...
<br/>
<table><tr><th></th><th align="left">24w40a</th><th>1.21.2-pre1</th></tr><tr><td>DataPack version</td><td><pre>56</pre></td><td><pre>57</pre></td></tr><tr><td>ResourcePack version</td><td><pre>40</pre></td><td><pre>41</pre></td></tr><tr><td>World version</td><td><pre>4072</pre></td><td><pre>4073</pre></td></tr><tr><td>Protocol version</td><td><pre>1073742036</pre></td><td><pre>1073742037</pre></td></tr></table>
<h3>Libraries<a name="version-data-libraries"></a></h3>
<details>
<summary>
Versions
</summary>
<table><tr><th></th><th align="left">24w40a</th><th>1.21.2-pre1</th></tr><tr><td>com.mojang:logging</td><td><pre>1.3.8</pre></td><td><pre>1.4.9</pre></td></tr></table>
</details>
</details>
<hr/>
...
```diff
+ universal_tags/recipe_book_category.json
```
...
<table><tr><th></th><th align="left">24w40a</th><th>1.21.2-pre1</th></tr><tr><td>minecraft:equippable</td><td><pre>{
  "slot": "head",
  "swappable": false
}</pre></td><td><pre>{
...
<table><tr><th></th><th align="left">24w40a</th><th>1.21.2-pre1</th></tr><tr><td>minecraft:damage</td><td><pre>0</pre></td><td><pre>/</pre></td></tr><tr><td>minecraft:max_damage</td><td><pre>528</pre></td><td><pre>/</pre></td></tr><tr><td>minecraft:repairable</td><td><pre>{
...
<table><tr><th></th><th align="left">24w40a</th><th>1.21.2-pre1</th></tr><tr><td>minecraft:damage</td><td><pre>0</pre></td><td><pre>/</pre></td></tr><tr><td>minecraft:max_damage</td><td><pre>112</pre></td><td><pre>/</pre></td></tr><tr><td>minecraft:repairable</td><td><pre>{
...
<table><tr><th></th><th align="left">24w40a</th><th>1.21.2-pre1</th></tr><tr><td>minecraft:damage</td><td><pre>0</pre></td><td><pre>/</pre></td></tr><tr><td>minecraft:max_damage</td><td><pre>240</pre></td><td><pre>/</pre></td></tr><tr><td>minecraft:repairable</td><td><pre>{
...
<table><tr><th></th><th align="left">24w40a</th><th>1.21.2-pre1</th></tr><tr><td>minecraft:damage</td><td><pre>0</pre></td><td><pre>/</pre></td></tr><tr><td>minecraft:max_damage</td><td><pre>80</pre></td><td><pre>/</pre></td></tr><tr><td>minecraft:repairable</td><td><pre>{
...
```
XXX.core.particles.DustColorTransitionOptions +5M -5M | +3P -3P
```
```
XXX.data.loot.LootTableProvider$SubProviderEntry +2M -2M | +1P -1P
```
```
XXX.item.crafting.BlastingRecipe +1M -1M
```
```
XXX.item.crafting.CraftingRecipe +1M -1M
```
```
XXX.item.crafting.RecipeBookCategory +1M
```
```
XXX.item.crafting.StonecutterRecipe +1M -1M
```
```
XXX.crafting.display.SlotDisplay$AnyFuel +1M -1M
```
```
XXX.crafting.display.SlotDisplay$Empty +1M -1M
```
```
XXX.crafting.display.SlotDisplay$SmithingTrimDemoSlotDisplay +10M -2M | +3P -1P
```
```
XXX.crafting.display.SmithingRecipeDisplay +4M -1M | +3P
```
```
XXX.item.enchantment.ConditionalEffect +4M -4M
```
```
XXX.item.equipment.Equippable +2M -1M | +1P
```
```
XXX.level.block.CreakingHeartBlock +2M
```
```
XXX.level.block.HangingMossBlock +1M
```
```
XXX.level.block.RedStoneWireBlock +2M -2M | +1P -1P
```
```
XXX.block.entity.CreakingHeartBlockEntity +3M | +3P -2P
```
```
XXX.storage.loot.LootContext +3M -3M
```
```
XXX.storage.loot.LootContext$EntityTarget +2M -2M | +1P -1P
```
```
XXX.storage.loot.LootParams$Builder +5M -5M | +1P -1P
```
```
XXX.storage.loot.LootTable +3M -3M | +2P -2P
```
```
XXX.storage.loot.ValidationContext +5M -5M | +1P -1P
```
```
XXX.loot.functions.CopyNameFunction$NameSource +1M -1M | +1P -1P
```
...
```diff
- Integer lambda$static$0(DustColorTransitionOptions)
- Integer lambda$static$1(DustColorTransitionOptions)
- Integer lambda$static$3(DustColorTransitionOptions)
- Integer lambda$static$4(DustColorTransitionOptions)
+ Vector3f lambda$static$0(DustColorTransitionOptions)
+ Vector3f lambda$static$1(DustColorTransitionOptions)
+ Vector3f lambda$static$3(DustColorTransitionOptions)
+ Vector3f lambda$static$4(DustColorTransitionOptions)
- void <init>(int,int,float)
+ void <init>(Vector3f,Vector3f,float)
```
...
- void <init>(Function,ContextKeySet)
+ void <init>(Function,LootContextParamSet)
```
...
<details>
<summary>
net.minecraft.world.item.crafting.display.SlotDisplay$AnyFuel
</summary>

```diff
- Stream resolve(ContextMap,DisplayContentsFactory)
+ void resolve(SlotDisplay$ResolutionContext,SlotDisplay$ResolutionOutput)
```
...
- boolean lambda$resolve$2(ItemStack)
- int hashCode()
- ItemStack lambda$resolve$1(List,RandomSource,List,List,HolderLookup$Provider)
- SlotDisplay base()
- SlotDisplay material()
- SlotDisplay pattern()
- Stream resolve(ContextMap,DisplayContentsFactory)
+ void <init>()
- void <init>(SlotDisplay,SlotDisplay,SlotDisplay)
+ void resolve(SlotDisplay$ResolutionContext,SlotDisplay$ResolutionOutput)
```
...
<details>
<summary>
net.minecraft.world.item.crafting.display.SmithingRecipeDisplay
</summary>
...
- void <init>(SlotDisplay,SlotDisplay,SlotDisplay,SlotDisplay,SlotDisplay)
+ void <init>(SlotDisplay,SlotDisplay)
```
...
```diff
- App lambda$codec$4(Codec,ContextKeySet,RecordCodecBuilder$Instance)
+ App lambda$codec$4(Codec,LootContextParamSet,RecordCodecBuilder$Instance)
- Codec codec(Codec,ContextKeySet)
+ Codec codec(Codec,LootContextParamSet)
- Codec conditionCodec(ContextKeySet)
+ Codec conditionCodec(LootContextParamSet)
- DataResult lambda$conditionCodec$3(ContextKeySet,LootItemCondition)
+ DataResult lambda$conditionCodec$3(LootContextParamSet,LootItemCondition)
```
...
```diff
- Optional cameraOverlay()
+ void <init>(EquipmentSlot,Holder,Optional,Optional,boolean,boolean,boolean)
- void <init>(EquipmentSlot,Holder,Optional,Optional,Optional,boolean,boolean,boolean)
```
...
```diff
- void lambda$static$0(int[])
+ void lambda$static$0(Vector3f[])
- void spawnParticlesAlongLine(Level,RandomSource,BlockPos,int,Direction,Direction,float,float)
...
```diff
- double distanceToCreaking()
- int computeAnalogOutputSignal()
...
```diff
+ boolean hasParam(LootContextParam)
- boolean hasParameter(ContextKey)
- Object getOptionalParameter(ContextKey)
+ Object getParam(LootContextParam)
- Object getParameter(ContextKey)
+ Object getParamOrNull(LootContextParam)
```
...
```diff
- ContextKey getParam()
+ LootContextParam getParam()
- void <init>(String,int,String,ContextKey)
+ void <init>(String,int,String,LootContextParam)
```
...
```diff
- LootParams create(ContextKeySet)
+ LootParams create(LootContextParamSet)
- LootParams$Builder withOptionalParameter(ContextKey,Object)
+ LootParams$Builder withOptionalParameter(LootContextParam,Object)
- LootParams$Builder withParameter(ContextKey,Object)
+ LootParams$Builder withParameter(LootContextParam,Object)
- Object getOptionalParameter(ContextKey)
+ Object getOptionalParameter(LootContextParam)
- Object getParameter(ContextKey)
+ Object getParameter(LootContextParam)
```
...
- ContextKeySet lambda$static$0(LootTable)
+ LootContextParamSet getParamSet()
+ LootContextParamSet lambda$static$0(LootTable)
- void <init>(ContextKeySet,Optional,List,List)
+ void <init>(LootContextParamSet,Optional,List,List)
```
...
```diff
- ValidationContext setContextKeySet(ContextKeySet)
+ ValidationContext setParams(LootContextParamSet)
- void <init>(ProblemReporter,ContextKeySet,HolderGetter$Provider)
- void <init>(ProblemReporter,ContextKeySet,Optional,Set)
- void <init>(ProblemReporter,ContextKeySet)
+ void <init>(ProblemReporter,LootContextParamSet,HolderGetter$Provider)
+ void <init>(ProblemReporter,LootContextParamSet,Optional,Set)
+ void <init>(ProblemReporter,LootContextParamSet)
- void validateContextUsage(LootContextUser)
+ void validateUser(LootContextUser)
```
...
```
XXX.minecraft.client.ClientRecipeBook +6M -5M
```
```
XXX.minecraft.client.MouseHandler +8M -12M
```
```
XXX.client.gui.Gui +11M -5M | +14P -2P
```
```
XXX.font.glyphs.BakedGlyph +1M
```
```
XXX.protocol.game.ClientboundRecipeBookAddPacket +2M -1M | +1P
```
```
...
```
```
XXX.minecraft.util.MemoryReserve -1M
```
```
XXX.entity.projectile.AbstractArrow +1M -1M
```
```
XXX.world.item.BundleItem +2M
```
```
XXX.item.crafting.Ingredient +2M
```
```
XXX.crafting.display.RecipeDisplayEntry +3M -3M | +1P -1P
```
```
XXX.loot.parameters.LootContextParamSets +24M -24M | +23P -23P
```
...
```diff
- List getCollection(ExtendedRecipeBookCategory)
+ List getCollection(RecipeBookCategory)
+ List lambda$categorizeAndGroupRecipes$2(BasicRecipeBookCategory)
- List lambda$categorizeAndGroupRecipes$2(RecipeBookCategory)
+ List lambda$categorizeAndGroupRecipes$3(BasicRecipeBookCategory)
- List lambda$categorizeAndGroupRecipes$3(RecipeBookCategory)
+ Stream lambda$rebuildCollections$1(Map,BasicRecipeBookCategory)
- Stream lambda$rebuildCollections$1(Map,RecipeBookCategory)
- void clear()
+ void lambda$rebuildCollections$0(Map,ImmutableList$Builder,BasicRecipeBookCategory,List)
- void lambda$rebuildCollections$0(Map,ImmutableList$Builder,RecipeBookCategory,List)
```
...
- void lambda$setup$0(long,double,double)
- void lambda$setup$1(long,double,double)
+ void lambda$setup$2(long,double,double)
- void lambda$setup$2(long,int,int,int)
+ void lambda$setup$3(long,double,double)
- void lambda$setup$3(long,int,int,int)
- void lambda$setup$4(long,double,double)
+ void lambda$setup$4(long,int,int,int)
- void lambda$setup$5(long,double,double)
+ void lambda$setup$5(long,int,int,int)
+ void lambda$setup$6(long,double,double)
- void lambda$setup$6(long,List,int)
+ void lambda$setup$7(long,double,double)
- void lambda$setup$7(long,int,long)
+ void lambda$setup$8(long,List,int)
+ void lambda$setup$9(long,int,long)
```
...
```diff
+ boolean lambda$displayScoreboardSidebar$6(PlayerScoreEntry)
- boolean lambda$displayScoreboardSidebar$7(PlayerScoreEntry)
+ Gui$1DisplayEntry lambda$displayScoreboardSidebar$7(Scoreboard,NumberFormat,PlayerScoreEntry)
- Gui$1DisplayEntry lambda$displayScoreboardSidebar$8(Scoreboard,NumberFormat,PlayerScoreEntry)
+ Gui$1DisplayEntry[] lambda$displayScoreboardSidebar$8(int)
- Gui$1DisplayEntry[] lambda$displayScoreboardSidebar$9(int)
- int getAirBubbleYLine(int,int)
- int getCurrentAirSupplyBubble(int,int,int)
- int getEmptyBubbleDelayDuration(int,boolean)
- RenderType lambda$renderConfusionOverlay$10(ResourceLocation)
+ RenderType lambda$renderConfusionOverlay$9(ResourceLocation)
- String lambda$renderCameraOverlays$5(String)
+ void lambda$renderEffects$5(float,GuiGraphics,TextureAtlasSprite,int,int)
- void lambda$renderEffects$6(float,GuiGraphics,TextureAtlasSprite,int,int)
- void playAirBubblePoppedSound(int,Player,int)
- void renderAirBubbles(GuiGraphics,Player,int,int,int)
```
...
```diff
- void renderChar(BakedGlyph$GlyphInstance,Matrix4f,VertexConsumer,int)
```
...
```diff
- SlotDisplay displayForSingleItem(Holder)
- SlotDisplay optionalIngredientToDisplay(Optional)
```
...
```diff
+ BasicRecipeBookCategory category()
- List resultItems(ContextMap)
+ List resultItems(SlotDisplay$ResolutionContext)
- RecipeBookCategory category()
+ void <init>(RecipeDisplayId,RecipeDisplay,OptionalInt,BasicRecipeBookCategory,Optional)
- void <init>(RecipeDisplayId,RecipeDisplay,OptionalInt,RecipeBookCategory,Optional)
```
...
```diff
- ContextKeySet register(String,Consumer)
+ LootContextParamSet register(String,Consumer)
- void lambda$static$10(ContextKeySet$Builder)
+ void lambda$static$10(LootContextParamSet$Builder)
- void lambda$static$11(ContextKeySet$Builder)
+ void lambda$static$11(LootContextParamSet$Builder)
- void lambda$static$12(ContextKeySet$Builder)
+ void lambda$static$12(LootContextParamSet$Builder)
- void lambda$static$13(ContextKeySet$Builder)
+ void lambda$static$13(LootContextParamSet$Builder)
- void lambda$static$14(ContextKeySet$Builder)
+ void lambda$static$14(LootContextParamSet$Builder)
- void lambda$static$15(ContextKeySet$Builder)
+ void lambda$static$15(LootContextParamSet$Builder)
- void lambda$static$16(ContextKeySet$Builder)
+ void lambda$static$16(LootContextParamSet$Builder)
- void lambda$static$17(ContextKeySet$Builder)
+ void lambda$static$17(LootContextParamSet$Builder)
- void lambda$static$18(ContextKeySet$Builder)
+ void lambda$static$18(LootContextParamSet$Builder)
- void lambda$static$19(ContextKeySet$Builder)
+ void lambda$static$19(LootContextParamSet$Builder)
- void lambda$static$20(ContextKeySet$Builder)
+ void lambda$static$20(LootContextParamSet$Builder)
- void lambda$static$21(ContextKeySet$Builder)
+ void lambda$static$21(LootContextParamSet$Builder)
- void lambda$static$22(ContextKeySet$Builder)
+ void lambda$static$22(LootContextParamSet$Builder)
- void lambda$static$23(ContextKeySet$Builder)
+ void lambda$static$23(LootContextParamSet$Builder)
- void lambda$static$24(ContextKeySet$Builder)
+ void lambda$static$24(LootContextParamSet$Builder)
- void lambda$static$25(ContextKeySet$Builder)
+ void lambda$static$25(LootContextParamSet$Builder)
- void lambda$static$3(ContextKeySet$Builder)
+ void lambda$static$3(LootContextParamSet$Builder)
- void lambda$static$4(ContextKeySet$Builder)
+ void lambda$static$4(LootContextParamSet$Builder)
- void lambda$static$5(ContextKeySet$Builder)
+ void lambda$static$5(LootContextParamSet$Builder)
- void lambda$static$6(ContextKeySet$Builder)
+ void lambda$static$6(LootContextParamSet$Builder)
- void lambda$static$7(ContextKeySet$Builder)
+ void lambda$static$7(LootContextParamSet$Builder)
- void lambda$static$8(ContextKeySet$Builder)
+ void lambda$static$8(LootContextParamSet$Builder)
- void lambda$static$9(ContextKeySet$Builder)
