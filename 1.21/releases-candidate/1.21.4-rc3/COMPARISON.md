## Comparison with [1.21.4-rc2](https://github.com/PixiGeko/Minecraft-generated-data/tree/1.21.4-rc2)
...
<br/>
<table><tr><th></th><th align="left">1.21.4-rc2</th><th>1.21.4-rc3</th></tr><tr><td>World version</td><td><pre>4186</pre></td><td><pre>4188</pre></td></tr><tr><td>Protocol version</td><td><pre>1073742051</pre></td><td><pre>1073742052</pre></td></tr></table>
</details>
<hr/>
...
```
XXX.util.datafix.DataFixers +9M -3M
```
...
```diff
- double lambda$addFixers$10(double)
- double lambda$addFixers$11(double)
- double lambda$addFixers$12(double)
- double lambda$addFixers$13(double)
- double lambda$addFixers$8(double)
- double lambda$addFixers$9(double)
+ String lambda$createRenamer$10(String,String,String)
- String lambda$createRenamer$15(Map,String)
- String lambda$createRenamer$16(String,String,String)
+ String lambda$createRenamer$9(Map,String)
- String lambda$createRenamerNoNamespace$14(Map,String)
+ String lambda$createRenamerNoNamespace$8(Map,String)
```
...
```
XXX.blaze3d.platform.Window +1M | +1P
```
```
XXX.util.datafix.DataFixers +9M -3M
```
