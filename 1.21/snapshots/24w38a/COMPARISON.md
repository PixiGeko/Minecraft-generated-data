## Comparison with [24w37a](https://github.com/PixiGeko/Minecraft-generated-data/tree/24w37a)
...
<br/>
<table><tr><th></th><th align="left">24w37a</th><th>24w38a</th></tr><tr><td>DataPack version</td><td><pre>53</pre></td><td><pre>54</pre></td></tr><tr><td>ResourcePack version</td><td><pre>38</pre></td><td><pre>39</pre></td></tr><tr><td>World version</td><td><pre>4065</pre></td><td><pre>4066</pre></td></tr><tr><td>Protocol version</td><td><pre>1073742033</pre></td><td><pre>1073742034</pre></td></tr></table>
</details>
<hr/>
...
<table><tr><th></th><th align="left">24w37a</th><th>24w38a</th></tr><tr><td>minecraft:food</td><td><pre>{
  "nutrition": 6,
  "saturation": 1.2
}</pre></td><td><pre>{
  "can_always_eat": true,
...
```diff
+ minecraft/advancement/recipes/decorations/black_shulker_box.json
+ minecraft/advancement/recipes/decorations/blue_shulker_box.json
+ minecraft/advancement/recipes/decorations/brown_shulker_box.json
+ minecraft/advancement/recipes/decorations/cyan_shulker_box.json
+ minecraft/advancement/recipes/decorations/gray_shulker_box.json
+ minecraft/advancement/recipes/decorations/green_shulker_box.json
+ minecraft/advancement/recipes/decorations/light_blue_shulker_box.json
+ minecraft/advancement/recipes/decorations/light_gray_shulker_box.json
+ minecraft/advancement/recipes/decorations/lime_shulker_box.json
+ minecraft/advancement/recipes/decorations/magenta_shulker_box.json
+ minecraft/advancement/recipes/decorations/orange_shulker_box.json
+ minecraft/advancement/recipes/decorations/pink_shulker_box.json
+ minecraft/advancement/recipes/decorations/purple_shulker_box.json
+ minecraft/advancement/recipes/decorations/red_shulker_box.json
+ minecraft/advancement/recipes/decorations/white_shulker_box.json
+ minecraft/advancement/recipes/decorations/yellow_shulker_box.json
...
+ minecraft/recipe/black_shulker_box.json
+ minecraft/recipe/blue_shulker_box.json
+ minecraft/recipe/brown_shulker_box.json
+ minecraft/recipe/cyan_shulker_box.json
+ minecraft/recipe/gray_shulker_box.json
+ minecraft/recipe/green_shulker_box.json
+ minecraft/recipe/light_blue_shulker_box.json
+ minecraft/recipe/light_gray_shulker_box.json
+ minecraft/recipe/lime_shulker_box.json
+ minecraft/recipe/magenta_shulker_box.json
+ minecraft/recipe/orange_shulker_box.json
+ minecraft/recipe/pink_shulker_box.json
+ minecraft/recipe/purple_shulker_box.json
+ minecraft/recipe/red_shulker_box.json
- minecraft/recipe/shulker_box_coloring.json
+ minecraft/recipe/white_shulker_box.json
+ minecraft/recipe/yellow_shulker_box.json
+ minecraft/tags/item/shulker_boxes.json
```
...
```diff
+ minecraft/models/block/template_torch_unlit.json
+ minecraft/models/block/template_torch_wall_unlit.json
+ minecraft/models/item/black_bundle_open_back.json
+ minecraft/models/item/black_bundle_open_front.json
+ minecraft/models/item/black_bundle.json
+ minecraft/models/item/blue_bundle_open_back.json
+ minecraft/models/item/blue_bundle_open_front.json
+ minecraft/models/item/blue_bundle.json
+ minecraft/models/item/brown_bundle_open_back.json
+ minecraft/models/item/brown_bundle_open_front.json
+ minecraft/models/item/brown_bundle.json
+ minecraft/models/item/cyan_bundle_open_back.json
+ minecraft/models/item/cyan_bundle_open_front.json
+ minecraft/models/item/cyan_bundle.json
+ minecraft/models/item/gray_bundle_open_back.json
+ minecraft/models/item/gray_bundle_open_front.json
+ minecraft/models/item/gray_bundle.json
+ minecraft/models/item/green_bundle_open_back.json
+ minecraft/models/item/green_bundle_open_front.json
+ minecraft/models/item/green_bundle.json
+ minecraft/models/item/light_blue_bundle_open_back.json
+ minecraft/models/item/light_blue_bundle_open_front.json
+ minecraft/models/item/light_blue_bundle.json
+ minecraft/models/item/light_gray_bundle_open_back.json
+ minecraft/models/item/light_gray_bundle_open_front.json
+ minecraft/models/item/light_gray_bundle.json
+ minecraft/models/item/lime_bundle_open_back.json
+ minecraft/models/item/lime_bundle_open_front.json
+ minecraft/models/item/lime_bundle.json
+ minecraft/models/item/magenta_bundle_open_back.json
+ minecraft/models/item/magenta_bundle_open_front.json
+ minecraft/models/item/magenta_bundle.json
+ minecraft/models/item/orange_bundle_open_back.json
+ minecraft/models/item/orange_bundle_open_front.json
+ minecraft/models/item/orange_bundle.json
+ minecraft/models/item/pink_bundle_open_back.json
+ minecraft/models/item/pink_bundle_open_front.json
+ minecraft/models/item/pink_bundle.json
+ minecraft/models/item/purple_bundle_open_back.json
+ minecraft/models/item/purple_bundle_open_front.json
+ minecraft/models/item/purple_bundle.json
+ minecraft/models/item/red_bundle_open_back.json
+ minecraft/models/item/red_bundle_open_front.json
+ minecraft/models/item/red_bundle.json
+ minecraft/models/item/white_bundle_open_back.json
+ minecraft/models/item/white_bundle_open_front.json
+ minecraft/models/item/white_bundle.json
+ minecraft/models/item/yellow_bundle_open_back.json
+ minecraft/models/item/yellow_bundle_open_front.json
+ minecraft/models/item/yellow_bundle.json
+ minecraft/textures/item/black_bundle_open_back.png
+ minecraft/textures/item/black_bundle_open_front.png
+ minecraft/textures/item/black_bundle.png
+ minecraft/textures/item/blue_bundle_open_back.png
+ minecraft/textures/item/blue_bundle_open_front.png
+ minecraft/textures/item/blue_bundle.png
+ minecraft/textures/item/brown_bundle_open_back.png
+ minecraft/textures/item/brown_bundle_open_front.png
+ minecraft/textures/item/brown_bundle.png
+ minecraft/textures/item/cyan_bundle_open_back.png
+ minecraft/textures/item/cyan_bundle_open_front.png
+ minecraft/textures/item/cyan_bundle.png
+ minecraft/textures/item/gray_bundle_open_back.png
+ minecraft/textures/item/gray_bundle_open_front.png
+ minecraft/textures/item/gray_bundle.png
+ minecraft/textures/item/green_bundle_open_back.png
+ minecraft/textures/item/green_bundle_open_front.png
+ minecraft/textures/item/green_bundle.png
+ minecraft/textures/item/light_blue_bundle_open_back.png
+ minecraft/textures/item/light_blue_bundle_open_front.png
+ minecraft/textures/item/light_blue_bundle.png
+ minecraft/textures/item/light_gray_bundle_open_back.png
+ minecraft/textures/item/light_gray_bundle_open_front.png
+ minecraft/textures/item/light_gray_bundle.png
+ minecraft/textures/item/lime_bundle_open_back.png
+ minecraft/textures/item/lime_bundle_open_front.png
+ minecraft/textures/item/lime_bundle.png
+ minecraft/textures/item/magenta_bundle_open_back.png
+ minecraft/textures/item/magenta_bundle_open_front.png
+ minecraft/textures/item/magenta_bundle.png
+ minecraft/textures/item/orange_bundle_open_back.png
+ minecraft/textures/item/orange_bundle_open_front.png
+ minecraft/textures/item/orange_bundle.png
+ minecraft/textures/item/pink_bundle_open_back.png
+ minecraft/textures/item/pink_bundle_open_front.png
+ minecraft/textures/item/pink_bundle.png
+ minecraft/textures/item/purple_bundle_open_back.png
+ minecraft/textures/item/purple_bundle_open_front.png
+ minecraft/textures/item/purple_bundle.png
+ minecraft/textures/item/red_bundle_open_back.png
+ minecraft/textures/item/red_bundle_open_front.png
+ minecraft/textures/item/red_bundle.png
+ minecraft/textures/item/white_bundle_open_back.png
+ minecraft/textures/item/white_bundle_open_front.png
+ minecraft/textures/item/white_bundle.png
+ minecraft/textures/item/yellow_bundle_open_back.png
+ minecraft/textures/item/yellow_bundle_open_front.png
+ minecraft/textures/item/yellow_bundle.png
```
...
```
```
XXX.world.level.LevelAccessor -4M | -2P
```
...
```diff
+ void scheduleTick(BlockPos,Block,int,TickPriority)
+ void scheduleTick(BlockPos,Block,int)
+ void scheduleTick(BlockPos,Fluid,int,TickPriority)
+ void scheduleTick(BlockPos,Fluid,int)
```
...
```
XXX.mojang.blaze3d.TracyFrameCapture +2P -3P
```
```
XXX.blaze3d.platform.GlConst +12P
```
```
XXX.blaze3d.vertex.VertexBuffer +1M -1M | +3P -3P
```
```
XXX.gui.screens.RealmsConfigureWorldScreen +1M
```
```
XXX.minecraft.data.Main +2M -1M
```
```
XXX.models.model.ModelTemplates +2P
```
```
XXX.protocol.login.ClientLoginPacketListener +1P -1P
```
```
XXX.protocol.login.LoginPacketTypes +1P -1P
```
```
XXX.server.commands.TeleportCommand +1M
```
```
XXX.server.network.ServerGamePacketListenerImpl +2P -2P
```
```
XXX.entity.vehicle.Minecart +2M -2M
```
```
XXX.entity.vehicle.MinecartChest +1M -2M
```
```
XXX.entity.vehicle.MinecartHopper +1M -2M
```
```
XXX.world.item.BundleItem +3M
```
```
XXX.item.crafting.RecipeSerializer +1P -1P
```
```
XXX.level.block.AbstractFurnaceBlock +1P -1P
```
```
XXX.level.block.AmethystClusterBlock +1M -1M | +1P -1P
```
```
XXX.level.block.AnvilBlock +1P -1P
```
```
XXX.level.block.BambooStalkBlock +1M -1M
```
```
XXX.level.block.BarrelBlock +1P -1P
```
```
XXX.level.block.BaseCoralPlantTypeBlock +2M -2M
```
```
...
```
```
XXX.level.block.BeehiveBlock +1M -1M | +1P -1P
```
```
XXX.level.block.BellBlock +1M -1M | +1P -1P
```
```
...
```
```
XXX.level.block.CalibratedSculkSensorBlock +1P -1P
```
```
XXX.level.block.CandleBlock +1M -1M
```
```
XXX.level.block.CarpetBlock +1M -1M
```
```
...
```
```
XXX.level.block.ConcretePowderBlock +1M -1M
```
```
...
```
```
XXX.level.block.DirectionalBlock +1P -1P
```
```
XXX.level.block.DispenserBlock +1P -1P
```
```
XXX.level.block.EndPortalFrameBlock +1P -1P
```
```
XXX.level.block.EnderChestBlock +1M -1M | +1P -1P
```
```
...
```
```
XXX.level.block.FireBlock +2M -2M
```
```
...
```
```
XXX.level.block.GrowingPlantHeadBlock +2M -2M
```
```
XXX.level.block.HangingRootsBlock +1M -1M
```
```
XXX.level.block.HeavyCoreBlock +1M -1M
```
```
XXX.level.block.HopperBlock +1P -1P
```
```
XXX.level.block.HorizontalDirectionalBlock +1P -1P
```
```
XXX.level.block.LadderBlock +1M -1M | +1P -1P
```
```
XXX.level.block.LanternBlock +1M -1M
```
```
XXX.level.block.LecternBlock +1P -1P
```
```
XXX.level.block.LightningRodBlock +1M -1M
```
```
XXX.level.block.MagmaBlock +1M -1M
```
```
XXX.level.block.MangrovePropaguleBlock +1M -1M
```
```
...
```
```
XXX.level.block.SeagrassBlock +1M -1M
```
```
...
```
```
XXX.level.block.VaultBlock +1P -1P
```
```
XXX.level.block.WallBlock +1M -1M
```
```
XXX.level.block.WallHangingSignBlock +1M -1M | +1P -1P
```
```
XXX.level.block.WallSignBlock +1M -1M | +1P -1P
```
```
XXX.level.block.WallTorchBlock +1M -1M | +1P -1P
```
```
XXX.level.block.WaterloggedTransparentBlock +1M -1M
```
```
XXX.block.piston.PistonHeadBlock +1M -1M
```
```
...
```
```
XXX.state.properties.BooleanProperty +1M -2M | +3P -1P
```
...
```diff
- void <init>(BufferUsage)
+ void <init>(VertexBuffer$Usage)
```
...
```diff
- Set getRelatives(Coordinates,Coordinates)
```
...
```diff
+ AbstractMinecart$Type getMinecartType()
- boolean isRideable()
...
+ BlockState updateShape(BlockState,Direction,BlockState,LevelAccessor,BlockPos,BlockPos)
- BlockState updateShape(BlockState,LevelReader,ScheduledTickAccess,BlockPos,Direction,BlockPos,BlockState,RandomSource)
- void tryScheduleDieTick(BlockState,BlockGetter,ScheduledTickAccess,RandomSource,BlockPos)
+ void tryScheduleDieTick(BlockState,LevelAccessor,BlockPos)
```
...
- BlockState getStateWithAge(LevelReader,BlockPos,int)
+ BlockState updateShape(BlockState,Direction,BlockState,LevelAccessor,BlockPos,BlockPos)
- BlockState updateShape(BlockState,LevelReader,ScheduledTickAccess,BlockPos,Direction,BlockPos,BlockState,RandomSource)
```
...
- BlockState getStateForPlacement(RandomSource)
```
...
- BlockState updateShape(LevelReader,ScheduledTickAccess,BlockPos,Direction,BlockPos,BlockState,RandomSource)
```
