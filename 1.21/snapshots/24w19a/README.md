...
<tr><th>Asset index</th><td><a href="https://piston-meta.mojang.com/v1/packages/b24500a7f4975293e4a0c401b25b0cf241afa85b/17.json">https://piston-meta.mojang.com/v1/packages/b24500a7f4975293e4a0c401b25b0cf241afa85b/17.json</a></td></tr>
...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/24w18a">24w18a</a>
...
<details><summary>net.minecraft.server.level.ChunkLevel</summary>
...
<details><summary>net.minecraft.world.level.chunk.status.ChunkStatusTasks</summary>
...
<details><summary>net.minecraft.data.info.ItemListReport</summary>
...
<details><summary>net.minecraft.network.protocol.game.ClientboundSetEntityMotionPacket</summary>
...
<details><summary>net.minecraft.world.entity.projectile.SmallFireball</summary>
...
<details><summary>net.minecraft.world.item.enchantment.effects.AddValue</summary>
...
<details><summary>net.minecraft.world.item.enchantment.effects.AllOf$ValueEffects</summary>
...
<details><summary>net.minecraft.world.item.enchantment.effects.ReplaceBlock</summary>
...
<details><summary>net.minecraft.world.item.enchantment.effects.SetValue</summary>
...
```diff
+ block/acacia_logs.json
+ block/all_hanging_signs.json
+ block/all_signs.json
+ block/ancient_city_replaceable.json
+ block/animals_spawnable_on.json
+ block/anvil.json
+ block/armadillo_spawnable_on.json
+ block/axolotls_spawnable_on.json
+ block/azalea_grows_on.json
+ block/azalea_root_replaceable.json
+ block/badlands_terracotta.json
+ block/bamboo_blocks.json
+ block/bamboo_plantable_on.json
+ block/banners.json
+ block/base_stone_nether.json
+ block/base_stone_overworld.json
+ block/beacon_base_blocks.json
+ block/beds.json
+ block/bee_growables.json
+ block/beehives.json
+ block/big_dripleaf_placeable.json
+ block/birch_logs.json
+ block/blocks_wind_charge_explosions.json
+ block/buttons.json
+ block/camel_sand_step_sound_blocks.json
+ block/campfires.json
+ block/candle_cakes.json
+ block/candles.json
+ block/cauldrons.json
+ block/cave_vines.json
+ block/ceiling_hanging_signs.json
+ block/cherry_logs.json
+ block/climbable.json
+ block/coal_ores.json
+ block/combination_step_sound_blocks.json
+ block/completes_find_tree_tutorial.json
+ block/concrete_powder.json
+ block/convertable_to_mud.json
+ block/copper_ores.json
+ block/coral_blocks.json
+ block/coral_plants.json
+ block/corals.json
+ block/crimson_stems.json
+ block/crops.json
+ block/crystal_sound_blocks.json
+ block/dampens_vibrations.json
+ block/dark_oak_logs.json
+ block/dead_bush_may_place_on.json
+ block/deepslate_ore_replaceables.json
+ block/diamond_ores.json
+ block/dirt.json
+ block/does_not_block_hoppers.json
+ block/doors.json
+ block/dragon_immune.json
+ block/dragon_transparent.json
+ block/dripstone_replaceable_blocks.json
+ block/emerald_ores.json
+ block/enchantment_power_provider.json
+ block/enchantment_power_transmitter.json
+ block/enderman_holdable.json
+ block/fall_damage_resetting.json
+ block/features_cannot_replace.json
+ block/fence_gates.json
+ block/fences.json
+ block/fire_aspect_lightable.json
+ block/fire.json
+ block/flower_pots.json
+ block/flowers.json
+ block/foxes_spawnable_on.json
+ block/frog_prefer_jump_to.json
+ block/frogs_spawnable_on.json
+ block/geode_invalid_blocks.json
+ block/goats_spawnable_on.json
+ block/gold_ores.json
+ block/guarded_by_piglins.json
+ block/hoglin_repellents.json
+ block/ice.json
+ block/impermeable.json
+ block/incorrect_for_diamond_tool.json
+ block/incorrect_for_gold_tool.json
+ block/incorrect_for_iron_tool.json
+ block/incorrect_for_netherite_tool.json
+ block/incorrect_for_stone_tool.json
+ block/incorrect_for_wooden_tool.json
+ block/infiniburn_end.json
+ block/infiniburn_nether.json
+ block/infiniburn_overworld.json
+ block/inside_step_sound_blocks.json
+ block/invalid_spawn_inside.json
+ block/iron_ores.json
+ block/jungle_logs.json
+ block/lapis_ores.json
+ block/lava_pool_stone_cannot_replace.json
+ block/leaves.json
+ block/logs_that_burn.json
+ block/logs.json
+ block/lush_ground_replaceable.json
+ block/maintains_farmland.json
+ block/mangrove_logs_can_grow_through.json
+ block/mangrove_logs.json
+ block/mangrove_roots_can_grow_through.json
+ block/mineable/axe.json
+ block/mineable/hoe.json
+ block/mineable/pickaxe.json
+ block/mineable/shovel.json
+ block/mooshrooms_spawnable_on.json
+ block/moss_replaceable.json
+ block/mushroom_grow_block.json
+ block/needs_diamond_tool.json
+ block/needs_iron_tool.json
+ block/needs_stone_tool.json
+ block/nether_carver_replaceables.json
+ block/nylium.json
+ block/oak_logs.json
+ block/occludes_vibration_signals.json
+ block/overworld_carver_replaceables.json
+ block/overworld_natural_logs.json
+ block/parrots_spawnable_on.json
+ block/piglin_repellents.json
+ block/planks.json
+ block/polar_bears_spawnable_on_alternate.json
+ block/portals.json
+ block/pressure_plates.json
+ block/prevent_mob_spawning_inside.json
+ block/rabbits_spawnable_on.json
+ block/rails.json
+ block/redstone_ores.json
+ block/replaceable_by_trees.json
+ block/replaceable.json
+ block/sand.json
+ block/saplings.json
+ block/sculk_replaceable_world_gen.json
+ block/sculk_replaceable.json
+ block/shulker_boxes.json
+ block/signs.json
+ block/slabs.json
+ block/small_dripleaf_placeable.json
+ block/small_flowers.json
+ block/smelts_to_glass.json
+ block/snaps_goat_horn.json
+ block/sniffer_diggable_block.json
+ block/sniffer_egg_hatch_boost.json
+ block/snow_layer_can_survive_on.json
+ block/snow_layer_cannot_survive_on.json
+ block/snow.json
+ block/soul_fire_base_blocks.json
+ block/soul_speed_blocks.json
+ block/spruce_logs.json
+ block/stairs.json
+ block/standing_signs.json
+ block/stone_bricks.json
+ block/stone_buttons.json
+ block/stone_ore_replaceables.json
+ block/stone_pressure_plates.json
+ block/strider_warm_blocks.json
+ block/sword_efficient.json
+ block/tall_flowers.json
+ block/terracotta.json
+ block/trail_ruins_replaceable.json
+ block/trapdoors.json
+ block/underwater_bonemeals.json
+ block/unstable_bottom_center.json
+ block/valid_spawn.json
+ block/vibration_resonators.json
+ block/wall_corals.json
+ block/wall_hanging_signs.json
+ block/wall_post_override.json
+ block/wall_signs.json
+ block/walls.json
+ block/warped_stems.json
+ block/wart_blocks.json
+ block/wither_immune.json
+ block/wither_summon_base_blocks.json
+ block/wolves_spawnable_on.json
+ block/wooden_buttons.json
+ block/wooden_doors.json
+ block/wooden_fences.json
+ block/wooden_pressure_plates.json
+ block/wooden_slabs.json
+ block/wooden_stairs.json
+ block/wooden_trapdoors.json
+ block/wool_carpets.json
+ block/wool.json
...
- blocks/dirt.json
- blocks/does_not_block_hoppers.json
- blocks/doors.json
...
- blocks/wooden_buttons.json
- blocks/wooden_doors.json
...
- blocks/wool.json
+ entity_type/aquatic.json
+ entity_type/arrows.json
+ entity_type/arthropod.json
+ entity_type/axolotl_always_hostiles.json
+ entity_type/axolotl_hunt_targets.json
+ entity_type/beehive_inhabitors.json
+ entity_type/can_breathe_under_water.json
+ entity_type/can_turn_in_boats.json
+ entity_type/deflects_projectiles.json
+ entity_type/dismounts_underwater.json
+ entity_type/fall_damage_immune.json
+ entity_type/freeze_hurts_extra_types.json
+ entity_type/freeze_immune_entity_types.json
+ entity_type/frog_food.json
+ entity_type/ignores_poison_and_regen.json
+ entity_type/illager_friends.json
+ entity_type/illager.json
+ entity_type/immune_to_infested.json
+ entity_type/immune_to_oozing.json
+ entity_type/impact_projectiles.json
+ entity_type/inverted_healing_and_harm.json
+ entity_type/no_anger_from_wind_charge.json
+ entity_type/non_controlling_rider.json
+ entity_type/not_scary_for_pufferfish.json
+ entity_type/powder_snow_walkable_mobs.json
+ entity_type/raiders.json
+ entity_type/redirectable_projectile.json
+ entity_type/sensitive_to_bane_of_arthropods.json
+ entity_type/sensitive_to_impaling.json
+ entity_type/sensitive_to_smite.json
+ entity_type/skeletons.json
+ entity_type/undead.json
+ entity_type/wither_friends.json
+ entity_type/zombies.json
...
- entity_types/raiders.json
- entity_types/redirectable_projectile.json
...
- fluids/lava.json
- fluids/water.json
+ game_event/allay_can_listen.json
+ game_event/ignore_vibrations_sneaking.json
+ game_event/shrieker_can_listen.json
+ game_event/vibrations.json
+ game_event/warden_can_listen.json
...
+ item/acacia_logs.json
+ item/anvil.json
+ item/armadillo_food.json
+ item/arrows.json
+ item/axes.json
+ item/axolotl_food.json
+ item/bamboo_blocks.json
+ item/banners.json
+ item/beacon_payment_items.json
+ item/beds.json
+ item/bee_food.json
+ item/birch_logs.json
+ item/boats.json
+ item/bookshelf_books.json
+ item/breaks_decorated_pots.json
+ item/buttons.json
+ item/camel_food.json
+ item/candles.json
+ item/cat_food.json
+ item/cherry_logs.json
+ item/chest_armor.json
+ item/chest_boats.json
+ item/chicken_food.json
+ item/cluster_max_harvestables.json
+ item/coal_ores.json
+ item/coals.json
+ item/compasses.json
+ item/completes_find_tree_tutorial.json
+ item/copper_ores.json
+ item/cow_food.json
+ item/creeper_drop_music_discs.json
+ item/creeper_igniters.json
+ item/crimson_stems.json
+ item/dampens_vibrations.json
+ item/dark_oak_logs.json
+ item/decorated_pot_ingredients.json
+ item/decorated_pot_sherds.json
+ item/diamond_ores.json
+ item/dirt.json
+ item/doors.json
+ item/dyeable.json
+ item/emerald_ores.json
+ item/enchantable/armor.json
+ item/enchantable/bow.json
+ item/enchantable/chest_armor.json
+ item/enchantable/crossbow.json
+ item/enchantable/durability.json
+ item/enchantable/equippable.json
+ item/enchantable/fire_aspect.json
+ item/enchantable/fishing.json
+ item/enchantable/foot_armor.json
+ item/enchantable/head_armor.json
+ item/enchantable/leg_armor.json
+ item/enchantable/mace.json
+ item/enchantable/mining_loot.json
+ item/enchantable/mining.json
+ item/enchantable/sharp_weapon.json
+ item/enchantable/sword.json
+ item/enchantable/trident.json
+ item/enchantable/vanishing.json
+ item/enchantable/weapon.json
+ item/fence_gates.json
+ item/fences.json
+ item/fishes.json
+ item/flowers.json
+ item/foot_armor.json
+ item/fox_food.json
+ item/freeze_immune_wearables.json
+ item/frog_food.json
+ item/goat_food.json
+ item/gold_ores.json
+ item/hanging_signs.json
+ item/head_armor.json
+ item/hoes.json
+ item/hoglin_food.json
+ item/horse_food.json
+ item/horse_tempt_items.json
+ item/ignored_by_piglin_babies.json
+ item/iron_ores.json
+ item/jungle_logs.json
+ item/lapis_ores.json
+ item/leaves.json
+ item/lectern_books.json
+ item/leg_armor.json
+ item/llama_food.json
+ item/llama_tempt_items.json
+ item/logs_that_burn.json
+ item/logs.json
+ item/mangrove_logs.json
+ item/meat.json
+ item/music_discs.json
+ item/non_flammable_wood.json
+ item/noteblock_top_instruments.json
+ item/oak_logs.json
+ item/ocelot_food.json
+ item/panda_food.json
+ item/parrot_food.json
+ item/parrot_poisonous_food.json
+ item/pickaxes.json
+ item/pig_food.json
+ item/piglin_food.json
+ item/piglin_loved.json
+ item/piglin_repellents.json
+ item/planks.json
+ item/rabbit_food.json
+ item/rails.json
+ item/redstone_ores.json
+ item/sand.json
+ item/saplings.json
+ item/sheep_food.json
+ item/shovels.json
+ item/signs.json
+ item/skulls.json
+ item/slabs.json
+ item/small_flowers.json
+ item/smelts_to_glass.json
+ item/sniffer_food.json
+ item/soul_fire_base_blocks.json
+ item/spruce_logs.json
+ item/stairs.json
+ item/stone_bricks.json
+ item/stone_buttons.json
+ item/stone_crafting_materials.json
+ item/stone_tool_materials.json
+ item/strider_food.json
+ item/strider_tempt_items.json
+ item/swords.json
+ item/tall_flowers.json
+ item/terracotta.json
+ item/trapdoors.json
+ item/trim_materials.json
+ item/trim_templates.json
+ item/trimmable_armor.json
+ item/turtle_food.json
+ item/villager_plantable_seeds.json
+ item/walls.json
+ item/warped_stems.json
+ item/wart_blocks.json
+ item/wolf_food.json
+ item/wooden_buttons.json
+ item/wooden_doors.json
+ item/wooden_fences.json
+ item/wooden_pressure_plates.json
+ item/wooden_slabs.json
+ item/wooden_stairs.json
+ item/wooden_trapdoors.json
+ item/wool_carpets.json
+ item/wool.json
...
- items/wooden_buttons.json
- items/wooden_doors.json
...
```diff
+ ambient/cave/cave20.ogg
+ ambient/cave/cave21.ogg
+ ambient/cave/cave22.ogg
+ ambient/cave/cave23.ogg
+ block/copper_bulb/toggle.ogg
- block/copper_bulb/turn_off.ogg
- block/copper_bulb/turn_on.ogg
```
