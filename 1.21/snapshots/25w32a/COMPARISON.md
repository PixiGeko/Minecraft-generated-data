## Comparison with [25w31a](https://github.com/PixiGeko/Minecraft-generated-data/tree/25w31a)
...
<br/>
<table><tr><th></th><th align="left">25w31a</th><th>25w32a</th></tr><tr><td>DataPack version</td><td><pre>{
  "major": 82,
  "minor": 0
}</pre></td><td><pre>{
  "major": 83,
  ...
  "major": 65,
  "minor": 1
}</pre></td></tr><tr><td>World version</td><td><pre>4534</pre></td><td><pre>4536</pre></td></tr><tr><td>Protocol version</td><td><pre>1073742084</pre></td><td><pre>1073742085</pre></td></tr></table>
</details>
<hr/>
...
```
Result: copper_trapdoor x2 -> copper_trapdoor x1
```
```
A: copper_ingot
...
<br/>
<table>
<tr><th>Name</th><th>25w31a</th><th>25w32a</th></tr>
<tr><th align="left"><div style="width:290px">block.minecraft.chain</div></th><td>Chain</td><td>Iron Chain</td></tr>
<tr><th align="left"><div style="width:290px">debug.entry.currently.inF3</div></th><td>%s: Currently only in f3</td><td>%s: Currently only in F3</td></tr>
<tr><th align="left"><div style="width:290px">debug.options.help</div></th><td>F3 + F5 = Edit Debug Options</td><td>F3 + F5 = Edit debug options</td></tr>
</table>
<br/>
</details>
</details>
...
```diff
+ minecraft/advancement/recipes/building_blocks/waxed_copper_bars_from_honeycomb.json
+ minecraft/advancement/recipes/building_blocks/waxed_copper_chain_from_honeycomb.json
+ minecraft/advancement/recipes/building_blocks/waxed_copper_lantern_from_honeycomb.json
+ minecraft/advancement/recipes/building_blocks/waxed_exposed_copper_bars_from_honeycomb.json
+ minecraft/advancement/recipes/building_blocks/waxed_exposed_copper_chain_from_honeycomb.json
+ minecraft/advancement/recipes/building_blocks/waxed_exposed_copper_lantern_from_honeycomb.json
+ minecraft/advancement/recipes/building_blocks/waxed_oxidized_copper_bars_from_honeycomb.json
+ minecraft/advancement/recipes/building_blocks/waxed_oxidized_copper_chain_from_honeycomb.json
+ minecraft/advancement/recipes/building_blocks/waxed_oxidized_copper_lantern_from_honeycomb.json
+ minecraft/advancement/recipes/building_blocks/waxed_weathered_copper_bars_from_honeycomb.json
+ minecraft/advancement/recipes/building_blocks/waxed_weathered_copper_chain_from_honeycomb.json
+ minecraft/advancement/recipes/building_blocks/waxed_weathered_copper_lantern_from_honeycomb.json
+ minecraft/advancement/recipes/decorations/copper_bars.json
+ minecraft/advancement/recipes/decorations/copper_chain.json
+ minecraft/advancement/recipes/decorations/copper_lantern.json
+ minecraft/advancement/recipes/decorations/copper_torch.json
+ minecraft/loot_table/blocks/copper_bars.json
+ minecraft/loot_table/blocks/copper_chain.json
+ minecraft/loot_table/blocks/copper_lantern.json
+ minecraft/loot_table/blocks/copper_torch.json
+ minecraft/loot_table/blocks/exposed_copper_bars.json
+ minecraft/loot_table/blocks/exposed_copper_chain.json
+ minecraft/loot_table/blocks/exposed_copper_lantern.json
+ minecraft/loot_table/blocks/oxidized_copper_bars.json
+ minecraft/loot_table/blocks/oxidized_copper_chain.json
+ minecraft/loot_table/blocks/oxidized_copper_lantern.json
+ minecraft/loot_table/blocks/waxed_copper_bars.json
+ minecraft/loot_table/blocks/waxed_copper_chain.json
+ minecraft/loot_table/blocks/waxed_copper_lantern.json
+ minecraft/loot_table/blocks/waxed_exposed_copper_bars.json
+ minecraft/loot_table/blocks/waxed_exposed_copper_chain.json
+ minecraft/loot_table/blocks/waxed_exposed_copper_lantern.json
+ minecraft/loot_table/blocks/waxed_oxidized_copper_bars.json
+ minecraft/loot_table/blocks/waxed_oxidized_copper_chain.json
+ minecraft/loot_table/blocks/waxed_oxidized_copper_lantern.json
+ minecraft/loot_table/blocks/waxed_weathered_copper_bars.json
+ minecraft/loot_table/blocks/waxed_weathered_copper_chain.json
+ minecraft/loot_table/blocks/waxed_weathered_copper_lantern.json
+ minecraft/loot_table/blocks/weathered_copper_bars.json
+ minecraft/loot_table/blocks/weathered_copper_chain.json
+ minecraft/loot_table/blocks/weathered_copper_lantern.json
+ minecraft/loot_table/harvest/sweet_berry_bush.json
+ minecraft/recipe/copper_bars.json
+ minecraft/recipe/copper_chain.json
+ minecraft/recipe/copper_lantern.json
+ minecraft/recipe/copper_torch.json
+ minecraft/recipe/waxed_copper_bars_from_honeycomb.json
+ minecraft/recipe/waxed_copper_chain_from_honeycomb.json
+ minecraft/recipe/waxed_copper_lantern_from_honeycomb.json
+ minecraft/recipe/waxed_exposed_copper_bars_from_honeycomb.json
+ minecraft/recipe/waxed_exposed_copper_chain_from_honeycomb.json
+ minecraft/recipe/waxed_exposed_copper_lantern_from_honeycomb.json
+ minecraft/recipe/waxed_oxidized_copper_bars_from_honeycomb.json
+ minecraft/recipe/waxed_oxidized_copper_chain_from_honeycomb.json
+ minecraft/recipe/waxed_oxidized_copper_lantern_from_honeycomb.json
+ minecraft/recipe/waxed_weathered_copper_bars_from_honeycomb.json
+ minecraft/recipe/waxed_weathered_copper_chain_from_honeycomb.json
+ minecraft/recipe/waxed_weathered_copper_lantern_from_honeycomb.json
+ minecraft/tags/block/bars.json
+ minecraft/tags/block/chains.json
+ minecraft/tags/block/lanterns.json
+ minecraft/tags/item/bars.json
+ minecraft/tags/item/chains.json
+ minecraft/tags/item/lanterns.json
```
...
```diff
+ minecraft/blockstates/copper_bars.json
+ minecraft/blockstates/copper_chain.json
+ minecraft/blockstates/copper_lantern.json
+ minecraft/blockstates/copper_torch.json
+ minecraft/blockstates/copper_wall_torch.json
+ minecraft/blockstates/exposed_copper_bars.json
+ minecraft/blockstates/exposed_copper_chain.json
+ minecraft/blockstates/exposed_copper_lantern.json
+ minecraft/blockstates/oxidized_copper_bars.json
+ minecraft/blockstates/oxidized_copper_chain.json
+ minecraft/blockstates/oxidized_copper_lantern.json
+ minecraft/blockstates/waxed_copper_bars.json
+ minecraft/blockstates/waxed_copper_chain.json
+ minecraft/blockstates/waxed_copper_lantern.json
+ minecraft/blockstates/waxed_exposed_copper_bars.json
+ minecraft/blockstates/waxed_exposed_copper_chain.json
+ minecraft/blockstates/waxed_exposed_copper_lantern.json
+ minecraft/blockstates/waxed_oxidized_copper_bars.json
+ minecraft/blockstates/waxed_oxidized_copper_chain.json
+ minecraft/blockstates/waxed_oxidized_copper_lantern.json
+ minecraft/blockstates/waxed_weathered_copper_bars.json
+ minecraft/blockstates/waxed_weathered_copper_chain.json
+ minecraft/blockstates/waxed_weathered_copper_lantern.json
+ minecraft/blockstates/weathered_copper_bars.json
+ minecraft/blockstates/weathered_copper_chain.json
+ minecraft/blockstates/weathered_copper_lantern.json
+ minecraft/items/copper_bars.json
+ minecraft/items/copper_chain.json
+ minecraft/items/copper_lantern.json
+ minecraft/items/copper_torch.json
+ minecraft/items/exposed_copper_bars.json
+ minecraft/items/exposed_copper_chain.json
+ minecraft/items/exposed_copper_lantern.json
+ minecraft/items/oxidized_copper_bars.json
+ minecraft/items/oxidized_copper_chain.json
+ minecraft/items/oxidized_copper_lantern.json
+ minecraft/items/waxed_copper_bars.json
+ minecraft/items/waxed_copper_chain.json
+ minecraft/items/waxed_copper_lantern.json
+ minecraft/items/waxed_exposed_copper_bars.json
+ minecraft/items/waxed_exposed_copper_chain.json
+ minecraft/items/waxed_exposed_copper_lantern.json
+ minecraft/items/waxed_oxidized_copper_bars.json
+ minecraft/items/waxed_oxidized_copper_chain.json
+ minecraft/items/waxed_oxidized_copper_lantern.json
+ minecraft/items/waxed_weathered_copper_bars.json
+ minecraft/items/waxed_weathered_copper_chain.json
+ minecraft/items/waxed_weathered_copper_lantern.json
+ minecraft/items/weathered_copper_bars.json
+ minecraft/items/weathered_copper_chain.json
+ minecraft/items/weathered_copper_lantern.json
+ minecraft/models/block/copper_bars_cap_alt.json
+ minecraft/models/block/copper_bars_cap.json
+ minecraft/models/block/copper_bars_post_ends.json
+ minecraft/models/block/copper_bars_post.json
+ minecraft/models/block/copper_bars_side_alt.json
+ minecraft/models/block/copper_bars_side.json
+ minecraft/models/block/copper_chain.json
+ minecraft/models/block/copper_lantern_hanging.json
+ minecraft/models/block/copper_lantern.json
+ minecraft/models/block/copper_torch.json
+ minecraft/models/block/copper_wall_torch.json
+ minecraft/models/block/exposed_copper_bars_cap_alt.json
+ minecraft/models/block/exposed_copper_bars_cap.json
+ minecraft/models/block/exposed_copper_bars_post_ends.json
+ minecraft/models/block/exposed_copper_bars_post.json
+ minecraft/models/block/exposed_copper_bars_side_alt.json
+ minecraft/models/block/exposed_copper_bars_side.json
+ minecraft/models/block/exposed_copper_chain.json
+ minecraft/models/block/exposed_copper_lantern_hanging.json
+ minecraft/models/block/exposed_copper_lantern.json
+ minecraft/models/block/oxidized_copper_bars_cap_alt.json
+ minecraft/models/block/oxidized_copper_bars_cap.json
+ minecraft/models/block/oxidized_copper_bars_post_ends.json
+ minecraft/models/block/oxidized_copper_bars_post.json
+ minecraft/models/block/oxidized_copper_bars_side_alt.json
+ minecraft/models/block/oxidized_copper_bars_side.json
+ minecraft/models/block/oxidized_copper_chain.json
+ minecraft/models/block/oxidized_copper_lantern_hanging.json
+ minecraft/models/block/oxidized_copper_lantern.json
+ minecraft/models/block/template_bars_cap_alt.json
+ minecraft/models/block/template_bars_cap.json
+ minecraft/models/block/template_bars_post_ends.json
+ minecraft/models/block/template_bars_post.json
+ minecraft/models/block/template_bars_side_alt.json
+ minecraft/models/block/template_bars_side.json
+ minecraft/models/block/template_chain.json
+ minecraft/models/block/weathered_copper_bars_cap_alt.json
+ minecraft/models/block/weathered_copper_bars_cap.json
+ minecraft/models/block/weathered_copper_bars_post_ends.json
+ minecraft/models/block/weathered_copper_bars_post.json
+ minecraft/models/block/weathered_copper_bars_side_alt.json
+ minecraft/models/block/weathered_copper_bars_side.json
+ minecraft/models/block/weathered_copper_chain.json
+ minecraft/models/block/weathered_copper_lantern_hanging.json
+ minecraft/models/block/weathered_copper_lantern.json
+ minecraft/models/item/copper_bars.json
+ minecraft/models/item/copper_chain.json
+ minecraft/models/item/copper_lantern.json
+ minecraft/models/item/copper_torch.json
+ minecraft/models/item/exposed_copper_bars.json
+ minecraft/models/item/exposed_copper_chain.json
+ minecraft/models/item/exposed_copper_lantern.json
+ minecraft/models/item/oxidized_copper_bars.json
+ minecraft/models/item/oxidized_copper_chain.json
+ minecraft/models/item/oxidized_copper_lantern.json
+ minecraft/models/item/weathered_copper_bars.json
+ minecraft/models/item/weathered_copper_chain.json
+ minecraft/models/item/weathered_copper_lantern.json
+ minecraft/particles/copper_fire_flame.json
+ minecraft/textures/block/copper_bars.png
+ minecraft/textures/block/copper_chain.png
+ minecraft/textures/block/copper_lantern.png
+ minecraft/textures/block/copper_lantern.png.mcmeta
+ minecraft/textures/block/copper_torch.png
+ minecraft/textures/block/exposed_copper_bars.png
+ minecraft/textures/block/exposed_copper_chain.png
+ minecraft/textures/block/exposed_copper_lantern.png
+ minecraft/textures/block/exposed_copper_lantern.png.mcmeta
+ minecraft/textures/block/oxidized_copper_bars.png
+ minecraft/textures/block/oxidized_copper_chain.png
+ minecraft/textures/block/oxidized_copper_lantern.png
+ minecraft/textures/block/oxidized_copper_lantern.png.mcmeta
+ minecraft/textures/block/weathered_copper_bars.png
+ minecraft/textures/block/weathered_copper_chain.png
+ minecraft/textures/block/weathered_copper_lantern.png
+ minecraft/textures/block/weathered_copper_lantern.png.mcmeta
+ minecraft/textures/item/copper_chain.png
+ minecraft/textures/item/copper_lantern.png
+ minecraft/textures/item/exposed_copper_chain.png
+ minecraft/textures/item/exposed_copper_lantern.png
+ minecraft/textures/item/oxidized_copper_chain.png
+ minecraft/textures/item/oxidized_copper_lantern.png
+ minecraft/textures/item/weathered_copper_chain.png
+ minecraft/textures/item/weathered_copper_lantern.png
+ minecraft/textures/particle/copper_fire_flame.png
```
...
```
```
XXX.minecraft.core.BlockPos +4M
```
```
XXX.minecraft.core.BlockPos$6 +3M -1M | +23P -2P
```
```
XXX.minecraft.network.FriendlyByteBuf +2M
```
```
XXX.network.chat.Style +3M -3M | +1P -2P
```
```
XXX.world.entity.Entity +15M -11M | +2P -2P
```
```
XXX.world.entity.Relative +3M
```
```
...
```
```
XXX.world.item.Items +16M -15M | +4P
```
```
XXX.world.level.BlockGetter +2M -1M | -1P
```
```
XXX.level.block.Blocks +67M -59M | +6P -1P
```
```
...
```diff
- Iterable betweenCornersInDirection(AABB,Vec3)
- Iterable betweenCornersInDirection(BlockPos,BlockPos,Vec3)
- Iterable betweenCornersInDirection(int,int,int,int,int,int,Vec3)
- Iterator lambda$betweenCornersInDirection$8(Direction,Direction,Direction,int,int,int,int,int,int)
```
...
- Object computeNext()
+ void <clinit>()
- void <init>(Direction,Direction,Direction,int,int,int,int,int,int)
```
...
- void <init>(TextColor,Integer,Boolean,Boolean,Boolean,Boolean,Boolean,ClickEvent,HoverEvent,String,FontDescription)
...
```diff
- boolean lambda$checkInsideBlocks$0(int,AtomicInteger,Vec3,Vec3,LongSet,InsideBlockEffectApplier$StepBasedCollector,BlockPos,int)
...
- int checkInsideBlocks(Vec3,Vec3,InsideBlockEffectApplier$StepBasedCollector,LongSet,int)
+ Iterable axisStepOrder(Vec3)
+ Iterator lambda$getIndirectPassengers$14()
- Iterator lambda$getIndirectPassengers$16()
- String lambda$fillCrashReportCategory$12()
- String lambda$fillCrashReportCategory$13()
+ String lambda$fillCrashReportCategory$8()
+ String lambda$fillCrashReportCategory$9()
+ Style lambda$getDisplayName$12(Style)
- Style lambda$getDisplayName$14(Style)
+ void checkInsideBlocks(Vec3,Vec3,InsideBlockEffectApplier$StepBasedCollector,LongSet)
- void forceSetRotation(float,boolean,float,boolean)
+ void forceSetRotation(float,float)
- void lambda$moveOrInterpolateTo$8(Float)
- void lambda$moveOrInterpolateTo$9(Float)
+ void lambda$teleportPassengers$13(Entity)
- void lambda$teleportPassengers$15(Entity)
+ void lerpMotion(double,double,double)
- void lerpMotion(Vec3)
- void moveOrInterpolateTo(float,float)
- void moveOrInterpolateTo(Optional,Optional,Optional)
- void moveOrInterpolateTo(Vec3)
```
...
```diff
- Set direction(boolean,boolean,boolean)
- Set position(boolean,boolean,boolean)
- Set rotation(boolean,boolean)
```
...
```diff
+ Item lambda$createBlockItemWithCustomItemName$183(Block,Item$Properties)
- Item lambda$createBlockItemWithCustomItemName$184(Block,Item$Properties)
+ Item lambda$registerBlock$184(UnaryOperator,Block,Item$Properties)
+ Item lambda$registerBlock$185(BiFunction,Block,Item$Properties)
- Item lambda$registerBlock$185(UnaryOperator,Block,Item$Properties)
- Item lambda$registerBlock$186(BiFunction,Block,Item$Properties)
+ Item lambda$static$100(Block,Item$Properties)
- Item lambda$static$100(Item$Properties)
- Item lambda$static$124(Block,Item$Properties)
+ Item lambda$static$124(Item$Properties)
- Item lambda$static$150(Item$Properties)
+ Item lambda$static$152(Item$Properties)
+ Item lambda$static$154(Block,Item$Properties)
- Item lambda$static$154(Item$Properties)
- Item lambda$static$161(Block,Item$Properties)
+ Item lambda$static$161(Item$Properties)
+ Item lambda$static$162(Block,Item$Properties)
- Item lambda$static$162(Item$Properties)
- Item lambda$static$178(Block,Item$Properties)
- Item lambda$static$18(Block,Item$Properties)
+ Item lambda$static$36(Block,Item$Properties)
- Item lambda$static$47(Block,Item$Properties)
+ Item lambda$static$51(Item$Properties)
+ Item$Properties lambda$static$150(Item$Properties)
- Item$Properties lambda$static$152(Item$Properties)
+ Item$Properties lambda$static$178(Item$Properties)
+ Item$Properties lambda$static$18(Item$Properties)
- Item$Properties lambda$static$183(Item$Properties)
- Item$Properties lambda$static$36(Item$Properties)
+ Item$Properties lambda$static$47(Item$Properties)
- Item$Properties lambda$static$51(Item$Properties)
```
...
```diff
- int addCollisionsAlongTravel(LongSet,Vec3,AABB,BlockGetter$BlockStepVisitor)
+ int addCollisionsAlongTravel(LongSet,Vec3,Vec3,AABB,BlockGetter$BlockStepVisitor)
- Vec3i getFurthestCorner(Vec3)
```
...
```diff
- Block lambda$static$142(BlockBehaviour$Properties)
- Block lambda$static$144(BlockBehaviour$Properties)
+ Block lambda$static$145(BlockBehaviour$Properties)
+ Block lambda$static$146(BlockBehaviour$Properties)
+ Block lambda$static$147(BlockBehaviour$Properties)
+ Block lambda$static$148(BlockBehaviour$Properties)
+ Block lambda$static$165(BlockBehaviour$Properties)
+ Block lambda$static$166(BlockBehaviour$Properties)
- Block lambda$static$168(BlockBehaviour$Properties)
- Block lambda$static$169(BlockBehaviour$Properties)
- Block lambda$static$171(BlockBehaviour$Properties)
- Block lambda$static$173(BlockBehaviour$Properties)
+ Block lambda$static$177(BlockBehaviour$Properties)
- Block lambda$static$178(BlockBehaviour$Properties)
+ Block lambda$static$179(BlockBehaviour$Properties)
+ Block lambda$static$180(BlockBehaviour$Properties)
+ Block lambda$static$184(BlockBehaviour$Properties)
+ Block lambda$static$187(BlockBehaviour$Properties)
- Block lambda$static$250(BlockBehaviour$Properties)
+ Block lambda$static$256(BlockBehaviour$Properties)
- Block lambda$static$317(BlockBehaviour$Properties)
- Block lambda$static$319(BlockBehaviour$Properties)
- Block lambda$static$322(BlockBehaviour$Properties)
- Block lambda$static$324(BlockBehaviour$Properties)
+ Block lambda$static$325(BlockBehaviour$Properties)
+ Block lambda$static$328(BlockBehaviour$Properties)
+ Block lambda$static$329(BlockBehaviour$Properties)
+ Block lambda$static$330(BlockBehaviour$Properties)
- Block lambda$static$378(BlockBehaviour$Properties)
- Block lambda$static$379(BlockBehaviour$Properties)
- Block lambda$static$381(BlockBehaviour$Properties)
- Block lambda$static$382(BlockBehaviour$Properties)
+ Block lambda$static$384(BlockBehaviour$Properties)
+ Block lambda$static$385(BlockBehaviour$Properties)
+ Block lambda$static$388(BlockBehaviour$Properties)
+ Block lambda$static$389(BlockBehaviour$Properties)
+ Block lambda$static$390(BlockBehaviour$Properties)
+ Block lambda$static$395(BlockBehaviour$Properties)
- Block lambda$static$402(BlockBehaviour$Properties)
- Block lambda$static$403(BlockBehaviour$Properties)
+ Block lambda$static$410(BlockBehaviour$Properties)
+ Block lambda$static$411(BlockBehaviour$Properties)
- Block lambda$static$428(BlockBehaviour$Properties)
- Block lambda$static$430(BlockBehaviour$Properties)
- Block lambda$static$432(BlockBehaviour$Properties)
- Block lambda$static$434(BlockBehaviour$Properties)
+ Block lambda$static$436(BlockBehaviour$Properties)
- Block lambda$static$439(BlockBehaviour$Properties)
+ Block lambda$static$442(BlockBehaviour$Properties)
+ Block lambda$static$446(BlockBehaviour$Properties)
+ Block lambda$static$447(BlockBehaviour$Properties)
+ Block lambda$static$448(BlockBehaviour$Properties)
- Block lambda$static$511(BlockBehaviour$Properties)
- Block lambda$static$512(BlockBehaviour$Properties)
- Block lambda$static$513(BlockBehaviour$Properties)
- Block lambda$static$514(BlockBehaviour$Properties)
- Block lambda$static$515(BlockBehaviour$Properties)
+ Block lambda$static$519(BlockBehaviour$Properties)
+ Block lambda$static$520(BlockBehaviour$Properties)
- Block lambda$static$524(BlockBehaviour$Properties)
- Block lambda$static$525(BlockBehaviour$Properties)
- Block lambda$static$526(BlockBehaviour$Properties)
- Block lambda$static$527(BlockBehaviour$Properties)
- Block lambda$static$528(BlockBehaviour$Properties)
- BlockBehaviour$Properties lambda$static$165(WeatheringCopper$WeatherState)
- BlockBehaviour$Properties lambda$static$166(WeatheringCopper$WeatherState)
- BlockBehaviour$Properties lambda$static$390(WeatheringCopper$WeatherState)
+ boolean lambda$static$322(BlockState,BlockGetter,BlockPos,EntityType)
+ boolean lambda$static$324(BlockState,BlockGetter,BlockPos,EntityType)
- boolean lambda$static$328(BlockState,BlockGetter,BlockPos,EntityType)
- boolean lambda$static$330(BlockState,BlockGetter,BlockPos,EntityType)
+ boolean lambda$static$439(BlockState,BlockGetter,BlockPos)
- boolean lambda$static$447(BlockState,BlockGetter,BlockPos)
+ int lambda$static$142(BlockState)
+ int lambda$static$144(BlockState)
- int lambda$static$145(BlockState)
- int lambda$static$146(BlockState)
- int lambda$static$147(BlockState)
- int lambda$static$148(BlockState)
+ int lambda$static$168(BlockState)
+ int lambda$static$169(BlockState)
+ int lambda$static$171(BlockState)
+ int lambda$static$173(BlockState)
- int lambda$static$177(BlockState)
+ int lambda$static$178(BlockState)
- int lambda$static$179(BlockState)
- int lambda$static$180(BlockState)
- int lambda$static$184(BlockState)
- int lambda$static$187(BlockState)
+ int lambda$static$250(BlockState)
- int lambda$static$256(BlockState)
+ int lambda$static$317(BlockState)
+ int lambda$static$319(BlockState)
- int lambda$static$325(BlockState)
- int lambda$static$329(BlockState)
+ int lambda$static$378(BlockState)
+ int lambda$static$379(BlockState)
+ int lambda$static$381(BlockState)
+ int lambda$static$382(BlockState)
- int lambda$static$384(BlockState)
- int lambda$static$385(BlockState)
- int lambda$static$388(BlockState)
- int lambda$static$389(BlockState)
- int lambda$static$395(BlockState)
+ int lambda$static$402(BlockState)
+ int lambda$static$403(BlockState)
- int lambda$static$410(BlockState)
- int lambda$static$411(BlockState)
+ int lambda$static$428(BlockState)
+ int lambda$static$430(BlockState)
+ int lambda$static$432(BlockState)
+ int lambda$static$434(BlockState)
- int lambda$static$436(BlockState)
- int lambda$static$442(BlockState)
- int lambda$static$446(BlockState)
- int lambda$static$448(BlockState)
...
- int lambda$static$519(BlockState)
- int lambda$static$520(BlockState)
- int lambda$static$522(BlockState)
- int lambda$static$523(BlockState)
- int lambda$static$529(BlockState)
```
...
+ BlockBehaviour$Properties noCollission()
```
...
```
XXX.blaze3d.font.GlyphInfo -1P
```
```
XXX.gui.font.FontManager$CachedFontProvider +2M -2M | +1P -1P
```
```
XXX.gui.font.FontSet$SelectedGlyphs +4M -4M | +2P -2P
```
```
...
```
```
XXX.screens.inventory.AbstractSignEditScreen +1M -1M
```
```
...
```
```
XXX.screens.inventory.EnchantmentNames +1P -1P
```
```
XXX.screens.inventory.StructureBlockEditScreen +1M -1M
```
```
XXX.screens.inventory.TestInstanceBlockEditScreen +1M -1M
```
```
XXX.client.main.GameConfig$UserData +1M -1M | -2P
```
```
XXX.client.player.RemotePlayer +1M -1M
```
```
XXX.client.renderer.ItemBlockRenderTypes +5M -2M
```
```
XXX.renderer.entity.ItemRenderer +1M -1M
```
```
XXX.entity.state.CopperGolemRenderState -2P
```
```
XXX.core.particles.ParticleTypes +1P
```
```
XXX.protocol.game.ClientboundAddEntityPacket +1M -3M | +1P -5P
```
```
...
```
```
XXX.metadata.pack.PackFormat$IntermediaryFormat +8M -10M
```
```
XXX.minecraft.tags.ItemTags +3P
```
```
XXX.item.component.TypedEntityData +1M -2M
```
...
```diff
+ FontSet fontSet(ResourceLocation)
- GlyphSource getGlyphSource(FontDescription)
- GlyphSource glyphs(FontDescription)
+ GlyphSource glyphs(ResourceLocation)
```
...
```diff
+ FontSet$BakeableGlyphImpl any()
+ FontSet$BakeableGlyphImpl nonFishy()
+ FontSet$BakeableGlyphImpl select(boolean)
- FontSet$StitchedBakeableGlyph any()
- FontSet$StitchedBakeableGlyph nonFishy()
- FontSet$StitchedBakeableGlyph select(boolean)
+ void <init>(FontSet$BakeableGlyphImpl,FontSet$BakeableGlyphImpl)
- void <init>(FontSet$StitchedBakeableGlyph,FontSet$StitchedBakeableGlyph)
```
...
```diff
+ void <init>(User,PropertyMap,PropertyMap,Proxy)
- void <init>(User,Proxy)
```
...
```diff
- void lambda$static$0(HashMap,ChunkSectionLayer,Block)
+ void lambda$static$0(HashMap)
- void lambda$static$1(HashMap,ChunkSectionLayer,Block)
+ void lambda$static$1(HashMap)
- void lambda$static$2(HashMap,ChunkSectionLayer,Block)
- void lambda$static$3(HashMap)
- void lambda$static$4(HashMap)
```
...
```diff
+ void renderStatic(ItemStack,ItemDisplayContext,int,int,PoseStack,MultiBufferSource,Level,Vec3,Direction,int)
...
```diff
- String lambda$validateNewFormat$10(String,String,InclusiveRange)
+ String lambda$validateNewFormat$10(String,String)
- String lambda$validateNewFormat$11(String,String,InclusiveRange)
+ String lambda$validateNewFormat$11(String,String,List)
- String lambda$validateNewFormat$12(String,int,int,String)
+ String lambda$validateNewFormat$12(String,String,List)
+ String lambda$validateNewFormat$13(String,int,int,String)
- String lambda$validateNewFormat$13(String)
- String lambda$validateNewFormat$14(String,int,int)
+ String lambda$validateNewFormat$14(String)
+ String lambda$validateNewFormat$15(String,int,int)
- String lambda$validateOldFormat$15(String,int)
+ String lambda$validateOldFormat$16(String,String)
- String lambda$validateOldFormat$16(String)
- String lambda$validateOldFormat$17(String,int,int)
+ String lambda$validateOldFormat$17(String,int)
+ String lambda$validateOldFormat$18(String)
+ String lambda$validateOldFormat$19(String,int,int)
```
...
```diff
+ App lambda$codec$0(Codec,RecordCodecBuilder$Instance)
- String lambda$loadInto$0()
+ String lambda$loadInto$1()
```
