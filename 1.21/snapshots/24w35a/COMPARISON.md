## Comparison with [24w34a](https://github.com/PixiGeko/Minecraft-generated-data/tree/24w34a)
...
<br/>
<table><tr><th></th><th align="left">24w34a</th><th>24w35a</th></tr><tr><td>DataPack version</td><td><pre>50</pre></td><td><pre>51</pre></td></tr><tr><td>World version</td><td><pre>4060</pre></td><td><pre>4062</pre></td></tr><tr><td>Protocol version</td><td><pre>1073742030</pre></td><td><pre>1073742031</pre></td></tr></table>
</details>
<hr/>
...
<table><tr><th></th><th align="left">24w34a</th><th>24w35a</th></tr><tr><td>minecraft:use_cooldown</td><td><pre>/</pre></td><td><pre>{
  "seconds": 1
}</pre></td></tr></table>
<br/>
</details>
...
<table><tr><th></th><th align="left">24w34a</th><th>24w35a</th></tr><tr><td>brush_completed_sound</td><td><pre>minecraft:item.brush.brushing.gravel.complete</pre></td><td><pre>minecraft:item.brush.brushing.gravel</pre></td></tr></table>
<br/>
</details>
<details>
<summary>
...
<table><tr><th></th><th align="left">24w34a</th><th>24w35a</th></tr><tr><td>brush_completed_sound</td><td><pre>minecraft:item.brush.brushing.sand.complete</pre></td><td><pre>minecraft:item.brush.brushing.sand</pre></td></tr></table>
<br/>
</details>
</details>
<hr/>
...
<br/>
<table>
<tr><th>Name</th><th>24w34a</th><th>24w35a</th></tr>
<tr><th align="left"><div style="width:290px">advancements.husbandry.silk_touch_nest.description</div></th><td>Move a Bee Nest, with 3 Bees inside, using Silk Touch</td><td>Move a Bee Nest or Beehive, with 3 Bees inside, using Silk Touch</td></tr>
</table>
<br/>
</details>
</details>
...
```diff
+ minecraft/loot_table/shearing/mooshroom.json
+ minecraft/loot_table/shearing/sheep.json
+ minecraft/trial_spawner/trial_chamber/breeze/normal.json
+ minecraft/trial_spawner/trial_chamber/breeze/ominous.json
+ minecraft/trial_spawner/trial_chamber/melee/husk/normal.json
+ minecraft/trial_spawner/trial_chamber/melee/husk/ominous.json
+ minecraft/trial_spawner/trial_chamber/melee/spider/normal.json
+ minecraft/trial_spawner/trial_chamber/melee/spider/ominous.json
+ minecraft/trial_spawner/trial_chamber/melee/zombie/normal.json
+ minecraft/trial_spawner/trial_chamber/melee/zombie/ominous.json
+ minecraft/trial_spawner/trial_chamber/ranged/poison_skeleton/normal.json
+ minecraft/trial_spawner/trial_chamber/ranged/poison_skeleton/ominous.json
+ minecraft/trial_spawner/trial_chamber/ranged/skeleton/normal.json
+ minecraft/trial_spawner/trial_chamber/ranged/skeleton/ominous.json
+ minecraft/trial_spawner/trial_chamber/ranged/stray/normal.json
+ minecraft/trial_spawner/trial_chamber/ranged/stray/ominous.json
+ minecraft/trial_spawner/trial_chamber/slow_ranged/poison_skeleton/normal.json
+ minecraft/trial_spawner/trial_chamber/slow_ranged/poison_skeleton/ominous.json
+ minecraft/trial_spawner/trial_chamber/slow_ranged/skeleton/normal.json
+ minecraft/trial_spawner/trial_chamber/slow_ranged/skeleton/ominous.json
+ minecraft/trial_spawner/trial_chamber/slow_ranged/stray/normal.json
+ minecraft/trial_spawner/trial_chamber/slow_ranged/stray/ominous.json
+ minecraft/trial_spawner/trial_chamber/small_melee/baby_zombie/normal.json
+ minecraft/trial_spawner/trial_chamber/small_melee/baby_zombie/ominous.json
+ minecraft/trial_spawner/trial_chamber/small_melee/cave_spider/normal.json
+ minecraft/trial_spawner/trial_chamber/small_melee/cave_spider/ominous.json
+ minecraft/trial_spawner/trial_chamber/small_melee/silverfish/normal.json
+ minecraft/trial_spawner/trial_chamber/small_melee/silverfish/ominous.json
+ minecraft/trial_spawner/trial_chamber/small_melee/slime/normal.json
+ minecraft/trial_spawner/trial_chamber/small_melee/slime/ominous.json
```
...
```diff
+ minecraft/models/block/bee_nest_empty.json
- minecraft/models/block/bee_nest.json
+ minecraft/models/block/beehive_empty.json
...
+ minecraft/textures/gui/sprites/container/bundle/bundle_progressbar_fill.png.mcmeta
+ minecraft/textures/gui/sprites/container/bundle/bundle_progressbar_full.png
+ minecraft/textures/gui/sprites/container/bundle/bundle_progressbar_full.png.mcmeta
```
...
```
XXX.minecraft.core.MappedRegistry +8M -9M | -1P
```
```
XXX.minecraft.core.MappedRegistry$2 +3M -4M | +1P
```
```
XXX.server.level.ServerEntity +1M -1M | +3P -3P
```
```
XXX.entity.animal.Bee +1M
```
```
XXX.entity.animal.MushroomCow$Variant +1M -2M | -1P
```
```
XXX.entity.animal.Salmon +6M
```
```
XXX.entity.animal.Sheep -1M
```
```
XXX.entity.animal.SnowGolem +2M -1M
```
```
XXX.animal.horse.TraderLlama +1M
```
```
XXX.entity.player.Player +2M
```
```
XXX.entity.projectile.ThrownTrident +2M -1M
```
```
XXX.entity.vehicle.NewMinecartBehavior$MinecartStep -2M | -1P
```
```
XXX.world.item.BowItem +1M -1M
```
```
...
```
```
XXX.world.item.TridentItem +1M -1M
```
```
...
+ Optional get(ResourceKey)
- Stream listTags()
- void <init>(MappedRegistry,ImmutableMap)
...
+ void handleMinecartPosRot(NewMinecartBehavior)
```
...
+ void <init>(String,int,String,BlockState,ResourceKey)
- void <init>(String,int,String,BlockState)
```
...
- float getSalmonScale()
- void lambda$saveToBucketTag$0(CompoundTag)
- void loadFromBucketTag(CompoundTag)
- void onSyncedDataUpdated(EntityDataAccessor)
- void saveToBucketTag(ItemStack)
```
...
```diff
- void lambda$performRangedAttack$1(double,double,double,double,Snowball)
+ void lambda$shear$1(ItemStack)
- void lambda$shear$2(ItemStack)
```
...
```diff
- boolean lambda$registerGoals$0(LivingEntity)
```
...
- void lambda$onHitEntity$0(Item)
```
...
```diff
+ byte compressRotation(float)
+ float uncompressRotation(byte)
```
...
```diff
- boolean releaseUsing(ItemStack,Level,LivingEntity,int)
...
- void doPostAttackEffectsWithItemSourceOnBreak(ServerLevel,Entity,DamageSource,ItemStack,Consumer)
...
- void lambda$doPostAttackEffectsWithItemSourceOnBreak$11(ServerLevel,Entity,DamageSource,Holder,int,EnchantedItemInUse)
...
+ void lambda$getPiercingCount$19(ServerLevel,ItemStack,MutableFloat,Holder,int)
...
+ void lambda$modifyDurabilityToRepairFromXp$22(ServerLevel,ItemStack,MutableFloat,Holder,int)
...
+ void lambda$processEquipmentDropChance$23(LootContext,MutableFloat,int,RandomSource,TargetedConditionalEffect)
- void lambda$processEquipmentDropChance$24(LootContext,MutableFloat,int,RandomSource,TargetedConditionalEffect)
+ void lambda$processEquipmentDropChance$24(ServerLevel,LivingEntity,DamageSource,MutableFloat,RandomSource,Holder,int,EnchantedItemInUse)
...
+ void lambda$processProjectileCount$17(ServerLevel,ItemStack,Entity,MutableFloat,Holder,int)
- void lambda$processProjectileCount$18(ServerLevel,ItemStack,Entity,MutableFloat,Holder,int)
+ void lambda$processProjectileSpread$18(ServerLevel,ItemStack,Entity,MutableFloat,Holder,int)
- void lambda$processProjectileSpread$19(ServerLevel,ItemStack,Entity,MutableFloat,Holder,int)
+ void lambda$runLocationChangedEffects$12(ServerLevel,LivingEntity,Holder,int,EnchantedItemInUse)
- void lambda$runLocationChangedEffects$14(ServerLevel,LivingEntity,Holder,int,EnchantedItemInUse)
+ void lambda$stopLocationBasedEffects$14(LivingEntity,Holder,int,EnchantedItemInUse)
- void lambda$stopLocationBasedEffects$16(LivingEntity,Holder,int,EnchantedItemInUse)
+ void lambda$tickEffects$16(ServerLevel,LivingEntity,Holder,int,EnchantedItemInUse)
...
```diff
- void neighborShapeChanged(Direction,BlockPos,BlockPos,BlockState,int,int)
+ void neighborShapeChanged(Direction,BlockState,BlockPos,BlockPos,int,int)
```
...
```
XXX.client.model.StriderModel -1M | -1P
```
```
XXX.client.model.TridentModel -1M | -1P
```
```
XXX.client.model.TropicalFishModelB -1M | -1P
```
```
XXX.client.model.VexModel -1M | -1P
```
```
XXX.client.model.VillagerModel -1M | -1P
```
```
XXX.client.model.WindChargeModel -1M
```
```
XXX.client.model.WitherBossModel -1M | -1P
```
```
XXX.model.dragon.EnderDragonModel -1M | -1P
```
```
XXX.client.renderer.FogRenderer +1M | +1P
```
```
XXX.renderer.entity.ArmadilloRenderer +1M -1M
```
```
XXX.renderer.entity.ArrowRenderer +1P
```
```
XXX.renderer.entity.BatRenderer +1M -1M
```
```
XXX.renderer.entity.BlazeRenderer -1M
```
```
XXX.renderer.entity.BreezeRenderer +1M -1M
```
```
XXX.renderer.entity.CatRenderer +1M -1M
```
```
XXX.renderer.entity.ChickenRenderer +1M -1M
```
```
XXX.renderer.entity.CowRenderer -1M
```
```
XXX.renderer.entity.DisplayRenderer +5M -2M
```
```
XXX.renderer.entity.DisplayRenderer$BlockDisplayRenderer +2M -1M
```
```
XXX.renderer.entity.DisplayRenderer$TextDisplayRenderer +2M -1M
```
```
...
```
```
XXX.renderer.entity.EndCrystalRenderer -2M
```
```
XXX.renderer.entity.EndermanRenderer +1M -1M
```
```
XXX.renderer.entity.EvokerRenderer +1M -1M
```
```
XXX.renderer.entity.ExperienceOrbRenderer -2M
```
```
XXX.renderer.entity.FireworkEntityRenderer -2M
```
```
XXX.renderer.entity.FoxRenderer +1M -1M
```
```
XXX.renderer.entity.GhastRenderer +1M -1M
```
```
XXX.renderer.entity.GlowSquidRenderer +1M -1M
```
```
XXX.renderer.entity.GuardianRenderer +1M -1M
```
```
XXX.renderer.entity.HorseRenderer +1M -1M
```
```
XXX.renderer.entity.HuskRenderer +1M -1M
```
```
XXX.renderer.entity.IllusionerRenderer +1M -1M
```
```
XXX.renderer.entity.IronGolemRenderer +1M -1M
```
```
XXX.renderer.entity.ItemFrameRenderer -2M
```
```
XXX.renderer.entity.LeashKnotRenderer -1M
```
```
XXX.renderer.entity.LivingEntityRenderer +1P
```
```
XXX.renderer.entity.LlamaRenderer +1M -1M
```
```
XXX.renderer.entity.LlamaSpitRenderer -2M
```
```
XXX.renderer.entity.MushroomCowRenderer +1M -1M
```
```
XXX.renderer.entity.OcelotRenderer +1M -1M
```
```
XXX.renderer.entity.PaintingRenderer -2M
```
```
XXX.renderer.entity.PandaRenderer +1M -1M
```
```
...
```
```
XXX.renderer.entity.PufferfishRenderer +1M -1M
```
```
XXX.renderer.entity.RenderLayerParent -1P
```
```
XXX.renderer.entity.SheepRenderer +1M -1M
```
```
XXX.renderer.entity.ShulkerRenderer +1M -1M
```
```
XXX.renderer.entity.SkeletonRenderer +1M -1M
```
```
XXX.renderer.entity.SnifferRenderer +1M -1M
```
```
XXX.renderer.entity.SpectralArrowRenderer -1M
```
```
...
```
```
XXX.renderer.entity.ThrownItemRenderer -2M
```
```
XXX.renderer.entity.TippableArrowRenderer +1M -1M
```
```
XXX.renderer.entity.TntRenderer -2M
```
```
...
```
```
XXX.renderer.entity.WardenRenderer +1M -1M
```
```
...
```
```
XXX.renderer.entity.ZombieRenderer -4M
```
```
XXX.renderer.entity.ZombifiedPiglinRenderer +1M -1M
```
```
XXX.entity.layers.HumanoidArmorLayer +1M -1M
```
```
XXX.entity.layers.ParrotOnShoulderLayer +1P
```
```
XXX.entity.layers.SpinAttackEffectLayer -2M | +1P -3P
```
```
XXX.minecraft.core.DefaultedRegistry +1P -1P
```
```
XXX.minecraft.core.HolderLookup$Provider$1 +2M -2M | +1P -1P
```
```
XXX.minecraft.core.Registry +2M -4M | +4P -10P
```
```
XXX.minecraft.core.RegistryAccess$1 +1M -1M
```
```
XXX.data.loot.EntityLootSubProvider +3M -4M | -1P
```
```
XXX.network.codec.ByteBufCodecs +1P
```
```
XXX.protocol.game.ClientboundRotateHeadPacket +1M -1M
```
```
XXX.level.block.RedstoneWallTorchBlock -1M
```
```
XXX.level.block.WallBannerBlock -1M
```
```
XXX.level.block.WallSkullBlock -1M
```
```
XXX.entity.trialspawner.TrialSpawner +7M -6M | +2P -2P
```
```
XXX.storage.loot.BuiltInLootTables +2P -1P
```
...
```diff
- int getBlockLightLevel(Display,BlockPos)
- int getBlockLightLevel(Entity,BlockPos)
- int getBrightnessOverride(Display)
- int getSkyLightLevel(Display,BlockPos)
- int getSkyLightLevel(Entity,BlockPos)
+ ResourceLocation getTextureLocation(DisplayEntityRenderState)
+ ResourceLocation getTextureLocation(EntityRenderState)
```
...
```diff
+ ResourceLocation getTextureLocation(EndCrystalRenderState)
+ ResourceLocation getTextureLocation(EntityRenderState)
```
...
```diff
+ ResourceLocation getTextureLocation(EntityRenderState)
+ ResourceLocation getTextureLocation(ExperienceOrbRenderState)
```
...
```diff
+ ResourceLocation getTextureLocation(EntityRenderState)
+ ResourceLocation getTextureLocation(FireworkRocketRenderState)
```
...
```diff
+ ResourceLocation getTextureLocation(EntityRenderState)
+ ResourceLocation getTextureLocation(ItemFrameRenderState)
```
...
```diff
+ ResourceLocation getTextureLocation(EntityRenderState)
+ ResourceLocation getTextureLocation(LlamaSpitRenderState)
```
...
```diff
+ ResourceLocation getTextureLocation(EntityRenderState)
+ ResourceLocation getTextureLocation(PaintingRenderState)
```
...
```diff
+ ResourceLocation getTextureLocation(EntityRenderState)
+ ResourceLocation getTextureLocation(ThrownItemRenderState)
```
...
```diff
- ResourceLocation getTextureLocation(ArrowRenderState)
+ ResourceLocation getTextureLocation(EntityRenderState)
```
...
```diff
+ ResourceLocation getTextureLocation(EntityRenderState)
+ ResourceLocation getTextureLocation(TntRenderState)
```
...
+ void extractRenderState(Zombie,ZombieRenderState,float)
```
...
```diff
- void renderArmorPiece(PoseStack,MultiBufferSource,HumanoidRenderState,ItemStack,EquipmentSlot,int,HumanoidModel)
+ void renderArmorPiece(PoseStack,MultiBufferSource,ItemStack,EquipmentSlot,int,HumanoidModel)
```
...
```diff
+ HolderGetter lambda$lookup$0(HolderLookup$RegistryLookup)
...
+ IllegalStateException lambda$getHolderOrThrow$9(ResourceKey)
+ Object getOrThrow(ResourceKey)
- Object getValueOrThrow(ResourceKey)
+ Optional lambda$getRandomElementOf$10(RandomSource,HolderSet$Named)
...
```diff
+ boolean canHaveLootTable(EntityType)
- IllegalStateException lambda$add$3(EntityType)
- LootPool$Builder createSheepDispatchPool(Map)
+ LootTable$Builder createSheepTable(ItemLike)
+ Map lambda$add$3(EntityType)
- Map lambda$add$4(EntityType)
+ void <clinit>()
```
...
+ boolean lambda$tickServer$3(ServerLevel,BlockPos,UUID)
- boolean lambda$tickServer$5(ServerLevel,BlockPos,UUID)
+ Entity lambda$spawnMob$2(double,double,double,RandomSource,Entity)
- Entity lambda$spawnMob$4(double,double,double,RandomSource,Entity)
- Holder lambda$codec$0(TrialSpawner)
- Holder lambda$codec$1(TrialSpawner)
+ TrialSpawner lambda$codec$0(TrialSpawnerConfig,TrialSpawnerConfig,TrialSpawnerData,Integer,Integer)
- TrialSpawner lambda$codec$2(Holder,Holder,TrialSpawnerData,Integer,Integer)
+ TrialSpawnerConfig getOminousConfigForSerialization()
- void <init>(Holder,Holder,TrialSpawnerData,int,int,TrialSpawner$StateAccessor,PlayerDetector,PlayerDetector$EntitySelector)
