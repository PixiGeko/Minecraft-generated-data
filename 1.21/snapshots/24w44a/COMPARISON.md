## Comparison with [1.21.3](https://github.com/PixiGeko/Minecraft-generated-data/tree/1.21.3)
...
<br/>
<table><tr><th></th><th align="left">1.21.3</th><th>24w44a</th></tr><tr><td>DataPack version</td><td><pre>57</pre></td><td><pre>58</pre></td></tr><tr><td>ResourcePack version</td><td><pre>42</pre></td><td><pre>43</pre></td></tr><tr><td>World version</td><td><pre>4082</pre></td><td><pre>4174</pre></td></tr><tr><td>Protocol version</td><td><pre>768</pre></td><td><pre>1073742044</pre></td></tr></table>
<h3>Libraries<a name="version-data-libraries"></a></h3>
<details>
<summary>
Versions
</summary>
<table><tr><th></th><th align="left">1.21.3</th><th>24w44a</th></tr><tr><td>com.mojang:authlib</td><td><pre>6.0.55</pre></td><td><pre>6.0.57</pre></td></tr></table>
</details>
</details>
<hr/>
...
<table><tr><th></th><th align="left">1.21.3</th><th>24w44a</th></tr><tr><td>minecraft:container</td><td><pre>/</pre></td><td><pre>[]</pre></td></tr></table>
<br/>
</details>
</details>
<hr/>
...
<table><tr><th></th><th align="left">1.21.3</th><th>24w44a</th></tr><tr><td>type</td><td><pre>minecraft:cherry_leaves</pre></td><td><pre>minecraft:particle_leaves</pre></td></tr><tr><td>chance</td><td><pre>/</pre></td><td><pre>10</pre></td></tr><tr><td>particle</td><td><pre>/</pre></td><td><pre>{
...
<table><tr><th></th><th align="left">1.21.3</th><th>24w44a</th></tr><tr><td>type</td><td><pre>minecraft:leaves</pre></td><td><pre>minecraft:particle_leaves</pre></td></tr><tr><td>chance</td><td><pre>/</pre></td><td><pre>50</pre></td></tr><tr><td>particle</td><td><pre>/</pre></td><td><pre>{
...
```diff
+ attribute <target: entity> <attribute: resource> base reset
```
...
+ item.op_block_warning.line2: Placing this item might lead to command execution
...
+ subtitles.item.elytra.flying: Elytra swooshes
...
```diff
+ minecraft/advancement/recipes/building_blocks/chiseled_resin_bricks_from_resin_bricks_stonecutting.json
+ minecraft/advancement/recipes/building_blocks/chiseled_resin_bricks.json
+ minecraft/advancement/recipes/building_blocks/pale_oak_planks.json
+ minecraft/advancement/recipes/building_blocks/pale_oak_slab.json
+ minecraft/advancement/recipes/building_blocks/pale_oak_stairs.json
+ minecraft/advancement/recipes/building_blocks/pale_oak_wood.json
+ minecraft/advancement/recipes/building_blocks/resin_block.json
+ minecraft/advancement/recipes/building_blocks/resin_brick_slab_from_resin_bricks_stonecutting.json
+ minecraft/advancement/recipes/building_blocks/resin_brick_slab.json
+ minecraft/advancement/recipes/building_blocks/resin_brick_stairs_from_resin_bricks_stonecutting.json
+ minecraft/advancement/recipes/building_blocks/resin_brick_stairs.json
+ minecraft/advancement/recipes/building_blocks/resin_bricks.json
+ minecraft/advancement/recipes/building_blocks/stripped_pale_oak_wood.json
+ minecraft/advancement/recipes/decorations/pale_moss_carpet.json
+ minecraft/advancement/recipes/decorations/pale_oak_fence.json
+ minecraft/advancement/recipes/decorations/pale_oak_hanging_sign.json
+ minecraft/advancement/recipes/decorations/pale_oak_sign.json
+ minecraft/advancement/recipes/decorations/resin_brick_wall_from_resin_bricks_stonecutting.json
+ minecraft/advancement/recipes/decorations/resin_brick_wall.json
+ minecraft/advancement/recipes/food/suspicious_stew_from_closed_eyeblossom.json
+ minecraft/advancement/recipes/food/suspicious_stew_from_open_eyeblossom.json
+ minecraft/advancement/recipes/misc/creaking_heart.json
+ minecraft/advancement/recipes/misc/gray_dye_from_closed_eyeblossom.json
+ minecraft/advancement/recipes/misc/orange_dye_from_open_eyeblossom.json
+ minecraft/advancement/recipes/misc/resin_brick.json
+ minecraft/advancement/recipes/misc/resin_clump.json
+ minecraft/advancement/recipes/redstone/pale_oak_button.json
+ minecraft/advancement/recipes/redstone/pale_oak_door.json
+ minecraft/advancement/recipes/redstone/pale_oak_fence_gate.json
+ minecraft/advancement/recipes/redstone/pale_oak_pressure_plate.json
+ minecraft/advancement/recipes/redstone/pale_oak_trapdoor.json
+ minecraft/advancement/recipes/transportation/pale_oak_boat.json
+ minecraft/advancement/recipes/transportation/pale_oak_chest_boat.json
...
- minecraft/datapacks/winter_drop/data/minecraft/tags/worldgen/biome/is_overworld.json
...
+ minecraft/loot_table/blocks/chiseled_resin_bricks.json
+ minecraft/loot_table/blocks/closed_eyeblossom.json
+ minecraft/loot_table/blocks/open_eyeblossom.json
+ minecraft/loot_table/blocks/potted_closed_eyeblossom.json
+ minecraft/loot_table/blocks/potted_open_eyeblossom.json
+ minecraft/loot_table/blocks/resin_block.json
+ minecraft/loot_table/blocks/resin_brick_slab.json
+ minecraft/loot_table/blocks/resin_brick_stairs.json
+ minecraft/loot_table/blocks/resin_brick_wall.json
+ minecraft/loot_table/blocks/resin_bricks.json
+ minecraft/loot_table/blocks/resin_clump.json
+ minecraft/recipe/chiseled_resin_bricks_from_resin_bricks_stonecutting.json
+ minecraft/recipe/chiseled_resin_bricks.json
+ minecraft/recipe/creaking_heart.json
+ minecraft/recipe/gray_dye_from_closed_eyeblossom.json
+ minecraft/recipe/orange_dye_from_open_eyeblossom.json
+ minecraft/recipe/pale_moss_carpet.json
+ minecraft/recipe/pale_oak_boat.json
+ minecraft/recipe/pale_oak_button.json
+ minecraft/recipe/pale_oak_chest_boat.json
+ minecraft/recipe/pale_oak_door.json
+ minecraft/recipe/pale_oak_fence_gate.json
+ minecraft/recipe/pale_oak_fence.json
+ minecraft/recipe/pale_oak_hanging_sign.json
+ minecraft/recipe/pale_oak_planks.json
+ minecraft/recipe/pale_oak_pressure_plate.json
+ minecraft/recipe/pale_oak_sign.json
+ minecraft/recipe/pale_oak_slab.json
+ minecraft/recipe/pale_oak_stairs.json
+ minecraft/recipe/pale_oak_trapdoor.json
+ minecraft/recipe/pale_oak_wood.json
+ minecraft/recipe/resin_block.json
+ minecraft/recipe/resin_brick_slab_from_resin_bricks_stonecutting.json
+ minecraft/recipe/resin_brick_slab.json
+ minecraft/recipe/resin_brick_stairs_from_resin_bricks_stonecutting.json
+ minecraft/recipe/resin_brick_stairs.json
+ minecraft/recipe/resin_brick_wall_from_resin_bricks_stonecutting.json
+ minecraft/recipe/resin_brick_wall.json
+ minecraft/recipe/resin_brick.json
+ minecraft/recipe/resin_bricks.json
+ minecraft/recipe/resin_clump.json
+ minecraft/recipe/stripped_pale_oak_wood.json
+ minecraft/recipe/suspicious_stew_from_closed_eyeblossom.json
+ minecraft/recipe/suspicious_stew_from_open_eyeblossom.json
+ minecraft/tags/block/pale_oak_logs.json
+ minecraft/tags/item/pale_oak_logs.json
+ minecraft/trim_material/resin.json
+ minecraft/worldgen/biome/pale_garden.json
+ minecraft/worldgen/configured_feature/flower_pale_garden.json
+ minecraft/worldgen/configured_feature/pale_forest_flowers.json
+ minecraft/worldgen/configured_feature/pale_moss_patch.json
+ minecraft/worldgen/configured_feature/pale_oak_bonemeal.json
+ minecraft/worldgen/placed_feature/flower_pale_garden.json
+ minecraft/worldgen/placed_feature/pale_garden_flowers.json
+ minecraft/worldgen/placed_feature/pale_moss_patch.json
```
...
```diff
+ minecraft/blockstates/chiseled_resin_bricks.json
+ minecraft/blockstates/closed_eyeblossom.json
+ minecraft/blockstates/open_eyeblossom.json
+ minecraft/blockstates/potted_closed_eyeblossom.json
+ minecraft/blockstates/potted_open_eyeblossom.json
+ minecraft/blockstates/resin_block.json
+ minecraft/blockstates/resin_brick_slab.json
+ minecraft/blockstates/resin_brick_stairs.json
+ minecraft/blockstates/resin_brick_wall.json
+ minecraft/blockstates/resin_bricks.json
+ minecraft/blockstates/resin_clump.json
+ minecraft/models/block/chiseled_resin_bricks.json
+ minecraft/models/block/closed_eyeblossom.json
+ minecraft/models/block/cross_emissive.json
+ minecraft/models/block/flower_pot_cross_emissive.json
+ minecraft/models/block/open_eyeblossom.json
+ minecraft/models/block/potted_closed_eyeblossom.json
+ minecraft/models/block/potted_open_eyeblossom.json
+ minecraft/models/block/resin_block.json
+ minecraft/models/block/resin_brick_slab_top.json
+ minecraft/models/block/resin_brick_slab.json
+ minecraft/models/block/resin_brick_stairs_inner.json
+ minecraft/models/block/resin_brick_stairs_outer.json
+ minecraft/models/block/resin_brick_stairs.json
+ minecraft/models/block/resin_brick_wall_inventory.json
+ minecraft/models/block/resin_brick_wall_post.json
+ minecraft/models/block/resin_brick_wall_side_tall.json
+ minecraft/models/block/resin_brick_wall_side.json
+ minecraft/models/block/resin_bricks.json
+ minecraft/models/block/resin_clump.json
+ minecraft/models/item/chainmail_boots_resin_trim.json
+ minecraft/models/item/chainmail_chestplate_resin_trim.json
+ minecraft/models/item/chainmail_helmet_resin_trim.json
+ minecraft/models/item/chainmail_leggings_resin_trim.json
+ minecraft/models/item/chiseled_resin_bricks.json
+ minecraft/models/item/closed_eyeblossom.json
+ minecraft/models/item/diamond_boots_resin_trim.json
+ minecraft/models/item/diamond_chestplate_resin_trim.json
+ minecraft/models/item/diamond_helmet_resin_trim.json
+ minecraft/models/item/diamond_leggings_resin_trim.json
+ minecraft/models/item/golden_boots_resin_trim.json
+ minecraft/models/item/golden_chestplate_resin_trim.json
+ minecraft/models/item/golden_helmet_resin_trim.json
+ minecraft/models/item/golden_leggings_resin_trim.json
+ minecraft/models/item/iron_boots_resin_trim.json
+ minecraft/models/item/iron_chestplate_resin_trim.json
+ minecraft/models/item/iron_helmet_resin_trim.json
+ minecraft/models/item/iron_leggings_resin_trim.json
+ minecraft/models/item/leather_boots_resin_trim.json
+ minecraft/models/item/leather_chestplate_resin_trim.json
+ minecraft/models/item/leather_helmet_resin_trim.json
+ minecraft/models/item/leather_leggings_resin_trim.json
+ minecraft/models/item/netherite_boots_resin_trim.json
+ minecraft/models/item/netherite_chestplate_resin_trim.json
+ minecraft/models/item/netherite_helmet_resin_trim.json
+ minecraft/models/item/netherite_leggings_resin_trim.json
+ minecraft/models/item/open_eyeblossom.json
...
+ minecraft/models/item/resin_brick.json
+ minecraft/models/item/resin_bricks.json
+ minecraft/models/item/resin_clump.json
+ minecraft/models/item/turtle_helmet_resin_trim.json
+ minecraft/particles/pale_oak_leaves.json
+ minecraft/textures/block/chiseled_resin_bricks.png
+ minecraft/textures/block/closed_eyeblossom.png
+ minecraft/textures/block/open_eyeblossom_emissive.png
+ minecraft/textures/block/open_eyeblossom.png
+ minecraft/textures/block/resin_block.png
+ minecraft/textures/block/resin_bricks.png
+ minecraft/textures/block/resin_clump.png
+ minecraft/textures/gui/sprites/advancements/box_obtained.png.mcmeta
+ minecraft/textures/gui/sprites/advancements/box_unobtained.png.mcmeta
...
+ minecraft/textures/gui/sprites/container/slot/amethyst_shard.png
+ minecraft/textures/gui/sprites/container/slot/axe.png
+ minecraft/textures/gui/sprites/container/slot/banner_pattern.png
+ minecraft/textures/gui/sprites/container/slot/banner.png
+ minecraft/textures/gui/sprites/container/slot/boots.png
+ minecraft/textures/gui/sprites/container/slot/brewing_fuel.png
+ minecraft/textures/gui/sprites/container/slot/chestplate.png
+ minecraft/textures/gui/sprites/container/slot/diamond.png
+ minecraft/textures/gui/sprites/container/slot/dye.png
+ minecraft/textures/gui/sprites/container/slot/emerald.png
+ minecraft/textures/gui/sprites/container/slot/helmet.png
+ minecraft/textures/gui/sprites/container/slot/hoe.png
+ minecraft/textures/gui/sprites/container/slot/horse_armor.png
+ minecraft/textures/gui/sprites/container/slot/ingot.png
+ minecraft/textures/gui/sprites/container/slot/lapis_lazuli.png
+ minecraft/textures/gui/sprites/container/slot/leggings.png
+ minecraft/textures/gui/sprites/container/slot/llama_armor.png
+ minecraft/textures/gui/sprites/container/slot/pickaxe.png
+ minecraft/textures/gui/sprites/container/slot/potion.png
+ minecraft/textures/gui/sprites/container/slot/quartz.png
+ minecraft/textures/gui/sprites/container/slot/redstone_dust.png
+ minecraft/textures/gui/sprites/container/slot/saddle.png
+ minecraft/textures/gui/sprites/container/slot/shield.png
+ minecraft/textures/gui/sprites/container/slot/shovel.png
+ minecraft/textures/gui/sprites/container/slot/smithing_template_armor_trim.png
+ minecraft/textures/gui/sprites/container/slot/smithing_template_netherite_upgrade.png
+ minecraft/textures/gui/sprites/container/slot/sword.png
+ minecraft/textures/gui/sprites/toast/system.png.mcmeta
+ minecraft/textures/gui/sprites/toast/tutorial.png.mcmeta
...
+ minecraft/textures/item/resin_brick.png
+ minecraft/textures/item/resin_clump.png
+ minecraft/textures/particle/pale_oak_0.png
+ minecraft/textures/particle/pale_oak_1.png
+ minecraft/textures/particle/pale_oak_10.png
+ minecraft/textures/particle/pale_oak_11.png
+ minecraft/textures/particle/pale_oak_2.png
+ minecraft/textures/particle/pale_oak_3.png
+ minecraft/textures/particle/pale_oak_4.png
+ minecraft/textures/particle/pale_oak_5.png
+ minecraft/textures/particle/pale_oak_6.png
+ minecraft/textures/particle/pale_oak_7.png
+ minecraft/textures/particle/pale_oak_8.png
+ minecraft/textures/particle/pale_oak_9.png
...
```
XXX.arguments.blocks.BlockInput +2M
```
```
XXX.server.level.TicketType -1P
```
```
XXX.server.network.ServerGamePacketListenerImpl +4M -1M
```
```
XXX.minecraft.sounds.SoundEvents +16P
```
```
XXX.profiling.jfr.JvmProfiler$NoOpProfiler +2M -1M
```
```
XXX.jfr.parse.JfrStatsResult +2M -1M | +1P
```
```
XXX.jfr.serialize.JfrResultJsonSerializer +17M -12M
```
```
...
```diff
- BlockState copyProperty(BlockState,BlockState,Property)
- BlockState overwriteWithDefinedProperties(BlockState)
```
...
```diff
- void addBlockDataToItem(BlockState,ServerLevel,BlockPos,ItemStack)
+ void handlePickItem(ServerboundPickItemPacket)
- void handlePickItemFromBlock(ServerboundPickItemFromBlockPacket)
- void handlePickItemFromEntity(ServerboundPickItemFromEntityPacket)
- void tryPickItem(ItemStack)
```
...
```diff
- ProfiledDuration onStructureGenerate(ChunkPos,ResourceKey,Holder)
+ void lambda$static$0()
- void lambda$static$0(boolean)
```
...
```diff
- List structureGenStats()
- void <init>(Instant,Instant,Duration,Duration,List,List,GcHeapStat$Summary,ThreadAllocationStat$Summary,IoSummary,IoSummary,IoSummary,IoSummary,FileIOStat$Summary,FileIOStat$Summary,List,List)
...
```diff
+ double lambda$chunkGen$0(Pair)
- double lambda$chunkGen$4(Pair)
- double lambda$serverTicks$11(TickTimeStat)
+ double lambda$serverTicks$7(TickTimeStat)
+ JsonElement lambda$chunkGen$4(ChunkGenStat)
- JsonElement lambda$chunkGen$8(ChunkGenStat)
- JsonElement lambda$structureGen$2(StructureGenStat)
- JsonElement structureGen(List)
+ JsonObject lambda$cpu$11(List,ToDoubleFunction)
- JsonObject lambda$cpu$15(List,ToDoubleFunction)
+ void lambda$chunkGen$1(JsonObject,JsonArray)
+ void lambda$chunkGen$2(JsonObject,JsonObject)
+ void lambda$chunkGen$3(JsonObject,Integer,Double)
- void lambda$chunkGen$5(JsonObject,JsonArray)
- void lambda$chunkGen$6(JsonObject,JsonObject)
- void lambda$chunkGen$7(JsonObject,Integer,Double)
- void lambda$fileIoSummary$13(JsonArray,Pair)
+ void lambda$fileIoSummary$9(JsonArray,Pair)
+ void lambda$ioSummary$10(JsonArray,BiConsumer,Pair)
- void lambda$ioSummary$14(JsonArray,BiConsumer,Pair)
- void lambda$serverTicks$12(JsonObject,Integer,Double)
+ void lambda$serverTicks$8(JsonObject,Integer,Double)
- void lambda$structureGen$0(JsonObject,JsonObject)
- void lambda$structureGen$1(JsonObject,Integer,Double)
- void lambda$structureGen$3(JsonArray,JsonObject,TimedStatSummary,String,List)
- void lambda$threadAllocations$10(JsonArray,String,Double)
+ void lambda$threadAllocations$5(String,Double,JsonObject)
+ void lambda$threadAllocations$6(JsonArray,String,Double)
- void lambda$threadAllocations$9(String,Double,JsonObject)
```
...
```
XXX.blaze3d.vertex.VertexBuffer +2M
```
```
XXX.animation.definitions.CreakingAnimation +1P
```
```
XXX.client.gui.Gui +1M -1M
```
```
XXX.components.toasts.SystemToast -1M
```
```
XXX.components.toasts.TutorialToast +4M -2M | +7P -3P
```
```
XXX.font.glyphs.BakedGlyph +3M -1M | +1P
```
```
XXX.font.glyphs.BakedGlyph$GlyphInstance +4M -1M | +2P
```
```
XXX.gui.screens.CreateFlatWorldScreen +1M -1M | +2P -2P
```
```
XXX.screens.inventory.CreativeModeInventoryScreen$SlotWrapper +1M -1M
```
```
XXX.screens.inventory.HorseInventoryScreen +1M | +1P -3P
```
```
XXX.client.model.ChickenModel -2P
```
```
XXX.client.model.DonkeyModel +2M -2M | +2P
```
```
XXX.client.model.FelineModel -1P
```
```
XXX.client.model.RabbitModel -5P
```
```
XXX.client.model.WitchModel +1M | +1P
```
```
XXX.client.model.ZombieVillagerModel +1M
```
```
XXX.model.geom.LayerDefinitions +1M -1M
```
```
XXX.model.geom.ModelLayers +1M -1M | +7P -1P
```
```
...
```
```
XXX.client.particle.ItemPickupParticle +3M -2M | -1P
```
```
XXX.client.particle.Particle +1M
```
```
XXX.renderer.entity.AbstractHorseRenderer +1M -3M | -1P
```
```
XXX.renderer.entity.DisplayRenderer +4M
```
```
XXX.renderer.entity.DisplayRenderer$BlockDisplayRenderer +2M
```
```
XXX.renderer.entity.DisplayRenderer$TextDisplayRenderer +2M
```
```
XXX.renderer.entity.DonkeyRenderer +1M -1M
```
```
XXX.renderer.entity.PufferfishRenderer +3M
```
```
XXX.renderer.entity.SlimeRenderer +3M -3M
```
```
XXX.entity.layers.CrossedArmsItemLayer +1M
```
```
XXX.resources.server.DownloadedPackSource$3 +1M
```
```
...
```
```
XXX.worldgen.features.VegetationFeatures +3P
```
```
XXX.network.chat.Style$Serializer +2M -1M
```
```
XXX.protocol.game.ClientboundLevelParticlesPacket +2M -1M | +1P
```
```
XXX.protocol.game.ClientboundPlayerInfoUpdatePacket$Entry +2M -1M | +1P
```
```
XXX.protocol.game.ClientboundSetHeldSlotPacket +4M -3M
```
```
XXX.protocol.game.GamePacketTypes +2P -1P
```
```
XXX.protocol.game.ServerGamePacketListener +2P -1P
```
```
XXX.entity.animal.Bee +1M
```
```
XXX.entity.animal.Salmon +1P
```
```
XXX.monster.creaking.Creaking +3M -2M | +1P
```
```
XXX.entity.player.Inventory +1M -1M
```
```
XXX.entity.projectile.AbstractArrow +3M -1M | +2P
```
```
XXX.entity.projectile.AbstractHurtingProjectile -2M
```
```
XXX.entity.vehicle.MinecartTNT +4P
```
```
XXX.world.inventory.ArmorSlot +1M -1M
```
```
XXX.world.inventory.BrewingStandMenu$FuelSlot +1M
```
```
XXX.world.inventory.BrewingStandMenu$PotionSlot +1M
```
```
XXX.world.inventory.EnchantmentMenu$3 +1M -1M
```
```
XXX.world.inventory.HorseInventoryMenu +1M | +3P
```
```
XXX.world.inventory.InventoryMenu$1 +1M -1M
```
```
XXX.world.item.EnderpearlItem +1M | +1P
```
```
XXX.world.item.Item$TooltipContext +1M -1M | +1P
```
```
XXX.world.item.Item$TooltipContext$2 +2M -1M | +1P
```
```
XXX.world.item.ItemStack +1M
```
```
XXX.world.item.TridentItem +1P -1P
```
```
XXX.equipment.trim.TrimMaterials +1P
```
```
XXX.item.trading.Merchant +1P
```
```
XXX.world.level.Level +1M -1M | +1P
```
```
XXX.level.biome.BiomeSpecialEffects$Builder +3M | +1P
```
```
XXX.level.biome.MultiNoiseBiomeSourceParameterList$Preset +1M -1M | -1P
```
```
XXX.level.block.Block -1M
```
```
XXX.level.block.FlowerPotBlock +3M
```
```
XXX.level.block.MultifaceBlock +2M | +1P -2P
```
```
XXX.level.block.WitherRoseBlock +1M
```
```
XXX.block.entity.BlockEntity -1M
```
```
...
```
```
XXX.level.chunk.ChunkGenerator +3M -3M
```
```
XXX.structure.pools.JigsawPlacement +1M
```
...
```diff
- VertexBuffer uploadStatic(VertexFormat$Mode,VertexFormat,Consumer)
- void drawWithRenderType(RenderType)
```
...
- int contentHeight()
- int height()
- void <init>(Font,TutorialToast$Icons,Component,Component,boolean,int)
- void <init>(Font,TutorialToast$Icons,Component,Component,boolean)
+ void <init>(TutorialToast$Icons,Component,Component,boolean,int)
+ void <init>(TutorialToast$Icons,Component,Component,boolean)
```
...
```diff
- void buildEffect(BakedGlyph$Effect,float,float,int,VertexConsumer,int,Matrix4f)
- void render(boolean,float,float,float,Matrix4f,VertexConsumer,int,boolean,int)
- void render(boolean,float,float,Matrix4f,VertexConsumer,int,boolean,int)
+ void render(boolean,float,float,Matrix4f,VertexConsumer,int,int)
```
...
- float shadowOffset()
- int shadowColor()
+ void <init>(float,float,int,BakedGlyph,Style,float)
- void <init>(float,float,int,int,BakedGlyph,Style,float,float)
```
...
```diff
- void drawSlot(GuiGraphics,int,int)
```
...
```diff
+ LayerDefinition createBabyLayer()
- LayerDefinition createBabyLayer(float)
+ LayerDefinition createBodyLayer()
- LayerDefinition createBodyLayer(float)
```
...
```diff
+ void lambda$createRoots$0(ImmutableMap$Builder,LayerDefinition,LayerDefinition,LayerDefinition,WoodType)
...
```diff
- ModelLayerLocation createHangingSignModelName(WoodType,HangingSignRenderer$AttachmentType)
+ ModelLayerLocation createHangingSignModelName(WoodType)
```
...
```diff
+ void handlePickItem(int)
- void handlePickItemFromBlock(BlockPos,boolean)
- void handlePickItemFromEntity(Entity,boolean)
```
...
```diff
- void <init>(EntityRenderDispatcher,ClientLevel,Entity,Entity,Vec3)
- void <init>(EntityRenderDispatcher,ClientLevel,Entity,Entity)
+ void <init>(EntityRenderDispatcher,RenderBuffers,ClientLevel,Entity,Entity,Vec3)
+ void <init>(EntityRenderDispatcher,RenderBuffers,ClientLevel,Entity,Entity)
- void renderCustom(PoseStack,MultiBufferSource,Camera,float)
```
...
```diff
+ void <init>(EntityRendererProvider$Context,EntityModel,EntityModel,float)
- void <init>(EntityRendererProvider$Context,EntityModel,EntityModel)
+ void scale(EquineRenderState,PoseStack)
...
```diff
- float getShadowRadius(DisplayEntityRenderState)
- float getShadowRadius(EntityRenderState)
- float getShadowStrength(DisplayEntityRenderState)
- float getShadowStrength(EntityRenderState)
```
...
```diff
+ void <init>(EntityRendererProvider$Context,float,ModelLayerLocation,ModelLayerLocation,boolean)
- void <init>(EntityRendererProvider$Context,ModelLayerLocation,ModelLayerLocation,boolean)
```
...
- float getShadowRadius(PufferfishRenderState)
```
...
- float getShadowRadius(EntityRenderState)
- float getShadowRadius(LivingEntityRenderState)
- float getShadowRadius(SlimeRenderState)
...
```diff
- TextureMapping crossEmissive(Block)
- TextureMapping plantEmissive(Block)
```
...
- Optional lambda$static$10(Style)
```
...
```diff
- boolean alwaysShow()
- void <init>(ParticleOptions,boolean,boolean,double,double,double,float,float,float,float,int)
+ void <init>(ParticleOptions,boolean,double,double,double,float,float,float,float,int)
```
...
```diff
- boolean showHat()
- void <init>(UUID,GameProfile,boolean,int,GameType,Component,boolean,int,RemoteChatSession$Data)
+ void <init>(UUID,GameProfile,boolean,int,GameType,Component,int,RemoteChatSession$Data)
```
...
```diff
+ boolean lambda$checkCanMove$0(LivingEntity)
+ double lambda$checkCanMove$1()
...
```diff
- void addAndPickItem(ItemStack)
+ void setPickedItem(ItemStack)
```
...
```diff
+ void applyInertia()
- void applyInertia(float)
- void onInsideBubbleColumn(boolean)
...
```diff
- Item$TooltipContext of(Level,Player)
...
```diff
- void addParticle(ParticleOptions,boolean,boolean,double,double,double,double,double,double)
+ void addParticle(ParticleOptions,boolean,double,double,double,double,double,double)
```
...
```diff
- BiomeSpecialEffects$Builder backgroundMusic(SimpleWeightedRandomList)
- BiomeSpecialEffects$Builder backgroundMusicVolume(float)
...
```diff
+ Climate$ParameterList generateOverworldBiomes(Function,OverworldBiomeBuilder$Modifier)
- Climate$ParameterList generateOverworldBiomes(Function)
```
...
```diff
- BlockState opposite(BlockState)
...
```diff
- boolean canAttachTo(BlockGetter,BlockPos,Direction)
- MapCodec codec()
```
...
```diff
- MobEffectInstance getBeeInteractionEffect()
```
...
```diff
- ItemStack getCloneItemStack(LevelReader,BlockPos)
```
...
```diff
- boolean tryGenerateStructure(StructureSet$StructureSelectionEntry,StructureManager,RegistryAccess,RandomState,StructureTemplateManager,long,ChunkAccess,ChunkPos,SectionPos,ResourceKey)
+ boolean tryGenerateStructure(StructureSet$StructureSelectionEntry,StructureManager,RegistryAccess,RandomState,StructureTemplateManager,long,ChunkAccess,ChunkPos,SectionPos)
- void createStructures(RegistryAccess,ChunkGeneratorStructureState,StructureManager,ChunkAccess,StructureTemplateManager,ResourceKey)
+ void createStructures(RegistryAccess,ChunkGeneratorStructureState,StructureManager,ChunkAccess,StructureTemplateManager)
+ void lambda$createStructures$14(StructureManager,SectionPos,ChunkAccess,ChunkGeneratorStructureState,ChunkPos,RegistryAccess,RandomState,StructureTemplateManager,Holder)
- void lambda$createStructures$14(StructureManager,SectionPos,ChunkAccess,ChunkGeneratorStructureState,ChunkPos,RegistryAccess,RandomState,StructureTemplateManager,ResourceKey,Holder)
```
...
```diff
- boolean isStartTooCloseToWorldHeightLimits(LevelHeightAccessor,DimensionPadding,BoundingBox)
```
