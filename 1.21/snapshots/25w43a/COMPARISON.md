## Comparison with [25w42a](https://github.com/PixiGeko/Minecraft-generated-data/tree/25w42a)
...
<br/>
<table><tr><th></th><th align="left">25w42a</th><th>25w43a</th></tr><tr><td>DataPack version</td><td><pre>{
  "major": 90,
  "minor": 0
}</pre></td><td><pre>{
  "major": 91,
  ...
  "major": 71,
  "minor": 0
}</pre></td></tr><tr><td>World version</td><td><pre>4654</pre></td><td><pre>4655</pre></td></tr><tr><td>Protocol version</td><td><pre>1073742098</pre></td><td><pre>1073742099</pre></td></tr></table>
...
- com.nimbusds:oauth2-oidc-sdk V11.18
- io.netty:netty-codec V4.1.118.Final
+ io.netty:netty-codec-base V4.2.7.Final
+ io.netty:netty-codec-compression V4.2.7.Final
- net.minidev:accessors-smart V2.5.1
- net.minidev:json-smart V2.5.1
+ org.jspecify:jspecify V1.0.0
...
<table><tr><th></th><th align="left">25w42a</th><th>25w43a</th></tr><tr><td>com.github.oshi:oshi-core</td><td><pre>6.6.5</pre></td><td><pre>6.9.0</pre></td></tr><tr><td>com.google.code.gson:gson</td><td><pre>2.11.0</pre></td><td><pre>2.13.2</pre></td></tr><tr><td>com.google.guava:failureaccess</td><td><pre>1.0.2</pre></td><td><pre>1.0.3</pre></td></tr><tr><td>com.google.guava:guava</td><td><pre>33.3.1-jre</pre></td><td><pre>33.5.0-jre</pre></td></tr><tr><td>com.ibm.icu:icu4j</td><td><pre>76.1</pre></td><td><pre>77.1</pre></td></tr><tr><td>com.microsoft.azure:msal4j</td><td><pre>1.17.2</pre></td><td><pre>1.23.1</pre></td></tr><tr><td>com.mojang:datafixerupper</td><td><pre>8.0.16</pre></td><td><pre>8.0.17</pre></td></tr><tr><td>com.mojang:logging</td><td><pre>1.5.10</pre></td><td><pre>1.6.11</pre></td></tr><tr><td>commons-codec:commons-codec</td><td><pre>1.17.1</pre></td><td><pre>1.19.0</pre></td></tr><tr><td>commons-io:commons-io</td><td><pre>2.17.0</pre></td><td><pre>2.20.0</pre></td></tr><tr><td>commons-logging:commons-logging</td><td><pre>1.3.4</pre></td><td><pre>1.3.5</pre></td></tr><tr><td>io.netty:netty-buffer</td><td><pre>4.1.118.Final</pre></td><td><pre>4.2.7.Final</pre></td></tr><tr><td>io.netty:netty-codec-http</td><td><pre>4.1.118.Final</pre></td><td><pre>4.2.7.Final</pre></td></tr><tr><td>io.netty:netty-common</td><td><pre>4.1.118.Final</pre></td><td><pre>4.2.7.Final</pre></td></tr><tr><td>io.netty:netty-handler</td><td><pre>4.1.118.Final</pre></td><td><pre>4.2.7.Final</pre></td></tr><tr><td>io.netty:netty-resolver</td><td><pre>4.1.118.Final</pre></td><td><pre>4.2.7.Final</pre></td></tr><tr><td>io.netty:netty-transport-classes-epoll</td><td><pre>4.1.118.Final</pre></td><td><pre>4.2.7.Final</pre></td></tr><tr><td>io.netty:netty-transport-native-epoll (linux-aarch_64)</td><td><pre>4.1.118.Final</pre></td><td><pre>4.2.7.Final</pre></td></tr><tr><td>io.netty:netty-transport-native-epoll (linux-x86_64)</td><td><pre>4.1.118.Final</pre></td><td><pre>4.2.7.Final</pre></td></tr><tr><td>io.netty:netty-transport-native-unix-common</td><td><pre>4.1.118.Final</pre></td><td><pre>4.2.7.Final</pre></td></tr><tr><td>io.netty:netty-transport</td><td><pre>4.1.118.Final</pre></td><td><pre>4.2.7.Final</pre></td></tr><tr><td>it.unimi.dsi:fastutil</td><td><pre>8.5.15</pre></td><td><pre>8.5.18</pre></td></tr><tr><td>net.java.dev.jna:jna-platform</td><td><pre>5.15.0</pre></td><td><pre>5.17.0</pre></td></tr><tr><td>net.java.dev.jna:jna</td><td><pre>5.15.0</pre></td><td><pre>5.17.0</pre></td></tr><tr><td>org.apache.commons:commons-compress</td><td><pre>1.27.1</pre></td><td><pre>1.28.0</pre></td></tr><tr><td>org.apache.commons:commons-lang3</td><td><pre>3.17.0</pre></td><td><pre>3.19.0</pre></td></tr><tr><td>org.apache.logging.log4j:log4j-api</td><td><pre>2.24.1</pre></td><td><pre>2.25.2</pre></td></tr><tr><td>org.apache.logging.log4j:log4j-core</td><td><pre>2.24.1</pre></td><td><pre>2.25.2</pre></td></tr><tr><td>org.apache.logging.log4j:log4j-slf4j2-impl</td><td><pre>2.24.1</pre></td><td><pre>2.25.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-freetype</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-freetype (natives-linux)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-freetype (natives-macos-arm64)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-freetype (natives-windows)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-freetype (natives-windows-arm64)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-freetype (natives-windows-x86)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-glfw</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-glfw (natives-linux)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-glfw (natives-macos)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-glfw (natives-macos-arm64)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-glfw (natives-windows)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-glfw (natives-windows-arm64)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-glfw (natives-windows-x86)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc (natives-linux)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc (natives-macos)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc (natives-macos-arm64)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc (natives-windows)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc (natives-windows-arm64)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc (natives-windows-x86)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal (natives-linux)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal (natives-macos)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal (natives-macos-arm64)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal (natives-windows)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal (natives-windows-arm64)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal (natives-windows-x86)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl (natives-linux)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl (natives-macos)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl (natives-macos-arm64)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl (natives-windows)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl (natives-windows-arm64)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl (natives-windows-x86)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb (natives-linux)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb (natives-macos)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb (natives-macos-arm64)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb (natives-windows)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb (natives-windows-arm64)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb (natives-windows-x86)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd (natives-linux)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd (natives-macos)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd (natives-macos-arm64)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd (natives-windows)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd (natives-windows-arm64)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd (natives-windows-x86)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl (natives-linux)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl (natives-macos)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl (natives-macos-arm64)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl (natives-windows)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl (natives-windows-arm64)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.lwjgl:lwjgl (natives-windows-x86)</td><td><pre>3.3.3</pre></td><td><pre>3.3.6</pre></td></tr><tr><td>org.slf4j:slf4j-api</td><td><pre>2.0.16</pre></td><td><pre>2.0.17</pre></td></tr></table>
</details>
</details>
<hr/>
...
<table><tr><th></th><th align="left">25w42a</th><th>25w43a</th></tr><tr><td>minecraft:attribute_modifiers</td><td><pre>[
  {
...
<br/>
<table>
<tr><th>Name</th><th>25w42a</th><th>25w43a</th></tr>
<tr><th align="left"><div style="width:290px">debug.entry.overlay</div></th><td>In overlay</td><td>In Overlay</td></tr>
<tr><th align="left"><div style="width:290px">key.debug.clearChat</div></th><td>Clear chat</td><td>Clear Chat</td></tr>
<tr><th align="left"><div style="width:290px">key.debug.copyLocation</div></th><td>Copy location</td><td>Copy Location</td></tr>
<tr><th align="left"><div style="width:290px">key.debug.copyRecreateCommand</div></th><td>Copy data</td><td>Copy Data</td></tr>
<tr><th align="left"><div style="width:290px">key.debug.crash</div></th><td>Debug crash</td><td>Debug Crash</td></tr>
<tr><th align="left"><div style="width:290px">key.debug.debugOptions</div></th><td>Debug options</td><td>Debug Options</td></tr>
<tr><th align="left"><div style="width:290px">key.debug.dumpDynamicTextures</div></th><td>Dump dynamic textures</td><td>Dump Dynamic Textures</td></tr>
<tr><th align="left"><div style="width:290px">key.debug.dumpVersion</div></th><td>Dump version info</td><td>Dump Version Info</td></tr>
<tr><th align="left"><div style="width:290px">key.debug.focusPause</div></th><td>Toggle lost focus pause</td><td>Toggle Lost Focus Pause</td></tr>
<tr><th align="left"><div style="width:290px">key.debug.fpsCharts</div></th><td>FPS charts</td><td>FPS Charts</td></tr>
<tr><th align="left"><div style="width:290px">key.debug.modifier</div></th><td>Debug modifier key</td><td>Debug Modifier Key</td></tr>
<tr><th align="left"><div style="width:290px">key.debug.networkCharts</div></th><td>Network charts</td><td>Network Charts</td></tr>
<tr><th align="left"><div style="width:290px">key.debug.overlay</div></th><td>Toggle overlay</td><td>Toggle Overlay</td></tr>
<tr><th align="left"><div style="width:290px">key.debug.profiling</div></th><td>Start/stop profiling</td><td>Start/Stop Profiling</td></tr>
<tr><th align="left"><div style="width:290px">key.debug.profilingChart</div></th><td>Profiling chart</td><td>Profiling Chart</td></tr>
<tr><th align="left"><div style="width:290px">key.debug.reloadChunk</div></th><td>Reload chunks</td><td>Reload Chunks</td></tr>
<tr><th align="left"><div style="width:290px">key.debug.reloadResourcePacks</div></th><td>Reload resource packs</td><td>Reload Resource Packs</td></tr>
<tr><th align="left"><div style="width:290px">key.debug.showAdvancedTooltips</div></th><td>Show advanced tooltips</td><td>Show Advanced Tooltips</td></tr>
<tr><th align="left"><div style="width:290px">key.debug.showChunkBorders</div></th><td>Show chunk boundaries</td><td>Show Chunk Boundaries</td></tr>
<tr><th align="left"><div style="width:290px">key.debug.showHitboxes</div></th><td>Show hitboxes</td><td>Show Hitboxes</td></tr>
<tr><th align="left"><div style="width:290px">key.debug.spectate</div></th><td>Cycle spectator</td><td>Cycle Spectator</td></tr>
<tr><th align="left"><div style="width:290px">key.debug.switchGameMode</div></th><td>Game mode switcher</td><td>Game Mode Switcher</td></tr>
<tr><th align="left"><div style="width:290px">mco.configure.world.name.validation.whitespace</div></th><td>Must not start or end with whitespace</td><td>Must not start or end with whitespace. It will be trimmed.</td></tr>
</table>
<br/>
</details>
</details>
...
```diff
+ minecraft/textures/block/allium.png.mcmeta
+ minecraft/textures/block/amethyst_cluster.png.mcmeta
+ minecraft/textures/block/azure_bluet.png.mcmeta
+ minecraft/textures/block/blue_orchid.png.mcmeta
+ minecraft/textures/block/brown_mushroom.png.mcmeta
+ minecraft/textures/block/cactus_flower.png.mcmeta
+ minecraft/textures/block/closed_eyeblossom.png.mcmeta
+ minecraft/textures/block/cornflower.png.mcmeta
+ minecraft/textures/block/crimson_fungus.png.mcmeta
+ minecraft/textures/block/dandelion.png.mcmeta
+ minecraft/textures/block/glass.png.mcmeta
+ minecraft/textures/block/large_amethyst_bud.png.mcmeta
+ minecraft/textures/block/lily_of_the_valley.png.mcmeta
+ minecraft/textures/block/medium_amethyst_bud.png.mcmeta
+ minecraft/textures/block/open_eyeblossom.png.mcmeta
+ minecraft/textures/block/orange_tulip.png.mcmeta
+ minecraft/textures/block/oxeye_daisy.png.mcmeta
+ minecraft/textures/block/pink_tulip.png.mcmeta
+ minecraft/textures/block/poppy.png.mcmeta
+ minecraft/textures/block/red_mushroom.png.mcmeta
+ minecraft/textures/block/red_tulip.png.mcmeta
+ minecraft/textures/block/redstone_dust_dot.png.mcmeta
+ minecraft/textures/block/redstone_dust_line0.png.mcmeta
+ minecraft/textures/block/redstone_dust_line1.png.mcmeta
+ minecraft/textures/block/redstone_dust_overlay.png.mcmeta
+ minecraft/textures/block/small_amethyst_bud.png.mcmeta
+ minecraft/textures/block/torchflower.png.mcmeta
+ minecraft/textures/block/warped_fungus.png.mcmeta
+ minecraft/textures/block/white_tulip.png.mcmeta
+ minecraft/textures/block/wither_rose.png.mcmeta
```
...
```
```
net.minecraft.Util$OS -1M
```
```
XXX.gametest.framework.GameTestServer +1M -1M
```
```
XXX.level.border.BorderChangeListener +1P -1P
```
```
XXX.level.border.WorldBorder +7M -2M | +2P
```
```
XXX.level.border.WorldBorder$MovingBorderExtent +7M -5M | +3P
```
```
XXX.level.border.WorldBorder$StaticBorderExtent +4M -4M
```
...
```diff
- DateTimeFormatter localizedDateFormatter(FormatStyle)
```
...
```diff
- double getMaxX(float)
- double getMaxZ(float)
- double getMinX(float)
- double getMinZ(float)
- void <init>(WorldBorder$Settings)
- void applyInitialSettings(long)
+ void applySettings(WorldBorder$Settings)
- void lerpSizeBetween(double,double,long,long)
+ void lerpSizeBetween(double,double,long)
```
...
+ double getMinZ()
- double getMinZ(float)
- double getPreviousSize()
- void <init>(WorldBorder,double,double,long,long)
+ void <init>(WorldBorder,double,double,long)
```
...
```
XXX.client.renderer.Sheets +11M -11M | +11P -11P
```
```
XXX.client.renderer.SubmitNodeStorage$BlockModelSubmit +2M -2M | +1P -1P
```
```
XXX.client.renderer.SubmitNodeStorage$ItemSubmit +2M -2M | +1P -1P
```
```
XXX.client.renderer.SubmitNodeStorage$TranslucentModelSubmit +2M -2M | +1P -1P
```
```
XXX.client.renderer.WorldBorderRenderer +1M -1M
```
```
XXX.renderer.blockentity.AbstractEndPortalRenderer +1M -1M
```
```
XXX.renderer.blockentity.SkullBlockRenderer +4M -4M
```
```
XXX.renderer.blockentity.TheEndGatewayRenderer +1M -1M
```
```
XXX.blockentity.state.SkullBlockRenderState +1P -1P
```
```
XXX.renderer.entity.ArmorStandRenderer +2M -2M
```
```
XXX.renderer.entity.BoatRenderer +2M -2M
```
```
XXX.renderer.entity.DragonFireballRenderer +1P -1P
```
```
XXX.renderer.entity.EnderDragonRenderer +1M -1M | +4P -4P
```
```
XXX.renderer.entity.FishingHookRenderer +1P -1P
```
```
XXX.renderer.entity.LivingEntityRenderer +1M -1M
```
```
XXX.renderer.entity.PaintingRenderer +1M -1M
```
```
XXX.entity.layers.CustomHeadLayer +1M -1M
```
```
XXX.entity.layers.EyesLayer +1P -1P
```
```
XXX.entity.layers.RopesLayer +1P -1P
```
```
XXX.renderer.feature.CustomFeatureRenderer$Storage +3M -3M
```
```
XXX.renderer.feature.ShadowFeatureRenderer +1P -1P
```
```
XXX.renderer.item.ItemStackRenderState$LayerRenderState +1M -1M | +1P -1P
```
```
XXX.minecraft.nbt.NbtUtils +1M
```
```
XXX.minecraft.network.Connection +11M -14M | -3P
```
```
XXX.minecraft.network.FriendlyByteBuf +1M -2M
```
```
XXX.minecraft.server.MinecraftServer +1P -1P
```
```
XXX.server.commands.SetWorldSpawnCommand +1M -1M
```
```
XXX.server.dedicated.DedicatedServer +1M -1M
```
```
XXX.jsonrpc.security.AuthenticationHandler +1P -1P
```
```
XXX.server.level.ChunkMap +42M -39M | -1P
```
```
XXX.server.network.ServerConnectionListener +1M -3M | -2P
```
```
XXX.server.players.PlayerList$1 +1M -1M
```
```
XXX.minecraft.sounds.SoundEvents +1P
```
```
XXX.minecraft.stats.StatFormatter +1M -2M
```
```
XXX.util.worldupdate.WorldUpgrader$ChunkUpgrader +3M -6M
```
```
XXX.world.entity.Entity +2P
```
```
XXX.world.entity.LivingEntity +1M | +1P
```
```
XXX.entity.ambient.Bat -1M
```
```
XXX.animal.nautilus.Nautilus +3M | +1P
```
```
XXX.chunk.storage.RecreatingSimpleRegionStorage +2M -2M
```
```
XXX.chunk.storage.SimpleRegionStorage +9M | +1P
```
```
...
```
```
XXX.levelgen.structure.LegacyStructureDataHandler +12M -9M | +2P
```
```
XXX.level.redstone.ExperimentalRedstoneWireEvaluator +2M -2M
```
```
XXX.level.storage.PlayerDataStorage -1P
```
...
```diff
+ RenderType armorTrimsSheet(boolean)
- RenderType armorTrimsSheet(boolean)
+ RenderType bannerSheet()
- RenderType bannerSheet()
+ RenderType bedSheet()
- RenderType bedSheet()
+ RenderType chestSheet()
- RenderType chestSheet()
+ RenderType cutoutBlockSheet()
- RenderType cutoutBlockSheet()
+ RenderType hangingSignSheet()
- RenderType hangingSignSheet()
+ RenderType shieldSheet()
- RenderType shieldSheet()
+ RenderType shulkerBoxSheet()
- RenderType shulkerBoxSheet()
+ RenderType signSheet()
- RenderType signSheet()
+ RenderType solidBlockSheet()
- RenderType solidBlockSheet()
...
- RenderType renderType()
+ void <init>(PoseStack$Pose,RenderType,BlockStateModel,float,float,float,int,int,int)
- void <init>(PoseStack$Pose,RenderType,BlockStateModel,float,float,float,int,int,int)
```
...
```diff
- void extract(WorldBorder,float,Vec3,double,WorldBorderRenderState)
+ void extract(WorldBorder,Vec3,double,WorldBorderRenderState)
```
...
- RenderType getSkullRenderType(SkullBlock$Type,ResourceLocation)
+ RenderType resolveSkullRenderType(SkullBlock$Type,SkullBlockEntity)
- RenderType resolveSkullRenderType(SkullBlock$Type,SkullBlockEntity)
+ void submitSkull(Direction,float,float,PoseStack,SubmitNodeCollector,int,SkullModelBase,RenderType,int,ModelFeatureRenderer$CrumblingOverlay)
- void submitSkull(Direction,float,float,PoseStack,SubmitNodeCollector,int,SkullModelBase,RenderType,int,ModelFeatureRenderer$CrumblingOverlay)
```
...
```diff
+ void submitRays(PoseStack,float,SubmitNodeCollector,RenderType)
- void submitRays(PoseStack,float,SubmitNodeCollector,RenderType)
```
...
```diff
+ void renderPainting(PoseStack,SubmitNodeCollector,RenderType,int[],int,int,TextureAtlasSprite,TextureAtlasSprite)
- void renderPainting(PoseStack,SubmitNodeCollector,RenderType,int[],int,int,TextureAtlasSprite,TextureAtlasSprite)
```
...
```diff
+ RenderType resolveSkullRenderType(LivingEntityRenderState,SkullBlock$Type)
- RenderType resolveSkullRenderType(LivingEntityRenderState,SkullBlock$Type)
```
...
```diff
+ boolean lambda$endFrame$1(RenderType)
- boolean lambda$endFrame$1(RenderType)
+ List lambda$add$0(RenderType)
- List lambda$add$0(RenderType)
+ void add(PoseStack,RenderType,SubmitNodeCollector$CustomGeometryRenderer)
- void add(PoseStack,RenderType,SubmitNodeCollector$CustomGeometryRenderer)
```
...
```diff
- int getDataVersion(CompoundTag)
```
...
+ Connection connectToServer(InetSocketAddress,boolean,LocalSampleLogger)
- Connection connectToServer(InetSocketAddress,EventLoopGroupHolder,LocalSampleLogger)
+ DefaultEventLoopGroup lambda$static$5()
- DisconnectionDetails lambda$handleDisconnection$11()
+ DisconnectionDetails lambda$handleDisconnection$14()
+ EpollEventLoopGroup lambda$static$4()
+ NioEventLoopGroup lambda$static$3()
- void lambda$exceptionCaught$3(DisconnectionDetails)
+ void lambda$exceptionCaught$6(DisconnectionDetails)
- void lambda$flush$10()
+ void lambda$flush$13()
...
- void lambda$initiateServerboundConnection$7(ProtocolInfo,ClientboundPacketListener,String,int,ClientIntent,ProtocolInfo,Connection)
+ void lambda$send$11(Packet,ChannelFutureListener,boolean,Connection)
- void lambda$send$8(Packet,ChannelFutureListener,boolean,Connection)
+ void lambda$sendPacket$12(Packet,ChannelFutureListener,boolean)
- void lambda$sendPacket$9(Packet,ChannelFutureListener,boolean)
- void lambda$setupInboundProtocol$4(PacketBundlePacker,ChannelHandlerContext)
+ void lambda$setupInboundProtocol$7(PacketBundlePacker,ChannelHandlerContext)
- void lambda$setupOutboundProtocol$5(PacketBundleUnpacker,ChannelHandlerContext)
- void lambda$setupOutboundProtocol$6(boolean,ChannelHandlerContext)
...
```diff
+ Date readDate()
+ FriendlyByteBuf writeDate(Date)
- String readString(int,Charset)
```
...
```diff
+ Component lambda$setSpawn$3(BlockPos,float,float,ServerLevel)
- Component lambda$setSpawn$3(BlockPos,LevelData$RespawnData,ServerLevel)
```
...
- CompoundTag getChunkDataFixContextTag(ResourceKey,Optional)
...
+ void lambda$applyChunkTrackingView$37(ServerPlayer,ChunkPos)
...
- void lambda$tick$0(Connection,Component)
+ void lambda$tick$2(Connection,Component)
```
...
```diff
- void onLerpSize(WorldBorder,double,double,long,long)
+ void onLerpSize(WorldBorder,double,double,long)
```
...
```diff
- String lambda$static$0(int)
+ String lambda$static$3(int)
...
```diff
+ AutoCloseable createStorage(RegionStorageInfo,Path)
+ boolean tryProcessOnePosition(AutoCloseable,ChunkPos,ResourceKey)
+ boolean tryProcessOnePosition(ChunkStorage,ChunkPos,ResourceKey)
- boolean tryProcessOnePosition(SimpleRegionStorage,ChunkPos,ResourceKey)
+ ChunkStorage createStorage(RegionStorageInfo,Path)
+ CompoundTag lambda$tryProcessOnePosition$1(CompoundTag)
+ DimensionDataStorage lambda$tryProcessOnePosition$0()
- LegacyTagFixer lambda$createStorage$0(RegionStorageInfo)
- SimpleRegionStorage createStorage(RegionStorageInfo,Path)
```
...
```diff
- float getTicksSinceEnemyHit(float)
```
...
- int getMaxAirSupply()
- void baseTick()
- void handleAirSupply(ServerLevel,int)
```
...
- void <init>(RegionStorageInfo,Path,RegionStorageInfo,Path,DataFixer,boolean,DataFixTypes,Supplier)
...
```diff
- boolean isOldChunkAround(ChunkPos,int)
- ChunkScanAccess chunkScanner()
- CompletableFuture write(ChunkPos,Supplier)
- CompoundTag lambda$write$0(CompoundTag)
- CompoundTag upgradeChunkTag(CompoundTag,int,CompoundTag)
- void <init>(RegionStorageInfo,Path,DataFixer,boolean,DataFixTypes,Supplier)
- void injectDatafixingContext(CompoundTag,CompoundTag)
- void markChunkDone(ChunkPos)
- void removeDatafixingContext(CompoundTag)
```
...
```diff
- void lambda$blendBiome$6(int,int,int,MutableDouble,MutableObject,long,BlendingData)
+ void lambda$blendBiome$6(int,int,int,MutableDouble,MutableObject,Long,BlendingData)
...
+ void lambda$logCounts$1(String,Integer,Registry,FeatureCountTracker$FeatureData,Integer)
```
...
```diff
- CompoundTag applyFix(CompoundTag)
...
+ Long2ObjectMap lambda$populateCaches$4(String)
- Long2ObjectMap lambda$populateCaches$5(String)
- Optional lambda$applyFix$2(CompoundTag)
+ Optional lambda$populateCaches$2(CompoundTag)
- Optional lambda$populateCaches$3(CompoundTag)
- void <init>(DimensionDataStorage,List,List,DataFixer)
+ void <init>(DimensionDataStorage,List,List)
+ void lambda$populateCaches$3(CompoundTag,String)
- void lambda$populateCaches$4(CompoundTag,String)
+ void lambda$populateCaches$5(long,CompoundTag,String)
- void lambda$populateCaches$6(long,CompoundTag,String)
+ void lambda$populateCaches$6(String,Tag)
- void lambda$populateCaches$7(String,Tag)
+ void lambda$populateCaches$7(StructureFeatureIndexSavedData,String,Tag)
- void lambda$populateCaches$8(StructureFeatureIndexSavedData,String,Tag)
- void markChunkDone(ChunkPos)
...
```diff
- void lambda$causeNeighborUpdates$0(Level,BlockPos,int)
+ void lambda$causeNeighborUpdates$0(Level,BlockPos,Integer)
- void lambda$causeNeighborUpdates$1(ServerLevel,BlockPos,int)
+ void lambda$causeNeighborUpdates$1(ServerLevel,BlockPos,Integer)
```
