## Comparison with [24w36a](https://github.com/PixiGeko/Minecraft-generated-data/tree/24w36a)
...
<br/>
<table><tr><th></th><th align="left">24w36a</th><th>24w37a</th></tr><tr><td>DataPack version</td><td><pre>52</pre></td><td><pre>53</pre></td></tr><tr><td>ResourcePack version</td><td><pre>37</pre></td><td><pre>38</pre></td></tr><tr><td>World version</td><td><pre>4063</pre></td><td><pre>4065</pre></td></tr><tr><td>Protocol version</td><td><pre>1073742032</pre></td><td><pre>1073742033</pre></td></tr></table>
...
```diff
+ com.mojang:jtracy (natives-linux) V1.0.29
+ com.mojang:jtracy (natives-macos) V1.0.29
+ com.mojang:jtracy (natives-windows) V1.0.29
+ com.mojang:jtracy V1.0.29
```
...
<table><tr><th></th><th align="left">24w36a</th><th>24w37a</th></tr><tr><td>com.mojang:logging</td><td><pre>1.2.7</pre></td><td><pre>1.3.8</pre></td></tr></table>
</details>
</details>
<hr/>
...
<table><tr><th></th><th align="left">24w36a</th><th>24w37a</th></tr><tr><td>minecraft:damage_resistant</td><td><pre>/</pre></td><td><pre>{
  "types": "#minecraft:is_fire"
}</pre></td></tr><tr><td>minecraft:fire_resistant</td><td><pre>{}</pre></td><td><pre>/</pre></td></tr></table>
<br/>
</details>
<details>
<summary>
...
<table><tr><th></th><th align="left">24w36a</th><th>24w37a</th></tr><tr><td>minecraft:equippable</td><td><pre>{
  "slot": "head"
}</pre></td><td><pre>{
  "slot": "head",
  "swappable": false
...
<table><tr><th></th><th align="left">24w36a</th><th>24w37a</th></tr><tr><td>minecraft:max_damage</td><td><pre>195</pre></td><td><pre>91</pre></td></tr></table>
<br/>
</details>
<details>
<summary>
...
<table><tr><th></th><th align="left">24w36a</th><th>24w37a</th></tr><tr><td>minecraft:max_damage</td><td><pre>240</pre></td><td><pre>112</pre></td></tr></table>
<br/>
</details>
<details>
<summary>
...
<table><tr><th></th><th align="left">24w36a</th><th>24w37a</th></tr><tr><td>minecraft:max_damage</td><td><pre>165</pre></td><td><pre>77</pre></td></tr></table>
<br/>
</details>
<details>
<summary>
...
<table><tr><th></th><th align="left">24w36a</th><th>24w37a</th></tr><tr><td>minecraft:max_damage</td><td><pre>225</pre></td><td><pre>105</pre></td></tr></table>
<br/>
</details>
<details>
<summary>
...
<table><tr><th></th><th align="left">24w36a</th><th>24w37a</th></tr><tr><td>minecraft:death_protection</td><td><pre>/</pre></td><td><pre>{
  "death_effects": [
    {
...
<br/>
<table>
<tr><th>Name</th><th>24w36a</th><th>24w37a</th></tr>
<tr><th align="left"><div style="width:290px">container.beehive.bees</div></th><td>Bees: %s/%s</td><td>Bees: %s / %s</td></tr>
<tr><th align="left"><div style="width:290px">container.beehive.honey</div></th><td>Honey: %s/%s</td><td>Honey: %s / %s</td></tr>
<tr><th align="left"><div style="width:290px">gamerule.minecartMaxSpeed.description</div></th><td>Maximum default speed of a moving Minecart on land</td><td>Maximum default speed of a moving Minecart on land.</td></tr>
<tr><th align="left"><div style="width:290px">options.rotateWithMinecart.tooltip</div></th><td>If the player's view should rotate with a turning Minecart. Only available in worlds with the 'Minecart Improvements' experimental setting turned on.</td><td>Whether the player's view should rotate with a turning Minecart. Only available in worlds with the 'Minecart Improvements' experimental setting turned on.</td></tr>
</table>
<br/>
</details>
</details>
...
```diff
+ minecraft/loot_table/gameplay/armadillo_shed.json
+ minecraft/loot_table/gameplay/chicken_lay.json
+ minecraft/loot_table/gameplay/hero_of_the_village/baby_gift.json
+ minecraft/loot_table/gameplay/hero_of_the_village/unemployed_gift.json
+ minecraft/tags/item/brewing_fuel.json
+ minecraft/tags/item/duplicates_allays.json
+ minecraft/tags/item/panda_eats_from_ground.json
```
...
+ minecraft/textures/gui/sprites/container/bundle/slot_highlight_back.png.mcmeta
+ minecraft/textures/gui/sprites/container/bundle/slot_highlight_front.png
+ minecraft/textures/gui/sprites/container/bundle/slot_highlight_front.png.mcmeta
+ minecraft/textures/gui/sprites/container/slot_highlight_back.png
+ minecraft/textures/gui/sprites/container/slot_highlight_back.png.mcmeta
+ minecraft/textures/gui/sprites/container/slot_highlight_front.png
+ minecraft/textures/gui/sprites/container/slot_highlight_front.png.mcmeta
```
...
```
XXX.minecraft.server.MinecraftServer +3M -4M | +1P -1P
```
```
XXX.server.commands.GameRuleCommand$1 +1M -2M
```
```
XXX.server.level.TicketType +1P
```
```
XXX.packs.resources.ProfiledReloadInstance$State +7M -1M | -2P
```
```
XXX.world.entity.LivingEntity +16M -12M
```
```
...
```
```
XXX.entity.animal.Panda +1M -2M | -1P
```
```
XXX.entity.animal.Sheep +1M -1M
```
```
XXX.entity.animal.SnowGolem +1M -1M
```
```
...
```
```
XXX.entity.vehicle.Boat$Type +10M -2M | +1P -2P
```
```
XXX.world.item.AirItem +1M
```
```
XXX.world.level.ChunkPos$1 +5M -2M | -5P
```
...
```diff
+ boolean lambda$visit$0(GameRules$Type,CommandSourceStack)
- int lambda$visit$0(GameRules$Key,CommandContext)
+ int lambda$visit$2(GameRules$Key,CommandContext)
```
...
- String name()
- String toString()
- void <init>(String,AtomicLong,AtomicLong)
+ void <init>(String,ProfileResults,ProfileResults,AtomicLong,AtomicLong)
```
...
+ Boolean lambda$checkBedExists$9(BlockPos)
+ boolean lambda$createEquipmentSlotAccess$13(LivingEntity,EquipmentSlot,ItemStack)
...
+ boolean lambda$updateFallFlying$8(EquipmentSlot)
...
+ Vec3 lambda$stopSleeping$10(BlockPos)
...
+ void lambda$stopLocationBasedEffects$12(AttributeMap,Holder,AttributeModifier)
- void lambda$stopLocationBasedEffects$14(AttributeMap,Holder,AttributeModifier)
+ void lambda$stopSleeping$11(BlockPos)
...
```diff
- boolean canPickUpAndEat(ItemEntity)
+ boolean isFoodOrCake(ItemStack)
+ boolean lambda$static$1(ItemEntity)
```
...
```diff
- void lambda$dropSeed$3(BlockPos,ItemStack)
```
...
- void spawnShearedMushrooms(ItemStack)
```
...
```diff
+ boolean isFacingTarget(Breeze,LivingEntity)
```
...
- void <init>(String,int,Supplier,String,String)
```
...
- ChunkPos decode(ByteBuf)
- Object decode(Object)
- void <init>()
+ void <init>(long,int,ChunkPos,ChunkPos,int,int)
- void encode(ByteBuf,ChunkPos)
...
```
XXX.client.gui.BundleMouseActions +1M
```
```
XXX.client.gui.GuiGraphics +2M
```
```
XXX.gui.screens.TitleScreen +8M -6M
```
```
XXX.inventory.tooltip.ClientBundleTooltip -1M | +2P
```
```
XXX.screens.worldselection.CreateWorldScreen +28M -22M
```
```
XXX.screens.worldselection.WorldCreationUiState +13M -8M
```
```
XXX.client.particle.ParticleEngine +2M -2M
```
```
XXX.renderer.chunk.SectionRenderDispatcher +1M -1M | +1P -1P
```
```
XXX.renderer.entity.ItemRenderer +3M -1M
```
```
XXX.entity.layers.CapeLayer +1M -1M
```
```
XXX.entity.state.PlayerRenderState +1M
```
```
XXX.client.resources.TextureAtlasHolder +2M -3M
```
```
XXX.resources.model.ModelManager +3M -3M
```
```
XXX.minecraft.commands.CommandBuildContext +1P
```
```
...
```
```
XXX.core.component.DataComponents +1M | +2P -1P
```
```
...
```
```
XXX.network.codec.StreamCodec +1M
```
```
XXX.util.profiling.ProfilerFiller +6M -1M
```
```
XXX.world.item.Item +1M -1M
```
```
XXX.world.item.MaceItem +1M
```
```
XXX.world.item.PotionItem -2M
```
```
XXX.item.equipment.ArmorMaterials +1P -1P
```
```
XXX.item.equipment.Equippable +4M -1M | +2P
```
```
XXX.world.level.PathNavigationRegion -1M
```
```
XXX.block.entity.BrushableBlockEntity +5M -5M
```
```
XXX.entity.vault.VaultBlockEntity$Server +1M -1M
```
```
XXX.state.properties.BooleanProperty +3M -1M | +1P -1P
```
```
XXX.level.levelgen.WorldOptions +1M
```
```
XXX.feature.foliageplacers.FoliagePlacer +2M -1M
```
```
XXX.levelgen.presets.WorldPresets +1M
```
```
XXX.storage.loot.BuiltInLootTables +4P
```
...
```diff
- void onSlotClicked(Slot,ClickType)
```
...
```diff
- int createDemoMenuOptions(int,int)
- int createNormalMenuOptions(int,int)
- int createTestWorldButton(int,int)
+ void createDemoMenuOptions(int,int)
+ void createNormalMenuOptions(int,int)
- void lambda$createDemoMenuOptions$10()
+ void lambda$createDemoMenuOptions$10(boolean,Button)
- void lambda$createDemoMenuOptions$11(boolean,Button)
+ void lambda$createDemoMenuOptions$11(Button)
- void lambda$createDemoMenuOptions$12(Button)
+ void lambda$createDemoMenuOptions$9()
+ void lambda$createNormalMenuOptions$6(Button)
- void lambda$createNormalMenuOptions$9(Button)
- void lambda$createTestWorldButton$6(Button)
```
...
```diff
+ void renderSlotHighlight(int,GuiGraphics,int,int)
```
...
+ boolean lambda$tryApplyNewDataPacks$9(List,String)
+ DataResult lambda$applyNewPackConfig$11(DynamicOps,JsonElement)
- DataResult lambda$applyNewPackConfig$15(DynamicOps,JsonElement)
+ IllegalStateException lambda$applyNewPackConfig$12(String)
- IllegalStateException lambda$applyNewPackConfig$16(String)
...
- void lambda$applyNewPackConfig$20(Consumer,boolean)
...
+ void lambda$init$5(AbstractWidget)
- void lambda$init$7(Button)
- void lambda$init$8(Button)
- void lambda$init$9(AbstractWidget)
- void lambda$onCreate$10(WorldDimensions$Complete,LayeredRegistryAccess,Lifecycle)
+ void lambda$onCreate$6(WorldDimensions$Complete,LayeredRegistryAccess,Lifecycle)
- void lambda$openDataPackSelectionScreen$12(PackRepository)
+ void lambda$openDataPackSelectionScreen$8(PackRepository)
- void lambda$openExperimentsScreen$11(PackRepository)
+ void lambda$openExperimentsScreen$7(PackRepository)
+ void lambda$removeTempDataPackDir$18(Path)
- void lambda$removeTempDataPackDir$22(Path)
+ void lambda$tryApplyNewDataPacks$10(PackRepository,WorldDataConfiguration,Consumer,boolean)
- void lambda$tryApplyNewDataPacks$14(PackRepository,WorldDataConfiguration,Consumer,boolean)
- void openCreateWorldScreen(Minecraft,Screen,Function,WorldCreationContextMapper,ResourceKey)
- void testWorld(Minecraft,Screen)
...
+ WorldCreationContext lambda$applyNewPackConfig$15(WorldCreationContext)
- WorldCreationContext lambda$applyNewPackConfig$18(CloseableResourceManager,ReloadableServerResources,LayeredRegistryAccess,DataPackReloadCookie)
- WorldCreationContext lambda$applyNewPackConfig$19(WorldCreationContext)
- WorldCreationContext lambda$openCreateWorldScreen$6(WorldCreationContextMapper,CloseableResourceManager,ReloadableServerResources,LayeredRegistryAccess,DataPackReloadCookie)
- WorldCreationContext lambda$openFresh$1(ReloadableServerResources,LayeredRegistryAccess,DataPackReloadCookie)
+ WorldCreationContext lambda$openFresh$2(CloseableResourceManager,ReloadableServerResources,LayeredRegistryAccess,CreateWorldScreen$DataPackReloadCookie)
- WorldCreationContext lambda$testWorld$3(ReloadableServerResources,LayeredRegistryAccess,DataPackReloadCookie)
- WorldGenSettings lambda$openFresh$2(WorldLoader$DataLoadContext)
- WorldGenSettings lambda$testWorld$4(WorldLoader$DataLoadContext)
+ WorldLoader$DataLoadOutput lambda$applyNewPackConfig$13(WorldLoader$DataLoadContext)
- WorldLoader$DataLoadOutput lambda$applyNewPackConfig$17(WorldLoader$DataLoadContext)
- WorldLoader$DataLoadOutput lambda$openCreateWorldScreen$5(Function,WorldLoader$DataLoadContext)
+ WorldLoader$DataLoadOutput lambda$openFresh$1(WorldLoader$DataLoadContext)
```
...
```diff
- boolean lambda$getNonEmptyList$12(List)
+ boolean lambda$getNonEmptyList$7(List)
- FlatLevelGeneratorSettings lambda$new$3(Holder$Reference)
- List lambda$getNonEmptyList$11(HolderSet$Named)
+ List lambda$getNonEmptyList$6(HolderSet$Named)
+ List lambda$updatePresetLists$4(Registry)
- List lambda$updatePresetLists$9(Registry)
- Optional lambda$findPreset$10(WorldCreationContext,ResourceKey)
+ Optional lambda$findPreset$5(WorldCreationContext,ResourceKey)
- Optional lambda$new$1(ResourceKey,Registry)
- Optional lambda$new$2(WorldCreationContext,ResourceKey)
- void lambda$new$0(GameRules$Key)
- void lambda$new$4(FlatLevelGeneratorSettings)
+ WorldDimensions lambda$setWorldType$3(Holder,RegistryAccess$Frozen,WorldDimensions)
- WorldDimensions lambda$setWorldType$8(Holder,RegistryAccess$Frozen,WorldDimensions)
+ WorldOptions lambda$onChanged$0(boolean,WorldOptions)
+ WorldOptions lambda$onChanged$1(boolean,WorldOptions)
- WorldOptions lambda$onChanged$5(boolean,WorldOptions)
- WorldOptions lambda$onChanged$6(boolean,WorldOptions)
+ WorldOptions lambda$setSeed$2(WorldOptions)
- WorldOptions lambda$setSeed$7(WorldOptions)
```
...
- void lambda$reload$9(CompletableFuture,CompletableFuture,Void)
+ void lambda$reload$9(ProfilerFiller,CompletableFuture,CompletableFuture,Void)
```
...
- void <init>(ClientLevel,LevelRenderer,TracingExecutor,RenderBuffers,BlockRenderDispatcher,BlockEntityRenderDispatcher)
```
...
```diff
- BakedModel resolveModelOverride(BakedModel,ItemStack,Level,LivingEntity,int)
- boolean shouldRenderItemFlat(ItemDisplayContext)
- void renderBundleItem(ItemStack,ItemDisplayContext,boolean,PoseStack,MultiBufferSource,int,int,BakedModel,Level,LivingEntity,int)
+ void renderBundleWithSelectedItem(BundleItem,ItemStack,ItemDisplayContext,boolean,PoseStack,MultiBufferSource,int,int,boolean)
```
...
- void apply(SpriteLoader$Preparations)
+ void lambda$reload$0(ProfilerFiller,SpriteLoader$Preparations)
```
...
- CompletableFuture reload(PreparableReloadListener$PreparationBarrier,ResourceManager,Executor,Executor)
+ CompletableFuture reload(PreparableReloadListener$PreparationBarrier,ResourceManager,ProfilerFiller,ProfilerFiller,Executor,Executor)
+ ModelManager$ReloadState lambda$reload$4(Map,CompletableFuture,CompletableFuture,ProfilerFiller,UnbakedModel,Void)
- ModelManager$ReloadState lambda$reload$4(Map,CompletableFuture,CompletableFuture,UnbakedModel,Void)
- void lambda$reload$7(ModelManager$ReloadState)
+ void lambda$reload$7(ProfilerFiller,ModelManager$ReloadState)
```
...
```diff
- DataComponentType$Builder lambda$static$66(DataComponentType$Builder)
```
...
+ boolean tryShearLivingEntity(ServerLevel,BlockPos)
```
...
```diff
- ChunkPos readChunkPos(ByteBuf)
- void writeChunkPos(ByteBuf,ChunkPos)
```
...
```diff
- StreamCodec composite(StreamCodec,Function,StreamCodec,Function,StreamCodec,Function,StreamCodec,Function,StreamCodec,Function,StreamCodec,Function,StreamCodec,Function,Function7)
```
...
```diff
- ProfilerFiller combine(ProfilerFiller,ProfilerFiller)
+ ProfilerFiller tee(ProfilerFiller,ProfilerFiller)
- void addZoneText(String)
- void addZoneValue(long)
...
- boolean swappable()
- Equippable$Builder builder(EquipmentSlot)
- void <init>(EquipmentSlot,Holder,Optional,Optional,boolean,boolean,boolean)
+ void <init>(EquipmentSlot,Holder,Optional,Optional,boolean)
```
...
```diff
+ boolean brush(long,Player,Direction)
- boolean brush(long,ServerLevel,Player,Direction,ItemStack)
+ void brushingCompleted(Player)
- void brushingCompleted(ServerLevel,Player,ItemStack)
+ void checkReset()
- void checkReset(ServerLevel)
+ void dropContent(Player)
...
```diff
- List resolveItemsToEject(ServerLevel,VaultConfig,BlockPos,Player,ItemStack)
+ List resolveItemsToEject(ServerLevel,VaultConfig,BlockPos,Player)
```
...
- int getInternalIndex(Boolean)
- int getInternalIndex(Comparable)
...
```diff
- boolean lambda$tryPlaceLeaf$2(BlockState)
+ boolean lambda$tryPlaceLeaf$2(FluidState)
- boolean lambda$tryPlaceLeaf$3(FluidState)
```
...
```diff
- WorldDimensions createFlatWorldDimensions(HolderLookup$Provider)
```
