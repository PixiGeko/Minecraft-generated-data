## Comparison with [25w08a](https://github.com/PixiGeko/Minecraft-generated-data/tree/25w08a)
...
<br/>
<table><tr><th></th><th align="left">25w08a</th><th>25w09a</th></tr><tr><td>DataPack version</td><td><pre>68</pre></td><td><pre>69</pre></td></tr><tr><td>World version</td><td><pre>4316</pre></td><td><pre>4317</pre></td></tr><tr><td>Protocol version</td><td><pre>1073742059</pre></td><td><pre>1073742060</pre></td></tr></table>
</details>
<hr/>
...
<br/>
<table>
<tr><th>Name</th><th>25w08a</th><th>25w09a</th></tr>
<tr><th align="left"><div style="width:290px">mco.backup.nobackups</div></th><td>This realm doesn't have any backups currently.</td><td>This Realm doesn't have any backups currently.</td></tr>
<tr><th align="left"><div style="width:290px">mco.backup.restoring</div></th><td>Restoring your realm</td><td>Restoring your Realm</td></tr>
<tr><th align="left"><div style="width:290px">mco.brokenworld.nonowner.error</div></th><td>Please wait for the realm owner to reset the world</td><td>Please wait for the Realm owner to reset the world</td></tr>
<tr><th align="left"><div style="width:290px">mco.configure.world.close.question.line1</div></th><td>Your realm will become unavailable.</td><td>Your Realm will become unavailable.</td></tr>
<tr><th align="left"><div style="width:290px">mco.configure.world.closing</div></th><td>Closing the realm...</td><td>Closing the Realm...</td></tr>
<tr><th align="left"><div style="width:290px">mco.configure.world.delete.question.line1</div></th><td>Your realm will be permanently deleted</td><td>Your Realm will be permanently deleted</td></tr>
...
<tr><th align="left"><div style="width:290px">mco.configure.world.opening</div></th><td>Opening the realm...</td><td>Opening the Realm...</td></tr>
<tr><th align="left"><div style="width:290px">mco.configure.world.resourcepack.question</div></th><td>You need a custom resource pack to play on this realm



Do you want to download it and play?</td><td>You need a custom resource pack to play on this Realm



Do you want to download it and play?</td></tr>
<tr><th align="left"><div style="width:290px">mco.configure.world.resourcepack.question.line1</div></th><td>You need a custom resource pack to play on this realm</td><td>You need a custom resource pack to play on this Realm</td></tr>
<tr><th align="left"><div style="width:290px">mco.configure.world.slot.switch.question.line1</div></th><td>Your realm will be switched to another world</td><td>Your Realm will be switched to another world</td></tr>
<tr><th align="left"><div style="width:290px">mco.connect.connecting</div></th><td>Connecting to the realm...</td><td>Connecting to the Realm...</td></tr>
<tr><th align="left"><div style="width:290px">mco.connect.failed</div></th><td>Failed to connect to the realm</td><td>Failed to connect to the Realm</td></tr>
<tr><th align="left"><div style="width:290px">mco.create.world.subtitle</div></th><td>Optionally, select what world to put on your new realm</td><td>Optionally, select what world to put on your new Realm</td></tr>
<tr><th align="left"><div style="width:290px">mco.create.world.wait</div></th><td>Creating the realm...</td><td>Creating the Realm...</td></tr>
<tr><th align="left"><div style="width:290px">mco.download.confirmation.line2</div></th><td>You won't be able to upload this world to your realm again</td><td>You won't be able to upload this world to your Realm again</td></tr>
<tr><th align="left"><div style="width:290px">mco.download.confirmation.oversized</div></th><td>The world you are going to download is larger than %s



You won't be able to upload this world to your realm again</td><td>The world you are going to download is larger than %s



You won't be able to upload this world to your Realm again</td></tr>
<tr><th align="left"><div style="width:290px">mco.minigame.world.restore.question.line1</div></th><td>The minigame will end and your realm will be restored.</td><td>The minigame will end and your Realm will be restored.</td></tr>
<tr><th align="left"><div style="width:290px">mco.reset.world.warning</div></th><td>This will replace the current world of your realm</td><td>This will replace the current world of your Realm</td></tr>
<tr><th align="left"><div style="width:290px">mco.selectServer.closed</div></th><td>Closed realm</td><td>Closed Realm</td></tr>
<tr><th align="left"><div style="width:290px">mco.selectServer.closeserver</div></th><td>Close realm</td><td>Close Realm</td></tr>
<tr><th align="left"><div style="width:290px">mco.selectServer.configureRealm</div></th><td>Configure realm</td><td>Configure Realm</td></tr>
<tr><th align="left"><div style="width:290px">mco.selectServer.create.subtitle</div></th><td>Select what world to put on your new realm</td><td>Select what world to put on your new Realm</td></tr>
<tr><th align="left"><div style="width:290px">mco.selectServer.expired</div></th><td>Expired realm</td><td>Expired Realm</td></tr>
<tr><th align="left"><div style="width:290px">mco.selectServer.open</div></th><td>Open realm</td><td>Open Realm</td></tr>
<tr><th align="left"><div style="width:290px">mco.selectServer.openserver</div></th><td>Open realm</td><td>Open Realm</td></tr>
<tr><th align="left"><div style="width:290px">mco.selectServer.uninitialized</div></th><td>Click to start your new realm!</td><td>Click to start your new Realm!</td></tr>
<tr><th align="left"><div style="width:290px">mco.trial.message.line1</div></th><td>Want to get your own realm?</td><td>Want to get your own Realm?</td></tr>
...
```
```
XXX.commands.arguments.NbtTagArgument -2M | +1P
```
```
XXX.commands.arguments.ParticleArgument +1M -1M | +1P
```
```
XXX.commands.arguments.StyleArgument -2M | +1P -1P
```
```
...
```
```
XXX.arguments.item.ItemParser$State +1M -1M
```
```
XXX.worldgen.features.TreeFeatures +5M | +5P
```
```
XXX.minecraft.nbt.ByteArrayTag +2M -11M
```
```
XXX.minecraft.nbt.ByteTag +9M -7M | +1P -1P
```
```
XXX.minecraft.nbt.ShortTag +9M -7M | +1P -1P
```
```
XXX.minecraft.nbt.StringTag$1 -1M
```
```
XXX.minecraft.nbt.Tag +15M -1M | -1P
```
```
XXX.minecraft.nbt.TagType -1M
```
```
XXX.nbt.visitors.CollectToTag -3M | +1P -3P
```
```
XXX.chat.contents.NbtContents +1M
```
```
XXX.protocol.game.ServerboundMovePlayerPacket$PosRot +1M
```
```
XXX.server.level.DistanceManager +1M -1M
```
```
XXX.parsing.packrat.ParseState +1M -6M | +6P -3P
```
```
XXX.parsing.packrat.Rule$RuleAction +1P -1P
```
```
XXX.parsing.packrat.Rule$WrappedTerm +1M -1M
```
```
XXX.parsing.packrat.Term$Alternative +2M -2M | +1P -1P
```
```
XXX.parsing.packrat.Term$Sequence +2M -2M | +1P -1P
```
```
XXX.util.random.WeightedList +2M
```
```
XXX.world.entity.AreaEffectCloud +9P
```
```
XXX.world.entity.Display$TextDisplay +1P
```
```
XXX.world.entity.EntityReference +1M
```
```
XXX.world.entity.ExperienceOrb +4P
```
```
XXX.world.entity.GlowSquid +1P
```
```
XXX.world.entity.LivingEntity +19M -17M
```
```
XXX.world.entity.Mob +4P
```
```
XXX.ai.attributes.AttributeInstance +1M -1M | +1P
```
```
XXX.entity.ambient.Bat +1P
```
```
XXX.entity.animal.Animal +1P
```
```
XXX.entity.animal.Chicken +1M | +1P
```
```
XXX.entity.animal.Fox +3P
```
```
XXX.entity.animal.Fox$Variant +1P
```
```
XXX.entity.animal.Ocelot +1P
```
```
XXX.entity.animal.Pufferfish +1P
```
```
XXX.entity.animal.Rabbit +1P
```
```
...
```
```
XXX.animal.frog.Tadpole +1P
```
```
XXX.animal.horse.AbstractChestedHorse +1P
```
```
XXX.animal.horse.AbstractHorse +4P
```
```
XXX.animal.horse.Horse +1P
```
```
XXX.animal.horse.Llama$Variant +1P
```
```
XXX.boss.enderdragon.EndCrystal +1P
```
```
XXX.entity.decoration.ArmorStand +6P
```
```
...
```
```
XXX.entity.monster.Shulker +2P
```
```
XXX.entity.monster.Skeleton +1P
```
```
XXX.entity.monster.Vindicator +1P
```
```
XXX.entity.monster.Zombie +4P
```
```
XXX.monster.piglin.AbstractPiglin +2P
```
```
XXX.entity.npc.InventoryCarrier +1M
```
```
XXX.entity.npc.Villager +6P
```
```
XXX.entity.player.Abilities +7P
```
```
XXX.entity.projectile.FireworkRocketEntity +3P
```
```
XXX.entity.projectile.SpectralArrow +1P
```
```
XXX.entity.projectile.ThrownTrident +1P
```
```
XXX.entity.vehicle.MinecartFurnace +2P
```
```
XXX.entity.vehicle.MinecartTNT +1P
```
```
XXX.world.food.FoodData +2P
```
```
XXX.world.level.BaseCommandBlock +1P
```
```
XXX.world.level.Spawner +3M -2M
```
```
XXX.block.entity.BlockEntity +1M -4M | +1P
```
```
XXX.block.entity.CampfireBlockEntity +4M
```
```
XXX.block.entity.ChiseledBookShelfBlockEntity +1P
```
```
XXX.block.entity.ComparatorBlockEntity +1P
```
```
XXX.block.entity.JigsawBlockEntity +1M | +5P
```
```
XXX.block.entity.JukeboxBlockEntity +4M -3M
```
```
XXX.block.entity.TestBlockEntity +2P
```
```
XXX.level.levelgen.BelowZeroRetrogen -1M
```
```
XXX.levelgen.structure.StructureCheck +7M -4M
```
```
XXX.structure.pools.FeaturePoolElement +1P
```
```
XXX.structure.pools.JigsawPlacement$Placer -1M
```
...
```
XXX.blaze3d.pipeline.BlendFunction +6M -7M | +4P -4P
```
```
XXX.blaze3d.pipeline.RenderPipeline$Builder +5M -3M | +3P
```
```
XXX.blaze3d.pipeline.RenderPipeline$UniformDescription +2M -2M | +1P -1P
```
```
XXX.blaze3d.platform.GLX -2M
```
```
XXX.blaze3d.platform.TextureUtil +3M -2M
```
```
XXX.blaze3d.systems.RenderSystem +6M -39M | +3P -2P
```
```
XXX.blaze3d.systems.RenderSystem$AutoStorageIndexBuffer +3M -2M
```
```
XXX.minecraft.client.Minecraft +48M -47M
```
```
XXX.data.models.BlockModelGenerators +77M -76M | -1P
```
```
XXX.models.blockstates.MultiVariantGenerator +1M -1M
```
```
XXX.models.blockstates.MultiVariantGenerator$Entry +2M -2M | +1P -1P
```
```
XXX.client.renderer.GameRenderer +10M -8M
```
```
XXX.client.renderer.LevelRenderer +7M -6M
```
```
XXX.client.renderer.PostChainConfig$Uniform +1M
```
```
XXX.client.renderer.PostPass$Input +1P -1P
```
```
XXX.client.renderer.PostPass$TextureInput +1M -1M
```
```
XXX.client.renderer.RenderStateShard +7M -20M | -4P
```
```
XXX.client.renderer.RenderStateShard$OutputStateShard +4M -1M | +1P
```
```
XXX.client.renderer.RenderType -13M | +3P -11P
```
```
XXX.client.renderer.RenderType$CompositeState +1P
```
```
XXX.renderer.block.BlockRenderDispatcher +1M -1M | +2P -1P
```
```
XXX.block.model.BlockStateModel +1M | +1P -2P
```
```
XXX.block.model.Variant +3M -3M | +1P -1P
```
```
XXX.block.model.VariantMutator -1P
```
```
XXX.resources.model.ModelBakery$MissingModels$1 +1M
```
```
XXX.resources.model.ModelGroupCollector +1M -1M
```
```
XXX.minecraft.nbt.CompoundTag +30M -26M
```
```
XXX.minecraft.nbt.DoubleTag$1 -1M
```
```
XXX.minecraft.nbt.EndTag$1 -1M
```
```
XXX.minecraft.nbt.FloatTag$1 -1M
```
```
XXX.minecraft.nbt.IntTag$1 -1M
```
```
XXX.minecraft.nbt.ListTag +29M -13M | +1P -1P
```
```
XXX.minecraft.nbt.LongTag$1 -1M
```
```
XXX.minecraft.nbt.NumericTag +8M -2M | +7P -7P
```
```
XXX.parsing.packrat.Dictionary +11M -4M
```
```
XXX.parsing.packrat.ErrorCollector$LongestOnly +1M | +2P -1P
```
```
XXX.packrat.commands.ResourceLocationParseRule +2M -1M
```
```
XXX.packrat.commands.StringReaderTerms +2M
```
```
XXX.packrat.commands.StringReaderTerms$TerminalWord +1M -4M | +2P
```
