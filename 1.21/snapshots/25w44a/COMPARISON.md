## Comparison with [25w43a](https://github.com/PixiGeko/Minecraft-generated-data/tree/25w43a)
...
<br/>
<table><tr><th></th><th align="left">25w43a</th><th>25w44a</th></tr><tr><td>DataPack version</td><td><pre>{
  "major": 91,
  "minor": 0
}</pre></td><td><pre>{
  "major": 92,
  ...
  "major": 72,
  "minor": 0
}</pre></td></tr><tr><td>World version</td><td><pre>4655</pre></td><td><pre>4659</pre></td></tr><tr><td>Protocol version</td><td><pre>1073742099</pre></td><td><pre>1073742100</pre></td></tr></table>
...
```diff
- commons-logging:commons-logging V1.3.5
+ io.netty:netty-transport-classes-kqueue V4.2.7.Final
+ io.netty:netty-transport-native-kqueue (osx-aarch_64) V4.2.7.Final
+ io.netty:netty-transport-native-kqueue (osx-x86_64) V4.2.7.Final
...
- org.lwjgl:lwjgl-freetype (natives-macos) V3.3.6
```
...
<table><tr><th></th><th align="left">25w43a</th><th>25w44a</th></tr><tr><td>org.lwjgl:lwjgl-freetype</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-freetype (natives-linux)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-freetype (natives-macos-arm64)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-freetype (natives-windows)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-freetype (natives-windows-arm64)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-freetype (natives-windows-x86)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-glfw</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-glfw (natives-linux)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-glfw (natives-macos)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-glfw (natives-macos-arm64)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-glfw (natives-windows)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-glfw (natives-windows-arm64)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-glfw (natives-windows-x86)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc (natives-linux)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc (natives-macos)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc (natives-macos-arm64)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc (natives-windows)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc (natives-windows-arm64)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc (natives-windows-x86)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal (natives-linux)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal (natives-macos)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal (natives-macos-arm64)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal (natives-windows)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal (natives-windows-arm64)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal (natives-windows-x86)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl (natives-linux)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl (natives-macos)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl (natives-macos-arm64)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl (natives-windows)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl (natives-windows-arm64)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl (natives-windows-x86)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb (natives-linux)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb (natives-macos)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb (natives-macos-arm64)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb (natives-windows)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb (natives-windows-arm64)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb (natives-windows-x86)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd (natives-linux)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd (natives-macos)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd (natives-macos-arm64)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd (natives-windows)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd (natives-windows-arm64)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd (natives-windows-x86)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl (natives-linux)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl (natives-macos)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl (natives-macos-arm64)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl (natives-windows)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl (natives-windows-arm64)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr><tr><td>org.lwjgl:lwjgl (natives-windows-x86)</td><td><pre>3.3.6</pre></td><td><pre>3.3.3</pre></td></tr></table>
</details>
</details>
<hr/>
...
- minecraft:item.underwater_saddle.equip
```
...
```diff
+ gamerule advance_time <value: bool>
+ gamerule advance_weather <value: bool>
+ gamerule allow_entering_nether_using_portals <value: bool>
...
+ gamerule block_drops <value: bool>
+ gamerule block_explosion_drop_decay <value: bool>
- gamerule blockExplosionDropDecay <value: bool>
+ gamerule command_block_output <value: bool>
+ gamerule command_blocks_work <value: bool>
- gamerule commandBlockOutput <value: bool>
- gamerule commandBlocksEnabled <value: bool>
- gamerule commandModificationBlockLimit <value: integer>
- gamerule disableElytraMovementCheck <value: bool>
- gamerule disablePlayerMovementCheck <value: bool>
...
- gamerule doPatrolSpawning <value: bool>
- gamerule doTileDrops <value: bool>
- gamerule doTraderSpawning <value: bool>
- gamerule doVinesSpread <value: bool>
- gamerule doWardenSpawning <value: bool>
- gamerule doWeatherCycle <value: bool>
+ gamerule drowning_damage <value: bool>
- gamerule drowningDamage <value: bool>
+ gamerule elytra_movement_check <value: bool>
+ gamerule ender_pearls_vanish_on_death <value: bool>
- gamerule enderPearlsVanishOnDeath <value: bool>
+ gamerule entity_drops <value: bool>
+ gamerule fall_damage <value: bool>
- gamerule fallDamage <value: bool>
+ gamerule fire_damage <value: bool>
+ gamerule fire_spread_radius_around_player <value: integer>
- gamerule fireDamage <value: bool>
+ gamerule forgive_dead_players <value: bool>
- gamerule forgiveDeadPlayers <value: bool>
+ gamerule freeze_damage <value: bool>
- gamerule freezeDamage <value: bool>
+ gamerule global_sound_events <value: bool>
- gamerule globalSoundEvents <value: bool>
+ gamerule immediate_respawn <value: bool>
+ gamerule keep_inventory <value: bool>
- gamerule keepInventory <value: bool>
+ gamerule lava_source_conversion <value: bool>
- gamerule lavaSourceConversion <value: bool>
+ gamerule limited_crafting <value: bool>
+ gamerule locator_bar <value: bool>
- gamerule locatorBar <value: bool>
+ gamerule log_admin_commands <value: bool>
- gamerule logAdminCommands <value: bool>
+ gamerule max_block_modifications <value: integer>
+ gamerule max_command_forks <value: integer>
+ gamerule max_command_sequence_length <value: integer>
+ gamerule max_entity_cramming <value: integer>
+ gamerule max_minecart_speed <value: integer>
+ gamerule max_snow_accumulation_height <value: integer>
- gamerule maxCommandChainLength <value: integer>
- gamerule maxCommandForkCount <value: integer>
- gamerule maxEntityCramming <value: integer>
- gamerule minecartMaxSpeed <value: integer>
+ gamerule mob_drops <value: bool>
+ gamerule mob_explosion_drop_decay <value: bool>
+ gamerule mob_griefing <value: bool>
- gamerule mobExplosionDropDecay <value: bool>
- gamerule mobGriefing <value: bool>
+ gamerule natural_health_regeneration <value: bool>
- gamerule naturalRegeneration <value: bool>
+ gamerule player_movement_check <value: bool>
+ gamerule players_nether_portal_creative_delay <value: integer>
+ gamerule players_nether_portal_default_delay <value: integer>
+ gamerule players_sleeping_percentage <value: integer>
...
+ gamerule projectiles_can_break_blocks <value: bool>
- gamerule projectilesCanBreakBlocks <value: bool>
+ gamerule raids <value: bool>
+ gamerule random_tick_speed <value: integer>
- gamerule randomTickSpeed <value: integer>
+ gamerule reduced_debug_info <value: bool>
- gamerule reducedDebugInfo <value: bool>
+ gamerule respawn_radius <value: integer>
+ gamerule send_command_feedback <value: bool>
- gamerule sendCommandFeedback <value: bool>
+ gamerule show_advancement_messages <value: bool>
+ gamerule show_death_messages <value: bool>
- gamerule showDeathMessages <value: bool>
- gamerule snowAccumulationHeight <value: integer>
+ gamerule spawn_mobs <value: bool>
+ gamerule spawn_monsters <value: bool>
+ gamerule spawn_patrols <value: bool>
+ gamerule spawn_phantoms <value: bool>
+ gamerule spawn_wandering_traders <value: bool>
+ gamerule spawn_wardens <value: bool>
+ gamerule spawner_blocks_work <value: bool>
- gamerule spawnerBlocksEnabled <value: bool>
- gamerule spawnMonsters <value: bool>
- gamerule spawnRadius <value: integer>
+ gamerule spectators_generate_chunks <value: bool>
- gamerule spectatorsGenerateChunks <value: bool>
+ gamerule spread_vines <value: bool>
+ gamerule tnt_explodes <value: bool>
+ gamerule tnt_explosion_drop_decay <value: bool>
- gamerule tntExplodes <value: bool>
- gamerule tntExplosionDropDecay <value: bool>
+ gamerule universal_anger <value: bool>
- gamerule universalAnger <value: bool>
+ gamerule water_source_conversion <value: bool>
...
```diff
- worldborder add <distance: double> <ticks: integer>
+ worldborder add <distance: double> <time: time>
- worldborder set <distance: double> <ticks: integer>
+ worldborder set <distance: double> <time: time>
- worldborder warning time <time: integer>
+ worldborder warning time <time: time>
```
...
+ options.maxAnisotropy.tooltip: Significantly improves how smooth textures look, but impacts performance and significantly impacts video memory usage. May not be supported on all hardware.
...
+ subtitles.entity.parched.ambient: Stray rattles
+ subtitles.entity.parched.death: Stray dies
+ subtitles.entity.parched.hurt: Stray hurts
...
```diff
+ minecraft/loot_table/entities/camel_husk.json
+ minecraft/loot_table/entities/parched.json
+ minecraft/tags/entity_type/can_float_while_ridden.json
+ minecraft/tags/item/camel_husk_food.json
```
...
```diff
+ minecraft/items/camel_husk_spawn_egg.json
+ minecraft/items/parched_spawn_egg.json
+ minecraft/models/item/camel_husk_spawn_egg.json
+ minecraft/models/item/parched_spawn_egg.json
+ minecraft/shaders/core/animate_sprite_blit.fsh
+ minecraft/shaders/core/animate_sprite_interpolate.fsh
+ minecraft/shaders/core/animate_sprite.vsh
+ minecraft/shaders/core/block.fsh
+ minecraft/shaders/core/block.vsh
+ minecraft/shaders/include/animation_sprite.glsl
+ minecraft/shaders/include/chunksection.glsl
+ minecraft/textures/block/nether_sprouts.png.mcmeta
+ minecraft/textures/block/sweet_berry_bush_stage0.png.mcmeta
+ minecraft/textures/entity/camel/camel_husk.png
+ minecraft/textures/entity/equipment/camel_husk_saddle/saddle.png
+ minecraft/textures/entity/skeleton/parched.png
+ minecraft/textures/item/camel_husk_spawn_egg.png
+ minecraft/textures/item/parched_spawn_egg.png
```
...
```
```
net.minecraft.Util +5M -7M
```
```
XXX.jsonrpc.internalapi.MinecraftGameRuleServiceImpl +3M -7M | +1P -1P
```
```
XXX.jsonrpc.methods.GameRulesService +4M -2M
```
```
XXX.server.level.ChunkMap +41M -40M
```
```
XXX.server.network.EventLoopGroupHolder +1P
```
```
XXX.util.worldupdate.WorldUpgrader$ChunkUpgrader +1M -1M
```
```
XXX.minecraft.world.Container +1M
```
```
XXX.animal.frog.Frog +1M -1M
```
```
XXX.entity.monster.AbstractSkeleton +2P
```
```
XXX.entity.monster.Bogged -2P
```
```
XXX.entity.monster.Drowned +2M -1M
```
```
...
```
```
XXX.world.level.LevelSettings +3M -2M | +2P -1P
```
```
XXX.level.block.CarvedPumpkinBlock +2M -4M
```
```
XXX.state.pattern.BlockPatternBuilder -2M | +1P -1P
```
```
XXX.loot.functions.CopyComponentsFunction +8M -7M | +2P -2P
```
```
XXX.loot.functions.CopyComponentsFunction$Builder +1M -1M | +1P -1P
```
...
```diff
- List lambda$fallibleSequence$23(ObjectArrayList,Void)
+ List lambda$fallibleSequence$24(List,Void)
+ Object lastOf(List)
- String lambda$fixedSize$25(int)
+ String lambda$fixedSize$28(int)
- String lambda$sanitizeName$28(CharPredicate,int)
+ String lambda$sanitizeName$29(CharPredicate,int)
+ void lambda$fallibleSequence$22(Consumer,List,int,Object,Throwable)
- void lambda$fallibleSequence$22(Consumer,ObjectArrayList,int,Object,Throwable)
+ void lambda$fallibleSequence$23(List,CompletableFuture[],Consumer,CompletableFuture)
- void lambda$prefix$24(Consumer,String,String)
+ void lambda$prefix$25(Consumer,String,String)
```
...
```diff
+ boolean lambda$getRuleKey$0(String,Map$Entry)
+ GameRules$Value getRule(GameRules$Key)
+ GameRules$Value getRuleValue(String)
- GameRulesService$GameRuleUpdate getTypedRule(GameRule,Object)
- GameRulesService$GameRuleUpdate updateGameRule(GameRulesService$GameRuleUpdate,ClientInfo)
+ GameRulesService$TypedRule getTypedRule(String,GameRules$Value)
+ GameRulesService$TypedRule updateGameRule(GameRulesService$UntypedRule,ClientInfo)
+ InvalidParameterJsonRpcException lambda$getRuleValue$1(String)
- Object getRuleValue(GameRule)
+ Optional getRuleKey(String)
```
...
```diff
- GameRulesService$GameRuleUpdate getTypedRule(MinecraftApi,GameRule,Object)
- GameRulesService$GameRuleUpdate update(MinecraftApi,GameRulesService$GameRuleUpdate,ClientInfo)
+ GameRulesService$TypedRule getTypedRule(MinecraftApi,String,GameRules$Value)
+ GameRulesService$TypedRule update(MinecraftApi,GameRulesService$UntypedRule,ClientInfo)
- void addGameRule(MinecraftApi,GameRule,List)
- void lambda$get$0(MinecraftApi,List,GameRule)
```
...
```diff
- boolean anyPlayerCloseEnoughTo(BlockPos,int)
- boolean lambda$allChunksWithAtLeastStatus$29(int,ChunkHolder)
+ boolean lambda$allChunksWithAtLeastStatus$30(int,ChunkHolder)
+ boolean lambda$saveAllChunks$10(ChunkAccess)
- boolean lambda$saveAllChunks$11()
+ boolean lambda$saveAllChunks$12()
- boolean lambda$saveAllChunks$9(ChunkAccess)
- boolean playerIsCloseEnoughTo(ServerPlayer,Vec3,int)
- ChunkAccess lambda$saveAllChunks$8(ChunkHolder)
+ ChunkAccess lambda$saveAllChunks$9(ChunkHolder)
- ChunkAccess lambda$scheduleChunkLoad$17(ChunkPos,Optional)
+ ChunkAccess lambda$scheduleChunkLoad$18(ChunkPos,Optional)
- ChunkAccess lambda$scheduleChunkLoad$18(ChunkPos,Throwable)
+ ChunkAccess lambda$scheduleChunkLoad$19(ChunkPos,Throwable)
- ChunkResult lambda$getChunkRangeFuture$1(ChunkResult)
+ ChunkResult lambda$getChunkRangeFuture$2(ChunkResult)
- ChunkResult lambda$getChunkRangeFuture$2(List)
+ ChunkResult lambda$getChunkRangeFuture$3(List)
- ChunkResult lambda$prepareAccessibleChunk$28(ChunkResult)
+ ChunkResult lambda$prepareAccessibleChunk$29(ChunkResult)
- ChunkResult lambda$prepareEntityTickingChunk$7(ChunkResult)
+ ChunkResult lambda$prepareEntityTickingChunk$8(ChunkResult)
- ChunkResult lambda$prepareTickingChunk$26(ChunkHolder,ChunkResult)
+ ChunkResult lambda$prepareTickingChunk$27(ChunkHolder,ChunkResult)
- ChunkStatus lambda$prepareEntityTickingChunk$5(int)
+ ChunkStatus lambda$prepareEntityTickingChunk$6(int)
- ChunkStatus lambda$prepareTickingChunk$23(int)
+ ChunkStatus lambda$prepareTickingChunk$24(int)
- int lambda$getChunkQueueLevel$0(long)
+ int lambda$getChunkQueueLevel$1(long)
- Integer lambda$dumpChunks$32(LevelChunk)
+ Integer lambda$dumpChunks$35(LevelChunk)
+ LegacyTagFixer lambda$new$0(ServerLevel,Supplier,DataFixer)
- LevelChunk lambda$prepareAccessibleChunk$27(List)
+ LevelChunk lambda$prepareAccessibleChunk$28(List)
- LevelChunk lambda$prepareEntityTickingChunk$6(List)
+ LevelChunk lambda$prepareEntityTickingChunk$7(List)
- LevelChunk lambda$prepareTickingChunk$25(ChunkHolder,List)
+ LevelChunk lambda$prepareTickingChunk$26(ChunkHolder,List)
- List lambda$resendBiomesForChunks$40(ServerPlayer)
+ List lambda$resendBiomesForChunks$41(ServerPlayer)
- Object lambda$save$30(ChunkPos,Void,Throwable)
+ Object lambda$save$31(ChunkPos,Void,Throwable)
- Optional lambda$dumpChunks$31(ChunkAccess)
+ Optional lambda$dumpChunks$32(ChunkAccess)
- Optional lambda$readChunk$35(Optional)
+ Optional lambda$readChunk$36(Optional)
- Optional lambda$scheduleChunkLoad$15(ChunkPos,Optional)
+ Optional lambda$scheduleChunkLoad$16(ChunkPos,Optional)
- Optional lambda$scheduleChunkLoad$16(Optional,Object)
+ Optional lambda$scheduleChunkLoad$17(Optional,Object)
- SerializableChunkData lambda$scheduleChunkLoad$14(ChunkPos,CompoundTag)
+ SerializableChunkData lambda$scheduleChunkLoad$15(ChunkPos,CompoundTag)
- String lambda$applyStep$19(ChunkStep)
+ String lambda$applyStep$20(ChunkStep)
- void lambda$applyChunkTrackingView$38(ServerPlayer,ChunkPos)
+ void lambda$applyChunkTrackingView$40(ServerPlayer,ChunkPos)
- void lambda$applyStep$20(CrashReport)
+ void lambda$applyStep$21(CrashReport)
...
- void lambda$forEachBlockTickingChunk$37(Consumer,long)
+ void lambda$forEachBlockTickingChunk$38(Consumer,long)
- void lambda$getChunkDataFixContextTag$36(CompoundTag,ResourceKey)
+ void lambda$getChunkDataFixContextTag$37(CompoundTag,ResourceKey)
- void lambda$prepareTickingChunk$24(ChunkHolder,LevelChunk,Object)
+ void lambda$prepareTickingChunk$25(ChunkHolder,LevelChunk,Object)
- void lambda$resendBiomesForChunks$41(ServerPlayer,List)
+ void lambda$resendBiomesForChunks$42(ServerPlayer,List)
- void lambda$runGenerationTask$21(ChunkGenerationTask)
+ void lambda$runGenerationTask$23(ChunkGenerationTask)
- void lambda$saveAllChunks$10(MutableBoolean,ChunkAccess)
+ void lambda$saveAllChunks$11(MutableBoolean,ChunkAccess)
- void lambda$scheduleUnload$12(ChunkHolder,CompletableFuture,long)
+ void lambda$scheduleUnload$13(ChunkHolder,CompletableFuture,long)
- void lambda$scheduleUnload$13(ChunkHolder,Void,Throwable)
+ void lambda$scheduleUnload$14(ChunkHolder,Void,Throwable)
- void lambda$waitForLightBeforeSending$42(ChunkPos)
...
```diff
- DimensionDataStorage lambda$createStorage$0()
+ LegacyTagFixer lambda$createStorage$0(RegionStorageInfo)
```
...
```diff
+ void travel(Vec3)
- void travelInWater(Vec3,double,boolean,double)
```
...
```diff
- boolean shouldTravelInFluid(FluidState)
+ void travel(Vec3)
- void travelInWater(Vec3,double,boolean,double)
```
...
```diff
+ boolean checkHuskSpawnRules(EntityType,ServerLevelAccessor,EntitySpawnReason,BlockPos,RandomSource)
...
- GameRules gameRules()
- void <clinit>()
+ void <init>(String,GameType,boolean,Difficulty,boolean,GameRules,WorldDataConfiguration)
- void <init>(String,GameType,boolean,Difficulty,boolean,GameRules,WorldDataConfiguration)
```
...
```diff
- boolean lambda$getOrCreateCopperGolemBase$3(BlockState)
+ boolean lambda$getOrCreateCopperGolemBase$5(BlockState)
- boolean lambda$getOrCreateCopperGolemFull$4(BlockState)
...
```diff
+ void <clinit>()
+ void ensureAllCharactersMatched()
```
...
+ boolean lambda$new$4(List,DataComponentType)
- boolean lambda$new$5(List,DataComponentType)
+ CopyComponentsFunction$Source lambda$static$0(CopyComponentsFunction)
- LootContextArg lambda$static$1(CopyComponentsFunction)
- LootContextArg$ArgCodecBuilder lambda$static$0(LootContextArg$ArgCodecBuilder)
+ Optional lambda$static$1(CopyComponentsFunction)
- Optional lambda$static$3(CopyComponentsFunction)
+ void <init>(List,CopyComponentsFunction$Source,Optional,Optional)
- void <init>(List,LootContextArg,Optional,Optional)
+ void lambda$new$5(List,List)
- void lambda$new$7(List,List)
+ void lambda$run$7(Collection,DataComponentGetter,ItemStack,DataComponentType)
- void lambda$run$8(Collection,DataComponentGetter,ItemStack,DataComponentType)
```
...
```diff
+ void <init>(CopyComponentsFunction$Source)
- void <init>(LootContextArg)
```
...
- XXX.mojang.blaze3d.GpuOutOfMemoryException
+ XXX.mojang.blaze3d.GraphicsWorkarounds
...
```
XXX.blaze3d.opengl.GlDevice +12M -10M | +2P -1P
```
```
XXX.blaze3d.opengl.GlSampler +2M -1M | +1P
```
```
XXX.blaze3d.opengl.GlTextureView +2M | +1P
```
```
XXX.minecraft.client.Options +82M -73M | +4P
```
```
XXX.gui.components.AbstractButton -1M
```
```
XXX.gui.components.OptionsList +1M
```
```
XXX.gui.components.OptionsList$Entry +4M -1M
```
```
XXX.client.renderer.GameRenderer +1M
```
```
XXX.client.renderer.GlobalSettingsUniform +1M -1M
```
```
XXX.client.renderer.RenderPipelines +12P -4P
```
```
XXX.block.model.ItemModelGenerator +3M -4M | +1P
```
```
XXX.renderer.chunk.SectionRenderDispatcher$RenderSection +1M | +1P
```
```
XXX.renderer.fog.FogRenderer +3M -3M
```
```
XXX.renderer.texture.SpriteContents +2M -3M | +1P
```
```
XXX.renderer.texture.Stitcher +1M -1M | +1P
```
```
XXX.renderer.texture.Stitcher$Holder -1M
```
```
XXX.renderer.texture.Stitcher$SpriteLoader +1P -1P
```
```
XXX.renderer.texture.TextureAtlas +9M -1M | +5P -2P
```
```
XXX.texture.atlas.SpriteSource$Output +1P -1P
```
```
XXX.minecraft.resources.ResourceLocation +1M
```
```
XXX.minecraft.server.MinecraftServer +5M -3M
```
```
XXX.minecraft.server.MinecraftServer$2 +2M -2M | +1P -1P
```
```
XXX.server.commands.GameRuleCommand +4M -4M
```
```
XXX.server.commands.WorldBorderCommand +4M -3M
```
```
XXX.jsonrpc.api.Schema +1M | +1P
```
```
XXX.server.notifications.NotificationManager +2M -2M
```
```
XXX.minecraft.sounds.SoundEvents +21P -1P
```
```
XXX.minecraft.stats.ServerStatsCounter +4M -4M | +2P -2P
```
```
...
```
```
XXX.minecraft.util.SpecialDates -1M | -1P
```
```
XXX.world.attribute.AttributeTypes +2P -1P
```
```
XXX.world.attribute.EnvironmentAttributes +7P -3P
```
```
XXX.attribute.modifier.AttributeModifier +2P -1P
```
```
XXX.attribute.modifier.ColorModifier +1P
```
```
XXX.world.entity.LivingEntity +5M | +1P
```
```
XXX.world.entity.Mob +1M
```
```
XXX.world.entity.SlotAccess$1 +1M -1M | +2P
```
```
XXX.world.entity.SlotAccess$3 +1M -1M | +2P -3P
```
```
XXX.ai.sensing.TemptingSensor +9M -4M | +1P -1P
```
```
XXX.animal.armadillo.ArmadilloAi -2M
```
```
XXX.levelgen.feature.FeatureCountTracker +1M -1M
```
```
XXX.levelgen.feature.UnderwaterMagmaFeature +2M -1M
```
```
XXX.feature.treedecorators.PaleMossDecorator +3M -4M
```
```
XXX.levelgen.structure.LegacyStructureDataHandler +4M -1M
```
```
XXX.level.material.FogType -1P
```
```
XXX.storage.loot.ContainerComponentManipulator +3M
```
```
XXX.storage.loot.LootContext$ItemStackTarget +1M -1M
```
```
XXX.providers.nbt.ContextNbtProvider +5M -4M | +1P -2P
```
```
XXX.providers.nbt.ContextNbtProvider$EntitySource +1M -1M
```
...
```diff
+ CompiledRenderPipeline precompilePipeline(RenderPipeline,BiFunction)
- CompiledRenderPipeline precompilePipeline(RenderPipeline,ShaderSource)
- GlProgram compileProgram(RenderPipeline,ShaderSource)
+ GlRenderPipeline compilePipeline(RenderPipeline,BiFunction)
- GlRenderPipeline compilePipeline(RenderPipeline,ShaderSource)
+ GlRenderPipeline lambda$getOrCompilePipeline$0(RenderPipeline,RenderPipeline)
- GlRenderPipeline lambda$getOrCompilePipeline$0(RenderPipeline)
+ GlRenderPipeline lambda$precompilePipeline$2(RenderPipeline,BiFunction,RenderPipeline)
- GlRenderPipeline lambda$precompilePipeline$2(ShaderSource,RenderPipeline)
+ GlRenderPipeline precompilePipeline(RenderPipeline,BiFunction)
- GlRenderPipeline precompilePipeline(RenderPipeline,ShaderSource)
+ GlShaderModule compileShader(GlDevice$ShaderCompilationKey,BiFunction)
- GlShaderModule compileShader(GlDevice$ShaderCompilationKey,ShaderSource)
+ GlShaderModule getOrCompileShader(ResourceLocation,ShaderType,ShaderDefines,BiFunction)
- GlShaderModule getOrCompileShader(ResourceLocation,ShaderType,ShaderDefines,ShaderSource)
+ GlShaderModule lambda$getOrCompileShader$1(GlDevice$ShaderCompilationKey,BiFunction,GlDevice$ShaderCompilationKey)
- GlShaderModule lambda$getOrCompileShader$1(ShaderSource,GlDevice$ShaderCompilationKey)
- GpuSampler createSampler(AddressMode,AddressMode,FilterMode,FilterMode,int)
+ GpuSampler createSampler(AddressMode,AddressMode,FilterMode,FilterMode)
- int getMaxSupportedAnisotropy()
+ void <init>(long,int,boolean,BiFunction,boolean)
- void <init>(long,int,boolean,ShaderSource,boolean)
```
...
+ void <init>(AddressMode,AddressMode,FilterMode,FilterMode)
```
...
```diff
- int getFbo(DirectStateAccess,GpuTexture)
...
+ Component lambda$new$101(Component,String)
...
+ Component lambda$new$109(Component,Integer)
...
+ Component lambda$new$24(Component,Double)
- Component lambda$new$28(Component,Double)
+ Component lambda$new$32(Component,Double)
+ Component lambda$new$34(Component,Double)
- Component lambda$new$42(Component,Double)
- Component lambda$new$48(Component,Double)
+ Component lambda$new$48(Component,Integer)
+ Component lambda$new$51(Component,Integer)
...
- Component lambda$new$57(Component,Integer)
- Component lambda$new$59(Component,Double)
+ Component lambda$new$67(Component,Boolean)
+ Component lambda$new$70(Component,Boolean)
+ Component lambda$new$72(Component,Boolean)
- Component lambda$new$73(Component,Boolean)
+ Component lambda$new$74(Component,Boolean)
- Component lambda$new$78(Component,Boolean)
+ Component lambda$new$78(Component,Integer)
- Component lambda$new$80(Component,Boolean)
+ Component lambda$new$81(Component,Integer)
- Component lambda$new$82(Component,Boolean)
...
+ Component lambda$new$93(Component,Double)
+ Component lambda$new$95(Component,Integer)
- Component lambda$new$99(Component,Double)
+ Component lambda$new$99(Component,NarratorStatus)
- Double lambda$new$22(int)
+ Double lambda$new$41(int)
- Double lambda$new$49(int)
+ Double lambda$new$83(Integer)
- Double lambda$new$89(Integer)
- int lambda$new$102()
- int lambda$new$23(Double)
+ int lambda$new$42(Double)
- int lambda$new$50(Double)
+ int lambda$new$96()
- int maxAnisotropyValue()
+ Integer lambda$new$82(Double)
- Integer lambda$new$88(Double)
+ KeyMapping[] lambda$new$80(int)
- KeyMapping[] lambda$new$86(int)
+ List lambda$new$102()
- List lambda$new$108()
+ Optional lambda$new$103(String)
- Optional lambda$new$109(String)
- OptionInstance chunkSectionFadeInTime()
+ OptionInstance lambda$new$63(SoundSource)
- OptionInstance lambda$new$69(SoundSource)
- OptionInstance maxAnisotropyBit()
+ String lambda$dumpOptionsForReport$113(Pair)
- String lambda$dumpOptionsForReport$119(Pair)
+ Tooltip lambda$new$21(PrioritizeChunkUpdates)
- Tooltip lambda$new$25(PrioritizeChunkUpdates)
+ Tooltip lambda$new$65(Boolean)
- Tooltip lambda$new$71(Boolean)
+ void lambda$createSoundSliderOptionInstance$64(SoundSource,Double)
- void lambda$createSoundSliderOptionInstance$70(SoundSource,Double)
+ void lambda$load$111(CompoundTag,String)
+ void lambda$load$112(String)
- void lambda$load$117(CompoundTag,String)
- void lambda$load$118(String)
- void lambda$new$100(Double)
+ void lambda$new$100(NarratorStatus)
- void lambda$new$103(Integer)
- void lambda$new$104(ParticleStatus)
+ void lambda$new$104(String)
+ void lambda$new$105(MusicManager$MusicFrequency)
+ void lambda$new$106(Boolean)
- void lambda$new$106(NarratorStatus)
+ void lambda$new$108(Integer)
+ void lambda$new$110(Integer)
...
+ void lambda$new$22(PrioritizeChunkUpdates)
+ void lambda$new$23(ChatVisiblity)
- void lambda$new$24(Double)
+ void lambda$new$25(Double)
+ void lambda$new$26(Double)
- void lambda$new$26(PrioritizeChunkUpdates)
- void lambda$new$27(ChatVisiblity)
+ void lambda$new$27(Integer)
+ void lambda$new$28(Double)
+ void lambda$new$30(Boolean)
- void lambda$new$30(Double)
+ void lambda$new$31(HumanoidArm)
- void lambda$new$31(Integer)
- void lambda$new$32(Double)
- void lambda$new$34(Boolean)
+ void lambda$new$35(Double)
- void lambda$new$35(HumanoidArm)
- void lambda$new$41(Double)
+ void lambda$new$49(Integer)
+ void lambda$new$50(AttackIndicatorStatus)
- void lambda$new$51(Double)
+ void lambda$new$52(Integer)
- void lambda$new$53(Integer)
+ void lambda$new$54(Double)
+ void lambda$new$55(Boolean)
- void lambda$new$55(Integer)
- void lambda$new$56(AttackIndicatorStatus)
+ void lambda$new$56(Boolean)
+ void lambda$new$57(Boolean)
+ void lambda$new$58(Boolean)
- void lambda$new$58(Integer)
+ void lambda$new$59(Boolean)
+ void lambda$new$60(Boolean)
...
- void lambda$new$72(Boolean)
+ void lambda$new$73(Boolean)
- void lambda$new$74(Boolean)
- void lambda$new$79(Boolean)
+ void lambda$new$79(Integer)
- void lambda$new$81(Boolean)
- void lambda$new$83(Boolean)
+ void lambda$new$84(Integer)
- void lambda$new$85(Integer)
+ void lambda$new$86(Boolean)
+ void lambda$new$87(Double)
+ void lambda$new$88(Double)
+ void lambda$new$89(Double)
+ void lambda$new$90(Double)
- void lambda$new$90(Integer)
+ void lambda$new$91(Double)
- void lambda$new$92(Boolean)
+ void lambda$new$92(Double)
...
+ void lambda$new$98(ParticleStatus)
```
...
```diff
- void addSmall(AbstractWidget,OptionInstance,AbstractWidget)
```
...
```diff
- AbstractWidget findOption(OptionInstance)
+ OptionsList$Entry big(List,Screen)
- OptionsList$Entry big(Options,OptionInstance,Screen)
- OptionsList$Entry small(AbstractWidget,OptionInstance,AbstractWidget,Screen)
...
```diff
- void updateCamera(DeltaTracker)
```
...
```diff
- void update(int,int,double,long,DeltaTracker,int,Camera)
+ void update(int,int,double,long,DeltaTracker,int)
```
...
```diff
- List getSideFaces(SpriteContents)
+ List getSpans(SpriteContents)
- void checkTransition(ItemModelGenerator$SideDirection,List,SpriteContents,int,int,int,int,int)
+ void checkTransition(ItemModelGenerator$SpanFacing,List,SpriteContents,int,int,int,int,int,boolean)
+ void createOrExpandSpan(List,ItemModelGenerator$SpanFacing,int,int)
- void lambda$getSideFaces$0(int,int,SpriteContents,List,int)
+ void lambda$getSpans$0(int,int,SpriteContents,List,int)
```
...
```diff
+ FogType getFogType(Camera,boolean)
- FogType getFogType(Camera)
+ Vector4f computeFogColor(Camera,float,ClientLevel,int,float,boolean)
- Vector4f computeFogColor(Camera,float,ClientLevel,int,float)
+ Vector4f setupFog(Camera,int,boolean,DeltaTracker,float,ClientLevel)
- Vector4f setupFog(Camera,int,DeltaTracker,float,ClientLevel)
```
...
```diff
- SpriteContents$AnimationState createAnimationState(GpuBufferSlice,int)
+ SpriteTicker createTicker()
+ void upload(int,int,int,int,NativeImage[],GpuTexture)
- void uploadFirstFrame(GpuTexture,int)
...
```diff
- boolean lambda$uploadInitialContents$1(TextureAtlasSprite)
+ int lambda$dumpContents$0(int)
- int lambda$dumpContents$5(int)
- String lambda$cycleAnimationFrames$6()
- String lambda$upload$0()
- String lambda$uploadInitialContents$2(TextureAtlasSprite)
- String lambda$uploadInitialContents$3()
- String lambda$uploadInitialContents$4()
- void close()
- void uploadInitialContents()
```
...
```diff
+ String lambda$storeChunkIoError$36(RegionStorageInfo)
- String lambda$storeChunkIoError$38(RegionStorageInfo)
- void lambda$onGameRuleChanged$36(ClientboundGameEventPacket,ServerPlayer)
- void lambda$onGameRuleChanged$37(Object,ServerLevel)
+ void lambda$storeChunkIoError$37(RegionStorageInfo,CrashReport,ChunkPos)
- void lambda$storeChunkIoError$39(RegionStorageInfo,CrashReport,ChunkPos)
- void onGameRuleChanged(GameRule,Object)
+ void onGameRuleChanged(String,GameRules$Value)
```
...
```diff
- Component lambda$queryRule$1(GameRule,Object)
+ Component lambda$queryRule$1(GameRules$Key,GameRules$Value)
- Component lambda$setRule$0(GameRule,Object)
+ Component lambda$setRule$0(GameRules$Key,GameRules$Value)
- int queryRule(CommandSourceStack,GameRule)
+ int queryRule(CommandSourceStack,GameRules$Key)
- int setRule(CommandContext,GameRule)
+ int setRule(CommandContext,GameRules$Key)
```
...
- Component lambda$setSize$16(String,long)
+ Component lambda$setSize$17(double,long)
- Component lambda$setSize$17(String,long)
+ Component lambda$setSize$18(double)
- Component lambda$setSize$18(String)
- String formatTicksToSeconds(long)
```
...
```diff
- void lambda$onGameRuleChanged$10(GameRule,Object,NotificationService)
+ void lambda$onGameRuleChanged$10(String,GameRules$Value,NotificationService)
- void onGameRuleChanged(GameRule,Object)
+ void onGameRuleChanged(String,GameRules$Value)
```
...
- JsonElement toJson()
+ String toJson()
+ void <init>(MinecraftServer,File)
- void <init>(MinecraftServer,Path)
- void lambda$parse$6(String)
+ void lambda$parseLocal$6(String)
- void parse(DataFixer,JsonElement)
+ void parseLocal(DataFixer,String)
```
...
```diff
- boolean shouldTravelInFluid(FluidState)
- void floatInWaterWhileRidden()
- void jumpOutOfFluid(double)
- void travelInLava(Vec3,double,boolean,double)
- void travelInWater(Vec3,double,boolean,double)
```
...
```diff
+ void <init>(Container,int,Predicate)
- void <init>(List,int)
```
...
```diff
+ boolean isTemptation(ItemStack)
- boolean isTemptation(PathfinderMob,ItemStack)
+ boolean lambda$doTick$0(TargetingConditions,ServerLevel,PathfinderMob,ServerPlayer)
+ boolean lambda$doTick$1(PathfinderMob,ServerPlayer)
- boolean lambda$doTick$2(TargetingConditions,ServerLevel,PathfinderMob,ServerPlayer)
- boolean lambda$doTick$3(PathfinderMob,ServerPlayer)
- boolean lambda$doTick$4(PathfinderMob,ServerPlayer)
- boolean lambda$forAnimal$1(PathfinderMob,ItemStack)
- boolean lambda$new$0(Predicate,PathfinderMob,ItemStack)
- boolean playerHoldingTemptation(PathfinderMob,Player)
+ boolean playerHoldingTemptation(Player)
- TemptingSensor forAnimal()
...
```diff
- void lambda$logCounts$1(String,int,Registry,FeatureCountTracker$FeatureData,int)
+ void lambda$logCounts$1(String,Integer,Registry,FeatureCountTracker$FeatureData,int)
```
...
```diff
- boolean isVisibleFromOutside(LevelAccessor,BlockPos,Direction)
- boolean isWaterOrAir(BlockState)
+ boolean isWaterOrAir(LevelAccessor,BlockPos)
```
...
```diff
- Optional lambda$place$4(Registry)
+ Optional lambda$place$5(Registry)
+ void lambda$place$4(Mutable,BlockPos)
- void lambda$place$5(WorldGenLevel,RandomSource,BlockPos,Holder$Reference)
- void lambda$place$6(RandomSource,TreeDecorator$Context,BlockPos)
+ void lambda$place$6(WorldGenLevel,RandomSource,BlockPos,Holder$Reference)
+ void lambda$place$8(RandomSource,TreeDecorator$Context,BlockPos)
```
...
```diff
+ LegacyStructureDataHandler getLegacyStructureHandler(ResourceKey,DimensionDataStorage,DataFixer)
- LegacyTagFixer lambda$getLegacyTagFixer$10(Supplier,List,DataFixer)
- LegacyTagFixer lambda$getLegacyTagFixer$11(Supplier,List,DataFixer)
- LegacyTagFixer lambda$getLegacyTagFixer$9(Supplier,DataFixer)
- Supplier getLegacyTagFixer(ResourceKey,Supplier,DataFixer)
```
...
```diff
- boolean lambda$getSlots$1(ItemStack)
- SlotCollection getSlots(ItemStack)
- Stream lambda$getSlots$2(ItemStack)
```
...
+ ContextNbtProvider$Source lambda$static$0(ContextNbtProvider)
+ ContextNbtProvider$Source lambda$static$2(ContextNbtProvider)
- LootContextArg lambda$static$1(ContextNbtProvider)
- LootContextArg lambda$static$3(ContextNbtProvider)
- LootContextArg$ArgCodecBuilder lambda$static$0(LootContextArg$ArgCodecBuilder)
+ void <init>(ContextNbtProvider$Source)
- void <init>(LootContextArg)
```
