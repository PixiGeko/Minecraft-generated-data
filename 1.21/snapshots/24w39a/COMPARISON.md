## Comparison with [24w38a](https://github.com/PixiGeko/Minecraft-generated-data/tree/24w38a)
...
<br/>
<table><tr><th></th><th align="left">24w38a</th><th>24w39a</th></tr><tr><td>DataPack version</td><td><pre>54</pre></td><td><pre>55</pre></td></tr><tr><td>World version</td><td><pre>4066</pre></td><td><pre>4069</pre></td></tr><tr><td>Protocol version</td><td><pre>1073742034</pre></td><td><pre>1073742035</pre></td></tr></table>
</details>
<hr/>
...
<table><tr><th></th><th align="left">24w38a</th><th>24w39a</th></tr><tr><td>minecraft:equippable</td><td><pre>{
...
```diff
+ minecraft/advancement/recipes/tools/black_bundle.json
+ minecraft/advancement/recipes/tools/blue_bundle.json
+ minecraft/advancement/recipes/tools/brown_bundle.json
+ minecraft/advancement/recipes/tools/bundle.json
+ minecraft/advancement/recipes/tools/cyan_bundle.json
+ minecraft/advancement/recipes/tools/gray_bundle.json
+ minecraft/advancement/recipes/tools/green_bundle.json
+ minecraft/advancement/recipes/tools/light_blue_bundle.json
+ minecraft/advancement/recipes/tools/light_gray_bundle.json
+ minecraft/advancement/recipes/tools/lime_bundle.json
+ minecraft/advancement/recipes/tools/magenta_bundle.json
+ minecraft/advancement/recipes/tools/orange_bundle.json
+ minecraft/advancement/recipes/tools/pink_bundle.json
+ minecraft/advancement/recipes/tools/purple_bundle.json
+ minecraft/advancement/recipes/tools/red_bundle.json
+ minecraft/advancement/recipes/tools/white_bundle.json
+ minecraft/advancement/recipes/tools/yellow_bundle.json
- minecraft/datapacks/bundle/data/minecraft/advancement/recipes/tools/black_bundle.json
- minecraft/datapacks/bundle/data/minecraft/advancement/recipes/tools/blue_bundle.json
- minecraft/datapacks/bundle/data/minecraft/advancement/recipes/tools/brown_bundle.json
- minecraft/datapacks/bundle/data/minecraft/advancement/recipes/tools/bundle.json
- minecraft/datapacks/bundle/data/minecraft/advancement/recipes/tools/cyan_bundle.json
- minecraft/datapacks/bundle/data/minecraft/advancement/recipes/tools/gray_bundle.json
- minecraft/datapacks/bundle/data/minecraft/advancement/recipes/tools/green_bundle.json
- minecraft/datapacks/bundle/data/minecraft/advancement/recipes/tools/light_blue_bundle.json
- minecraft/datapacks/bundle/data/minecraft/advancement/recipes/tools/light_gray_bundle.json
- minecraft/datapacks/bundle/data/minecraft/advancement/recipes/tools/lime_bundle.json
- minecraft/datapacks/bundle/data/minecraft/advancement/recipes/tools/magenta_bundle.json
- minecraft/datapacks/bundle/data/minecraft/advancement/recipes/tools/orange_bundle.json
- minecraft/datapacks/bundle/data/minecraft/advancement/recipes/tools/pink_bundle.json
- minecraft/datapacks/bundle/data/minecraft/advancement/recipes/tools/purple_bundle.json
- minecraft/datapacks/bundle/data/minecraft/advancement/recipes/tools/red_bundle.json
- minecraft/datapacks/bundle/data/minecraft/advancement/recipes/tools/white_bundle.json
- minecraft/datapacks/bundle/data/minecraft/advancement/recipes/tools/yellow_bundle.json
- minecraft/datapacks/bundle/data/minecraft/recipe/black_bundle.json
- minecraft/datapacks/bundle/data/minecraft/recipe/blue_bundle.json
- minecraft/datapacks/bundle/data/minecraft/recipe/brown_bundle.json
- minecraft/datapacks/bundle/data/minecraft/recipe/bundle.json
- minecraft/datapacks/bundle/data/minecraft/recipe/cyan_bundle.json
- minecraft/datapacks/bundle/data/minecraft/recipe/gray_bundle.json
- minecraft/datapacks/bundle/data/minecraft/recipe/green_bundle.json
- minecraft/datapacks/bundle/data/minecraft/recipe/light_blue_bundle.json
- minecraft/datapacks/bundle/data/minecraft/recipe/light_gray_bundle.json
- minecraft/datapacks/bundle/data/minecraft/recipe/lime_bundle.json
- minecraft/datapacks/bundle/data/minecraft/recipe/magenta_bundle.json
- minecraft/datapacks/bundle/data/minecraft/recipe/orange_bundle.json
- minecraft/datapacks/bundle/data/minecraft/recipe/pink_bundle.json
- minecraft/datapacks/bundle/data/minecraft/recipe/purple_bundle.json
- minecraft/datapacks/bundle/data/minecraft/recipe/red_bundle.json
- minecraft/datapacks/bundle/data/minecraft/recipe/white_bundle.json
- minecraft/datapacks/bundle/data/minecraft/recipe/yellow_bundle.json
- minecraft/datapacks/bundle/data/minecraft/tags/item/bundles.json
- minecraft/datapacks/bundle/pack.mcmeta
+ minecraft/recipe/black_bundle.json
+ minecraft/recipe/blue_bundle.json
+ minecraft/recipe/brown_bundle.json
+ minecraft/recipe/bundle.json
+ minecraft/recipe/cyan_bundle.json
+ minecraft/recipe/gray_bundle.json
+ minecraft/recipe/green_bundle.json
+ minecraft/recipe/light_blue_bundle.json
+ minecraft/recipe/light_gray_bundle.json
+ minecraft/recipe/lime_bundle.json
+ minecraft/recipe/magenta_bundle.json
+ minecraft/recipe/orange_bundle.json
+ minecraft/recipe/pink_bundle.json
+ minecraft/recipe/purple_bundle.json
+ minecraft/recipe/red_bundle.json
+ minecraft/recipe/white_bundle.json
+ minecraft/recipe/yellow_bundle.json
+ minecraft/tags/entity_type/boat.json
+ minecraft/tags/item/bundles.json
+ minecraft/tags/item/map_invisibility_equipment.json
```
...
+ XXX.data.tags.BundlesItemTagsProvider
...
```
XXX.advancements.critereon.EntitySubPredicates -1M | -1P
```
```
XXX.minecraft.data.Main +1M -3M
```
```
XXX.network.codec.ByteBufCodecs$9 +2M -2M
```
```
XXX.protocol.game.ClientboundSetTimePacket +6M -4M | +1P
```
```
XXX.minecraft.tags.ItemTags +1P
```
```
XXX.minecraft.world.LockCode +3M -2M | +1P -1P
```
```
...
```
```
XXX.world.effect.MobEffectInstance +2M -2M
```
```
XXX.world.effect.RaidOmenMobEffect +1M -1M
```
```
XXX.world.effect.SaturationMobEffect +1M -1M
```
```
XXX.world.effect.WindChargedMobEffect +1M -1M
```
```
XXX.world.entity.AreaEffectCloud +5M -2M
```
```
XXX.world.entity.EntityType +34M -8M | +18P -2P
```
```
XXX.world.entity.ExperienceOrb +2M -1M
```
```
XXX.world.entity.GlowSquid +1M -1M
```
```
XXX.world.entity.LivingEntity +29M -27M
```
```
XXX.world.entity.Mob +9M -9M
```
```
XXX.world.entity.NeutralMob +3M -3M
```
```
XXX.world.entity.Shearable +1P -1P
```
```
XXX.ai.behavior.GiveGiftToHero +2M -2M
```
```
XXX.ai.behavior.StartAttacking +6M -6M
```
```
XXX.ai.behavior.WorkAtComposter +1M -1M
```
```
XXX.ai.goal.AvoidEntityGoal +3M -2M
```
```
XXX.ai.goal.LookAtPlayerGoal +1M -1M
```
```
XXX.goal.target.NearestAttackableTargetGoal +2M -2M
```
```
XXX.goal.target.NearestHealableRaiderTargetGoal +1M -1M
```
```
XXX.ai.sensing.BreezeAttackEntitySensor +1M -1M
```
```
XXX.ai.sensing.FrogAttackablesSensor +1M -1M
```
```
XXX.ai.sensing.PlayerSensor +2M -2M
```
```
XXX.ai.targeting.TargetingConditions +2M -2M | +1P -1P
```
```
XXX.entity.vehicle.AbstractMinecartContainer +1M -1M
```
```
XXX.entity.vehicle.ChestBoat +2M -29M | -4P
```
```
XXX.entity.vehicle.ContainerEntity +1M -1M
```
```
XXX.entity.vehicle.MinecartBehavior +2P -2P
```
```
XXX.entity.vehicle.MinecartFurnace +1M -1M
```
```
XXX.entity.vehicle.MinecartTNT +2M -2M
```
```
XXX.entity.vehicle.OldMinecartBehavior +2M -2M | +3P
```
```
XXX.world.level.Explosion +1P
```
```
XXX.world.level.ServerExplosion +1M
```
```
...
```
```
XXX.level.material.FlowingFluid +5M -5M | +1P -1P
```
```
XXX.level.material.Fluid +2M -2M
```
```
XXX.level.material.LavaFluid +2M -2M
```
```
...
```diff
+ BundlesItemTagsProvider lambda$createStandardGenerator$5(CompletableFuture,TagsProvider,TagsProvider,PackOutput)
- PackMetadataGenerator lambda$createStandardGenerator$5(PackOutput)
...
- boolean applyEffectTick(ServerLevel,LivingEntity,int)
```
...
```diff
+ void onMobHurt(LivingEntity,DamageSource,float)
- void onMobHurt(ServerLevel,LivingEntity,DamageSource,float)
+ void onMobRemoved(LivingEntity,Entity$RemovalReason)
- void onMobRemoved(ServerLevel,LivingEntity,Entity$RemovalReason)
```
...
- void onMobRemoved(ServerLevel,LivingEntity,int,Entity$RemovalReason)
```
...
- boolean lambda$serverTick$0(Map$Entry)
+ boolean lambda$tick$0(Map$Entry)
- int lambda$serverTick$1(int)
+ int lambda$tick$1(int)
- void clientTick()
- void serverTick(ServerLevel)
```
...
- EntityType$EntityFactory boatFactory(Supplier)
- EntityType$EntityFactory chestBoatFactory(Supplier)
- EntityType$EntityFactory chestRaftFactory(Supplier)
- EntityType$EntityFactory raftFactory(Supplier)
- Item lambda$static$0()
- Item lambda$static$1()
- Item lambda$static$10()
- Item lambda$static$11()
- Item lambda$static$12()
- Item lambda$static$13()
- Item lambda$static$14()
- Item lambda$static$15()
- Item lambda$static$16()
- Item lambda$static$17()
- Item lambda$static$2()
- Item lambda$static$3()
- Item lambda$static$4()
- Item lambda$static$5()
- Item lambda$static$6()
- Item lambda$static$7()
- Item lambda$static$8()
- Item lambda$static$9()
...
+ void lambda$create$5(CompoundTag,Entity)
+ void lambda$create$6(CompoundTag)
+ void lambda$createDefaultStackConfig$1(Entity)
- void lambda$createDefaultStackConfig$19(Entity)
+ void lambda$spawn$0(Entity)
...
- boolean hurtClient(DamageSource)
- boolean hurtServer(ServerLevel,DamageSource,float)
```
...
```diff
+ boolean canAttack(LivingEntity,TargetingConditions)
+ boolean doHurtTarget(Entity)
- boolean doHurtTarget(ServerLevel,Entity)
+ boolean dropFromGiftLootTable(ResourceKey,Consumer)
- boolean dropFromGiftLootTable(ServerLevel,ResourceKey,BiConsumer)
+ boolean dropFromLootTable(ResourceKey,Function,Consumer)
- boolean dropFromLootTable(ServerLevel,ResourceKey,Function,BiConsumer)
+ boolean hurt(DamageSource,float)
- boolean hurtServer(ServerLevel,DamageSource,float)
+ boolean isInvulnerableTo(DamageSource)
- boolean isInvulnerableTo(ServerLevel,DamageSource)
+ Boolean lambda$checkBedExists$11(BlockPos)
- Boolean lambda$checkBedExists$13(BlockPos)
+ boolean lambda$createEquipmentSlotAccess$15(LivingEntity,EquipmentSlot,ItemStack)
...
+ boolean lambda$updateFallFlying$10(EquipmentSlot)
- boolean lambda$updateFallFlying$12(EquipmentSlot)
+ int getBaseExperienceReward()
- int getBaseExperienceReward(ServerLevel)
+ LootParams lambda$dropFromGiftLootTable$3(LootParams$Builder)
- LootParams lambda$dropFromGiftLootTable$4(LootParams$Builder)
+ LootParams lambda$dropFromShearingLootTable$4(ItemStack,LootParams$Builder)
- LootParams lambda$dropFromShearingLootTable$5(ItemStack,LootParams$Builder)
+ Reference2ObjectMap lambda$activeLocationDependentEnchantments$5(EquipmentSlot)
- Reference2ObjectMap lambda$activeLocationDependentEnchantments$7(EquipmentSlot)
+ Vec3 lambda$dismountVehicle$7(double,Vec3)
- Vec3 lambda$dismountVehicle$9(double,Vec3)
+ Vec3 lambda$stopSleeping$12(BlockPos)
...
- void dropExperience(ServerLevel,Entity)
+ void dropFromLootTable(DamageSource,boolean)
- void dropFromLootTable(ServerLevel,DamageSource,boolean)
+ void dropFromShearingLootTable(ResourceKey,ItemStack,Consumer)
- void dropFromShearingLootTable(ServerLevel,ResourceKey,ItemStack,BiConsumer)
- void handleExtraItemsCreatedOnUse(ItemStack)
+ void kill()
- void kill(ServerLevel)
- void lambda$collectEquipmentChanges$10(Holder,AttributeModifier)
+ void lambda$collectEquipmentChanges$8(Holder,AttributeModifier)
...
+ void lambda$handleEquipmentChanges$9(List,EquipmentSlot,ItemStack)
+ void lambda$stopLocationBasedEffects$14(AttributeMap,Holder,AttributeModifier)
- void lambda$stopLocationBasedEffects$16(AttributeMap,Holder,AttributeModifier)
+ void lambda$stopSleeping$13(BlockPos)
- void lambda$stopSleeping$15(BlockPos)
+ void triggerOnDeathMobEffects(Entity$RemovalReason)
- void triggerOnDeathMobEffects(ServerLevel,Entity$RemovalReason)
```
...
- boolean wantsToPickUp(ServerLevel,ItemStack)
+ int getBaseExperienceReward()
- int getBaseExperienceReward(ServerLevel)
+ ItemStack equipItemIfPossible(ItemStack)
- ItemStack equipItemIfPossible(ServerLevel,ItemStack)
+ Set dropPreservedEquipment(Predicate)
- Set dropPreservedEquipment(ServerLevel,Predicate)
+ void customServerAiStep()
- void customServerAiStep(ServerLevel)
+ void dropFromLootTable(DamageSource,boolean)
- void dropFromLootTable(ServerLevel,DamageSource,boolean)
+ void dropPreservedEquipment()
- void dropPreservedEquipment(ServerLevel)
+ void pickUpItem(ItemEntity)
- void pickUpItem(ServerLevel,ItemEntity)
```
...
```diff
- boolean isAngryAt(LivingEntity,ServerLevel)
+ boolean isAngryAt(LivingEntity)
+ boolean isAngryAtAllPlayers(Level)
- boolean isAngryAtAllPlayers(ServerLevel)
+ void playerDied(Player)
- void playerDied(ServerLevel,Player)
```
...
```diff
+ App lambda$create$3(Predicate,Function,BehaviorBuilder$Instance)
- App lambda$create$3(StartAttacking$StartAttackingCondition,StartAttacking$TargetFinder,BehaviorBuilder$Instance)
+ BehaviorControl create(Function)
+ BehaviorControl create(Predicate,Function)
- BehaviorControl create(StartAttacking$StartAttackingCondition,StartAttacking$TargetFinder)
- BehaviorControl create(StartAttacking$TargetFinder)
+ boolean lambda$create$0(Mob)
- boolean lambda$create$0(ServerLevel,Mob)
+ boolean lambda$create$1(Predicate,Function,MemoryAccessor,MemoryAccessor,ServerLevel,Mob,long)
- boolean lambda$create$1(StartAttacking$StartAttackingCondition,StartAttacking$TargetFinder,MemoryAccessor,MemoryAccessor,ServerLevel,Mob,long)
+ Trigger lambda$create$2(Predicate,Function,MemoryAccessor,MemoryAccessor)
- Trigger lambda$create$2(StartAttacking$StartAttackingCondition,StartAttacking$TargetFinder,MemoryAccessor,MemoryAccessor)
```
...
```diff
- void makeBread(ServerLevel,Villager)
+ void makeBread(Villager)
```
...
- boolean lambda$canUse$3(LivingEntity)
+ boolean lambda$new$1(LivingEntity)
- boolean lambda$new$1(Predicate,Predicate,LivingEntity,ServerLevel)
...
```diff
+ boolean lambda$new$0(Mob,LivingEntity)
- boolean lambda$new$0(Predicate,LivingEntity,ServerLevel)
```
...
```diff
+ void <init>(Mob,Class,boolean,Predicate)
- void <init>(Mob,Class,boolean,TargetingConditions$Selector)
+ void <init>(Mob,Class,int,boolean,boolean,Predicate)
- void <init>(Mob,Class,int,boolean,boolean,TargetingConditions$Selector)
```
...
```diff
+ void <init>(Raider,Class,boolean,Predicate)
- void <init>(Raider,Class,boolean,TargetingConditions$Selector)
```
...
```diff
+ boolean lambda$doTick$0(Breeze,LivingEntity)
- boolean lambda$doTick$0(ServerLevel,Breeze,LivingEntity)
```
...
```diff
+ boolean isMatchingEntity(LivingEntity,LivingEntity)
- boolean isMatchingEntity(ServerLevel,LivingEntity,LivingEntity)
```
...
- boolean lambda$doTick$1(ServerLevel,LivingEntity,Player)
+ boolean lambda$doTick$2(LivingEntity,Player)
- boolean lambda$doTick$2(ServerLevel,LivingEntity,Player)
```
...
- boolean test(ServerLevel,LivingEntity,LivingEntity)
+ TargetingConditions selector(Predicate)
- TargetingConditions selector(TargetingConditions$Selector)
```
...
- void destroy(ServerLevel,DamageSource)
```
...
```diff
+ AbstractContainerMenu createMenu(int,Inventory,Player)
+ boolean stillValid(Player)
- double rideHeight(EntityDimensions)
+ float getSinglePassengerXOffset()
...
+ ResourceKey getContainerLootTable()
+ SlotAccess getSlot(int)
- void <init>(EntityType,Level,Supplier)
...
+ void destroy(DamageSource)
+ void openCustomInventoryScreen(Player)
+ void readAdditionalSaveData(CompoundTag)
+ void remove(Entity$RemovalReason)
+ void setChanged()
+ void setContainerLootTable(ResourceKey)
+ void setContainerLootTableSeed(long)
...
```diff
+ void chestVehicleDestroyed(DamageSource,Level,Entity)
- void chestVehicleDestroyed(DamageSource,ServerLevel,Entity)
```
...
```diff
+ double getMaxSpeed()
- double getMaxSpeed(ServerLevel)
```
...
- double getMaxSpeed(ServerLevel)
+ void moveAlongTrack()
- void moveAlongTrack(ServerLevel)
```
...
```diff
+ boolean canDestroyEgg(Level,Entity)
- boolean canDestroyEgg(ServerLevel,Entity)
```
...
```diff
+ boolean canSpawnInLevel(Level)
- boolean canSpawnInLevel(ServerLevel)
```
...
- void postProcessGeneration(ServerLevel)
```
...
- FluidState getNewLiquid(ServerLevel,BlockPos,BlockState)
+ Map getSpread(Level,BlockPos,BlockState)
- Map getSpread(ServerLevel,BlockPos,BlockState)
+ void spread(Level,BlockPos,BlockState,FluidState)
- void spread(ServerLevel,BlockPos,BlockState,FluidState)
+ void spreadToSides(Level,BlockPos,FluidState,BlockState)
- void spreadToSides(ServerLevel,BlockPos,FluidState,BlockState)
+ void tick(Level,BlockPos,BlockState,FluidState)
- void tick(ServerLevel,BlockPos,BlockState,FluidState)
```
...
```diff
+ void randomTick(Level,BlockPos,FluidState,RandomSource)
- void randomTick(ServerLevel,BlockPos,FluidState,RandomSource)
+ void tick(Level,BlockPos,BlockState,FluidState)
- void tick(ServerLevel,BlockPos,BlockState,FluidState)
```
...
- boolean canConvertToSource(ServerLevel)
+ void randomTick(Level,BlockPos,FluidState,RandomSource)
- void randomTick(ServerLevel,BlockPos,FluidState,RandomSource)
```
...
```
```
XXX.gui.screens.Screen +2M
```
```
XXX.screens.inventory.AbstractFurnaceScreen +1M -10M | -2P
```
```
XXX.client.model.RaftModel -3M | -2P
```
```
XXX.client.multiplayer.ClientLevel +1M -2M | +1P
```
```
XXX.client.multiplayer.ClientLevel$ClientLevelData +1M -2M | -1P
```
```
XXX.client.player.RemotePlayer +1M -2M
```
```
XXX.renderer.entity.EntityRenderers +18M -2M
```
```
XXX.network.codec.ByteBufCodecs$11 +1M -1M | +1P
```
```
XXX.network.codec.ByteBufCodecs$13 +3M -3M | +1P -1P
```
```
XXX.network.codec.ByteBufCodecs$15 +5M -3M | +2P
```
```
XXX.network.codec.ByteBufCodecs$17 +2M -2M
```
```
XXX.network.codec.ByteBufCodecs$19 +3M -3M | -1P
```
```
XXX.network.codec.ByteBufCodecs$20 +3M -3M | +1P -3P
```
```
XXX.network.codec.ByteBufCodecs$22 +4M -5M | +4P -2P
```
```
XXX.network.codec.ByteBufCodecs$24 +3M -4M | +2P -2P
```
```
XXX.network.codec.ByteBufCodecs$26 +4M -3M | +2P -2P
```
```
XXX.network.codec.ByteBufCodecs$28 +4M -2M | +4P
```
```
XXX.server.level.ServerLevel +1M
```
```
XXX.entity.animal.Animal +3M -3M
```
```
XXX.entity.animal.Cat +1M -1M
```
```
XXX.entity.animal.Cat$CatRelaxOnOwnerGoal +1M -1M
```
```
XXX.entity.animal.Dolphin +1M -1M
```
```
XXX.entity.animal.Fox$DefendTrustedTargetGoal +1M -1M
```
```
XXX.entity.animal.Fox$FoxAlertableEntitiesSelector +1M -2M
```
```
...
```
```
XXX.entity.animal.Turtle +1M -1M | +1P -1P
```
```
XXX.entity.animal.WaterAnimal +1M -1M
```
```
XXX.animal.allay.Allay +10M -9M
```
```
XXX.animal.frog.Tadpole +1M -1M
```
```
...
```
```
XXX.animal.horse.AbstractHorse +4M -4M | +1P -1P
```
```
...
```
```
XXX.boss.enderdragon.EnderDragon +7M -7M
```
```
XXX.enderdragon.phases.AbstractDragonPhaseInstance +1M -1M
```
```
XXX.enderdragon.phases.DragonChargePlayerPhase +1M -1M
```
```
XXX.enderdragon.phases.DragonHoldingPatternPhase +2M -2M
```
```
XXX.enderdragon.phases.DragonLandingApproachPhase +2M -2M
```
```
XXX.enderdragon.phases.DragonPhaseInstance +1P -1P
```
```
XXX.enderdragon.phases.DragonSittingFlamingPhase +1M -1M
```
```
XXX.enderdragon.phases.DragonStrafePlayerPhase +1M -1M
```
```
XXX.boss.wither.WitherBoss +3M -3M | +1P -1P
```
```
XXX.entity.decoration.LeashFenceKnotEntity +1M -1M
```
```
XXX.entity.item.ItemEntity +3M -1M
```
```
XXX.entity.monster.CaveSpider +1M -1M
```
```
XXX.entity.monster.ElderGuardian +1M -1M
```
```
XXX.entity.monster.EnderMan$EndermanLookForPlayerGoal +2M -2M | +1P -1P
```
```
XXX.entity.monster.Evoker -1M
```
```
XXX.entity.monster.Evoker$EvokerWololoSpellGoal +1M -1M
```
```
XXX.entity.monster.Monster +1M -1M
```
```
...
```
```
XXX.entity.monster.Vindicator$VindicatorJohnnyAttackGoal +1M
```
```
XXX.entity.monster.WitherSkeleton +1M -1M
```
```
XXX.entity.monster.Zombie +5M -4M
```
```
XXX.entity.monster.ZombifiedPiglin +3M -3M
```
```
XXX.monster.hoglin.HoglinAi +3M -3M
```
```
XXX.monster.piglin.AbstractPiglin +1M -1M
```
```
XXX.monster.piglin.PiglinAi +31M -29M
```
```
XXX.monster.piglin.PiglinBrute +3M -3M
```
```
XXX.monster.warden.WardenAi +2M -2M
```
```
XXX.entity.npc.InventoryCarrier +1M -1M
```
```
XXX.entity.npc.Villager +3M -3M
```
```
...
```
```
XXX.entity.projectile.FireworkRocketEntity +2M -2M
```
```
XXX.entity.projectile.SmallFireball -1M
```
```
...
```
```
XXX.entity.raid.Raider +2M -2M
```
```
XXX.world.food.FoodData +1M -4M | -1P
```
```
XXX.world.inventory.RecipeCraftingHolder +1M -1M
```
```
XXX.world.item.BundleItem +1M -2M
```
...
```diff
+ void saveSlotSettingsLocally(RealmsWorldOptions)
```
...
- ScreenPosition getRecipeBookButtonPosition()
+ void containerTick()
+ void lambda$init$0(Button)
+ void recipesUpdated()
+ void render(GuiGraphics,int,int,float)
+ void slotClicked(Slot,int,int,ClickType)
```
...
```diff
+ void animatePaddle(float,int,ModelPart)
+ void setupAnim(BoatRenderState)
...
- void setTimeFromServer(long,long,boolean)
```
...
- EntityRenderer lambda$static$31(EntityRendererProvider$Context)
- EntityRenderer lambda$static$32(EntityRendererProvider$Context)
- EntityRenderer lambda$static$33(EntityRendererProvider$Context)
- EntityRenderer lambda$static$34(EntityRendererProvider$Context)
- EntityRenderer lambda$static$35(EntityRendererProvider$Context)
- EntityRenderer lambda$static$36(EntityRendererProvider$Context)
- EntityRenderer lambda$static$37(EntityRendererProvider$Context)
- EntityRenderer lambda$static$38(EntityRendererProvider$Context)
- EntityRenderer lambda$static$39(EntityRendererProvider$Context)
- EntityRenderer lambda$static$40(EntityRendererProvider$Context)
...
+ void lambda$createPlayerRenderers$26(ImmutableMap$Builder,EntityRendererProvider$Context,PlayerSkin$Model,EntityRendererProvider)
- void lambda$createPlayerRenderers$42(ImmutableMap$Builder,EntityRendererProvider$Context,PlayerSkin$Model,EntityRendererProvider)
```
...
```diff
+ void lambda$giveMorningGift$2(BlockPos$MutableBlockPos,ItemStack)
- void lambda$giveMorningGift$2(BlockPos$MutableBlockPos,ServerLevel,ItemStack)
```
...
```diff
+ void <init>(Fox,Class,boolean,boolean,Predicate)
- void <init>(Fox,Class,boolean,boolean,TargetingConditions$Selector)
```
...
```diff
- boolean test(LivingEntity,ServerLevel)
...
- void lambda$shear$0(ServerLevel,ItemStack)
+ void lambda$shear$1(ItemStack,Cow)
- void lambda$shear$1(ServerLevel,ItemStack,Cow)
- void shear(ServerLevel,SoundSource,ItemStack)
+ void shear(SoundSource,ItemStack)
```
...
```diff
- boolean lambda$static$0(LivingEntity,ServerLevel)
...
- void lambda$dropEquipment$0(ServerLevel,ItemStack)
...
+ boolean hurt(DamageSource,float)
- boolean hurtServer(ServerLevel,DamageSource,float)
- boolean lambda$static$6(LivingEntity,ServerLevel)
+ boolean lambda$static$6(LivingEntity)
+ void dropEquipment()
- void dropEquipment(ServerLevel)
+ void followMommy()
- void followMommy(ServerLevel)
```
...
```diff
+ void containerChanged(Container)
```
...
```diff
+ boolean checkWalls(AABB)
- boolean checkWalls(ServerLevel,AABB)
+ boolean hurt(DamageSource,float)
+ boolean hurt(EnderDragonPart,DamageSource,float)
- boolean hurt(ServerLevel,EnderDragonPart,DamageSource,float)
- boolean hurtServer(ServerLevel,DamageSource,float)
+ boolean reallyHurt(DamageSource,float)
+ void hurt(List)
- void hurt(ServerLevel,List)
+ void kill()
- void kill(ServerLevel)
+ void onCrystalDestroyed(EndCrystal,BlockPos,DamageSource)
- void onCrystalDestroyed(ServerLevel,EndCrystal,BlockPos,DamageSource)
- void reallyHurt(ServerLevel,DamageSource,float)
```
...
- void doServerTick(ServerLevel)
+ void findNewTarget()
- void findNewTarget(ServerLevel)
```
...
- void dropItem(ServerLevel,Entity)
```
...
```diff
- boolean lambda$new$0(EnderMan,LivingEntity,ServerLevel)
+ boolean lambda$new$0(EnderMan,LivingEntity)
+ void <init>(EnderMan,Predicate)
- void <init>(EnderMan,TargetingConditions$Selector)
```
...
```diff
- boolean lambda$new$0(LivingEntity,ServerLevel)
...
```diff
+ boolean isPreventingPlayerRest(Player)
- boolean isPreventingPlayerRest(ServerLevel,Player)
```
...
```diff
+ Optional findNearestValidAttackTarget(Hoglin)
- Optional findNearestValidAttackTarget(ServerLevel,Hoglin)
+ void maybeRetaliate(Hoglin,LivingEntity)
- void maybeRetaliate(ServerLevel,Hoglin,LivingEntity)
+ void wasHurtBy(Hoglin,LivingEntity)
- void wasHurtBy(ServerLevel,Hoglin,LivingEntity)
```
...
```diff
+ boolean isNearestValidAttackTarget(Piglin,LivingEntity)
- boolean isNearestValidAttackTarget(ServerLevel,Piglin,LivingEntity)
+ boolean lambda$angerNearbyPiglins$4(boolean,Player,Piglin)
- boolean lambda$angerNearbyPiglins$6(boolean,Player,Piglin)
- boolean lambda$babySometimesRideBabyHoglin$10(SetEntityLookTargetSometimes$Ticker,LivingEntity)
...
- boolean lambda$broadcastRetreat$14(AbstractPiglin)
+ boolean lambda$initCelebrateActivity$1(Piglin)
- boolean lambda$initCelebrateActivity$2(ServerLevel,Piglin)
- boolean lambda$initCelebrateActivity$3(Piglin)
+ boolean lambda$initFightActivity$0(Piglin,LivingEntity)
- boolean lambda$initFightActivity$1(Piglin,ServerLevel,LivingEntity)
- boolean lambda$initIdleActivity$0(ServerLevel,Piglin)
+ boolean lambda$initRideHoglinActivity$2(Piglin)
- boolean lambda$initRideHoglinActivity$4(Piglin)
+ boolean lambda$isNearestValidAttackTarget$3(LivingEntity,LivingEntity)
- boolean lambda$isNearestValidAttackTarget$5(LivingEntity,LivingEntity)
+ InteractionResult mobInteract(Piglin,Player,InteractionHand)
- InteractionResult mobInteract(ServerLevel,Piglin,Player,InteractionHand)
+ Optional findNearestValidAttackTarget(Piglin)
- Optional findNearestValidAttackTarget(ServerLevel,Piglin)
+ SoundEvent lambda$getSoundForCurrentActivity$7(Piglin,Activity)
- SoundEvent lambda$getSoundForCurrentActivity$9(Piglin,Activity)
+ void angerNearbyPiglins(Player,boolean)
- void angerNearbyPiglins(ServerLevel,Player,boolean)
+ void broadcastAngerTarget(AbstractPiglin,LivingEntity)
- void broadcastAngerTarget(ServerLevel,AbstractPiglin,LivingEntity)
+ void broadcastUniversalAnger(AbstractPiglin)
- void broadcastUniversalAnger(ServerLevel,AbstractPiglin)
+ void cancelAdmiring(Piglin)
- void cancelAdmiring(ServerLevel,Piglin)
+ void holdInOffhand(Piglin,ItemStack)
- void holdInOffhand(ServerLevel,Piglin,ItemStack)
+ void lambda$angerNearbyPiglins$5(Player,Piglin)
- void lambda$angerNearbyPiglins$7(ServerLevel,Player,Piglin)
- void lambda$broadcastAngerTarget$11(LivingEntity,ServerLevel,AbstractPiglin)
...
- void lambda$broadcastRetreat$15(LivingEntity,AbstractPiglin)
+ void lambda$broadcastUniversalAnger$10(AbstractPiglin,Player)
+ void lambda$broadcastUniversalAnger$11(AbstractPiglin)
- void lambda$broadcastUniversalAnger$12(ServerLevel,AbstractPiglin,Player)
- void lambda$broadcastUniversalAnger$13(ServerLevel,AbstractPiglin)
+ void lambda$wasHurtBy$6(LivingEntity,Brain,LivingEntity)
- void lambda$wasHurtBy$8(LivingEntity,Brain,LivingEntity)
+ void maybeRetaliate(AbstractPiglin,LivingEntity)
- void maybeRetaliate(ServerLevel,AbstractPiglin,LivingEntity)
+ void pickUpItem(Piglin,ItemEntity)
- void pickUpItem(ServerLevel,Piglin,ItemEntity)
+ void setAngerTarget(AbstractPiglin,LivingEntity)
- void setAngerTarget(ServerLevel,AbstractPiglin,LivingEntity)
+ void setAngerTargetIfCloserThanCurrent(AbstractPiglin,LivingEntity)
- void setAngerTargetIfCloserThanCurrent(ServerLevel,AbstractPiglin,LivingEntity)
+ void setAngerTargetToNearestTargetablePlayerIfFound(AbstractPiglin,LivingEntity)
- void setAngerTargetToNearestTargetablePlayerIfFound(ServerLevel,AbstractPiglin,LivingEntity)
+ void stopHoldingOffHandItem(Piglin,boolean)
- void stopHoldingOffHandItem(ServerLevel,Piglin,boolean)
+ void wasHurtBy(Piglin,LivingEntity)
- void wasHurtBy(ServerLevel,Piglin,LivingEntity)
```
...
```diff
+ boolean lambda$initFightActivity$3(Warden,LivingEntity)
- boolean lambda$initFightActivity$3(Warden,ServerLevel,LivingEntity)
- void onTargetInvalid(ServerLevel,Warden,LivingEntity)
+ void onTargetInvalid(Warden,LivingEntity)
```
...
- void pickUpItem(ServerLevel,Mob,InventoryCarrier,ItemEntity)
```
...
- void dealExplosionDamage(ServerLevel)
+ void explode()
- void explode(ServerLevel)
```
...
- void applySplash(ServerLevel,Iterable,Entity)
+ void applyWater()
- void applyWater(ServerLevel)
```
...
```diff
+ boolean setRecipeUsed(Level,ServerPlayer,RecipeHolder)
- boolean setRecipeUsed(ServerPlayer,RecipeHolder)
```
...
```diff
+ BundleItem lambda$getAllBundleItemColors$0(Item)
+ List getAllBundleItemColors()
- void broadcastChangesOnContainerMenu(Player)
```
