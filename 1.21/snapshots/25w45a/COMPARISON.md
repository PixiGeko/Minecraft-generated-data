## Comparison with [25w44a](https://github.com/PixiGeko/Minecraft-generated-data/tree/25w44a)
...
<br/>
<table><tr><th></th><th align="left">25w44a</th><th>25w45a</th></tr><tr><td>DataPack version</td><td><pre>{
  "major": 92,
  "minor": 0
}</pre></td><td><pre>{
  "major": 93,
  ...
  "major": 73,
  "minor": 0
}</pre></td></tr><tr><td>World version</td><td><pre>4659</pre></td><td><pre>4660</pre></td></tr><tr><td>Protocol version</td><td><pre>1073742100</pre></td><td><pre>1073742101</pre></td></tr></table>
<h3>Libraries<a name="version-data-libraries"></a></h3>
<details>
<summary>
Versions
</summary>
<table><tr><th></th><th align="left">25w44a</th><th>25w45a</th></tr><tr><td>com.mojang:datafixerupper</td><td><pre>8.0.17</pre></td><td><pre>9.0.19</pre></td></tr></table>
</details>
</details>
<hr/>
...
<table><tr><th></th><th align="left">25w44a</th><th>25w45a</th></tr><tr><td>minecraft:kinetic_weapon</td><td><pre>{
  "damage_conditions": {
...
<br/>
<table>
<tr><th>Name</th><th>25w44a</th><th>25w45a</th></tr>
<tr><th align="left"><div style="width:290px">subtitles.entity.parched.ambient</div></th><td>Stray rattles</td><td>Parched rattles</td></tr>
<tr><th align="left"><div style="width:290px">subtitles.entity.parched.death</div></th><td>Stray dies</td><td>Parched dies</td></tr>
<tr><th align="left"><div style="width:290px">subtitles.entity.parched.hurt</div></th><td>Stray hurts</td><td>Parched hurts</td></tr>
</table>
<br/>
</details>
</details>
...
+ minecraft/advancement/recipes/combat/netherite_horse_armor_smithing.json
+ minecraft/recipe/netherite_horse_armor_smithing.json
+ minecraft/tags/timeline/in_end.json
+ minecraft/tags/timeline/in_nether.json
+ minecraft/tags/timeline/in_overworld.json
+ minecraft/tags/timeline/universal.json
+ minecraft/tags/worldgen/biome/spawns_coral_variant_zombie_nautilus.json
- minecraft/tags/worldgen/biome/without_patrol_spawns.json
+ minecraft/timeline/day.json
+ minecraft/timeline/early_game.json
+ minecraft/timeline/moon.json
+ minecraft/timeline/villager_schedule.json
+ minecraft/zombie_nautilus_variant/temperate.json
+ minecraft/zombie_nautilus_variant/warm.json
```
...
+ minecraft/items/netherite_horse_armor.json
+ minecraft/models/item/netherite_horse_armor.json
+ minecraft/textures/entity/equipment/horse_body/netherite.png
+ minecraft/textures/entity/nautilus/zombie_nautilus_coral.png
+ minecraft/textures/item/netherite_horse_armor.png
```
...
```
XXX.commands.arguments.RangeArgument$Ints +2M -2M
```
```
XXX.data.tags.VanillaItemTagsProvider +1M -1M
```
```
XXX.gametest.framework.GameTestInfo +2M -2M
```
```
XXX.gametest.framework.StructureUtils +1M -1M
```
```
XXX.gametest.framework.TestCommand +2M -2M
```
```
XXX.gametest.framework.TestEnvironmentDefinition$Functions +3M -3M
```
```
XXX.minecraft.nbt.NbtOps +4M
```
```
XXX.minecraft.network.FriendlyByteBuf +2M -2M
```
```
XXX.network.chat.ClickEvent$Custom +2M -2M | +1P -1P
```
```
XXX.contents.data.StorageDataSource +2M -2M | +1P -1P
```
```
XXX.contents.objects.AtlasSprite +4M -4M | +3P -3P
```
```
XXX.network.protocol.PacketType +2M -2M | +1P -1P
```
```
XXX.protocol.common.ClientboundStoreCookiePacket +2M -2M | +1P -1P
```
```
XXX.protocol.common.ServerboundCustomClickActionPacket +2M -2M | +1P -1P
```
```
XXX.common.custom.CustomPacketPayload$1 +1M -1M
```
```
XXX.common.custom.CustomPacketPayload$Type +2M -2M | +1P -1P
```
```
XXX.common.custom.DiscardedPayload +4M -4M | +1P -1P
```
```
XXX.protocol.cookie.ClientboundCookieRequestPacket +2M -2M | +1P -1P
```
```
XXX.protocol.game.ClientboundCommandsPacket$NodeBuilder +1P -1P
```
```
XXX.protocol.game.ClientboundCooldownPacket +2M -2M | +1P -1P
```
```
XXX.protocol.game.ClientboundSelectAdvancementsTabPacket +2M -2M | +1P -1P
```
```
XXX.protocol.game.ClientboundStopSoundPacket +2M -2M | +1P -1P
```
```
XXX.protocol.game.ServerboundSetJigsawBlockPacket +4M -4M | +3P -3P
```
```
XXX.login.custom.CustomQueryPayload +1P -1P
```
```
XXX.login.custom.DiscardedQueryPayload +2M -2M | +1P -1P
```
```
XXX.network.syncher.EntityDataSerializers +2P
```
```
XXX.minecraft.server.PlayerAdvancements +1M -1M
```
```
XXX.minecraft.server.ServerAdvancementManager +3M -3M
```
```
XXX.minecraft.server.ServerFunctionManager +3M -3M | +2P -2P
```
```
XXX.server.bossevents.CustomBossEvent +3M -3M | +1P -1P
```
```
XXX.server.bossevents.CustomBossEvents +3M -3M
```
```
XXX.server.commands.AttributeCommand +6M -6M
```
```
XXX.server.commands.BossBarCommands +1M -1M
```
```
XXX.server.commands.FunctionCommand$Callbacks +1P -1P
```
```
XXX.server.commands.PlaySoundCommand +3M -3M
```
```
XXX.server.commands.ScheduleCommand +2M -2M
```
```
XXX.server.commands.StopwatchCommand +8M -8M
```
```
XXX.commands.data.StorageDataAccessor +1M -1M | +1P -1P
```
```
XXX.server.dedicated.DedicatedServerProperties$WorldDimensionData +1M -1M
```
```
XXX.dialog.action.CustomAll +2M -2M | +1P -1P
```
```
XXX.server.jsonrpc.JsonRPCUtils +1M -1M
```
```
XXX.server.jsonrpc.OutgoingRpcMethod$OutgoingRpcMethodBuilder +1M -1M
```
```
XXX.jsonrpc.api.MethodInfo$Named +2M -2M | +1P -1P
```
```
XXX.server.level.ServerPlayer +2M -1M
```
```
...
```
```
XXX.server.packs.FilePackResources +2M -2M
```
```
XXX.server.packs.PackResources +1P -1P
```
```
XXX.server.packs.PathPackResources +3M -3M
```
```
XXX.server.packs.VanillaPackResources +7M -7M
```
```
XXX.packs.repository.ServerPacksSource +1P -1P
```
```
XXX.packs.resources.FallbackResourceManager$LeakedResourceWarningInputStream +2M -2M
```
```
XXX.packs.resources.MultiPackResourceManager +3M -3M
```
```
XXX.packs.resources.ReloadableResourceManager +2M -2M
```
```
XXX.packs.resources.ResourceFilterSection +2M -2M
```
```
XXX.packs.resources.ResourceManager$Empty +2M -2M
```
```
XXX.packs.resources.SimpleJsonResourceReloadListener +2M -2M
```
```
XXX.server.permissions.Permission$Atom +3M -3M | +1P -1P
```
```
XXX.minecraft.sounds.SoundEvent +7M -7M | +1P -1P
```
```
XXX.minecraft.stats.Stat +1M -1M
```
```
XXX.minecraft.tags.TagEntry +5M -5M | +1P -1P
```
```
XXX.minecraft.tags.TagLoader +6M -6M
```
```
XXX.minecraft.tags.TagLoader$ElementLookup +2M -2M | +1P -1P
```
```
XXX.minecraft.tags.TagNetworkSerialization +1M -1M
```
```
XXX.minecraft.util.Mth +2M -2M | +4P -1P
```
```
XXX.attribute.modifier.AttributeModifier$OperationId +1P
```
```
XXX.attribute.modifier.BooleanModifier +1M
```
```
XXX.attribute.modifier.ColorModifier$1 +1M
```
```
XXX.attribute.modifier.ColorModifier$RgbModifier +1M
```
```
XXX.attribute.modifier.FloatModifier$1 +2M
```
```
XXX.world.effect.MobEffect +1M -1M
```
```
XXX.world.entity.Entity +3M -1M | +2P -2P
```
```
XXX.world.entity.EntityType +1M -1M
```
```
XXX.world.entity.HumanoidArm +3M -2M | +2P -1P
```
```
XXX.entity.ai.Brain$1 +2M -2M
```
```
XXX.ai.attributes.AttributeModifier +3M -3M | +1P -1P
```
```
...
```
```
XXX.entity.animal.ChickenVariants +1M -1M
```
```
XXX.entity.animal.PigVariants +1M -1M
```
```
XXX.entity.animal.TemperatureVariants +3P -3P
```
```
XXX.entity.variant.ModelAndTexture +1M -1M
```
```
XXX.entity.variant.SpawnContext +2M -1M | +1P
```
```
XXX.entity.vehicle.AbstractMinecart +1M -1M
```
```
XXX.world.flag.FeatureFlagRegistry +2M -2M
```
```
XXX.world.flag.FeatureFlags +1M -1M
```
```
XXX.world.inventory.BrewingStandMenu +2P -2P
```
```
XXX.world.inventory.EnchantmentMenu +1P -1P
```
```
XXX.world.inventory.HorseInventoryMenu$1 +1M -1M
```
```
XXX.world.inventory.InventoryMenu +5P -5P
```
```
XXX.world.item.AdventureModePredicate +1M -1M
```
```
XXX.world.item.CreativeModeTab +2M -2M | +2P -2P
```
```
XXX.world.item.Item$Properties +2M -2M
```
```
XXX.world.item.Items +1P
```
```
XXX.item.component.TypedEntityData$1 +3M -3M
```
```
XXX.item.enchantment.Enchantment$Builder +1M -1M
```
```
XXX.enchantment.effects.DamageImmunity -1M
```
```
XXX.enchantment.effects.RunFunction +2M -2M | +1P -1P
```
```
XXX.equipment.trim.TrimPattern +2M -2M | +1P -1P
```
```
XXX.world.level.Level -3M | +1P -1P
```
```
XXX.world.level.LevelAccessor -1M
```
...
```diff
+ MinMaxBounds$Ints getRange(CommandContext,String)
- MinMaxBounds$Ints getRange(CommandContext,String)
+ MinMaxBounds$Ints parse(StringReader)
- MinMaxBounds$Ints parse(StringReader)
```
...
```diff
- Identifier lambda$addTags$2(Holder$Reference)
+ ResourceLocation lambda$addTags$2(Holder$Reference)
```
...
```diff
- TestInstanceBlockEntity createNewEmptyTest(Identifier,BlockPos,Vec3i,Rotation,ServerLevel)
+ TestInstanceBlockEntity createNewEmptyTest(ResourceLocation,BlockPos,Vec3i,Rotation,ServerLevel)
```
...
```diff
- boolean verifyStructureExists(CommandSourceStack,Identifier)
+ boolean verifyStructureExists(CommandSourceStack,ResourceLocation)
- int createNewStructure(CommandSourceStack,Identifier,int,int,int)
+ int createNewStructure(CommandSourceStack,ResourceLocation,int,int,int)
```
...
```diff
- void lambda$setup$1(ServerLevel,Identifier)
+ void lambda$setup$1(ServerLevel,ResourceLocation)
- void lambda$teardown$2(ServerLevel,Identifier)
+ void lambda$teardown$2(ServerLevel,ResourceLocation)
- void run(ServerLevel,Identifier)
+ void run(ServerLevel,ResourceLocation)
```
...
- String toShortName(Identifier)
+ String toShortName(ResourceLocation)
- void <init>(Identifier,Identifier)
+ void <init>(ResourceLocation,ResourceLocation)
```
...
- Identifier id()
+ ResourceLocation id()
- void <init>(PacketFlow,Identifier)
+ void <init>(PacketFlow,ResourceLocation)
```
...
- void <init>(Identifier,byte[])
+ void <init>(ResourceLocation,byte[])
```
...
```diff
- StreamCodec findCodec(Identifier)
+ StreamCodec findCodec(ResourceLocation)
```
...
```diff
- DiscardedPayload lambda$codec$1(int,Identifier,FriendlyByteBuf)
+ DiscardedPayload lambda$codec$1(int,ResourceLocation,FriendlyByteBuf)
- Identifier id()
+ ResourceLocation id()
- StreamCodec codec(Identifier,int)
+ StreamCodec codec(ResourceLocation,int)
- void <init>(Identifier)
+ void <init>(ResourceLocation)
```
...
- void <init>(Identifier,SoundSource)
...
- void <init>(BlockPos,Identifier,Identifier,Identifier,String,JigsawBlockEntity$JointType,int,int)
...
```diff
- void lambda$applyFrom$0(ServerAdvancementManager,Identifier,AdvancementProgress)
+ void lambda$applyFrom$0(ServerAdvancementManager,ResourceLocation,AdvancementProgress)
```
...
```diff
- AdvancementHolder get(Identifier)
+ AdvancementHolder get(ResourceLocation)
- void lambda$apply$0(ImmutableMap$Builder,Identifier,Advancement)
+ void lambda$apply$0(ImmutableMap$Builder,ResourceLocation,Advancement)
- void validate(Identifier,Advancement)
+ void validate(ResourceLocation,Advancement)
```
...
```diff
- List getTag(Identifier)
+ List getTag(ResourceLocation)
- Optional get(Identifier)
+ Optional get(ResourceLocation)
- void executeTagFunctions(Collection,Identifier)
...
```diff
- CustomBossEvent load(Identifier,CustomBossEvent$Packed)
+ CustomBossEvent load(ResourceLocation,CustomBossEvent$Packed)
- Identifier getTextId()
+ ResourceLocation getTextId()
- void <init>(Identifier,Component)
+ void <init>(ResourceLocation,Component)
```
...
```diff
- CustomBossEvent create(Identifier,Component)
+ CustomBossEvent create(ResourceLocation,Component)
- CustomBossEvent get(Identifier)
+ CustomBossEvent get(ResourceLocation)
- void lambda$load$1(Identifier,CustomBossEvent$Packed)
...
```diff
- Component lambda$addModifier$23(Identifier,Holder,Entity)
+ Component lambda$addModifier$23(ResourceLocation,Holder,Entity)
- Component lambda$getAttributeModifier$20(Identifier,Holder,Entity,double)
+ Component lambda$getAttributeModifier$20(ResourceLocation,Holder,Entity,double)
- Component lambda$removeModifier$24(Identifier,Holder,Entity)
+ Component lambda$removeModifier$24(ResourceLocation,Holder,Entity)
- int addModifier(CommandSourceStack,Entity,Holder,Identifier,double,AttributeModifier$Operation)
+ int addModifier(CommandSourceStack,Entity,Holder,ResourceLocation,double,AttributeModifier$Operation)
- int getAttributeModifier(CommandSourceStack,Entity,Holder,Identifier,double)
+ int getAttributeModifier(CommandSourceStack,Entity,Holder,ResourceLocation,double)
- int removeModifier(CommandSourceStack,Entity,Holder,Identifier)
...
```diff
- int createBar(CommandSourceStack,Identifier,Component)
+ int createBar(CommandSourceStack,ResourceLocation,Component)
```
...
```diff
- Component lambda$playSound$7(Identifier,List)
+ Component lambda$playSound$7(ResourceLocation,List)
- Component lambda$playSound$8(Identifier,int)
+ Component lambda$playSound$8(ResourceLocation,int)
- int playSound(CommandSourceStack,Collection,Identifier,SoundSource,Vec3,float,float,float)
+ int playSound(CommandSourceStack,Collection,ResourceLocation,SoundSource,Vec3,float,float,float)
```
...
```diff
- Component lambda$schedule$6(Identifier,int,long)
+ Component lambda$schedule$6(ResourceLocation,int,long)
- Component lambda$schedule$7(Identifier,int,long)
+ Component lambda$schedule$7(ResourceLocation,int,long)
```
...
```diff
- Component lambda$createStopwatch$8(Identifier)
+ Component lambda$createStopwatch$8(ResourceLocation)
- Component lambda$queryStopwatch$9(Identifier,double)
+ Component lambda$queryStopwatch$9(ResourceLocation,double)
- Component lambda$removeStopwatch$12(Identifier)
+ Component lambda$removeStopwatch$12(ResourceLocation)
- Component lambda$restartStopwatch$11(Identifier)
+ Component lambda$restartStopwatch$11(ResourceLocation)
- int createStopwatch(CommandSourceStack,Identifier)
+ int createStopwatch(CommandSourceStack,ResourceLocation)
- int queryStopwatch(CommandSourceStack,Identifier,double)
+ int queryStopwatch(CommandSourceStack,ResourceLocation,double)
- int removeStopwatch(CommandSourceStack,Identifier)
+ int removeStopwatch(CommandSourceStack,ResourceLocation)
- int restartStopwatch(CommandSourceStack,Identifier)
+ int restartStopwatch(CommandSourceStack,ResourceLocation)
```
...
```diff
- void <init>(CommandStorage,Identifier)
+ void <init>(CommandStorage,ResourceLocation)
```
...
```diff
- ResourceKey lambda$create$2(Identifier)
+ ResourceKey lambda$create$2(ResourceLocation)
```

</details>
<details>
<summary>
net.minecraft.server.dialog.action.CustomAll
</summary>
...
```diff
- JsonObject createRequest(Integer,Identifier,List)
+ JsonObject createRequest(Integer,ResourceLocation,List)
```
...
```diff
- Holder$Reference register(Identifier)
+ Holder$Reference register(ResourceLocation)
```
...
- void <init>(Identifier,MethodInfo)
+ void <init>(ResourceLocation,MethodInfo)
```
...
- IoSupplier getResource(PackType,Identifier)
+ IoSupplier getResource(PackType,ResourceLocation)
- String getPathFromLocation(PackType,Identifier)
...
```diff
- IoSupplier getResource(Identifier,Path)
- IoSupplier getResource(PackType,Identifier)
+ IoSupplier getResource(PackType,ResourceLocation)
+ IoSupplier getResource(ResourceLocation,Path)
- IoSupplier lambda$getResource$1(Identifier,DataResult$Error)
...
- IoSupplier getResource(PackType,Identifier)
+ IoSupplier getResource(PackType,ResourceLocation)
- IoSupplier lambda$getResource$4(Identifier,PackType,List)
+ IoSupplier lambda$getResource$4(ResourceLocation,PackType,List)
- IoSupplier lambda$getResource$5(Identifier,DataResult$Error)
+ IoSupplier lambda$getResource$5(ResourceLocation,DataResult$Error)
- Optional lambda$asProvider$7(Identifier)
+ Optional lambda$asProvider$7(ResourceLocation)
- void lambda$listRawPaths$0(Identifier,PackType,Consumer,List)
+ void lambda$listRawPaths$0(ResourceLocation,PackType,Consumer,List)
- void lambda$listRawPaths$1(Identifier,DataResult$Error)
+ void lambda$listRawPaths$1(ResourceLocation,DataResult$Error)
- void listRawPaths(PackType,Identifier,Consumer)
+ void listRawPaths(PackType,ResourceLocation,Consumer)
```
...
```diff
- String lambda$new$0(Exception,Identifier,String)
+ String lambda$new$0(Exception,ResourceLocation,String)
- void <init>(InputStream,Identifier,String)
+ void <init>(InputStream,ResourceLocation,String)
```
...
```diff
- boolean lambda$new$1(ResourceFilterSection,Identifier)
+ boolean lambda$new$1(ResourceFilterSection,ResourceLocation)
- List getResourceStack(Identifier)
+ List getResourceStack(ResourceLocation)
- Optional getResource(Identifier)
...
```diff
- boolean lambda$isNamespaceFiltered$2(String,IdentifierPattern)
+ boolean lambda$isNamespaceFiltered$2(String,ResourceLocationPattern)
- boolean lambda$isPathFiltered$3(String,IdentifierPattern)
+ boolean lambda$isPathFiltered$3(String,ResourceLocationPattern)
```
...
```diff
- void lambda$scanDirectory$0(Map,Identifier,Object)
+ void lambda$scanDirectory$0(Map,ResourceLocation,Object)
- void lambda$scanDirectory$1(Identifier,Identifier,DataResult$Error)
...
```diff
- Identifier id()
- Permission$Atom create(Identifier)
+ Permission$Atom create(ResourceLocation)
+ ResourceLocation id()
- void <init>(Identifier)
+ void <init>(ResourceLocation)
```
...
```diff
- String locationToKey(Identifier)
+ String locationToKey(ResourceLocation)
```
...
```diff
- TagEntry element(Identifier)
+ TagEntry element(ResourceLocation)
- TagEntry optionalElement(Identifier)
+ TagEntry optionalElement(ResourceLocation)
- TagEntry optionalTag(Identifier)
+ TagEntry optionalTag(ResourceLocation)
- TagEntry tag(Identifier)
+ TagEntry tag(ResourceLocation)
- void <init>(Identifier,boolean,boolean)
...
```diff
- List lambda$load$0(Identifier)
+ List lambda$load$0(ResourceLocation)
- void lambda$build$2(DependencySorter,Identifier,List)
+ void lambda$build$2(DependencySorter,ResourceLocation,List)
- void lambda$build$3(Identifier,List)
+ void lambda$build$3(ResourceLocation,List)
- void lambda$build$4(Map,Identifier,List)
+ void lambda$build$4(Map,ResourceLocation,List)
- void lambda$build$5(TagEntry$Lookup,Map,Identifier,TagLoader$SortingEntry)
+ void lambda$build$5(TagEntry$Lookup,Map,ResourceLocation,TagLoader$SortingEntry)
- void lambda$loadTagsForRegistry$7(WritableRegistry,ResourceKey,Identifier,List)
+ void lambda$loadTagsForRegistry$7(WritableRegistry,ResourceKey,ResourceLocation,List)
```
...
```diff
- Optional lambda$fromFrozenRegistry$0(Registry,Identifier,boolean)
+ Optional lambda$fromFrozenRegistry$0(Registry,ResourceLocation,boolean)
- Optional lambda$fromWritableRegistry$1(HolderGetter,WritableRegistry,Identifier,boolean)
+ Optional lambda$fromWritableRegistry$1(HolderGetter,WritableRegistry,ResourceLocation,boolean)
```
...
```diff
- void lambda$deserializeTagsFromNetwork$3(ResourceKey,Registry,Map,Identifier,IntList)
...
```diff
- LerpFunction argumentKeyframeLerp(EnvironmentAttribute)
```

</details>
<details>
<summary>
net.minecraft.world.attribute.modifier.ColorModifier$1
</summary>
...
<details>
<summary>
net.minecraft.world.attribute.modifier.ColorModifier$RgbModifier
</summary>
...
<details>
<summary>
net.minecraft.world.attribute.modifier.FloatModifier$1
</summary>

```diff
- FloatWithAlpha lambda$argumentKeyframeLerp$0(float,FloatWithAlpha,FloatWithAlpha)
- LerpFunction argumentKeyframeLerp(EnvironmentAttribute)
```
...
```diff
- MobEffect addAttributeModifier(Holder,Identifier,double,AttributeModifier$Operation)
+ MobEffect addAttributeModifier(Holder,ResourceLocation,double,AttributeModifier$Operation)
```
...
```diff
- Vec3 getKnownSpeed()
+ Vec3 getRelativePortalPosition(Direction$Axis,BlockUtil$FoundRectangle)
- Vec3 getRelativePortalPosition(Direction$Axis,BlockUtil$FoundRectangle)
- void computeSpeed()
```
...
```diff
- Identifier getKey(EntityType)
+ ResourceLocation getKey(EntityType)
```
...
- Component caption()
+ int getId()
- int lambda$static$0(HumanoidArm)
- int lambda$static$1(HumanoidArm)
+ String getKey()
```
...
```diff
- Identifier lambda$keys$0(MemoryModuleType,Codec)
- Object lambda$keys$2(DynamicOps,Identifier)
+ Object lambda$keys$2(DynamicOps,ResourceLocation)
+ ResourceLocation lambda$keys$0(MemoryModuleType,Codec)
```
...
```diff
- boolean is(Identifier)
+ boolean is(ResourceLocation)
- Identifier id()
+ ResourceLocation id()
- void <init>(Identifier,double,AttributeModifier$Operation)
...
```diff
- boolean hasModifier(Holder,Identifier)
+ boolean hasModifier(Holder,ResourceLocation)
- double getModifierValue(Holder,Identifier)
...
```diff
+ boolean isNightOrRaining(Level)
```

</details>
<details>
<summary>
net.minecraft.world.entity.animal.ChickenVariants
</summary>

```diff
- ResourceKey createKey(Identifier)
...
```diff
- void <init>(Object,Identifier)
+ void <init>(Object,ResourceLocation)
```
...
- void <init>(BlockPos,ServerLevelAccessor,EnvironmentAttributeReader,Holder)
+ void <init>(BlockPos,ServerLevelAccessor,Holder)
```
...
```diff
- void lambda$fromNames$0(Identifier)
+ void lambda$fromNames$0(ResourceLocation)
- void lambda$toNames$1(FeatureFlagSet,Set,Identifier,FeatureFlag)
+ void lambda$toNames$1(FeatureFlagSet,Set,ResourceLocation,FeatureFlag)
```
...
```diff
- boolean lambda$printMissingFlags$0(Set,Identifier)
+ boolean lambda$printMissingFlags$0(Set,ResourceLocation)
```
...
+ void <init>(HorseInventoryMenu,Container,LivingEntity,EquipmentSlot,int,int,int,ResourceLocation,AbstractHorse)
```
...
```diff
+ Stream lambda$computeTooltip$2(BlockPredicate)
- Stream lambda$computeTooltip$2(BlockPredicate)
```
...
```diff
- Identifier createTextureLocation(String)
- Identifier getBackgroundTexture()
+ ResourceLocation createTextureLocation(String)
...
```diff
- DataComponentMap buildAndValidateComponents(Component,Identifier)
+ DataComponentMap buildAndValidateComponents(Component,ResourceLocation)
- Identifier effectiveModel()
+ ResourceLocation effectiveModel()
```

</details>
<details>
<summary>
net.minecraft.world.item.component.TypedEntityData$1
</summary>

```diff
+ DataResult lambda$decode$1(Codec,DynamicOps,Object)
- DataResult lambda$decode$2(Object,Codec,DynamicOps,Pair)
- Pair lambda$decode$1(CompoundTag,Pair,Object)
+ Pair lambda$decode$2(Object,Pair)
- String lambda$decode$0(Object)
+ String lambda$decode$0(String)
```
...
```diff
- Enchantment build(Identifier)
+ Enchantment build(ResourceLocation)
```
...
```diff
+ DamageImmunity lambda$static$0()
```
...
- void <init>(Identifier,Component,boolean)
+ void <init>(ResourceLocation,Component,boolean)
```
...
+ XXX.blaze3d.shaders.ShaderSource
...
- XXX.blaze3d.systems.SamplerCache
...
- XXX.blaze3d.textures.GpuSampler
+ XXX.blaze3d.textures.GpuTexture
- XXX.blaze3d.textures.GpuTexture$Usage
...
+ XXX.client.model.GuardianParticleModel
...
- XXX.client.model.HumanoidModel$ArmPose$1
...
+ XXX.client.renderer.DynamicUniforms$ChunkSectionInfo
...
+ XXX.gui.components.ChatComponent$DrawingGraphicsAccess
...
- XXX.realmsclient.client.FileUpload$UploadCountingInputStream
...
- XXX.realmsclient.dto.OutboundPlayer
...
```
XXX.blaze3d.opengl.GlDevice +2M -2M
```
```
XXX.blaze3d.opengl.GlSampler +2M -1M | +1P
```
```
XXX.blaze3d.opengl.GlShaderModule +2M -2M | +1P -1P
```
```
XXX.blaze3d.pipeline.RenderPipeline$Builder +3M -3M
```
```
XXX.blaze3d.platform.Lighting +1M -1M
```
```
XXX.minecraft.advancements.AdvancementHolder +2M -2M | +1P -1P
```
```
XXX.minecraft.advancements.AdvancementRewards$Builder +2M -2M
```
```
XXX.minecraft.advancements.CriteriaTriggers +58P -57P
```
```
XXX.minecraft.client.CloudStatus +2M -3M | +1P -2P
```
```
XXX.minecraft.client.KeyMapping$Category +3M -3M | +1P -1P
```
```
XXX.minecraft.client.NarratorStatus +1P
```
```
XXX.minecraft.client.Options +102M -94M
```
```
XXX.minecraft.client.PeriodicNotificationManager +1M -1M | +1P -1P
```
```
XXX.data.models.BlockModelGenerators$PlantType +1M -1M
```
```
XXX.data.models.ModelProvider$ItemInfoCollector +1M -1M
```
```
XXX.models.model.ItemModelUtils +3M -3M
```
```
XXX.models.model.ModelLocationUtils +6M -6M
```
```
XXX.models.model.TexturedModel$Provider +2M -2M
```
```
XXX.client.gui.Gui +3M -3M | +31P -31P
```
```
XXX.gui.components.AbstractSelectionList +2P -2P
```
```
XXX.gui.components.AbstractSliderButton +2M -2M | +4P -4P
```
```
XXX.gui.components.ChatComponent +1P -1P
```
```
XXX.model.geom.ModelLayers +1P
```
```
XXX.model.geom.PartNames +11P
```
```
XXX.client.multiplayer.ClientAdvancements +1M -1M
```
```
XXX.client.multiplayer.ClientLevel +14M -14M | +1P -2P
```
```
XXX.client.multiplayer.SessionSearchTrees +1M -1M
```
```
XXX.client.particle.BlockMarker +1P
```
```
XXX.client.particle.BreakingItemParticle +1P
```
```
XXX.client.particle.ParticleResources +3M -3M
```
```
XXX.client.particle.SingleQuadParticle$Layer +2M -2M | +2P -1P
```
```
XXX.client.player.LocalPlayer -1M
```
```
XXX.client.renderer.CloudRenderer +1M -1M | +2P -2P
```
```
XXX.client.renderer.PostChain +4M -4M | +1P -1P
```
```
XXX.client.renderer.PostChain$TargetBundle$1 +3M -3M | +1P -1P
```
```
XXX.client.renderer.PostChainConfig$Pass +4M -4M | +3P -3P
```
```
XXX.client.renderer.PostChainConfig$TextureInput +2M -2M | +1P -1P
```
```
XXX.client.renderer.PostPass$TargetInput +2M -2M | +1P -1P
```
```
XXX.client.renderer.ScreenEffectRenderer +1P -1P
```
```
XXX.client.renderer.ShaderManager$1 +1M -1M | +1P -1P
```
```
XXX.client.renderer.ShaderManager$ShaderSourceKey +2M -2M | +1P -1P
```
```
XXX.client.renderer.Sheets +3M -2M | +14P -13P
```
```
XXX.client.renderer.SkyRenderer +3M -3M | +3P -3P
```
```
XXX.client.renderer.WeatherEffectRenderer +2P -2P
```
```
XXX.client.renderer.WorldBorderRenderer +1P -1P
```
```
XXX.block.model.BlockModel +2M -2M | +1P -1P
```
```
XXX.block.model.ItemModelGenerator +1P -1P
```
```
XXX.block.model.SimpleModelWrapper +1M -1M
```
```
XXX.block.model.TextureSlots +2M -2M
```
```
XXX.renderer.blockentity.AbstractEndPortalRenderer +2P -2P
```
```
XXX.renderer.blockentity.SkullBlockRenderer +2M -2M
```
```
XXX.renderer.blockentity.TheEndGatewayRenderer +1P -1P
```
```
XXX.renderer.chunk.SectionRenderDispatcher$RenderSection +4M -1M | +2P
```
```
XXX.renderer.entity.AbstractMinecartRenderer +1P -1P
```
```
XXX.renderer.entity.AbstractZombieRenderer +2M -2M | +1P -1P
```
```
XXX.renderer.entity.AllayRenderer +2M -2M | +1P -1P
```
```
XXX.renderer.entity.ArmorStandRenderer +2M -2M | +1P -1P
```
```
XXX.renderer.entity.AxolotlRenderer +2M -2M
```
```
XXX.renderer.entity.BeeRenderer +2M -2M | +4P -4P
```
```
XXX.renderer.entity.BoatRenderer +1M -1M | +1P -1P
```
```
XXX.renderer.entity.BreezeRenderer +2M -2M | +1P -1P
```
```
XXX.renderer.entity.CamelRenderer +2M -2M | +1P -1P
```
```
XXX.renderer.entity.CaveSpiderRenderer +1M -1M | +1P -1P
```
```
XXX.renderer.entity.CodRenderer +1M -1M | +1P -1P
```
```
XXX.renderer.entity.CowRenderer +2M -2M
```
```
XXX.renderer.entity.CreeperRenderer +2M -2M | +1P -1P
```
```
XXX.renderer.entity.DolphinRenderer +2M -2M | +1P -1P
```
```
XXX.renderer.entity.DonkeyRenderer$Type +1M -1M | +1P -1P
```
```
XXX.renderer.entity.DrownedRenderer +2M -2M | +1P -1P
```
```
XXX.renderer.entity.EndCrystalRenderer +1P -1P
```
```
XXX.renderer.entity.EndermanRenderer +2M -2M | +1P -1P
```
```
XXX.renderer.entity.EntityRenderers +1M -3M
```
```
XXX.renderer.entity.EvokerRenderer +2M -2M | +1P -1P
```
```
XXX.renderer.entity.ExperienceOrbRenderer +1P -1P
```
```
XXX.renderer.entity.FoxRenderer +2M -2M | +4P -4P
```
```
XXX.renderer.entity.GhastRenderer +2M -2M | +2P -2P
```
```
XXX.renderer.entity.GlowSquidRenderer +2M -2M | +1P -1P
```
```
XXX.renderer.entity.GuardianRenderer +2M -2M | +2P -2P
```
```
XXX.renderer.entity.HoglinRenderer +2M -2M | +1P -1P
```
```
XXX.renderer.entity.ItemRenderer +2P -2P
```
```
XXX.renderer.entity.MagmaCubeRenderer +2M -2M | +1P -1P
```
```
XXX.renderer.entity.NautilusRenderer +4M -3M | +2P -2P
```
```
XXX.renderer.entity.ZombieVillagerRenderer +2M -2M | +1P -1P
```
```
XXX.entity.layers.BreezeWindLayer +1P -1P
```
```
XXX.entity.layers.CreeperPowerLayer +1M -1M | +1P -1P
```
```
XXX.entity.layers.DrownedOuterLayer +1P -1P
```
```
XXX.entity.layers.EnergySwirlLayer +1P -1P
```
```
XXX.entity.layers.HorseMarkingLayer +2P -2P
```
```
XXX.entity.layers.IronGolemCrackinessLayer +1P -1P
```
```
XXX.entity.layers.RopesLayer +1M -1M
```
```
XXX.entity.layers.SheepWoolUndercoatLayer +1P -1P
```
```
XXX.entity.layers.SkeletonClothingLayer +1M -1M | +1P -1P
```
```
XXX.entity.layers.SpinAttackEffectLayer +1P -1P
```
```
XXX.entity.layers.WingsLayer +1M -1M
```
```
XXX.entity.layers.WitherArmorLayer +1M -1M | +1P -1P
```
```
XXX.entity.layers.WolfCollarLayer +1P -1P
```
```
XXX.fog.environment.AtmosphericFogEnvironment +1M
```
```
XXX.renderer.item.BlockModelWrapper$Unbaked +2M -2M | +1P -1P
```
```
XXX.renderer.item.SpecialModelWrapper$Unbaked +2M -2M | +1P -1P
```
```
XXX.renderer.rendertype.RenderSetup$RenderSetupBuilder +4M -1M
```
```
XXX.renderer.rendertype.RenderTypes +68M -67M | +4P -3P
```
```
XXX.renderer.special.ChestSpecialRenderer +8P -8P
```
```
XXX.renderer.special.CopperGolemStatueSpecialRenderer +1M -1M | +1P -1P
```
```
XXX.renderer.special.ShulkerBoxSpecialRenderer$Unbaked +2M -2M | +1P -1P
```
```
XXX.renderer.special.SkullSpecialRenderer$Unbaked +1M -1M
```
```
XXX.renderer.state.LevelRenderState +1P
```
```
XXX.renderer.state.SkyRenderState +3P -3P
```
```
XXX.renderer.texture.CubeMapTexture +1M -1M
```
```
XXX.renderer.texture.DynamicTexture +1M -1M
```
```
XXX.renderer.texture.SimpleTexture +1M -1M
```
```
XXX.renderer.texture.SpriteContents +3M -3M | +1P -1P
```
```
XXX.renderer.texture.SpriteLoader +3M -3M | +1P -1P
```
```
XXX.renderer.texture.Stitcher +1M -1M
```
```
XXX.renderer.texture.TextureAtlas +4M -4M | +4P -3P
```
```
XXX.renderer.texture.TextureContents +1M -1M
```
```
XXX.texture.atlas.SpriteResourceLoader +1M -1M | +1P -1P
```
```
XXX.texture.atlas.SpriteSource$Output +2M -2M | +1P -1P
```
```
XXX.texture.atlas.SpriteSourceList$1 +1M -1M
```
```
XXX.atlas.sources.LazyLoadedImage +1M -1M | +1P -1P
```
```
XXX.atlas.sources.PalettedPermutations$PalettedSpriteSupplier +2M -2M | +1P -1P
```
```
XXX.atlas.sources.SourceFilter +2M -2M | +1P -1P
```
```
XXX.atlas.sources.Unstitcher$Region +2M -2M | +1P -1P
```
```
XXX.client.resources.ClientPackSource +1P -1P
```
```
XXX.client.resources.DryFoliageColorReloadListener +1P -1P
```
```
XXX.client.resources.GrassColorReloadListener +1P -1P
```
```
XXX.client.resources.LegacyStuffWrapper +1M -1M
```
```
XXX.client.resources.MapTextureManager$MapInstance +1P -1P
```
```
XXX.client.resources.SplashManager +1P -1P
```
```
XXX.resources.model.AtlasManager +3M -3M
```
```
XXX.resources.model.AtlasManager$PendingStitchResults +1M -1M
```
```
XXX.resources.model.BlockStateModelLoader +2M -2M
```
```
XXX.resources.model.EquipmentClientInfo$Builder +3M -3M
```
```
XXX.resources.model.EquipmentClientInfo$Layer +6M -6M | +1P -1P
```
```
XXX.resources.model.Material +3M -3M | +2P -2P
```
```
XXX.resources.model.MissingBlockModel +1P -1P
```
```
XXX.resources.model.ModelBakery$MissingModels$1 +1M -1M
```
```
XXX.resources.model.ModelDiscovery$ModelWrapper +1M -1M | +1P -1P
```
```
XXX.resources.model.ModelManager +5M -5M | +1P
```
```
XXX.resources.model.ResolvableModel$Resolver +1P -1P
```
```
XXX.resources.model.UnbakedModel +1M -1M
```
```
XXX.resources.sounds.AbstractSoundInstance +2M -2M | +1P -1P
```
```
XXX.resources.sounds.SimpleSoundInstance +2M -2M
```
```
XXX.resources.sounds.Sound +3M -3M | +1P -1P
```
```
XXX.resources.sounds.SoundInstance +1P -1P
```
```
XXX.client.searchtree.FullTextSearchTree +1M -1M
```
```
XXX.client.sounds.MusicManager$MusicFrequency +2M -3M | +2P -3P
```
```
XXX.client.sounds.SoundEngine +7M -7M | +1P -1P
```
```
XXX.client.sounds.SoundManager$Preparations +1M -1M
```
```
XXX.client.sounds.WeighedSoundEvents +1M -1M
```
```
XXX.client.telemetry.WorldSessionTelemetryManager +1M -1M
```
```
XXX.minecraft.commands.CacheableFunction +2M -2M | +1P -1P
```
```
XXX.minecraft.commands.CommandSourceStack +1M -1M
```
```
XXX.minecraft.commands.Commands$1 +1M -1M
```
```
XXX.minecraft.commands.SharedSuggestionProvider +4M -4M
```
```
XXX.commands.arguments.ResourceOrTagArgument +2M -2M
```
```
XXX.commands.arguments.ResourceSelectorArgument +1M -1M
```
```
XXX.arguments.blocks.BlockStateParser +1M -1M | +1P -1P
```
```
XXX.arguments.item.ComponentPredicateParser$ComponentLookupRule +1M -1M
```
```
XXX.arguments.item.ComponentPredicateParser$ElementLookupRule +1M -1M
```
```
XXX.arguments.item.ComponentPredicateParser$TagLookupRule +1M -1M
```
```
XXX.arguments.item.FunctionArgument$1 +1M -1M | +1P -1P
```
```
XXX.arguments.item.ItemInput +1M -1M
```
```
XXX.arguments.item.ItemParser$State +2M -2M
```
```
XXX.arguments.item.ItemPredicateArgument$ComponentWrapper +3M -3M | +1P -1P
```
```
XXX.arguments.item.ItemPredicateArgument$PredicateWrapper +2M -2M | +1P -1P
```
```
XXX.arguments.selector.EntitySelector +1M -1M | +1P -1P
```
```
XXX.arguments.selector.EntitySelectorParser +9M -9M | +4P -4P
```
```
XXX.selector.options.EntitySelectorOptions +3M -3M
```
```
XXX.commands.execution.TraceCallbacks +1P -1P
```
```
XXX.commands.functions.CommandFunction +1M -1M | +1P -1P
```
```
XXX.commands.functions.InstantiatedFunction +1P -1P
```
```
XXX.commands.functions.MacroFunction$Entry +1P -1P
```
```
XXX.commands.functions.MacroFunction$PlainTextEntry +1M -1M
```
```
XXX.commands.synchronization.SuggestionProviders$RegisteredSuggestion +2M -2M | +1P -1P
```
```
XXX.minecraft.core.ClientAsset$DownloadedTexture +3M -3M | +1P -1P
```
```
XXX.minecraft.core.ClientAsset$Texture +1P -1P
```
```
XXX.minecraft.core.DefaultedMappedRegistry +4M -4M | +1P -1P
```
```
XXX.minecraft.core.Holder +1P -1P
```
```
XXX.minecraft.core.MappedRegistry +6M -6M
```
```
XXX.minecraft.core.RegistrySynchronization$PackedRegistryEntry +2M -2M | +1P -1P
```
```
XXX.core.component.DataComponentPatch$PatchKey +2M -2M
```
```
XXX.component.predicates.AttributeModifiersPredicate$EntryPredicate +2M -2M | +1P -1P
```
```
XXX.component.predicates.DamagePredicate +4M -4M | +2P -2P
```
```
XXX.minecraft.data.PackOutput$PathProvider +2M -2M
```
```
XXX.advancements.packs.VanillaAdventureAdvancements +2M -2M
```
```
XXX.data.info.BiomeParametersDumpReport +1M -1M
```
```
XXX.data.loot.LootTableProvider +1M -1M
```
```
XXX.data.recipes.RecipeBuilder +1M -1M | +1P -1P
```
```
XXX.data.recipes.RecipeProvider +4M -4M
```
```
XXX.data.registries.VanillaRegistries +2M -2M
```
```
XXX.minecraft.resources.RegistryDataLoader +2M -2M
```
```
XXX.minecraft.resources.ResourceKey +8M -8M | +2P -2P
```
```
XXX.minecraft.util.BinaryAnimator +1M -2M | +1P -1P
```
```
XXX.minecraft.util.ExtraCodecs$TagOrElementLocation +2M -2M | +1P -1P
```
```
XXX.packrat.commands.ResourceLookupRule +1P -1P
```
```
XXX.minecraft.world.LockCode +2M -2M | +1P -1P
```
```
XXX.minecraft.world.RandomSequences +6M -6M
```
```
XXX.minecraft.world.Stopwatches +7M -7M
```
```
XXX.world.attribute.AttributeTypes +4P
```
```
XXX.world.attribute.EnvironmentAttributes +20P
```
```
XXX.world.attribute.LerpFunction +5M -1M
```
```
XXX.attribute.modifier.ColorModifier$ArgbModifier +1M
```
```
XXX.animal.camel.CamelHusk +1M -1M
```
```
XXX.animal.horse.ZombieHorse +2M -1M
```
```
XXX.animal.nautilus.AbstractNautilus +1M -1M
```
```
XXX.entity.decoration.PaintingVariant +2M -2M | +1P -1P
```
```
XXX.entity.monster.Shulker +1P -1P
```
```
XXX.entity.monster.Strider +1P -1P
```
```
XXX.entity.monster.Zombie +4P -4P
```
```
XXX.entity.monster.ZombifiedPiglin +1P -1P
```
```
XXX.entity.player.ChatVisiblity +3M -3M | +2P -1P
```
```
XXX.entity.player.Player +5M -2M
```
```
XXX.entity.projectile.ProjectileUtil +1M -2M
```
```
XXX.block.entity.BannerPattern +2M -2M | +1P -1P
```
```
XXX.block.entity.BlockEntityType +1M -1M
```
```
XXX.block.entity.DecoratedPotPattern +2M -2M | +1P -1P
```
```
XXX.block.entity.SkullBlockEntity +1M -1M | +1P -1P
```
```
XXX.block.entity.StructureBlockEntity +2M -2M | +1P -1P
```
```
XXX.block.entity.TestInstanceBlockEntity +3M -3M
```
```
XXX.chunk.storage.SerializableChunkData +1M -1M
```
```
XXX.level.gamerules.GameRuleCategory +4M -4M | +1P -1P
```
```
XXX.level.levelgen.RandomState +2M -2M
```
```
XXX.level.levelgen.SurfaceRules$VerticalGradientConditionSource +2M -2M | +1P -1P
```
```
XXX.feature.configurations.NoneFeatureConfiguration -1M
```
```
XXX.levelgen.structure.TemplateStructurePiece +2M -2M
```
```
XXX.structure.pools.SinglePoolElement +1M -1M
```
```
XXX.structure.structures.IglooPieces +3P -3P
```
```
XXX.structure.structures.NetherFossilPieces +1P -1P
```
```
XXX.structure.structures.OceanRuinPieces +2M -2M | +8P -8P
```
```
XXX.structure.structures.OceanRuinPieces$OceanRuinPiece +2M -2M
```
```
XXX.structure.structures.RuinedPortalStructure +1M -1M
```
```
XXX.structure.structures.ShipwreckPieces +2P -2P
```
```
XXX.structure.templatesystem.StructureTemplateManager +12M -12M
```
```
XXX.level.portal.PortalShape +1M -1M
```
```
XXX.saveddata.maps.MapDecoration +1M -1M
```
```
XXX.level.storage.CommandStorage +2M -2M
```
```
XXX.storage.loot.LootContext +1M -1M
```
```
XXX.storage.loot.LootParams$Builder +1M -1M
```
```
XXX.loot.entries.DynamicLoot +4M -4M | +1P -1P
```
```
XXX.loot.functions.ApplyBonusCount +2M -2M
```
```
XXX.loot.functions.ApplyBonusCount$OreDrops +1P
```
```
XXX.loot.functions.FilteredFunction$Builder +1M -1M | +1P -1P
```
```
XXX.loot.functions.SetAttributesFunction +1M -1M
```
```
XXX.loot.functions.SetAttributesFunction$Modifier +2M -2M | +1P -1P
```
```
XXX.loot.parameters.LootContextParamSets +3M -3M
```
```
XXX.loot.predicates.DamageSourceCondition +2M -2M
```
```
XXX.loot.predicates.LocationCheck +4M -4M
```
```
XXX.loot.predicates.LootItemBlockStatePropertyCondition$Builder +1M -1M
```
```
XXX.providers.nbt.StorageNbtProvider +2M -2M | +1P -1P
```
```
XXX.level.timers.FunctionTagCallback +2M -2M | +1P -1P
```
```
XXX.level.timers.TimerCallbacks +1M -1M
```
```
XXX.world.phys.Vec3 +1M
```
```
XXX.scores.criteria.ObjectiveCriteria +1M -1M
```
...
```diff
- GlShaderModule getOrCompileShader(Identifier,ShaderType,ShaderDefines,ShaderSource)
+ GlShaderModule getOrCompileShader(ResourceLocation,ShaderType,ShaderDefines,ShaderSource)
- GpuSampler createSampler(AddressMode,AddressMode,FilterMode,FilterMode,int,OptionalDouble)
+ GpuSampler createSampler(AddressMode,AddressMode,FilterMode,FilterMode,int)
```
...
- void <init>(AddressMode,AddressMode,FilterMode,FilterMode,int,OptionalDouble)
+ void <init>(AddressMode,AddressMode,FilterMode,FilterMode,int)
```
...
- void <init>(int,Identifier,ShaderType)
+ void <init>(int,ResourceLocation,ShaderType)
```
...
```diff
- RenderPipeline$Builder withFragmentShader(Identifier)
+ RenderPipeline$Builder withFragmentShader(ResourceLocation)
- RenderPipeline$Builder withLocation(Identifier)
+ RenderPipeline$Builder withLocation(ResourceLocation)
- RenderPipeline$Builder withVertexShader(Identifier)
+ RenderPipeline$Builder withVertexShader(ResourceLocation)
```
...
```diff
+ void updateLevel(boolean)
- void updateLevel(DimensionType$CardinalLightType)
```
...
- Identifier id()
+ ResourceLocation id()
- void <init>(Identifier,Advancement)
+ void <init>(ResourceLocation,Advancement)
```
...
```diff
- AdvancementRewards$Builder function(Identifier)
+ AdvancementRewards$Builder function(ResourceLocation)
- AdvancementRewards$Builder runs(Identifier)
+ AdvancementRewards$Builder runs(ResourceLocation)
```
...
+ KeyMapping$Category register(ResourceLocation)
+ ResourceLocation id()
- void <init>(Identifier)
+ void <init>(ResourceLocation)
```
...
```diff
+ CloudStatus lambda$new$12(Boolean)
- CloudStatus lambda$new$14(Boolean)
+ Component lambda$new$101(Component,Integer)
- Component lambda$new$105(Component,Double)
+ Component lambda$new$105(Component,NarratorStatus)
- Component lambda$new$107(Component,Integer)
+ Component lambda$new$107(Component,String)
- Component lambda$new$11(Component,InactivityFpsLimit)
- Component lambda$new$110(Component,ParticleStatus)
- Component lambda$new$112(Component,NarratorStatus)
+ Component lambda$new$113(Component,Integer)
- Component lambda$new$114(Component,String)
+ Component lambda$new$115(Component,Integer)
...
- Component lambda$new$13(Component,CloudStatus)
+ Component lambda$new$14(Component,Integer)
- Component lambda$new$18(Component,Integer)
+ Component lambda$new$21(Component,Double)
- Component lambda$new$23(Component,Double)
+ Component lambda$new$28(Component,Double)
- Component lambda$new$28(Component,PrioritizeChunkUpdates)
- Component lambda$new$30(Component,ChatVisiblity)
- Component lambda$new$32(Component,Double)
+ Component lambda$new$36(Component,Double)
+ Component lambda$new$38(Component,Double)
- Component lambda$new$39(Component,HumanoidArm)
+ Component lambda$new$40(Component,Double)
- Component lambda$new$41(Component,Double)
+ Component lambda$new$42(Component,Double)
- Component lambda$new$43(Component,Double)
+ Component lambda$new$44(Component,Double)
- Component lambda$new$45(Component,Double)
- Component lambda$new$47(Component,Double)
+ Component lambda$new$48(Component,Double)
- Component lambda$new$49(Component,Double)
+ Component lambda$new$52(Component,Integer)
- Component lambda$new$53(Component,Double)
+ Component lambda$new$54(Component,Integer)
+ Component lambda$new$59(Component,Double)
- Component lambda$new$59(Component,Integer)
...
+ Component lambda$new$73(Component,Boolean)
+ Component lambda$new$76(Component,Boolean)
+ Component lambda$new$78(Component,Boolean)
- Component lambda$new$79(Component,Boolean)
+ Component lambda$new$80(Component,Boolean)
...
- Component lambda$new$93(Component,Integer)
- Component lambda$new$97(Component,Boolean)
+ Component lambda$new$99(Component,Double)
+ Double lambda$new$22(int)
- Double lambda$new$24(int)
+ Double lambda$new$45(int)
+ Double lambda$new$49(int)
- Double lambda$new$50(int)
- Double lambda$new$54(int)
+ Double lambda$new$89(Integer)
- Double lambda$new$95(Integer)
+ int lambda$new$102()
- int lambda$new$108()
+ int lambda$new$23(Double)
- int lambda$new$25(Double)
+ int lambda$new$46(Double)
+ int lambda$new$50(Double)
- int lambda$new$51(Double)
- int lambda$new$55(Double)
+ Integer lambda$new$88(Double)
- Integer lambda$new$94(Double)
+ KeyMapping[] lambda$new$86(int)
- KeyMapping[] lambda$new$92(int)
+ List lambda$new$108()
- List lambda$new$115()
+ Optional lambda$new$109(String)
- Optional lambda$new$116(String)
+ OptionInstance lambda$new$69(SoundSource)
- OptionInstance lambda$new$75(SoundSource)
+ String lambda$dumpOptionsForReport$119(Pair)
- String lambda$dumpOptionsForReport$127(Pair)
+ Tooltip lambda$new$25(PrioritizeChunkUpdates)
- Tooltip lambda$new$27(PrioritizeChunkUpdates)
+ Tooltip lambda$new$71(Boolean)
- Tooltip lambda$new$77(Boolean)
+ void lambda$createSoundSliderOptionInstance$70(SoundSource,Double)
- void lambda$createSoundSliderOptionInstance$76(SoundSource,Double)
+ void lambda$load$117(CompoundTag,String)
+ void lambda$load$118(String)
- void lambda$load$125(CompoundTag,String)
- void lambda$load$126(String)
- void lambda$new$101(Double)
- void lambda$new$102(Double)
- void lambda$new$103(Double)
+ void lambda$new$103(Integer)
- void lambda$new$104(Double)
+ void lambda$new$104(ParticleStatus)
- void lambda$new$106(Double)
+ void lambda$new$106(NarratorStatus)
- void lambda$new$109(Integer)
+ void lambda$new$11(InactivityFpsLimit)
+ void lambda$new$110(String)
+ void lambda$new$111(MusicManager$MusicFrequency)
- void lambda$new$111(ParticleStatus)
+ void lambda$new$112(Boolean)
- void lambda$new$113(NarratorStatus)
+ void lambda$new$114(Integer)
+ void lambda$new$116(Integer)
- void lambda$new$117(String)
- void lambda$new$119(MusicManager$MusicFrequency)
- void lambda$new$12(InactivityFpsLimit)
- void lambda$new$120(Boolean)
- void lambda$new$122(Integer)
- void lambda$new$124(Integer)
+ void lambda$new$13(CloudStatus)
- void lambda$new$15(CloudStatus)
+ void lambda$new$15(Integer)
+ void lambda$new$18(Boolean)
+ void lambda$new$19(Boolean)
- void lambda$new$19(Integer)
- void lambda$new$21(Boolean)
- void lambda$new$22(Boolean)
+ void lambda$new$24(Double)
- void lambda$new$26(Double)
+ void lambda$new$26(PrioritizeChunkUpdates)
+ void lambda$new$27(ChatVisiblity)
+ void lambda$new$29(Double)
- void lambda$new$29(PrioritizeChunkUpdates)
+ void lambda$new$30(Double)
- void lambda$new$31(ChatVisiblity)
+ void lambda$new$31(Integer)
+ void lambda$new$32(Double)
+ void lambda$new$34(Boolean)
- void lambda$new$34(Double)
+ void lambda$new$35(HumanoidArm)
- void lambda$new$35(Integer)
- void lambda$new$36(Double)
- void lambda$new$38(Boolean)
+ void lambda$new$39(Double)
- void lambda$new$40(HumanoidArm)
+ void lambda$new$41(Double)
- void lambda$new$42(Double)
+ void lambda$new$43(Double)
- void lambda$new$44(Double)
- void lambda$new$46(Double)
+ void lambda$new$47(Double)
- void lambda$new$48(Double)
+ void lambda$new$51(Double)
- void lambda$new$52(Double)
+ void lambda$new$53(Integer)
+ void lambda$new$55(Integer)
+ void lambda$new$56(AttackIndicatorStatus)
- void lambda$new$56(Double)
+ void lambda$new$60(Double)
- void lambda$new$60(Integer)
+ void lambda$new$61(Boolean)
- void lambda$new$62(AttackIndicatorStatus)
+ void lambda$new$62(Boolean)
+ void lambda$new$63(Boolean)
+ void lambda$new$64(Boolean)
- void lambda$new$64(Integer)
+ void lambda$new$65(Boolean)
+ void lambda$new$66(Boolean)
- void lambda$new$66(Double)
- void lambda$new$69(Boolean)
- void lambda$new$70(Boolean)
- void lambda$new$71(Boolean)
- void lambda$new$73(Boolean)
+ void lambda$new$75(Boolean)
+ void lambda$new$77(Boolean)
- void lambda$new$78(Boolean)
+ void lambda$new$79(Boolean)
- void lambda$new$80(Boolean)
- void lambda$new$85(Boolean)
+ void lambda$new$85(Integer)
...
+ void lambda$new$93(Double)
+ void lambda$new$94(Double)
+ void lambda$new$95(Double)
+ void lambda$new$96(Double)
- void lambda$new$96(Integer)
+ void lambda$new$97(Double)
- void lambda$new$98(Boolean)
+ void lambda$new$98(Double)
...
```diff
- void <init>(Identifier,Object2BooleanFunction)
+ void <init>(ResourceLocation,Object2BooleanFunction)
```

</details>
<details>
<summary>
net.minecraft.client.data.models.BlockModelGenerators$PlantType
</summary>

```diff
- Identifier createItemModel(BlockModelGenerators,Block)
+ ResourceLocation createItemModel(BlockModelGenerators,Block)
```
...
```diff
- Identifier lambda$finalizeAndValidate$3(Holder$Reference)
+ ResourceLocation lambda$finalizeAndValidate$3(Holder$Reference)
```
...
```diff
- ItemModel$Unbaked plainModel(Identifier)
+ ItemModel$Unbaked plainModel(ResourceLocation)
- ItemModel$Unbaked specialModel(Identifier,SpecialModelRenderer$Unbaked)
+ ItemModel$Unbaked specialModel(ResourceLocation,SpecialModelRenderer$Unbaked)
- ItemModel$Unbaked tintedModel(Identifier,ItemTintSource[])
+ ItemModel$Unbaked tintedModel(ResourceLocation,ItemTintSource[])
```
...
```diff
- Identifier decorateBlockModelLocation(String)
- Identifier decorateItemModelLocation(String)
- Identifier getModelLocation(Block,String)
- Identifier getModelLocation(Block)
- Identifier getModelLocation(Item,String)
- Identifier getModelLocation(Item)
+ ResourceLocation decorateBlockModelLocation(String)
+ ResourceLocation decorateItemModelLocation(String)
+ ResourceLocation getModelLocation(Block,String)
+ ResourceLocation getModelLocation(Block)
+ ResourceLocation getModelLocation(Item,String)
+ ResourceLocation getModelLocation(Item)
```
...
```diff
- Identifier create(Block,BiConsumer)
- Identifier createWithSuffix(Block,String,BiConsumer)
+ ResourceLocation create(Block,BiConsumer)
+ ResourceLocation createWithSuffix(Block,String,BiConsumer)
```
...
```diff
- Identifier getMobEffectSprite(Holder)
- Identifier lambda$getMobEffectSprite$6(Identifier)
+ ResourceLocation getMobEffectSprite(Holder)
+ ResourceLocation lambda$getMobEffectSprite$6(ResourceLocation)
- void renderTextureOverlay(GuiGraphics,Identifier,float)
+ void renderTextureOverlay(GuiGraphics,ResourceLocation,float)
```
...
- EnvironmentAttributeReader environmentAttributes()
- EnvironmentAttributeSystem environmentAttributes()
- EnvironmentAttributeSystem$Builder addEnvironmentAttributeLayers(EnvironmentAttributeSystem$Builder)
+ float getSkyDarken(float)
+ float getStarBrightness(float)
- Float lambda$addEnvironmentAttributeLayers$6(Float,int)
+ int getCloudColor(float,Camera)
+ int getSkyColor(Camera,float)
- Integer lambda$addEnvironmentAttributeLayers$5(int,Integer,int)
+ String lambda$doAddParticle$12(ParticleOptions)
+ String lambda$doAddParticle$13(double,double,double)
- String lambda$doAddParticle$14(ParticleOptions)
- String lambda$doAddParticle$15(double,double,double)
+ String lambda$fillReportDetails$10()
- String lambda$fillReportDetails$12()
- String lambda$fillReportDetails$13()
+ String lambda$fillReportDetails$9()
+ String lambda$tickNonPassenger$6(Entity)
...
- void lambda$clearTintCaches$10(ColorResolver,BlockTintCache)
+ void lambda$clearTintCaches$8(ColorResolver,BlockTintCache)
+ void lambda$onChunkLoaded$7(ChunkPos,ColorResolver,BlockTintCache)
- void lambda$onChunkLoaded$9(ChunkPos,ColorResolver,BlockTintCache)
+ void lambda$tickEntities$5(Entity)
- void lambda$tickEntities$7(Entity)
```
...
```diff
- Identifier lambda$updateRecipes$6(Registry,ItemStack)
+ ResourceLocation lambda$updateRecipes$6(Registry,ItemStack)
```
...
```diff
- Optional loadParticleDescription(Identifier,Resource)
+ Optional loadParticleDescription(ResourceLocation,Resource)
- ParticleResources$1ParticleDefinition lambda$reload$1(Identifier,Resource)
+ ParticleResources$1ParticleDefinition lambda$reload$1(ResourceLocation,Resource)
- void lambda$reload$2(List,Executor,Identifier,Resource)
...
- void <init>(boolean,Identifier,RenderPipeline)
+ void <init>(boolean,ResourceLocation,RenderPipeline)
```
...
- void render(int,CloudStatus,float,Vec3,long,float)
```
...
```diff
- boolean lambda$load$0(PostChainConfig,Identifier)
+ boolean lambda$load$0(PostChainConfig,ResourceLocation)
- PostChain load(PostChainConfig,TextureManager,Set,Identifier,CachedOrthoProjectionMatrixBuffer)
+ PostChain load(PostChainConfig,TextureManager,Set,ResourceLocation,CachedOrthoProjectionMatrixBuffer)
- PostPass createPass(TextureManager,PostChainConfig$Pass,Identifier)
+ PostPass createPass(TextureManager,PostChainConfig$Pass,ResourceLocation)
- RenderTarget getOrCreatePersistentTarget(Identifier,RenderTargetDescriptor)
+ RenderTarget getOrCreatePersistentTarget(ResourceLocation,RenderTargetDescriptor)
```

</details>
<details>
<summary>
net.minecraft.client.renderer.PostChain$TargetBundle$1
</summary>

```diff
- ResourceHandle get(Identifier)
+ ResourceHandle get(ResourceLocation)
- void <init>(ResourceHandle,Identifier)
+ void <init>(ResourceHandle,ResourceLocation)
- void replace(Identifier,ResourceHandle)
+ void replace(ResourceLocation,ResourceHandle)
```
...
- void <init>(Identifier,Identifier,List,Identifier,Map)
+ void <init>(ResourceLocation,ResourceLocation,List,ResourceLocation,Map)
```
...
- Identifier location()
+ ResourceLocation location()
- void <init>(String,Identifier,int,int,boolean)
+ void <init>(String,ResourceLocation,int,int,boolean)
```
...
- void <init>(String,Identifier,boolean,boolean)
+ void <init>(String,ResourceLocation,boolean,boolean)
```

</details>
<details>
<summary>
net.minecraft.client.renderer.ShaderManager$1
</summary>

```diff
- void <init>(Identifier,Map)
+ void <init>(ResourceLocation,Map)
```
...
- Identifier id()
+ ResourceLocation id()
- void <init>(Identifier,ShaderType)
+ void <init>(ResourceLocation,ShaderType)
```
...
```diff
- Identifier colorToResourceMaterial(DyeColor)
- Identifier colorToShulkerMaterial(DyeColor)
- RenderType translucentBlockItemSheet()
...
```diff
- AbstractTexture getTexture(TextureManager,Identifier)
+ AbstractTexture getTexture(TextureManager,ResourceLocation)
+ void renderSkyDisc(float,float,float)
- void renderSkyDisc(int)
- void renderSunMoonAndStars(PoseStack,float,float,float,MoonPhase,float,float)
+ void renderSunMoonAndStars(PoseStack,float,MoonPhase,float,float)
```
...
- void <init>(UnbakedGeometry,UnbakedModel$GuiLight,Boolean,ItemTransforms,TextureSlots$Data,Identifier)
+ void <init>(UnbakedGeometry,UnbakedModel$GuiLight,Boolean,ItemTransforms,TextureSlots$Data,ResourceLocation)
```
...
```diff
- SimpleModelWrapper bake(ModelBaker,Identifier,ModelState)
+ SimpleModelWrapper bake(ModelBaker,ResourceLocation,ModelState)
```
...
```diff
+ TextureSlots$Data parseTextureMap(JsonObject,ResourceLocation)
- TextureSlots$Data parseTextureMap(JsonObject)
+ void parseEntry(ResourceLocation,String,String,TextureSlots$Data$Builder)
- void parseEntry(String,String,TextureSlots$Data$Builder)
```
...
```diff
- RenderType getPlayerSkinRenderType(Identifier)
+ RenderType getPlayerSkinRenderType(ResourceLocation)
- RenderType getSkullRenderType(SkullBlock$Type,Identifier)
+ RenderType getSkullRenderType(SkullBlock$Type,ResourceLocation)
```
...
```diff
- boolean wasPreviouslyEmpty()
+ float getVisibility(long,long)
- float getVisibility(long)
- void setFadeDuration(long)
- void setWasPreviouslyEmpty(boolean)
```
...
```diff
- Identifier getTextureLocation(LivingEntityRenderState)
- Identifier getTextureLocation(ZombieRenderState)
...
```diff
- Identifier getTextureLocation(AllayRenderState)
- Identifier getTextureLocation(LivingEntityRenderState)
...
```diff
- Identifier getTextureLocation(ArmorStandRenderState)
- Identifier getTextureLocation(LivingEntityRenderState)
...
```diff
- Identifier getTextureLocation(AxolotlRenderState)
- Identifier getTextureLocation(LivingEntityRenderState)
...
```diff
- Identifier getTextureLocation(BeeRenderState)
- Identifier getTextureLocation(LivingEntityRenderState)
...
```diff
- RenderType lambda$new$1(Identifier)
+ RenderType lambda$new$1(ResourceLocation)
```
...
```diff
- Identifier getTextureLocation(BreezeRenderState)
- Identifier getTextureLocation(LivingEntityRenderState)
+ ResourceLocation getTextureLocation(BreezeRenderState)
+ ResourceLocation getTextureLocation(LivingEntityRenderState)
```
...
- Identifier getTextureLocation(LivingEntityRenderState)
+ ResourceLocation getTextureLocation(CamelRenderState)
+ ResourceLocation getTextureLocation(LivingEntityRenderState)
```
...
```diff
- Identifier getTextureLocation(CowRenderState)
- Identifier getTextureLocation(LivingEntityRenderState)
+ ResourceLocation getTextureLocation(CowRenderState)
+ ResourceLocation getTextureLocation(LivingEntityRenderState)
```
...
```diff
- Identifier getTextureLocation(CreeperRenderState)
- Identifier getTextureLocation(LivingEntityRenderState)
...
```diff
- Identifier getTextureLocation(DolphinRenderState)
- Identifier getTextureLocation(LivingEntityRenderState)
...
```diff
- void <init>(String,int,Identifier,ModelLayerLocation,ModelLayerLocation,EquipmentClientInfo$LayerType,ModelLayerLocation,ModelLayerLocation)
+ void <init>(String,int,ResourceLocation,ModelLayerLocation,ModelLayerLocation,EquipmentClientInfo$LayerType,ModelLayerLocation,ModelLayerLocation)
```
...
```diff
- Identifier getTextureLocation(EndermanRenderState)
- Identifier getTextureLocation(LivingEntityRenderState)
+ ResourceLocation getTextureLocation(EndermanRenderState)
+ ResourceLocation getTextureLocation(LivingEntityRenderState)
```
...
```diff
- Identifier getTextureLocation(EvokerRenderState)
- Identifier getTextureLocation(LivingEntityRenderState)
+ ResourceLocation getTextureLocation(EvokerRenderState)
+ ResourceLocation getTextureLocation(LivingEntityRenderState)
```
...
```diff
- Identifier getTextureLocation(FoxRenderState)
- Identifier getTextureLocation(LivingEntityRenderState)
+ ResourceLocation getTextureLocation(FoxRenderState)
+ ResourceLocation getTextureLocation(LivingEntityRenderState)
```
...
```diff
- Identifier getTextureLocation(GhastRenderState)
- Identifier getTextureLocation(LivingEntityRenderState)
+ ResourceLocation getTextureLocation(GhastRenderState)
+ ResourceLocation getTextureLocation(LivingEntityRenderState)
```
...
```diff
- Identifier getTextureLocation(LivingEntityRenderState)
- Identifier getTextureLocation(SquidRenderState)
+ ResourceLocation getTextureLocation(LivingEntityRenderState)
+ ResourceLocation getTextureLocation(SquidRenderState)
```
...
```diff
- Identifier getTextureLocation(GuardianRenderState)
- Identifier getTextureLocation(LivingEntityRenderState)
+ ResourceLocation getTextureLocation(GuardianRenderState)
+ ResourceLocation getTextureLocation(LivingEntityRenderState)
```
...
```diff
- Identifier getTextureLocation(HoglinRenderState)
- Identifier getTextureLocation(LivingEntityRenderState)
...
```diff
- Identifier getTextureLocation(LivingEntityRenderState)
- Identifier getTextureLocation(SlimeRenderState)
+ ResourceLocation getTextureLocation(LivingEntityRenderState)
...
```diff
- Identifier getTextureLocation(LivingEntityRenderState)
- Identifier getTextureLocation(NautilusRenderState)
+ ResourceLocation getTextureLocation(LivingEntityRenderState)
+ ResourceLocation getTextureLocation(NautilusRenderState)
- void <clinit>()
+ void <init>(EntityRendererProvider$Context,NautilusRenderer$Type)
...
```diff
- Identifier getTextureLocation(LivingEntityRenderState)
- Identifier getTextureLocation(ZombieVillagerRenderState)
+ ResourceLocation getTextureLocation(LivingEntityRenderState)
+ ResourceLocation getTextureLocation(ZombieVillagerRenderState)
```
...
```diff
- void <init>(RenderLayerParent,EntityModelSet,Identifier)
+ void <init>(RenderLayerParent,EntityModelSet,ResourceLocation)
```
...
```diff
- void <init>(RenderLayerParent,EntityModelSet,ModelLayerLocation,Identifier)
+ void <init>(RenderLayerParent,EntityModelSet,ModelLayerLocation,ResourceLocation)
```
...
```diff
- Identifier getPlayerElytraTexture(HumanoidRenderState)
+ ResourceLocation getPlayerElytraTexture(HumanoidRenderState)
```
...
```diff
- int applyWeatherDarken(int,float,float)
```
...
- void <init>(Identifier,List)
+ void <init>(ResourceLocation,List)
```
...
- void <init>(Identifier,SpecialModelRenderer$Unbaked)
+ void <init>(ResourceLocation,SpecialModelRenderer$Unbaked)
```
...
```diff
- GpuSampler lambda$withTexture$0()
- GpuSampler lambda$withTexture$1(Supplier)
- RenderSetup$RenderSetupBuilder withTexture(String,Identifier,Supplier)
- RenderSetup$RenderSetupBuilder withTexture(String,Identifier)
+ RenderSetup$RenderSetupBuilder withTexture(String,ResourceLocation)
```
...
```diff
- GpuSampler lambda$static$1()
- RenderType armorCutoutNoCull(Identifier)
+ RenderType armorCutoutNoCull(ResourceLocation)
- RenderType armorTranslucent(Identifier)
+ RenderType armorTranslucent(ResourceLocation)
- RenderType beaconBeam(Identifier,boolean)
+ RenderType beaconBeam(ResourceLocation,boolean)
- RenderType blockScreenEffect(Identifier)
+ RenderType blockScreenEffect(ResourceLocation)
- RenderType breezeEyes(Identifier)
+ RenderType breezeEyes(ResourceLocation)
- RenderType breezeWind(Identifier,float,float)
+ RenderType breezeWind(ResourceLocation,float,float)
- RenderType createArmorDecalCutoutNoCull(Identifier)
+ RenderType createArmorDecalCutoutNoCull(ResourceLocation)
- RenderType crumbling(Identifier)
+ RenderType crumbling(ResourceLocation)
+ RenderType cutout()
- RenderType cutoutMovingBlock()
- RenderType dragonExplosionAlpha(Identifier)
+ RenderType dragonExplosionAlpha(ResourceLocation)
- RenderType energySwirl(Identifier,float,float)
+ RenderType energySwirl(ResourceLocation,float,float)
- RenderType entityCutout(Identifier)
+ RenderType entityCutout(ResourceLocation)
- RenderType entityCutoutNoCull(Identifier,boolean)
- RenderType entityCutoutNoCull(Identifier)
+ RenderType entityCutoutNoCull(ResourceLocation,boolean)
+ RenderType entityCutoutNoCull(ResourceLocation)
- RenderType entityCutoutNoCullZOffset(Identifier,boolean)
- RenderType entityCutoutNoCullZOffset(Identifier)
+ RenderType entityCutoutNoCullZOffset(ResourceLocation,boolean)
+ RenderType entityCutoutNoCullZOffset(ResourceLocation)
- RenderType entityDecal(Identifier)
+ RenderType entityDecal(ResourceLocation)
- RenderType entityNoOutline(Identifier)
+ RenderType entityNoOutline(ResourceLocation)
- RenderType entityShadow(Identifier)
+ RenderType entityShadow(ResourceLocation)
- RenderType entitySmoothCutout(Identifier)
+ RenderType entitySmoothCutout(ResourceLocation)
- RenderType entitySolid(Identifier)
+ RenderType entitySolid(ResourceLocation)
- RenderType entitySolidZOffsetForward(Identifier)
+ RenderType entitySolidZOffsetForward(ResourceLocation)
- RenderType entityTranslucent(Identifier,boolean)
- RenderType entityTranslucent(Identifier)
+ RenderType entityTranslucent(ResourceLocation,boolean)
+ RenderType entityTranslucent(ResourceLocation)
- RenderType entityTranslucentEmissive(Identifier,boolean)
- RenderType entityTranslucentEmissive(Identifier)
+ RenderType entityTranslucentEmissive(ResourceLocation,boolean)
+ RenderType entityTranslucentEmissive(ResourceLocation)
- RenderType eyes(Identifier)
+ RenderType eyes(ResourceLocation)
- RenderType fireScreenEffect(Identifier)
+ RenderType fireScreenEffect(ResourceLocation)
- RenderType itemEntityTranslucentCull(Identifier)
+ RenderType itemEntityTranslucentCull(ResourceLocation)
+ RenderType lambda$createWeather$25(RenderPipeline,ResourceLocation)
- RenderType lambda$createWeather$26(RenderPipeline,Identifier)
- RenderType lambda$static$0(Identifier,Boolean)
+ RenderType lambda$static$0(ResourceLocation,Boolean)
+ RenderType lambda$static$1(ResourceLocation)
- RenderType lambda$static$10(Identifier,Boolean)
+ RenderType lambda$static$10(ResourceLocation,Boolean)
- RenderType lambda$static$11(Identifier,Boolean)
+ RenderType lambda$static$11(ResourceLocation)
- RenderType lambda$static$12(Identifier)
+ RenderType lambda$static$12(ResourceLocation,Boolean)
- RenderType lambda$static$13(Identifier,Boolean)
+ RenderType lambda$static$13(ResourceLocation)
- RenderType lambda$static$14(Identifier)
+ RenderType lambda$static$14(ResourceLocation)
- RenderType lambda$static$15(Identifier)
+ RenderType lambda$static$15(ResourceLocation)
- RenderType lambda$static$16(Identifier)
+ RenderType lambda$static$16(ResourceLocation)
- RenderType lambda$static$17(Identifier)
+ RenderType lambda$static$17(ResourceLocation)
- RenderType lambda$static$18(Identifier)
+ RenderType lambda$static$18(ResourceLocation)
- RenderType lambda$static$19(Identifier)
+ RenderType lambda$static$19(ResourceLocation)
- RenderType lambda$static$2(Identifier)
+ RenderType lambda$static$2(ResourceLocation)
- RenderType lambda$static$20(Identifier)
+ RenderType lambda$static$20(ResourceLocation)
- RenderType lambda$static$21(Identifier)
+ RenderType lambda$static$21(ResourceLocation)
- RenderType lambda$static$22(Identifier)
+ RenderType lambda$static$22(ResourceLocation)
- RenderType lambda$static$23(Identifier)
+ RenderType lambda$static$23(ResourceLocation)
- RenderType lambda$static$24(Identifier)
+ RenderType lambda$static$24(ResourceLocation)
- RenderType lambda$static$25(Identifier)
+ RenderType lambda$static$26(ResourceLocation)
- RenderType lambda$static$27(Identifier)
+ RenderType lambda$static$27(ResourceLocation)
- RenderType lambda$static$28(Identifier)
- RenderType lambda$static$3(Identifier)
+ RenderType lambda$static$3(ResourceLocation)
- RenderType lambda$static$4(Identifier)
+ RenderType lambda$static$4(ResourceLocation)
- RenderType lambda$static$5(Identifier)
+ RenderType lambda$static$5(ResourceLocation)
- RenderType lambda$static$6(Identifier)
+ RenderType lambda$static$6(ResourceLocation,Boolean)
- RenderType lambda$static$7(Identifier,Boolean)
+ RenderType lambda$static$7(ResourceLocation,Boolean)
- RenderType lambda$static$8(Identifier,Boolean)
+ RenderType lambda$static$8(ResourceLocation)
- RenderType lambda$static$9(Identifier)
+ RenderType lambda$static$9(ResourceLocation,Boolean)
- RenderType outline(Identifier)
+ RenderType outline(ResourceLocation)
+ RenderType solid()
- RenderType solidMovingBlock()
- RenderType text(Identifier)
+ RenderType text(ResourceLocation)
- RenderType textIntensity(Identifier)
+ RenderType textIntensity(ResourceLocation)
- RenderType textIntensityPolygonOffset(Identifier)
+ RenderType textIntensityPolygonOffset(ResourceLocation)
- RenderType textIntensitySeeThrough(Identifier)
+ RenderType textIntensitySeeThrough(ResourceLocation)
- RenderType textPolygonOffset(Identifier)
+ RenderType textPolygonOffset(ResourceLocation)
- RenderType textSeeThrough(Identifier)
+ RenderType textSeeThrough(ResourceLocation)
+ RenderType tripwire()
- RenderType tripwireMovingBlock()
- RenderType weather(Identifier,boolean)
+ RenderType weather(ResourceLocation,boolean)
```
...
```diff
- void <init>(CopperGolemStatueModel,Identifier)
+ void <init>(CopperGolemStatueModel,ResourceLocation)
```
...
- void <init>(Identifier,float,Direction)
+ void <init>(ResourceLocation,float,Direction)
```
...
```diff
- Identifier lambda$bake$2(Identifier)
...
```diff
- void dumpContents(Identifier,Path)
+ void dumpContents(ResourceLocation,Path)
```
...
- Identifier name()
+ ResourceLocation name()
- void <init>(Identifier,FrameSize,NativeImage,Optional,List,MipmapStrategy)
- void <init>(Identifier,FrameSize,NativeImage)
+ void <init>(ResourceLocation,FrameSize,NativeImage,Optional,List,MipmapStrategy)
...
```diff
- CompletableFuture loadAndStitch(ResourceManager,Identifier,int,Executor,Set)
+ CompletableFuture loadAndStitch(ResourceManager,ResourceLocation,int,Executor,Set)
- List lambda$loadAndStitch$7(ResourceManager,Identifier)
+ List lambda$loadAndStitch$7(ResourceManager,ResourceLocation)
- void <init>(Identifier,int,int,int)
+ void <init>(ResourceLocation,int,int,int)
```
...
```diff
- Identifier lambda$static$2(Stitcher$Holder)
+ ResourceLocation lambda$static$2(Stitcher$Holder)
```
...
- Identifier location()
+ ResourceLocation location()
- TextureAtlasSprite getSprite(Identifier)
...
```diff
- TextureContents load(ResourceManager,Identifier)
+ TextureContents load(ResourceManager,ResourceLocation)
```
...
```diff
- SpriteContents lambda$create$0(Set,Identifier,Resource)
...
```diff
- SpriteContents lambda$add$0(Identifier,Resource,SpriteResourceLoader)
+ SpriteContents lambda$add$0(ResourceLocation,Resource,SpriteResourceLoader)
- void add(Identifier,Resource)
...
```diff
- void add(Identifier,SpriteSource$DiscardableLoader)
+ void add(ResourceLocation,SpriteSource$DiscardableLoader)
```
...
```diff
- void <init>(Identifier,Resource,int)
+ void <init>(ResourceLocation,Resource,int)
```
...
+ ResourceLocation permutationLocation()
- void <init>(LazyLoadedImage,Supplier,Identifier)
+ void <init>(LazyLoadedImage,Supplier,ResourceLocation)
```
...
```diff
- IdentifierPattern filter()
+ ResourceLocationPattern filter()
- void <init>(IdentifierPattern)
+ void <init>(ResourceLocationPattern)
```
...
- Identifier sprite()
+ ResourceLocation sprite()
- void <init>(Identifier,double,double,double,double)
+ void <init>(ResourceLocation,double,double,double,double)
```
...
```diff
- int[] getPixels(ResourceManager,Identifier)
+ int[] getPixels(ResourceManager,ResourceLocation)
```
...
```diff
- TextureAtlas getAtlasOrThrow(Identifier)
+ TextureAtlas getAtlasOrThrow(ResourceLocation)
- void lambda$forEach$0(BiConsumer,Identifier,AtlasManager$AtlasEntry)
+ void lambda$forEach$0(BiConsumer,ResourceLocation,AtlasManager$AtlasEntry)
- void lambda$prepareSharedState$1(Map,List,List,Identifier,AtlasManager$AtlasEntry)
+ void lambda$prepareSharedState$1(Map,List,List,ResourceLocation,AtlasManager$AtlasEntry)
```
...
```diff
- CompletableFuture get(Identifier)
+ CompletableFuture get(ResourceLocation)
```
...
```diff
- BlockStateModelLoader$LoadedModels loadBlockStateDefinitionStack(Identifier,StateDefinition,List)
+ BlockStateModelLoader$LoadedModels loadBlockStateDefinitionStack(ResourceLocation,StateDefinition,List)
- String lambda$loadBlockStateDefinitionStack$4(Identifier,BlockStateModelLoader$LoadedBlockModelDefinition)
+ String lambda$loadBlockStateDefinitionStack$4(ResourceLocation,BlockStateModelLoader$LoadedBlockModelDefinition)
```
...
```diff
- EquipmentClientInfo$Builder addHumanoidLayers(Identifier,boolean)
- EquipmentClientInfo$Builder addHumanoidLayers(Identifier)
+ EquipmentClientInfo$Builder addHumanoidLayers(ResourceLocation,boolean)
+ EquipmentClientInfo$Builder addHumanoidLayers(ResourceLocation)
- EquipmentClientInfo$Builder addMainHumanoidLayer(Identifier,boolean)
+ EquipmentClientInfo$Builder addMainHumanoidLayer(ResourceLocation,boolean)
```
...
```diff
- EquipmentClientInfo$Layer leatherDyeable(Identifier,boolean)
+ EquipmentClientInfo$Layer leatherDyeable(ResourceLocation,boolean)
- EquipmentClientInfo$Layer onlyIfDyed(Identifier,boolean)
+ EquipmentClientInfo$Layer onlyIfDyed(ResourceLocation,boolean)
- Identifier getTextureLocation(EquipmentClientInfo$LayerType)
- Identifier textureId()
+ ResourceLocation getTextureLocation(EquipmentClientInfo$LayerType)
+ ResourceLocation textureId()
- void <init>(Identifier,Optional,boolean)
- void <init>(Identifier)
+ void <init>(ResourceLocation,Optional,boolean)
+ void <init>(ResourceLocation)
```
...
<details>
<summary>
net.minecraft.client.resources.model.ModelBakery$MissingModels$1
</summary>

```diff
- ResolvedModel getModel(Identifier)
...
```diff
- void <init>(Identifier,UnbakedModel,boolean)
+ void <init>(ResourceLocation,UnbakedModel,boolean)
```
...
```diff
- ClientItem$Properties getItemProperties(Identifier)
+ ClientItem$Properties getItemProperties(ResourceLocation)
...
- CompletableFuture loadModels(SpriteLoader$Preparations,SpriteLoader$Preparations,ModelBakery,Object2IntMap,EntityModelSet,SpecialBlockModelRenderer,Executor)
- CompletionStage lambda$reload$4(CompletableFuture,CompletableFuture,CompletableFuture,CompletableFuture,CompletableFuture,CompletableFuture,CompletableFuture,CompletableFuture,CompletableFuture,Executor,Void)
...
- ItemModel getItemModel(Identifier)
+ ItemModel getItemModel(ResourceLocation)
- String lambda$reload$3(Identifier)
...
- void <init>(Identifier,SoundSource,RandomSource)
...
```diff
+ SimpleSoundInstance forMusic(SoundEvent,float)
- SimpleSoundInstance forMusic(SoundEvent)
- void <init>(Identifier,SoundSource,float,float,RandomSource,boolean,int,SoundInstance$Attenuation,double,double,double,boolean)
...
- void <init>(Identifier,SampledFloat,SampledFloat,int,Sound$Type,boolean,boolean,int)
...
```diff
- List searchIdentifier(String,String)
+ List searchResourceLocation(String,String)
```

</details>
<details>
<summary>
net.minecraft.client.sounds.MusicManager$MusicFrequency
</summary>
...
- void <init>(String,int,String,String,int)
```
...
```diff
+ void <init>(MusicManager,SoundManager,Options,ResourceProvider)
- void <init>(SoundManager,Options,ResourceProvider)
- void lambda$new$0(Object2FloatOpenHashMap)
- void lambda$refreshCategoryVolume$1(float,Channel)
- void lambda$refreshCategoryVolume$2(SoundSource,SoundInstance,ChannelAccess$ChannelHandle)
+ void lambda$setVolume$2(float,SoundInstance,Channel)
+ void lambda$updateCategoryVolume$0(float,Channel)
+ void lambda$updateCategoryVolume$1(SoundInstance,ChannelAccess$ChannelHandle)
- void refreshCategoryVolume(SoundSource)
+ void setVolume(SoundInstance,float)
- void stop(Identifier,SoundSource)
+ void stop(ResourceLocation,SoundSource)
...
```diff
- void handleRegistration(Identifier,SoundEventRegistration)
...
```diff
- void <init>(Identifier,String)
+ void <init>(ResourceLocation,String)
```
...
```diff
- void lambda$onAdvancementDone$1(Identifier,long,TelemetryPropertyMap$Builder)
...
```diff
- Identifier lambda$suggestRegistryElements$0(RecipeHolder)
...
```diff
- Identifier suggestionId(ArgumentCommandNode)
+ ResourceLocation suggestionId(ArgumentCommandNode)
```
...
```diff
- Identifier lambda$suggestResource$0(Identifier)
- Identifier lambda$suggestResource$2(Identifier)
+ ResourceLocation lambda$suggestResource$0(ResourceLocation)
+ ResourceLocation lambda$suggestResource$2(ResourceLocation)
- void lambda$suggestResource$1(SuggestionsBuilder,String,Identifier)
+ void lambda$suggestResource$1(SuggestionsBuilder,String,ResourceLocation)
- void lambda$suggestResource$3(SuggestionsBuilder,Identifier)
...
```diff
- CommandSyntaxException lambda$parse$5(StringReader,Identifier)
+ CommandSyntaxException lambda$parse$5(StringReader,ResourceLocation)
- CommandSyntaxException lambda$parse$6(StringReader,Identifier)
+ CommandSyntaxException lambda$parse$6(StringReader,ResourceLocation)
```
...
+ boolean matches(String,ResourceLocation)
```
...
```diff
- CommandSyntaxException lambda$readTag$7(int,Identifier)
...
```diff
- Object validateElement(ImmutableStringReader,Identifier)
+ Object validateElement(ImmutableStringReader,ResourceLocation)
```
...
```diff
- void <init>(FunctionArgument,Identifier)
+ void <init>(FunctionArgument,ResourceLocation)
```
...
```diff
- String lambda$serializeComponents$1(Identifier,Tag)
...
```diff
- CommandSyntaxException lambda$readItem$0(int,Identifier)
+ CommandSyntaxException lambda$readItem$0(int,ResourceLocation)
- Identifier lambda$suggestComponent$2(Map$Entry)
...
```diff
- Identifier id()
- ItemPredicateArgument$ComponentWrapper create(ImmutableStringReader,Identifier,DataComponentType)
+ ItemPredicateArgument$ComponentWrapper create(ImmutableStringReader,ResourceLocation,DataComponentType)
+ ResourceLocation id()
- void <init>(Identifier,Predicate,Decoder)
+ void <init>(ResourceLocation,Predicate,Decoder)
```
...
- Identifier id()
+ ResourceLocation id()
- void <init>(Identifier,Decoder)
+ void <init>(ResourceLocation,Decoder)
```
...
```diff
+ void <init>(int,boolean,boolean,List,MinMaxBounds$Doubles,Function,AABB,BiConsumer,boolean,String,UUID,EntityType,boolean)
- void <init>(int,boolean,boolean,List,MinMaxBounds$Doubles,Function,AABB,BiConsumer,boolean,String,UUID,EntityType,boolean)
```
...
- MinMaxBounds$Doubles getDistance()
+ MinMaxBounds$FloatDegrees getRotX()
- MinMaxBounds$FloatDegrees getRotX()
+ MinMaxBounds$FloatDegrees getRotY()
- MinMaxBounds$FloatDegrees getRotY()
+ MinMaxBounds$Ints getLevel()
- MinMaxBounds$Ints getLevel()
+ Predicate createRotationPredicate(MinMaxBounds$FloatDegrees,ToFloatFunction)
- Predicate createRotationPredicate(MinMaxBounds$FloatDegrees,ToFloatFunction)
+ void setDistance(MinMaxBounds$Doubles)
- void setDistance(MinMaxBounds$Doubles)
+ void setLevel(MinMaxBounds$Ints)
- void setLevel(MinMaxBounds$Ints)
+ void setRotX(MinMaxBounds$FloatDegrees)
- void setRotX(MinMaxBounds$FloatDegrees)
+ void setRotY(MinMaxBounds$FloatDegrees)
- void setRotY(MinMaxBounds$FloatDegrees)
```
...
```diff
- CommandSyntaxException lambda$bootStrap$44(EntitySelectorParser,int,Identifier)
+ CommandSyntaxException lambda$bootStrap$44(EntitySelectorParser,int,ResourceLocation)
- Identifier lambda$bootStrap$40(HolderSet$Named)
- Identifier lambda$bootStrap$41(HolderSet$Named)
...
```diff
- CommandFunction fromLines(Identifier,CommandDispatcher,ExecutionCommandSource,List)
+ CommandFunction fromLines(ResourceLocation,CommandDispatcher,ExecutionCommandSource,List)
```
...
```diff
- UnboundEntryAction instantiate(List,CommandDispatcher,Identifier)
...
- Identifier name()
+ ResourceLocation name()
- void <init>(Identifier,SuggestionProvider)
+ void <init>(ResourceLocation,SuggestionProvider)
```
...
- Identifier getKey(Object)
- Object getValue(Identifier)
+ Object getValue(ResourceLocation)
- Optional getOptional(Identifier)
...
```diff
- boolean containsKey(Identifier)
+ boolean containsKey(ResourceLocation)
- Identifier getKey(Object)
- Identifier lambda$freeze$5(Map$Entry)
- Identifier lambda$freeze$7(Map$Entry)
- Object getValue(Identifier)
+ Object getValue(ResourceLocation)
- Optional get(Identifier)
+ Optional get(ResourceLocation)
...
```diff
- String lambda$static$0(Identifier)
+ String lambda$static$0(ResourceLocation)
- String lambda$static$1(Identifier)
+ String lambda$static$1(ResourceLocation)
```
...
- MinMaxBounds$Doubles amount()
+ void <init>(Optional,Optional,MinMaxBounds$Doubles,Optional,Optional)
- void <init>(Optional,Optional,MinMaxBounds$Doubles,Optional,Optional)
```
...
```diff
+ DamagePredicate durability(MinMaxBounds$Ints)
- DamagePredicate durability(MinMaxBounds$Ints)
+ MinMaxBounds$Ints damage()
- MinMaxBounds$Ints damage()
+ MinMaxBounds$Ints durability()
- MinMaxBounds$Ints durability()
+ void <init>(MinMaxBounds$Ints,MinMaxBounds$Ints)
- void <init>(MinMaxBounds$Ints,MinMaxBounds$Ints)
```
...
```diff
- Path file(Identifier,String)
+ Path file(ResourceLocation,String)
- Path json(Identifier)
+ Path json(ResourceLocation)
```
...
```diff
+ Criterion fireCountAndBystander(MinMaxBounds$Ints,Optional)
- Criterion fireCountAndBystander(MinMaxBounds$Ints,Optional)
+ Criterion lookAtThroughItem(EntityPredicate$Builder,ItemPredicate$Builder)
- Criterion lookAtThroughItem(EntityPredicate$Builder,ItemPredicate$Builder)
```
...
```diff
- Path createPath(Identifier)
+ Path createPath(ResourceLocation)
```
...
```diff
- Identifier sequenceIdForLootTable(ResourceKey)
...
```diff
- Identifier getDefaultRecipeId(ItemLike)
...
- Criterion inventoryTrigger(ItemPredicate$Builder[])
+ ItemPredicate[] lambda$inventoryTrigger$21(int)
- ItemPredicate[] lambda$inventoryTrigger$21(int)
```
...
```diff
- void lambda$validateThatAllBiomeFeaturesHaveBiomeFilter$0(HolderGetter,Identifier,ResourceKey)
+ void lambda$validateThatAllBiomeFeaturesHaveBiomeFilter$0(HolderGetter,ResourceLocation,ResourceKey)
- void lambda$validateThatAllBiomeFeaturesHaveBiomeFilter$2(HolderGetter,Identifier,Holder$Reference,Holder)
+ void lambda$validateThatAllBiomeFeaturesHaveBiomeFilter$2(HolderGetter,ResourceLocation,Holder$Reference,Holder)
```
...
```diff
- Identifier lambda$printFullDetailsToLog$10(Map$Entry)
- Identifier lambda$printFullDetailsToLog$9(Map$Entry)
...
- Identifier registry()
- ResourceKey create(Identifier,Identifier)
- ResourceKey create(ResourceKey,Identifier)
+ ResourceKey create(ResourceKey,ResourceLocation)
+ ResourceKey create(ResourceLocation,ResourceLocation)
- ResourceKey createRegistryKey(Identifier)
+ ResourceKey createRegistryKey(ResourceLocation)
- ResourceKey lambda$codec$0(ResourceKey,Identifier)
+ ResourceKey lambda$codec$0(ResourceKey,ResourceLocation)
- ResourceKey lambda$streamCodec$1(ResourceKey,Identifier)
+ ResourceKey lambda$streamCodec$1(ResourceKey,ResourceLocation)
+ ResourceLocation location()
...
+ void <init>(int,BinaryAnimator$EasingFunction)
- void <init>(int,EasingType)
```
...
```diff
- RandomSequence createSequence(Identifier,long,int,boolean,boolean)
- RandomSequence createSequence(Identifier,long)
...
- RandomSequence lambda$get$2(long,Identifier)
+ RandomSequence lambda$get$2(long,ResourceLocation)
- RandomSource get(Identifier,long)
+ RandomSource get(ResourceLocation,long)
- void reset(Identifier,long,int,boolean,boolean)
- void reset(Identifier,long)
...
```diff
- boolean add(Identifier,Stopwatch)
+ boolean add(ResourceLocation,Stopwatch)
- boolean remove(Identifier)
+ boolean remove(ResourceLocation)
- boolean update(Identifier,UnaryOperator)
+ boolean update(ResourceLocation,UnaryOperator)
- Stopwatch get(Identifier)
+ Stopwatch get(ResourceLocation)
- Stopwatch lambda$update$2(UnaryOperator,Identifier,Stopwatch)
+ Stopwatch lambda$update$2(UnaryOperator,ResourceLocation,Stopwatch)
- void lambda$pack$1(Map,long,Identifier,Stopwatch)
+ void lambda$pack$1(Map,long,ResourceLocation,Stopwatch)
- void lambda$unpack$0(Stopwatches,long,Identifier,Long)
+ void lambda$unpack$0(Stopwatches,long,ResourceLocation,Long)
```
...
```diff
- Float lambda$ofDegrees$0(float,float,Float,Float)
- LerpFunction ofConstant()
- LerpFunction ofDegrees(float)
- Object lambda$ofConstant$1(float,Object,Object)
+ Object lambda$ofStep$0(float,float,Object,Object)
- Object lambda$ofStep$2(float,float,Object,Object)
```

</details>
<details>
<summary>
net.minecraft.world.attribute.modifier.ColorModifier$ArgbModifier
</summary>
...
- Identifier assetId()
+ ResourceLocation assetId()
- void <init>(int,int,Identifier,Optional,Optional)
...
```diff
+ ChatVisiblity byId(int)
- Component caption()
+ int getId()
- int lambda$static$0(ChatVisiblity)
- Integer lambda$static$1(ChatVisiblity)
+ String getKey()
```
...
```diff
- boolean hasEnoughFoodToDoExhaustiveManoeuvres()
- float baseDamageScaleFactor()
- void awardStat(Identifier,int)
- void awardStat(Identifier)
+ void awardStat(ResourceLocation,int)
+ void awardStat(ResourceLocation)
- void playServerSideSound(SoundEvent)
```
...
```diff
+ Collection getManyEntityHitResult(Level,Entity,Vec3,Vec3,AABB,Predicate,float,boolean)
- Collection getManyEntityHitResult(Level,Entity,Vec3,Vec3,AABB,Predicate,float,ClipContext$Block,boolean)
...
```diff
- Identifier getKey(BlockEntityType)
+ ResourceLocation getKey(BlockEntityType)
```
...
```diff
- boolean saveStructure(ServerLevel,Identifier,BlockPos,Vec3i,boolean,String,boolean,List)
+ boolean saveStructure(ServerLevel,ResourceLocation,BlockPos,Vec3i,boolean,String,boolean,List)
- void setStructureName(Identifier)
+ void setStructureName(ResourceLocation)
```
...
```diff
- boolean export(ServerLevel,Identifier,Consumer)
+ boolean export(ServerLevel,ResourceLocation,Consumer)
- Identifier lambda$getStructureTemplate$0(Holder$Reference)
- Optional lambda$getStructureTemplate$1(ServerLevel,Identifier)
+ Optional lambda$getStructureTemplate$1(ServerLevel,ResourceLocation)
+ ResourceLocation lambda$getStructureTemplate$0(Holder$Reference)
```
...
```diff
- boolean lambda$unpackStructureReferences$11(ChunkPos,Identifier,long)
+ boolean lambda$unpackStructureReferences$11(ChunkPos,ResourceLocation,long)
```
...
```diff
- GameRuleCategory register(Identifier)
+ GameRuleCategory register(ResourceLocation)
- Identifier getDescriptionId()
- Identifier id()
+ ResourceLocation getDescriptionId()
+ ResourceLocation id()
- void <init>(Identifier)
+ void <init>(ResourceLocation)
```
...
```diff
- PositionalRandomFactory getOrCreateRandomFactory(Identifier)
+ PositionalRandomFactory getOrCreateRandomFactory(ResourceLocation)
- PositionalRandomFactory lambda$getOrCreateRandomFactory$1(Identifier,Identifier)
...
- void <init>(Identifier,VerticalAnchor,VerticalAnchor)
+ void <init>(ResourceLocation,VerticalAnchor,VerticalAnchor)
```
...
```diff
- Identifier makeTemplateLocation()
+ ResourceLocation makeTemplateLocation()
- void <init>(StructurePieceType,int,StructureTemplateManager,Identifier,String,StructurePlaceSettings,BlockPos)
+ void <init>(StructurePieceType,int,StructureTemplateManager,ResourceLocation,String,StructurePlaceSettings,BlockPos)
```
...
```diff
- Identifier getTemplateLocation()
...
```diff
- Identifier getBigWarmRuin(RandomSource)
- Identifier getSmallWarmRuin(RandomSource)
...
```diff
- StructurePlaceSettings lambda$new$0(Rotation,float,OceanRuinStructure$Type,Identifier)
+ StructurePlaceSettings lambda$new$0(Rotation,float,OceanRuinStructure$Type,ResourceLocation)
- void <init>(StructureTemplateManager,Identifier,BlockPos,Rotation,float,OceanRuinStructure$Type,boolean)
+ void <init>(StructureTemplateManager,ResourceLocation,BlockPos,Rotation,float,OceanRuinStructure$Type,boolean)
```
...
```diff
- void lambda$findGenerationPoint$2(RuinedPortalStructure$Setup,RuinedPortalPiece$Properties,BlockPos,Structure$GenerationContext,RandomState,ChunkGenerator,Identifier,StructureTemplate,Rotation,Mirror,BlockPos,StructurePiecesBuilder)
...
```diff
- boolean save(Identifier)
+ boolean save(ResourceLocation)
- InputStream lambda$loadFromResource$1(Identifier)
+ InputStream lambda$loadFromResource$1(ResourceLocation)
- Optional get(Identifier)
+ Optional get(ResourceLocation)
- Optional loadFromGenerated(Identifier)
+ Optional loadFromGenerated(ResourceLocation)
- Optional loadFromResource(Identifier)
+ Optional loadFromResource(ResourceLocation)
- Optional loadFromSnbt(Identifier,Path)
+ Optional loadFromSnbt(ResourceLocation,Path)
- Optional loadFromTestStructures(Identifier)
+ Optional loadFromTestStructures(ResourceLocation)
- Optional tryLoad(Identifier)
+ Optional tryLoad(ResourceLocation)
- Path createAndValidatePathToGeneratedStructure(Identifier,String)
+ Path createAndValidatePathToGeneratedStructure(ResourceLocation,String)
- StructureTemplate getOrCreate(Identifier)
+ StructureTemplate getOrCreate(ResourceLocation)
- void lambda$loadFromResource$2(Identifier,Throwable)
...
```diff
+ Vec3 getRelativePosition(BlockUtil$FoundRectangle,Direction$Axis,Vec3,EntityDimensions)
- Vec3 getRelativePosition(BlockUtil$FoundRectangle,Direction$Axis,Vec3,EntityDimensions)
```
...
```diff
- CompoundTag get(Identifier)
+ CompoundTag get(ResourceLocation)
- void set(Identifier,CompoundTag)
+ void set(ResourceLocation,CompoundTag)
```
...
```diff
- void addDynamicDrops(Identifier,Consumer)
+ void addDynamicDrops(ResourceLocation,Consumer)
```
...
```diff
- LootParams$Builder withDynamicDrop(Identifier,LootParams$DynamicDrop)
...
```diff
- Identifier lambda$static$0(DynamicLoot)
- LootPoolSingletonContainer lambda$dynamicEntry$2(Identifier,int,int,List,List)
+ LootPoolSingletonContainer lambda$dynamicEntry$2(ResourceLocation,int,int,List,List)
- LootPoolSingletonContainer$Builder dynamicEntry(Identifier)
+ LootPoolSingletonContainer$Builder dynamicEntry(ResourceLocation)
+ ResourceLocation lambda$static$0(DynamicLoot)
- void <init>(Identifier,int,int,List,List)
...
```diff
- DataResult lambda$static$1(Identifier)
...
<details>
<summary>
net.minecraft.world.level.storage.loot.functions.FilteredFunction$Builder
</summary>
...
```diff
- SetAttributesFunction$ModifierBuilder modifier(Identifier,Holder,AttributeModifier$Operation,NumberProvider)
...
- Identifier id()
+ ResourceLocation id()
- void <init>(Identifier,Holder,AttributeModifier$Operation,NumberProvider,List)
...
- DataResult lambda$static$1(Identifier)
+ DataResult lambda$static$1(ResourceLocation)
- DataResult lambda$static$2(Identifier)
...
```diff
+ LootItemCondition lambda$hasDamageSource$1(DamageSourcePredicate$Builder)
- LootItemCondition lambda$hasDamageSource$1(DamageSourcePredicate$Builder)
+ LootItemCondition$Builder hasDamageSource(DamageSourcePredicate$Builder)
- LootItemCondition$Builder hasDamageSource(DamageSourcePredicate$Builder)
```
...
```diff
+ LootItemCondition lambda$checkLocation$2(LocationPredicate$Builder)
- LootItemCondition lambda$checkLocation$2(LocationPredicate$Builder)
+ LootItemCondition lambda$checkLocation$3(LocationPredicate$Builder,BlockPos)
- LootItemCondition lambda$checkLocation$3(LocationPredicate$Builder,BlockPos)
+ LootItemCondition$Builder checkLocation(LocationPredicate$Builder,BlockPos)
- LootItemCondition$Builder checkLocation(LocationPredicate$Builder,BlockPos)
+ LootItemCondition$Builder checkLocation(LocationPredicate$Builder)
- LootItemCondition$Builder checkLocation(LocationPredicate$Builder)
```
...
```diff
+ LootItemBlockStatePropertyCondition$Builder setProperties(StatePropertiesPredicate$Builder)
- LootItemBlockStatePropertyCondition$Builder setProperties(StatePropertiesPredicate$Builder)
```
...
```diff
- TimerCallbacks register(Identifier,MapCodec)
+ TimerCallbacks register(ResourceLocation,MapCodec)
```
...
```diff
- Optional getStat(StatType,Identifier)
+ Optional getStat(StatType,ResourceLocation)
```
