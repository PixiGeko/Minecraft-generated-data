## Comparison with [24w19b](https://github.com/PixiGeko/Minecraft-generated-data/tree/24w19b)
...
> - [Development Partner - Red Lens](#credits-development-partner---red-lens)
>     - [Main](#credits-development-partner---red-lens-main)
...
> - [Development Partner - Disbelief Alumni](#credits-development-partner---disbelief-alumni)
>     - [Main](#credits-development-partner---disbelief-alumni-main)
> - [Development Partner - Red Lens Alumni](#credits-development-partner---red-lens-alumni)
>     - [Main](#credits-development-partner---red-lens-alumni-main)
...
<br/>
<table><tr><th></th><th align="left">24w19b</th><th>24w20a</th></tr><tr><td>DataPack version</td><td><pre>43</pre></td><td><pre>44</pre></td></tr><tr><td>World version</td><td><pre>3942</pre></td><td><pre>3944</pre></td></tr><tr><td>Protocol version</td><td><pre>1073742019</pre></td><td><pre>1073742020</pre></td></tr></table>
</details>
<hr/>
...
+ Álvaro García Gutiérrez (Globant)
...
<h1>Development Partner - Red Lens<a name="credits-development-partner---red-lens"></a></h1>
<h3>Main<a name="credits-development-partner---red-lens-main"></a></h3>
<details>
<summary>
🗒️ Titles
</summary>
...
<h1>Development Partner - Disbelief Alumni<a name="credits-development-partner---disbelief-alumni"></a></h1>
<h3>Main<a name="credits-development-partner---disbelief-alumni-main"></a></h3>
<details>
<summary>
🗒️ Titles
</summary>
...
<h1>Development Partner - Red Lens Alumni<a name="credits-development-partner---red-lens-alumni"></a></h1>
<h3>Main<a name="credits-development-partner---red-lens-alumni-main"></a></h3>
<details>
<summary>
🗒️ Titles
</summary>
...
```
```
XXX.advancements.critereon.EntityPredicate +2M -3M | +1P -2P
```
```
XXX.server.level.ServerPlayerGameMode +1M -1M
```
```
XXX.server.players.PlayerList +3M -1M
```
```
...
```
```
XXX.structure.structures.JigsawStructure +2M -2M | +2P -2P
```
...
```
```
XXX.blaze3d.systems.RenderSystem +17M -85M | -2P
```
```
net.minecraft.SharedConstants -2P
```
...
```
```
XXX.client.renderer.GameRenderer +2M -2M | +1P -1P
```
```
XXX.client.renderer.LevelRenderer +1M -1M
```
```
...
```
```
XXX.network.chat.ChatTypeDecoration$Parameter +3M -1M | +3P
```
```
XXX.server.level.ServerLevel -2M
```
```
XXX.server.level.ServerPlayer +17M -9M
```
```
XXX.world.damagesource.DamageType +1P
```
```
XXX.world.entity.EquipmentSlot$Type +2P -2P
```
```
XXX.world.entity.LivingEntity +4M -4M
```
```
XXX.world.entity.Mob +5M -6M
```
```
...
```
```
XXX.animal.horse.SkeletonTrapGoal +1M -1M
```
```
XXX.boss.wither.WitherBoss +1M -1M
```
```
XXX.entity.decoration.PaintingVariant +2P
```
```
...
```
```
XXX.entity.npc.VillagerTrades$ItemsForEmeralds +1M -1M
```
```
...
```
```
XXX.entity.raid.Raider +1P -1P
```
```
XXX.item.component.ItemAttributeModifiers +1M
```
```
XXX.item.crafting.RecipeCache +1M -1M
```
```
XXX.item.enchantment.Enchantment +2P
```
```
XXX.item.enchantment.EnchantmentHelper +24M -20M
```
```
XXX.item.enchantment.ItemEnchantments -1P
```
```
XXX.enchantment.providers.EnchantmentProvider +1P -1P
```
```
XXX.enchantment.providers.EnchantmentsByCost +1M -1M
```
```
XXX.enchantment.providers.SingleEnchantment +1M -1M
```
```
XXX.level.block.EndPortalBlock +1M
```
```
XXX.chunk.storage.IOWorker$PendingStore +1M
```
```
XXX.level.levelgen.PositionalRandomFactory +1P
```
```
XXX.level.levelgen.XoroshiroRandomSource$XoroshiroPositionalRandomFactory +1M
```
