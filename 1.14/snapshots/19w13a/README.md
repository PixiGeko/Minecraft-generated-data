...
```diff
+ gameplay/hero_of_the_village/armorer_gift.json
+ gameplay/hero_of_the_village/butcher_gift.json
+ gameplay/hero_of_the_village/cartographer_gift.json
+ gameplay/hero_of_the_village/cleric_gift.json
+ gameplay/hero_of_the_village/farmer_gift.json
+ gameplay/hero_of_the_village/fisherman_gift.json
+ gameplay/hero_of_the_village/fletcher_gift.json
+ gameplay/hero_of_the_village/leatherworker_gift.json
+ gameplay/hero_of_the_village/librarian_gift.json
+ gameplay/hero_of_the_village/mason_gift.json
+ gameplay/hero_of_the_village/shepherd_gift.json
+ gameplay/hero_of_the_village/toolsmith_gift.json
+ gameplay/hero_of_the_village/weaponsmith_gift.json
```
...
+ mob_effect/hero_of_the_village.png
```
