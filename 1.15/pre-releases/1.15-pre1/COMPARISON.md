## Comparison with [19w46b](https://github.com/PixiGeko/Minecraft-generated-data/tree/19w46b)
...
<br/>
<table><tr><th></th><th align="left">19w46b</th><th>1.15-pre1</th></tr><tr><td>World version</td><td><pre>2217</pre></td><td><pre>2218</pre></td></tr><tr><td>Protocol version</td><td><pre>564</pre></td><td><pre>565</pre></td></tr></table>
<h3>Libraries<a name="version-data-libraries"></a></h3>
<details>
<summary>
Versions
</summary>
<table><tr><th></th><th align="left">19w46b</th><th>1.15-pre1</th></tr><tr><td>org.lwjgl:lwjgl-glfw</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-glfw</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr></table>
</details>
</details>
<hr/>
...
```
XXX.mojang.math.Matrix3f -4M | +9P -1P
```
```
...
```
```
XXX.ai.util.RandomPos +5M -13M
```
```
XXX.entity.animal.Bee +62M -21M | +6P -2P
```
```
XXX.chunk.storage.ChunkSerializer +2M -1M
```
```
XXX.level.pathfinder.PathFinder +2M -3M
```
...
```
XXX.blaze3d.platform.NativeImage +7M | +2P -1P
```
```
XXX.blaze3d.vertex.VertexConsumer +2P
```
```
XXX.blaze3d.vertex.VertexMultiConsumer +1M -14M | -1P
```
```
XXX.renderer.blockentity.ConduitRenderer +6P -6P
```
```
XXX.renderer.blockentity.SignRenderer$SignModel +1M -1M
```
```
XXX.renderer.debug.BeeDebugRenderer +11M -6M
```
```
XXX.renderer.entity.EndCrystalRenderer +1P
```
```
XXX.renderer.entity.EnderDragonRenderer$DragonModel +1M -1M
```
```
XXX.renderer.entity.EntityRenderer +2M
```
```
XXX.renderer.entity.ExperienceOrbRenderer +2M | +1P
```
```
XXX.renderer.entity.MagmaCubeRenderer +2M
```
```
XXX.renderer.entity.ShulkerRenderer +1M -1M
```
```
XXX.entity.layers.EnderEyesLayer +1M -1M | +1P -1P
```
```
XXX.entity.layers.EyesLayer +1P -1P
```
```
XXX.entity.layers.PhantomEyesLayer +1M -1M | +1P -1P
```
```
XXX.renderer.texture.Stitcher +4M -4M
```
```
XXX.client.resources.MobEffectTextureManager +1M -1M
```
```
XXX.entity.animal.Bee$BeeGoToKnownFlowerGoal +3M -2M | +1P
```
```
XXX.entity.item.ItemEntity +4M -1M
```
```
XXX.entity.monster.Blaze -1M
```
```
XXX.entity.monster.PigZombie -1M
```
```
XXX.world.inventory.InventoryMenu$1 +1M -1M
```
```
XXX.world.level.ChunkPos +1M
```
```
XXX.world.level.Explosion +2M
```
```
XXX.level.block.SignBlock +2M -1M | +1P
```
```
XXX.level.block.StandingSignBlock +1M -1M
```
