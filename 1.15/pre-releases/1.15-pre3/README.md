...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/1.15-pre2">1.15-pre2</a>
## Mappings
...
<details><summary>com.mojang.blaze3d.vertex.BufferVertexConsumer</summary>
...
```diff
+ boolean dispenseArmor(ItemStack)
- ItemStack dispenseArmor(ItemStack)
```
...
```diff
+ AbstractContainerMenu lambda$use$1(Player)
+ BlockEntityType lambda$new$0()
+ DoubleBlockCombiner$NeighborCombineResult combine(BlockPos,boolean)
- AbstractContainerMenu lambda$use$0(Player)
```
...
- Long2ByteFunction computedLevels
+ int getQueueSize()
