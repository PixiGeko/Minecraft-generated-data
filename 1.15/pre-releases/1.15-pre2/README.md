...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/1.15-pre1">1.15-pre1</a>
## File structure
...
<details><summary>net.minecraft.client.renderer.blockentity.BedRenderer</summary>

```diff
+ boolean lambda$render$0(BlockPos)
```
...
+ void maybeDoSlideAchievement(BlockPos)
+ void maybeDoSlideEffects(Entity)
+ void showJumpParticles(Entity)
+ void showParticles(Entity,int)
+ void showSlideParticles(Entity)
- void doLandingParticleEffect(Entity)
- void doParticleEffects(BlockPos,int,double,double,double,double,double,double)
- void doSlideDownParticleEffects(Entity)
```
...
```diff
+ DoubleBlockCombiner$Combiner CHEST_COMBINER
+ DoubleBlockCombiner$Combiner MENU_PROVIDER_COMBINER
+ Supplier blockEntityType
- ChestBlock$ChestSearchCallback CHEST_COMBINER
- ChestBlock$ChestSearchCallback MENU_PROVIDER_COMBINER
- ChestBlock$ChestSearchCallback OPENNES_COMBINER
+ BlockEntityType blockEntityType()
+ boolean lambda$combine$0(BlockPos)
+ Container getContainer(BlockPos,boolean)
+ DoubleBlockCombiner$BlockType getBlockType(BlockState)
+ DoubleBlockCombiner$Combiner opennessCombiner(LidBlockEntity)
+ DoubleBlockCombiner$NeighborCombineResult combine(BlockPos,boolean)
+ void <init>(Supplier)
- Container getContainer(BlockPos,boolean)
- float getCombinedOpenness(BlockPos,float)
- Object combineWithNeigbour(ChestBlock$ChestSearchCallback)
- void <init>(Block$Properties)
```

</details>

<details><summary>net.minecraft.world.level.block.ChestBlock$2</summary>

```diff
+ Object acceptDouble(Object)
+ Object acceptNone()
+ Object acceptSingle(Object)
+ Optional acceptDouble(ChestBlockEntity)
+ Optional acceptNone()
+ Optional acceptSingle(ChestBlockEntity)
- MenuProvider acceptDouble(ChestBlockEntity)
- MenuProvider acceptSingle(ChestBlockEntity)
- Object acceptDouble(ChestBlockEntity)
- Object acceptSingle(ChestBlockEntity)
```

</details>

<details><summary>net.minecraft.world.level.block.ChestBlock$3</summary>

```diff
+ LidBlockEntity val$entity
