...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/1.15.1">1.15.1</a>
## Commands
...
<details><summary>net.minecraft.CrashReport</summary>
...
+ MobEffectInstance loadSpecifiedEffect(CompoundTag)
...
- List colors
- String textureHashName
+ List createPatterns(ListTag)
...
<details><summary>net.minecraft.world.level.block.grower.AcaciaTreeGrower</summary>
...
<details><summary>net.minecraft.util.datafix.fixes.AdvancementsFix</summary>
...
<details><summary>net.minecraft.util.profiling.GameProfiler</summary>
