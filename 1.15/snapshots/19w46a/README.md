...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/19w45b">19w45b</a>
## File structure
...
```diff
+ adventure/honey_block_slide.json
+ husbandry/safely_harvest_honey.json
+ husbandry/silk_touch_nest.json
```
...
```diff
+ BeeNestDestroyedTrigger BEE_NEST_DESTROYED
+ ItemUsedOnBlockTrigger SAFELY_HARVEST_HONEY
+ SlideDownBlockTrigger HONEY_BLOCK_SLIDE
```
...
<details><summary>net.minecraft.client.model.geom.ModelPart$Polygon</summary>
...
+ boolean lambda$clearRemovedHives$2(Map$Entry)
...
- boolean lambda$clearRemovedHives$1(Map$Entry)
- boolean lambda$getHiveMembers$7(BeeDebugRenderer$BeeInfo)
- void lambda$doRender$2(BeeDebugRenderer$BeeInfo)
- void lambda$doRender$3(BeeDebugRenderer$HiveInfo)
- void lambda$doRender$4(List)
- void lambda$renderFlowerInfos$5(BeeDebugRenderer$BeeInfo)
...
<details><summary>net.minecraft.client.renderer.debug.BeeDebugRenderer$HiveInfo</summary>

```diff
+ boolean sedated
+ int honeyLevel
+ void <init>(String,int,int,boolean,long)
- void <init>(String,int,long)
```
...
<details><summary>net.minecraft.server.level.Ticket</summary>
