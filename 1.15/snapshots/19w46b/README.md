...
- boolean requireSlash
+ boolean access$1102(CommandSuggestions,boolean)
+ boolean access$200(CommandSuggestions)
+ CommandSuggestions$SuggestionsList access$1202(CommandSuggestions$SuggestionsList)
...
- CommandSuggestions$SuggestionsList access$1102(CommandSuggestions$SuggestionsList)
