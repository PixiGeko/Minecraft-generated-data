...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/19w42a">19w42a</a>
## File structure
...
```diff
+ recipes/food/honey_bottle.json
```
...
```diff
+ void renderLevel(Matrix4f)
- void renderLevel(LightTexture)
```
...
<details><summary>net.minecraft.world.level.storage.loot.PredicateManager</summary>

```diff
- LootItemCondition get(LootItemCondition)
```
...
```diff
+ boolean checkCustomPredicate(LootItemCondition)
...
```diff
- SoundEvent PARROT_IMITATE_POLAR_BEAR
- SoundEvent PARROT_IMITATE_WOLF
- SoundEvent PARROT_IMITATE_ZOMBIE_PIGMAN
```
