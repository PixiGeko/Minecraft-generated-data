...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/19w36a">19w36a</a>
## Mappings
...
```diff
+ void assertAtTickTime(Runnable)
+ void assertAtTickTimeContainerContains(Item)
+ void assertAtTickTimeContainerEmpty(BlockPos)
+ void assertContainerContains(Item)
+ void assertContainerEmpty(BlockPos)
+ void assertEntityData(Object)
+ void lambda$assertAtTickTimeContainerContains$4(Item)
+ void lambda$assertAtTickTimeContainerEmpty$5(BlockPos)
+ void lambda$succeedWhenEntityData$6(Object)
+ void lambda$succeedWhenEntityNotPresent$8(BlockPos)
+ void lambda$succeedWhenEntityPresent$7(BlockPos)
+ void succeedWhenEntityData(Object)
- void lambda$succeedWhenEntityNotPresent$5(BlockPos)
- void lambda$succeedWhenEntityPresent$4(BlockPos)
```
...
```diff
+ Map assertAtTickTimeMap
+ void setAssertAtTickTime(Runnable)
```
