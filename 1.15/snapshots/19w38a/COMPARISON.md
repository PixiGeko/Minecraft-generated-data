## Comparison with [19w37a](https://github.com/PixiGeko/Minecraft-generated-data/tree/19w37a)
...
<br/>
<table><tr><th></th><th align="left">19w37a</th><th>19w38a</th></tr><tr><td>World version</td><td><pre>2204</pre></td><td><pre>2205</pre></td></tr><tr><td>Protocol version</td><td><pre>553</pre></td><td><pre>554</pre></td></tr></table>
<h3>Libraries<a name="version-data-libraries"></a></h3>
<details>
<summary>
Versions
</summary>
<table><tr><th></th><th align="left">19w37a</th><th>19w38a</th></tr><tr><td>org.lwjgl:lwjgl-glfw</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-glfw</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr></table>
</details>
</details>
<hr/>
...
+ XXX.advancements.critereon.BredAnimalsTrigger$PlayerListeners
- XXX.advancements.critereon.BredAnimalsTrigger$TriggerInstance
+ XXX.advancements.critereon.BrewedPotionTrigger
+ XXX.advancements.critereon.ChangeDimensionTrigger$PlayerListeners
- XXX.advancements.critereon.ChangeDimensionTrigger$TriggerInstance
+ XXX.advancements.critereon.ChanneledLightningTrigger
+ XXX.advancements.critereon.ConstructBeaconTrigger$PlayerListeners
- XXX.advancements.critereon.ConstructBeaconTrigger$TriggerInstance
+ XXX.advancements.critereon.ConsumeItemTrigger
+ XXX.advancements.critereon.CuredZombieVillagerTrigger$PlayerListeners
...
+ XXX.advancements.critereon.EffectsChangedTrigger$PlayerListeners
+ XXX.advancements.critereon.EnchantedItemTrigger$TriggerInstance
- XXX.advancements.critereon.EnchantmentPredicate
+ XXX.advancements.critereon.EnterBlockTrigger
+ XXX.advancements.critereon.EntityHurtPlayerTrigger$PlayerListeners
...
+ XXX.advancements.critereon.FilledBucketTrigger$PlayerListeners
+ XXX.advancements.critereon.FishingRodHookedTrigger$TriggerInstance
- XXX.advancements.critereon.FluidPredicate
- XXX.advancements.critereon.ImpossibleTrigger
+ XXX.advancements.critereon.ImpossibleTrigger$TriggerInstance
- XXX.advancements.critereon.InventoryChangeTrigger
+ XXX.advancements.critereon.InventoryChangeTrigger$PlayerListeners
+ XXX.advancements.critereon.ItemDurabilityTrigger$TriggerInstance
- XXX.advancements.critereon.ItemPredicate
+ XXX.advancements.critereon.ItemPredicate$Builder
- XXX.advancements.critereon.KilledByCrossbowTrigger
+ XXX.advancements.critereon.KilledByCrossbowTrigger$PlayerListeners
+ XXX.advancements.critereon.KilledTrigger$TriggerInstance
- XXX.advancements.critereon.LevitationTrigger
+ XXX.advancements.critereon.LevitationTrigger$PlayerListeners
- XXX.advancements.critereon.LightPredicate
- XXX.advancements.critereon.LightPredicate$Builder
+ XXX.advancements.critereon.LocationPredicate
- XXX.advancements.critereon.LocationPredicate$Builder
+ XXX.advancements.critereon.LocationTrigger
+ XXX.advancements.critereon.NetherTravelTrigger$PlayerListeners
- XXX.advancements.critereon.NetherTravelTrigger$TriggerInstance
+ XXX.advancements.critereon.PlacedBlockTrigger
+ XXX.advancements.critereon.PlayerHurtEntityTrigger$PlayerListeners
- XXX.advancements.critereon.PlayerHurtEntityTrigger$TriggerInstance
- XXX.advancements.critereon.PlayerPredicate$1
- XXX.advancements.critereon.PlayerPredicate$AdvancementDonePredicate
- XXX.advancements.critereon.PlayerPredicate$Builder
+ XXX.advancements.critereon.RecipeUnlockedTrigger
+ XXX.advancements.critereon.ShotCrossbowTrigger$PlayerListeners
...
+ XXX.advancements.critereon.TameAnimalTrigger$PlayerListeners
+ XXX.advancements.critereon.TickTrigger$TriggerInstance
- XXX.advancements.critereon.TradeTrigger
+ XXX.advancements.critereon.TradeTrigger$PlayerListeners
+ XXX.advancements.critereon.UsedEnderEyeTrigger$TriggerInstance
- XXX.advancements.critereon.UsedTotemTrigger
+ XXX.advancements.critereon.UsedTotemTrigger$PlayerListeners
...
+ XXX.storage.loot.LootTableProblemCollector
...
```
```
XXX.advancements.critereon.EnterBlockTrigger$TriggerInstance +1M -1M | +1P -1P
```
```
...
```
```
XXX.advancements.critereon.KilledTrigger +1M -3M | -1P
```
```
XXX.advancements.critereon.PlacedBlockTrigger$TriggerInstance +1M -1M | +1P -1P
```
```
XXX.advancements.critereon.SummonedEntityTrigger +1M -3M | -1P
```
```
XXX.advancements.critereon.TickTrigger -3M | -1P
```
```
XXX.advancements.critereon.UsedEnderEyeTrigger +1M -3M | -1P
```
```
XXX.data.loot.BlockLoot +5M -11M
```
```
XXX.protocol.game.ClientboundMoveEntityPacket +1M | +1P
```
```
XXX.server.commands.ExecuteCommand +49M -46M | +1P
```
```
XXX.server.level.ChunkMap$TrackedEntity +1M
```
```
...
```
```
XXX.level.block.BarrierBlock -1M
```
```
XXX.level.block.BedBlock -1M
```
```
XXX.level.block.Block +2M -2M | +1P
```
```
XXX.level.block.Block$Properties +2M | +1P
```
```
XXX.level.block.BubbleColumnBlock -1M
```
```
XXX.level.block.BushBlock -1M
```
```
XXX.level.block.ChorusFlowerBlock -1M
```
```
XXX.level.block.CocoaBlock -1M
```
```
XXX.level.block.DiodeBlock -2M
```
```
XXX.level.block.DragonEggBlock -1M
```
```
...
```
```
XXX.level.block.IronBarsBlock -1M
```
```
XXX.level.block.KelpPlantBlock -1M
```
```
XXX.level.block.LeavesBlock -3M | -1P
```
```
XXX.level.block.NetherPortalBlock -1M
```
```
XXX.level.block.SlimeBlock -1M
```
```
...
```
```
XXX.level.block.TrapDoorBlock -1M
```
```
XXX.level.block.VineBlock -1M
```
```
XXX.level.block.WebBlock -1M
```
```
XXX.block.entity.BannerBlockEntity +2M | +1P
```
```
XXX.block.piston.MovingPistonBlock -1M
```
```
XXX.level.material.EmptyFluid -1M
```
```
...
```
```
XXX.storage.loot.LootPool +1M -1M
```
```
XXX.storage.loot.LootTable +1M -1M
```
```
XXX.loot.predicates.LootItemBlockStatePropertyCondition$Serializer +2M -4M
```
...
+ XXX.advancements.critereon.BredAnimalsTrigger$TriggerInstance
- XXX.advancements.critereon.BrewedPotionTrigger
+ XXX.advancements.critereon.BrewedPotionTrigger$PlayerListeners
+ XXX.advancements.critereon.ChangeDimensionTrigger$TriggerInstance
- XXX.advancements.critereon.ChanneledLightningTrigger
+ XXX.advancements.critereon.ChanneledLightningTrigger$PlayerListeners
+ XXX.advancements.critereon.ConstructBeaconTrigger$TriggerInstance
- XXX.advancements.critereon.ConsumeItemTrigger
+ XXX.advancements.critereon.ConsumeItemTrigger$PlayerListeners
+ XXX.advancements.critereon.CuredZombieVillagerTrigger$TriggerInstance
- XXX.advancements.critereon.DamagePredicate
+ XXX.advancements.critereon.DamagePredicate$Builder
- XXX.advancements.critereon.DamageSourcePredicate
...
- XXX.advancements.critereon.DistancePredicate
+ XXX.advancements.critereon.EffectsChangedTrigger
+ XXX.advancements.critereon.EnchantedItemTrigger$PlayerListeners
- XXX.advancements.critereon.EnchantedItemTrigger$TriggerInstance
+ XXX.advancements.critereon.EnchantmentPredicate
- XXX.advancements.critereon.EnterBlockTrigger
+ XXX.advancements.critereon.EnterBlockTrigger$PlayerListeners
+ XXX.advancements.critereon.EntityHurtPlayerTrigger$TriggerInstance
- XXX.advancements.critereon.EntityPredicate
+ XXX.advancements.critereon.EntityPredicate$1
- XXX.advancements.critereon.EntityPredicate$Builder
...
- XXX.advancements.critereon.EntityTypePredicate$TypePredicate
+ XXX.advancements.critereon.FilledBucketTrigger
+ XXX.advancements.critereon.FishingRodHookedTrigger$PlayerListeners
- XXX.advancements.critereon.FishingRodHookedTrigger$TriggerInstance
- XXX.advancements.critereon.FluidPredicate$Builder
+ XXX.advancements.critereon.ImpossibleTrigger
- XXX.advancements.critereon.ImpossibleTrigger$TriggerInstance
+ XXX.advancements.critereon.InventoryChangeTrigger
+ XXX.advancements.critereon.ItemDurabilityTrigger$PlayerListeners
- XXX.advancements.critereon.ItemDurabilityTrigger$TriggerInstance
+ XXX.advancements.critereon.ItemPredicate
- XXX.advancements.critereon.ItemPredicate$Builder
+ XXX.advancements.critereon.KilledByCrossbowTrigger
+ XXX.advancements.critereon.KilledTrigger$PlayerListeners
- XXX.advancements.critereon.KilledTrigger$TriggerInstance
+ XXX.advancements.critereon.LevitationTrigger
...
+ XXX.advancements.critereon.LocationPredicate$Builder
- XXX.advancements.critereon.LocationTrigger
+ XXX.advancements.critereon.LocationTrigger$PlayerListeners
+ XXX.advancements.critereon.NetherTravelTrigger$TriggerInstance
- XXX.advancements.critereon.PlacedBlockTrigger
+ XXX.advancements.critereon.PlacedBlockTrigger$PlayerListeners
+ XXX.advancements.critereon.PlayerHurtEntityTrigger$TriggerInstance
- XXX.advancements.critereon.PlayerPredicate
- XXX.advancements.critereon.PlayerPredicate$AdvancementCriterionsPredicate
- XXX.advancements.critereon.PlayerPredicate$AdvancementPredicate
- XXX.advancements.critereon.RecipeUnlockedTrigger
+ XXX.advancements.critereon.RecipeUnlockedTrigger$PlayerListeners
+ XXX.advancements.critereon.ShotCrossbowTrigger$TriggerInstance
...
+ XXX.advancements.critereon.SummonedEntityTrigger$PlayerListeners
- XXX.advancements.critereon.SummonedEntityTrigger$TriggerInstance
+ XXX.advancements.critereon.TameAnimalTrigger
+ XXX.advancements.critereon.TickTrigger$PlayerListeners
- XXX.advancements.critereon.TickTrigger$TriggerInstance
+ XXX.advancements.critereon.TradeTrigger
+ XXX.advancements.critereon.UsedEnderEyeTrigger$PlayerListeners
- XXX.advancements.critereon.UsedEnderEyeTrigger$TriggerInstance
+ XXX.advancements.critereon.UsedTotemTrigger
...
+ XXX.blaze3d.platform.GlStateManager$AlphaState
...
+ XXX.blaze3d.platform.GlStateManager$CullFace
...
+ XXX.blaze3d.platform.GlStateManager$Profile$1
+ XXX.blaze3d.platform.GlStateManager$Profile$3
...
+ XXX.blaze3d.vertex.BufferUploader$1
+ XXX.blaze3d.vertex.VertexBufferUploader
...
+ XXX.client.model.BedModel
+ XXX.client.model.BellModel
- XXX.client.model.BlazeModel
+ XXX.client.model.BoatModel
- XXX.client.model.BookModel
+ XXX.client.model.CatModel
+ XXX.client.model.LargeChestModel
...
+ XXX.client.model.Polygon
+ XXX.client.model.Vertex
...
+ XXX.client.multiplayer.PlayerInfo$1
...
+ XXX.minecraft.realms.RealmsBufferBuilder
...
+ XXX.minecraft.util.CrashReportFiller
+ XXX.minecraft.world.package-info
+ XXX.model.dragon.DragonHeadModel
- XXX.model.dragon.DragonModel
+ XXX.model.dragon.EndCrystalModel
- XXX.model.dragon.package-info
+ XXX.model.geom.Cube
+ XXX.model.geom.ImageGenerator$Region
...
+ XXX.renderer.blockentity.ConduitRenderer$EyeModel
+ XXX.renderer.blockentity.ConduitRenderer$WindModel
...
+ XXX.renderer.chunk.ChunkCompileTask$Status
...
+ XXX.renderer.chunk.ChunkRenderWorker
+ XXX.renderer.chunk.CompiledChunk
...
+ XXX.renderer.texture.TextureObject
- XXX.renderer.texture.Tickable
+ XXX.renderer.texture.TickableTextureObject
...
```
```
XXX.blaze3d.vertex.BufferBuilder +13M -5M | +5P -1P
```
```
XXX.blaze3d.vertex.Tesselator +1M | -1P
```
```
XXX.mojang.math.Matrix4f +8M
```
```
XXX.mojang.math.Vector4f +1M
```
```
...
```
```
XXX.advancements.critereon.NetherTravelTrigger +1M -3M | -1P
```
```
...
```
```
XXX.minecraft.client.KeyboardHandler +5M -1M
```
```
XXX.minecraft.client.MouseHandler +8M -2M
```
```
XXX.client.gui.GuiComponent +2M
```
```
XXX.gui.screens.PresetFlatWorldScreen -1M
```
```
XXX.screens.inventory.LoomScreen +1M -1M | +1P -6P
```
```
XXX.client.renderer.ChunkBufferBuilderPack +4M -2M | +1P -1P
```
```
XXX.client.renderer.LevelRenderer$1 -1M | -1P
```
```
XXX.client.renderer.ViewArea +3M -3M | +1P -1P
```
```
XXX.renderer.banner.BannerTextures -1P
```
```
XXX.renderer.blockentity.BannerRenderer +3M -3M | +4P -1P
```
```
XXX.renderer.chunk.ChunkRenderDispatcher +17M -15M | +6P -8P
```
```
XXX.renderer.entity.ShulkerRenderer +2M
```
```
XXX.renderer.texture.LayeredColorMaskTexture +2M
```
```
XXX.renderer.texture.SimpleTexture +2M
```
```
XXX.resources.model.ModelBakery +26M -24M | +4P -10P
```
```
XXX.selector.options.EntitySelectorOptions +3M
```
```
...
```
```
XXX.entity.monster.PatrollingMonster$LongDistancePatrolGoal +1M -1M | +1P
```
```
XXX.world.item.Items +1P -1P
```
```
XXX.storage.loot.LootTables +3M -3M | +1P
```
```
XXX.loot.entries.CompositeEntryBase +1M -1M
```
```
XXX.loot.entries.LootPoolEntryContainer +1M -1M
```
```
XXX.loot.entries.LootTableReference +1M -1M
```
```
XXX.loot.functions.LootItemConditionalFunction +1M -1M
```
```
XXX.loot.parameters.LootContextParamSets +2M | +2P
```
```
XXX.loot.predicates.InvertedLootItemCondition +1M -1M
```
