## Comparison with [1.21.6-pre1](https://github.com/PixiGeko/Minecraft-generated-data/tree/1.21.6-pre1)
...
<br/>
<table><tr><th></th><th align="left">1.21.6-pre1</th><th>1.21.6-pre2</th></tr><tr><td>World version</td><td><pre>4430</pre></td><td><pre>4431</pre></td></tr><tr><td>Protocol version</td><td><pre>1073742076</pre></td><td><pre>1073742077</pre></td></tr></table>
</details>
<hr/>
...
<br/>
<table>
<tr><th>Name</th><th>1.21.6-pre1</th><th>1.21.6-pre2</th></tr>
<tr><th align="left"><div style="width:290px">soundCategory.hostile</div></th><td>Hostile Creatures</td><td>Hostile Mobs</td></tr>
<tr><th align="left"><div style="width:290px">soundCategory.neutral</div></th><td>Friendly Creatures</td><td>Friendly Mobs</td></tr>
</table>
<br/>
</details>
</details>
...
```
```
XXX.datafix.fixes.EntityCustomNameToComponentFix +3M -3M
```
...
```diff
- String escapeWithoutQuotes(String)
- void escapeWithoutQuotes(String,StringBuilder)
```
...
```diff
- Dynamic lambda$fixEntity$1(Dynamic)
+ Object lambda$fixEntity$1(Typed,OpticFinder,Type,String)
+ Typed fixEntity(Typed,OpticFinder,OpticFinder,Type)
- Typed fixEntity(Typed,Type,OpticFinder,OpticFinder,Type)
+ Typed lambda$makeRule$0(OpticFinder,OpticFinder,Type,Typed)
- Typed lambda$makeRule$0(Type,OpticFinder,OpticFinder,Type,Typed)
```
...
```
XXX.blaze3d.vertex.BufferBuilder +1P
```
```
XXX.blaze3d.vertex.ByteBufferBuilder$Result +1M -1M | +1P -1P
```
```
XXX.screens.configuration.RealmsConfigureWorldScreen +3M -5M
```
```
XXX.screens.configuration.RealmsSubscriptionTab +1M -2M
```
```
XXX.realmsclient.util.RealmsUtil +8M | +1P
```
```
XXX.world.level.TicketStorage +4M -4M
```
...
```diff
+ void <init>(ByteBufferBuilder,int,int,int)
- void <init>(ByteBufferBuilder,long,int,int)
```
...
```diff
- RealmsServer lambda$fetchServerData$6(long,RealmsClient)
- Screen createErrorScreen(RealmsServiceException)
+ void lambda$fetchRegionData$6(RealmsServiceException)
+ void lambda$fetchRegionData$7()
+ void lambda$fetchServerData$10(long)
- void lambda$fetchServerData$7(RealmsServer)
+ void lambda$fetchServerData$8(RealmsServer)
+ void lambda$fetchServerData$9(RealmsServiceException)
```
...
```diff
- void lambda$deleteRealm$3(RealmsClient)
+ void lambda$deleteRealm$3(RealmsServiceException)
+ void lambda$deleteRealm$5()
```
...
```diff
- CompletableFuture runAsync(RealmsUtil$RealmsIoConsumer,Consumer)
- CompletableFuture supplyAsync(RealmsUtil$RealmsIoFunction,Consumer)
- Consumer openScreenAndLogOnFailure(Function,String)
- Consumer openScreenOnFailure(Function)
- Object lambda$supplyAsync$0(RealmsUtil$RealmsIoFunction,Consumer)
- void lambda$openScreenAndLogOnFailure$3(String,RealmsServiceException)
- void lambda$openScreenOnFailure$1(Minecraft,Function,RealmsServiceException)
- void lambda$openScreenOnFailure$2(Minecraft,Function,RealmsServiceException)
```
...
```diff
- boolean lambda$deactivateTicketsOnClosing$6(Long,Ticket)
+ boolean lambda$deactivateTicketsOnClosing$6(Ticket)
- boolean lambda$purgeStaleTickets$5(ChunkMap,Long,Ticket)
+ boolean lambda$purgeStaleTickets$5(Ticket)
+ void purgeStaleTickets()
- void purgeStaleTickets(ChunkMap)
- void removeTicketIf(BiPredicate,Long2ObjectOpenHashMap)
+ void removeTicketIf(Predicate,Long2ObjectOpenHashMap)
```
