## Comparison with [22w24a](https://github.com/PixiGeko/Minecraft-generated-data/tree/22w24a)
...
<table><tr><th></th><th align="left">22w24a</th><th>1.19.1-pre1</th></tr><tr><td>World version</td><td><code>3106</code></td><td><code>3107</code></td></tr><tr><td>Protocol version</td><td><code>1073741916</code></td><td><code>1073741917</code></td></tr></table>
</details>
...
```
gui.chatReport.selected_chat: %s Chat Messages(s) Selected to Report
gui.abuseReport.reason.non_consensual_intimate_imagery: Non-consentsual intimate imagery
gui.chatSelection.fold: %s Uunrelated messages hidden
```
...
```
net.minecraft.Util +1P -1P
```
```
XXX.network.chat.CommonComponents +3M | +1P
```
```
XXX.animal.allay.Allay +2M | +1P -1P
```
...
```
```
XXX.realmsclient.client.RealmsClient +1M
```
```
XXX.realmsclient.gui.RealmsDataFetcher +2M -29M | +7P -24P
```
```
XXX.realmsclient.util.LevelType +1M -1M
```
```
net.minecraft.Util +1P -1P
```
```
XXX.minecraft.client.Minecraft +52M -48M | +1P
```
```
XXX.gui.components.AbstractSelectionList +1M
```
...
+ String newsLink()
+ void <clinit>()
+ void <init>(Minecraft,RealmsClient,RealmsPersistence)
...
```diff
+ void <init>(String,int,int,Component)
- void <init>(String,int,int,ResourceKey)
```
