## Comparison with [1.17.1-pre2](https://github.com/PixiGeko/Minecraft-generated-data/tree/1.17.1-pre2)
...
<table><tr><th></th><th align="left">1.17.1-pre2</th><th>1.17.1-pre3</th></tr><tr><td>World version</td><td><code>2726</code></td><td><code>2727</code></td></tr><tr><td>Protocol version</td><td><code>1073741861</code></td><td><code>1073741862</code></td></tr></table>
</details>
...
```
XXX.ai.behavior.RandomSwim +1M | +1P
```
```
XXX.ai.behavior.SetWalkTargetFromLookTarget +4M -2M | +1P
```
```
...
```diff
- boolean isEntityAttackableIgnoringLineOfSight(LivingEntity,LivingEntity)
```
...
```diff
- BlockState copyWaterloggedFrom(LevelReader,BlockPos,BlockState)
```
...
```
XXX.level.lighting.SkyLightSectionStorage +1M
```
...
```diff
- DataLayer repeatFirstLayer(DataLayer)
```
