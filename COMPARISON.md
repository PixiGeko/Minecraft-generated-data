## Comparison with [23w32a](https://github.com/PixiGeko/Minecraft-generated-data/tree/23w32a)
...
<table><tr><th></th><th align="left">23w32a</th><th>23w33a</th></tr><tr><td>World version</td><td><code>3569</code></td><td><code>3570</code></td></tr><tr><td>Protocol version</td><td><code>1073741969</code></td><td><code>1073741970</code></td></tr></table>
</details>
...
gui.abuseReport.reason.defamation_impersonation_false_information.description: Someone is damaging your or someone else's reputation, pretending to be someone they're not, orfor example sharing false information with the aim to exploit or mislead others.
gui.abuseReport.reason.imminent_harm: Imminent harm - Threat tof harm to others
...
```
XXX.gametest.framework.GameTestBatchRunner +2P
```
```
XXX.minecraft.server.MinecraftServer +1M -1M | -1P
```
```
XXX.world.entity.LivingEntity +1M -1M
```
```
XXX.world.entity.Mob +1M -2M | +1P
```
```
...
```
```
XXX.item.armortrim.TrimPattern +2M -1M | +1P
```
```
...
```
```
XXX.minecraft.client.Minecraft +70M -64M | -3P
```
```
XXX.screens.inventory.CreativeModeInventoryScreen$SlotWrapper +1M -1M
```
```
XXX.chat.report.AbuseReportSender$Services +2M -2M
```
```
XXX.ai.goal.MeleeAttackGoal +1M -2M
```
```
XXX.entity.monster.Spider$SpiderAttackGoal -1M
```
