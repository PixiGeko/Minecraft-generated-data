...
<table><tr><th></th><th align="left">23w13a</th><th>23w14a</th></tr><tr><td>ResourcePack version</td><td><code>13</code></td><td><code>14</code></td></tr><tr><td>World version</td><td><code>3443</code></td><td><code>3445</code></td></tr><tr><td>Protocol version</td><td><code>1073741952</code></td><td><code>1073741954</code></td></tr></table>
</details>
...
- net.minecraft.world.level.block.FarmableBlock
...
```
```
XXX.world.inventory.AbstractContainerMenu +1M -1M
```
```
XXX.world.item.BrushItem +1M -1M
```
```
XXX.item.crafting.MapExtendingRecipe +1M
```
```
...
```
```
XXX.gui.screens.ConnectScreen +2M -2M | +1P
```
```
XXX.gui.screens.DisconnectedScreen +5M | +4P -2P
```
```
XXX.screens.social.SocialInteractionsScreen -1M
```
```
...
```
```
XXX.minecraft.server.MinecraftServer +1M -3M
```
```
XXX.packs.resources.SimpleJsonResourceReloadListener +1M
```
```
XXX.minecraft.tags.BlockTags +5P -1P
```
```
