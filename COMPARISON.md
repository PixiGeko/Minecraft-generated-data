## Comparison with [1.16.4-pre1](https://github.com/PixiGeko/Minecraft-generated-data/tree/1.16.4-pre1)
...
<table><tr><th></th><th align="left">1.16.4-pre1</th><th>1.16.4-pre2</th></tr><tr><td>World version</td><td><code>2581</code></td><td><code>2582</code></td></tr><tr><td>Protocol version</td><td><code>1073741825</code></td><td><code>1073741826</code></td></tr></table>
</details>
...
title.multiplayer.disabled: Multiplayer is disabled. Please check your launcherMicrosoft account settings.
```
...
```
XXX.minecraft.network.Connection +1M -1M
```
```
XXX.protocol.login.ClientboundHelloPacket +1M -1M | +1P -1P
```
```
XXX.minecraft.server.MinecraftServer +1M -1M
```
```
XXX.server.network.ServerLoginPacketListenerImpl +2M -3M
```
...
```diff
- void setEncryptionKey(Cipher,Cipher)
+ void setEncryptionKey(SecretKey)
```
...
+ void <init>(String,PublicKey,byte[])
```
...
- Logger access$200()
+ Logger access$300()
+ SecretKey access$200(ServerLoginPacketListenerImpl)
- ServerLoginPacketListenerImpl$State access$302(ServerLoginPacketListenerImpl,ServerLoginPacketListenerImpl$State)
+ ServerLoginPacketListenerImpl$State access$402(ServerLoginPacketListenerImpl,ServerLoginPacketListenerImpl$State)
```
...
```
XXX.screens.inventory.AnvilScreen +1M
```
```
XXX.screens.social.PlayerSocialManager +3M -1M | +1P
```
```
XXX.screens.social.SocialInteractionsScreen +7M -1M | +7P -1P
```
...
- boolean shouldHideMessageFrom(UUID)
- void <init>(Minecraft,SocialInteractionsService)
+ void <init>(Minecraft)
```
...
```diff
- Component access$200()
- EditBox access$000(SocialInteractionsScreen)
- SocialInteractionsPlayerList access$100(SocialInteractionsScreen)
- void lambda$init$2(Button)
- void lambda$init$4(Button)
- void lambda$null$3(boolean)
+ void onHiddenOrShown()
- void tick()
```
