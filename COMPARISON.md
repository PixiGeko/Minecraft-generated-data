## Comparison with [1.20.5-pre2](https://github.com/PixiGeko/Minecraft-generated-data/tree/1.20.5-pre2)
...
<table><tr><th></th><th align="left">1.20.5-pre2</th><th>1.20.5-pre3</th></tr><tr><td>DataPack version</td><td><code>40</code></td><td><code>41</code></td></tr><tr><td>World version</td><td><code>3830</code></td><td><code>3831</code></td></tr><tr><td>Protocol version</td><td><code>1073742010</code></td><td><code>1073742011</code></td></tr></table>
</details>
...
```
XXX.minecraft.nbt.CompoundTag +2M -1M
```
```
XXX.minecraft.nbt.NbtOps$1 +1M -1M
```
...
```diff
+ Pair lambda$entries$0(CompoundTag,String)
- Pair lambda$entries$0(Map$Entry)
```
...
```
XXX.minecraft.client.OptionInstance$IntRange +2M | +1P
```
```
XXX.minecraft.client.OptionInstance$OptionInstanceSliderButton +3M -1M | +2P
```
```
XXX.minecraft.client.OptionInstance$SliderableValueSet +1M
```
```
...
```
```
XXX.minecraft.resources.DelegatingOps +5M
```
```
XXX.minecraft.resources.RegistryOps +2M -1M
```
...
```diff
- void <init>(Options,int,int,int,int,OptionInstance,OptionInstance$SliderableValueSet,OptionInstance$TooltipSupplier,Consumer,boolean)
+ void <init>(Options,int,int,int,int,OptionInstance,OptionInstance$SliderableValueSet,OptionInstance$TooltipSupplier,Consumer)
- void applyUnsavedValue()
...
```diff
- DataResult mergeToMap(Object,Map)
- DataResult mergeToPrimitive(Object,Object)
- Object createMap(Map)
- Object emptyList()
- Object emptyMap()
```
...
- int hashCode()
+ RegistryOps$RegistryInfoLookup memoizeLookup(RegistryOps$RegistryInfoLookup)
```
