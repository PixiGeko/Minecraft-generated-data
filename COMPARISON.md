## Comparison with [1.20.2-pre1](https://github.com/PixiGeko/Minecraft-generated-data/tree/1.20.2-pre1)
...
<table><tr><th></th><th align="left">1.20.2-pre1</th><th>1.20.2-pre2</th></tr><tr><td>ResourcePack version</td><td><code>17</code></td><td><code>18</code></td></tr><tr><td>World version</td><td><code>3572</code></td><td><code>3573</code></td></tr><tr><td>Protocol version</td><td><code>1073741972</code></td><td><code>1073741973</code></td></tr></table>
</details>
...
```
XXX.gui.components.CommandSuggestions +3M | +1P
```
```
...
```
```
XXX.screens.recipebook.RecipeBookComponent +4M -7M
```
```
XXX.screens.recipebook.RecipeCollection +1M -1M
```
```
XXX.client.multiplayer.ClientHandshakePacketListenerImpl +4M -2M | +1P
```
...
```diff
- ClientHandshakePacketListenerImpl$State lambda$switchState$0(ClientHandshakePacketListenerImpl$State,ClientHandshakePacketListenerImpl$State)
