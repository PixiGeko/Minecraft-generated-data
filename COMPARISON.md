## Comparison with [1.20-pre2](https://github.com/PixiGeko/Minecraft-generated-data/tree/1.20-pre2)
...
<table><tr><th></th><th align="left">1.20-pre2</th><th>1.20-pre3</th></tr><tr><td>World version</td><td><code>3455</code></td><td><code>3456</code></td></tr><tr><td>Protocol version</td><td><code>1073741959</code></td><td><code>1073741960</code></td></tr></table>
</details>
...
key.keyboard.unknown: Not bBound
...
```
```
XXX.protocol.game.ClientboundPlayerCombatEndPacket +1M -1M | -1P
```
```
XXX.protocol.game.ClientboundPlayerCombatKillPacket +1M -3M | -1P
```
```
XXX.protocol.status.ServerStatus$Favicon -2P
```
```
XXX.server.level.ServerEntity +1M -1M
```
```
XXX.world.damagesource.CombatEntry +8M -11M | +1P -3P
```
```
XXX.world.damagesource.CombatTracker +5M -10M | -1P
```
...
```diff
+ int getKillerId()
+ void <init>(CombatTracker,Component)
- void <init>(int,Component)
+ void <init>(int,int,Component)
```
...
- void sendPairingData(ServerPlayer,Consumer)
```
...
+ String getLocation()
- String toString()
- void <init>(DamageSource,float,FallLocation,float)
+ void <init>(DamageSource,int,float,float,String,float)
```
...
- Component getFallMessage(CombatEntry,Entity)
- Component getMessageForAssistedFall(Entity,Component,String,String)
+ int getKillerId()
...
```
XXX.world.entity.Display +1M
```
```
XXX.world.entity.Interaction +1M
```
```
