...
<table><tr><th></th><th align="left">24w13a</th><th>24w14a</th></tr><tr><td>DataPack version</td><td><code>37</code></td><td><code>38</code></td></tr><tr><td>World version</td><td><code>3826</code></td><td><code>3827</code></td></tr><tr><td>Protocol version</td><td><code>1073742006</code></td><td><code>1073742008</code></td></tr></table>
</details>
...
```
XXX.arguments.item.FunctionArgument$1 -1P
```
```
XXX.arguments.item.ItemParser$1 -1P
```
```
...
```
```
XXX.datafix.fixes.StructuresBecomeConfiguredFix +6M -9M | +1P
```
```
XXX.entity.monster.Phantom$PhantomLookControl -1P
```
```
XXX.monster.warden.Warden$1$1 -1P
```
```
...
```
```
XXX.world.item.FireworkRocketItem +1M -1M
```
```
...
```
```
XXX.world.item.MaceItem +1M -2M | -1P
```
```
XXX.world.item.MobBucketItem +1M -1M
```
```
XXX.world.item.OminousBottleItem +1M -1M
```
```
...
```
```
XXX.item.component.BundleContents$Mutable +1M -1M | +1P -1P
```
```
...
```
```
XXX.loot.functions.SetAttributesFunction +6M -4M | +1P
```
...
```diff
- Dynamic findUpdatedStructureType(Dynamic,Dynamic)
+ Dynamic findUpdatedStructureType(Pair,Dynamic)
+ Dynamic lambda$updateReference$7(Pair,Dynamic,Dynamic)
- Dynamic lambda$updateReferences$5(Dynamic,Dynamic,Dynamic)
- Dynamic lambda$updateStarts$3(Dynamic,Dynamic,Dynamic)
+ Pair lambda$updateReferences$6(Dynamic,Pair)
+ Pair lambda$updateStarts$4(Dynamic,Pair)
+ Pair updateReference(Pair,Dynamic)
+ Pair updateStart(Pair,Dynamic)
- void lambda$guessConfiguration$7(StructuresBecomeConfiguredFix$Conversion,Object2IntArrayMap,Dynamic)
+ void lambda$guessConfiguration$9(StructuresBecomeConfiguredFix$Conversion,Object2IntArrayMap,Dynamic)
+ void lambda$updateReferences$5(List,Dynamic,Dynamic)
- void lambda$updateReferences$6(Dynamic,HashMap,Dynamic,Dynamic)
+ void lambda$updateStarts$3(List,Dynamic,Dynamic)
- void lambda$updateStarts$4(Dynamic,HashMap,Dynamic,Dynamic)
```
...
```
XXX.minecraft.client.Options$3 -1P
```
```
...
```
```
XXX.renderer.chunk.SectionRenderDispatcher$RenderSection$CompileTask -1P
```
```
XXX.renderer.debug.ChunkDebugRenderer$ChunkData -1P
```
```
...
```
```
XXX.packs.linkfs.LinkFSProvider$1 -1P
```
```
...
```
```
XXX.entity.animal.Fox$FoxBreedGoal -1P
```
```
XXX.entity.animal.Squid$SquidRandomMovementGoal -1P
```
```
XXX.entity.animal.Wolf$WolfPanicGoal -1P
```
```
...
```
```
XXX.world.inventory.GrindstoneMenu$3 -1P
```
```
XXX.world.inventory.HorseInventoryMenu$1 -1P
```
```
XXX.world.inventory.InventoryMenu$2 -1P
```
```
XXX.world.inventory.ItemCombinerMenu$1 -1P
```
```
XXX.world.inventory.LoomMenu$4 -1P
```
```
XXX.world.item.ArmorItem +2M -2M
```
```
XXX.world.item.BannerPatternItem +1M -1M
```
```
XXX.world.item.BlockItem +1M -1M
```
```
XXX.world.item.BundleItem +1M -1M | +1P
```
```
XXX.level.block.Block +1M -1M
```
```
XXX.level.block.RespawnAnchorBlock$1 -1P
```
```
XXX.block.entity.SkullBlockEntity +9M -4M | +2P -1P
```
```
...
```
```
XXX.structure.structures.StrongholdPieces$3 -1P
```
...
+ CompletableFuture loadProfile(String,Services,BooleanSupplier)
...
+ Optional lambda$loadProfile$2(BooleanSupplier,Services,Optional)
+ void lambda$loadAdditional$3(String)
- void lambda$loadAdditional$6(String)
+ void lambda$updateOwnerProfile$4(ResolvableProfile)
- void lambda$updateOwnerProfile$7(ResolvableProfile)
```
