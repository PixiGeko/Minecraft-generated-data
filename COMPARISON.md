## Comparison with [18w06a](https://github.com/PixiGeko/Minecraft-generated-data/tree/18w06a)
...
+ item.minecraft.lingering_potion.effect.turtle_master: Potion of the Turtle Master
+ item.minecraft.phantom_spawn_egg: Spawn Phantom
+ item.minecraft.potion.effect.turtle_master: Potion of the Turtle Master
+ item.minecraft.splash_potion.effect.turtle_master: Potion of the Turtle Master
...
+ item.minecraft.turtle_spawn_egg: Spawn Turtle
+ potion.potency.3: IV
+ potion.potency.4: V
+ potion.potency.5: VI
+ stat.minecraft.time_since_sleep: Since Last Rest
+ subtitles.item.axe.strip: Debarking log
+ subtitles.turtle.ambient_land: Turtle chirp
