## Comparison with [1.19.4-pre3](https://github.com/PixiGeko/Minecraft-generated-data/tree/1.19.4-pre3)
...
<table><tr><th></th><th align="left">1.19.4-pre3</th><th>1.19.4-pre4</th></tr><tr><td>World version</td><td><code>3332</code></td><td><code>3333</code></td></tr><tr><td>Protocol version</td><td><code>1073741946</code></td><td><code>1073741947</code></td></tr></table>
</details>
...
```
commands.banip.info: This ban affects %s players(s): %s
commands.banlist.list: There is/are %s bans(s):
commands.clear.success.multiple: Removed %s items(s) from %s players
commands.clear.success.single: Removed %s items(s) from player %s
commands.clear.test.multiple: Found %s matching items(s) on %s players
commands.clear.test.single: Found %s matching items(s) on player %s
commands.debug.function.success.multiple: Traced %s commands(s) from %s functions to output file %s
commands.debug.function.success.single: Traced %s commands(s) from function '%s' to output file %s
commands.function.success.multiple: Executed %s commands(s) from %s functions
commands.function.success.single: Executed %s commands(s) from function '%s'
commands.perf.stopped: Stopped performance profiling after %s seconds(s) and %s ticks(s) (%s ticks(s) per second)
commands.schedule.cleared.success: Removed %s schedules(s) with id %s
commands.schedule.created.function: Scheduled function '%s' in %s ticks(s) at gametime %s
commands.setidletimeout.success: The player idle timeout is now %s minutes(s)
...
commands.spreadplayers.failed.teams: Could not spread %s teams(s) around %s, %s (too many entities for space - try using spread of at most %s)
commands.spreadplayers.success.entities: Spread %s players(s) around %s, %s with an average distance of %s blocks apart
commands.spreadplayers.success.teams: Spread %s teams(s) around %s, %s with an average distance of %s blocks apart
commands.whitelist.list: There is/are %s whitelisted players(s): %s
commands.worldborder.damage.buffer.success: Set the world border damage buffer to %s blocks(s)
commands.worldborder.get: The world border is currently %s blocks(s) wide
commands.worldborder.set.immediate: Set the world border to %s blocks(s) wide
commands.worldborder.set.shrink: Shrinking the world border to %s blocks(s) wide over %s seconds(s)
commands.worldborder.warning.distance.success: Set the world border warning distance to %s blocks(s)
commands.worldborder.warning.time.success: Set the world border warning time to %s seconds(s)
...
mco.activity.noactivity: No activity for the past %s days(s)
mco.configure.world.invite.narration: You have %s new invites(s)
mco.invites.pending: New invites(s)!
...
selectWorld.gameMode.hardcore.info: Survival mMode locked to 'Hard' difficulty. You can't respawn if you die.
...
+ net.minecraft.data.advancements.packs.UpdateOneTwentyAdventureAdvancements
...
- net.minecraft.data.loot.packs.UpdateOneTwentyArchaeologyLoot
+ net.minecraft.data.loot.packs.UpdateOneTwentyBlockLoot
- net.minecraft.data.loot.packs.UpdateOneTwentyBuiltInLootTables
+ net.minecraft.data.loot.packs.UpdateOneTwentyChestLoot
- net.minecraft.data.loot.packs.UpdateOneTwentyEntityLoot
+ net.minecraft.data.loot.packs.UpdateOneTwentyFishingLoot
...
+ net.minecraft.data.tags.UpdateOneTwentyBiomeTagsProvider
...
- net.minecraft.world.level.biome.OverworldBiomeBuilder$Modifier
...
```
```
XXX.world.entity.Display$FloatInterpolator +2M
```
```
XXX.world.entity.Display$IntInterpolator +2M
```
...
- net.minecraft.world.entity.Display$2
...
```
```
XXX.world.entity.Display$Interpolator -1M | +1P
```
```
XXX.world.entity.Display$TextDisplay +1M -1M
```
