## Comparison with [1.19.1-pre3](https://github.com/PixiGeko/Minecraft-generated-data/tree/1.19.1-pre3)
...
<table><tr><th></th><th align="left">1.19.1-pre3</th><th>1.19.1-pre4</th></tr><tr><td>World version</td><td><code>3111</code></td><td><code>3112</code></td></tr><tr><td>Protocol version</td><td><code>1073741920</code></td><td><code>1073741921</code></td></tr></table>
</details>
...
```
XXX.minecraft.client.GuiMessage +2M -1M | +1P
```
```
XXX.gui.components.ChatComponent +4M -1M
```
```
XXX.client.multiplayer.ClientPacketListener +3M | +1P
```
```
XXX.multiplayer.chat.ChatListener$Message +8M | +2P -1P
```
```
XXX.chat.report.ChatReportBuilder -1M
```
```
XXX.client.player.LocalPlayer +4M -4M
```
```
XXX.minecraft.commands.CommandSigningContext +1M -3M | +3P -1P
```
