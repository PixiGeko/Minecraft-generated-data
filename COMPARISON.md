## Comparison with [24w46a](https://github.com/PixiGeko/Minecraft-generated-data/tree/24w46a)
...
<br/>
<table><tr><th></th><th align="left">24w46a</th><th>1.21.4-pre1</th></tr><tr><td>ResourcePack version</td><td><pre>45</pre></td><td><pre>46</pre></td></tr><tr><td>World version</td><td><pre>4178</pre></td><td><pre>4179</pre></td></tr><tr><td>Protocol version</td><td><pre>1073742046</pre></td><td><pre>1073742047</pre></td></tr></table>
<h3>Libraries<a name="version-data-libraries"></a></h3>
<details>
<summary>
Versions
</summary>
<table><tr><th></th><th align="left">24w46a</th><th>1.21.4-pre1</th></tr><tr><td>com.github.oshi:oshi-core</td><td><pre>6.4.10</pre></td><td><pre>6.6.5</pre></td></tr><tr><td>com.google.code.gson:gson</td><td><pre>2.10.1</pre></td><td><pre>2.11.0</pre></td></tr><tr><td>com.google.guava:failureaccess</td><td><pre>1.0.1</pre></td><td><pre>1.0.2</pre></td></tr><tr><td>com.google.guava:guava</td><td><pre>32.1.2-jre</pre></td><td><pre>33.3.1-jre</pre></td></tr><tr><td>com.ibm.icu:icu4j</td><td><pre>73.2</pre></td><td><pre>76.1</pre></td></tr><tr><td>com.microsoft.azure:msal4j</td><td><pre>1.15.0</pre></td><td><pre>1.17.2</pre></td></tr><tr><td>com.mojang:logging</td><td><pre>1.4.9</pre></td><td><pre>1.5.10</pre></td></tr><tr><td>com.nimbusds:nimbus-jose-jwt</td><td><pre>9.37.3</pre></td><td><pre>9.40</pre></td></tr><tr><td>com.nimbusds:oauth2-oidc-sdk</td><td><pre>11.9.1</pre></td><td><pre>11.18</pre></td></tr><tr><td>commons-codec:commons-codec</td><td><pre>1.16.0</pre></td><td><pre>1.17.1</pre></td></tr><tr><td>commons-io:commons-io</td><td><pre>2.15.1</pre></td><td><pre>2.17.0</pre></td></tr><tr><td>commons-logging:commons-logging</td><td><pre>1.2</pre></td><td><pre>1.3.4</pre></td></tr><tr><td>io.netty:netty-buffer</td><td><pre>4.1.97.Final</pre></td><td><pre>4.1.115.Final</pre></td></tr><tr><td>io.netty:netty-codec</td><td><pre>4.1.97.Final</pre></td><td><pre>4.1.115.Final</pre></td></tr><tr><td>io.netty:netty-common</td><td><pre>4.1.97.Final</pre></td><td><pre>4.1.115.Final</pre></td></tr><tr><td>io.netty:netty-handler</td><td><pre>4.1.97.Final</pre></td><td><pre>4.1.115.Final</pre></td></tr><tr><td>io.netty:netty-resolver</td><td><pre>4.1.97.Final</pre></td><td><pre>4.1.115.Final</pre></td></tr><tr><td>io.netty:netty-transport-classes-epoll</td><td><pre>4.1.97.Final</pre></td><td><pre>4.1.115.Final</pre></td></tr><tr><td>io.netty:netty-transport-native-epoll (linux-aarch_64)</td><td><pre>4.1.97.Final</pre></td><td><pre>4.1.115.Final</pre></td></tr><tr><td>io.netty:netty-transport-native-epoll (linux-x86_64)</td><td><pre>4.1.97.Final</pre></td><td><pre>4.1.115.Final</pre></td></tr><tr><td>io.netty:netty-transport-native-unix-common</td><td><pre>4.1.97.Final</pre></td><td><pre>4.1.115.Final</pre></td></tr><tr><td>io.netty:netty-transport</td><td><pre>4.1.97.Final</pre></td><td><pre>4.1.115.Final</pre></td></tr><tr><td>it.unimi.dsi:fastutil</td><td><pre>8.5.12</pre></td><td><pre>8.5.15</pre></td></tr><tr><td>net.java.dev.jna:jna-platform</td><td><pre>5.14.0</pre></td><td><pre>5.15.0</pre></td></tr><tr><td>net.java.dev.jna:jna</td><td><pre>5.14.0</pre></td><td><pre>5.15.0</pre></td></tr><tr><td>net.minidev:accessors-smart</td><td><pre>2.5.0</pre></td><td><pre>2.5.1</pre></td></tr><tr><td>net.minidev:json-smart</td><td><pre>2.5.0</pre></td><td><pre>2.5.1</pre></td></tr><tr><td>org.apache.commons:commons-compress</td><td><pre>1.26.0</pre></td><td><pre>1.27.1</pre></td></tr><tr><td>org.apache.commons:commons-lang3</td><td><pre>3.14.0</pre></td><td><pre>3.17.0</pre></td></tr><tr><td>org.apache.httpcomponents:httpclient</td><td><pre>4.5.13</pre></td><td><pre>4.5.14</pre></td></tr><tr><td>org.apache.logging.log4j:log4j-api</td><td><pre>2.22.1</pre></td><td><pre>2.24.1</pre></td></tr><tr><td>org.apache.logging.log4j:log4j-core</td><td><pre>2.22.1</pre></td><td><pre>2.24.1</pre></td></tr><tr><td>org.apache.logging.log4j:log4j-slf4j2-impl</td><td><pre>2.22.1</pre></td><td><pre>2.24.1</pre></td></tr><tr><td>org.joml:joml</td><td><pre>1.10.5</pre></td><td><pre>1.10.8</pre></td></tr><tr><td>org.ow2.asm:asm</td><td><pre>9.3</pre></td><td><pre>9.6</pre></td></tr><tr><td>org.slf4j:slf4j-api</td><td><pre>2.0.9</pre></td><td><pre>2.0.16</pre></td></tr></table>
</details>
</details>
<hr/>
...
<br/>
<table>
<tr><th>Name</th><th>24w46a</th><th>1.21.4-pre1</th></tr>
<tr><th align="left"><div style="width:290px">item.op_block_warning.line2</div></th><td>Placing this item might lead to command execution</td><td>Use of this item might lead to command execution</td></tr>
</table>
<br/>
</details>
</details>
...
```
XXX.blaze3d.platform.GlConst +1P
```
```
XXX.color.item.Constant +1M -1M
```
```
XXX.color.item.Dye +1M -1M
```
```
XXX.color.item.GrassColorSource +1M -1M
```
```
XXX.color.item.Potion +1M -1M
```
```
XXX.renderer.item.ClientItem +2M -1M | +1P
```
```
XXX.properties.select.LocalTime +10M -6M | +2P -3P
```
```
XXX.minecraft.util.PngInfo +1M | +1P
```
```
XXX.world.entity.Interaction +1M -1M
```
```
XXX.world.entity.Leashable +5M -2M
```
```
XXX.entity.item.FallingBlockEntity -1M
```
```
XXX.monster.creaking.Creaking +4M -1M | +1P -1P
```
```
XXX.world.item.BlockItem -3M | -1P
```
```
XXX.world.item.CompassItem -1M
```
```
XXX.world.item.Item +1M
```
```
XXX.world.item.ItemStack +1P
```
```
XXX.block.entity.CreakingHeartBlockEntity +3M
```
...
```diff
- int calculate(ItemStack,ClientLevel,LivingEntity)
+ int calculate(ItemStack)
```
...
- void <init>(ItemModel$Unbaked,ClientItem$Properties)
+ void <init>(ItemModel$Unbaked)
```
...
```diff
+ Calendar lambda$create$6(ULocale,TimeZone)
+ Calendar lambda$create$7(ULocale)
- Calendar lambda$create$8(ULocale,TimeZone)
- Calendar lambda$create$9(ULocale)
- DataResult create(LocalTime$Data)
- DataResult lambda$static$6(LocalTime)
- IllegalStateException lambda$create$7(String)
+ Optional lambda$static$4(LocalTime)
- Optional lambda$static$4(LocalTime$Data)
- String lambda$create$10(SimpleDateFormat,Exception)
+ String lambda$static$2(LocalTime)
- String lambda$static$2(LocalTime$Data)
+ String lambda$static$3(LocalTime)
- String lambda$static$3(LocalTime$Data)
- void <init>(LocalTime$Data,DateFormat)
+ void <init>(String,Optional,String,DateFormat)
```
...
```diff
+ Leashable$LeashData readLeashData(CompoundTag)
- Leashable$LeashData readLeashDataInternal(CompoundTag)
- void dropLeash()
+ void dropLeash(boolean,boolean)
- void onLeashRemoved()
- void readLeashData(CompoundTag)
- void removeLeash()
```
...
```diff
- BlockPos getHomePos()
- boolean canBeNameTagged()
- boolean isHeartBound()
+ boolean isTransient()
- void setHomePos(BlockPos)
```
...
```diff
+ BlockEntityType getBlockEntityType(HolderLookup$Provider,CustomData)
+ Optional lambda$getBlockEntityType$0(ResourceLocation,HolderLookup$RegistryLookup)
+ void <clinit>()
```
...
```diff
- void clearCreakingInfo()
- void setCreakingInfo(Creaking)
- void setCreakingInfo(UUID)
```
