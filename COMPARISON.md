## Comparison with [1.21.6](https://github.com/PixiGeko/Minecraft-generated-data/tree/1.21.6)
...
<br/>
<table><tr><th></th><th align="left">1.21.6</th><th>1.21.7-rc1</th></tr><tr><td>World version</td><td><pre>4435</pre></td><td><pre>4436</pre></td></tr><tr><td>Protocol version</td><td><pre>771</pre></td><td><pre>1073742081</pre></td></tr></table>
</details>
<hr/>
...
```diff
+ minecraft/jukebox_song/lava_chicken.json
+ minecraft/painting_variant/dennis.json
```
...
```diff
+ minecraft/items/music_disc_lava_chicken.json
+ minecraft/models/item/music_disc_lava_chicken.json
+ minecraft/textures/item/music_disc_lava_chicken.png
+ minecraft/textures/painting/dennis.png
```
...
```
```
XXX.entity.decoration.PaintingVariants +1P
```
```
XXX.world.item.JukeboxSongs +1P
```
...
```
XXX.blaze3d.opengl.DirectStateAccess +1P
```
```
XXX.blaze3d.opengl.DirectStateAccess$Emulated +1M
```
```
net.minecraft.Util +1M
```
```
XXX.gui.components.EditBox -1M
```
```
XXX.render.state.GuiItemRenderState +2M -2M | +1P -1P
```
```
XXX.renderer.item.ItemStackRenderState -2M | -1P
```
...
```diff
+ void renderHighlight(GuiGraphics,int,int,int,int)
```
...
- void <init>(String,Matrix3x2f,TrackingItemStackRenderState,int,int,ScreenRectangle)
```
