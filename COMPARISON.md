...
<table><tr><th></th><th align="left">1.20-pre1</th><th>1.20-pre2</th></tr><tr><td>World version</td><td><code>3454</code></td><td><code>3455</code></td></tr><tr><td>Protocol version</td><td><code>1073741958</code></td><td><code>1073741959</code></td></tr></table>
</details>
...
commands.bossbar.get.players.some: Custom bossbar %s has %s players(s) currently online: %s
commands.bossbar.list.bars.some: There is/are %s custom bossbars(s) active: %s
commands.bossbar.set.players.success.some: Custom bossbar %s now has %s players(s): %s
commands.clone.success: Successfully cloned %s blocks(s)
commands.datapack.list.available.success: There is/are %s data packs(s) available: %s
commands.datapack.list.enabled.success: There is/are %s data packs(s) enabled: %s
commands.fill.success: Successfully filled %s blocks(s)
commands.fillbiome.success.count: %s biome entry/entries set between %s, %s, %s and %s, %s, %s
commands.scoreboard.objectives.list.success: There is/are %s objectives(s): %s
commands.scoreboard.players.list.entity.success: %s has %s scores(s):
commands.scoreboard.players.list.success: There is/are %s tracked entity/entities: %s
commands.team.empty.success: Removed %s members(s) from team %s
commands.team.list.members.success: Team %s has %s members(s): %s
commands.team.list.teams.success: There is/are %s teams(s): %s
mco.configure.world.uninvite.player: Are you sure that you want to uninvite '%s' ?
options.graphics.warning.accept: Continue wWithout Support
options.graphics.warning.cancel: Take mMe Back
structure_block.detect_size: Detect sStructure sSize and pPosition:
...
telemetry.event.game_load_times.description: This event can help us figure out where improvements to startup performance improvements are needed by measuring the execution times of the startup phases.
```
