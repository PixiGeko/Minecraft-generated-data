## Comparison with [1.15.1](https://github.com/PixiGeko/Minecraft-generated-data/tree/1.15.1)
...
<table><tr><th></th><th align="left">1.15.1</th><th>1.15.2-pre1</th></tr><tr><td>World version</td><td><code>2227</code></td><td><code>2228</code></td></tr><tr><td>Protocol version</td><td><code>575</code></td><td><code>576</code></td></tr></table>
</details>
...
```
chat.link.open: Open in bBrowser
options.rawMouseInput: Raw iInput
```
...
```
```
XXX.datafix.fixes.AdvancementsFix +1M -5M | +1P -1P
```
```
XXX.datafix.fixes.RecipesRenameningFix +1M -4M
```
```
XXX.util.profiling.GameProfiler +2M
```
```
XXX.util.profiling.InactiveProfiler +2M
```
...
```
```
XXX.mojang.realmsclient.RealmsMainScreen -2M
```
```
net.minecraft.CrashReport +1M
```
```
XXX.gui.font.FontManager +1M -2M | -1P
```
```
XXX.screens.inventory.LoomScreen +1P -1P
```
```
XXX.datafix.fixes.RecipesFix +1M -4M
```
```
XXX.world.effect.MobEffectInstance +4M | +1P
```
```
XXX.block.entity.BannerBlockEntity +2M -5M | -3P
```
```
XXX.block.grower.AcaciaTreeGrower +1M -1M
```
```
XXX.block.grower.DarkOakTreeGrower +1M -1M
```
```
XXX.block.grower.OakTreeGrower +1M -1M
```
```
XXX.level.storage.LevelData +3M | +2P
```
...
```diff
+ Set access$300(FontManager)
- TextureManager access$300(FontManager)
+ TextureManager access$400(FontManager)
```
...
- void <init>(MobEffect,int,int,boolean,boolean,boolean,MobEffectInstance)
- void setDetailsFrom(MobEffectInstance)
...
```diff
- ConfiguredFeature getConfiguredFeature(Random,boolean)
+ ConfiguredFeature getConfiguredFeature(Random)
```
...
- void setModdedInfo(String,boolean)
```
