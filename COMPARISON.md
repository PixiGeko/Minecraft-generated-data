## Comparison with [1.20.5-pre4](https://github.com/PixiGeko/Minecraft-generated-data/tree/1.20.5-pre4)
...
<table><tr><th></th><th align="left">1.20.5-pre4</th><th>1.20.5-rc1</th></tr><tr><td>World version</td><td><code>3832</code></td><td><code>3834</code></td></tr><tr><td>Protocol version</td><td><code>1073742012</code></td><td><code>1073742013</code></td></tr></table>
</details>
...
```
XXX.datafix.fixes.HorseBodyArmorItemFix +5M -1M | +1P
```
...
```diff
- Dynamic lambda$fix$0(Dynamic,long)
- Dynamic lambda$fix$1(Dynamic)
- Dynamic lambda$fix$2(Dynamic,long)
- Dynamic lambda$fix$3(Dynamic)
- void <init>(Schema,String,String,boolean)
+ void <init>(Schema,String,String)
```
