## Comparison with [1.19.4-pre2](https://github.com/PixiGeko/Minecraft-generated-data/tree/1.19.4-pre2)
...
<table><tr><th></th><th align="left">1.19.4-pre2</th><th>1.19.4-pre3</th></tr><tr><td>World version</td><td><code>3331</code></td><td><code>3332</code></td></tr><tr><td>Protocol version</td><td><code>1073741945</code></td><td><code>1073741946</code></td></tr></table>
</details>
...
```
XXX.world.damagesource.DamageSource +1M
```
```
XXX.world.entity.LivingEntity +1M
```
```
XXX.entity.ai.Brain +5M -3M
```
...
- boolean lambda$isMemoryValue$2(Object,Object)
...
```
XXX.minecraft.client.KeyboardHandler +10M -9M
```
```
XXX.minecraft.client.OptionInstance$ClampingLazyMaxIntRange +2M -1M | +1P
```
```
XXX.components.tabs.TabNavigationBar +1M -1M
```
```
XXX.screens.worldselection.SelectWorldScreen +1M -1M
```
...
```diff
- Style lambda$handleDebugKeys$0(Path,Style)
...
- void lambda$copyRecreateCommand$1(BlockState,BlockPos,CompoundTag)
+ void lambda$copyRecreateCommand$1(ResourceLocation,Entity,CompoundTag)
- void lambda$copyRecreateCommand$2(ResourceLocation,Entity,CompoundTag)
...
- void lambda$keyPress$5(int,Screen,boolean[],int,int,int)
...
- void <init>(int,IntSupplier,int)
+ void <init>(int,IntSupplier)
```
