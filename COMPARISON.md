## Comparison with [1.19.3-pre3](https://github.com/PixiGeko/Minecraft-generated-data/tree/1.19.3-pre3)
...
<table><tr><th></th><th align="left">1.19.3-pre3</th><th>1.19.3-rc1</th></tr><tr><td>World version</td><td><code>3213</code></td><td><code>3215</code></td></tr><tr><td>Protocol version</td><td><code>1073741935</code></td><td><code>1073741936</code></td></tr></table>
</details>
...
```
XXX.commands.arguments.NbtPathArgument -1P
```
```
XXX.minecraft.nbt.DoubleTag +1M -1M | +1P -1P
```
```
XXX.minecraft.nbt.EndTag +1M -1M | +1P -1P
```
```
XXX.minecraft.nbt.FloatTag +1M -1M | +1P -1P
```
```
XXX.minecraft.nbt.IntArrayTag +1M -1M | +1P -1P
```
```
XXX.minecraft.nbt.IntTag +1M -1M | +1P -1P
```
```
XXX.minecraft.nbt.LongArrayTag +1M -1M | +1P -1P
```
```
XXX.minecraft.nbt.LongTag +1M -1M | +1P -1P
```
```
XXX.minecraft.nbt.NbtAccounter$1 +1M -1M
```
```
XXX.minecraft.nbt.StringTag +1M -1M | +1P -1P
```
```
XXX.protocol.game.ClientboundSoundEntityPacket +3M -2M | +1P -1P
```
```
...
- Holder getSound()
+ SoundEvent getSound()
- void <init>(Holder,SoundSource,Entity,float,float,long)
...
```diff
- void playSeededSound(Player,Entity,Holder,SoundSource,float,float,long)
+ void playSeededSound(Player,Entity,SoundEvent,SoundSource,float,float,long)
```
