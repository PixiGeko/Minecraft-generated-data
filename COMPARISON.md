## Comparison with [1.20.2-pre2](https://github.com/PixiGeko/Minecraft-generated-data/tree/1.20.2-pre2)
...
<table><tr><th></th><th align="left">1.20.2-pre2</th><th>1.20.2-pre3</th></tr><tr><td>World version</td><td><code>3573</code></td><td><code>3574</code></td></tr><tr><td>Protocol version</td><td><code>1073741973</code></td><td><code>1073741974</code></td></tr></table>
</details>
...
```
XXX.minecraft.nbt.CompoundTag +1M -3M
```
```
XXX.minecraft.nbt.DoubleTag$1 +4M -3M
```
```
XXX.minecraft.nbt.EndTag$1 +5M -5M
```
```
XXX.minecraft.nbt.FloatTag$1 +4M -3M
```
```
XXX.minecraft.nbt.IntArrayTag$1 +5M -4M
```
```
XXX.minecraft.nbt.IntTag$1 +4M -3M
```
```
XXX.minecraft.nbt.LongArrayTag$1 +5M -4M
```
```
XXX.minecraft.nbt.LongTag$1 +4M -3M
```
```
XXX.minecraft.nbt.NbtAccounter +6M -2M | +3P -1P
```
```
XXX.minecraft.nbt.NbtIo +5M -5M
```
```
XXX.minecraft.nbt.StringTag$1 +5M -4M
```
```
XXX.minecraft.nbt.TagType +1M -1M | +4P -4P
```
```
XXX.minecraft.nbt.TagType$VariableSize +1M -1M
```
...
```
XXX.mojang.realmsclient.RealmsMainScreen$ButtonEntry -1P
```
```
XXX.realmsclient.gui.RealmsDataFetcher -1P
```
```
XXX.gui.screens.RealmsTermsScreen +1M -1M | -1P
```
```
XXX.util.task.GetServerDetailsTask +1M -1M | -2P
```
```
XXX.util.task.OpenServerTask +1M -1M | -1P
```
```
XXX.renderer.texture.TextureAtlas +1P
```
```
XXX.minecraft.nbt.CompoundTag +1M -3M
```
