## Comparison with [1.19.1-rc1](https://github.com/PixiGeko/Minecraft-generated-data/tree/1.19.1-rc1)
...
<table><tr><th></th><th align="left">1.19.1-rc1</th><th>1.19.1-pre2</th></tr><tr><td>World version</td><td><code>3109</code></td><td><code>3110</code></td></tr><tr><td>Protocol version</td><td><code>1073741918</code></td><td><code>1073741919</code></td></tr></table>
</details>
...
```
XXX.network.chat.ChatSender +2M -1M | +1P -1P
```
```
XXX.server.players.PlayerList +2M -2M
```
```
...
```diff
- void broadcastSystemMessage(Component,boolean)
- void broadcastSystemMessage(Component,Function,boolean)
...
```
XXX.minecraft.client.Minecraft +2M | +2P
```
```
XXX.minecraft.client.NarratorStatus +2M -1M
```
```
...
```
```
XXX.screens.reporting.ChatSelectionScreen$ChatSelectionList$MessageEntry +2M -1M | +3P
```
```
XXX.screens.reporting.ReportReasonSelectionScreen$ReasonSelectionList +3M
```
```
XXX.network.chat.Component +2M
```
```
XXX.protocol.game.ClientboundPlayerChatPacket -3M | -1P
```
```
XXX.protocol.game.ClientboundSystemChatPacket +2M -3M | +1P -1P
```
```
XXX.protocol.login.ServerboundHelloPacket +2M -1M | +1P
```
...
- boolean shouldNarrateChat()
- boolean shouldNarrateSystem()
```
...
```diff
+ void <init>(ChatSelectionScreen$ChatSelectionList,int,Component,Component,boolean,boolean)
- void <init>(ChatSelectionScreen$ChatSelectionList,int,Component,Component,GuiMessageTag,boolean,boolean)
- void renderTag(PoseStack,int,int,int,int,int)
```
...
- void setSelected(ReportReasonSelectionScreen$ReasonSelectionList$Entry)
```
...
```diff
- Optional profileId()
- void <init>(String,Optional,Optional)
