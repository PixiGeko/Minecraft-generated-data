## Comparison with [23w40a](https://github.com/PixiGeko/Minecraft-generated-data/tree/23w40a)
...
<table><tr><th></th><th align="left">23w40a</th><th>23w41a</th></tr><tr><td>DataPack version</td><td><code>19</code></td><td><code>20</code></td></tr><tr><td>World version</td><td><code>3679</code></td><td><code>3681</code></td></tr><tr><td>Protocol version</td><td><code>1073741978</code></td><td><code>1073741980</code></td></tr></table>
</details>
...
```diff
+ execute if function <name: function>
+ execute unless function <name: function>
```
...
+ mco.snapshot.friendsRealm.upgrade: %s needs to upgrade their Realm before you can play from this Snapshot
...
```
mco.selectServer.create: Create rRealm
mco.selectServer.leave: Leave rRealm
...
```diff
+ minecraft/particles/dust_plume.json
```
...
```
```
XXX.minecraft.server.ServerFunctionManager +3M -3M | -2P
```
```
XXX.server.commands.DebugCommand +2M -6M | +1P
```
```
XXX.server.commands.ExecuteCommand +65M -60M | +1P
```
```
XXX.server.commands.ReturnCommand +1M -3M
```
```
XXX.server.commands.ScheduleCommand +1M -1M
```
```
XXX.minecraft.sounds.SoundEvents +3P
```
```
XXX.minecraft.world.Containers +1M
```
```
XXX.entity.item.ItemEntity +2M -1M | +1P
```
```
XXX.entity.monster.Shulker -1M
```
```
XXX.entity.projectile.ProjectileUtil +1M -1M | +1P
```
```
XXX.entity.projectile.WitherSkull +2M
```
```
XXX.entity.vehicle.AbstractMinecart +1M -9M | -4P
```
```
XXX.entity.vehicle.Boat -8M | -3P
```
```
XXX.block.entity.HangingSignBlockEntity +1M
```
```
XXX.block.entity.SignBlockEntity +1M -1M
```
```
...
+ int execute(CommandFunction,CommandSourceStack)
+ int getCommandLimit()
- String lambda$execute$0(CommandFunction)
- void execute(CommandFunction,CommandSourceStack)
- void lambda$execute$1(InstantiatedFunction,CommandSourceStack,ExecutionContext)
```
...
+ int traceFunction(CommandSourceStack,Collection)
```
...
+ ArgumentBuilder lambda$wrapStores$35(LiteralCommandNode,DataCommands$DataProvider,boolean,ArgumentBuilder)
- ArgumentBuilder lambda$wrapStores$36(LiteralCommandNode,DataCommands$DataProvider,boolean,ArgumentBuilder)
...
+ boolean lambda$addConditionals$48(Integer,Integer)
+ boolean lambda$addConditionals$49(CommandContext)
- boolean lambda$addConditionals$49(Integer,Integer)
- boolean lambda$addConditionals$50(CommandContext)
+ boolean lambda$addConditionals$50(Integer,Integer)
+ boolean lambda$addConditionals$51(CommandContext)
- boolean lambda$addConditionals$51(Integer,Integer)
- boolean lambda$addConditionals$53(CommandContext)
+ boolean lambda$addConditionals$55(CommandContext)
...
+ Collection lambda$addConditionals$53(boolean,CommandContext)
- Collection lambda$addConditionals$54(boolean,CommandContext)
...
- Collection lambda$register$15(CommandContext)
+ Collection lambda$register$7(CommandContext)
- Collection lambda$register$9(CommandContext)
- CommandResultConsumer lambda$static$4(CommandResultConsumer,CommandResultConsumer)
...
+ CommandSourceStack lambda$register$15(CommandContext)
- CommandSourceStack lambda$register$20(CommandContext)
+ CommandSourceStack lambda$register$9(CommandContext)
+ CommandSourceStack lambda$wrapStores$20(boolean,CommandContext)
- CommandSourceStack lambda$wrapStores$23(boolean,CommandContext)
+ CommandSourceStack lambda$wrapStores$24(DataCommands$DataProvider,boolean,CommandContext)
- CommandSourceStack lambda$wrapStores$25(DataCommands$DataProvider,boolean,CommandContext)
+ CommandSourceStack lambda$wrapStores$26(DataCommands$DataProvider,boolean,CommandContext)
- CommandSourceStack lambda$wrapStores$27(DataCommands$DataProvider,boolean,CommandContext)
+ CommandSourceStack lambda$wrapStores$28(DataCommands$DataProvider,boolean,CommandContext)
- CommandSourceStack lambda$wrapStores$29(DataCommands$DataProvider,boolean,CommandContext)
+ CommandSourceStack lambda$wrapStores$30(DataCommands$DataProvider,boolean,CommandContext)
- CommandSourceStack lambda$wrapStores$31(DataCommands$DataProvider,boolean,CommandContext)
+ CommandSourceStack lambda$wrapStores$32(DataCommands$DataProvider,boolean,CommandContext)
- CommandSourceStack lambda$wrapStores$33(DataCommands$DataProvider,boolean,CommandContext)
+ CommandSourceStack lambda$wrapStores$34(DataCommands$DataProvider,boolean,CommandContext)
- CommandSourceStack lambda$wrapStores$35(DataCommands$DataProvider,boolean,CommandContext)
...
- ExecutionCommandSource prepareCallback(Function,IntPredicate,List,ExecutionCommandSource,boolean)
...
- int lambda$addConditionals$55(CommandContext)
...
+ ResultConsumer lambda$static$3(ResultConsumer,ResultConsumer)
...
- Tag lambda$wrapStores$24(CommandContext,int)
+ Tag lambda$wrapStores$25(CommandContext,int)
- Tag lambda$wrapStores$26(CommandContext,int)
+ Tag lambda$wrapStores$27(CommandContext,int)
- Tag lambda$wrapStores$28(CommandContext,int)
+ Tag lambda$wrapStores$29(CommandContext,int)
- Tag lambda$wrapStores$30(CommandContext,int)
+ Tag lambda$wrapStores$31(CommandContext,int)
- Tag lambda$wrapStores$32(CommandContext,int)
+ Tag lambda$wrapStores$33(CommandContext,int)
- Tag lambda$wrapStores$34(CommandContext,int)
- void lambda$prepareCallback$85(IntPredicate,List,ExecutionCommandSource,int)
- void lambda$prepareCallback$86(MutableBoolean,IntPredicate,List,ExecutionCommandSource,int)
+ void lambda$static$2(ResultConsumer,ResultConsumer,CommandContext,boolean,int)
- void lambda$static$3(CommandResultConsumer,CommandResultConsumer,CommandSourceStack,boolean,int)
+ void lambda$storeData$38(DataAccessor,boolean,NbtPathArgument$NbtPath,IntFunction,CommandContext,boolean,int)
- void lambda$storeData$39(DataAccessor,boolean,NbtPathArgument$NbtPath,IntFunction,CommandSourceStack,boolean,int)
+ void lambda$storeValue$36(Collection,Scoreboard,Objective,boolean,CommandContext,boolean,int)
+ void lambda$storeValue$37(boolean,boolean,CustomBossEvent,CommandContext,boolean,int)
- void lambda$storeValue$37(Collection,Scoreboard,Objective,boolean,CommandSourceStack,boolean,int)
- void lambda$storeValue$38(boolean,boolean,CustomBossEvent,CommandSourceStack,boolean,int)
- void scheduleFunctionConditionsAndTest(List,Function,IntPredicate,ContextChain,CompoundTag,ExecutionControl,ExecuteCommand$CommandGetter,boolean)
```
...
+ int setReturn(CommandSourceStack,int)
```
...
```diff
- void dropContentsOnDestroy(BlockState,BlockState,Level,BlockPos)
```
...
```diff
- void restoreFrom(Entity)
- void setThrower(Entity)
...
```diff
- HitResult getHitResult(Vec3,Entity,Predicate,Vec3,Level,float)
...
```diff
+ AbstractMinecart createMinecart(Level,double,double,double,AbstractMinecart$Type)
- AbstractMinecart createMinecart(ServerLevel,double,double,double,AbstractMinecart$Type,ItemStack,Player)
...
```diff
- SoundEvent getSignInteractionFailedSoundEvent()
```
...
```diff
+ SignText getTextFacingPlayer(Player)
- SoundEvent getSignInteractionFailedSoundEvent()
```
...
```
XXX.realmsclient.client.Request +1M -1M | +2P
```
```
XXX.gui.screens.RealmsResetWorldScreen +5M -6M | +1P
```
```
XXX.realmsclient.util.WorldGenerationInfo +2M -1M | +1P
```
```
XXX.minecraft.commands.Commands +15M -12M
```
```
XXX.world.item.BoatItem +1M -1M
```
```
XXX.world.item.BrushItem +1M -2M | -1P
```
...
- void addSnapshotHeader(boolean)
```
...
```diff
+ RealmsResetWorldScreen forNewRealm(Screen,RealmsServer,Runnable)
...
+ void lambda$generationSelectionCallback$10(WorldGenerationInfo)
- void lambda$runResetTasks$8()
+ void lambda$switchSlot$8(Runnable)
- void lambda$switchSlot$9(Runnable)
+ void lambda$templateSelectionCallback$9(WorldTemplate)
+ void resetWorld(Runnable)
- void runResetTasks(LongRunningTask)
...
```diff
- Set experiments()
- void <init>(String,LevelType,boolean,Set)
+ void <init>(String,LevelType,boolean)
```
...
+ int performCommand(ParseResults,String)
+ int performPrefixedCommand(CommandSourceStack,String)
- String lambda$performCommand$0(String)
...
- void executeCommandInContext(CommandSourceStack,Consumer)
...
- void performCommand(ParseResults,String)
- void performPrefixedCommand(CommandSourceStack,String)
- void validateParseResults(ParseResults)
```
...
```diff
- Boat getBoat(Level,HitResult,ItemStack,Player)
+ Boat getBoat(Level,HitResult)
```
...
```diff
+ HitResult calculateHitResult(LivingEntity)
- HitResult calculateHitResult(Player)
+ void <clinit>()
```
