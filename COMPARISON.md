## Comparison with [21w17a](https://github.com/PixiGeko/Minecraft-generated-data/tree/21w17a)
...
<table><tr><th></th><th align="left">21w17a</th><th>21w18a</th></tr><tr><td>World version</td><td><code>2712</code></td><td><code>2713</code></td></tr><tr><td>Protocol version</td><td><code>1073741849</code></td><td><code>1073741850</code></td></tr></table>
</details>
...
```diff
+ minecraft/models/item/amethyst_bud.json
```
...
```
```
XXX.ai.behavior.PrepareRamNearestTarget +1M -1M | +1P -1P
```
```
XXX.ai.behavior.RamTarget +1M -1M | +4P -4P
```
```
XXX.entity.animal.Pufferfish +3M -2M | +2P -1P
```
```
XXX.animal.goat.Goat +1M -1M
```
```
XXX.animal.goat.GoatAi +5M -3M | +1P
```
```
XXX.block.state.BlockBehaviour +1M
```
```
XXX.level.levelgen.OreVeinifier +1M -1M | +3P
```
...
```diff
+ CrashReport fillReport(CrashReport)
...
```diff
+ void <init>(int,int,int,float,TargetingConditions,int,Function)
- void <init>(ToIntFunction,int,int,float,TargetingConditions,int,Function)
```
...
```diff
- void <init>(Function,TargetingConditions,ToIntFunction,float,ToDoubleFunction,Function)
+ void <init>(UniformInt,TargetingConditions,Function,float,Function,Function)
```
...
```diff
- boolean lambda$aiStep$1(Mob)
- int access$002(Pufferfish,int)
+ int access$202(Pufferfish,int)
+ Predicate access$000()
...
```diff
- double lambda$initRamActivity$5(Goat)
+ Float lambda$initRamActivity$4(Goat)
- int lambda$initRamActivity$4(Goat)
- int lambda$initRamActivity$7(Goat)
+ Integer lambda$initRamActivity$3(Goat)
+ SoundEvent lambda$initRamActivity$5(Goat)
- SoundEvent lambda$initRamActivity$8(Goat)
- UniformInt lambda$initRamActivity$3(Goat)
```
...
```diff
- OreVeinifier$VeinType getVeinType(double,int)
+ OreVeinifier$VeinType getVeinType(double)
```
...
- net.minecraft.client.profiling.ActiveClientMetricsLogger$1
+ net.minecraft.client.profiling.ClientMetricsLogger
- net.minecraft.client.profiling.InactiveClientMetricsLogger
...
```
```
XXX.minecraft.client.Minecraft +12M -10M | +1P
```
...
```diff
- boolean isOutsideBounds(int,int)
```
...
- CompletionStage lambda$delayTextureReload$39(CompletableFuture)
+ PackResources lambda$adaptV3$42(Supplier)
- PackResources lambda$adaptV3$43(Supplier)
+ PackResources lambda$adaptV4$43(Supplier)
- PackResources lambda$adaptV4$44(Supplier)
+ String lambda$fillReport$33()
- String lambda$fillReport$33(Minecraft)
- String lambda$fillReport$36()
+ String lambda$fillReport$36(Options)
+ String lambda$fillReport$37(LanguageManager)
- String lambda$fillReport$37(Options)
- String lambda$fillReport$38(LanguageManager)
+ Style lambda$grabHugeScreenshot$41(File,Style)
- Style lambda$grabHugeScreenshot$42(File,Style)
+ Style lambda$grabPanoramixScreenshot$40(File,Style)
- Style lambda$grabPanoramixScreenshot$41(File,Style)
+ void fillReport(LanguageManager,String,Options,CrashReport)
- void fillReport(Minecraft,LanguageManager,String,Options,CrashReport)
+ void lambda$grabPanoramixScreenshot$39(Component)
- void lambda$grabPanoramixScreenshot$40(Component)
```
