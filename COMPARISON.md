## Comparison with [24w06a](https://github.com/PixiGeko/Minecraft-generated-data/tree/24w06a)
...
<table><tr><th></th><th align="left">24w06a</th><th>24w07a</th></tr><tr><td>DataPack version</td><td><code>31</code></td><td><code>32</code></td></tr><tr><td>World version</td><td><code>3815</code></td><td><code>3817</code></td></tr><tr><td>Protocol version</td><td><code>1073742000</code></td><td><code>1073742001</code></td></tr></table>
</details>
...
+ minecraft/textures/entity/skeleton/bogged.png
```
...
```
XXX.minecraft.core.HolderLookup$RegistryLookup$Delegate -1M
```
```
XXX.minecraft.core.RegistrySetBuilder$2 +1M -3M
```
```
XXX.gametest.framework.TestCommand +10M -8M
```
```
XXX.gametest.framework.TestFunction +2M -1M | +1P
```
```
XXX.minecraft.resources.RegistryOps$RegistryInfo +1M
```
```
XXX.entity.monster.Strider$StriderPathNavigation +1M -1M
```
```
XXX.world.item.EnderEyeItem +1M
```
```
XXX.world.item.Items +1P
```
```
XXX.level.block.HopperBlock +1P
```
```
XXX.block.entity.Hopper +1P -1P
```
```
XXX.level.pathfinder.WalkNodeEvaluator$1 +1P -1P
```
...
+ Optional get(TagKey)
+ Stream listTags()
- void <init>(HolderOwner,ResourceKey,Lifecycle,Map)
+ void <init>(ResourceKey,Lifecycle,Map)
```
...
- boolean lambda$say$36(ServerPlayer)
+ boolean lambda$toGameTestInfo$29(CommandSourceStack,TestFunction)
- boolean lambda$toGameTestInfo$30(CommandSourceStack,TestFunction)
+ Component lambda$say$33(String)
- Component lambda$say$35(String)
+ Component lambda$showPos$31(String,Component)
- Component lambda$showPos$33(String,Component)
+ GameTestInfo lambda$toGameTestInfo$30(int,CommandSourceStack,RetryOptions,TestFunction)
- GameTestInfo lambda$toGameTestInfo$31(int,CommandSourceStack,RetryOptions,TestFunction)
+ Optional lambda$toGameTestInfos$28(CommandSourceStack,RetryOptions,BlockPos)
- Optional lambda$toGameTestInfos$29(CommandSourceStack,RetryOptions,BlockPos)
- void lambda$createNewStructure$32(ServerLevel,BlockPos)
- void lambda$resetGameTestInfo$28(Entity)
+ void lambda$say$35(String,ChatFormatting,ServerPlayer)
- void lambda$say$37(String,ChatFormatting,ServerPlayer)
+ void lambda$trackAndStartRunner$32(GameTestInfo)
- void lambda$trackAndStartRunner$34(GameTestInfo)
```
...
```diff
- boolean skyAccess()
- void <init>(String,String,String,Rotation,int,long,boolean,int,int,boolean,Consumer)
...
```diff
- RegistryOps$RegistryInfo fromRegistryLookup(HolderLookup$RegistryLookup)
```
...
```diff
+ boolean hasValidPathType(BlockPathTypes)
- boolean hasValidPathType(PathType)
```
...
- net.minecraft.commands.arguments.item.ItemPredicateParser
+ net.minecraft.commands.arguments.item.ItemPredicateParser$1
- net.minecraft.commands.arguments.item.ItemSyntaxParser
+ net.minecraft.commands.arguments.item.ItemSyntaxParser$State
- net.minecraft.commands.arguments.item.ItemSyntaxParser$SuggestionsVisitor
...
```
XXX.minecraft.core.RegistrySetBuilder +16M -15M
```
```
XXX.world.entity.EntityType +1P
```
```
XXX.ai.navigation.PathNavigation +1M -1M
```
```
XXX.animal.frog.Frog$FrogPathNavigation +1M -1M
```
```
XXX.level.pathfinder.Node +1P -1P
```
...
```diff
+ boolean lambda$buildPatch$11(Set,ResourceKey)
- boolean lambda$buildPatch$12(Set,ResourceKey)
+ Holder$Reference lambda$createLazyFullPatchedRegistries$7(HolderOwner,ResourceKey,Cloner,Holder$Reference,HolderLookup$Provider,MutableObject,ResourceKey)
- Holder$Reference lambda$createLazyFullPatchedRegistries$8(HolderOwner,ResourceKey,Cloner,Holder$Reference,HolderLookup$Provider,MutableObject,ResourceKey)
+ HolderLookup$Provider buildProviderWithContext(RegistryAccess,Stream)
- HolderLookup$Provider buildProviderWithContext(RegistrySetBuilder$UniversalOwner,RegistryAccess,Stream)
+ HolderLookup$RegistryLookup lambda$build$2(RegistrySetBuilder$BuildState,RegistrySetBuilder$RegistryStub)
- HolderLookup$RegistryLookup lambda$build$3(RegistrySetBuilder$BuildState,RegistrySetBuilder$RegistryStub)
+ HolderLookup$RegistryLookup lambda$buildPatch$13(RegistrySetBuilder$BuildState,RegistrySetBuilder$RegistryContents)
- HolderLookup$RegistryLookup lambda$buildPatch$14(RegistrySetBuilder$BuildState,RegistrySetBuilder$RegistryContents)
+ HolderLookup$RegistryLookup lambda$buildProviderWithContext$1(RegistryAccess$RegistryEntry)
+ HolderLookup$RegistryLookup lambda$createLazyFullPatchedRegistries$3(RegistrySetBuilder$CompositeOwner,Cloner$Factory,HolderLookup$Provider,HolderLookup$Provider,MutableObject,ResourceKey)
- HolderLookup$RegistryLookup lambda$createLazyFullPatchedRegistries$4(RegistrySetBuilder$UniversalOwner,Cloner$Factory,HolderLookup$Provider,HolderLookup$Provider,MutableObject,ResourceKey)
- HolderLookup$RegistryLookup lookupFromMap(ResourceKey,Lifecycle,HolderOwner,Map)
+ HolderLookup$RegistryLookup lookupFromMap(ResourceKey,Lifecycle,Map)
+ Object lambda$createLazyFullPatchedRegistries$4(Cloner,Holder$Reference,HolderLookup$Provider,MutableObject)
- Object lambda$createLazyFullPatchedRegistries$5(Cloner,Holder$Reference,HolderLookup$Provider,MutableObject)
+ Object lambda$createLazyFullPatchedRegistries$6(Cloner,Holder$Reference,HolderLookup$Provider,MutableObject)
- Object lambda$createLazyFullPatchedRegistries$7(Cloner,Holder$Reference,HolderLookup$Provider,MutableObject)
- RegistrySetBuilder$RegistryContents lambda$buildPatch$10(RegistrySetBuilder$BuildState,RegistrySetBuilder$RegistryStub)
+ RegistrySetBuilder$RegistryContents lambda$buildPatch$9(RegistrySetBuilder$BuildState,RegistrySetBuilder$RegistryStub)
+ void lambda$buildPatch$10(Map,RegistrySetBuilder$RegistryContents)
- void lambda$buildPatch$11(Map,RegistrySetBuilder$RegistryContents)
+ void lambda$buildPatch$12(Map,ResourceKey)
- void lambda$buildPatch$13(Map,ResourceKey)
- void lambda$buildProviderWithContext$1(Map,RegistryAccess$RegistryEntry)
- void lambda$buildProviderWithContext$2(Map,RegistrySetBuilder$UniversalOwner,HolderLookup$RegistryLookup)
+ void lambda$createLazyFullPatchedRegistries$5(HolderOwner,Cloner,HolderLookup$Provider,MutableObject,Map,Holder$Reference)
- void lambda$createLazyFullPatchedRegistries$6(HolderOwner,Cloner,HolderLookup$Provider,MutableObject,Map,Holder$Reference)
+ void lambda$createLazyFullPatchedRegistries$8(Map,HolderOwner,Cloner,HolderLookup$Provider,MutableObject,Holder$Reference)
- void lambda$createLazyFullPatchedRegistries$9(Map,HolderOwner,Cloner,HolderLookup$Provider,MutableObject,Holder$Reference)
```
