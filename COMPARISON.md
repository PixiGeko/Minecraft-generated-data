## Comparison with [1.20.3-pre2](https://github.com/PixiGeko/Minecraft-generated-data/tree/1.20.3-pre2)
...
<table><tr><th></th><th align="left">1.20.3-pre2</th><th>1.20.3-pre3</th></tr><tr><td>World version</td><td><code>3694</code></td><td><code>3695</code></td></tr><tr><td>Protocol version</td><td><code>1073741989</code></td><td><code>1073741990</code></td></tr></table>
</details>
...
```
commands.tick.query.rate.sprinting: Target tick rate: %s per second (ingnored, reference only).\nAverage time per tick: %sms
```
...
```
XXX.network.chat.PlayerChatMessage +1M
```
```
XXX.network.chat.SignedMessageValidator +1M -2M | +1P -1P
```
```
XXX.protocol.common.ServerboundResourcePackPacket$Action +1M | +1P
```
```
XXX.server.packs.DownloadQueue +1P
```
```
XXX.minecraft.util.HttpUtil +1M
```
```
XXX.structure.pools.JigsawPlacement +5M -4M
```
...
```diff
- PlayerChatMessage removeSignature()
```
...
- PlayerChatMessage lambda$static$0(PlayerChatMessage)
```
...
```diff
- void updateModificationTime(Path)
```
...
- Optional lambda$addPieces$0(Registry,PoolAliasLookup,ResourceKey)
+ String lambda$addPieces$0(ResourceKey)
- String lambda$addPieces$1(ResourceKey)
+ String lambda$getRandomNamedJigsaw$2(StructureTemplate$StructureBlockInfo)
- String lambda$getRandomNamedJigsaw$3(StructureTemplate$StructureBlockInfo)
+ void lambda$addPieces$1(PoolElementStructurePiece,int,int,int,int,int,BoundingBox,Structure$GenerationContext,boolean,ChunkGenerator,StructureTemplateManager,LevelHeightAccessor,WorldgenRandom,Registry,PoolAliasLookup,StructurePiecesBuilder)
...
```
XXX.util.task.GetServerDetailsTask +4M -3M | -1P
```
```
XXX.minecraft.client.Minecraft +62M -59M | +1P
```
```
XXX.client.multiplayer.ClientCommonPacketListenerImpl +6M -4M
```
```
XXX.client.particle.ItemPickupParticle +2M | +6P
```
```
XXX.resources.server.DownloadedPackSource +1M -5M | +1P
```
```
XXX.resources.server.DownloadedPackSource$2 +3M -4M | -6P
```
```
XXX.resources.server.DownloadedPackSource$4 +3M | +7P -2P
```
```
XXX.resources.server.PackLoadFeedback +2P -1P
```
...
```diff
- CompletableFuture scheduleResourcePackDownload(RealmsServerAddress,UUID)
...
- RealmsLongConfirmationScreen resourcePackDownloadConfirmationScreen(RealmsServerAddress,UUID,Function)
- UUID generatePackId(RealmsServer)
+ void lambda$resourcePackDownloadConfirmationScreen$2(RealmsServerAddress,Function,boolean)
- void lambda$resourcePackDownloadConfirmationScreen$2(RealmsServerAddress,UUID,Function,boolean)
```
...
```diff
- boolean canValidateProfileKeys()
...
- boolean lambda$createSearchTrees$22(String)
+ boolean lambda$tick$46()
- boolean lambda$tick$47()
+ ChunkProgressListener lambda$doWorldLoad$47(int)
- ChunkProgressListener lambda$doWorldLoad$48(int)
+ CompletionStage lambda$delayTextureReload$63(CompletableFuture)
- CompletionStage lambda$delayTextureReload$64(CompletableFuture)
+ CrashReport lambda$delayCrash$27(CrashReport)
- CrashReport lambda$delayCrash$28(CrashReport)
+ CrashReport lambda$delayCrashRaw$28(CrashReport)
- CrashReport lambda$delayCrashRaw$29(CrashReport)
+ IntegratedServer lambda$doWorldLoad$48(LevelStorageSource$LevelStorageAccess,PackRepository,WorldStem,Services,Thread)
- IntegratedServer lambda$doWorldLoad$49(LevelStorageSource$LevelStorageAccess,PackRepository,WorldStem,Services,Thread)
...
- RefreshableSearchTree lambda$createSearchTrees$26(List)
+ ResourceLocation lambda$createSearchTrees$23(RecipeCollection,RecipeHolder)
- ResourceLocation lambda$createSearchTrees$24(RecipeCollection,RecipeHolder)
- Screen lambda$addInitialScreens$10(BanDetails,Runnable)
+ Screen lambda$addInitialScreens$10(GameProfile,Runnable)
- Screen lambda$addInitialScreens$11(GameProfile,Runnable)
+ Screen lambda$addInitialScreens$7(Runnable)
- Screen lambda$addInitialScreens$8(Runnable)
+ Screen lambda$addInitialScreens$9(BanDetails,Runnable)
+ Stream lambda$createSearchTrees$14(ItemStack)
- Stream lambda$createSearchTrees$16(ItemStack)
+ Stream lambda$createSearchTrees$17(ItemStack)
- Stream lambda$createSearchTrees$18(ItemStack)
+ Stream lambda$createSearchTrees$19(RecipeCollection,RecipeHolder)
- Stream lambda$createSearchTrees$20(RecipeCollection,RecipeHolder)
+ Stream lambda$createSearchTrees$22(RecipeCollection)
- Stream lambda$createSearchTrees$23(RecipeCollection)
+ Stream lambda$createSearchTrees$24(RecipeCollection)
- Stream lambda$createSearchTrees$25(RecipeCollection)
...
- String lambda$createSearchTrees$21(Component)
+ String lambda$doWorldLoad$49(WorldStem)
- String lambda$doWorldLoad$50(WorldStem)
+ String lambda$fillSystemReport$55(String)
+ String lambda$fillSystemReport$56(Minecraft)
- String lambda$fillSystemReport$56(String)
+ String lambda$fillSystemReport$57()
- String lambda$fillSystemReport$57(Minecraft)
- String lambda$fillSystemReport$60()
+ String lambda$fillSystemReport$60(Minecraft)
- String lambda$fillSystemReport$61(Minecraft)
+ String lambda$fillSystemReport$61(Options)
+ String lambda$fillSystemReport$62(LanguageManager)
- String lambda$fillSystemReport$62(Options)
- String lambda$fillSystemReport$63(LanguageManager)
+ String lambda$fillUptime$51()
- String lambda$fillUptime$55()
+ Style lambda$debugClientMetricsStart$37(Path,Style)
- Style lambda$debugClientMetricsStart$38(Path,Style)
+ Style lambda$grabHugeScreenshot$66(File,Style)
- Style lambda$grabHugeScreenshot$67(File,Style)
+ Style lambda$grabPanoramixScreenshot$65(File,Style)
- Style lambda$grabPanoramixScreenshot$66(File,Style)
- UserApiService$UserProperties lambda$new$2()
- UserApiService$UserProperties userProperties()
+ void lambda$addInitialScreens$8(Runnable,boolean)
- void lambda$addInitialScreens$9(Runnable,boolean)
+ void lambda$buildInitialScreens$5(Minecraft$GameLoadCookie)
- void lambda$buildInitialScreens$6(Minecraft$GameLoadCookie)
+ void lambda$buildInitialScreens$6(Screen)
- void lambda$buildInitialScreens$7(Screen)
+ void lambda$clearResourcePacksOnError$11(Component)
- void lambda$clearResourcePacksOnError$12(Component)
+ void lambda$createSearchTrees$26(List)
- void lambda$createSearchTrees$27(List)
+ void lambda$debugClientMetricsStart$35(Consumer,double,int)
- void lambda$debugClientMetricsStart$36(Consumer,double,int)
...
- void lambda$debugClientMetricsStart$39(Consumer,Component)
+ void lambda$debugClientMetricsStart$39(Consumer,Path)
- void lambda$debugClientMetricsStart$40(Consumer,Path)
+ void lambda$debugClientMetricsStart$40(SystemReport,Consumer,List)
+ void lambda$debugClientMetricsStart$41(Consumer,Path)
- void lambda$debugClientMetricsStart$41(SystemReport,Consumer,List)
+ void lambda$debugClientMetricsStart$42(Consumer,CompletableFuture,CompletableFuture)
- void lambda$debugClientMetricsStart$42(Consumer,Path)
- void lambda$debugClientMetricsStart$43(Consumer,CompletableFuture,CompletableFuture)
...
- void lambda$debugClientMetricsStart$45(Consumer,ProfileResults)
+ void lambda$doWorldLoad$50(Component)
- void lambda$doWorldLoad$51(Component)
+ void lambda$grabPanoramixScreenshot$64(Component)
- void lambda$grabPanoramixScreenshot$65(Component)
...
- void lambda$openChatScreen$33(boolean)
+ void lambda$reloadResourcePacks$29(boolean,Minecraft$GameLoadCookie,Throwable)
- void lambda$reloadResourcePacks$30(boolean,Minecraft$GameLoadCookie,Throwable)
...
- void lambda$reloadResourcePacks$31(CompletableFuture,Minecraft$GameLoadCookie)
- void lambda$reloadResourcePacks$32(boolean,Minecraft$GameLoadCookie,CompletableFuture,Optional)
+ void lambda$runTick$33(CompletableFuture)
- void lambda$runTick$34(CompletableFuture)
+ void lambda$runTick$34(TimerQuery)
- void lambda$runTick$35(TimerQuery)
+ void lambda$tick$45()
- void lambda$tick$46()
```
...
```diff
- IllegalStateException lambda$updateTagsForRegistry$3(ResourceKey)
+ IllegalStateException lambda$updateTagsForRegistry$4(ResourceKey)
- Screen addOrUpdatePackPrompt(UUID,URL,String,boolean,Component)
+ Screen lambda$createDisconnectScreen$5()
- Screen lambda$createDisconnectScreen$6()
- String lambda$fillListenerSpecificCrashDetails$4()
- String lambda$fillListenerSpecificCrashDetails$5()
- void fillListenerSpecificCrashDetails(CrashReportCategory)
+ void lambda$showServerPackPrompt$3(Screen,UUID,URL,String,boolean,boolean)
+ void showServerPackPrompt(UUID,URL,String,boolean,Component)
```
...
```diff
+ void lambda$createPackResponseSender$4(Connection,UUID,PackLoadFeedback$Result)
- void lambda$createRepositorySource$1(Consumer)
+ void lambda$createRepositorySource$3(Consumer)
+ void lambda$new$2(UUID,PackLoadFeedback$Result)
+ void lambda$static$1(UUID,PackLoadFeedback$Result)
+ void lambda$waitForPackFeedback$5(UUID,PackLoadFeedback,CompletableFuture,UUID,PackLoadFeedback$Result)
```
...
```diff
+ Map createDownloadHeaders()
+ void <clinit>()
+ void <init>(DownloadedPackSource,User,DownloadQueue,Proxy,Executor)
- void <init>(DownloadedPackSource)
+ void download(Map,Consumer)
- void reportFinalResult(UUID,PackLoadFeedback$FinalResult)
- void reportUpdate(UUID,PackLoadFeedback$Update)
```
