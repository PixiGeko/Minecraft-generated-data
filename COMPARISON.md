## Comparison with [1.21-pre1](https://github.com/PixiGeko/Minecraft-generated-data/tree/1.21-pre1)
...
<table><tr><th></th><th align="left">1.21-pre1</th><th>1.21-pre2</th></tr><tr><td>DataPack version</td><td><code>46</code></td><td><code>47</code></td></tr><tr><td>World version</td><td><code>3948</code></td><td><code>3949</code></td></tr><tr><td>Protocol version</td><td><code>1073742023</code></td><td><code>1073742024</code></td></tr></table>
</details>
...
<table><tr><th colspan="3">flow_banner_pattern.json</th></tr><tr><th></th><th align="left">1.21-pre1</th><th>1.21-pre2</th></tr><tr><td>minecraft:rarity</td><td><code>common</code></td><td><code>rare</code></td></tr></table>
<table><tr><th colspan="3">guster_banner_pattern.json</th></tr><tr><th></th><th align="left">1.21-pre1</th><th>1.21-pre2</th></tr><tr><td>minecraft:rarity</td><td><code>common</code></td><td><code>rare</code></td></tr></table>
<table><tr><th colspan="3">heavy_core.json</th></tr><tr><th></th><th align="left">1.21-pre1</th><th>1.21-pre2</th></tr><tr><td>minecraft:rarity</td><td><code>common</code></td><td><code>epic</code></td></tr></table>
<table><tr><th colspan="3">mace.json</th></tr><tr><th></th><th align="left">1.21-pre1</th><th>1.21-pre2</th></tr><tr><td>minecraft:rarity</td><td><code>common</code></td><td><code>epic</code></td></tr></table>
<table><tr><th colspan="3">piglin_banner_pattern.json</th></tr><tr><th></th><th align="left">1.21-pre1</th><th>1.21-pre2</th></tr><tr><td>minecraft:rarity</td><td><code>common</code></td><td><code>uncommon</code></td></tr></table>
<table><tr><th colspan="3">trident.json</th></tr><tr><th></th><th align="left">1.21-pre1</th><th>1.21-pre2</th></tr><tr><td>minecraft:rarity</td><td><code>common</code></td><td><code>epic</code></td></tr></table>
</details>
...
```diff
+ minecraft/tags/block/mob_interactable_doors.json
+ minecraft/worldgen/configured_feature/end_platform.json
+ minecraft/worldgen/placed_feature/end_platform.json
```
...
```
XXX.worldgen.features.EndFeatures +1P
```
```
XXX.worldgen.placement.EndPlacements +1P
```
```
...
```
```
XXX.enchantment.effects.SpawnParticlesEffect$PositionSource +1M -1M
```
```
XXX.enchantment.effects.SpawnParticlesEffect$PositionSourceType$CoordinateSource +1P -1P
```
```
XXX.level.block.EndGatewayBlock -2P
```
```
XXX.level.border.WorldBorder +4M
```
...
```diff
- double getCoordinate(double,double,float,RandomSource)
+ double getCoordinate(double,float,RandomSource)
```
...
```diff
- BlockPos clampToBounds(BlockPos)
- BlockPos clampToBounds(Vec3)
- boolean isWithinBounds(double,double,double,double)
- boolean isWithinBounds(Vec3)
```
...
+ net.minecraft.client.gui.screens.multiplayer.ServerLinksScreen$LinkList
- net.minecraft.client.gui.screens.multiplayer.ServerLinksScreen$LinkListEntry
...
```
net.minecraft.Util +15M -13M
```
```
XXX.gui.components.Checkbox$Builder +1M | +1P
```
```
XXX.gui.components.MultiLineLabel$1 +3M -4M
```
```
XXX.gui.screens.AccessibilityOnboardingScreen +1M -1M
```
...
- boolean lambda$allOf$9(Predicate[],Object)
+ boolean lambda$anyOf$10(List,Object)
- boolean lambda$anyOf$10(Object)
- boolean lambda$anyOf$12(Predicate[],Object)
+ boolean lambda$anyOf$9(Object)
+ boolean lambda$getVmArguments$11(String)
- boolean lambda$getVmArguments$13(String)
+ List lambda$fallibleSequence$16(List,Void)
- List lambda$fallibleSequence$18(List,Void)
+ List lambda$sequence$12(List,Void)
- List lambda$sequence$14(List,Void)
- Predicate[] lambda$allOf$8(int)
- Predicate[] lambda$anyOf$11(int)
+ String lambda$fixedSize$18(int)
+ String lambda$fixedSize$19(int)
- String lambda$fixedSize$21(int)
- String lambda$fixedSize$22(int)
+ String lambda$sanitizeName$21(CharPredicate,int)
- String lambda$sanitizeName$23(CharPredicate,int)
...
- void lambda$fallibleSequence$16(Consumer,List,int,Object,Throwable)
- void lambda$fallibleSequence$17(List,CompletableFuture[],Consumer,CompletableFuture)
+ void lambda$prefix$17(Consumer,String,String)
- void lambda$prefix$19(Consumer,String,String)
+ void lambda$sequenceFailFastAndCancel$13(CompletableFuture,List,Throwable)
- void lambda$sequenceFailFastAndCancel$15(CompletableFuture,List,Throwable)
```
...
```diff
+ int renderCentered(GuiGraphics,int,int,int,int)
+ int renderCentered(GuiGraphics,int,int)
+ int renderLeftAligned(GuiGraphics,int,int,int,int)
+ void renderBackgroundCentered(GuiGraphics,int,int,int,int,int)
- void renderCentered(GuiGraphics,int,int,int,int)
- void renderCentered(GuiGraphics,int,int)
- void renderLeftAligned(GuiGraphics,int,int,int,int)
```
