## Comparison with [1.20-pre5](https://github.com/PixiGeko/Minecraft-generated-data/tree/1.20-pre5)
...
<table><tr><th></th><th align="left">1.20-pre5</th><th>1.20-pre6</th></tr><tr><td>World version</td><td><code>3458</code></td><td><code>3460</code></td></tr><tr><td>Protocol version</td><td><code>1073741962</code></td><td><code>1073741963</code></td></tr></table>
</details>
...
```
```
XXX.level.storage.PrimaryLevelData +6M -7M | +1P -1P
```
...
```diff
- JsonElement getNonNull(JsonObject,String)
```
...
+ void <init>(DataFixer,int,CompoundTag,boolean,int,int,int,float,long,long,int,int,int,boolean,int,boolean,boolean,boolean,WorldBorder$Settings,int,int,UUID,Set,Set,TimerQueue,CompoundTag,CompoundTag,LevelSettings,WorldOptions,PrimaryLevelData$SpecialWorldProperty,Lifecycle)
- void <init>(DataFixer,int,CompoundTag,boolean,int,int,int,float,long,long,int,int,int,boolean,int,boolean,boolean,boolean,WorldBorder$Settings,int,int,UUID,Set,Set,TimerQueue,CompoundTag,EndDragonFight$Data,LevelSettings,WorldOptions,PrimaryLevelData$SpecialWorldProperty,Lifecycle)
- void lambda$setTagData$2(CompoundTag,Tag)
+ void lambda$setTagData$4(CompoundTag,Tag)
...
```
```
XXX.minecraft.client.ToggleKeyMapping +1M
```
```
XXX.dimension.end.EndDragonFight +6M -5M
```
...
+ void <init>(ServerLevel,long,CompoundTag,BlockPos)
+ void <init>(ServerLevel,long,CompoundTag)
- void <init>(ServerLevel,long,EndDragonFight$Data,BlockPos)
- void <init>(ServerLevel,long,EndDragonFight$Data)
+ void lambda$spawnNewGateway$1(BlockPos,Holder$Reference)
