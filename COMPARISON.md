## Comparison with [19w39a](https://github.com/PixiGeko/Minecraft-generated-data/tree/19w39a)
...
<table><tr><th></th><th align="left">19w39a</th><th>19w40a</th></tr><tr><td>World version</td><td><code>2207</code></td><td><code>2208</code></td></tr><tr><td>Protocol version</td><td><code>556</code></td><td><code>557</code></td></tr></table>
</details>
...
```
```
XXX.level.block.BeehiveBlock +2M
```
```
XXX.level.block.RedstoneLampBlock +1M
```
```
XXX.block.entity.BeehiveBlockEntity +2M
```
...
- List getDrops(BlockState,LootContext$Builder)
```
...
+ net.minecraft.client.gui.screens.ChatScreen$SuggestionsList
...
```
XXX.blaze3d.systems.RenderSystem +3M -2M
```
```
XXX.blaze3d.vertex.DefaultedVertexConsumer +1M
```
```
XXX.client.renderer.RenderType +6M -5M | -2P
```
...
```diff
- void lambda$glGenBuffers$70(Consumer)
+ void lambda$glGenBuffers$71(Consumer)
+ void lambda$teardownOverlayColor$70()
- void setupOutline()
...
```diff
+ boolean affectsEntityOutline()
- Optional outlineTexture()
- RenderType NEW_ENTITY(ResourceLocation,boolean,boolean,boolean,float,boolean,boolean)
+ RenderType NEW_ENTITY(ResourceLocation,boolean,boolean,boolean,float,boolean)
