## Comparison with [1.16-pre3](https://github.com/PixiGeko/Minecraft-generated-data/tree/1.16-pre3)
...
<table><tr><th></th><th align="left">1.16-pre3</th><th>1.16-pre4</th></tr><tr><td>World version</td><td><code>2559</code></td><td><code>2560</code></td></tr><tr><td>Protocol version</td><td><code>725</code></td><td><code>727</code></td></tr></table>
</details>
...
```
XXX.protocol.game.ClientboundPlayerAbilitiesPacket -6M
```
```
...
```diff
- InteractionResult fedFood(Player,ItemStack)
```
...
```diff
- ItemStack createBucketResult(ItemStack,Player,ItemStack)
```
