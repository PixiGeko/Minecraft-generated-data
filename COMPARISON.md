## Comparison with [1.20.3-pre1](https://github.com/PixiGeko/Minecraft-generated-data/tree/1.20.3-pre1)
...
<table><tr><th></th><th align="left">1.20.3-pre1</th><th>1.20.3-pre2</th></tr><tr><td>World version</td><td><code>3693</code></td><td><code>3694</code></td></tr><tr><td>Protocol version</td><td><code>1073741988</code></td><td><code>1073741989</code></td></tr></table>
</details>
...
```
XXX.arguments.item.FunctionArgument$1 +1M
```
```
XXX.arguments.item.FunctionArgument$Result +1P
```
```
XXX.commands.execution.ExecutionContext +1M
```
```
XXX.server.commands.FunctionCommand$FunctionCustomExecutor +1M -2M
```
```
...
```
```
XXX.level.storage.LevelStorageSource$LevelStorageAccess +2M -7M
```
```
XXX.world.scores.PlayerScores +1M -1M | +1P -1P
```
...
```diff
- Pair unwrapToCollection(CommandContext)
```
...
```diff
+ Collection lambda$runGuarded$0(Either)
- Component lambda$runGuarded$0(Collection)
+ Component lambda$runGuarded$2(Collection)
```
...
```diff
- String formatTickDuration(int,float)
...
+ String lambda$saveLevelData$1(Path)
+ String lambda$saveLevelData$2(CompoundTag)
+ String lambda$saveLevelData$3(LocalDateTime,Path)
+ String lambda$saveLevelData$4(LocalDateTime,CompoundTag)
- void lambda$renameAndDropPlayer$1(String,CompoundTag)
+ void lambda$renameAndDropPlayer$6(String,CompoundTag)
- void lambda$renameLevel$0(String,CompoundTag)
...
```diff
- Score lambda$getOrCreate$0(Consumer,Object)
+ Score lambda$getOrCreate$0(Consumer,Objective)
```
...
- com.mojang.blaze3d.audio.package-info
+ com.mojang.blaze3d.audio.SoundBuffer
+ com.mojang.blaze3d.font.GlyphInfo
- com.mojang.blaze3d.font.GlyphInfo$SpaceGlyphInfo
...
```
XXX.blaze3d.audio.Listener +2M -3M | +1P -1P
```
