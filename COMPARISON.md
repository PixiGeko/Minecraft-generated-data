## Comparison with [1.18.2-pre1](https://github.com/PixiGeko/Minecraft-generated-data/tree/1.18.2-pre1)
...
<table><tr><th></th><th align="left">1.18.2-pre1</th><th>1.18.2-pre2</th></tr><tr><td>World version</td><td><code>2971</code></td><td><code>2972</code></td></tr><tr><td>Protocol version</td><td><code>1073741894</code></td><td><code>1073741895</code></td></tr></table>
</details>
...
```
net.minecraft.Util$1 +2M -2M
```
```
XXX.minecraft.util.Mth +2M
```
```
XXX.entity.raid.Raids +1M -1M
```
```
XXX.level.biome.TerrainShaper +1M | +1P
```
```
XXX.level.chunk.ChunkGenerator +22M -21M | +1P
```
...
```diff
- double lengthSquared(double,double,double)
- double lengthSquared(double,double)
```
...
```diff
- TerrainShaper$PointCustom makePoint(DensityFunction$FunctionContext)
```
...
```diff
+ boolean lambda$allConfigurations$18(StructureFeature,ConfiguredStructureFeature)
- boolean lambda$allConfigurations$19(StructureFeature,ConfiguredStructureFeature)
+ boolean lambda$getMobsAt$15(StructureFeatureManager,BlockPos,StructureStart)
+ boolean lambda$getMobsAt$16(BlockPos,StructureStart)
- boolean lambda$getMobsAt$16(StructureFeatureManager,BlockPos,StructureStart)
- boolean lambda$getMobsAt$17(BlockPos,StructureStart)
+ boolean lambda$tryGenerateStructure$20(HolderSet,Holder)
- boolean lambda$tryGenerateStructure$21(HolderSet,Holder)
+ ChunkAccess lambda$createBiomes$5(ChunkAccess)
- ChunkAccess lambda$createBiomes$6(ChunkAccess)
- CompletableFuture generateRingPositions(Holder,ConcentricRingsStructurePlacement)
+ Integer lambda$applyBiomeDecoration$8(ConfiguredStructureFeature)
- Integer lambda$applyBiomeDecoration$9(ConfiguredStructureFeature)
- List lambda$generateRingPositions$5(Holder,ConcentricRingsStructurePlacement)
+ Set lambda$findNearestMapFeature$7(StructurePlacement)
- Set lambda$findNearestMapFeature$8(StructurePlacement)
+ Stream lambda$findNearestMapFeature$6(Holder)
- Stream lambda$findNearestMapFeature$7(Holder)
+ String lambda$applyBiomeDecoration$11(Registry,ConfiguredStructureFeature)
- String lambda$applyBiomeDecoration$12(Registry,ConfiguredStructureFeature)
+ String lambda$applyBiomeDecoration$14(Registry,PlacedFeature)
- String lambda$applyBiomeDecoration$15(Registry,PlacedFeature)
+ String lambda$createReferences$21(StructureStart,Registry)
+ String lambda$createReferences$22(Optional,StructureStart)
- String lambda$createReferences$22(StructureStart,Registry)
- String lambda$createReferences$23(Optional,StructureStart)
+ String lambda$createReferences$23(StructureStart)
- String lambda$createReferences$25(StructureStart)
+ void ensureGenerated()
- void ensureStructuresGenerated()
+ void generateRingPositions(StructureSet,ConcentricRingsStructurePlacement)
- void lambda$applyBiomeDecoration$10(Set,Holder)
+ void lambda$applyBiomeDecoration$10(WorldGenLevel,Set,ChunkPos)
- void lambda$applyBiomeDecoration$11(WorldGenLevel,Set,ChunkPos)
+ void lambda$applyBiomeDecoration$12(WorldGenLevel,StructureFeatureManager,WorldgenRandom,ChunkAccess,ChunkPos,StructureStart)
+ void lambda$applyBiomeDecoration$13(IntSet,BiomeSource$StepFeatureData,PlacedFeature)
- void lambda$applyBiomeDecoration$13(WorldGenLevel,StructureFeatureManager,WorldgenRandom,ChunkAccess,ChunkPos,StructureStart)
- void lambda$applyBiomeDecoration$14(IntSet,BiomeSource$StepFeatureData,PlacedFeature)
+ void lambda$applyBiomeDecoration$9(Set,Holder)
+ void lambda$createStructures$19(StructureFeatureManager,SectionPos,ChunkAccess,ChunkPos,RegistryAccess,StructureManager,long,Holder)
...
- void lambda$getMobsAt$18(MutableBoolean,Predicate,StructureStart)
```
...
```
```
XXX.minecraft.core.MappedRegistry +9M -8M
```
```
XXX.minecraft.core.RegistryAccess +2M
```
```
XXX.server.dedicated.DedicatedServerProperties +2M -1M
```
```
XXX.minecraft.util.CubicSpline +1P
```
```
...
```
```
XXX.levelgen.flat.FlatLevelGeneratorSettings +1M -1M
```
```
...
+ void lambda$resetTags$11(HolderSet$Named)
+ void lambda$resetTags$12(Holder$Reference)
...
```diff
- Lifecycle allElementsLifecycle()
...
```diff
- JsonObject lambda$new$2(String)
+ String lambda$new$2(String)
- String lambda$new$3(String)
```
...
```diff
- FlatLevelGeneratorSettings lambda$create$2(Registry,Registry)
...
```diff
- WorldData getDataTag(DynamicOps,DataPackConfig,Lifecycle)
