## Comparison with [1.19.4-pre1](https://github.com/PixiGeko/Minecraft-generated-data/tree/1.19.4-pre1)
...
<table><tr><th></th><th align="left">1.19.4-pre1</th><th>1.19.4-pre2</th></tr><tr><td>World version</td><td><code>3330</code></td><td><code>3331</code></td></tr><tr><td>Protocol version</td><td><code>1073741944</code></td><td><code>1073741945</code></td></tr></table>
</details>
...
```
XXX.data.tags.ItemTagsProvider +4M -4M
```
```
XXX.data.tags.TagsProvider +4M -3M | +2P -1P
```
```
...
- HolderLookup$Provider lambda$createContentsProvider$4(HolderLookup$Provider,TagsProvider$TagLookup)
...
- void lambda$createContentsProvider$3(TagsProvider$TagLookup,TagKey,TagKey)
```
...
```
XXX.minecraft.client.InputType +1P -1P
```
```
XXX.client.gui.GuiComponent +3M | +1P
```
