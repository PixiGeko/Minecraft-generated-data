## Comparison with [25w18a](https://github.com/PixiGeko/Minecraft-generated-data/tree/25w18a)
...
<br/>
<table><tr><th></th><th align="left">25w18a</th><th>25w19a</th></tr><tr><td>DataPack version</td><td><pre>75</pre></td><td><pre>76</pre></td></tr><tr><td>ResourcePack version</td><td><pre>59</pre></td><td><pre>60</pre></td></tr><tr><td>World version</td><td><pre>4426</pre></td><td><pre>4427</pre></td></tr><tr><td>Protocol version</td><td><pre>1073742072</pre></td><td><pre>1073742073</pre></td></tr></table>
</details>
<hr/>
...
+ minecraft/advancement/recipes/combat/black_harness.json
+ minecraft/advancement/recipes/combat/blue_harness.json
+ minecraft/advancement/recipes/combat/brown_harness.json
+ minecraft/advancement/recipes/combat/cyan_harness.json
+ minecraft/advancement/recipes/combat/dye_black_harness.json
+ minecraft/advancement/recipes/combat/dye_blue_harness.json
+ minecraft/advancement/recipes/combat/dye_brown_harness.json
+ minecraft/advancement/recipes/combat/dye_cyan_harness.json
+ minecraft/advancement/recipes/combat/dye_gray_harness.json
+ minecraft/advancement/recipes/combat/dye_green_harness.json
+ minecraft/advancement/recipes/combat/dye_light_blue_harness.json
+ minecraft/advancement/recipes/combat/dye_light_gray_harness.json
+ minecraft/advancement/recipes/combat/dye_lime_harness.json
+ minecraft/advancement/recipes/combat/dye_magenta_harness.json
+ minecraft/advancement/recipes/combat/dye_orange_harness.json
+ minecraft/advancement/recipes/combat/dye_pink_harness.json
+ minecraft/advancement/recipes/combat/dye_purple_harness.json
+ minecraft/advancement/recipes/combat/dye_red_harness.json
+ minecraft/advancement/recipes/combat/dye_white_harness.json
+ minecraft/advancement/recipes/combat/dye_yellow_harness.json
+ minecraft/advancement/recipes/combat/gray_harness.json
+ minecraft/advancement/recipes/combat/green_harness.json
+ minecraft/advancement/recipes/combat/light_blue_harness.json
+ minecraft/advancement/recipes/combat/light_gray_harness.json
+ minecraft/advancement/recipes/combat/lime_harness.json
+ minecraft/advancement/recipes/combat/magenta_harness.json
+ minecraft/advancement/recipes/combat/orange_harness.json
+ minecraft/advancement/recipes/combat/pink_harness.json
+ minecraft/advancement/recipes/combat/purple_harness.json
+ minecraft/advancement/recipes/combat/red_harness.json
+ minecraft/advancement/recipes/combat/white_harness.json
+ minecraft/advancement/recipes/combat/yellow_harness.json
+ minecraft/advancement/recipes/decorations/dye_black_bed.json
+ minecraft/advancement/recipes/decorations/dye_black_carpet.json
+ minecraft/advancement/recipes/decorations/dye_blue_bed.json
+ minecraft/advancement/recipes/decorations/dye_blue_carpet.json
+ minecraft/advancement/recipes/decorations/dye_brown_bed.json
+ minecraft/advancement/recipes/decorations/dye_brown_carpet.json
+ minecraft/advancement/recipes/decorations/dye_cyan_bed.json
+ minecraft/advancement/recipes/decorations/dye_cyan_carpet.json
+ minecraft/advancement/recipes/decorations/dye_gray_bed.json
+ minecraft/advancement/recipes/decorations/dye_gray_carpet.json
+ minecraft/advancement/recipes/decorations/dye_green_bed.json
+ minecraft/advancement/recipes/decorations/dye_green_carpet.json
+ minecraft/advancement/recipes/decorations/dye_light_blue_bed.json
+ minecraft/advancement/recipes/decorations/dye_light_blue_carpet.json
+ minecraft/advancement/recipes/decorations/dye_light_gray_bed.json
+ minecraft/advancement/recipes/decorations/dye_light_gray_carpet.json
+ minecraft/advancement/recipes/decorations/dye_lime_bed.json
+ minecraft/advancement/recipes/decorations/dye_lime_carpet.json
+ minecraft/advancement/recipes/decorations/dye_magenta_bed.json
+ minecraft/advancement/recipes/decorations/dye_magenta_carpet.json
+ minecraft/advancement/recipes/decorations/dye_orange_bed.json
+ minecraft/advancement/recipes/decorations/dye_orange_carpet.json
+ minecraft/advancement/recipes/decorations/dye_pink_bed.json
+ minecraft/advancement/recipes/decorations/dye_pink_carpet.json
+ minecraft/advancement/recipes/decorations/dye_purple_bed.json
+ minecraft/advancement/recipes/decorations/dye_purple_carpet.json
+ minecraft/advancement/recipes/decorations/dye_red_bed.json
+ minecraft/advancement/recipes/decorations/dye_red_carpet.json
+ minecraft/advancement/recipes/decorations/dye_white_bed.json
+ minecraft/advancement/recipes/decorations/dye_white_carpet.json
+ minecraft/advancement/recipes/decorations/dye_yellow_bed.json
+ minecraft/advancement/recipes/decorations/dye_yellow_carpet.json
...
+ minecraft/shaders/core/panorama.vsh
```
...
```
```
XXX.gametest.framework.GameTestTicker +1M | +1P
```
```
XXX.server.level.ServerPlayer +2M -1M | +1P
```
...
```
XXX.blaze3d.opengl.GlRenderPass +1M -1M
```
```
XXX.blaze3d.opengl.GlTexture +5M -2M | +1P
```
```
XXX.blaze3d.systems.CommandEncoder +5P -5P
```
```
XXX.blaze3d.systems.RenderPass +1P -1P
```
```
XXX.blaze3d.textures.GpuTexture +2M -1M | +2P
```
```
XXX.client.main.Main +1M
```
```
XXX.client.multiplayer.PlayerInfo +2M -1M
```
```
XXX.client.quickplay.QuickPlay +2M -1M | +1P
```
```
XXX.client.renderer.GameRenderer +1M | +2P
```
```
XXX.client.renderer.PostPass$TargetInput +1M -1M
```
```
XXX.renderer.item.ItemStackRenderState +1M
```
```
XXX.gametest.framework.GameTestTicker +1M | +1P
```
...
- void bindSampler(String,GpuTextureView)
```
...
```diff
- void <init>(int,String,TextureFormat,int,int,int,int,int)
+ void <init>(int,String,TextureFormat,int,int,int,int)
- void addViews()
- void destroyImmediately()
+ void flushModeChanges()
- void flushModeChanges(int)
- void removeViews()
```
...
```diff
- GameConfig$QuickPlayVariant getQuickPlayVariant(OptionSet,OptionSpec,OptionSpec,OptionSpec)
```
...
```diff
+ PlayerSkin lambda$createSkinLookup$2(CompletableFuture,PlayerSkin,boolean)
- PlayerSkin lambda$createSkinLookup$2(PlayerSkin)
- PlayerSkin lambda$createSkinLookup$3(CompletableFuture,PlayerSkin,boolean)
```
...
```diff
- String getLatestSingleplayerWorld(LevelStorageSource)
+ void connect(Minecraft,GameConfig$QuickPlayData,RealmsClient)
- void connect(Minecraft,GameConfig$QuickPlayVariant,RealmsClient)
```
