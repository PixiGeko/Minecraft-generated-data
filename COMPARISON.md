## Comparison with [25w04a](https://github.com/PixiGeko/Minecraft-generated-data/tree/25w04a)
...
<br/>
<table><tr><th></th><th align="left">25w04a</th><th>25w05a</th></tr><tr><td>DataPack version</td><td><pre>64</pre></td><td><pre>65</pre></td></tr><tr><td>ResourcePack version</td><td><pre>49</pre></td><td><pre>50</pre></td></tr><tr><td>World version</td><td><pre>4308</pre></td><td><pre>4310</pre></td></tr><tr><td>Protocol version</td><td><pre>1073742055</pre></td><td><pre>1073742056</pre></td></tr></table>
</details>
<hr/>
...
<table><tr><th></th><th align="left">25w04a</th><th>25w05a</th></tr><tr><td>minecraft:provides_banner_patterns</td><td><pre>minecraft:pattern_item/bordure_indented</pre></td><td><pre>#minecraft:pattern_item/bordure_indented</pre></td></tr></table>
<br/>
</details>
<details>
<summary>
...
<table><tr><th></th><th align="left">25w04a</th><th>25w05a</th></tr><tr><td>minecraft:provides_banner_patterns</td><td><pre>minecraft:pattern_item/creeper</pre></td><td><pre>#minecraft:pattern_item/creeper</pre></td></tr></table>
<br/>
</details>
<details>
<summary>
...
<table><tr><th></th><th align="left">25w04a</th><th>25w05a</th></tr><tr><td>minecraft:provides_banner_patterns</td><td><pre>minecraft:pattern_item/field_masoned</pre></td><td><pre>#minecraft:pattern_item/field_masoned</pre></td></tr></table>
<br/>
</details>
<details>
<summary>
...
<table><tr><th></th><th align="left">25w04a</th><th>25w05a</th></tr><tr><td>minecraft:provides_banner_patterns</td><td><pre>minecraft:pattern_item/flower</pre></td><td><pre>#minecraft:pattern_item/flower</pre></td></tr></table>
<br/>
</details>
<details>
<summary>
...
<table><tr><th></th><th align="left">25w04a</th><th>25w05a</th></tr><tr><td>minecraft:provides_banner_patterns</td><td><pre>minecraft:pattern_item/flow</pre></td><td><pre>#minecraft:pattern_item/flow</pre></td></tr></table>
<br/>
</details>
<details>
<summary>
...
<table><tr><th></th><th align="left">25w04a</th><th>25w05a</th></tr><tr><td>minecraft:provides_banner_patterns</td><td><pre>minecraft:pattern_item/globe</pre></td><td><pre>#minecraft:pattern_item/globe</pre></td></tr></table>
<br/>
</details>
<details>
<summary>
...
<table><tr><th></th><th align="left">25w04a</th><th>25w05a</th></tr><tr><td>minecraft:provides_banner_patterns</td><td><pre>minecraft:pattern_item/guster</pre></td><td><pre>#minecraft:pattern_item/guster</pre></td></tr></table>
<br/>
</details>
<details>
<summary>
...
<table><tr><th></th><th align="left">25w04a</th><th>25w05a</th></tr><tr><td>minecraft:provides_banner_patterns</td><td><pre>minecraft:pattern_item/mojang</pre></td><td><pre>#minecraft:pattern_item/mojang</pre></td></tr></table>
<br/>
</details>
<details>
<summary>
...
<table><tr><th></th><th align="left">25w04a</th><th>25w05a</th></tr><tr><td>minecraft:provides_banner_patterns</td><td><pre>minecraft:pattern_item/piglin</pre></td><td><pre>#minecraft:pattern_item/piglin</pre></td></tr></table>
<br/>
</details>
<details>
<summary>
...
<table><tr><th></th><th align="left">25w04a</th><th>25w05a</th></tr><tr><td>minecraft:blocks_attacks</td><td><pre>{
...
<table><tr><th></th><th align="left">25w04a</th><th>25w05a</th></tr><tr><td>minecraft:provides_banner_patterns</td><td><pre>minecraft:pattern_item/skull</pre></td><td><pre>#minecraft:pattern_item/skull</pre></td></tr></table>
<br/>
</details>
</details>
<hr/>
...
<table><tr><th></th><th align="left">25w04a</th><th>25w05a</th></tr><tr><td>type</td><td><pre>minecraft:block</pre></td><td><pre>minecraft:terracotta</pre></td></tr></table>
<br/>
</details>
<details>
<summary>
...
<table><tr><th></th><th align="left">25w04a</th><th>25w05a</th></tr><tr><td>type</td><td><pre>minecraft:colored_falling</pre></td><td><pre>minecraft:sand</pre></td></tr></table>
<br/>
</details>
<details>
<summary>
...
```diff
+ minecraft/cow_variant/cold.json
+ minecraft/cow_variant/temperate.json
+ minecraft/cow_variant/warm.json
+ minecraft/loot_table/blocks/bush.json
+ minecraft/loot_table/blocks/firefly_bush.json
+ minecraft/tags/block/plays_ambient_desert_block_sounds.json
- minecraft/tags/damage_type/bypasses_blocking.json
+ minecraft/tags/damage_type/bypasses_shield.json
+ minecraft/worldgen/configured_feature/patch_bush.json
...
+ minecraft/worldgen/configured_feature/patch_firefly_bush.json
+ minecraft/worldgen/placed_feature/patch_bush.json
+ minecraft/worldgen/placed_feature/patch_firefly_bush_near_water_swamp.json
+ minecraft/worldgen/placed_feature/patch_firefly_bush_near_water.json
+ minecraft/worldgen/placed_feature/patch_firefly_bush_swamp.json
```
...
+ minecraft/blockstates/firefly_bush.json
+ minecraft/items/bush.json
+ minecraft/items/firefly_bush.json
+ minecraft/models/block/bush.json
+ minecraft/models/block/firefly_bush.json
+ minecraft/models/item/bush.json
+ minecraft/models/item/firefly_bush.json
+ minecraft/particles/firefly.json
+ minecraft/textures/block/bush.png
+ minecraft/textures/block/firefly_bush_emissive.png
+ minecraft/textures/block/firefly_bush_emissive.png.mcmeta
+ minecraft/textures/block/firefly_bush.png
...
+ minecraft/textures/item/firefly_bush.png
+ minecraft/textures/particle/firefly.png
```
...
```
net.minecraft.ChatFormatting +3M -1M | +1P
```
```
XXX.commands.arguments.ComponentArgument +3M -1M
```
```
XXX.core.registries.Registries +1P
```
```
XXX.worldgen.placement.VegetationPlacements +4P
```
```
XXX.gametest.framework.BlockBasedTestInstance +5M -4M
```
```
XXX.gametest.framework.FunctionGameTestInstance +3M -2M | +1P -1P
```
```
XXX.minecraft.server.Main +1M -1M
```
```
XXX.server.level.ServerLevel +1M -1M
```
```
XXX.server.level.TicketType +1P -1P
```
```
XXX.minecraft.tags.BlockTags +1P
```
```
XXX.entity.animal.Cow +9M -11M | +1P -1P
```
```
XXX.chunk.storage.SerializableChunkData +5M -7M
```
```
XXX.levelgen.structure.StructurePiece +1M -3M | -1P
```
```
XXX.structure.structures.MineshaftPieces -1M | -1P
```
```
XXX.structure.structures.RuinedPortalPiece +1M -3M | -1P
```
```
XXX.rule.blockentity.AppendLoot -1M | -1P
```
...
```diff
+ ChatFormatting lambda$static$1(ChatFormatting)
- ChatFormatting lambda$static$3(ChatFormatting)
- DataResult lambda$static$1(ChatFormatting)
- String lambda$static$2(ChatFormatting)
```
...
```diff
+ Component getComponent(CommandContext,String)
- Component getRawComponent(CommandContext,String)
- Component getResolvedComponent(CommandContext,String,Entity)
- Component getResolvedComponent(CommandContext,String)
```
...
```diff
- BlockPos findStartBlock(GameTestHelper)
+ BlockPos findTestBlock(GameTestHelper,TestBlockMode)
- TestBlockEntity lambda$run$1(GameTestHelper,BlockPos)
+ void lambda$findTestBlocks$3(GameTestHelper,TestBlockMode,List,BlockPos)
- void lambda$findTestBlocks$4(GameTestHelper,TestBlockMode,List,BlockPos)
+ void lambda$run$1(GameTestHelper,TestBlockEntity)
- void lambda$run$2(GameTestHelper,TestBlockEntity)
+ void lambda$run$2(GameTestHelper)
- void lambda$run$3(GameTestHelper)
```
...
```diff
+ Holder function()
- IllegalStateException lambda$run$1()
- ResourceKey function()
+ void <init>(Holder,TestData)
- void <init>(ResourceKey,TestData)
```
...
```diff
+ void forceUpgrade(LevelStorageSource$LevelStorageAccess,DataFixer,boolean,BooleanSupplier,RegistryAccess,boolean)
- void forceUpgrade(LevelStorageSource$LevelStorageAccess,WorldData,DataFixer,boolean,BooleanSupplier,RegistryAccess,boolean)
```
...
+ RandomSequences lambda$new$1(long)
```
...
+ boolean lambda$unpackStructureReferences$14(ChunkPos,ResourceLocation,long)
- String lambda$saveTicks$10(Fluid)
+ String lambda$saveTicks$11(Block)
+ String lambda$saveTicks$12(Fluid)
- String lambda$saveTicks$9(Block)
- void lambda$postLoadChunk$11(List,ServerLevel,List,LevelChunk)
+ void lambda$postLoadChunk$13(List,ServerLevel,List,LevelChunk)
+ void lambda$write$10(CompoundTag,Heightmap$Types,long[])
- void lambda$write$8(CompoundTag,Heightmap$Types,long[])
+ void lambda$write$8(CompoundTag,Tag)
+ void lambda$write$9(CompoundTag,Tag)
```
...
+ void lambda$createTag$1(CompoundTag,Tag)
```
...
- void lambda$postProcess$1(RandomSource,WorldGenLevel,BlockPos)
+ void lambda$postProcess$2(RandomSource,WorldGenLevel,BlockPos)
```
...
```diff
+ void lambda$apply$2(CompoundTag,Tag)
```
...
```
```
XXX.model.geom.ModelLayers +4P
```
```
XXX.renderer.blockentity.AbstractSignRenderer +2M -2M
```
```
XXX.renderer.blockentity.BeaconRenderer +2M -2M | +3P
```
```
...
```
```
XXX.renderer.blockentity.BlockEntityWithBoundingBoxRenderer +1M -1M
```
```
XXX.renderer.blockentity.BrushableBlockRenderer +2M -2M
```
```
XXX.renderer.blockentity.CampfireRenderer +2M -2M
```
```
XXX.renderer.blockentity.ConduitRenderer +2M -2M
```
```
XXX.renderer.blockentity.EnchantTableRenderer +2M -2M
```
```
XXX.renderer.blockentity.LecternRenderer +2M -2M
```
```
XXX.renderer.blockentity.ShulkerBoxRenderer +2M -2M
```
```
XXX.renderer.blockentity.SkullBlockRenderer +2M -2M
```
```
XXX.renderer.blockentity.SpawnerRenderer +2M -2M
```
```
XXX.renderer.blockentity.TheEndGatewayRenderer +3M -3M
```
```
XXX.renderer.blockentity.TrialSpawnerRenderer +2M -2M
```
```
XXX.gametest.framework.GameTestHelper +1M -1M
```
```
XXX.gametest.framework.GameTestInfo +3M -2M | +1P -1P
```
```
XXX.gametest.framework.GameTestServer +1M -2M
```
```
XXX.world.entity.Display -6M | +1P
```
```
XXX.world.entity.Display$ItemDisplay -2M
```
```
XXX.world.entity.Entity +10M -10M | -1P
```
```
XXX.world.entity.LivingEntity +1M -1M
```
```
XXX.world.entity.Mob +3M -7M | -1P
```
```
XXX.ai.attributes.AttributeModifier -2M | -1P
```
```
XXX.animal.allay.Allay -4M | -1P
```
```
XXX.entity.monster.ZombieVillager +2M -4M | -1P
```
```
XXX.monster.warden.Warden +1M -8M | -1P
```
```
XXX.monster.warden.WardenSpawnTracker +1M
```
```
XXX.entity.npc.AbstractVillager -1M | -1P
```
```
XXX.entity.player.Player +3M -5M | -1P
```
```
XXX.entity.projectile.AbstractThrownPotion -1M
```
```
XXX.entity.projectile.ThrownLingeringPotion +1M
```
```
XXX.entity.raid.Raids +13M -10M | +5P -3P
```
```
XXX.world.item.EitherHolder +6M -8M | +1P -2P
```
```
XXX.world.item.Items +2P
```
```
XXX.item.component.BlocksAttacks$DamageReduction +3M -2M | +1P -1P
```
```
XXX.level.block.BushBlock +8M -5M | +2P -1P
```
```
XXX.block.entity.BlockEntity +4M -8M
```
```
XXX.block.entity.BlockEntity$ComponentHelper +1P -1P
```
```
XXX.entity.trialspawner.TrialSpawnerData +1M -2M
```
```
XXX.entity.vault.VaultBlockEntity -3M | -1P
```
```
XXX.saveddata.maps.MapBanner -1P
```
```
XXX.saveddata.maps.MapItemSavedData +17M -10M | +1P
```
```
XXX.level.storage.CommandStorage +3M -5M
```
```
XXX.level.storage.DimensionDataStorage +17M -15M | +1P
```
```
XXX.level.storage.PrimaryLevelData -2M
```
```
XXX.world.scores.Score +5M -5M | +1P -4P
```
```
XXX.world.scores.Scoreboard +6M -4M
```
```
XXX.world.scores.Team$CollisionRule +3M -3M | +3P -1P
```
```
XXX.scores.criteria.ObjectiveCriteria +3M -1M | +1P
```
...
- void <init>(BooleanConsumer,DataFixer,LevelStorageSource$LevelStorageAccess,WorldData,boolean,RegistryAccess)
```
...
```diff
- void render(BlockEntity,float,PoseStack,MultiBufferSource,int,int,Vec3)
+ void render(BlockEntity,float,PoseStack,MultiBufferSource,int,int)
- void render(SignBlockEntity,float,PoseStack,MultiBufferSource,int,int,Vec3)
...
- void render(BlockEntity,float,PoseStack,MultiBufferSource,int,int,Vec3)
+ void render(BlockEntity,float,PoseStack,MultiBufferSource,int,int)
- void renderBeaconBeam(PoseStack,MultiBufferSource,float,float,long,int,int,int)
...
```diff
- void render(BellBlockEntity,float,PoseStack,MultiBufferSource,int,int,Vec3)
+ void render(BellBlockEntity,float,PoseStack,MultiBufferSource,int,int)
- void render(BlockEntity,float,PoseStack,MultiBufferSource,int,int,Vec3)
+ void render(BlockEntity,float,PoseStack,MultiBufferSource,int,int)
```
...
- void render(BlockEntity,float,PoseStack,MultiBufferSource,int,int,Vec3)
+ void render(BlockEntity,float,PoseStack,MultiBufferSource,int,int)
- void render(BrushableBlockEntity,float,PoseStack,MultiBufferSource,int,int,Vec3)
+ void render(BrushableBlockEntity,float,PoseStack,MultiBufferSource,int,int)
```
...
- void render(BlockEntity,float,PoseStack,MultiBufferSource,int,int,Vec3)
+ void render(BlockEntity,float,PoseStack,MultiBufferSource,int,int)
- void render(CampfireBlockEntity,float,PoseStack,MultiBufferSource,int,int,Vec3)
+ void render(CampfireBlockEntity,float,PoseStack,MultiBufferSource,int,int)
```
...
- void render(BlockEntity,float,PoseStack,MultiBufferSource,int,int,Vec3)
+ void render(BlockEntity,float,PoseStack,MultiBufferSource,int,int)
- void render(ConduitBlockEntity,float,PoseStack,MultiBufferSource,int,int,Vec3)
+ void render(ConduitBlockEntity,float,PoseStack,MultiBufferSource,int,int)
```
...
- void render(BlockEntity,float,PoseStack,MultiBufferSource,int,int,Vec3)
+ void render(BlockEntity,float,PoseStack,MultiBufferSource,int,int)
- void render(EnchantingTableBlockEntity,float,PoseStack,MultiBufferSource,int,int,Vec3)
+ void render(EnchantingTableBlockEntity,float,PoseStack,MultiBufferSource,int,int)
```
...
- void render(BlockEntity,float,PoseStack,MultiBufferSource,int,int,Vec3)
+ void render(BlockEntity,float,PoseStack,MultiBufferSource,int,int)
- void render(LecternBlockEntity,float,PoseStack,MultiBufferSource,int,int,Vec3)
+ void render(LecternBlockEntity,float,PoseStack,MultiBufferSource,int,int)
```
...
- void render(BlockEntity,float,PoseStack,MultiBufferSource,int,int,Vec3)
+ void render(BlockEntity,float,PoseStack,MultiBufferSource,int,int)
- void render(ShulkerBoxBlockEntity,float,PoseStack,MultiBufferSource,int,int,Vec3)
+ void render(ShulkerBoxBlockEntity,float,PoseStack,MultiBufferSource,int,int)
```
...
- void render(BlockEntity,float,PoseStack,MultiBufferSource,int,int,Vec3)
+ void render(BlockEntity,float,PoseStack,MultiBufferSource,int,int)
- void render(SkullBlockEntity,float,PoseStack,MultiBufferSource,int,int,Vec3)
+ void render(SkullBlockEntity,float,PoseStack,MultiBufferSource,int,int)
```
...
- void render(BlockEntity,float,PoseStack,MultiBufferSource,int,int,Vec3)
+ void render(BlockEntity,float,PoseStack,MultiBufferSource,int,int)
- void render(SpawnerBlockEntity,float,PoseStack,MultiBufferSource,int,int,Vec3)
+ void render(SpawnerBlockEntity,float,PoseStack,MultiBufferSource,int,int)
```
...
- void render(BlockEntity,float,PoseStack,MultiBufferSource,int,int,Vec3)
+ void render(BlockEntity,float,PoseStack,MultiBufferSource,int,int)
- void render(TheEndGatewayBlockEntity,float,PoseStack,MultiBufferSource,int,int,Vec3)
+ void render(TheEndGatewayBlockEntity,float,PoseStack,MultiBufferSource,int,int)
- void render(TheEndPortalBlockEntity,float,PoseStack,MultiBufferSource,int,int,Vec3)
...
- void render(BlockEntity,float,PoseStack,MultiBufferSource,int,int,Vec3)
+ void render(BlockEntity,float,PoseStack,MultiBufferSource,int,int)
- void render(TrialSpawnerBlockEntity,float,PoseStack,MultiBufferSource,int,int,Vec3)
+ void render(TrialSpawnerBlockEntity,float,PoseStack,MultiBufferSource,int,int)
```
...
- GameTestException lambda$failIf$29()
```
...
```diff
- GameTestException getError()
+ Throwable getError()
- void fail(Component)
- void fail(GameTestException)
+ void fail(Throwable)
```
...
```diff
+ void lambda$tickServer$4(GameTestInfo)
+ void lambda$tickServer$5(GameTestInfo)
- void logFailedTest(GameTestInfo)
```
...
+ void lambda$readAdditionalSaveData$1(Pair)
+ void lambda$readAdditionalSaveData$2(Pair)
```
...
+ void lambda$load$1(Tag,DataResult$Error)
...
- void propagateFallToPassengers(double,float,DamageSource)
```
...
```diff
+ boolean isDamageSourceBlocked(DamageSource)
- float applyItemBlocking(ServerLevel,DamageSource,float)
```
...
```diff
- boolean lambda$dropPreservedEquipment$0(ItemStack)
+ boolean lambda$dropPreservedEquipment$4(ItemStack)
- boolean lambda$removeFreeWill$2(Goal)
+ boolean lambda$removeFreeWill$6(Goal)
- void lambda$checkAndHandleImportantInteractions$1(Player,Mob)
+ void lambda$checkAndHandleImportantInteractions$5(Player,Mob)
+ void lambda$readAdditionalSaveData$0(String)
...
```diff
- boolean lambda$finishConversion$1(ItemStack)
+ boolean lambda$finishConversion$3(ItemStack)
+ void lambda$addAdditionalSaveData$1(CompoundTag,Tag)
- void lambda$finishConversion$2(ServerLevel,Villager)
...
```diff
- AngerManagement lambda$readAdditionalSaveData$0()
+ void lambda$addAdditionalSaveData$0(String)
+ void lambda$addAdditionalSaveData$1(CompoundTag,Tag)
+ void lambda$addAdditionalSaveData$2(String)
+ void lambda$addAdditionalSaveData$3(CompoundTag,Tag)
+ void lambda$readAdditionalSaveData$4(String)
+ void lambda$readAdditionalSaveData$5(AngerManagement)
+ void lambda$readAdditionalSaveData$6(String)
+ void lambda$readAdditionalSaveData$7(VibrationSystem$Data)
```
...
```diff
+ Optional lambda$addAdditionalSaveData$3(GlobalPos)
- Style lambda$decorateDisplayNameComponent$4(String,Style)
+ Style lambda$decorateDisplayNameComponent$6(String,Style)
- void lambda$addAdditionalSaveData$2(CompoundTag,GlobalPos)
+ void lambda$addAdditionalSaveData$4(CompoundTag,Tag)
+ void lambda$readAdditionalSaveData$2(Vec3)
...
+ boolean canJoinRaid(Raider,Raid)
- boolean canJoinRaid(Raider)
+ boolean lambda$createOrExtendRaid$2(Holder)
- boolean lambda$createOrExtendRaid$4(Holder)
+ CompoundTag save(CompoundTag,HolderLookup$Provider)
- Integer lambda$static$1(Raids)
- Integer lambda$static$2(Raids)
- List lambda$static$0(Raids)
- OptionalInt getId(Raid)
+ Raids lambda$factory$0(ServerLevel)
+ Raids lambda$factory$1(ServerLevel,CompoundTag,HolderLookup$Provider)
- Raids load(CompoundTag)
+ Raids load(ServerLevel,CompoundTag)
+ SavedData$Factory factory(ServerLevel)
- SavedDataType getType(Holder)
+ String getFileId(Holder)
- void <clinit>()
- void <init>()
- void <init>(List,int,int)
+ void <init>(ServerLevel)
+ void tick()
- void tick(ServerLevel)
```
...
+ Either asEither()
- Either contents()
+ Either lambda$asEither$2()
+ EitherHolder fromEither(Either)
- Holder lambda$unwrap$3(Holder$Reference)
+ Optional holder()
- Optional key()
- Optional lambda$unwrap$2(Holder)
+ Optional lambda$unwrap$3(Registry)
- Optional lambda$unwrap$4(HolderLookup$Provider,ResourceKey)
+ Optional lambda$unwrap$4(HolderLookup$Provider)
+ ResourceKey key()
- void <init>(Either)
...
- float resolve(DamageSource,float,double)
+ float resolve(DamageSource,float)
- void <init>(float,Optional,float,float)
+ void <init>(Optional,float,float)
```
...
+ boolean mayPlaceOn(BlockState,BlockGetter,BlockPos)
...
+ void lambda$parseCustomNameSafe$7(String)
...
- void lambda$getUpdateTag$11(CompoundTag,SpawnData)
...
- boolean lambda$mapMatcher$12(ItemStack,MapId,ItemStack)
+ boolean lambda$mapMatcher$4(ItemStack,MapId,ItemStack)
- Boolean lambda$static$5(MapItemSavedData)
- Boolean lambda$static$6(MapItemSavedData)
- Boolean lambda$static$7(MapItemSavedData)
- Byte lambda$static$3(MapItemSavedData)
- ByteBuffer lambda$static$4(MapItemSavedData)
+ CompoundTag save(CompoundTag,HolderLookup$Provider)
+ IllegalArgumentException lambda$load$1(CompoundTag)
- Integer lambda$static$1(MapItemSavedData)
- Integer lambda$static$2(MapItemSavedData)
- List lambda$static$8(MapItemSavedData)
- List lambda$static$9(MapItemSavedData)
- MapDecorations lambda$addTargetDecoration$14(String,MapDecorations$Entry,MapDecorations)
+ MapDecorations lambda$addTargetDecoration$6(String,MapDecorations$Entry,MapDecorations)
+ MapItemSavedData lambda$factory$0()
- MapItemSavedData lambda$type$11()
+ MapItemSavedData load(CompoundTag,HolderLookup$Provider)
- ResourceKey lambda$static$0(MapItemSavedData)
+ SavedData$Factory factory()
- SavedDataType type(MapId)
- void <init>(ResourceKey,int,int,byte,ByteBuffer,boolean,boolean,boolean,List,List)
+ void lambda$load$2(String)
+ void lambda$save$3(CompoundTag,Tag)
- void lambda$tickCarriedBy$13(Player,String,MapDecorations$Entry)
+ void lambda$tickCarriedBy$5(Player,String,MapDecorations$Entry)
```
...
```diff
- CommandStorage$Container getContainer(String)
- CommandStorage$Container getOrCreateContainer(String)
+ CommandStorage$Container lambda$factory$0(String)
+ CommandStorage$Container lambda$factory$1(String,CompoundTag,HolderLookup$Provider)
+ CommandStorage$Container newStorage(String)
+ SavedData$Factory factory(String)
- Stream lambda$keys$0(Map$Entry)
+ Stream lambda$keys$2(Map$Entry)
```
...
```diff
+ CompletableFuture lambda$scheduleSave$4(Map$Entry)
- CompletableFuture lambda$scheduleSave$5(Map$Entry)
+ CompletableFuture[] lambda$scheduleSave$1(int)
- CompletableFuture[] lambda$scheduleSave$2(int)
+ CompletableFuture[] lambda$scheduleSave$5(int)
- CompletableFuture[] lambda$scheduleSave$6(int)
+ CompletionStage lambda$scheduleSave$2(int,int,Map,Object)
- CompletionStage lambda$scheduleSave$3(int,int,Map,Object)
+ CompletionStage lambda$scheduleSave$6(Map,Object)
- CompletionStage lambda$scheduleSave$7(Map,Object)
- CompoundTag encodeUnchecked(SavedDataType,SavedData,RegistryOps)
+ SavedData computeIfAbsent(SavedData$Factory,String)
- SavedData computeIfAbsent(SavedDataType)
+ SavedData get(SavedData$Factory,String)
- SavedData get(SavedDataType)
+ SavedData readSavedData(BiFunction,DataFixTypes,String)
- SavedData readSavedData(SavedDataType)
+ void <init>(Path,DataFixer,HolderLookup$Provider)
- void <init>(SavedData$Context,Path,DataFixer,HolderLookup$Provider)
+ void lambda$collectDirtyTagsToSave$7(Map,String,SavedData)
- void lambda$collectDirtyTagsToSave$8(Map,SavedDataType,RegistryOps,SavedData)
+ void lambda$collectDirtyTagsToSave$8(Map,String,Optional)
- void lambda$collectDirtyTagsToSave$9(Map,RegistryOps,SavedDataType,Optional)
- void lambda$readSavedData$0(SavedDataType,String)
+ void lambda$scheduleSave$0(List)
- void lambda$scheduleSave$1(List)
+ void lambda$scheduleSave$3(Map$Entry)
- void lambda$scheduleSave$4(Map$Entry)
- void set(SavedDataType,SavedData)
+ void set(String,SavedData)
+ void tryWrite(Path,CompoundTag)
- void tryWrite(SavedDataType,CompoundTag)
```
...
```diff
+ void lambda$setTagData$3(CompoundTag,Tag)
+ void lambda$setTagData$4(DataResult$Error)
```
...
- Optional lambda$static$0(Score)
- Optional lambda$static$1(Score)
+ Score read(CompoundTag,HolderLookup$Provider)
- void <clinit>()
- void <init>(int,boolean,Optional,Optional)
+ void lambda$read$1(Score,Component)
+ void lambda$read$2(Score,NumberFormat)
+ void lambda$write$0(CompoundTag,Tag)
```
...
```diff
- List packPlayerScores()
+ ListTag savePlayerScores(HolderLookup$Provider)
- Scoreboard$PackedScore lambda$packPlayerScores$5(String,Map$Entry)
- Stream lambda$packPlayerScores$6(Map$Entry)
...
- void loadObjective(Objective$Packed)
- void loadPlayerScore(Scoreboard$PackedScore)
+ void loadPlayerScores(ListTag,HolderLookup$Provider)
- void loadPlayerTeam(PlayerTeam$Packed)
```
...
```diff
- int lambda$static$0(Team$CollisionRule)
- int lambda$static$1(Team$CollisionRule)
- String getSerializedName()
+ String lambda$static$0(Team$CollisionRule)
+ Team$CollisionRule byName(String)
+ Team$CollisionRule lambda$static$1(Team$CollisionRule)
```
...
+ Optional lambda$byName$0(String,int,StatType)
- Optional lambda$byName$2(String,int,StatType)
