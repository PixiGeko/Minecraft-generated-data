...
<table><tr><th></th><th align="left">23w33a</th><th>23w35a</th></tr><tr><td>World version</td><td><code>3570</code></td><td><code>3571</code></td></tr><tr><td>Protocol version</td><td><code>1073741970</code></td><td><code>1073741971</code></td></tr></table>
</details>
...
```
commands.random.error.range_too_large: RThe range of the random value must be at most 2147483646
commands.random.error.range_too_small: RThe range of the random value must be at least 2
gui.abuseReport.type.chat: Chat mMessages
gui.abuseReport.type.name: Player nName
gui.abuseReport.type.skin: Player sSkin
mco.selectServer.loading: Loading Realm ls List
options.accessibility.narrator_hotkey.tooltip: Allows the nNarrator to be toggled on and off with 'Ctrl+B'
pack.dropRejected.message: FThe following entries were not valid packs and were not copied:\n %s
selectWorld.loading_list: Loading wWorld lList
symlink_warning.title.pack: Added pack(s) contain(s) symbolic links
symlink_warning.title.world: WThe world folder contains symbolic links
```
