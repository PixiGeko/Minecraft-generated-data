## Comparison with [25w07a](https://github.com/PixiGeko/Minecraft-generated-data/tree/25w07a)
...
<br/>
<table><tr><th></th><th align="left">25w07a</th><th>25w08a</th></tr><tr><td>DataPack version</td><td><pre>67</pre></td><td><pre>68</pre></td></tr><tr><td>ResourcePack version</td><td><pre>52</pre></td><td><pre>53</pre></td></tr><tr><td>World version</td><td><pre>4315</pre></td><td><pre>4316</pre></td></tr><tr><td>Protocol version</td><td><pre>1073742058</pre></td><td><pre>1073742059</pre></td></tr></table>
</details>
<hr/>
...
```diff
+ minecraft/wolf_sound_variant/angry.json
+ minecraft/wolf_sound_variant/big.json
+ minecraft/wolf_sound_variant/classic.json
+ minecraft/wolf_sound_variant/cute.json
+ minecraft/wolf_sound_variant/grumpy.json
+ minecraft/wolf_sound_variant/puglin.json
+ minecraft/wolf_sound_variant/sad.json
```
...
+ minecraft/textures/entity/sheep/sheep_wool.png
+ minecraft/textures/item/allay_spawn_egg.png
+ minecraft/textures/item/armadillo_spawn_egg.png
+ minecraft/textures/item/axolotl_spawn_egg.png
+ minecraft/textures/item/bat_spawn_egg.png
+ minecraft/textures/item/bee_spawn_egg.png
+ minecraft/textures/item/blaze_spawn_egg.png
+ minecraft/textures/item/bogged_spawn_egg.png
+ minecraft/textures/item/breeze_spawn_egg.png
+ minecraft/textures/item/camel_spawn_egg.png
+ minecraft/textures/item/cat_spawn_egg.png
+ minecraft/textures/item/cave_spider_spawn_egg.png
+ minecraft/textures/item/chicken_spawn_egg.png
+ minecraft/textures/item/cod_spawn_egg.png
+ minecraft/textures/item/cow_spawn_egg.png
+ minecraft/textures/item/creaking_spawn_egg.png
+ minecraft/textures/item/creeper_spawn_egg.png
+ minecraft/textures/item/dolphin_spawn_egg.png
+ minecraft/textures/item/donkey_spawn_egg.png
+ minecraft/textures/item/drowned_spawn_egg.png
+ minecraft/textures/item/elder_guardian_spawn_egg.png
+ minecraft/textures/item/ender_dragon_spawn_egg.png
+ minecraft/textures/item/enderman_spawn_egg.png
+ minecraft/textures/item/endermite_spawn_egg.png
+ minecraft/textures/item/evoker_spawn_egg.png
+ minecraft/textures/item/fox_spawn_egg.png
+ minecraft/textures/item/frog_spawn_egg.png
+ minecraft/textures/item/ghast_spawn_egg.png
+ minecraft/textures/item/glow_squid_spawn_egg.png
+ minecraft/textures/item/goat_spawn_egg.png
+ minecraft/textures/item/guardian_spawn_egg.png
+ minecraft/textures/item/hoglin_spawn_egg.png
+ minecraft/textures/item/horse_spawn_egg.png
+ minecraft/textures/item/husk_spawn_egg.png
+ minecraft/textures/item/iron_golem_spawn_egg.png
+ minecraft/textures/item/leaf_litter.png
+ minecraft/textures/item/llama_spawn_egg.png
+ minecraft/textures/item/magma_cube_spawn_egg.png
+ minecraft/textures/item/mooshroom_spawn_egg.png
+ minecraft/textures/item/mule_spawn_egg.png
+ minecraft/textures/item/ocelot_spawn_egg.png
+ minecraft/textures/item/panda_spawn_egg.png
+ minecraft/textures/item/parrot_spawn_egg.png
+ minecraft/textures/item/phantom_spawn_egg.png
+ minecraft/textures/item/pig_spawn_egg.png
+ minecraft/textures/item/piglin_brute_spawn_egg.png
+ minecraft/textures/item/piglin_spawn_egg.png
+ minecraft/textures/item/pillager_spawn_egg.png
+ minecraft/textures/item/polar_bear_spawn_egg.png
+ minecraft/textures/item/pufferfish_spawn_egg.png
+ minecraft/textures/item/rabbit_spawn_egg.png
+ minecraft/textures/item/ravager_spawn_egg.png
+ minecraft/textures/item/salmon_spawn_egg.png
+ minecraft/textures/item/sheep_spawn_egg.png
+ minecraft/textures/item/shulker_spawn_egg.png
+ minecraft/textures/item/silverfish_spawn_egg.png
+ minecraft/textures/item/skeleton_horse_spawn_egg.png
+ minecraft/textures/item/skeleton_spawn_egg.png
+ minecraft/textures/item/slime_spawn_egg.png
+ minecraft/textures/item/sniffer_spawn_egg.png
+ minecraft/textures/item/snow_golem_spawn_egg.png
- minecraft/textures/item/spawn_egg_overlay.png
- minecraft/textures/item/spawn_egg.png
+ minecraft/textures/item/spider_spawn_egg.png
+ minecraft/textures/item/squid_spawn_egg.png
+ minecraft/textures/item/stray_spawn_egg.png
+ minecraft/textures/item/strider_spawn_egg.png
+ minecraft/textures/item/tadpole_spawn_egg.png
+ minecraft/textures/item/trader_llama_spawn_egg.png
+ minecraft/textures/item/tropical_fish_spawn_egg.png
+ minecraft/textures/item/turtle_spawn_egg.png
+ minecraft/textures/item/vex_spawn_egg.png
+ minecraft/textures/item/villager_spawn_egg.png
+ minecraft/textures/item/vindicator_spawn_egg.png
+ minecraft/textures/item/wandering_trader_spawn_egg.png
+ minecraft/textures/item/warden_spawn_egg.png
+ minecraft/textures/item/witch_spawn_egg.png
+ minecraft/textures/item/wither_skeleton_spawn_egg.png
+ minecraft/textures/item/wither_spawn_egg.png
+ minecraft/textures/item/wolf_spawn_egg.png
+ minecraft/textures/item/zoglin_spawn_egg.png
+ minecraft/textures/item/zombie_horse_spawn_egg.png
+ minecraft/textures/item/zombie_spawn_egg.png
+ minecraft/textures/item/zombie_villager_spawn_egg.png
+ minecraft/textures/item/zombified_piglin_spawn_egg.png
```
...
```
```
XXX.worldgen.biome.OverworldBiomes +1M -1M | +1P
```
```
XXX.minecraft.sounds.SoundEvents +3M | +1P -7P
```
```
XXX.ai.goal.BegGoal +1M -1M | +1P -1P
```
```
...
```diff
- DataComponentType$Builder lambda$static$95(DataComponentType$Builder)
```
...
```diff
- Map registerWolfSoundVariants()
- WolfSoundVariant lambda$registerWolfSoundVariants$2(WolfSoundVariants$SoundSet)
- WolfSoundVariants$SoundSet lambda$registerWolfSoundVariants$1(WolfSoundVariants$SoundSet)
```
...
```diff
- BiomeSpecialEffects$Builder dryFoliageColorOverride(int)
```
...
```
XXX.blaze3d.platform.GlStateManager -3M
```
```
XXX.blaze3d.platform.NativeImage -5M
```
```
XXX.blaze3d.platform.TextureUtil +3M -3M
```
```
XXX.blaze3d.systems.RenderSystem +2M -2M | +1P
```
```
...
```diff
+ void _getTexImage(int,int,int,int,long)
+ void _glDrawPixels(int,int,int,int,long)
+ void _readPixels(int,int,int,int,int,int,ByteBuffer)
```
...
```diff
+ void applyToAllPixels(IntUnaryOperator)
+ void downloadDepthBuffer(float)
+ void downloadTexture(int,boolean)
+ void drawPixels()
+ void flipY()
```
...
- void writeAsPNG(Path,String,GpuTexture,int,IntUnaryOperator)
+ void writeAsPNG(Path,String,int,int,int,int,IntUnaryOperator)
+ void writeAsPNG(Path,String,int,int,int,int)
```
...
+ void pixelStore(int,int)
- void queueFencedTask(Runnable)
+ void readPixels(int,int,int,int,int,int,ByteBuffer)
```
