...
<tr><th>Asset index</th><td><a href="https://piston-meta.mojang.com/v1/packages/cbe801caf1919eb053be7e39422752061e98972e/15.json">https://piston-meta.mojang.com/v1/packages/cbe801caf1919eb053be7e39422752061e98972e/15.json</a></td></tr>
<tr><th>Server</th><td><a href="https://piston-data.mojang.com/v1/objects/846d3fe65b6dab3f8bf929a601e1f83d801d919c/server.jar">https://piston-data.mojang.com/v1/objects/846d3fe65b6dab3f8bf929a601e1f83d801d919c/server.jar</a></td></tr>
...
<tr><th>Client</th><td><a href="https://piston-data.mojang.com/v1/objects/b8bfe382f0f721d58a179035d90617e15909efb4/client.jar">https://piston-data.mojang.com/v1/objects/b8bfe382f0f721d58a179035d90617e15909efb4/client.jar</a></td></tr>
<tr><th>Client mappings</th><td><a href="https://piston-data.mojang.com/v1/objects/f36439c5d1c2780962a4561b6eee4ba4fb244ad9/client.txt">https://piston-data.mojang.com/v1/objects/f36439c5d1c2780962a4561b6eee4ba4fb244ad9/client.txt</a></td></tr>
<tr><td colspan="2" align="center"><img width="0" height="0"><br/>
...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/24w13a">24w13a</a>
...
+ net.minecraft.advancements.critereon.PotatoPredicate
+ net.minecraft.advancements.critereon.PotatoRefinementTrigger$ItemStackPredicate
+ net.minecraft.advancements.critereon.PotatoRefinementTrigger$StandardItemStackPredicate
+ net.minecraft.advancements.critereon.PotatoRefinementTrigger$Type
...
+ net.minecraft.advancements.critereon.ThrowLubricatedTrigger$TriggerInstance
...
+ net.minecraft.client.grid.ClientSubGrid
+ net.minecraft.client.grid.SubGridMeshBuilder$BlockView
+ net.minecraft.client.grid.SubGridRenderer
...
+ net.minecraft.client.gui.screens.inventory.PotatoRefineryScreen
+ net.minecraft.client.gui.screens.PotatoPoemScreen$CreditsReader
+ net.minecraft.client.gui.screens.SproutRespawnScreen
...
+ net.minecraft.client.renderer.DimensionSpecialEffects$PotatoEffects
...
+ net.minecraft.client.renderer.entity.BatatoRenderer
- net.minecraft.client.renderer.entity.BatRenderer
+ net.minecraft.client.renderer.entity.GridCarrierEntityRenderer
...
+ net.minecraft.client.renderer.entity.layers.MegaSpudArmorLayer
...
+ net.minecraft.client.renderer.entity.MegaSpudRenderer
...
+ net.minecraft.client.renderer.entity.PoisonousPotatoZombieRenderer
...
+ net.minecraft.data.advancements.packs.PoisonousPotatoAdvancements
...
+ net.minecraft.data.worldgen.biome.PotatoBiomes
+ net.minecraft.data.worldgen.BiomeDefaultFeatures
- net.minecraft.data.worldgen.BootstrapContext
+ net.minecraft.data.worldgen.Carvers
+ net.minecraft.data.worldgen.ColosseumPieces
+ net.minecraft.data.worldgen.PotatoVillagePools
...
+ net.minecraft.network.protocol.game.ClientboundSoundSequencePacket
...
+ net.minecraft.server.level.ServerLevel$1Builder
...
+ net.minecraft.util.ExtraCodecs$9
...
+ net.minecraft.world.entity.animal.Pig$1
...
+ net.minecraft.world.entity.ExperienceOrb$PlayerTarget
...
+ net.minecraft.world.entity.monster.Guardian$2
+ net.minecraft.world.entity.monster.Guardian$4
+ net.minecraft.world.entity.monster.Guardian$6
...
+ net.minecraft.world.entity.monster.MegaSpud
+ net.minecraft.world.entity.monster.MegaSpud$GhastShootFireballGoal
+ net.minecraft.world.entity.monster.MegaSpud$SlimeMoveControl
+ net.minecraft.world.entity.monster.MegaSpud$Stage
...
+ net.minecraft.world.entity.projectile.LashingPotatoHook
+ net.minecraft.world.entity.projectile.package-info
+ net.minecraft.world.entity.projectile.VineProjectile
...
+ net.minecraft.world.grid.GridCarrier
+ net.minecraft.world.grid.SubGrid
+ net.minecraft.world.grid.SubGridBlocks$1
+ net.minecraft.world.grid.SubGridLightEngine
+ net.minecraft.world.grid.SubGridMovementCollider
- net.minecraft.world.InteractionHand
+ net.minecraft.world.InteractionResult
- net.minecraft.world.InteractionResultHolder
+ net.minecraft.world.inventory.FletchingMenu
+ net.minecraft.world.inventory.FletchingMenu$IngredientsSlot
...
+ net.minecraft.world.inventory.PoisonousPotatoCutterMenu
+ net.minecraft.world.inventory.PoisonousPotatoCutterMenu$2
+ net.minecraft.world.inventory.PotatoRefineryMenu$FuelSlot
...
+ net.minecraft.world.item.component.SnekComponent
...
+ net.minecraft.world.item.crafting.PotatoRefinementRecipe
...
+ net.minecraft.world.item.HotPotatoItem
...
+ net.minecraft.world.item.PoisonousPotatoPlantItem
+ net.minecraft.world.item.PotatoEyeItem
+ net.minecraft.world.item.PotatoOfKnowledgeItem
+ net.minecraft.world.item.PotatoPeelerItem
...
+ net.minecraft.world.level.biome.MultiNoiseBiomeSourceParameterList$Preset$3
+ net.minecraft.world.level.block.BigBrainBlock
...
+ net.minecraft.world.level.block.entity.BigBrainBlockEntity
...
+ net.minecraft.world.level.block.entity.FletchingBlockEntity
+ net.minecraft.world.level.block.entity.FletchingBlockEntity$Fletching
+ net.minecraft.world.level.block.entity.InventoryHeatComponent
...
+ net.minecraft.world.level.block.entity.LubricationComponent
+ net.minecraft.world.level.block.entity.package-info
+ net.minecraft.world.level.block.entity.PotatoBaneComponent
+ net.minecraft.world.level.block.entity.PotatoRefineryBlockEntity$1
+ net.minecraft.world.level.block.entity.PotatoRefineryBlockEntity$NormalRecipe
+ net.minecraft.world.level.block.entity.PotatoRefineryBlockEntity$SomeKindOfRecipe
...
+ net.minecraft.world.level.block.FloataterBlock
...
+ net.minecraft.world.level.block.PotatoBatteryBlock
- net.minecraft.world.level.block.PotatoBlock
+ net.minecraft.world.level.block.PotatoPeelsBlock
+ net.minecraft.world.level.block.PotatoRefineryBlock
+ net.minecraft.world.level.block.PotatoZombieHeadBlock
...
+ net.minecraft.world.level.block.StrongRootsBlock$FoundPos
...
+ net.minecraft.world.level.block.WeakRootsBlock
...
+ net.minecraft.world.level.levelgen.feature.DripstoneUtilsFlex
...
+ net.minecraft.world.level.levelgen.feature.ParkLaneSurfaceFeature
+ net.minecraft.world.level.levelgen.feature.PotatoBudsFeature
...
+ net.minecraft.world.level.levelgen.placement.CloudPlacement
...
+ net.minecraft.world.level.lighting.LayerLightEventListener$ConstantLayer
...
<details><summary>net.minecraft.client.renderer.DimensionSpecialEffects</summary>
...
<details><summary>net.minecraft.client.renderer.entity.ElderGuardianRenderer</summary>
...
<details><summary>net.minecraft.client.renderer.texture.atlas.SpriteSources</summary>
...
<details><summary>net.minecraft.client.resources.metadata.gui.GuiSpriteScaling$NineSlice$Border</summary>
...
<details><summary>net.minecraft.core.component.DataComponentMap</summary>
...
<details><summary>net.minecraft.core.dispenser.DispenseItemBehavior$1</summary>
...
<details><summary>net.minecraft.core.dispenser.DispenseItemBehavior$13</summary>
...
<details><summary>net.minecraft.core.dispenser.DispenseItemBehavior$15</summary>
...
<details><summary>net.minecraft.core.dispenser.DispenseItemBehavior$4</summary>
...
<details><summary>net.minecraft.core.dispenser.DispenseItemBehavior$6</summary>
...
<details><summary>net.minecraft.network.chat.ComponentSerialization</summary>
...
<details><summary>net.minecraft.network.chat.SignableCommand</summary>
...
<details><summary>net.minecraft.network.codec.ByteBufCodecs$4</summary>
...
<details><summary>net.minecraft.network.codec.ByteBufCodecs$6</summary>
...
<details><summary>net.minecraft.network.codec.ByteBufCodecs$8</summary>
...
<details><summary>net.minecraft.network.codec.StreamCodec$13</summary>
...
<details><summary>net.minecraft.network.protocol.game.CommonPlayerSpawnInfo</summary>
...
<details><summary>net.minecraft.server.commands.RaidCommand</summary>
...
<details><summary>net.minecraft.stats.StatFormatter</summary>
...
<details><summary>net.minecraft.util.ExtraCodecs$7</summary>
...
<details><summary>net.minecraft.util.KeyDispatchDataCodec</summary>
...
<details><summary>net.minecraft.world.entity.monster.breeze.LongJump</summary>
...
<details><summary>net.minecraft.world.inventory.EnchantmentMenu</summary>
...
<details><summary>net.minecraft.world.item.CreativeModeTabs</summary>
...
<details><summary>net.minecraft.world.item.WindChargeItem</summary>
...
<details><summary>net.minecraft.world.item.alchemy.PotionContents</summary>
...
<details><summary>net.minecraft.world.level.block.entity.ComparatorBlockEntity</summary>
...
<details><summary>net.minecraft.world.level.block.entity.trialspawner.TrialSpawnerData</summary>
...
<details><summary>net.minecraft.world.level.block.entity.trialspawner.TrialSpawnerState$ParticleEmission</summary>
...
<details><summary>net.minecraft.world.level.block.entity.vault.VaultBlockEntity$Client</summary>
...
<details><summary>net.minecraft.world.level.block.entity.vault.VaultState</summary>
...
<details><summary>net.minecraft.world.level.block.entity.vault.VaultState$2</summary>
...
<details><summary>net.minecraft.world.level.block.entity.vault.VaultState$4</summary>
...
<details><summary>net.minecraft.world.level.chunk.ChunkGenerators</summary>
...
<details><summary>net.minecraft.world.level.levelgen.feature.LargeDripstoneFeature$LargeDripstone</summary>
...
+ net.minecraft.core.dispenser.DispenseItemBehavior$30
...
+ net.minecraft.data.advancements.packs.PoisonousPotatoAdvancements$ExtendedBuilder
...
+ net.minecraft.data.worldgen.ColosseumMobs
+ net.minecraft.data.worldgen.ColosseumPools
...
+ net.minecraft.network.protocol.game.ClientboundAddSubGridPacket
+ net.minecraft.network.protocol.game.ClientboundBossEventPacket$UpdateCenterAndRadiusOperation
...
+ net.minecraft.network.protocol.game.ClientboundSoundSequencePacket$DelayedSound
...
<details><summary>net.minecraft.core.component.DataComponentPredicate</summary>
...
<details><summary>net.minecraft.core.component.DataComponentType</summary>
...
<details><summary>net.minecraft.core.dispenser.DispenseItemBehavior$2</summary>
...
<details><summary>net.minecraft.core.dispenser.DispenseItemBehavior$8</summary>
...
<details><summary>net.minecraft.core.particles.ColorParticleOption</summary>
...
<details><summary>net.minecraft.core.particles.ParticleTypes$1</summary>
...
<details><summary>net.minecraft.network.chat.SignedMessageChain$DecodeException</summary>
...
<details><summary>net.minecraft.network.codec.ByteBufCodecs$10</summary>
...
<details><summary>net.minecraft.network.codec.ByteBufCodecs$12</summary>
...
<details><summary>net.minecraft.network.codec.ByteBufCodecs$14</summary>
...
<details><summary>net.minecraft.network.codec.ByteBufCodecs$16</summary>
...
<details><summary>net.minecraft.network.codec.ByteBufCodecs$18</summary>
...
<details><summary>net.minecraft.network.codec.ByteBufCodecs$21</summary>
...
<details><summary>net.minecraft.network.codec.ByteBufCodecs$23</summary>
...
<details><summary>net.minecraft.network.codec.ByteBufCodecs$25</summary>
...
<details><summary>net.minecraft.network.codec.ByteBufCodecs$27</summary>
...
<details><summary>net.minecraft.resources.RegistryDataLoader</summary>
...
<details><summary>net.minecraft.server.packs.PathPackResources</summary>
...
<details><summary>net.minecraft.world.ContainerHelper</summary>
...
<details><summary>net.minecraft.world.effect.BadOmenMobEffect</summary>
...
<details><summary>net.minecraft.world.entity.monster.Bogged</summary>
...
<details><summary>net.minecraft.world.item.ArrowItem</summary>
...
<details><summary>net.minecraft.world.item.MaceItem</summary>
...
<details><summary>net.minecraft.world.item.SpectralArrowItem</summary>
...
<details><summary>net.minecraft.world.item.ThrowablePotionItem</summary>
...
<details><summary>net.minecraft.world.item.crafting.ShapedRecipe$Serializer</summary>
...
<details><summary>net.minecraft.world.item.crafting.ShapelessRecipe$Serializer</summary>
...
<details><summary>net.minecraft.world.item.crafting.SimpleCraftingRecipeSerializer</summary>
...
<details><summary>net.minecraft.world.item.crafting.SingleItemRecipe$Serializer</summary>
...
<details><summary>net.minecraft.world.item.crafting.SmithingTransformRecipe$Serializer</summary>
...
<details><summary>net.minecraft.world.item.crafting.SmithingTrimRecipe$Serializer</summary>
...
<details><summary>net.minecraft.world.level.block.PipeBlock</summary>
...
<details><summary>net.minecraft.world.level.block.entity.TrialSpawnerBlockEntity</summary>
...
<details><summary>net.minecraft.world.level.gameevent.EntityPositionSource$Type</summary>
...
<details><summary>net.minecraft.world.level.levelgen.SurfaceRules$ConditionSource</summary>
...
<details><summary>net.minecraft.world.level.levelgen.SurfaceRules$RuleSource</summary>
...
<details><summary>net.minecraft.world.level.levelgen.VerticalAnchor</summary>
...
<details><summary>net.minecraft.world.level.levelgen.WorldDimensions</summary>
...
<details><summary>net.minecraft.world.level.levelgen.heightproviders.HeightProviderType</summary>
...
<details><summary>net.minecraft.world.level.levelgen.structure.Structure$GenerationContext</summary>
...
<details><summary>net.minecraft.world.level.levelgen.structure.Structure$StructureSettings</summary>
...
<details><summary>net.minecraft.world.level.levelgen.structure.placement.StructurePlacementType</summary>
...
<details><summary>net.minecraft.world.level.levelgen.structure.pools.StructurePoolElementType</summary>
...
<details><summary>net.minecraft.world.level.levelgen.structure.pools.alias.RandomGroup</summary>
...
<details><summary>net.minecraft.world.level.levelgen.structure.structures.RuinedPortalStructure$Setup</summary>
...
<details><summary>net.minecraft.world.level.levelgen.structure.templatesystem.RuleTestType</summary>
...
<details><summary>net.minecraft.world.level.storage.loot.functions.ListOperation</summary>
...
<details><summary>net.minecraft.world.level.storage.loot.providers.number.LootNumberProviderType</summary>
...
<details><summary>net.minecraft.world.level.storage.loot.providers.number.NumberProviders</summary>
...
<details><summary>:warning:  minecraft-generated/  :warning:</summary>
...
+ minecraft/font/include/potato.json
+ minecraft/font/potatis.ttf
...
<details><summary>block_type.txt</summary>
...
<details><summary>creative_mode_tab.txt</summary>
...
<details><summary>data_component_type.txt</summary>
...
<details><summary>entity_sub_predicate_type.txt</summary>
...
<details><summary>painting_variant.txt</summary>
...
<details><summary>trigger_type.txt</summary>
...
<details><summary>villager_type.txt</summary>
...
<details><summary>worldgen/placement_modifier_type.txt</summary>
...
```diff
+ blocks/grows_potatoes.json
+ blocks/mineable/potone.json
+ blocks/poisonous_potato_ores.json
+ blocks/potatostone_base.json
- damage_type/is_player_attack.json
- items/enchantable/fire_aspect.json
- items/enchantable/sharp_weapon.json
+ items/heatable_potatos.json
+ painting_variant/potato.json
+ worldgen/biome/has_structure/colosseum.json
+ worldgen/biome/has_structure/ruined_portatols.json
+ worldgen/biome/has_structure/village_potato.json
+ worldgen/biome/is_potato.json
+ worldgen/structure/colosseum.json
+ worldgen/structure/ruined_portatol.json
```

</details>


<details><summary>blocks/animals_spawnable_on.json</summary>
...
<details><summary>blocks/armadillo_spawnable_on.json</summary>
...
<details><summary>blocks/beacon_base_blocks.json</summary>
...
<details><summary>blocks/campfires.json</summary>
...
<details><summary>blocks/ceiling_hanging_signs.json</summary>
...
<details><summary>blocks/combination_step_sound_blocks.json</summary>
...
<details><summary>blocks/convertable_to_mud.json</summary>
...
<details><summary>blocks/copper_ores.json</summary>
...
<details><summary>blocks/diamond_ores.json</summary>
...
<details><summary>blocks/foxes_spawnable_on.json</summary>
...
<details><summary>blocks/iron_ores.json</summary>
...
<details><summary>blocks/lapis_ores.json</summary>
...
```diff
+ #minecraft:poisonous_potato_ores
+ minecraft:amber_block
+ minecraft:compressed_poisonous_potato_block
+ minecraft:double_compressed_poisonous_potato_block
+ minecraft:floatater
...
<details><summary>blocks/needs_iron_tool.json</summary>
...
<details><summary>blocks/nylium.json</summary>
...
<details><summary>blocks/parrots_spawnable_on.json</summary>
...
<details><summary>blocks/portals.json</summary>
...
<details><summary>blocks/rabbits_spawnable_on.json</summary>
...
<details><summary>blocks/redstone_ores.json</summary>
...
<details><summary>blocks/replaceable.json</summary>
...
<details><summary>blocks/smelts_to_glass.json</summary>
...
<details><summary>blocks/snaps_goat_horn.json</summary>
...
<details><summary>blocks/sniffer_diggable_block.json</summary>
...
<details><summary>blocks/sword_efficient.json</summary>
...
<details><summary>blocks/valid_spawn.json</summary>
...
<details><summary>blocks/wall_hanging_signs.json</summary>
...
<details><summary>blocks/wolves_spawnable_on.json</summary>
...
```diff
+ minecraft:potato_magic
```

</details>


<details><summary>damage_type/is_projectile.json</summary>
...
<details><summary>entity_types/aquatic.json</summary>
...
<details><summary>entity_types/can_breathe_under_water.json</summary>
...
<details><summary>entity_types/fall_damage_immune.json</summary>
...
<details><summary>entity_types/not_scary_for_pufferfish.json</summary>
...
<details><summary>entity_types/zombies.json</summary>
...
<details><summary>items/beacon_payment_items.json</summary>
...
<details><summary>items/chest_armor.json</summary>
...
<details><summary>items/copper_ores.json</summary>
...
<details><summary>items/diamond_ores.json</summary>
...
<details><summary>items/enchantable/durability.json</summary>
...
<details><summary>items/enchantable/equippable.json</summary>
...
<details><summary>items/enchantable/weapon.json</summary>
...
<details><summary>items/foot_armor.json</summary>
...
<details><summary>items/hanging_signs.json</summary>
...
<details><summary>items/iron_ores.json</summary>
...
<details><summary>items/lapis_ores.json</summary>
...
<details><summary>items/parrot_poisonous_food.json</summary>
...
<details><summary>items/redstone_ores.json</summary>
...
<details><summary>items/smelts_to_glass.json</summary>
...
<details><summary>items/trim_materials.json</summary>
...
<details><summary>painting_variant/placeable.json</summary>
...
<details><summary>worldgen/biome/has_structure/buried_treasure.json</summary>
...
<details><summary>worldgen/biome/has_structure/shipwreck.json</summary>
...
<details><summary>worldgen/biome/has_structure/swamp_hut.json</summary>
...
<details><summary>worldgen/biome/snow_golem_melts.json</summary>
...
<details><summary>worldgen/biome/without_patrol_spawns.json</summary>
...
<details><summary>worldgen/structure/village.json</summary>

```diff
+ minecraft:village_potato
```
...
+ options.potatoFont: Potato Font
+ options.potatoFont.tooltip: Makes the font potato
...
```diff
+ potato/all_potatoed.json
+ potato/bring_home_the_corruption.json
+ potato/craft_poisonous_potato_chips.json
+ potato/craft_poisonous_potato_fries.json
+ potato/craft_poisonous_potato_slices.json
+ potato/craft_poisonous_potato_sticks.json
+ potato/eat_armor.json
+ potato/enter_the_potato.json
+ potato/get_oily.json
+ potato/get_peeled.json
+ potato/good_plant.json
+ potato/lubricate_boots.json
+ potato/lubricate_whee.json
+ potato/lubricate.json
+ potato/mega_lubricate_whee.json
+ potato/mega_lubricate.json
+ potato/peel_all_the_things.json
+ potato/poisonous_potato_gourmet.json
+ potato/poisonous_potato_taster.json
+ potato/potato_peeler.json
+ potato/root.json
+ potato/rumbled.json
+ potato/sweet_potato_talker.json
+ potato/well_done.json
+ recipes/building_blocks/amber_block.json
+ recipes/building_blocks/baked_potato_brick_slab_from_baked_potato_bricks_stonecutting.json
+ recipes/building_blocks/baked_potato_brick_slab.json
+ recipes/building_blocks/baked_potato_brick_stairs_from_baked_potato_bricks_stonecutting.json
+ recipes/building_blocks/baked_potato_brick_stairs.json
+ recipes/building_blocks/baked_potato_brick_wall_from_baked_potato_bricks_stonecutting.json
+ recipes/building_blocks/baked_potato_bricks.json
+ recipes/building_blocks/charred_baked_potato_brick_slab_from_charred_baked_potato_bricks_stonecutting.json
+ recipes/building_blocks/charred_baked_potato_brick_slab.json
+ recipes/building_blocks/charred_baked_potato_brick_stairs_from_charred_baked_potato_bricks_stonecutting.json
+ recipes/building_blocks/charred_baked_potato_brick_stairs.json
+ recipes/building_blocks/charred_baked_potato_brick_wall_from_charred_baked_potato_bricks_stonecutting.json
+ recipes/building_blocks/charred_baked_potato_bricks.json
+ recipes/building_blocks/compressed_poisonous_potato_block.json
+ recipes/building_blocks/double_compressed_poisonous_potato_block.json
+ recipes/building_blocks/expired_baked_potato_brick_slab_from_expired_baked_potato_bricks_stonecutting.json
+ recipes/building_blocks/expired_baked_potato_brick_slab.json
+ recipes/building_blocks/expired_baked_potato_brick_stairs_from_expired_baked_potato_bricks_stonecutting.json
+ recipes/building_blocks/expired_baked_potato_brick_stairs.json
+ recipes/building_blocks/expired_baked_potato_brick_wall_from_expired_baked_potato_bricks_stonecutting.json
+ recipes/building_blocks/expired_baked_potato_bricks.json
+ recipes/building_blocks/floatato.json
+ recipes/building_blocks/poisonous_potato_block.json
+ recipes/building_blocks/potato_planks.json
+ recipes/building_blocks/potato_slab.json
+ recipes/building_blocks/potato_stairs.json
+ recipes/building_blocks/potone_slab_from_potone_stonecutting.json
+ recipes/building_blocks/potone_slab.json
+ recipes/building_blocks/potone_stairs_from_potone_stonecutting.json
+ recipes/building_blocks/potone_stairs.json
+ recipes/building_blocks/potone_wall_from_potone_stonecutting.json
+ recipes/building_blocks/potone.json
+ recipes/building_blocks/quadruple_compressed_poisonous_potato_block.json
+ recipes/building_blocks/taterstone_slab_from_taterstone_stonecutting.json
+ recipes/building_blocks/taterstone_slab.json
+ recipes/building_blocks/taterstone_stairs_from_taterstone_stonecutting.json
+ recipes/building_blocks/taterstone_stairs.json
+ recipes/building_blocks/taterstone_wall_from_taterstone_stonecutting.json
+ recipes/building_blocks/triple_compressed_poisonous_potato_block.json
+ recipes/combat/big_brain.json
+ recipes/combat/poisonous_pota_toes.json
+ recipes/combat/poisonous_potato_chestplate.json
+ recipes/combat/vicious_potato.json
+ recipes/decorations/baked_potato_brick_wall.json
+ recipes/decorations/charred_baked_potato_brick_wall.json
+ recipes/decorations/expired_baked_potato_brick_wall.json
+ recipes/decorations/poisonous_potato_cutter.json
+ recipes/decorations/potato_fence.json
+ recipes/decorations/potato_hanging_sign.json
+ recipes/decorations/potato_sign.json
+ recipes/decorations/potone_wall.json
+ recipes/decorations/taterstone_wall.json
+ recipes/food/baked_potato_bricks_from_terredepomme.json
+ recipes/food/compressed_poisonous_potato_block_from_double_compressed_poisonous_potato_block_unpacking.json
+ recipes/food/double_compressed_poisonous_potato_block_from_triple_compressed_poisonous_potato_block_unpacking.json
+ recipes/food/enchanted_golden_poisonous_potato.json
+ recipes/food/golden_poisonous_potato.json
+ recipes/food/hash_browns_from_campfire_cooking.json
+ recipes/food/hot_potato.json
+ recipes/food/poisonous_potato_block_from_compressed_poisonous_potato_block_unpacking.json
+ recipes/food/poisonous_potato_chips_from_campfire_cooking.json
+ recipes/food/poisonous_potato_chips_from_smoking.json
+ recipes/food/poisonous_potato_chips.json
+ recipes/food/poisonous_potato_fries_from_campfire_cooking.json
+ recipes/food/poisonous_potato_fries_from_smoking.json
+ recipes/food/poisonous_potato_fries.json
+ recipes/food/poisonous_potato_from_poisonous_potato_block_unpacking.json
+ recipes/food/poisonous_potato_slices_from_poisonous_potato_poisonous_potato_cutting.json
+ recipes/food/poisonous_potato_sticks_from_poisonous_potato_poisonous_potato_cutting.json
+ recipes/food/triple_compressed_poisonous_potato_block_from_quadruple_compressed_poisonous_potato_block_unpacking.json
+ recipes/misc/amber_gem.json
+ recipes/misc/black_potato_peels_block.json
+ recipes/misc/black_potato_peels.json
+ recipes/misc/blue_potato_peels_block.json
+ recipes/misc/blue_potato_peels.json
+ recipes/misc/brown_potato_peels_block.json
+ recipes/misc/brown_potato_peels.json
+ recipes/misc/corrupted_potato_peels.json
+ recipes/misc/cyan_potato_peels_block.json
+ recipes/misc/cyan_potato_peels.json
+ recipes/misc/gray_potato_peels_block.json
+ recipes/misc/gray_potato_peels.json
+ recipes/misc/green_potato_peels_block.json
+ recipes/misc/green_potato_peels.json
+ recipes/misc/light_blue_potato_peels_block.json
+ recipes/misc/light_blue_potato_peels.json
+ recipes/misc/light_gray_potato_peels_block.json
+ recipes/misc/light_gray_potato_peels.json
+ recipes/misc/lime_potato_peels_block.json
+ recipes/misc/lime_potato_peels.json
+ recipes/misc/magenta_potato_peels_block.json
+ recipes/misc/magenta_potato_peels.json
+ recipes/misc/orange_potato_peels_block.json
+ recipes/misc/orange_potato_peels.json
+ recipes/misc/overcooked_potatoes.json
+ recipes/misc/pink_potato_peels_block.json
+ recipes/misc/pink_potato_peels.json
+ recipes/misc/poisonous_polytra.json
+ recipes/misc/potato_eye.json
+ recipes/misc/potato_hammer.json
+ recipes/misc/potato_peels_block.json
+ recipes/misc/potato_peels.json
+ recipes/misc/purple_potato_peels_block.json
+ recipes/misc/purple_potato_peels.json
+ recipes/misc/red_potato_peels_block.json
+ recipes/misc/red_potato_peels.json
+ recipes/misc/toxic_resin.json
+ recipes/misc/yellow_potato_peels_block.json
+ recipes/misc/yellow_potato_peels.json
+ recipes/redstone/floatater.json
+ recipes/redstone/potato_battery.json
+ recipes/redstone/potato_button.json
+ recipes/redstone/potato_door.json
+ recipes/redstone/potato_fence_gate.json
+ recipes/redstone/potato_pressure_plate.json
+ recipes/redstone/potato_trapdoor.json
+ recipes/tools/corrupted_potato_peels_block.json
+ recipes/tools/frying_table.json
+ recipes/tools/lashing_potato.json
+ recipes/tools/potato_peeler.json
+ recipes/tools/potato_refinery.json
+ recipes/tools/trident.json
```
...
```diff
+ blocks/amber_block.json
+ blocks/baked_potato_brick_slab.json
+ blocks/baked_potato_brick_stairs.json
+ blocks/baked_potato_brick_wall.json
+ blocks/baked_potato_bricks.json
+ blocks/big_brain.json
+ blocks/black_potato_peels_block.json
+ blocks/blue_potato_peels_block.json
+ blocks/brown_potato_peels_block.json
+ blocks/charred_baked_potato_brick_slab.json
+ blocks/charred_baked_potato_brick_stairs.json
+ blocks/charred_baked_potato_brick_wall.json
+ blocks/charred_baked_potato_bricks.json
+ blocks/compressed_poisonous_potato_block.json
+ blocks/corrupted_peelgrass_block.json
+ blocks/corrupted_potato_peels_block.json
+ blocks/cyan_potato_peels_block.json
+ blocks/deepslate_poisonous_potato_ore.json
+ blocks/double_compressed_poisonous_potato_block.json
+ blocks/expired_baked_potato_brick_slab.json
+ blocks/expired_baked_potato_brick_stairs.json
+ blocks/expired_baked_potato_brick_wall.json
+ blocks/expired_baked_potato_bricks.json
+ blocks/floatater.json
+ blocks/floatato.json
+ blocks/frying_table.json
+ blocks/gravtater.json
+ blocks/gray_potato_peels_block.json
+ blocks/green_potato_peels_block.json
+ blocks/light_blue_potato_peels_block.json
+ blocks/light_gray_potato_peels_block.json
+ blocks/lime_potato_peels_block.json
+ blocks/magenta_potato_peels_block.json
+ blocks/orange_potato_peels_block.json
+ blocks/pedestal.json
+ blocks/peelgrass_block.json
+ blocks/pink_potato_peels_block.json
+ blocks/poison_farmland.json
+ blocks/poison_path.json
+ blocks/poisonous_mashed_potato.json
+ blocks/poisonous_potato_block.json
+ blocks/poisonous_potato_cutter.json
+ blocks/poisonous_potato_ore.json
+ blocks/poisonous_potato_zombie_head_block.json
+ blocks/poisonous_potato_zombie_head_hat.json
+ blocks/potato_battery.json
+ blocks/potato_bud.json
+ blocks/potato_button.json
+ blocks/potato_door.json
+ blocks/potato_fence_gate.json
+ blocks/potato_fence.json
+ blocks/potato_flower.json
+ blocks/potato_fruit.json
+ blocks/potato_hanging_sign.json
+ blocks/potato_leaves.json
+ blocks/potato_pedicule.json
+ blocks/potato_peels_block.json
+ blocks/potato_planks.json
+ blocks/potato_portal.json
+ blocks/potato_pressure_plate.json
+ blocks/potato_refinery.json
+ blocks/potato_sign.json
+ blocks/potato_slab.json
+ blocks/potato_sprouts.json
+ blocks/potato_stairs.json
+ blocks/potato_stem.json
+ blocks/potato_trapdoor.json
+ blocks/potone_copper_ore.json
+ blocks/potone_diamond_ore.json
+ blocks/potone_gold_ore.json
+ blocks/potone_iron_ore.json
+ blocks/potone_lapis_ore.json
+ blocks/potone_redstone_ore.json
+ blocks/potone_slab.json
+ blocks/potone_stairs.json
+ blocks/potone_wall.json
+ blocks/potone.json
+ blocks/potted_potato_flower.json
+ blocks/powerful_potato.json
+ blocks/purple_potato_peels_block.json
+ blocks/quadruple_compressed_poisonous_potato_block.json
+ blocks/red_potato_peels_block.json
+ blocks/resin_ore.json
+ blocks/strong_roots.json
+ blocks/taterstone_slab.json
+ blocks/taterstone_stairs.json
+ blocks/taterstone_wall.json
+ blocks/taterstone.json
+ blocks/terredepomme.json
+ blocks/triple_compressed_poisonous_potato_block.json
+ blocks/vicious_potato.json
+ blocks/weak_roots.json
+ blocks/yellow_potato_peels_block.json
+ chests/ruined_portatol.json
+ chests/simple_dungeon_potato.json
- chests/trial_chambers/reward_ominous_common.json
- chests/trial_chambers/reward_ominous_rare.json
- chests/trial_chambers/reward_ominous_unique.json
- chests/trial_chambers/reward_ominous.json
+ chests/village/village_potato_house.json
+ entities/batato.json
+ entities/mega_spud.json
+ entities/plaguewhale.json
+ entities/poisonous_potato_zombie.json
+ entities/sheep/potato/black.json
+ entities/sheep/potato/blue.json
+ entities/sheep/potato/brown.json
+ entities/sheep/potato/cyan.json
+ entities/sheep/potato/gray.json
+ entities/sheep/potato/green.json
+ entities/sheep/potato/light_blue.json
+ entities/sheep/potato/light_gray.json
+ entities/sheep/potato/lime.json
+ entities/sheep/potato/magenta.json
+ entities/sheep/potato/orange.json
+ entities/sheep/potato/pink.json
+ entities/sheep/potato/purple.json
+ entities/sheep/potato/red.json
+ entities/sheep/potato/white.json
+ entities/sheep/potato/yellow.json
+ entities/toxifin.json
- equipment/trial_chamber.json
- spawners/ominous/trial_chamber/consumables.json
- spawners/ominous/trial_chamber/key.json
- spawners/trial_chamber/items_to_drop_when_ominous.json
```
...
```diff
- block/cobweb/break1.ogg
- block/cobweb/break2.ogg
- block/cobweb/break3.ogg
- block/cobweb/break4.ogg
- block/cobweb/break5.ogg
- block/cobweb/break6.ogg
- block/cobweb/step1.ogg
- block/cobweb/step2.ogg
- block/cobweb/step3.ogg
- block/cobweb/step4.ogg
- block/cobweb/step5.ogg
- block/cobweb/step6.ogg
- block/trial_spawner/about_to_spawn_item.ogg
- block/trial_spawner/ambient_charged1.ogg
- block/trial_spawner/ambient_charged2.ogg
- block/trial_spawner/ambient_charged3.ogg
- block/trial_spawner/ambient_charged4.ogg
- block/trial_spawner/ambient_charged5.ogg
- block/trial_spawner/charge_activate.ogg
- block/trial_spawner/spawn_item_begin1.ogg
- block/trial_spawner/spawn_item_begin2.ogg
- block/trial_spawner/spawn_item_begin3.ogg
- block/trial_spawner/spawn_item1.ogg
- block/trial_spawner/spawn_item2.ogg
- block/trial_spawner/spawn_item3.ogg
- event/mob_effects/bad_omen.ogg
- event/mob_effects/raid_omen.ogg
- event/mob_effects/trial_omen.ogg
- item/ominous_bottle/dispose.ogg
```
...
```diff
+ colosseum/mobs/mega_spud.nbt
+ colosseum/mobs/plaguewhale.nbt
+ colosseum/mobs/toxifin.nbt
+ colosseum/treasure/bases/centers/center_0.nbt
+ colosseum/treasure/bases/centers/center_1.nbt
+ colosseum/treasure/bases/centers/center_2.nbt
+ colosseum/treasure/bases/centers/center_3.nbt
+ colosseum/treasure/bases/lava_basin.nbt
+ colosseum/treasure/big_air_full.nbt
+ colosseum/treasure/brains/center_brain.nbt
+ colosseum/treasure/connectors/center_to_wall_middle.nbt
+ colosseum/treasure/connectors/center_to_wall_top_entrance.nbt
+ colosseum/treasure/connectors/center_to_wall_top.nbt
+ colosseum/treasure/corners/bottom/corner_0.nbt
+ colosseum/treasure/corners/bottom/corner_1.nbt
+ colosseum/treasure/corners/edges/bottom.nbt
+ colosseum/treasure/corners/edges/middle.nbt
+ colosseum/treasure/corners/edges/top.nbt
+ colosseum/treasure/corners/middle/corner_0.nbt
+ colosseum/treasure/corners/middle/corner_1.nbt
+ colosseum/treasure/corners/top/corner_0.nbt
+ colosseum/treasure/corners/top/corner_1.nbt
+ colosseum/treasure/extensions/empty.nbt
+ colosseum/treasure/extensions/fire_room.nbt
+ colosseum/treasure/extensions/house_0.nbt
+ colosseum/treasure/extensions/house_1.nbt
+ colosseum/treasure/extensions/large_bridge_0.nbt
+ colosseum/treasure/extensions/large_bridge_1.nbt
+ colosseum/treasure/extensions/large_bridge_2.nbt
+ colosseum/treasure/extensions/large_bridge_3.nbt
+ colosseum/treasure/extensions/roofed_bridge.nbt
+ colosseum/treasure/extensions/small_bridge_0.nbt
+ colosseum/treasure/extensions/small_bridge_1.nbt
+ colosseum/treasure/extensions/small_bridge_2.nbt
+ colosseum/treasure/extensions/small_bridge_3.nbt
+ colosseum/treasure/roofs/center_roof.nbt
+ colosseum/treasure/roofs/corner_roof.nbt
+ colosseum/treasure/roofs/wall_roof.nbt
+ colosseum/treasure/stairs/lower_stairs.nbt
+ colosseum/treasure/walls/bottom/wall_0.nbt
+ colosseum/treasure/walls/bottom/wall_1.nbt
+ colosseum/treasure/walls/bottom/wall_2.nbt
+ colosseum/treasure/walls/bottom/wall_3.nbt
+ colosseum/treasure/walls/entrance_wall.nbt
+ colosseum/treasure/walls/lava_wall.nbt
+ colosseum/treasure/walls/mid/wall_0.nbt
+ colosseum/treasure/walls/mid/wall_1.nbt
+ colosseum/treasure/walls/mid/wall_2.nbt
+ colosseum/treasure/walls/outer/bottom_corner.nbt
+ colosseum/treasure/walls/outer/medium_outer_wall.nbt
+ colosseum/treasure/walls/outer/mid_corner.nbt
+ colosseum/treasure/walls/outer/outer_wall.nbt
+ colosseum/treasure/walls/outer/tall_outer_wall.nbt
+ colosseum/treasure/walls/outer/top_corner.nbt
+ colosseum/treasure/walls/top/main_entrance.nbt
+ colosseum/treasure/walls/top/wall_0.nbt
+ colosseum/treasure/walls/top/wall_1.nbt
+ ruined_portatol/giant_portal_1.nbt
+ ruined_portatol/giant_portal_2.nbt
+ ruined_portatol/giant_portal_3.nbt
+ ruined_portatol/portal_1.nbt
+ ruined_portatol/portal_10.nbt
+ ruined_portatol/portal_2.nbt
+ ruined_portatol/portal_3.nbt
+ ruined_portatol/portal_4.nbt
+ ruined_portatol/portal_5.nbt
+ ruined_portatol/portal_6.nbt
+ ruined_portatol/portal_7.nbt
+ ruined_portatol/portal_8.nbt
+ ruined_portatol/portal_9.nbt
+ trial_chambers/chamber/chamber_5.nbt
- trial_chambers/chamber/eruption.nbt
- trial_chambers/chamber/eruption/breeze_slice_1.nbt
- trial_chambers/chamber/eruption/center_1.nbt
- trial_chambers/chamber/eruption/quadrant_1.nbt
- trial_chambers/chamber/eruption/quadrant_2.nbt
- trial_chambers/chamber/eruption/quadrant_3.nbt
- trial_chambers/chamber/eruption/quadrant_4.nbt
- trial_chambers/chamber/eruption/quadrant_5.nbt
- trial_chambers/chamber/eruption/slice_1.nbt
- trial_chambers/chamber/eruption/slice_2.nbt
- trial_chambers/chamber/eruption/slice_3.nbt
- trial_chambers/chamber/pedestal/ominous_slice_1.nbt
- trial_chambers/chamber/slanted/ominous_upper_arm_1.nbt
- trial_chambers/corridor/atrium_1.nbt
- trial_chambers/corridor/atrium/bogged_relief.nbt
- trial_chambers/corridor/atrium/breeze_relief.nbt
- trial_chambers/corridor/atrium/grand_staircase_1.nbt
- trial_chambers/corridor/atrium/grand_staircase_2.nbt
- trial_chambers/corridor/atrium/grand_staircase_3.nbt
- trial_chambers/corridor/atrium/spider_relief.nbt
- trial_chambers/corridor/atrium/spiral_relief.nbt
+ trial_chambers/reward/connectors/default.nbt
+ trial_chambers/reward/default.nbt
- trial_chambers/reward/ominous_vault.nbt
- trial_chambers/reward/vault.nbt
+ village/potato/frying_table_1.nbt
+ village/potato/houses/plains_accessory_1.nbt
+ village/potato/houses/plains_animal_pen_1.nbt
+ village/potato/houses/plains_animal_pen_2.nbt
+ village/potato/houses/plains_animal_pen_3.nbt
+ village/potato/houses/plains_armorer_house_1.nbt
+ village/potato/houses/plains_big_house_1.nbt
+ village/potato/houses/plains_butcher_shop_1.nbt
+ village/potato/houses/plains_butcher_shop_2.nbt
+ village/potato/houses/plains_cartographer_1.nbt
+ village/potato/houses/plains_fisher_cottage_1.nbt
+ village/potato/houses/plains_fletcher_house_1.nbt
+ village/potato/houses/plains_large_farm_1.nbt
+ village/potato/houses/plains_library_1.nbt
+ village/potato/houses/plains_library_2.nbt
+ village/potato/houses/plains_masons_house_1.nbt
+ village/potato/houses/plains_medium_house_1.nbt
+ village/potato/houses/plains_medium_house_2.nbt
+ village/potato/houses/plains_meeting_point_4.nbt
+ village/potato/houses/plains_meeting_point_5.nbt
+ village/potato/houses/plains_shepherds_house_1.nbt
+ village/potato/houses/plains_small_farm_1.nbt
+ village/potato/houses/plains_small_house_1.nbt
+ village/potato/houses/plains_small_house_2.nbt
+ village/potato/houses/plains_small_house_3.nbt
+ village/potato/houses/plains_small_house_4.nbt
+ village/potato/houses/plains_small_house_5.nbt
+ village/potato/houses/plains_small_house_6.nbt
+ village/potato/houses/plains_small_house_7.nbt
+ village/potato/houses/plains_small_house_8.nbt
+ village/potato/houses/plains_stable_1.nbt
+ village/potato/houses/plains_stable_2.nbt
+ village/potato/houses/plains_tannery_1.nbt
+ village/potato/houses/plains_temple_3.nbt
+ village/potato/houses/plains_temple_4.nbt
+ village/potato/houses/plains_tool_smith_1.nbt
+ village/potato/houses/plains_weaponsmith_1.nbt
+ village/potato/houses/potato_maze.nbt
+ village/potato/plains_lamp_1.nbt
+ village/potato/streets/corner_01.nbt
+ village/potato/streets/corner_02.nbt
+ village/potato/streets/corner_03.nbt
+ village/potato/streets/crossroad_01.nbt
+ village/potato/streets/crossroad_02.nbt
+ village/potato/streets/crossroad_03.nbt
+ village/potato/streets/crossroad_04.nbt
+ village/potato/streets/crossroad_05.nbt
+ village/potato/streets/crossroad_06.nbt
+ village/potato/streets/straight_01.nbt
+ village/potato/streets/straight_02.nbt
+ village/potato/streets/straight_03.nbt
+ village/potato/streets/straight_04.nbt
+ village/potato/streets/straight_05.nbt
+ village/potato/streets/straight_06.nbt
+ village/potato/streets/turn_01.nbt
+ village/potato/terminators/terminator_01.nbt
+ village/potato/terminators/terminator_02.nbt
+ village/potato/terminators/terminator_03.nbt
+ village/potato/terminators/terminator_04.nbt
+ village/potato/town_centers/plains_fountain_01.nbt
+ village/potato/town_centers/plains_meeting_point_1.nbt
+ village/potato/town_centers/plains_meeting_point_2.nbt
+ village/potato/town_centers/plains_meeting_point_3.nbt
+ village/potato/villagers/baby.nbt
+ village/potato/villagers/nitwit.nbt
+ village/potato/villagers/unemployed.nbt
+ village/potato/well_bottom.nbt
+ village/potato/zombie/houses/plains_animal_pen_3.nbt
+ village/potato/zombie/houses/plains_big_house_1.nbt
+ village/potato/zombie/houses/plains_butcher_shop_2.nbt
+ village/potato/zombie/houses/plains_fletcher_house_1.nbt
+ village/potato/zombie/houses/plains_medium_house_1.nbt
+ village/potato/zombie/houses/plains_medium_house_2.nbt
+ village/potato/zombie/houses/plains_meeting_point_4.nbt
+ village/potato/zombie/houses/plains_meeting_point_5.nbt
+ village/potato/zombie/houses/plains_shepherds_house_1.nbt
+ village/potato/zombie/houses/plains_small_house_1.nbt
+ village/potato/zombie/houses/plains_small_house_2.nbt
+ village/potato/zombie/houses/plains_small_house_3.nbt
+ village/potato/zombie/houses/plains_small_house_4.nbt
+ village/potato/zombie/houses/plains_small_house_5.nbt
+ village/potato/zombie/houses/plains_small_house_6.nbt
+ village/potato/zombie/houses/plains_small_house_7.nbt
+ village/potato/zombie/houses/plains_small_house_8.nbt
+ village/potato/zombie/houses/plains_stable_1.nbt
+ village/potato/zombie/streets/corner_01.nbt
+ village/potato/zombie/streets/corner_02.nbt
+ village/potato/zombie/streets/corner_03.nbt
+ village/potato/zombie/streets/crossroad_01.nbt
+ village/potato/zombie/streets/crossroad_02.nbt
+ village/potato/zombie/streets/crossroad_03.nbt
+ village/potato/zombie/streets/crossroad_04.nbt
+ village/potato/zombie/streets/crossroad_05.nbt
+ village/potato/zombie/streets/crossroad_06.nbt
+ village/potato/zombie/streets/straight_01.nbt
+ village/potato/zombie/streets/straight_02.nbt
+ village/potato/zombie/streets/straight_03.nbt
+ village/potato/zombie/streets/straight_04.nbt
+ village/potato/zombie/streets/straight_05.nbt
+ village/potato/zombie/streets/straight_06.nbt
+ village/potato/zombie/streets/turn_01.nbt
+ village/potato/zombie/town_centers/plains_fountain_01.nbt
+ village/potato/zombie/town_centers/plains_meeting_point_1.nbt
+ village/potato/zombie/town_centers/plains_meeting_point_2.nbt
+ village/potato/zombie/town_centers/plains_meeting_point_3.nbt
+ village/potato/zombie/villagers/nitwit.nbt
+ village/potato/zombie/villagers/unemployed.nbt
```
...
```diff
+ block/amber_block.png
+ block/baked_potato_bricks.png
+ block/big_brain_front_back.png
+ block/big_brain_left_right.png
+ block/big_brain_top_bottom.png
+ block/black_potato_peels_block.png
+ block/blue_potato_peels_block.png
+ block/brown_potato_peels_block.png
+ block/charred_baked_potato_bricks.png
+ block/compressed_poisonous_potato_block.png
+ block/corrupted_peelgrass_block_side.png
+ block/corrupted_peelgrass_block.png
+ block/corrupted_potato_peels_block.png
+ block/cyan_potato_peels_block.png
+ block/deepslate_poisonous_potato_ore.png
+ block/double_compressed_poisonous_potato_block.png
+ block/expired_baked_potato_bricks.png
+ block/floatater_back_triggered.png
+ block/floatater_back.png
+ block/floatater_front.png
+ block/floatater_side.png
+ block/floatato.png
+ block/frying_table.png
+ block/gravtater.png
+ block/gray_potato_peels_block.png
+ block/green_potato_peels_block.png
+ block/light_blue_potato_peels_block.png
+ block/light_gray_potato_peels_block.png
+ block/lime_potato_peels_block.png
+ block/magenta_potato_peels_block.png
+ block/orange_potato_peels_block.png
+ block/pedestal.png
+ block/peelgrass_block_side.png
+ block/peelgrass_block_snow.png
+ block/peelgrass_block_top.png
+ block/pink_potato_peels_block.png
+ block/poison_farmland_moist.png
+ block/poison_farmland.png
+ block/poison_path_side.png
+ block/poison_path_top.png
+ block/poisonous_mashed_potato.png
+ block/poisonous_potato_block.png
+ block/poisonous_potato_ore.png
+ block/poisonous_potato_zombie_head_block_side.png
+ block/poisonous_potato_zombie_head_block_top.png
+ block/poisonous_potato_zombie_head_hat.png
+ block/potato_battery_inverted_top.png
+ block/potato_battery_side.png
+ block/potato_battery_top.png
+ block/potato_bud_down_base.png
+ block/potato_bud_down_frustum.png
+ block/potato_bud_down_middle.png
+ block/potato_bud_down_tip_merge.png
+ block/potato_bud_down_tip.png
+ block/potato_bud_up_base.png
+ block/potato_bud_up_frustum.png
+ block/potato_bud_up_middle.png
+ block/potato_bud_up_tip_merge.png
+ block/potato_bud_up_tip.png
+ block/potato_cutter_bottom.png
+ block/potato_cutter_saw.png
+ block/potato_cutter_side.png
+ block/potato_cutter_top.png
+ block/potato_door_bottom.png
+ block/potato_door_top.png
+ block/potato_flower.png
+ block/potato_fruit_bottom.png
+ block/potato_fruit_side.png
+ block/potato_fruit_top.png
+ block/potato_leaves.png
+ block/potato_pedicule.png
+ block/potato_peels_block.png
+ block/potato_planks.png
+ block/potato_portal.png
+ block/potato_refinery_front_on.png
+ block/potato_refinery_front.png
+ block/potato_refinery_side.png
+ block/potato_refinery_top.png
+ block/potato_sprouts.png
+ block/potato_stem_top.png
+ block/potato_stem.png
+ block/potato_trapdoor.png
+ block/potone_copper_ore.png
+ block/potone_diamond_ore.png
+ block/potone_gold_ore.png
+ block/potone_iron_ore.png
+ block/potone_lapis_ore.png
+ block/potone_redstone_ore.png
+ block/potone.png
+ block/powerful_potato.png
+ block/purple_potato_peels_block.png
+ block/quadruple_compressed_poisonous_potato_block.png
+ block/red_potato_peels_block.png
+ block/resin_ore.png
+ block/strong_roots.png
+ block/tater.png
+ block/taterstone.png
+ block/terredepomme.png
- block/trial_spawner_side_active_ominous.png
- block/trial_spawner_side_inactive_ominous.png
- block/trial_spawner_top_active_ominous.png
- block/trial_spawner_top_ejecting_reward_ominous.png
- block/trial_spawner_top_inactive_ominous.png
+ block/triple_compressed_poisonous_potato_block.png
- block/vault_bottom_ominous.png
- block/vault_front_ejecting_ominous.png
- block/vault_front_off_ominous.png
- block/vault_front_on_ominous.png
- block/vault_side_off_ominous.png
- block/vault_side_on_ominous.png
- block/vault_top_ejecting_ominous.png
- block/vault_top_ominous.png
+ block/vicious_potato_enabled.png
+ block/vicious_potato.png
+ block/weak_roots.png
+ block/yellow_potato_peels_block.png
+ entity/armadillo_potato.png
+ entity/batato.png
+ entity/bee/bee_angry_nectar_potato.png
+ entity/bee/bee_angry_potato.png
+ entity/bee/bee_nectar_potato.png
+ entity/bee/bee_potato.png
+ entity/bee/bee_stinger_potato.png
+ entity/chicken_potato.png
+ entity/cow/cow_potato.png
+ entity/creeper/creeper_potato.png
+ entity/enderman/enderman_potato.png
+ entity/pig/pig_hwat_potato.png
+ entity/pig/pig_potato.png
+ entity/plaguewhale.png
+ entity/poisonous_polytra.png
+ entity/sheep/sheep_fur_potato.png
+ entity/sheep/sheep_potato.png
+ entity/signs/hanging/potato.png
+ entity/signs/potato.png
+ entity/skeleton/skeleton_potato.png
+ entity/slime/mega_spud.png
+ entity/spider/spider_potato.png
+ entity/toxifin_beam.png
+ entity/toxifin.png
+ entity/villager/profession/armorer_potato.png
+ entity/villager/profession/butcher_potato.png
+ entity/villager/profession/cartographer_potato.png
+ entity/villager/profession/cleric_potato.png
+ entity/villager/profession/farmer_potato.png
+ entity/villager/profession/fisherman_potato.png
+ entity/villager/profession/fletcher_potato.png
+ entity/villager/profession/leatherworker_potato.png
+ entity/villager/profession/librarian_potato.png
+ entity/villager/profession/mason_potato.png
+ entity/villager/profession/nitwit_potato.png
+ entity/villager/profession/shepard_potato.png
+ entity/villager/profession/toolsmith_potato.png
+ entity/villager/profession/weaponsmith_potato.png
+ entity/villager/type/potato.png
+ entity/villager/villager_potato.png
+ entity/zombie_villager/type/potato.png
+ entity/zombie/husk_potato.png
+ entity/zombie/poisonous_potato_zombie.png
+ entity/zombie/zombie_potato.png
+ environment/poisonus_sun.png
+ environment/rain_potato.png
+ font/potato.png
+ gui/advancements/backgrounds/potato.png
+ gui/container/fletching.png
+ gui/container/potato_refinery.png
+ gui/hanging_signs/potato.png
+ gui/sprites/container/creative_inventory/tab_top_selected_8.png
+ gui/sprites/container/creative_inventory/tab_top_unselected_8.png
+ gui/sprites/container/fletching/progresss.png
+ gui/sprites/container/potato_refinery/burn_progress.png
+ gui/sprites/container/potato_refinery/lit_progress.png
+ item/amber_gem.png
+ item/black_potato_peels.png
+ item/blue_potato_peels.png
+ item/brown_potato_peels.png
+ item/corrupted_potato_peels.png
+ item/cyan_potato_peels.png
+ item/dent.png
+ item/golden_poisonous_potato.png
+ item/gray_potato_peels.png
+ item/green_potato_peels.png
+ item/hash_browns.png
+ item/hot_potato.png
+ item/imposter.png
+ item/lashing_potato_extended.png
+ item/lashing_potato.png
+ item/light_blue_potato_peels.png
+ item/light_gray_potato_peels.png
+ item/lime_potato_peels.png
+ item/magenta_potato_peels.png
- item/ominous_bottle.png
- item/ominous_trial_key.png
+ item/orange_potato_peels.png
+ item/pink_potato_peels.png
+ item/poisonous_polytra.png
+ item/poisonous_pota_toes.png
+ item/poisonous_potato_chestplate.png
+ item/poisonous_potato_chips.png
+ item/poisonous_potato_fries.png
+ item/poisonous_potato_slices.png
+ item/poisonous_potato_sticks.png
+ item/potato_bud.png
+ item/potato_door.png
+ item/potato_eye.png
+ item/potato_hammer.png
+ item/potato_hanging_sign.png
+ item/potato_of_knowledge.png
+ item/potato_pedicule.png
+ item/potato_peeler.png
+ item/potato_peels.png
+ item/potato_sign.png
+ item/potato_staff.png
+ item/purple_potato_peels.png
+ item/red_potato_peels.png
+ item/toxic_beam.png
+ item/toxic_resin.png
+ item/venomous_potato.png
+ item/yellow_potato_peels.png
- mob_effect/bad_omen_121.png
- mob_effect/infested.png
- mob_effect/oozing.png
- mob_effect/raid_omen.png
+ mob_effect/sticky.png
- mob_effect/trial_omen.png
- mob_effect/weaving.png
- mob_effect/wind_charged.png
+ models/armor/potato_layer_1.png
+ painting/abstractato.png
+ painting/burning_potato.png
+ painting/ceci.png
+ painting/mr_potato.png
+ painting/poisonous_potato.png
+ painting/potatoe.png
+ painting/ubiquitato.png
+ particle/footprint.png
- particle/infested.png
+ particle/lightning_0.png
+ particle/lightning_1.png
+ particle/lightning_2.png
+ particle/lightning_3.png
+ particle/lightning_4.png
+ particle/lightning_5.png
+ particle/lightning_6.png
+ particle/lightning_7.png
+ particle/lightning_potato.png
- particle/ominous_spawning.png
- particle/raid_omen.png
- particle/small_gust_0.png
- particle/small_gust_1.png
- particle/small_gust_2.png
- particle/small_gust_3.png
- particle/small_gust_4.png
- particle/small_gust_5.png
- particle/small_gust_6.png
- particle/trial_omen.png
- particle/trial_spawner_detection_ominous_0.png
- particle/trial_spawner_detection_ominous_1.png
- particle/trial_spawner_detection_ominous_2.png
- particle/trial_spawner_detection_ominous_3.png
- particle/trial_spawner_detection_ominous_4.png
+ trims/color_palettes/amber.png
```

</details>


<details><summary>trim_materials.txt</summary>
...
```diff
+ arboretum_trees.json
+ corrputed_buds.json
+ hash_well.json
+ large_potato_columns.json
+ large_potatostone.json
+ leaf_pile.json
+ mother_potato_tree.json
+ ore_amber.json
+ ore_gravtater.json
+ ore_poisonous_potato.json
+ ore_taterstone.json
+ park_lane_surface.json
+ park_lane.json
+ patch_potato.json
+ pile_potato_fruit.json
+ poison.json
+ potato_cloud.json
+ potato_field.json
+ potato_geode.json
+ potato_leaf.json
+ potato_sprouts.json
+ potato_tree_tall.json
+ potato_tree.json
+ small_debris_columns.json
+ twisted_potato.json
+ venomous_column.json
```

</details>


<details><summary>worldgen/multi_noise_biome_source_parameter_list.txt</summary>
...
+ large_potatostone.json
+ leaf_pile_hash.json
+ mother_potato_checked.json
+ mother_potato_tree.json
+ ore_amber.json
+ ore_copper_small.json
+ ore_gold_above_zero.json
+ ore_gravtater.json
+ ore_poisonous_potato.json
+ ore_tatterstone.json
+ park_lane_surface.json
+ park_lane.json
+ patch_dead_bush_2_all_levels.json
+ patch_potato_sparse.json
+ patch_potato.json
+ pile_potato_fruit.json
+ poison_pool.json
+ potato_checked.json
...
```diff
+ colosseum_veins.json
+ farm_potato.json
+ spoil_10_percent.json
+ spoil_20_percent.json
+ spoil_70_percent.json
+ street_potato.json
+ zombie_potato.json
```
...
```diff
+ colosseum.json
+ mineshaft_potato.json
+ ruined_portatol.json
+ village_potato.json
```
...
```diff
+ colosseum/mobs/mega_spud.json
+ colosseum/mobs/plaguewhale.json
+ colosseum/mobs/toxifin.json
+ colosseum/starts.json
+ colosseum/treasure/bases.json
+ colosseum/treasure/bases/centers.json
+ colosseum/treasure/brains.json
+ colosseum/treasure/connectors.json
+ colosseum/treasure/corners/bottom.json
+ colosseum/treasure/corners/edges.json
+ colosseum/treasure/corners/middle.json
+ colosseum/treasure/corners/top.json
+ colosseum/treasure/extensions/houses.json
+ colosseum/treasure/extensions/large_pool.json
+ colosseum/treasure/extensions/small_pool.json
+ colosseum/treasure/roofs.json
+ colosseum/treasure/stairs.json
+ colosseum/treasure/walls.json
+ colosseum/treasure/walls/bottom.json
+ colosseum/treasure/walls/mid.json
+ colosseum/treasure/walls/outer.json
+ colosseum/treasure/walls/top.json
+ village/potato/decor.json
+ village/potato/houses.json
+ village/potato/streets.json
+ village/potato/terminators.json
+ village/potato/town_centers.json
+ village/potato/trees.json
+ village/potato/villagers.json
+ village/potato/well_bottoms.json
+ village/potato/zombie/decor.json
+ village/potato/zombie/houses.json
+ village/potato/zombie/streets.json
+ village/potato/zombie/villagers.json
```
...
```diff
+ com.mojang:datafixerupper:6.0.12
- com.mojang:datafixerupper:7.0.13
```
