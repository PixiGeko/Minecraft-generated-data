...
<tr><th>Asset index</th><td><a href="https://piston-meta.mojang.com/v1/packages/f3528dd8a293cf8d51dd13ccaee94175b55d1785/17.json">https://piston-meta.mojang.com/v1/packages/f3528dd8a293cf8d51dd13ccaee94175b55d1785/17.json</a></td></tr>
...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/1.20.6">1.20.6</a>
...
<details><summary>net.minecraft.client.gui.screens.recipebook.OverlayRecipeComponent$OverlayRecipeButton</summary>
...
<details><summary>net.minecraft.client.particle.SingleQuadParticle</summary>
...
<details><summary>net.minecraft.client.resources.language.LanguageManager</summary>
...
<details><summary>net.minecraft.client.searchtree.SearchTree</summary>
...
<details><summary>net.minecraft.commands.arguments.item.ItemParser$1</summary>
...
<details><summary>net.minecraft.commands.arguments.item.ItemParser$State</summary>
...
<details><summary>net.minecraft.commands.arguments.item.ItemParser$Visitor</summary>
...
<details><summary>net.minecraft.data.loot.packs.TradeRebalanceChestLoot</summary>
...
<details><summary>net.minecraft.data.loot.packs.VanillaArchaeologyLoot</summary>
...
<details><summary>net.minecraft.data.loot.packs.VanillaChestLoot</summary>
...
<details><summary>net.minecraft.data.loot.packs.VanillaEquipmentLoot</summary>
...
<details><summary>net.minecraft.data.loot.packs.VanillaGiftLoot</summary>
...
<details><summary>net.minecraft.data.loot.packs.VanillaPiglinBarterLoot</summary>
...
<details><summary>net.minecraft.resources.RegistryDataLoader$RegistryData</summary>
...
<details><summary>net.minecraft.util.datafix.ExtraDataFixUtils</summary>
...
<details><summary>net.minecraft.util.datafix.fixes.FixProjectileStoredItem</summary>
...
<details><summary>net.minecraft.world.entity.animal.Sheep$1</summary>
...
<details><summary>net.minecraft.world.item.InstrumentItem</summary>
...
<details><summary>net.minecraft.world.item.ProjectileWeaponItem</summary>
...
<details><summary>net.minecraft.world.item.enchantment.Enchantment$Cost</summary>
...
<details><summary>net.minecraft.world.item.enchantment.EnchantmentInstance</summary>
...
<details><summary>net.minecraft.world.item.enchantment.ItemEnchantments$Mutable</summary>
...
<details><summary>net.minecraft.world.level.storage.loot.functions.EnchantRandomlyFunction$Builder</summary>
...
<details><summary>net.minecraft.world.level.storage.loot.functions.EnchantWithLevelsFunction$Builder</summary>
...
<details><summary>net.minecraft.world.level.storage.loot.functions.SetEnchantmentsFunction$Builder</summary>
...
<details><summary>net.minecraft.data.worldgen.biome.BiomeData</summary>
...
<details><summary>net.minecraft.world.entity.decoration.PaintingVariants</summary>
...
<details><summary>net.minecraft.world.entity.npc.VillagerTrades$EnchantBookForEmeralds</summary>
...
<details><summary>net.minecraft.world.entity.projectile.SpectralArrow</summary>
...
<details><summary>net.minecraft.world.item.crafting.RecipeManager$1</summary>
...
<details><summary>net.minecraft.world.item.crafting.ShapedRecipePattern</summary>
...
<details><summary>net.minecraft.world.item.crafting.SmithingTransformRecipe</summary>
...
<details><summary>net.minecraft.world.item.crafting.SmithingTrimRecipe</summary>
...
<details><summary>net.minecraft.world.item.crafting.SuspiciousStewRecipe</summary>
...
<details><summary>net.minecraft.world.level.storage.loot.predicates.LootItemCondition</summary>
...
<details><summary>loot_number_provider_type.txt</summary>
...
```diff
+ banner_pattern/pattern_item/flow.json
+ banner_pattern/pattern_item/guster.json
+ blocks/blocks_wind_charge_explosions.json
+ damage_type/breeze_immune_to.json
+ damage_type/burn_from_stepping.json
+ enchantment/curse.json
+ enchantment/double_trade_price.json
+ enchantment/exclusive_set/armor.json
+ enchantment/exclusive_set/boots.json
+ enchantment/exclusive_set/bow.json
+ enchantment/exclusive_set/crossbow.json
+ enchantment/exclusive_set/damage.json
+ enchantment/exclusive_set/mining.json
+ enchantment/exclusive_set/riptide.json
+ enchantment/in_enchanting_table.json
+ enchantment/non_treasure.json
+ enchantment/on_mob_spawn_equipment.json
+ enchantment/on_random_loot.json
+ enchantment/on_traded_equipment.json
+ enchantment/prevents_bee_spawns_when_mining.json
+ enchantment/prevents_decorated_pot_shattering.json
+ enchantment/prevents_ice_melting.json
+ enchantment/prevents_infested_spawns.json
+ enchantment/smelts_loot.json
+ enchantment/tradeable.json
+ enchantment/treasure.json
+ entity_types/can_turn_in_boats.json
+ entity_types/deflects_projectiles.json
+ entity_types/immune_to_infested.json
+ entity_types/immune_to_oozing.json
+ entity_types/no_anger_from_wind_charge.json
+ items/enchantable/mace.json
+ worldgen/biome/has_structure/trial_chambers.json
+ worldgen/structure/on_trial_chambers_maps.json
```

</details>


<details><summary>blocks/doors.json</summary>
...
<details><summary>blocks/trapdoors.json</summary>
...
<details><summary>damage_type/always_kills_armor_stands.json</summary>
...
<details><summary>damage_type/ignites_armor_stands.json</summary>
...
<details><summary>damage_type/is_fire.json</summary>
...
<details><summary>damage_type/no_knockback.json</summary>
...
<details><summary>enchantment/tooltip_order.json</summary>
...
<details><summary>entity_types/impact_projectiles.json</summary>
...
<details><summary>entity_types/redirectable_projectile.json</summary>
...
<details><summary>entity_types/skeletons.json</summary>
...
<details><summary>items/breaks_decorated_pots.json</summary>
...
<details><summary>items/doors.json</summary>
...
<details><summary>items/enchantable/fire_aspect.json</summary>
...
<details><summary>items/trapdoors.json</summary>
...
<details><summary>items/trim_templates.json</summary>
...
```diff
+ adventure/blowback.json
+ adventure/crafters_crafting_crafters.json
+ adventure/lighten_up.json
+ adventure/minecraft_trials_edition.json
+ adventure/overoverkill.json
+ adventure/revaulting.json
+ adventure/under_lock_and_key.json
+ adventure/who_needs_rockets.json
+ recipes/building_blocks/chiseled_copper_from_copper_block_stonecutting.json
+ recipes/building_blocks/chiseled_copper_from_cut_copper_stonecutting.json
+ recipes/building_blocks/chiseled_copper.json
+ recipes/building_blocks/chiseled_tuff_bricks_from_polished_tuff_stonecutting.json
+ recipes/building_blocks/chiseled_tuff_bricks_from_tuff_bricks_stonecutting.json
+ recipes/building_blocks/chiseled_tuff_bricks_from_tuff_stonecutting.json
+ recipes/building_blocks/chiseled_tuff_bricks.json
+ recipes/building_blocks/chiseled_tuff_from_tuff_stonecutting.json
+ recipes/building_blocks/chiseled_tuff.json
+ recipes/building_blocks/copper_grate_from_copper_block_stonecutting.json
+ recipes/building_blocks/copper_grate.json
+ recipes/building_blocks/exposed_chiseled_copper_from_exposed_copper_stonecutting.json
+ recipes/building_blocks/exposed_chiseled_copper_from_exposed_cut_copper_stonecutting.json
+ recipes/building_blocks/exposed_chiseled_copper.json
+ recipes/building_blocks/exposed_copper_grate_from_exposed_copper_stonecutting.json
+ recipes/building_blocks/exposed_copper_grate.json
+ recipes/building_blocks/oxidized_chiseled_copper_from_oxidized_copper_stonecutting.json
+ recipes/building_blocks/oxidized_chiseled_copper_from_oxidized_cut_copper_stonecutting.json
+ recipes/building_blocks/oxidized_chiseled_copper.json
+ recipes/building_blocks/oxidized_copper_grate_from_oxidized_copper_stonecutting.json
+ recipes/building_blocks/oxidized_copper_grate.json
+ recipes/building_blocks/polished_tuff_from_tuff_stonecutting.json
+ recipes/building_blocks/polished_tuff_slab_from_polished_tuff_stonecutting.json
+ recipes/building_blocks/polished_tuff_slab_from_tuff_stonecutting.json
+ recipes/building_blocks/polished_tuff_slab.json
+ recipes/building_blocks/polished_tuff_stairs_from_polished_tuff_stonecutting.json
+ recipes/building_blocks/polished_tuff_stairs_from_tuff_stonecutting.json
+ recipes/building_blocks/polished_tuff_stairs.json
+ recipes/building_blocks/polished_tuff.json
+ recipes/building_blocks/tuff_brick_slab_from_polished_tuff_stonecutting.json
+ recipes/building_blocks/tuff_brick_slab_from_tuff_bricks_stonecutting.json
+ recipes/building_blocks/tuff_brick_slab_from_tuff_stonecutting.json
+ recipes/building_blocks/tuff_brick_slab.json
+ recipes/building_blocks/tuff_brick_stairs_from_polished_tuff_stonecutting.json
+ recipes/building_blocks/tuff_brick_stairs_from_tuff_bricks_stonecutting.json
+ recipes/building_blocks/tuff_brick_stairs_from_tuff_stonecutting.json
+ recipes/building_blocks/tuff_brick_stairs.json
+ recipes/building_blocks/tuff_bricks_from_polished_tuff_stonecutting.json
+ recipes/building_blocks/tuff_bricks_from_tuff_stonecutting.json
+ recipes/building_blocks/tuff_bricks.json
+ recipes/building_blocks/tuff_slab_from_tuff_stonecutting.json
+ recipes/building_blocks/tuff_slab.json
+ recipes/building_blocks/tuff_stairs_from_tuff_stonecutting.json
+ recipes/building_blocks/tuff_stairs.json
+ recipes/building_blocks/waxed_chiseled_copper_from_honeycomb.json
+ recipes/building_blocks/waxed_chiseled_copper_from_waxed_copper_block_stonecutting.json
+ recipes/building_blocks/waxed_chiseled_copper_from_waxed_cut_copper_stonecutting.json
+ recipes/building_blocks/waxed_chiseled_copper.json
+ recipes/building_blocks/waxed_copper_bulb_from_honeycomb.json
+ recipes/building_blocks/waxed_copper_door_from_honeycomb.json
+ recipes/building_blocks/waxed_copper_grate_from_honeycomb.json
+ recipes/building_blocks/waxed_copper_grate_from_waxed_copper_block_stonecutting.json
+ recipes/building_blocks/waxed_copper_grate.json
+ recipes/building_blocks/waxed_copper_trapdoor_from_honeycomb.json
+ recipes/building_blocks/waxed_exposed_chiseled_copper_from_honeycomb.json
+ recipes/building_blocks/waxed_exposed_chiseled_copper_from_waxed_exposed_copper_stonecutting.json
+ recipes/building_blocks/waxed_exposed_chiseled_copper_from_waxed_exposed_cut_copper_stonecutting.json
+ recipes/building_blocks/waxed_exposed_chiseled_copper.json
+ recipes/building_blocks/waxed_exposed_copper_bulb_from_honeycomb.json
+ recipes/building_blocks/waxed_exposed_copper_door_from_honeycomb.json
+ recipes/building_blocks/waxed_exposed_copper_grate_from_honeycomb.json
+ recipes/building_blocks/waxed_exposed_copper_grate_from_waxed_exposed_copper_stonecutting.json
+ recipes/building_blocks/waxed_exposed_copper_grate.json
+ recipes/building_blocks/waxed_exposed_copper_trapdoor_from_honeycomb.json
+ recipes/building_blocks/waxed_oxidized_chiseled_copper_from_honeycomb.json
+ recipes/building_blocks/waxed_oxidized_chiseled_copper_from_waxed_oxidized_copper_stonecutting.json
+ recipes/building_blocks/waxed_oxidized_chiseled_copper_from_waxed_oxidized_cut_copper_stonecutting.json
+ recipes/building_blocks/waxed_oxidized_chiseled_copper.json
+ recipes/building_blocks/waxed_oxidized_copper_bulb_from_honeycomb.json
+ recipes/building_blocks/waxed_oxidized_copper_door_from_honeycomb.json
+ recipes/building_blocks/waxed_oxidized_copper_grate_from_honeycomb.json
+ recipes/building_blocks/waxed_oxidized_copper_grate_from_waxed_oxidized_copper_stonecutting.json
+ recipes/building_blocks/waxed_oxidized_copper_grate.json
+ recipes/building_blocks/waxed_oxidized_copper_trapdoor_from_honeycomb.json
+ recipes/building_blocks/waxed_weathered_chiseled_copper_from_honeycomb.json
+ recipes/building_blocks/waxed_weathered_chiseled_copper_from_waxed_weathered_copper_stonecutting.json
+ recipes/building_blocks/waxed_weathered_chiseled_copper_from_waxed_weathered_cut_copper_stonecutting.json
+ recipes/building_blocks/waxed_weathered_chiseled_copper.json
+ recipes/building_blocks/waxed_weathered_copper_bulb_from_honeycomb.json
+ recipes/building_blocks/waxed_weathered_copper_door_from_honeycomb.json
+ recipes/building_blocks/waxed_weathered_copper_grate_from_honeycomb.json
+ recipes/building_blocks/waxed_weathered_copper_grate_from_waxed_weathered_copper_stonecutting.json
+ recipes/building_blocks/waxed_weathered_copper_grate.json
+ recipes/building_blocks/waxed_weathered_copper_trapdoor_from_honeycomb.json
+ recipes/building_blocks/weathered_chiseled_copper_from_weathered_copper_stonecutting.json
+ recipes/building_blocks/weathered_chiseled_copper_from_weathered_cut_copper_stonecutting.json
+ recipes/building_blocks/weathered_chiseled_copper.json
+ recipes/building_blocks/weathered_copper_grate_from_weathered_copper_stonecutting.json
+ recipes/building_blocks/weathered_copper_grate.json
+ recipes/combat/mace.json
+ recipes/decorations/polished_tuff_wall_from_polished_tuff_stonecutting.json
+ recipes/decorations/polished_tuff_wall_from_tuff_stonecutting.json
+ recipes/decorations/polished_tuff_wall.json
+ recipes/decorations/tuff_brick_wall_from_polished_tuff_stonecutting.json
+ recipes/decorations/tuff_brick_wall_from_tuff_bricks_stonecutting.json
+ recipes/decorations/tuff_brick_wall_from_tuff_stonecutting.json
+ recipes/decorations/tuff_brick_wall.json
+ recipes/decorations/tuff_wall_from_tuff_stonecutting.json
+ recipes/decorations/tuff_wall.json
+ recipes/misc/bolt_armor_trim_smithing_template_smithing_trim.json
+ recipes/misc/bolt_armor_trim_smithing_template.json
+ recipes/misc/flow_armor_trim_smithing_template_smithing_trim.json
+ recipes/misc/flow_armor_trim_smithing_template.json
+ recipes/misc/wind_charge.json
+ recipes/redstone/copper_bulb.json
+ recipes/redstone/copper_door.json
+ recipes/redstone/copper_trapdoor.json
+ recipes/redstone/crafter.json
+ recipes/redstone/exposed_copper_bulb.json
+ recipes/redstone/oxidized_copper_bulb.json
+ recipes/redstone/waxed_copper_bulb.json
+ recipes/redstone/waxed_exposed_copper_bulb.json
+ recipes/redstone/waxed_oxidized_copper_bulb.json
+ recipes/redstone/waxed_weathered_copper_bulb.json
+ recipes/redstone/weathered_copper_bulb.json
```

</details>


<details><summary>banner_patterns.txt</summary>
...
+ block/trial_spawner/ambient_ominous1.ogg
+ block/trial_spawner/ambient_ominous2.ogg
+ block/trial_spawner/ambient_ominous3.ogg
+ block/trial_spawner/ambient_ominous4.ogg
+ block/trial_spawner/ambient_ominous5.ogg
- block/trial_spawner/charge_activate.ogg
+ block/trial_spawner/ominous_activate.ogg
+ music/game/deeper.ogg
+ music/game/eld_unknown.ogg
+ music/game/endless.ogg
+ music/game/featherfall.ogg
+ music/game/komorebi.ogg
+ music/game/pokopoko.ogg
+ music/game/puzzlebox.ogg
+ music/game/watcher.ogg
+ music/game/yakusoku.ogg
+ records/creator_music_box.ogg
+ records/creator.ogg
+ records/precipice.ogg
```
...
```diff
- trial_chambers/chamber/addon/10x15_pathway_3.nbt
- trial_chambers/chamber/addon/10x15_rise.nbt
- trial_chambers/chamber/addon/10x15_stacked_pathway.nbt
- trial_chambers/chamber/addon/c3_side_walkway_1.nbt
- trial_chambers/chamber/addon/c3_side_walkway_2.nbt
- trial_chambers/chamber/addon/closed_side_walkway.nbt
- trial_chambers/chamber/addon/corner_room_1.nbt
- trial_chambers/chamber/addon/full_column_ranged_spawner.nbt
- trial_chambers/chamber/addon/lower_walkway_platform.nbt
- trial_chambers/chamber/addon/middle_column_ranged_spawner.nbt
- trial_chambers/chamber/addon/middle_walkway.nbt
- trial_chambers/chamber/addon/platform_with_space.nbt
- trial_chambers/chamber/addon/side_walkway.nbt
- trial_chambers/chamber/addon/stairs_with_space_2.nbt
- trial_chambers/chamber/addon/stairs_with_space.nbt
- trial_chambers/chamber/addon/walkway_extension.nbt
+ trial_chambers/chamber/assembly/cover_7.nbt
+ trial_chambers/chamber/assembly/hanging_5.nbt
- trial_chambers/chamber/assembly/spawner_trap_1.nbt
+ trial_chambers/corridor/addon/display_1.nbt
+ trial_chambers/corridor/addon/display_2.nbt
+ trial_chambers/corridor/addon/display_3.nbt
+ trial_chambers/corridor/entrance_2.nbt
+ trial_chambers/corridor/entrance_3.nbt
- trial_chambers/spawner/melee/slime.nbt
+ trial_chambers/spawner/melee/spider.nbt
+ trial_chambers/spawner/small_melee/slime.nbt
- trial_chambers/spawner/small_melee/spider.nbt
```
...
```diff
+ item/music_disc_creator_music_box.png
+ item/music_disc_creator.png
+ item/music_disc_precipice.png
- mob_effect/bad_omen_121.png
+ painting/backyard.png
+ painting/baroque.png
+ painting/bouquet.png
+ painting/cavebird.png
+ painting/changing.png
+ painting/cotan.png
+ painting/endboss.png
+ painting/fern.png
+ painting/finding.png
+ painting/humble.png
+ painting/lowmist.png
+ painting/meditative.png
+ painting/orb.png
+ painting/owlemons.png
+ painting/passage.png
+ painting/pond.png
+ painting/prairie_ride.png
+ painting/sunflowers.png
+ painting/tides.png
+ painting/unpacked.png
```

</details>


<details><summary>trim_patterns.txt</summary>
...
```diff
+ trial_chambers/atrium.json
+ trial_chambers/chamber/addon.json
+ trial_chambers/chamber/assembly.json
+ trial_chambers/chamber/end.json
+ trial_chambers/chamber/entrance_cap.json
+ trial_chambers/chamber/eruption.json
+ trial_chambers/chamber/pedestal.json
+ trial_chambers/chamber/slanted.json
+ trial_chambers/chambers/end.json
+ trial_chambers/chests/contents/supply.json
+ trial_chambers/chests/supply.json
+ trial_chambers/corridor.json
+ trial_chambers/corridor/slices.json
+ trial_chambers/corridors/addon/lower.json
+ trial_chambers/corridors/addon/middle_upper.json
+ trial_chambers/corridors/addon/middle.json
+ trial_chambers/decor.json
+ trial_chambers/decor/chamber.json
+ trial_chambers/dispensers/chamber.json
+ trial_chambers/entrance.json
+ trial_chambers/hallway.json
+ trial_chambers/hallway/fallback.json
+ trial_chambers/reward/all.json
+ trial_chambers/reward/contents/default.json
+ trial_chambers/reward/ominous_vault.json
+ trial_chambers/spawner/all.json
+ trial_chambers/spawner/breeze.json
+ trial_chambers/spawner/contents/breeze.json
+ trial_chambers/spawner/melee.json
+ trial_chambers/spawner/melee/husk.json
+ trial_chambers/spawner/melee/spider.json
+ trial_chambers/spawner/melee/zombie.json
+ trial_chambers/spawner/ranged.json
+ trial_chambers/spawner/ranged/poison_skeleton.json
+ trial_chambers/spawner/ranged/skeleton.json
+ trial_chambers/spawner/ranged/stray.json
+ trial_chambers/spawner/slow_ranged.json
+ trial_chambers/spawner/slow_ranged/poison_skeleton.json
+ trial_chambers/spawner/slow_ranged/skeleton.json
+ trial_chambers/spawner/slow_ranged/stray.json
+ trial_chambers/spawner/small_melee.json
+ trial_chambers/spawner/small_melee/baby_zombie.json
+ trial_chambers/spawner/small_melee/cave_spider.json
+ trial_chambers/spawner/small_melee/silverfish.json
+ trial_chambers/spawner/small_melee/slime.json
```
...
+ com.mojang:datafixerupper:7.1.15
```
