...
- argument.nbt.invalid
+ argument.time.invalid_unit
+ argument.time.not_nonnegative_integer
- arguments.nbtpath.child.invalid
- arguments.nbtpath.element.invalid
...
+ commands.drop.no_held_items
+ commands.drop.no_loot_table
