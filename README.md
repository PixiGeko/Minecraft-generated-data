...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/1.19-pre1">1.19-pre1</a>
...
<details><summary>net.minecraft.network.protocol.game.ClientboundChatPreviewPacket</summary>
...
```diff
+ worldgen/biome/mineshaft_blocking.json
```
