...
<tr><th>Asset index</th><td><a href="https://piston-meta.mojang.com/v1/packages/0b779bfa8ac3797a58f2f0f49612d4108a2316dc/16.json">https://piston-meta.mojang.com/v1/packages/0b779bfa8ac3797a58f2f0f49612d4108a2316dc/16.json</a></td></tr>
...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/24w12a">24w12a</a>
...
```diff
+ Collector toMutableList()
- Object getOrThrow(DataResult,Function)
- Object getPartialOrThrow(DataResult,Function)
...
<details><summary>net.minecraft.advancements.critereon.PlayerPredicate$AdvancementPredicate</summary>

```diff
+ Either lambda$static$0(PlayerPredicate$AdvancementPredicate)
- Either lambda$static$3(PlayerPredicate$AdvancementPredicate)
- PlayerPredicate$AdvancementPredicate lambda$static$2(Either)
- Record lambda$static$0(PlayerPredicate$AdvancementDonePredicate)
- Record lambda$static$1(PlayerPredicate$AdvancementCriterionsPredicate)
```

</details>


<details><summary>net.minecraft.advancements.critereon.PlayerPredicate$StatMatcher</summary>

```diff
- Codec createTypedCodec(StatType)
+ MapCodec createTypedCodec(StatType)
```
...
<details><summary>net.minecraft.client.multiplayer.chat.LoggedChatEvent$Type</summary>
...
+ MapCodec codec()
+ MapCodec lambda$static$0()
+ MapCodec lambda$static$1()
```

</details>


<details><summary>net.minecraft.client.particle.TerrainParticle</summary>

```diff
+ TerrainParticle createTerrainParticle(BlockParticleOption,ClientLevel,double,double,double,double,double,double)
```
...
+ CommandSourceStack lambda$performSignedChatCommand$9(CommandSigningContext,CommandSourceStack)
- Map collectSignedArguments(ServerboundChatCommandPacket,SignableCommand,LastSeenMessages)
+ Map collectSignedArguments(ServerboundChatCommandSignedPacket,SignableCommand,LastSeenMessages)
+ Map collectUnsignedArguments(List)
- Optional tryHandleChat(LastSeenMessages$Update)
+ SignedMessageChain$DecodeException createSignedArgumentMismatchException(String,List,List)
...
+ void lambda$handleChatCommand$7(ServerboundChatCommandPacket)
...
+ void lambda$handleSignedChatCommand$8(ServerboundChatCommandSignedPacket,Optional)
...
+ void performSignedChatCommand(ServerboundChatCommandSignedPacket,LastSeenMessages)
+ void performUnsignedChatCommand(String)
...
- DataResult encode(Map,DynamicOps,Object)
+ DataResult encode(Optional,DynamicOps,Object)
- DataResult encodeValue(Codec,Object,DynamicOps)
- DataResult lambda$decode$0(DynamicOps,Pair,Codec)
...
```diff
- TypeTemplate lambda$registerTypes$30(Map)
+ TypeTemplate lambda$registerTypes$30(Schema,Map)
```
...
```diff
- AABB getAABB(double,double,double)
+ AABB getSpawnAABB(double,double,double)
+ void <init>(EntityType$EntityFactory,MobCategory,boolean,boolean,boolean,boolean,ImmutableSet,EntityDimensions,float,int,int,FeatureFlagSet)
- void <init>(EntityType$EntityFactory,MobCategory,boolean,boolean,boolean,boolean,ImmutableSet,EntityDimensions,int,int,FeatureFlagSet)
```
...
```diff
+ EntityType$Builder spawnDimensionsScale(float)
```
...
<details><summary>net.minecraft.world.entity.projectile.windcharge.AbstractWindCharge</summary>
...
<details><summary>net.minecraft.world.entity.projectile.windcharge.BreezeWindCharge</summary>
...
```diff
+ Raid createOrExtendRaid(ServerPlayer,BlockPos)
- Raid createOrExtendRaid(ServerPlayer)
```
...
- void lambda$bootstrap$19(CreativeModeTab$Output,HolderLookup$RegistryLookup)
+ void lambda$bootstrap$22(CreativeModeTab$Output,CreativeModeTab$ItemDisplayParameters,HolderLookup$RegistryLookup)
- void lambda$bootstrap$22(CreativeModeTab$Output,HolderLookup$RegistryLookup)
...
```diff
- JigsawBlockEntity$JointType lambda$load$0()
...
```diff
- void lambda$load$2(SignText)
- void lambda$load$3(SignText)
+ void lambda$loadAdditional$2(SignText)
+ void lambda$loadAdditional$3(SignText)
- void load(CompoundTag,HolderLookup$Provider)
+ void loadAdditional(CompoundTag,HolderLookup$Provider)
```
...
+ void lambda$loadAdditional$3(String)
- void load(CompoundTag,HolderLookup$Provider)
+ void loadAdditional(CompoundTag,HolderLookup$Provider)
```
...
<details><summary>net.minecraft.world.level.block.entity.trialspawner.PlayerDetector</summary>

```diff
+ boolean inLineOfSight(Level,Vec3,Vec3)
+ boolean lambda$static$1(boolean,ServerLevel,BlockPos,Player)
- boolean lambda$static$2(BlockPos,double,Player)
+ boolean lambda$static$3(BlockPos,double,Player)
+ boolean lambda$static$4(boolean,ServerLevel,BlockPos,Player)
+ boolean lambda$static$6(boolean,ServerLevel,BlockPos,Sheep)
- List lambda$static$1(ServerLevel,PlayerDetector$EntitySelector,BlockPos,double)
+ List lambda$static$2(ServerLevel,PlayerDetector$EntitySelector,BlockPos,double,boolean)
- List lambda$static$3(ServerLevel,PlayerDetector$EntitySelector,BlockPos,double)
- List lambda$static$4(ServerLevel,PlayerDetector$EntitySelector,BlockPos,double)
+ List lambda$static$5(ServerLevel,PlayerDetector$EntitySelector,BlockPos,double,boolean)
+ List lambda$static$7(ServerLevel,PlayerDetector$EntitySelector,BlockPos,double,boolean)
```

</details>


<details><summary>net.minecraft.world.level.block.entity.trialspawner.TrialSpawner</summary>

```diff
+ boolean isOminous()
+ int getRequiredPlayerRange()
+ int getTargetCooldownLength()
+ TrialSpawner lambda$codec$0(TrialSpawnerConfig,TrialSpawnerConfig,TrialSpawnerData,Integer,Integer)
- TrialSpawner lambda$codec$0(TrialSpawnerConfig,TrialSpawnerData)
+ TrialSpawnerConfig getNormalConfig()
+ TrialSpawnerConfig getOminousConfig()
+ TrialSpawnerConfig getOminousConfigForSerialization()
+ void <init>(TrialSpawnerConfig,TrialSpawnerConfig,TrialSpawnerData,int,int,TrialSpawner$StateAccessor,PlayerDetector,PlayerDetector$EntitySelector)
- void <init>(TrialSpawnerConfig,TrialSpawnerData,TrialSpawner$StateAccessor,PlayerDetector,PlayerDetector$EntitySelector)
+ void addBecomeOminousParticles(Level,BlockPos,RandomSource)
+ void addDetectPlayerParticles(Level,BlockPos,RandomSource,int,ParticleOptions)
- void addDetectPlayerParticles(Level,BlockPos,RandomSource,int)
+ void addSpawnParticles(Level,BlockPos,RandomSource,SimpleParticleType)
- void addSpawnParticles(Level,BlockPos,RandomSource)
+ void applyOminous(ServerLevel,BlockPos)
+ void removeOminous(ServerLevel,BlockPos)
+ void tickClient(Level,BlockPos,boolean)
- void tickClient(Level,BlockPos)
+ void tickServer(ServerLevel,BlockPos,boolean)
- void tickServer(ServerLevel,BlockPos)
```
...
<details><summary>net.minecraft.world.level.storage.loot.providers.nbt.LootNbtProviderType</summary>
...
<details><summary>net.minecraft.world.level.storage.loot.providers.nbt.NbtProviders</summary>

```diff
+ Codec lambda$static$1()
- Codec lambda$static$2()
+ Either lambda$static$0(NbtProvider)
- Either lambda$static$1(NbtProvider)
- LootNbtProviderType register(String,Codec)
+ LootNbtProviderType register(String,MapCodec)
- NbtProvider lambda$static$0(Either)
```
...
+ Codec lambda$static$1()
- Codec lambda$static$2()
+ Either lambda$static$0(ScoreboardNameProvider)
- Either lambda$static$1(ScoreboardNameProvider)
- LootScoreProviderType register(String,Codec)
+ LootScoreProviderType register(String,MapCodec)
...
<details><summary>net.minecraft.util.ExtraCodecs$StrictUnboundedMapCodec</summary>

```diff
- String lambda$decode$0(DataResult,DataResult)
+ String lambda$decode$0(DataResult,String)
```
...
```diff
+ void spawnSmashAttackParticles(LevelAccessor,BlockPos,int)
```

</details>


<details><summary>net.minecraft.util.datafix.ComponentDataFixUtils</summary>

```diff
+ Optional extractTranslationString(String)
```
...
- Dynamic renameAndFixField(Dynamic,String,String,UnaryOperator)
...
<details><summary>net.minecraft.util.datafix.fixes.RenameEnchantmentsFix</summary>

```diff
+ Dynamic lambda$fixEnchantmentList$3(Dynamic,DataResult$Error)
- Dynamic lambda$fixEnchantmentList$3(Dynamic,DataResult$PartialResult)
+ Dynamic lambda$fixEnchantmentList$7(Dynamic,DataResult$Error)
- Dynamic lambda$fixEnchantmentList$7(Dynamic,DataResult$PartialResult)
```
...
```diff
+ FeatureFlagSet requiredFeatures()
+ Potion requiredFeatures(FeatureFlag[])
```
...
```diff
+ Position getDispensePosition(BlockSource,double,Vec3)
+ void registerProjectileBehavior(ItemLike)
```
...
- void lambda$load$1(BannerPatternLayers)
+ void lambda$loadAdditional$0(String)
+ void lambda$loadAdditional$1(BannerPatternLayers)
- void load(CompoundTag,HolderLookup$Provider)
+ void loadAdditional(CompoundTag,HolderLookup$Provider)
```
...
<details><summary>net.minecraft.world.level.block.entity.trialspawner.TrialSpawnerConfig</summary>

```diff
- int requiredPlayerRange()
- int targetCooldownLength()
+ long ticksBetweenItemSpawners()
+ ResourceKey itemsToDropWhenOminous()
+ void <init>(int,float,float,float,float,int,SimpleWeightedRandomList,SimpleWeightedRandomList,ResourceKey)
- void <init>(int,int,float,float,float,float,int,int,SimpleWeightedRandomList,SimpleWeightedRandomList)
```

</details>


<details><summary>net.minecraft.world.level.block.entity.trialspawner.TrialSpawnerState</summary>

```diff
+ boolean lambda$calculatePositionToSpawnSpawner$4(BlockPos,TrialSpawner,Player)
+ boolean lambda$selectEntityToSpawnItemAbove$5(BlockPos,TrialSpawner,Entity)
+ boolean timeToSpawnItemSpawner(ServerLevel,TrialSpawnerData)
+ Entity selectEntityToSpawnItemAbove(List,Set,TrialSpawner,BlockPos,ServerLevel)
+ Optional calculatePositionAbove(Entity,ServerLevel)
+ Optional calculatePositionToSpawnSpawner(ServerLevel,BlockPos,TrialSpawner,TrialSpawnerData)
+ void emitParticles(Level,BlockPos,boolean)
- void emitParticles(Level,BlockPos)
+ void lambda$spawnOminousOminousItemSpawner$3(ServerLevel,ItemStack,TrialSpawnerData,TrialSpawner,Vec3)
+ void spawnOminousOminousItemSpawner(ServerLevel,BlockPos,TrialSpawner)
```

</details>


<details><summary>net.minecraft.world.level.block.entity.vault.VaultBlockEntity</summary>

```diff
- void lambda$load$1(VaultConfig)
+ void lambda$loadAdditional$1(VaultConfig)
- void load(CompoundTag,HolderLookup$Provider)
+ void loadAdditional(CompoundTag,HolderLookup$Provider)
```
...
<details><summary>net.minecraft.world.level.block.entity.vault.VaultState$1</summary>
...
<details><summary>net.minecraft.world.level.block.entity.vault.VaultState$3</summary>
...
```diff
- Codec lambda$codec$2(Function,Object)
+ MapCodec lambda$codec$2(Function,Object)
```
...
<details><summary>net.minecraft.world.level.levelgen.placement.PlacementModifierType</summary>

```diff
- Codec lambda$register$0(Codec)
+ MapCodec lambda$register$0(MapCodec)
- PlacementModifierType register(String,Codec)
+ PlacementModifierType register(String,MapCodec)
```
