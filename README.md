...
```diff
- block.minecraft.blue_coral
- block.minecraft.blue_coral_fan
- block.minecraft.blue_coral_plant
- block.minecraft.blue_dead_coral
...
- block.minecraft.pink_coral
- block.minecraft.pink_coral_fan
- block.minecraft.pink_coral_plant
- block.minecraft.pink_dead_coral
- block.minecraft.purple_coral
- block.minecraft.purple_coral_fan
- block.minecraft.purple_coral_plant
- block.minecraft.purple_dead_coral
- block.minecraft.red_coral
- block.minecraft.red_coral_fan
- block.minecraft.red_coral_plant
- block.minecraft.red_dead_coral
+ block.minecraft.sea_pickle
+ block.minecraft.tube_coral
+ block.minecraft.tube_coral_block
+ block.minecraft.tube_coral_fan
- block.minecraft.yellow_coral
- block.minecraft.yellow_coral_fan
- block.minecraft.yellow_coral_plant
- block.minecraft.yellow_dead_coral
```
