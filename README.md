...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/18w31a">18w31a</a>
...
<details><summary>blocks/underwater_bonemeals.json</summary>
...
```diff
+ block/dead_brain_coral.png
+ block/dead_bubble_coral.png
+ block/dead_fire_coral.png
+ block/dead_horn_coral.png
+ block/dead_tube_coral.png
```
