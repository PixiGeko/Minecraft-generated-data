...
<tr><th>Asset index</th><td><a href="https://piston-meta.mojang.com/v1/packages/dde1698e4c39ca4e3b7af503419e1a18fd6ca781/15.json">https://piston-meta.mojang.com/v1/packages/dde1698e4c39ca4e3b7af503419e1a18fd6ca781/15.json</a></td></tr>
...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/24w10a">24w10a</a>
...
<details><summary>net.minecraft.advancements.critereon.SlimePredicate</summary>
...
<details><summary>net.minecraft.client.renderer.PostChain</summary>
...
<details><summary>net.minecraft.world.inventory.SlotRanges</summary>
...
```diff
+ blocks/heavy_core.json
+ chests/trial_chambers/reward_common.json
+ chests/trial_chambers/reward_rare.json
+ chests/trial_chambers/reward_unique.json
```
...
```diff
+ block/heavy_core/break1.ogg
+ block/heavy_core/break2.ogg
+ block/heavy_core/break3.ogg
+ block/heavy_core/break4.ogg
+ block/heavy_core/step1.ogg
+ block/heavy_core/step2.ogg
+ block/heavy_core/step3.ogg
+ block/heavy_core/step4.ogg
+ item/mace/smash_air1.ogg
+ item/mace/smash_air2.ogg
+ item/mace/smash_air3.ogg
+ item/mace/smash_ground1.ogg
+ item/mace/smash_ground2.ogg
+ item/mace/smash_ground3.ogg
+ item/mace/smash_ground4.ogg
```
...
+ trial_chambers/chamber/pedestal.nbt
+ trial_chambers/chamber/pedestal/center_1.nbt
+ trial_chambers/chamber/pedestal/quadrant_1.nbt
+ trial_chambers/chamber/pedestal/quadrant_2.nbt
+ trial_chambers/chamber/pedestal/quadrant_3.nbt
+ trial_chambers/chamber/pedestal/slice_1.nbt
+ trial_chambers/chamber/pedestal/slice_2.nbt
+ trial_chambers/chamber/pedestal/slice_3.nbt
+ trial_chambers/chamber/pedestal/slice_4.nbt
+ trial_chambers/chamber/pedestal/slice_5.nbt
+ trial_chambers/chamber/slanted.nbt
+ trial_chambers/chamber/slanted/center.nbt
+ trial_chambers/chamber/slanted/hallway_1.nbt
+ trial_chambers/chamber/slanted/hallway_2.nbt
+ trial_chambers/chamber/slanted/hallway_3.nbt
+ trial_chambers/chamber/slanted/hallway_4.nbt
+ trial_chambers/chamber/slanted/hallway_5.nbt
+ trial_chambers/chamber/slanted/quadrant_1.nbt
+ trial_chambers/chamber/slanted/quadrant_2.nbt
+ trial_chambers/chamber/slanted/quadrant_3.nbt
+ trial_chambers/chamber/slanted/quadrant_4.nbt
+ trial_chambers/chamber/slanted/ramp_1.nbt
+ trial_chambers/chamber/slanted/ramp_2.nbt
+ trial_chambers/chamber/slanted/ramp_3.nbt
+ trial_chambers/chamber/slanted/ramp_4.nbt
+ trial_chambers/decor/flow_pot.nbt
+ trial_chambers/decor/guster_pot.nbt
+ trial_chambers/decor/scrape_pot.nbt
```
...
```diff
+ block/heavy_core.png
+ entity/banner/flow.png
+ entity/banner/guster.png
+ entity/decorated_pot/flow_pottery_pattern.png
+ entity/decorated_pot/guster_pottery_pattern.png
+ entity/decorated_pot/scrape_pottery_pattern.png
+ entity/shield/flow.png
+ entity/shield/guster.png
+ gui/inworld_footer_separator.png
+ gui/inworld_header_separator.png
+ gui/inworld_menu_background.png
+ gui/inworld_menu_list_background.png
+ gui/tab_header_background.png
+ item/bolt_armor_trim_smithing_template.png
+ item/breeze_rod.png
+ item/flow_armor_trim_smithing_template.png
+ item/flow_banner_pattern.png
+ item/flow_pottery_sherd.png
+ item/guster_banner_pattern.png
+ item/guster_pottery_sherd.png
+ item/mace.png
+ item/scrape_pottery_sherd.png
+ misc/credits_vignette.png
+ trims/models/armor/bolt_leggings.png
+ trims/models/armor/bolt.png
+ trims/models/armor/flow_leggings.png
+ trims/models/armor/flow.png
```
