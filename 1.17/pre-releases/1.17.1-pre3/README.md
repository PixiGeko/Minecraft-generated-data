...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/1.17.1-pre2">1.17.1-pre2</a>
## Mappings
...
<details><summary>net.minecraft.world.entity.ai.behavior.RandomSwim</summary>

```diff
+ int[][] XY_DISTANCE_TIERS
+ void <clinit>()
```
...
```diff
+ TargetingConditions ATTACK_TARGET_CONDITIONS_IGNORE_INVISIBILITY_AND_LINE_OF_SIGHT
+ TargetingConditions ATTACK_TARGET_CONDITIONS_IGNORE_LINE_OF_SIGHT
+ boolean isEntityAttackableIgnoringLineOfSight(LivingEntity)
```
...
```diff
+ BlockState copyWaterloggedFrom(BlockState)
```
