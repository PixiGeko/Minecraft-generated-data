...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/1.17-pre2">1.17-pre2</a>
## File structure
...
+ VertexConsumer lambda$renderLevel$2(RenderType)
+ void lambda$renderLevel$1(Camera,float,boolean)
+ void lambda$renderShape$4(PoseStack$Pose,double,double,double,float,float,float,float,double,double,double,double,double,double)
+ void renderSky(Runnable)
...
- void lambda$renderShape$3(PoseStack$Pose,double,double,double,float,float,float,float,double,double,double,double,double,double)
- void renderSky(Matrix4f,float)
```
...
<details><summary>net.minecraft.resources.RegistryReadOps</summary>
...
+ void lambda$createMultiface$44(Condition$TerminalCondition)
+ void lambda$createMultiface$45(Function)
