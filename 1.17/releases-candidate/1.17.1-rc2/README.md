...
+ StrictQueue$IntRunnable lambda$submitTask$11(ProcessorHandle)
+ void lambda$close$12(ProcessorHandle)
+ void lambda$submitTask$10(Supplier)
- CompletableFuture synchronize()
- StrictQueue$IntRunnable lambda$close$11(ProcessorHandle)
- StrictQueue$IntRunnable lambda$submitTask$9(ProcessorHandle)
- void lambda$close$10(ProcessorHandle)
- void lambda$submitTask$8(Supplier)
```
...
```diff
+ ProcessorMailbox entityDeserializerQueue
...
<details><summary>net.minecraft.world.level.entity.EntityPersistentStorage</summary>
