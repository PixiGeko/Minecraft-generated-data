...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/1.16.5">1.16.5</a>
## File structure
...
+  minecraft/textures/entity/squid
...
+ recipes/building_blocks/dripstone_block.json
...
+ recipes/building_blocks/waxed_cut_copper.json
...
+ recipes/decorations/glow_item_frame.json
...
+ block/glow_item_frame.png
+ block/glow_lichen.png
...
+ RealmsPersistence newsLocalStorage
+ RepeatableTask liveStatsTask
+ RepeatableTask pendingInviteUpdateTask
+ RepeatableTask serverListUpdateTask
+ RepeatableTask trialAvailabilityTask
+ RepeatableTask unreadNewsTask
...
```diff
+ LevelChunk replaceWithPacketData(BitSet)
...
<details><summary>net.minecraft.client.particle.SquidInkParticle</summary>

```diff
+ void <init>(SpriteSet)
+ void <init>(SquidInkParticle$1)
- void <init>(SpriteSet)
- void <init>(SquidInkParticle$1)
```
...
<details><summary>net.minecraft.client.renderer.entity.HoglinRenderer</summary>
...
```diff
+ void <init>(HumanoidModel,float,float,float,float)
+ void <init>(HumanoidModel,float)
- void <init>(HumanoidModel,float,float,float,float)
- void <init>(HumanoidModel,float)
```
...
<details><summary>net.minecraft.client.renderer.entity.IllagerRenderer</summary>

```diff
+ void <init>(IllagerModel,float)
- void <init>(IllagerModel,float)
```
...
<details><summary>net.minecraft.client.renderer.entity.ItemEntityRenderer</summary>

```diff
+ void <init>(EntityRendererProvider$Context)
- void <init>(ItemRenderer)
```
...
+ BakedModel getModel(LivingEntity,int)
+ void <init>(BlockEntityWithoutLevelRenderer)
+ void renderAndDecorateItem(ItemStack,int,int,int)
+ void renderAndDecorateItem(ItemStack,int,int,int)
+ void renderStatic(Level,int,int,int)
+ void renderStatic(MultiBufferSource,int)
+ void tryRenderGuiItem(ItemStack,int,int,int)
- BakedModel getModel(LivingEntity)
- void <init>(ItemColors)
- void renderAndDecorateItem(ItemStack,int,int)
- void renderStatic(Level,int,int)
- void renderStatic(MultiBufferSource)
- void tryRenderGuiItem(ItemStack,int,int)
```
...
<details><summary>net.minecraft.client.renderer.entity.MinecartRenderer</summary>

```diff
+ void <init>(ModelLayerLocation)
- void <init>(EntityRenderDispatcher)
```

</details>

<details><summary>net.minecraft.client.renderer.entity.MushroomCowRenderer</summary>
...
<details><summary>net.minecraft.client.renderer.entity.PaintingRenderer</summary>
...
<details><summary>net.minecraft.client.renderer.entity.ParrotRenderer</summary>
...
<details><summary>net.minecraft.client.renderer.entity.PigRenderer</summary>
...
<details><summary>net.minecraft.client.renderer.entity.PillagerRenderer</summary>
...
<details><summary>net.minecraft.client.renderer.entity.PufferfishRenderer</summary>

```diff
+ EntityModel big
+ EntityModel mid
+ EntityModel small
- PufferfishBigModel big
- PufferfishMidModel mid
...
<details><summary>net.minecraft.client.renderer.entity.RavagerRenderer</summary>
...
<details><summary>net.minecraft.client.renderer.entity.SalmonRenderer</summary>
...
<details><summary>net.minecraft.client.renderer.entity.ShulkerBulletRenderer</summary>
...
<details><summary>net.minecraft.client.renderer.entity.SilverfishRenderer</summary>
...
<details><summary>net.minecraft.client.renderer.entity.SpectralArrowRenderer</summary>
...
```diff
+ void <init>(SquidModel)
- void <init>(EntityRenderDispatcher)
```

</details>

<details><summary>net.minecraft.client.renderer.entity.StriderRenderer</summary>
...
<details><summary>net.minecraft.client.renderer.entity.ThrownTridentRenderer</summary>
...
<details><summary>net.minecraft.client.renderer.entity.TntMinecartRenderer</summary>
...
<details><summary>net.minecraft.client.renderer.entity.TropicalFishRenderer</summary>

```diff
+ ColorableHierarchicalModel modelA
+ ColorableHierarchicalModel modelB
- TropicalFishModelA modelA
- TropicalFishModelB modelB
+ void <init>(EntityRendererProvider$Context)
- void <init>(EntityRenderDispatcher)
```
...
<details><summary>net.minecraft.client.renderer.entity.UndeadHorseRenderer</summary>
...
<details><summary>net.minecraft.client.renderer.entity.VillagerRenderer</summary>
...
<details><summary>net.minecraft.client.renderer.entity.WitchRenderer</summary>
...
<details><summary>net.minecraft.client.renderer.entity.WitherSkeletonRenderer</summary>
...
<details><summary>net.minecraft.client.renderer.entity.WolfRenderer</summary>
...
<details><summary>net.minecraft.client.renderer.entity.ZombieRenderer</summary>
...
<details><summary>net.minecraft.client.renderer.entity.layers.ArrowLayer</summary>
...
<details><summary>net.minecraft.client.renderer.entity.layers.CatCollarLayer</summary>
...
<details><summary>net.minecraft.client.renderer.entity.layers.HorseArmorLayer</summary>
...
+ BlockFamily family
+ Map models
+ BlockModelGenerators$BlockFamilyProvider access$2300(Block)
...
+ ResourceLocation getOrCreateModel(Block)
+ ResourceLocation lambda$getOrCreateModel$0(ModelTemplate)
+ void access$2200(Block)
+ void lambda$generateFor$1(Block)
+ void trapdoor(Block)
...
```diff
+ ModelTemplate CANDLE
+ ModelTemplate CANDLE_CAKE
+ ModelTemplate CAULDRON_FULL
+ ModelTemplate CAULDRON_LEVEL1
+ ModelTemplate CAULDRON_LEVEL2
+ ModelTemplate FOUR_CANDLES
+ ModelTemplate POINTED_DRIPSTONE
+ ModelTemplate THREE_CANDLES
+ ModelTemplate TWO_CANDLES
```
...
+ SoundEvent DYE_USE
+ SoundEvent GLOW_INK_SAC_USE
+ SoundEvent GLOW_SQUID_AMBIENT
+ SoundEvent GLOW_SQUID_DEATH
+ SoundEvent GLOW_SQUID_HURT
+ SoundEvent GLOW_SQUID_SQUIRT
+ SoundEvent INK_SAC_USE
...
+ boolean lambda$hasIndirectPassenger$15(Entity)
...
```diff
+ SensorType AXOLOTL_HOSTILES
+ SensorType AXOLOTL_TEMPTATIONS
+ TemptingSensor lambda$static$0()
```

</details>

<details><summary>net.minecraft.world.entity.ai.util.GoalUtils</summary>

```diff
+ boolean hasMalus(BlockPos)
+ boolean isNotStable(BlockPos)
+ boolean isOutsideLimits(PathfinderMob)
+ boolean isRestricted(BlockPos)
+ boolean isSolid(BlockPos)
+ boolean isWater(BlockPos)
...
```diff
+ AgeableMob getBreedOffspring(AgeableMob)
+ Sheep getBreedOffspring(AgeableMob)
- AgableMob getBreedOffspring(AgableMob)
- Sheep getBreedOffspring(AgableMob)
```
...
+ void load(CompoundTag)
+ void moveCollidedEntities(BlockState)
+ void tick(ShulkerBoxBlockEntity)
+ void updateAnimation(BlockState)
...
+ void <init>(EnchantWithLevelsFunction$1)
...
- void <init>(EnchantWithLevelsFunction$1)
- void <init>(RandomIntGenerator,boolean)
```
...
- void <init>(LootingEnchantFunction$1)
- void <init>(RandomValueBounds,int)
```

</details>

<details><summary>net.minecraft.world.level.storage.loot.functions.LootingEnchantFunction$Builder</summary>

```diff
+ NumberProvider count
- RandomValueBounds count
+ void <init>(NumberProvider)
...
<details><summary>net.minecraft.world.level.storage.loot.functions.SetStewEffectFunction</summary>
...
<details><summary>net.minecraft.world.level.storage.loot.functions.SetStewEffectFunction$Builder</summary>

```diff
+ SetStewEffectFunction$Builder withEffect(NumberProvider)
- SetStewEffectFunction$Builder withEffect(RandomValueBounds)
```
...
```diff
+ boolean hasScore(IntRange)
+ Stream lambda$getReferencedContextParams$0(IntRange)
- boolean hasScore(RandomValueBounds)
```
...
```diff
+ EntityHasScoreCondition$Builder withScore(IntRange)
- EntityHasScoreCondition$Builder withScore(RandomValueBounds)
```
...
<details><summary>net.minecraft.world.phys.shapes.BitSetDiscreteVoxelShape</summary>
...
+ void forAllBoxes(DiscreteVoxelShape$IntLineConsumer,boolean)
...
<details><summary>net.minecraft.world.phys.shapes.DiscreteVoxelShape</summary>
...
<details><summary>net.minecraft.world.phys.shapes.IndexMerger</summary>
...
<details><summary>net.minecraft.world.phys.shapes.IndirectMerger</summary>
...
+ int[] firstIndices
+ int[] secondIndices
- DoubleArrayList result
- IntArrayList firstIndices
- IntArrayList secondIndices
+ int size()
+ void <clinit>()
```
...
```diff
+ Vector3f REDSTONE_PARTICLE_COLOR
- float b
- float g
- float r
- float scale
...
```diff
+ List mirroredFullBlocks
+ List nonOrientableTrapdoor
+ Map MULTIFACE_GENERATOR
+ Map SHAPE_CONSUMERS
+ Map texturedModels
+ BlockStateGenerator access$1000(ResourceLocation)
+ BlockStateGenerator access$1300(ResourceLocation)
+ BlockStateGenerator access$1400(ResourceLocation)
...
+ List lambda$createTurtleEgg$34(Integer)
+ Map access$1900()
+ MultiVariantGenerator access$200(ResourceLocation)
+ MultiVariantGenerator access$400(ResourceLocation)
+ ResourceLocation lambda$null$10(Block,int,int)
+ TextureMapping lambda$createChorusFlower$13(ResourceLocation)
+ TextureMapping lambda$createCommandBlock$6(ResourceLocation)
+ Variant createPointedDripstoneVariant(DripstoneThickness)
+ Variant lambda$createActiveRail$5(RailShape)
+ Variant lambda$createBambooModels$7(String,int)
+ Variant lambda$createCropBlock$11(Integer)
+ Variant lambda$createEmptyOrFullDispatch$9(Comparable)
...
+ Variant lambda$createRepeater$29(Boolean)
+ Variant lambda$createRespawnAnchor$43(Integer)
+ Variant lambda$createSculkSensor$28(SculkSensorPhase)
+ Variant lambda$createSnowBlocks$30(Integer)
...
+ void <clinit>()
+ void access$1100(Item)
+ void access$1200(Block)
+ void access$1500(Block)
+ void access$1700(Block)
+ void access$1800(Block)
+ void access$500(ResourceLocation)
...
+ void lambda$createBarrel$8(TextureMapping)
+ void lambda$createFurnace$12(TextureMapping)
+ void lambda$createGrassBlocks$26(TextureMapping)
+ void lambda$createGrassBlocks$27(TextureMapping)
+ void lambda$createMultiface$42(Function)
...
+ void lambda$static$2(Block)
+ void lambda$static$3(Block)
+ void lambda$static$41(HashMap)
- BlockModelGenerators$BlockFamilyProvider family(TexturedModel)
- BlockModelGenerators$BlockFamilyProvider family(TexturedModel$Provider)
- BlockModelGenerators$BlockFamilyProvider family(TextureMapping)
- BlockStateGenerator access$1100(ResourceLocation)
...
- List lambda$createTurtleEgg$29(Integer)
- MultiVariantGenerator access$100(ResourceLocation)
- ResourceLocation lambda$null$6(Block,int,int)
- ResourceLocation lambda$run$33(TextureMapping)
- TextureMapping lambda$createChorusFlower$9(ResourceLocation)
- TextureMapping lambda$createCommandBlock$2(ResourceLocation)
- Variant lambda$createActiveRail$1(RailShape)
- Variant lambda$createBambooModels$3(String,int)
- Variant lambda$createCropBlock$7(Integer)
- Variant lambda$createEmptyOrFullDispatch$5(Comparable)
...
- Variant lambda$createRepeater$24(Boolean)
- Variant lambda$createRespawnAnchor$30(Integer)
- Variant lambda$createSnowBlocks$25(Integer)
...
- Variant lambda$createStems$0(Integer)
- Variant lambda$createStructureBlock$26(StructureMode)
- Variant lambda$createSweetBerryBush$27(Integer)
- Variant lambda$createTripwireHook$28(Boolean)
- Variant lambda$wrapModels$10(ResourceLocation)
- void access$1000(Block)
- void access$400(ResourceLocation)
- void access$900(Item)
- void createCauldron()
- void createGrassPath()
- void createVine()
- void lambda$createBarrel$4(TextureMapping)
- void lambda$createFurnace$8(TextureMapping)
- void lambda$createGrassBlocks$22(TextureMapping)
- void lambda$createGrassBlocks$23(TextureMapping)
...
<details><summary>net.minecraft.world.entity.animal.AbstractGolem</summary>
...
```diff
+ boolean canDismountTo(Pose)
- Vec3 findDismountLocation(Pose)
```
...
```diff
+ BlockState getBlockState(ConfiguredFeature)
```
...
+ BlockEntity newBlockEntity(BlockState)
+ BlockEntityTicker getTicker(BlockEntityType)
+ boolean canOpen(ShulkerBoxBlockEntity)
- BlockEntity newBlockEntity(BlockGetter)
```
...
+ void replaceWithPacketData(BitSet)
+ void setBlockEntity(BlockEntity)
...
- void replaceWithPacketData(CompoundTag,int)
- void setBlockEntity(BlockEntity)
...
+ LootItemFunctionType SET_ENCHANTMENTS
```
...
<details><summary>net.minecraft.world.level.storage.loot.functions.SetAttributesFunction$Modifier</summary>

```diff
+ NumberProvider amount
- RandomValueBounds amount
+ NumberProvider access$400(SetAttributesFunction$Modifier)
+ void <init>(SetAttributesFunction$1)
+ void <init>(UUID)
...
+ LootItemFunction lambda$setCount$0(LootItemCondition[])
+ LootItemFunction lambda$setCount$1(LootItemCondition[])
+ NumberProvider access$000(SetItemCountFunction)
+ Set getReferencedContextParams()
+ void <init>(NumberProvider,boolean)
+ void <init>(SetItemCountFunction$1)
...
```diff
+ LootItemConditionType VALUE_CHECK
```
...
<details><summary>net.minecraft.world.scores.Score</summary>
...
<details><summary>net.minecraft.world.scores.ScoreboardSaveData</summary>

```diff
- CompoundTag delayLoad
- Logger LOGGER
