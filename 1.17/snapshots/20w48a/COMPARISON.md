## Comparison with [20w46a](https://github.com/PixiGeko/Minecraft-generated-data/tree/20w46a)
...
<br/>
<table><tr><th></th><th align="left">20w46a</th><th>20w48a</th></tr><tr><td>World version</td><td><pre>2682</pre></td><td><pre>2683</pre></td></tr><tr><td>Protocol version</td><td><pre>1073741830</pre></td><td><pre>1073741831</pre></td></tr></table>
<h3>Libraries<a name="version-data-libraries"></a></h3>
<details>
<summary>
Versions
</summary>
<table><tr><th></th><th align="left">20w46a</th><th>20w48a</th></tr><tr><td>org.lwjgl:lwjgl-glfw</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-glfw</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr></table>
</details>
</details>
<hr/>
...
```
Result: cut_copper_slab x4 -> cut_copper_slab x6
```
...
```
Result: lightly_weathered_cut_copper_slab x4 -> lightly_weathered_cut_copper_slab x6
```
...
```
Result: semi_weathered_cut_copper_slab x4 -> semi_weathered_cut_copper_slab x6
```
...
```
Result: weathered_cut_copper_slab x4 -> weathered_cut_copper_slab x6
```
...
+ item.minecraft.bundle.fullness: Fullness: %s / %s
...
+ subtitles.block.pointed_dripstone.land: Pointed Dripstone crashes down
```
...
```
XXX.data.models.BlockModelGenerators +2M
```
```
XXX.data.recipes.RecipeProvider +12M
```
```
...
```
```
XXX.server.level.ServerPlayerGameMode +2M -3M
```
```
...
```
```
XXX.world.inventory.AbstractContainerMenu -1M
```
```
...
```
```
XXX.item.context.BlockPlaceContext +1M
```
```
...
```
```
XXX.level.block.AbstractCauldronBlock +3M | +1P
```
```
XXX.level.block.Blocks +2P
```
```
XXX.level.block.CandleBlock +1M
```
```
XXX.levelgen.feature.RuinedPortalFeature -1M
```
...
```
XXX.block.model.ItemOverride +1M -1M
```
```
XXX.block.model.ItemOverrides +1M -1M
```
```
XXX.renderer.blockentity.BlockEntityRendererProvider$Context +1M -1M
```
```
XXX.renderer.entity.EntityRendererProvider$Context +1M -1M
```
```
XXX.entity.layers.CustomHeadLayer +1M
```
```
XXX.level.block.LavaCauldronBlock +1M
```
```
