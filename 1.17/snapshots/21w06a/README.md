...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/21w05b">21w05b</a>
## File structure
...
```diff
+ block/small_dripleaf_stem_bottom.png
+ block/small_dripleaf_stem_top.png
```
...
+ CompletableFuture lambda$sequence$5(CompletableFuture)
+ CompletableFuture lambda$sequence$7(CompletableFuture)
+ CompletableFuture sequenceFailFast(List)
+ List lambda$null$4(List)
+ List lambda$null$6(List)
+ List lambda$sequenceFailFast$10(Void)
+ Runnable wrapThreadWithTaskName(Runnable)
+ String lambda$sanitizeName$12(CharPredicate,int)
+ void lambda$null$8(Throwable)
+ void lambda$prefix$11(String)
+ void lambda$sequenceFailFast$9(CompletableFuture)
+ void lambda$wrapThreadWithTaskName$2(Runnable)
- boolean lambda$getVmArguments$2(String)
- List lambda$sequence$5(Void)
- String lambda$sanitizeName$7(CharPredicate,int)
- void lambda$null$3(Throwable)
- void lambda$prefix$6(String)
- void lambda$sequence$4(CompletableFuture)
```
...
```diff
+ Component WORLD_PRE_WORLDHEIGHT_TOOLTIP
...
```diff
- AABB ENTITY_DETECTION_SHAPE
+ boolean canEntityTilt(Entity)
+ boolean canPlaceAt(BlockState)
+ boolean canReplace(BlockState)
+ boolean place(Direction)
+ void neighborChanged(BlockPos,boolean)
+ void placeWithRandomHeight(BlockPos)
- boolean canEntityTilt(Entity,boolean)
- boolean isAnyEntityTouching(BlockPos,boolean)
- boolean isEntityAbove(Entity)
- boolean lambda$isAnyEntityTouching$1(Entity)
- void place(BlockPos)
```
...
+ NoiseGeneratorSettings endLikePreset(BlockState,boolean,boolean,boolean)
+ NoiseGeneratorSettings netherLikePreset(BlockState,boolean)
+ NoiseGeneratorSettings overworld(StructureSettings,boolean)
+ void <init>(BlockState,int,int,int,boolean,boolean,boolean)
- NoiseGeneratorSettings end(ResourceLocation,boolean,boolean)
- NoiseGeneratorSettings nether(ResourceLocation)
- NoiseGeneratorSettings overworld(ResourceLocation)
- void <init>(BlockState,int,int,int,boolean)
```
...
<details><summary>net.minecraft.world.level.levelgen.feature.MineshaftFeature$Type</summary>

```diff
+ BlockState fenceState
+ BlockState planksState
...
+ boolean canBeReplaced(BoundingBox)
...
```diff
+ DebugBuffer chunkToSaveHistory
+ ChunkPos access$100(ChunkHolder)
+ Either lambda$updateFutures$8(Either)
+ Either lambda$updateFutures$9(Either)
+ void updateChunkToSave(String)
...
```diff
+ CompletableFuture fillFromNoise(java.util.concurrent.Executor,net.minecraft.world.level.StructureFeatureManager,net.minecraft.world.level.chunk.ChunkAccess)
...
+ Either lambda$null$5(ChunkAccess)
...
- CompletableFuture lambda$static$10(ChunkAccess)
- CompletableFuture lambda$static$11(ChunkAccess)
- CompletableFuture lambda$static$14(ChunkAccess)
- CompletableFuture lambda$static$15(ChunkAccess)
- CompletableFuture lambda$static$2(ChunkAccess)
- CompletableFuture lambda$static$9(ChunkAccess)
- void lambda$static$12(ChunkAccess)
- void lambda$static$16(IntArrayList)
- void lambda$static$5(ChunkAccess)
- void lambda$static$6(ChunkAccess)
```
...
- CompletableFuture doWork(net.minecraft.world.level.chunk.ChunkStatus,net.minecraft.server.level.ServerLevel,net.minecraft.world.level.chunk.ChunkGenerator,net.minecraft.world.level.levelgen.structure.templatesystem.StructureManager,net.minecraft.server.level.ThreadedLevelLightEngine,java.util.function.Function,java.util.List,net.minecraft.world.level.chunk.ChunkAccess)
```
...
+ ChunkAccess doFill(ChunkAccess,int,int)
+ ChunkAccess lambda$fillFromNoise$4(ChunkAccess,int,int)
+ ChunkAccess lambda$fillFromNoise$5(ChunkAccess)
+ CompletableFuture fillFromNoise(ChunkAccess)
+ int getMinY()
...
<details><summary>net.minecraft.world.level.levelgen.structure.MineShaftPieces$1</summary>

```diff
- int[] $SwitchMap$net$minecraft$world$level$levelgen$feature$MineshaftFeature$Type
```
