...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/21w17a">21w17a</a>
## File structure
...
<details><summary>blocks/guarded_by_piglins.json</summary>
...
```diff
+ ResourceLoadStateTracker reloadStateTracker
...
+ Style lambda$grabHugeScreenshot$42(Style)
+ Style lambda$grabPanoramixScreenshot$41(Style)
+ void fillReport(CrashReport)
...
```diff
+ ToIntFunction getCooldownOnFail
- int cooldownOnFail
+ void <init>(Function)
- void <init>(Function)
```
...
<details><summary>net.minecraft.world.entity.ai.behavior.RamTarget</summary>

```diff
+ Function getTimeBetweenRams
+ TargetingConditions ramTargeting
+ ToDoubleFunction getKnockbackForce
+ ToIntFunction getDamage
- Function getDamage
- Function getKnockbackForce
- TargetingConditions targeting
- UniformInt timeBetweenRams
+ void <init>(Function)
- void <init>(Function)
```
...
- Predicate NO_SPECTATORS_AND_NO_WATER_MOB
...
```diff
+ UniformInt TIME_BETWEEN_RAMS_SCREAMER
...
<details><summary>net.minecraft.world.level.levelgen.OreVeinifier</summary>

```diff
+ double MAX_EDGE_ROUNDOFF
+ double VEININESS_FREQUENCY
+ int EDGE_ROUNDOFF_BEGIN
