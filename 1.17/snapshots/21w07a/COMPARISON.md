## Comparison with [21w06a](https://github.com/PixiGeko/Minecraft-generated-data/tree/21w06a)
...
<br/>
<table><tr><th></th><th align="left">21w06a</th><th>21w07a</th></tr><tr><td>World version</td><td><pre>2694</pre></td><td><pre>2695</pre></td></tr><tr><td>Protocol version</td><td><pre>1073741838</pre></td><td><pre>1073741839</pre></td></tr></table>
<h3>Libraries<a name="version-data-libraries"></a></h3>
<details>
<summary>
Versions
</summary>
<table><tr><th></th><th align="left">21w06a</th><th>21w07a</th></tr><tr><td>org.lwjgl:lwjgl-glfw</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-glfw</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr></table>
</details>
</details>
<hr/>
...
```
XXX.data.worldgen.Features +6P -2P
```
```
XXX.data.worldgen.Features$Decorators +5P -2P
```
```
XXX.protocol.game.ServerboundClientInformationPacket +2M -1M | +1P
```
```
XXX.server.level.ServerPlayer +3M | +1P
```
```
XXX.level.levelgen.Beardifier +3M -2M
```
```
XXX.level.levelgen.NoiseBasedChunkGenerator +1M -1M | +1P -1P
```
```
XXX.level.levelgen.WorldgenRandom +1M
```
```
XXX.levelgen.feature.LargeDripstoneFeature$WindOffsetter +1M -1M
```
```
XXX.feature.configurations.RangeDecoratorConfiguration +4M -5M | +2P -3P
```
```
XXX.levelgen.placement.Spread32Decorator +2M -2M
```
```
XXX.levelgen.structure.StrongholdPieces$FillerCorridor +1M
```
```
XXX.levelgen.structure.StrongholdPieces$PrisonHall +1M
```
```
XXX.levelgen.structure.StrongholdPieces$RoomCrossing +1M
```
```
XXX.levelgen.structure.StrongholdPieces$StairsDown +1M
```
```
XXX.levelgen.structure.StrongholdPieces$Straight +1M
```
```
XXX.levelgen.structure.StrongholdPieces$StrongholdPiece +1M
```
```
XXX.levelgen.structure.StrongholdPieces$Turn +1M
```
```
XXX.levelgen.structure.StructurePiece +2M
```
...
```
XXX.server.network.TextFilter +1M | +1P
```
```
XXX.server.network.TextFilterClient$PlayerContext +1M -3M
```
```
XXX.world.item.Items +17P
```
```
XXX.world.item.WrittenBookItem +1M
```
```
XXX.level.block.Blocks +17P
```
```
XXX.block.entity.BlockEntity -1M
```
```
XXX.block.entity.SignBlockEntity +7M -3M | +4P
```
```
XXX.level.levelgen.Decoratable +3M -1M
```
```
XXX.levelgen.placement.CarvingMaskDecorator +1M -2M
```
```
XXX.levelgen.placement.ChanceDecorator +2M -2M
```
```
XXX.levelgen.placement.CountNoiseDecorator +2M -3M
```
```
XXX.levelgen.placement.DarkOakTreePlacementDecorator +1M -3M
```
```
XXX.levelgen.placement.FeatureDecorator +2P -7P
```
```
XXX.levelgen.placement.LakeLavaPlacementDecorator +2M -2M
```
```
XXX.levelgen.structure.MineShaftPieces$MineShaftCorridor +4M -2M
```
```
XXX.levelgen.structure.MineShaftPieces$MineShaftPiece +1M
```
