## Comparison with [26.2-snapshot-1](https://github.com/PixiGeko/Minecraft-generated-data/tree/26.2-snapshot-1)
...
<br/>
<table><tr><th></th><th align="left">26.2-snapshot-1</th><th>26.1.2-rc-1</th></tr><tr><td>DataPack version</td><td><pre>101.2</pre></td><td><pre>101.1</pre></td></tr><tr><td>ResourcePack version</td><td><pre>85.0</pre></td><td><pre>84.0</pre></td></tr><tr><td>World version</td><td><pre>4883</pre></td><td><pre>4789</pre></td></tr><tr><td>Protocol version</td><td><pre>1073742130</pre></td><td><pre>1073742131</pre></td></tr></table>
...
<table><tr><th></th><th align="left">26.2-snapshot-1</th><th>26.1.2-rc-1</th></tr><tr><td>type</td><td><pre>minecraft:weathering_copper_trapdoor</pre></td><td><pre>minecraft:weathering_copper_trap_door</pre></td></tr></table>
<br/>
</details>
<details>
<summary>
...
<br/>
<table>
<tr><th>Name</th><th>26.2-snapshot-1</th><th>26.1.2-rc-1</th></tr>
...
<tr><th align="left"><div style="width:290px">build.tooHigh</div></th><td>The height limit for building is %s</td><td>Height limit for building is %s</td></tr>
<tr><th align="left"><div style="width:290px">build.tooLow</div></th><td>The minimum height for building is %s</td><td>Minimum height for building is %s</td></tr>
<tr><th align="left"><div style="width:290px">command.failed</div></th><td>An unexpected error occurred while trying to execute that command</td><td>An unexpected error occurred trying to execute that command</td></tr>
<tr><th align="left"><div style="width:290px">commands.locate.biome.not_found</div></th><td>Could not find a biome of type "%s" within a reasonable distance</td><td>Could not find a biome of type "%s" within reasonable distance</td></tr>
<tr><th align="left"><div style="width:290px">commands.locate.poi.not_found</div></th><td>Could not find a point of interest of type "%s" within a reasonable distance</td><td>Could not find a point of interest of type "%s" within reasonable distance</td></tr>
...
<tr><th align="left"><div style="width:290px">commands.profile_fetch.id.failure</div></th><td>Failed to resolve profile for ID %s</td><td>Failed to resolved profile for id %s</td></tr>
...
<tr><th align="left"><div style="width:290px">datapackFailure.title</div></th><td>Errors in the currently selected data pack(s) prevented the world from loading.
...
<tr><th align="left"><div style="width:290px">mco.configure.world.restore.download.question.line1</div></th><td>The world will be downloaded and added to your singleplayer worlds.</td><td>The world will be downloaded and added to your single player worlds.</td></tr>
