...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/1.16-pre4">1.16-pre4</a>
## File structure
...
```diff
+ Component GRAPHICS_TOOLTIP_FABULOUS
+ Component GRAPHICS_TOOLTIP_FANCY
+ Component GRAPHICS_TOOLTIP_FAST
...
+ Stream lambda$getRecipesFor$4(Recipe)
...
```diff
+ MapCodec appendPropertyCodec(Property)
