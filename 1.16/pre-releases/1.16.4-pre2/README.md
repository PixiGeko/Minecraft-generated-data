...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/1.16.4-pre1">1.16.4-pre1</a>
## Version data
...
```diff
+ SocialInteractionsService service
+ boolean isBlocked(UUID)
+ boolean shouldHideMessageFrom(UUID)
+ void <init>(SocialInteractionsService)
- void <init>(Minecraft)
```
...
+ Button blockingHintButton
+ Component BLOCKING_HINT
+ Component EMPTY_BLOCKED
+ Component EMPTY_SEARCH
+ Component TAB_BLOCKED
+ Component TAB_BLOCKED_SELECTED
- boolean showHiddenExclaim
...
```diff
+ Logger access$200()
+ ServerLoginPacketListenerImpl$State access$302(ServerLoginPacketListenerImpl$State)
- Logger access$300()
- SecretKey access$200(ServerLoginPacketListenerImpl)
- ServerLoginPacketListenerImpl$State access$402(ServerLoginPacketListenerImpl$State)
```
