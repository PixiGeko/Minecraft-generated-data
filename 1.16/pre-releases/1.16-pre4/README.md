...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/1.16-pre3">1.16-pre3</a>
## Mappings
...
```diff
+ InteractionResult fedFood(ItemStack)
```
...
```diff
+ ItemStack createBucketResult(ItemStack)
```
