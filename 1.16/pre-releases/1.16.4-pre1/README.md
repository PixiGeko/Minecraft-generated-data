...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/1.16.3">1.16.3</a>
## File structure
...
```diff
+ List timedToasts
+ boolean lambda$removeTimedToast$0(Tutorial$TimedToast)
...
+ void lambda$null$0(String)
+ void lambda$null$1(Optional)
...
+ void lambda$filterTextPacket$2(Optional)
+ void lambda$filterTextPacket$3(Object)
+ void lambda$handleCustomCommandSuggestions$4(Suggestions)
+ void lambda$handleEditBook$5(List)
+ void lambda$handleEditBook$6(List)
+ void lambda$handlePlaceRecipe$10(Recipe)
+ void lambda$handleSignUpdate$11(List)
+ void signBook(List,int)
+ void updateBookContents(List,int)
+ void updateSignText(List)
- boolean lambda$isPlayerCollidingWithAnythingNew$2(Entity)
- boolean lambda$isPlayerCollidingWithAnythingNew$3(VoxelShape)
- String lambda$send$4(Packet)
- void lambda$handleCustomCommandSuggestions$1(Suggestions)
- void lambda$handlePlaceRecipe$5(Recipe)
```
