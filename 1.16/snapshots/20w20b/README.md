...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/20w20a">20w20a</a>
## Mappings
...
<details><summary>net.minecraft.server.MinecraftServer$2</summary>

```diff
+ GameRules val$gameRules
+ List val$entries
+ MinecraftServer this$0
- DedicatedServer val$server
+ void <init>(GameRules)
