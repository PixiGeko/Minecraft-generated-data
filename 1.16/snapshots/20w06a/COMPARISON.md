...
<br/>
<table><tr><th></th><th align="left">1.15.2</th><th>20w06a</th></tr><tr><td>World version</td><td><pre>2230</pre></td><td><pre>2504</pre></td></tr><tr><td>Protocol version</td><td><pre>578</pre></td><td><pre>701</pre></td></tr></table>
<h3>Libraries<a name="version-data-libraries"></a></h3>
<details>
<summary>
Versions
</summary>
<table><tr><th></th><th align="left">1.15.2</th><th>20w06a</th></tr><tr><td>org.lwjgl:lwjgl-glfw</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-glfw</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr></table>
</details>
</details>
<hr/>
...
<br/>
<table>
<tr><th>Name</th><th>1.15.2</th><th>20w06a</th></tr>
<tr><th align="left"><div style="width:290px">selectWorld.futureworld.error.title</div></th><td>An error occured!</td><td>An error occurred!</td></tr>
<tr><th align="left"><div style="width:290px">selectWorld.futureworld.error.text</div></th><td>Something went wrong while trying to load a world from a future version. This was a risky operation to begin with, sorry it didn't work.</td><td>Something went wrong while trying to load a world from a future version. This was a risky operation to begin with; sorry it didn't work.</td></tr>
<tr><th align="left"><div style="width:290px">selectWorld.recreate.error.title</div></th><td>An error occured!</td><td>An error occurred!</td></tr>
<tr><th align="left"><div style="width:290px">createWorld.customize.presets.share</div></th><td>Want to share your preset with someone? Use the below box!</td><td>Want to share your preset with someone? Use the box below!</td></tr>
<tr><th align="left"><div style="width:290px">selectWorld.gameMode.survival.line1</div></th><td>Search for resources, crafting, gain</td><td>Search for resources, craft, gain</td></tr>
<tr><th align="left"><div style="width:290px">selectWorld.gameMode.hardcore.line1</div></th><td>Same as survival mode, locked at hardest</td><td>Same as Survival Mode, locked at hardest</td></tr>
<tr><th align="left"><div style="width:290px">selectWorld.gameMode.adventure.line1</div></th><td>Same as survival mode, but blocks can't</td><td>Same as Survival Mode, but blocks can't</td></tr>
<tr><th align="left"><div style="width:290px">selectWorld.mapFeatures.info</div></th><td>Villages, dungeons etc</td><td>Villages, dungeons etc.</td></tr>
<tr><th align="left"><div style="width:290px">generator.amplified.info</div></th><td>Notice: Just for fun, requires beefy computer</td><td>Notice: Just for fun! Requires a beefy computer.</td></tr>
<tr><th align="left"><div style="width:290px">selectServer.direct</div></th><td>Direct Connect</td><td>Direct Connection</td></tr>
<tr><th align="left"><div style="width:290px">multiplayer.downloadingStats</div></th><td>Downloading statistics...</td><td>Retrieving statistics...</td></tr>
<tr><th align="left"><div style="width:290px">multiplayer.message_not_delivered</div></th><td>Can't deliver chat message starting with %s, check server logs</td><td>Can't deliver chat message, check server logs: %s</td></tr>
<tr><th align="left"><div style="width:290px">multiplayer.status.request_handled</div></th><td>Status requst has been handled</td><td>Status request has been handled</td></tr>
<tr><th align="left"><div style="width:290px">demo.day.1</div></th><td>This demo will last five game days, do your best!</td><td>This demo will last five game days. Do your best!</td></tr>
<tr><th align="left"><div style="width:290px">demo.day.6</div></th><td>You have passed your fifth day, use %s to save a screenshot of your creation</td><td>You have passed your fifth day. Use %s to save a screenshot of your creation.</td></tr>
<tr><th align="left"><div style="width:290px">demo.reminder</div></th><td>The demo time has expired, buy the game to continue or start a new world!</td><td>The demo time has expired. Buy the game to continue or start a new world!</td></tr>
<tr><th align="left"><div style="width:290px">demo.help.fullWrapped</div></th><td>This demo will last 5 ingame days (about 1 hour and 40 minutes of real time). Check the advancements for hints! Have fun!</td><td>This demo will last 5 in-game days (about 1 hour and 40 minutes of real time). Check the advancements for hints! Have fun!</td></tr>
<tr><th align="left"><div style="width:290px">options.chat.scale</div></th><td>Scale</td><td>Chat Text Size</td></tr>
<tr><th align="left"><div style="width:290px">options.narrator.all</div></th><td>Narrates all</td><td>Narrates All</td></tr>
<tr><th align="left"><div style="width:290px">options.narrator.chat</div></th><td>Narrates chat</td><td>Narrates Chat</td></tr>
<tr><th align="left"><div style="width:290px">options.narrator.system</div></th><td>Narrates system</td><td>Narrates System</td></tr>
<tr><th align="left"><div style="width:290px">options.narrator.notavailable</div></th><td>Not available</td><td>Not Available</td></tr>
<tr><th align="left"><div style="width:290px">key.saveToolbarActivator</div></th><td>Save Toolbar Activator</td><td>Save Hotbar Activator</td></tr>
<tr><th align="left"><div style="width:290px">key.loadToolbarActivator</div></th><td>Load Toolbar Activator</td><td>Load Hotbar Activator</td></tr>
<tr><th align="left"><div style="width:290px">block.minecraft.smooth_quartz</div></th><td>Smooth Quartz</td><td>Smooth Quartz Block</td></tr>
<tr><th align="left"><div style="width:290px">block.minecraft.bed.no_sleep</div></th><td>You can sleep only at night and during thunderstorms</td><td>You can sleep only at night or during thunderstorms</td></tr>
<tr><th align="left"><div style="width:290px">block.minecraft.bamboo_sapling</div></th><td>Bamboo Sapling</td><td>Bamboo Shoot</td></tr>
<tr><th align="left"><div style="width:290px">item.minecraft.clay_ball</div></th><td>Clay</td><td>Clay Ball</td></tr>
<tr><th align="left"><div style="width:290px">entity.minecraft.tropical_fish.type.sunstreak</div></th><td>SunStreak</td><td>Sunstreak</td></tr>
<tr><th align="left"><div style="width:290px">stat.minecraft.time_since_rest</div></th><td>Since Last Rest</td><td>Time Since Last Rest</td></tr>
<tr><th align="left"><div style="width:290px">stat.minecraft.time_since_death</div></th><td>Since Last Death</td><td>Time Since Last Death</td></tr>
<tr><th align="left"><div style="width:290px">itemGroup.hotbar</div></th><td>Saved Toolbars</td><td>Saved Hotbars</td></tr>
<tr><th align="left"><div style="width:290px">inventory.hotbarSaved</div></th><td>Item toolbar saved (restore with %1$s+%2$s)</td><td>Item hotbar saved (restore with %1$s+%2$s)</td></tr>
<tr><th align="left"><div style="width:290px">inventory.hotbarInfo</div></th><td>Save toolbar with %1$s+%2$s</td><td>Save hotbar with %1$s+%2$s</td></tr>
<tr><th align="left"><div style="width:290px">subtitles.item.honey_bottle.drink</div></th><td>Honey gulping</td><td>Gulping</td></tr>
<tr><th align="left"><div style="width:290px">advancements.adventure.shoot_arrow.description</div></th><td>Shoot something with a bow and arrow</td><td>Shoot something with an arrow</td></tr>
<tr><th align="left"><div style="width:290px">advancements.end.elytra.description</div></th><td>Find Elytra</td><td>Find elytra</td></tr>
<tr><th align="left"><div style="width:290px">advancements.story.deflect_arrow.description</div></th><td>Deflect an arrow with a shield</td><td>Deflect an arrow or trident with a shield</td></tr>
<tr><th align="left"><div style="width:290px">advancements.story.form_obsidian.description</div></th><td>Form and mine a block of Obsidian</td><td>Form and mine a block of obsidian</td></tr>
<tr><th align="left"><div style="width:290px">commands.drop.success.single</div></th><td>Dropped %s * %s</td><td>Dropped %s %s</td></tr>
<tr><th align="left"><div style="width:290px">commands.drop.success.single_with_table</div></th><td>Dropped %s * %s from loot table %s</td><td>Dropped %s %s from loot table %s</td></tr>
<tr><th align="left"><div style="width:290px">commands.list.players</div></th><td>There are %s of a max %s players online: %s</td><td>There are %s of a max of %s players online: %s</td></tr>
<tr><th align="left"><div style="width:290px">commands.worldborder.damage.amount.success</div></th><td>Set the world border damage time to %s seconds</td><td>Set the world border damage time to %s per block each second</td></tr>
<tr><th align="left"><div style="width:290px">commands.team.option.name.success</div></th><td>Updated team %s name</td><td>Updated the name of team %s</td></tr>
<tr><th align="left"><div style="width:290px">commands.scoreboard.objectives.modify.displayname</div></th><td>Changed objective %s display name to %s</td><td>Changed the display name of %s to %s</td></tr>
<tr><th align="left"><div style="width:290px">commands.scoreboard.objectives.modify.rendertype</div></th><td>Changed objective %s render type</td><td>Changed the render type of objective %s</td></tr>
<tr><th align="left"><div style="width:290px">commands.data.merge.failed</div></th><td>Nothing changed, the specified properties already have these values</td><td>Nothing changed. The specified properties already have these values</td></tr>
<tr><th align="left"><div style="width:290px">argument.criteria.invalid</div></th><td>Unknown criteria '%s'</td><td>Unknown criterion '%s'</td></tr>
<tr><th align="left"><div style="width:290px">command.unknown.command</div></th><td>Unknown command</td><td>Unknown or incomplete command, see below for error</td></tr>
</table>
<br/>
</details>
</details>
