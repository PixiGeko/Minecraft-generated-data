## Comparison with [20w08a](https://github.com/PixiGeko/Minecraft-generated-data/tree/20w08a)
...
<br/>
<table><tr><th></th><th align="left">20w08a</th><th>20w09a</th></tr><tr><td>World version</td><td><pre>2507</pre></td><td><pre>2510</pre></td></tr><tr><td>Protocol version</td><td><pre>703</pre></td><td><pre>704</pre></td></tr></table>
<h3>Libraries<a name="version-data-libraries"></a></h3>
<details>
<summary>
Versions
</summary>
<table><tr><th></th><th align="left">20w08a</th><th>20w09a</th></tr><tr><td>org.lwjgl:lwjgl-glfw</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-glfw</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr></table>
</details>
</details>
<hr/>
...
```
```
XXX.core.particles.ParticleTypes +3P
```
```
XXX.server.level.ServerLevel +1M
```
```
XXX.server.players.StoredUserList -1M | +2P -2P
```
```
XXX.minecraft.stats.Stats +1P
```
```
XXX.util.datafix.DataFixers +3M
```
```
XXX.minecraft.world.SimpleContainer +1M
```
```
XXX.world.entity.EntityType +1P -1P
```
```
XXX.world.entity.LivingEntity +5M -1M | +1P
```
```
XXX.world.entity.Mob +1M
```
```
XXX.ai.behavior.StopHoldingItemIfNoLongerAdmiring +2M
```
```
XXX.ai.memory.MemoryModuleType +1P -1P
```
```
XXX.entity.animal.Fox +3M -1M
```
```
XXX.entity.animal.Rabbit +4M -3M
```
```
XXX.entity.animal.Turtle +2M -1M
```
```
...
```
```
XXX.monster.piglin.Piglin +5M -2M | +1P
```
```
XXX.monster.piglin.PiglinAi +9M -8M | -2P
```
```
XXX.world.item.HoeItem +5M -2M
```
```
XXX.world.level.BlockAndTintGetter +1P
```
```
...
```
```
XXX.level.block.SoundType +1P -1P
```
...
+ XXX.ai.behavior.AdmireHeldItem
...
+ XXX.ai.behavior.StartAdmiringItemIfSeen
- XXX.ai.behavior.StartAttacking
+ XXX.ai.behavior.StartCelebratingIfTargetDead
- XXX.ai.behavior.StartHuntingHoglin
+ XXX.ai.behavior.StopAdmiringIfItemTooFarAway
...
```
XXX.blaze3d.audio.Library +1M
```
```
XXX.minecraft.client.Options$1 -3M
```
```
XXX.client.model.PiglinModel +1M -1M
```
```
XXX.client.multiplayer.ClientLevel +1M
```
```
XXX.block.model.FaceBakery +1M -3M
```
```
XXX.entity.monster.Slime +1M
```
```
XXX.level.block.FireBlock +1M -1M
```
```
XXX.level.dimension.Dimension +1P -1P
```
```
XXX.level.dimension.NetherDimension +1M -1M
```
```
