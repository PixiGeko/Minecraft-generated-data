## Comparison with [20w17a](https://github.com/PixiGeko/Minecraft-generated-data/tree/20w17a)
...
<br/>
<table><tr><th></th><th align="left">20w17a</th><th>20w18a</th></tr><tr><td>World version</td><td><pre>2529</pre></td><td><pre>2532</pre></td></tr><tr><td>Protocol version</td><td><pre>713</pre></td><td><pre>714</pre></td></tr></table>
<h3>Libraries<a name="version-data-libraries"></a></h3>
<details>
<summary>
Versions
</summary>
<table><tr><th></th><th align="left">20w17a</th><th>20w18a</th></tr><tr><td>org.lwjgl:lwjgl-glfw</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-glfw</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr></table>
</details>
</details>
<hr/>
...
<br/>
<table>
<tr><th>Name</th><th>20w17a</th><th>20w18a</th></tr>
<tr><th align="left"><div style="width:290px">selectWorld.access_failure</div></th><td>Failed to access level</td><td>Failed to access world</td></tr>
<tr><th align="left"><div style="width:290px">selectWorld.delete_failure</div></th><td>Failed to delete level</td><td>Failed to delete world</td></tr>
<tr><th align="left"><div style="width:290px">selectWorld.gameRules</div></th><td>Game rules</td><td>Game Rules</td></tr>
<tr><th align="left"><div style="width:290px">multiplayerWarning.header</div></th><td>Online play is not rated</td><td>Caution: Third-Party Online Play</td></tr>
<tr><th align="left"><div style="width:290px">multiplayerWarning.message</div></th><td>During online play you may be exposed to chat messages or other types of user generated content that has not been rated, and may not be suitable for all ages.</td><td>Caution: Online play is offered by third-party servers that are not owned, operated, or supervised by Mojang or Microsoft. During online play, you may be exposed to unmoderated chat messages or other types of user-generated content that may not be suitable for everyone.</td></tr>
<tr><th align="left"><div style="width:290px">block.minecraft.spawn.not_valid</div></th><td>You have no home bed or respawn anchor, or it was obstructed</td><td>You have no home bed or charged respawn anchor, or it was obstructed</td></tr>
<tr><th align="left"><div style="width:290px">block.minecraft.warped_wall_sign</div></th><td>Warped Sign</td><td>Warped Wall Sign</td></tr>
<tr><th align="left"><div style="width:290px">block.minecraft.crimson_wall_sign</div></th><td>Crimson Sign</td><td>Crimson Wall Sign</td></tr>
<tr><th align="left"><div style="width:290px">item.minecraft.piglin_banner_pattern.desc</div></th><td>Piglin</td><td>Snout</td></tr>
<tr><th align="left"><div style="width:290px">container.upgrade</div></th><td>Upgrade gear</td><td>Upgrade Gear</td></tr>
<tr><th align="left"><div style="width:290px">death.fell.accident.scaffolding</div></th><td>%1$s fell off a scaffolding</td><td>%1$s fell off scaffolding</td></tr>
<tr><th align="left"><div style="width:290px">subtitles.block.end_portal.spawn</div></th><td>End Portal opens!</td><td>End Portal opens</td></tr>
<tr><th align="left"><div style="width:290px">subtitles.entity.husk.converted_to_zombie</div></th><td>Husk converted to Zombie</td><td>Husk converts to Zombie</td></tr>
<tr><th align="left"><div style="width:290px">subtitles.entity.zombie.converted_to_drowned</div></th><td>Zombie converted to Drowned</td><td>Zombie converts to Drowned</td></tr>
<tr><th align="left"><div style="width:290px">commands.locatebiome.notFound</div></th><td>Could not find a %s within reasonable distance</td><td>Could not find a biome of type %s within reasonable distance</td></tr>
<tr><th align="left"><div style="width:290px">gamerule.disableElytraMovementCheck</div></th><td>Disable Elytra movement check</td><td>Disable elytra movement check</td></tr>
</table>
<br/>
</details>
</details>
...
+ XXX.world.item.CompassItem$CompassWobble
...
```
XXX.minecraft.advancements.AdvancementRewards +1M
```
```
XXX.advancements.critereon.EffectsChangedTrigger$TriggerInstance +2M -2M
```
```
XXX.advancements.critereon.EnchantedItemTrigger$TriggerInstance +2M -2M
```
```
XXX.advancements.critereon.EnterBlockTrigger +2M -2M
```
```
XXX.advancements.critereon.EntityHurtPlayerTrigger +2M -2M
```
```
XXX.advancements.critereon.EntityPredicate +1M -2M | -1P
```
```
XXX.advancements.critereon.ShotCrossbowTrigger$TriggerInstance +2M -2M
```
```
XXX.advancements.critereon.SlideDownBlockTrigger +2M -2M
```
```
XXX.advancements.critereon.SummonedEntityTrigger +3M -3M
```
```
XXX.advancements.critereon.TameAnimalTrigger +3M -3M
```
```
XXX.advancements.critereon.TargetBlockTrigger +3M -3M
```
```
XXX.advancements.critereon.TickTrigger +2M -2M
```
```
XXX.advancements.critereon.TradeTrigger +3M -3M
```
```
...
```
```
XXX.minecraft.server.MinecraftServer +4M -1M
```
```
...
```
```
XXX.server.level.WorldGenRegion -1M | -1P
```
```
XXX.server.players.PlayerList +1M -1M
```
```
XXX.world.entity.Entity +1M -1M | +1P -1P
```
```
XXX.ai.goal.CatSitOnBlockGoal +2M
```
```
XXX.ai.navigation.PathNavigation +2M -1M
```
```
XXX.ai.navigation.WaterBoundPathNavigation +1M -1M
```
```
XXX.entity.animal.Cat$CatRelaxOnOwnerGoal +2M
```
```
XXX.entity.monster.Zoglin +2M
```
```
XXX.world.item.BowItem +1M -3M
```
```
XXX.world.item.CompassItem -9M
```
```
XXX.world.item.FishingRodItem +1M -2M
```
```
XXX.world.item.Item -8M | -6P
```
```
XXX.level.block.ChainBlock +4M | +1P
```
```
XXX.block.entity.BannerPattern +2M -6M | +3P -2P
```
```
XXX.block.state.AbstractStateHolder +1M
```
```
XXX.block.state.BlockBehaviour$BlockStateBase +2M
```
```
XXX.block.state.StateHolder +1P
```
```
XXX.levelgen.flat.FlatLevelGeneratorSettings +1P
```
```
XXX.level.pathfinder.Path +1M
```
```
XXX.level.storage.DerivedLevelData +1M -1M | +1P -1P
```
```
XXX.level.storage.LevelData -4M | -30P
```
```
XXX.level.storage.PrimaryLevelData +1M
```
...
```
XXX.blaze3d.platform.Lighting +2M | +4P
```
```
XXX.minecraft.advancements.AdvancementRewards +1M
```
...
```
```
XXX.gui.components.DebugScreenOverlay +6M -4M
```
```
XXX.gui.font.TextFieldHelper +4M -4M
```
```
XXX.client.map.Map +8M -5M | +2P -6P
```
```
XXX.world.level.LevelAccessor -1P
```
```
XXX.world.level.NaturalSpawner +14M -2M | +2P
```
```
XXX.level.biome.Biome +2M | +1P
```
```
XXX.level.storage.WorldData +1P
```
```
XXX.loot.parameters.LootContextParamSets +1M | +1P
```
```
XXX.loot.predicates.LootItemEntityPropertyCondition +2M
```
```
XXX.phys.shapes.EntityCollisionContext +4M -1M | +1P
```
