...
```diff
+ FormattedCharSequence incompatibleNameDisplayCache
+ MultiLineLabel incompatibleDescriptionDisplayCache
+ FormattedCharSequence cacheName(Component)
+ MultiLineLabel cacheDescription(Component)
```
