...
```diff
+ ChunkAccess lambda$addSaveDependency$2(Object)
+ ChunkAccess lambda$updateChunkToSave$3(ChunkAccess)
+ ChunkAccess lambda$updateChunkToSave$4(ChunkHolder$ChunkLoadingFailure)
+ ChunkAccess lambda$updateChunkToSave$5(Either)
+ void addSaveDependency(CompletableFuture)
+ void lambda$scheduleFullChunkPromotion$6(ChunkHolder$FullChunkStatus)
+ void lambda$scheduleFullChunkPromotion$7(LevelChunk)
+ void lambda$scheduleFullChunkPromotion$8(Either)
- ChunkAccess lambda$updateChunkToSave$2(ChunkAccess)
- ChunkAccess lambda$updateChunkToSave$3(ChunkHolder$ChunkLoadingFailure)
- ChunkAccess lambda$updateChunkToSave$4(Either)
- void lambda$scheduleFullChunkPromotion$5(ChunkHolder$FullChunkStatus)
- void lambda$scheduleFullChunkPromotion$6(LevelChunk)
