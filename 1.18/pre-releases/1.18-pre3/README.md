...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/1.18-pre2">1.18-pre2</a>
## Version data
...
```diff
- ClientTelemetryManager telemetryManager
```
...
<details><summary>net.minecraft.nbt.TagType$1</summary>
...
+ void lambda$pieceGeneratorSupplier$0(PieceGenerator$Context)
- boolean isFeatureChunk(LevelHeightAccessor)
- boolean isFeatureChunk(LevelHeightAccessor)
- void generatePieces(PieceGenerator$Context)
```
...
```diff
+ Optional lambda$new$0(PieceGeneratorSupplier$Context)
+ void <init>(Predicate)
- void <init>(Codec,int,boolean,boolean)
- void lambda$new$0(PieceGenerator$Context)
```
...
<details><summary>net.minecraft.world.level.levelgen.placement.PlacedFeature</summary>
...
<details><summary>net.minecraft.world.level.levelgen.structure.pieces.PieceGenerator</summary>

```diff
+ void generatePieces(net.minecraft.world.level.levelgen.structure.pieces.StructurePiecesBuilder,net.minecraft.world.level.levelgen.structure.pieces.PieceGenerator$Context)
- void generatePieces(net.minecraft.world.level.levelgen.structure.pieces.StructurePiecesBuilder,net.minecraft.world.level.levelgen.feature.configurations.FeatureConfiguration,net.minecraft.world.level.levelgen.structure.pieces.PieceGenerator$Context)
```
...
<details><summary>net.minecraft.world.level.chunk.CarvingMask</summary>

```diff
+ CarvingMask$Mask additionalMask
...
+ void lambda$getAll$4(GlobalPalette,int)
- int lambda$read$4(Object)
- int lambda$read$5(SimpleBitStorage,int)
- void lambda$count$6(Int2IntMap,int)
- void lambda$count$7(Int2IntMap$Entry)
```
...
```diff
+ NoiseColumn lambda$findSuitableY$1(BlockPos)
+ Optional pieceGeneratorSupplier(PieceGeneratorSupplier$Context)
+ void lambda$pieceGeneratorSupplier$0(PieceGenerator$Context)
...
```diff
+ PieceGeneratorSupplier pieceGenerator
- PieceGenerator pieceGenerator
+ boolean canGenerate(Predicate)
+ void <init>(PieceGeneratorSupplier)
+ void <init>(PostPlacementProcessor)
- boolean isFeatureChunk(LevelHeightAccessor)
- void <init>(PieceGenerator)
- void <init>(PostPlacementProcessor)
```
...
- boolean lambda$canBePlacedOn$7(BlockState)
```
...
<details><summary>net.minecraft.world.level.levelgen.structure.NoiseAffectingStructureFeature</summary>
...
<details><summary>net.minecraft.world.level.levelgen.structure.pieces.PieceGenerator$Context</summary>
...
<details><summary>net.minecraft.world.ticks.ScheduledTick</summary>

```diff
- ScheduledTick worldgen(BlockPos,long)
```
