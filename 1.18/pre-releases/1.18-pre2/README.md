...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/1.18-pre1">1.18-pre1</a>
## File structure
...
```diff
+ SimpleCommandExceptionType ERROR_TOO_FAR_OUT
```
...
```diff
+ Dynamic lambda$makeBiomeContainer$24(Integer)
...
+ Pair lambda$updateCarvingMasks$21(Pair)
+ void lambda$shiftUpgradeData$17(Integer)
+ void lambda$shiftUpgradeData$18(Dynamic)
+ void lambda$shiftUpgradeData$19(Map)
- Dynamic lambda$makeBiomeContainer$20(Integer)
- Dynamic lambda$updateHeightmaps$18(Dynamic)
- long lambda$getFixedHeightmap$19(long)
- Pair lambda$updateCarvingMasks$17(Pair)
```
...
```diff
+ int PANIC_DISTANCE_HORIZONTAL
- int PANIC_DISTANCE_HORIZANTAL
+ boolean lambda$lookForWater$0(BlockPos)
+ Optional lookForWater(Entity)
+ Vec3 getPanicPos(ServerLevel)
```
...
```diff
+ double MINIMUM_FALL_DISTANCE_FOR_BIG_SOUND
+ double MINIMUM_FALL_DISTANCE_FOR_SOUND
