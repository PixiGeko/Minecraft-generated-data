...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/1.18.2-pre1">1.18.2-pre1</a>
## Registries
...
<details><summary>net.minecraft.Util$1</summary>
...
```diff
+ CubicSpline mapAll(net.minecraft.util.CubicSpline$CoordinateVisitor)
```
...
```diff
+ WorldData getDataTag(Lifecycle)
...
```diff
+ Logger LOGGER
+ boolean lambda$allConfigurations$19(ConfiguredStructureFeature)
+ boolean lambda$getMobsAt$16(StructureStart)
+ boolean lambda$getMobsAt$17(StructureStart)
+ boolean lambda$tryGenerateStructure$21(Holder)
+ ChunkAccess lambda$createBiomes$6(ChunkAccess)
+ CompletableFuture generateRingPositions(ConcentricRingsStructurePlacement)
+ Integer lambda$applyBiomeDecoration$9(ConfiguredStructureFeature)
+ List lambda$generateRingPositions$5(ConcentricRingsStructurePlacement)
+ Set lambda$findNearestMapFeature$8(StructurePlacement)
+ Stream lambda$findNearestMapFeature$7(Holder)
+ String lambda$applyBiomeDecoration$12(ConfiguredStructureFeature)
+ String lambda$applyBiomeDecoration$15(PlacedFeature)
+ String lambda$createReferences$22(Registry)
...
+ void lambda$applyBiomeDecoration$10(Holder)
+ void lambda$applyBiomeDecoration$11(ChunkPos)
+ void lambda$applyBiomeDecoration$13(StructureStart)
+ void lambda$applyBiomeDecoration$14(PlacedFeature)
+ void lambda$createStructures$20(Holder)
+ void lambda$getMobsAt$18(StructureStart)
- boolean lambda$allConfigurations$18(ConfiguredStructureFeature)
- boolean lambda$getMobsAt$15(StructureStart)
- boolean lambda$getMobsAt$16(StructureStart)
- boolean lambda$tryGenerateStructure$20(Holder)
...
- String lambda$applyBiomeDecoration$11(ConfiguredStructureFeature)
- String lambda$applyBiomeDecoration$14(PlacedFeature)
- String lambda$createReferences$21(Registry)
- String lambda$createReferences$22(StructureStart)
- String lambda$createReferences$23(StructureStart)
- void ensureGenerated()
- void generateRingPositions(ConcentricRingsStructurePlacement)
...
- void lambda$applyBiomeDecoration$9(Holder)
- void lambda$createStructures$19(Holder)
