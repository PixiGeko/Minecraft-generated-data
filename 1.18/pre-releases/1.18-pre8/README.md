...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/1.18-pre7">1.18-pre7</a>
## Mappings
...
```diff
+ Supplier delayedCrash
- CrashReport delayedCrash
...
<details><summary>net.minecraft.client.renderer.chunk.ChunkRenderDispatcher$RenderChunk$ResortTransparencyTask</summary>
...
<details><summary>net.minecraft.util.CrudeIncrementalIntIdentityHashBiMap</summary>

```diff
+ CrudeIncrementalIntIdentityHashBiMap copy()
+ void <init>(Object[],int,int)
```
...
+ Dynamic lambda$repackBiomes$1(ByteBuffer)
+ Dynamic lambda$repackBiomes$2(Dynamic)
+ Dynamic lambda$repackTicks$5(Dynamic,int)
+ Dynamic lambda$repackTicks$6(ShortList)
+ Dynamic lambda$repackTicks$7(Stream)
...
+ void lambda$repackTicks$4(Dynamic)
- Dynamic lambda$makeRule$4(ShortList)
...
- void lambda$makeRule$3(Dynamic)
```
...
<details><summary>net.minecraft.world.entity.ai.goal.PathfindToRaidGoal</summary>
...
+ void <init>(PalettedContainer$Data)
```
