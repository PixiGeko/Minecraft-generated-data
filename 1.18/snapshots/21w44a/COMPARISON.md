## Comparison with [21w43a](https://github.com/PixiGeko/Minecraft-generated-data/tree/21w43a)
...
<br/>
<table><tr><th></th><th align="left">21w43a</th><th>21w44a</th></tr><tr><td>World version</td><td><pre>2844</pre></td><td><pre>2845</pre></td></tr><tr><td>Protocol version</td><td><pre>1073741871</pre></td><td><pre>1073741872</pre></td></tr></table>
<h3>Libraries<a name="version-data-libraries"></a></h3>
<details>
<summary>
Versions
</summary>
<table><tr><th></th><th align="left">21w43a</th><th>21w44a</th></tr><tr><td>org.lwjgl:lwjgl-glfw</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-glfw</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr></table>
</details>
</details>
<hr/>
...
```
XXX.minecraft.core.SectionPos +3M
```
```
XXX.data.advancements.AdventureAdvancements +1M | -1P
```
```
...
```
```
XXX.server.commands.JfrCommand +1M
```
```
XXX.server.network.ServerGamePacketListenerImpl +4M -6M
```
```
XXX.minecraft.util.CubicSpline +1M
```
```
XXX.profiling.jfr.JfrProfiler +7M -4M | +3P -1P
```
```
XXX.profiling.jfr.JvmProfiler +2P -3P
```
```
XXX.world.level.CollisionGetter +8M -10M | +1P -1P
```
```
XXX.level.levelgen.DebugLevelSource +1M -1M
```
```
XXX.level.levelgen.NoiseBasedChunkGenerator +1M -2M | -1P
```
```
XXX.level.levelgen.NoiseSampler +1P -2P
```
```
XXX.level.levelgen.SurfaceRules +2M
```
```
XXX.level.levelgen.SurfaceRules$Context$HoleCondition +2M -3M
```
```
XXX.level.levelgen.SurfaceSystem +5M -4M | +1P
```
...
```
net.minecraft.SharedConstants +1M -1M | +1P
```
```
XXX.jfr.event.PacketEvent$Fields +2P -1P
```
```
XXX.jfr.event.PacketSentEvent +1M -1M
```
```
XXX.jfr.parse.JfrStatsParser +4M | +2P -2P
```
```
XXX.world.entity.EntitySelector +1P
```
```
XXX.world.entity.EntityType +4M -5M
```
```
...
```
```
XXX.world.level.CommonLevelAccessor +1M -1M
```
```
XXX.world.level.PathNavigationRegion +1M -2M
```
```
XXX.level.biome.TerrainShaper +1M -1M
```
```
XXX.level.border.WorldBorder +2M
```
```
XXX.level.chunk.ProtoChunk +2M
```
```
XXX.level.entity.EntitySectionStorage +3M -5M
```
```
XXX.level.levelgen.SurfaceRules$BiomeConditionSource$1BiomeCondition +2M -3M | +1P
```
```
XXX.level.levelgen.SurfaceRules$Context +6M -3M | +20P -6P
```
```
XXX.level.levelgen.SurfaceRules$Context$TemperatureHelperCondition +2M -3M
```
```
XXX.level.levelgen.SurfaceRules$LazyCondition +1M -2M | +4P -2P
```
```
XXX.level.levelgen.SurfaceRules$NoiseThresholdConditionSource$1NoiseThresholdCondition +2M -3M | +1P
```
```
XXX.levelgen.carver.CarvingContext +1M -1M
```
```
XXX.levelgen.feature.LargeDripstoneFeature +1M -1M
```
```
XXX.feature.structures.JigsawPlacement$Placer +1M -1M
```
```
XXX.phys.shapes.EntityCollisionContext +2M -2M | +1P -1P
```
```
XXX.phys.shapes.Shapes +3M -4M
```
