## Comparison with [21w42a](https://github.com/PixiGeko/Minecraft-generated-data/tree/21w42a)
...
<br/>
<table><tr><th></th><th align="left">21w42a</th><th>21w43a</th></tr><tr><td>World version</td><td><pre>2840</pre></td><td><pre>2844</pre></td></tr><tr><td>Protocol version</td><td><pre>1073741870</pre></td><td><pre>1073741871</pre></td></tr></table>
<h3>Libraries<a name="version-data-libraries"></a></h3>
<details>
<summary>
Versions
</summary>
<table><tr><th></th><th align="left">21w42a</th><th>21w43a</th></tr><tr><td>org.lwjgl:lwjgl-glfw</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-glfw</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr></table>
</details>
</details>
<hr/>
...
<br/>
<table>
<tr><th>Name</th><th>21w42a</th><th>21w43a</th></tr>
<tr><th align="left"><div style="width:290px">options.prioritizeChunkUpdates</div></th><td>Priority updates</td><td>Chunk Builder</td></tr>
<tr><th align="left"><div style="width:290px">options.prioritizeChunkUpdates.none</div></th><td>none</td><td>Threaded</td></tr>
<tr><th align="left"><div style="width:290px">options.prioritizeChunkUpdates.byPlayer</div></th><td>by player</td><td>Semi Blocking</td></tr>
<tr><th align="left"><div style="width:290px">options.prioritizeChunkUpdates.nearby</div></th><td>nearby</td><td>Fully Blocking</td></tr>
</table>
<br/>
</details>
</details>
...
- XXX.level.levelgen.SurfaceRules$Context$SteepMaterialCondition$State
+ XXX.level.levelgen.SurfaceRules$Context$TemperatureHelperCondition
- XXX.level.levelgen.SurfaceRules$Context$TemperatureHelperCondition$State
+ XXX.level.levelgen.SurfaceRules$EagerCondition
- XXX.level.levelgen.SurfaceRules$Hole
+ XXX.level.levelgen.SurfaceRules$LazyCondition
- XXX.level.levelgen.SurfaceRules$NoiseThresholdConditionSource
+ XXX.level.levelgen.SurfaceRules$NoiseThresholdConditionSource$1NoiseThresholdCondition
- XXX.level.levelgen.SurfaceRules$NoiseThresholdConditionState
...
- XXX.level.levelgen.SurfaceRules$UpdatableCondition
...
```
```
XXX.data.worldgen.Features$Configs +1P
```
```
XXX.data.worldgen.SurfaceRuleData +2P
```
```
XXX.minecraft.util.CubicSpline +10M -11M | +1P -4P
```
```
XXX.level.chunk.ChunkAccess +8M -4M | +5P -2P
```
```
XXX.chunk.storage.ChunkSerializer +11M -5M | +2P
```
```
XXX.level.dimension.DimensionType +2P
```
```
XXX.level.levelgen.Aquifer -1P
```
```
XXX.level.levelgen.NoiseSampler +6M -5M
```
...
```
XXX.blaze3d.platform.GlUtil -1M
```
```
XXX.worldgen.biome.OverworldBiomes -1M
```
```
XXX.server.dedicated.DedicatedServer -2M
```
```
XXX.server.dedicated.DedicatedServerProperties -1P
```
```
XXX.server.level.ChunkHolder -1M
```
```
XXX.server.level.ChunkMap +4M -4M
```
```
XXX.server.level.ServerLevel +30M -31M | +3P -2P
```
```
XXX.server.level.WorldGenRegion +5M -4M | +3P -2P
```
```
XXX.minecraft.util.CubicSpline$Constant +4M
```
```
XXX.minecraft.util.Mth +1M
```
```
XXX.datafix.fixes.ChunkHeightAndBiomeFix +20M -18M | +2P -1P
```
```
XXX.util.profiling.InactiveProfiler +2M -2M
```
```
XXX.util.profiling.ProfilerFiller$1 +2M -2M
```
```
XXX.util.worldupdate.WorldUpgrader +1M -1M | +1P -1P
```
```
XXX.level.biome.BiomeSource +3M -2M
```
```
XXX.level.biome.Biomes -1P
```
```
XXX.level.biome.TerrainShaper +4M | +2P -4P
```
```
XXX.level.chunk.LevelChunk +10M -8M | +2P
```
```
XXX.level.chunk.ProtoChunk +11M -6M | +3P -1P
```
```
XXX.level.levelgen.FlatLevelSource +1M -1M
```
```
XXX.level.levelgen.NoiseChunk +3M -8M | +2P -6P
```
```
XXX.level.levelgen.NoiseSettings +3M -2M | +1P
```
```
XXX.level.levelgen.Noises +6P -2P
```
```
XXX.level.levelgen.RandomSource +1M
```
```
XXX.level.levelgen.SurfaceRules$Context -1M | -1P
```
