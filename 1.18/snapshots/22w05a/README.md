...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/22w03a">22w03a</a>
## Tags

<details><summary>blocks/dripstone_replaceable_blocks.json</summary>
...
+ void lambda$new$2(AbstractSelectionList$Entry)
...
```diff
+ boolean renderLiquid(FluidState)
- boolean renderLiquid(FluidState)
```

</details>

<details><summary>net.minecraft.client.renderer.block.LiquidBlockRenderer</summary>

```diff
+ boolean isFaceOccludedByNeighbor(BlockState)
+ boolean isNeighborSameFluid(FluidState)
+ boolean shouldRenderFace(FluidState)
+ boolean tesselate(FluidState)
+ float calculateAverageHeight(BlockPos)
+ float getHeight(BlockPos)
+ float getHeight(FluidState)
+ void addWeightedHeight(float[],float)
- boolean isFaceOccludedByNeighbor(Direction,float)
- boolean isNeighborSameFluid(FluidState)
- boolean shouldRenderFace(Direction)
- boolean tesselate(FluidState)
- float getWaterHeight(Fluid)
```
...
<details><summary>net.minecraft.world.entity.animal.Panda$PandaPanicGoal</summary>
...
<details><summary>net.minecraft.world.entity.animal.PolarBear$PolarBearPanicGoal</summary>
...
```diff
+ int EAGER_CHUNK_SAVE_COOLDOWN_IN_MILLIS
+ Long2LongMap chunkSaveCooldowns
...
+ CompletableFuture lambda$schedule$15(ChunkAccess)
...
+ void lambda$prepareAccessibleChunk$42(Runnable)
+ void lambda$prepareTickingChunk$35(Runnable)
+ void lambda$prepareTickingChunk$36(ServerPlayer)
+ void lambda$prepareTickingChunk$37(LevelChunk)
+ void lambda$prepareTickingChunk$38(Either)
+ void lambda$prepareTickingChunk$39(Runnable)
...
+ void lambda$saveAllChunks$11(ChunkAccess)
+ void lambda$scheduleChunkGeneration$19(Runnable)
+ void lambda$scheduleChunkGeneration$21(CrashReport)
+ void lambda$scheduleUnload$13(ChunkAccess)
+ void lambda$scheduleUnload$14(Throwable)
+ void lambda$setViewDistance$43(ServerPlayer)
...
```diff
- int MAX_SEARCH_LENGTH_WHEN_LOOKING_FOR_TIP_OF_FALLING_STALACTITE
- int getStalactiteSizeFromTip(BlockPos,int)
- void scheduleStalactiteFallTicks(BlockPos)
```
...
<details><summary>net.minecraft.world.level.levelgen.feature.DripstoneUtils</summary>
