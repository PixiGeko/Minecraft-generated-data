## Comparison with [21w37a](https://github.com/PixiGeko/Minecraft-generated-data/tree/21w37a)
...
<br/>
<table><tr><th></th><th align="left">21w37a</th><th>21w38a</th></tr><tr><td>World version</td><td><pre>2834</pre></td><td><pre>2835</pre></td></tr><tr><td>Protocol version</td><td><pre>1073741865</pre></td><td><pre>1073741866</pre></td></tr></table>
<h3>Libraries<a name="version-data-libraries"></a></h3>
<details>
<summary>
Versions
</summary>
<table><tr><th></th><th align="left">21w37a</th><th>21w38a</th></tr><tr><td>com.mojang:authlib</td><td><pre>2.3.31</pre></td><td><pre>3.0.35</pre></td></tr><tr><td>commons-codec:commons-codec</td><td><pre>1.10</pre></td><td><pre>1.15</pre></td></tr><tr><td>org.lwjgl:lwjgl-glfw</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-glfw</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr><tr><td>org.lwjgl:lwjgl</td><td><pre>3.2.1</pre></td><td><pre>3.2.2</pre></td></tr></table>
</details>
</details>
<hr/>
...
- XXX.levelgen.placement.BlockSurvivesFilterDecorator
...
```
```
XXX.data.worldgen.Carvers +1P -6P
```
```
XXX.data.worldgen.Features +6M | +32P -41P
```
```
XXX.minecraft.network.PacketEncoder +1M
```
```
XXX.server.players.PlayerList +2M | +1P
```
```
XXX.levelgen.feature.DesertPyramidFeature +1M -1M
```
```
XXX.levelgen.feature.PillagerOutpostFeature -1M
```
```
XXX.levelgen.feature.SwamplandHutFeature +1M -3M
```
```
XXX.levelgen.structure.DesertPyramidPiece +3M -3M
```
```
XXX.levelgen.structure.EndCityPieces$EndCityPiece +2M -2M
```
```
XXX.levelgen.structure.JunglePyramidPiece +3M -3M
```
```
XXX.levelgen.structure.MineShaftPieces$MineShaftCrossing +3M -3M
```
```
XXX.levelgen.structure.MineShaftPieces$MineShaftRoom +3M -3M
```
```
XXX.levelgen.structure.NetherBridgePieces$BridgeCrossing +2M -2M
```
```
XXX.levelgen.structure.NetherBridgePieces$BridgeStraight +2M -2M
```
```
XXX.levelgen.structure.NetherBridgePieces$CastleCorridorTBalconyPiece +2M -2M
```
```
XXX.levelgen.structure.NetherBridgePieces$CastleSmallCorridorCrossingPiece +2M -2M
```
```
XXX.levelgen.structure.NetherBridgePieces$CastleSmallCorridorPiece +2M -2M
```
```
XXX.levelgen.structure.NetherBridgePieces$CastleStalkRoom +2M -2M
```
```
XXX.levelgen.structure.NetherBridgePieces$NetherBridgePiece +1M -1M
```
```
XXX.levelgen.structure.NetherBridgePieces$RoomCrossing +2M -2M
```
```
XXX.levelgen.structure.NetherBridgePieces$StartPiece +1M -1M
```
```
XXX.levelgen.structure.PoolElementStructurePiece +4M -4M
```
```
XXX.levelgen.structure.SwamplandHutPiece +3M -3M
```
...
- XXX.levelgen.feature.StructurePieceType$StructureTemplateType
...
- XXX.levelgen.placement.SurfaceRelativeThresholdDecorator
...
- XXX.levelgen.surfacebuilders.GroveSurfaceBuilder
...
- XXX.levelgen.surfacebuilders.NoiseMaterialSurfaceBuilder
...
- XXX.levelgen.surfacebuilders.SnowcappedPeaksSurfaceBuilder
...
- XXX.levelgen.surfacebuilders.StonyPeaksSurfaceBuilder
...
```
```
XXX.server.level.DistanceManager +12M -8M | +4P
```
```
XXX.server.level.ServerChunkCache +2M -1M
```
```
XXX.jfr.serialize.JfrResultJsonSerializer +5M -4M
```
```
XXX.jfr.stats.ChunkGenStat +1M -2M | -1P
```
```
XXX.world.entity.Entity +2P
```
```
XXX.level.biome.Climate +2M
```
```
XXX.level.biome.Climate$Parameter +7M -5M | +2P -2P
```
```
XXX.level.biome.Climate$ParameterPoint +4M -4M | +1P -1P
```
```
XXX.level.biome.Climate$RTree$Leaf +1M -1M
```
```
XXX.level.biome.Climate$RTree$SubTree +1M -1M
```
```
XXX.level.biome.Climate$TargetPoint +11M -8M | +6P -6P
```
```
XXX.level.chunk.ChunkGenerator +5M -7M
```
```
XXX.level.chunk.ChunkStatus +1M -2M
```
```
XXX.levelgen.carver.CanyonCarverConfiguration +1M -1M
```
```
XXX.levelgen.carver.CaveCarverConfiguration +1M -1M
```
```
XXX.levelgen.feature.BuriedTreasureFeature +2M -1M
```
```
XXX.levelgen.feature.EndCityFeature +1M -1M
```
```
XXX.levelgen.feature.MineshaftFeature +1M -1M
```
```
XXX.levelgen.feature.WoodlandMansionFeature +2M -1M
```
```
XXX.feature.configurations.TreeConfiguration$TreeConfigurationBuilder +1M -1M | -1P
```
```
XXX.levelgen.structure.NetherFossilPieces$NetherFossilPiece +3M -3M
```
```
XXX.levelgen.structure.OceanMonumentPieces$OceanMonumentDoubleXRoom +2M -2M
```
```
XXX.levelgen.structure.OceanMonumentPieces$OceanMonumentDoubleYRoom +2M -2M
```
```
XXX.levelgen.structure.OceanMonumentPieces$OceanMonumentDoubleZRoom +2M -2M
```
```
XXX.levelgen.structure.OceanMonumentPieces$OceanMonumentPenthouse +2M -2M
```
```
XXX.levelgen.structure.OceanMonumentPieces$OceanMonumentSimpleRoom +2M -2M
```
```
XXX.levelgen.structure.OceanMonumentPieces$OceanMonumentWingRoom +2M -2M
```
```
XXX.levelgen.structure.OceanRuinFeature +1M -2M
```
```
XXX.levelgen.structure.ScatteredFeaturePiece +1M -1M
```
```
XXX.levelgen.structure.ShipwreckPieces$ShipwreckPiece +3M -3M
```
```
XXX.levelgen.structure.StrongholdPieces$FillerCorridor +3M -3M
```
```
XXX.levelgen.structure.StrongholdPieces$LeftTurn +2M -2M
```
```
XXX.levelgen.structure.StrongholdPieces$PrisonHall +2M -2M
```
```
XXX.levelgen.structure.StrongholdPieces$RoomCrossing +3M -3M
```
```
XXX.levelgen.structure.StrongholdPieces$StairsDown +3M -3M
```
```
XXX.levelgen.structure.StrongholdPieces$Straight +3M -3M
```
```
XXX.levelgen.structure.StrongholdPieces$StrongholdPiece +1M -1M
```
```
XXX.levelgen.structure.StructurePiece +4M -1M | +2P -2P
```
```
XXX.levelgen.structure.StructureStart +3M -16M | +1P -4P
```
