## Comparison with [22w19a](https://github.com/PixiGeko/Minecraft-generated-data/tree/22w19a)
...
<br/>
<table><tr><th></th><th align="left">22w19a</th><th>1.19-pre1</th></tr><tr><td>World version</td><td><pre>3096</pre></td><td><pre>3098</pre></td></tr><tr><td>Protocol version</td><td><pre>1073741908</pre></td><td><pre>1073741909</pre></td></tr></table>
...
```diff
+ io.netty:netty-transport-native-epoll (linux-aarch_64) V4.1.77.Final
+ io.netty:netty-transport-native-epoll (linux-x86_64) V4.1.77.Final
- io.netty:netty-transport-native-epoll V4.1.77.Final
+ org.lwjgl:lwjgl (natives-linux) V3.3.1
+ org.lwjgl:lwjgl (natives-macos-arm64) V3.3.1
+ org.lwjgl:lwjgl (natives-macos) V3.3.1
+ org.lwjgl:lwjgl (natives-windows-x86) V3.3.1
+ org.lwjgl:lwjgl (natives-windows) V3.3.1
+ org.lwjgl:lwjgl-glfw (natives-linux) V3.3.1
+ org.lwjgl:lwjgl-glfw (natives-macos-arm64) V3.3.1
+ org.lwjgl:lwjgl-glfw (natives-macos) V3.3.1
+ org.lwjgl:lwjgl-glfw (natives-windows-x86) V3.3.1
+ org.lwjgl:lwjgl-glfw (natives-windows) V3.3.1
+ org.lwjgl:lwjgl-jemalloc (natives-linux) V3.3.1
+ org.lwjgl:lwjgl-jemalloc (natives-macos-arm64) V3.3.1
+ org.lwjgl:lwjgl-jemalloc (natives-macos) V3.3.1
+ org.lwjgl:lwjgl-jemalloc (natives-windows-x86) V3.3.1
+ org.lwjgl:lwjgl-jemalloc (natives-windows) V3.3.1
+ org.lwjgl:lwjgl-openal (natives-linux) V3.3.1
+ org.lwjgl:lwjgl-openal (natives-macos-arm64) V3.3.1
+ org.lwjgl:lwjgl-openal (natives-macos) V3.3.1
+ org.lwjgl:lwjgl-openal (natives-windows-x86) V3.3.1
+ org.lwjgl:lwjgl-openal (natives-windows) V3.3.1
+ org.lwjgl:lwjgl-opengl (natives-linux) V3.3.1
+ org.lwjgl:lwjgl-opengl (natives-macos-arm64) V3.3.1
+ org.lwjgl:lwjgl-opengl (natives-macos) V3.3.1
+ org.lwjgl:lwjgl-opengl (natives-windows-x86) V3.3.1
+ org.lwjgl:lwjgl-opengl (natives-windows) V3.3.1
+ org.lwjgl:lwjgl-stb (natives-linux) V3.3.1
+ org.lwjgl:lwjgl-stb (natives-macos-arm64) V3.3.1
+ org.lwjgl:lwjgl-stb (natives-macos) V3.3.1
+ org.lwjgl:lwjgl-stb (natives-windows-x86) V3.3.1
+ org.lwjgl:lwjgl-stb (natives-windows) V3.3.1
+ org.lwjgl:lwjgl-tinyfd (natives-linux) V3.3.1
+ org.lwjgl:lwjgl-tinyfd (natives-macos-arm64) V3.3.1
+ org.lwjgl:lwjgl-tinyfd (natives-macos) V3.3.1
+ org.lwjgl:lwjgl-tinyfd (natives-windows-x86) V3.3.1
+ org.lwjgl:lwjgl-tinyfd (natives-windows) V3.3.1
```
...
<br/>
<table>
<tr><th>Name</th><th>22w19a</th><th>1.19-pre1</th></tr>
<tr><th align="left"><div style="width:290px">options.fovEffectScale.tooltip</div></th><td>Controls how much the field of view can change with speed effects.</td><td>Controls how much the field of view can change with gameplay effects.</td></tr>
<tr><th align="left"><div style="width:290px">subtitles.entity.goat.horn_break</div></th><td>Goat horn breaks off</td><td>Goat Horn breaks off</td></tr>
<tr><th align="left"><div style="width:290px">subtitles.item.goat_horn.play</div></th><td>Goat horn plays</td><td>Goat Horn plays</td></tr>
<tr><th align="left"><div style="width:290px">advancements.husbandry.allay_deliver_cake_to_note_block.description</div></th><td>Have an Allay drop a cake at a Note Block</td><td>Have an Allay drop a Cake at a Note Block</td></tr>
</table>
<br/>
</details>
</details>
...
```
```
XXX.minecraft.commands.Commands +10M -8M
```
```
XXX.commands.arguments.ArgumentSignatures +1P
```
```
XXX.commands.arguments.ComponentArgument -2M
```
```
XXX.minecraft.core.MappedRegistry +3M -2M
```
```
XXX.data.structures.NbtToSnbt +3M -3M
```
```
XXX.gametest.framework.GameTestServer +1P
```
```
XXX.network.chat.ChatDecorator +5M -5M | +1P -1P
```
```
XXX.protocol.game.ServerboundChatPacket +1M -2M
```
```
XXX.protocol.login.ServerboundKeyPacket +2M -1M
```
```
XXX.minecraft.resources.RegistryFixedCodec +2M -2M
```
```
XXX.util.datafix.DataFixers +3M -2M
```
```
XXX.datafix.fixes.GoatHornIdFix +2M -4M
```
...
```
```
XXX.minecraft.client.Minecraft +2M -1M | +2P
```
```
XXX.commands.arguments.MessageArgument$Message +2M
```
```
XXX.network.chat.MessageSignature +4M -3M
```
```
XXX.server.dedicated.DedicatedServer +1M -2M | -1P
```
```
XXX.server.dedicated.DedicatedServerProperties -1P
```
```
XXX.server.players.PlayerList +3M -3M
```
```
XXX.datafix.fixes.OminousBannerRenameFix +3M -4M
```
```
XXX.world.entity.AnimationState +2M -2M | -1P
```
```
...
```
```
XXX.entity.animal.CatVariant +1P -1P
```
```
...
```
```
XXX.entity.player.ProfilePublicKey +2M -2M | -1P
```
```
XXX.world.inventory.InventoryMenu$1 +2M -1M | +1P
```
```
XXX.level.biome.Biome$ClimateSettings +7M
```
```
XXX.level.biome.BiomeSource -6M | -1P
```
```
XXX.block.entity.SculkSensorBlockEntity +3M -2M
```
```
XXX.block.entity.SkullBlockEntity +1M -1M
```
```
XXX.level.chunk.ChunkAccess +1M -1M | +1P -1P
```
```
XXX.level.chunk.ChunkGenerator +23M -22M | +2P -1P
```
```
XXX.gameevent.vibrations.VibrationListener +3M -3M | +1P -1P
```
```
XXX.gameevent.vibrations.VibrationListener$VibrationListenerConfig +1P -1P
```
```
