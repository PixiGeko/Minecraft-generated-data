...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/1.19.1-rc1">1.19.1-rc1</a>
## File structure
...
<details><summary>net.minecraft.client.gui.screens.reporting.ChatSelectionScreen$ChatSelectionList$MessageEntry</summary>

```diff
+ GuiMessageTag$Icon tagIcon
+ int TAG_MARGIN_LEFT
+ List tagHoverText
+ void <init>(GuiMessageTag,boolean,boolean)
+ void renderTag(PoseStack,int,int,int,int,int)
- void <init>(Component,boolean,boolean)
```
...
```diff
- Duration MESSAGE_EXPIRES_AFTER
...
+ void broadcastSystemMessage(Function,boolean)
