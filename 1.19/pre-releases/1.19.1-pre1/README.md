...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/22w24a">22w24a</a>
## File structure
...
```diff
+ TimeSource$NanoTimeSource initBackendSystem()
- LongSupplier initBackendSystem()
```
...
+ DataFetcher$Task newsTask
+ DataFetcher$Task pendingInvitesTask
+ DataFetcher$Task serverListUpdateTask
+ DataFetcher$Task trialAvailabilityTask
+ RealmsNewsManager newsManager
...
- RealmsServerPlayerLists livestats
...
- ScheduledFuture liveStatsScheduledFuture
- ScheduledFuture pendingInviteScheduledFuture
- ScheduledFuture serverListScheduledFuture
- ScheduledFuture trialAvailableScheduledFuture
- ScheduledFuture unreadNewsScheduledFuture
- Set removedServers
- String newsLink
+ List lambda$new$0(RealmsClient)
+ void <init>(RealmsClient)
- boolean hasUnreadNews()
- boolean isActive()
- boolean isFetchedSinceLastTry(RealmsDataFetcher$Task)
- boolean isStopped()
...
- RealmsServerPlayerLists getLivestats()
- String newsLink()
- void <clinit>()
- void <init>(RealmsClient)
- void <init>(RealmsPersistence)
- void cancelTasks()
- void forceUpdate()
- void init()
...
<details><summary>com.mojang.realmsclient.util.LevelType</summary>
...
```diff
+ TimeSource$NanoTimeSource timeSource
...
- boolean lambda$createSearchTrees$5(String)
...
```diff
+ boolean removeEntryFromTop(AbstractSelectionList$Entry)
```
...
+ net.minecraft.client.multiplayer.chat.LoggedChat
- net.minecraft.client.multiplayer.chat.LoggedChat$Player
+ net.minecraft.client.multiplayer.chat.LoggedChat$System
...
```diff
+ Component GUI_ACKNOWLEDGE
+ MutableComponent days(long)
+ MutableComponent hours(long)
+ MutableComponent minutes(long)
```
...
```diff
+ int NUM_OF_DUPLICATION_HEARTS
- int numOfDuplicatingHearts
+ void handleEntityEvent(byte)
+ void spawnHeartParticle()
```
