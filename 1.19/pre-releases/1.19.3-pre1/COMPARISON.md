## Comparison with [22w46a](https://github.com/PixiGeko/Minecraft-generated-data/tree/22w46a)
...
<br/>
<table><tr><th></th><th align="left">22w46a</th><th>1.19.3-pre1</th></tr><tr><td>World version</td><td><pre>3210</pre></td><td><pre>3211</pre></td></tr><tr><td>Protocol version</td><td><pre>1073741932</pre></td><td><pre>1073741933</pre></td></tr></table>
</details>
<hr/>
...
<br/>
<table>
<tr><th>Name</th><th>22w46a</th><th>1.19.3-pre1</th></tr>
<tr><th align="left"><div style="width:290px">lanServer.port</div></th><td>Port number</td><td>Port Number</td></tr>
...
The World Loaded event is pair with the World Unloaded event to calculate how long the play session has lasted.</td><td>Knowing how players play Minecraft (such as Game Mode, client or server modded, and game version) allows us to focus game updates to improve the areas that players care about most.
...
```
XXX.advancements.critereon.EntitySubPredicate$Types +11M | +11P
```
```
XXX.advancements.critereon.EntityVariantPredicate$1 +1M
```
```
XXX.server.commands.FillBiomeCommand +6M -4M
```
```
XXX.world.entity.Mob +3M -1M
```
```
XXX.entity.animal.Rabbit$RabbitGroupData +1M -1M | +1P -1P
```
```
XXX.entity.animal.TropicalFish$TropicalFishGroupData +1M -1M | +1P -4P
```
```
XXX.entity.monster.Vex +1M | +1P
```
```
XXX.entity.monster.ZombifiedPiglin +1P
```
```
XXX.entity.vehicle.Boat$Type +1M | +1P
```
```
XXX.world.item.DyeColor +1P
```
```
XXX.level.block.ChiseledBookShelfBlock +2M -2M
```
```
XXX.level.block.NoteBlock +1M -1M
```
```
XXX.block.entity.ChiseledBookShelfBlockEntity +1M -3M | +1P
```
```
XXX.block.entity.SkullBlockEntity +1M | +2P
```
```
...
- XXX.atlas.sources.Unstitcher$LazyLoadedImage
...
```
```
XXX.gui.screens.PauseScreen +11M -10M | +18P
```
```
XXX.gui.screens.ShareToLanScreen +1M | +2P
```
```
XXX.renderer.entity.LlamaRenderer +4P -1P
```
```
XXX.entity.layers.ParrotOnShoulderLayer +1M -1M
```
```
XXX.ai.goal.GoalSelector +3M -2M
```
```
XXX.ai.navigation.FlyingPathNavigation +1M
```
```
XXX.ai.navigation.PathNavigation +1M -1M | +2P
```
```
XXX.entity.animal.Fox +4M -2M
```
```
XXX.entity.animal.Fox$Type +1M -2M | +1P -1P
```
```
XXX.entity.animal.MushroomCow +4M -2M
```
```
XXX.entity.animal.Parrot +4M -2M | -1P
```
```
XXX.entity.animal.TropicalFish +10M -13M | +1P -9P
```
```
XXX.animal.axolotl.Axolotl +2M
```
```
XXX.animal.axolotl.Axolotl$Variant +1M | +1P
```
```
XXX.animal.frog.Frog +2M
```
```
XXX.level.pathfinder.AmphibiousNodeEvaluator -1M
```
