...
<tr><th>SHA1</th><td>21a94b1ae0e6fc501f50e4a1a87f5a47f6a6c4f9</td></tr>
<tr><th>Url</th><td><a href="https://piston-meta.mojang.com/v1/packages/21a94b1ae0e6fc501f50e4a1a87f5a47f6a6c4f9/1.19.4-pre2.json">https://piston-meta.mojang.com/v1/packages/21a94b1ae0e6fc501f50e4a1a87f5a47f6a6c4f9/1.19.4-pre2.json</a></td></tr>
...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/1.19.4-pre1">1.19.4-pre1</a>
## File structure
...
```diff
+ entity_types/dismounts_underwater.json
```
...
<details><summary>net.minecraft.client.InputType</summary>

```diff
+ InputType KEYBOARD_ARROW
- InputType KEYBOARD_OTHER
```
...
```diff
+ GuiComponent$ScissorStack SCISSOR_STACK
+ IntIterator slices(int,int)
+ void applyScissor(ScreenRectangle)
+ void blitNineSliced(PoseStack,int,int,int,int,int,int,int,int,int,int)
```
...
- net.minecraft.client.renderer.blockentity.SuspiciousSandRenderer$1
...
+ HolderLookup$Provider lambda$createContentsProvider$4(TagsProvider$TagLookup)
+ IllegalStateException lambda$createContentsProvider$2(TagKey)
+ void lambda$createContentsProvider$3(TagKey)
...
```diff
+ CompletableFuture contentsDone
+ CompletableFuture lookupProvider
- CompletableFuture contentsProvider
+ CompletableFuture createContentsProvider()
+ HolderLookup$Provider lambda$createContentsProvider$11(HolderLookup$Provider)
+ HolderLookup$Provider lambda$run$0(HolderLookup$Provider)
+ TagsProvider$TagLookup lambda$contentsGetter$10(Void)
- CompletableFuture contentsProvider()
...
```diff
+ boolean dismountsUnderwater()
+ Entity getControlledVehicle()
