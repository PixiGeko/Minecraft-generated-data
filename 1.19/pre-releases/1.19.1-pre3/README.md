...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/1.19.1-pre2">1.19.1-pre2</a>
## File structure
...
- void enqueueMessage(GuiMessageTag)
...
<details><summary>net.minecraft.network.chat.ChatTypeDecoration</summary>
...
```diff
+ ClientboundPlayerChatPacket system(Instant)
```
...
```diff
+ ChatType lambda$decorateChatMessage$24(Registry)
+ Component decorateChatMessage(ResourceKey)
- ChatType lambda$logChatMessage$24(Registry)
```
...
<details><summary>net.minecraft.server.commands.MsgCommand</summary>

```diff
+ void lambda$sendMessage$1(FilteredText)
- void lambda$sendMessage$1(FilteredText)
```
