## Comparison with [1.19.1-pre4](https://github.com/PixiGeko/Minecraft-generated-data/tree/1.19.1-pre4)
...
<br/>
<table><tr><th></th><th align="left">1.19.1-pre4</th><th>1.19.1-pre5</th></tr><tr><td>World version</td><td><pre>3112</pre></td><td><pre>3113</pre></td></tr><tr><td>Protocol version</td><td><pre>1073741921</pre></td><td><pre>1073741922</pre></td></tr></table>
<h3>Libraries<a name="version-data-libraries"></a></h3>
<details>
<summary>
Versions
</summary>
<table><tr><th></th><th align="left">1.19.1-pre4</th><th>1.19.1-pre5</th></tr><tr><td>com.mojang:authlib</td><td><pre>3.9.47</pre></td><td><pre>3.10.48</pre></td></tr></table>
</details>
</details>
<hr/>
...
+ options.chatPreview.confirm: On Send
+ options.chatPreview.live: On Modified
...
<br/>
<table>
<tr><th>Name</th><th>1.19.1-pre4</th><th>1.19.1-pre5</th></tr>
<tr><th align="left"><div style="width:290px">gui.chatReport.title</div></th><td>Report Chat</td><td>Report Player</td></tr>
...
<tr><th align="left"><div style="width:290px">gui.abuseReport.reason.imminent_harm.description</div></th><td>Someone is threatening to harm themselves in real life or talking about harming themselves in real life.</td><td>Someone is threatening to harm you or someone else in real life.</td></tr>
<tr><th align="left"><div style="width:290px">gui.abuseReport.reason.self_harm_or_suicide.description</div></th><td>Someone is threatening to harm themselves in real life, or talking about harming yourself in real life.</td><td>Someone is threatening to harm themselves in real life or talking about harming themselves in real life.</td></tr>
<tr><th align="left"><div style="width:290px">chatPreview.warning.content</div></th><td>Chat Preview allows the server to see your messages in real time as you type them, even before they’re sent. This is often used to preview your message with styling applied.



Chat Preview is on by default, but can be turned off in Chat Settings.</td><td>Chat Preview allows the server to see your messages before they are sent to other players. This allows a server to send you a preview of your chat messages with custom modifications and styling applied.



The Chat Preview behavior can be changed in your Chat Settings. Current setting is: [%s]</td></tr>
</table>
<br/>
</details>
</details>
...
+ XXX.network.chat.SignedMessageBody$LastSeen
...
```
```
XXX.minecraft.commands.CommandSigningContext$1 +1M -2M
```
```
XXX.network.chat.ChatDecorator +3M -5M
```
```
XXX.network.chat.SignedMessageChain$Decoder +2M -2M | +1P -1P
```
```
XXX.network.chat.SignedMessageValidator +1P -1P
```
```
XXX.network.chat.SignedMessageValidator$KeyBased +2M -1M
```
```
...
+ XXX.multiplayer.chat.LoggedChat
+ XXX.multiplayer.chat.LoggedChat$System
...
```
```
XXX.minecraft.client.Options +32M -29M | +3P -1P
```
```
XXX.minecraft.client.Options$4 +1P
```
```
XXX.minecraft.client.Screenshot -1P
```
```
XXX.minecraft.client.StringSplitter +1M
```
```
XXX.gui.chat.ClientChatPreview$Preview +2M
```
```
XXX.gui.components.CommandSuggestions +3M
```
```
XXX.screens.reporting.ChatLogSegmenter +1M -1M
```
```
XXX.screens.reporting.ChatSelectionLogFiller +4M -3M
```
```
XXX.screens.reporting.ChatSelectionScreen +1M -1M
```
```
XXX.client.multiplayer.ClientPacketListener +2M | +4P
```
```
XXX.multiplayer.chat.ChatListener$Message +3M -8M | +1P -2P
```
```
XXX.multiplayer.chat.ChatTrustLevel +1M -1M
```
```
XXX.multiplayer.chat.RollingMemoryChatLog +2M -3M | +1P -1P
```
```
XXX.chat.report.ChatReportBuilder +15M -4M | +1P -2P
```
```
XXX.minecraft.commands.CommandSigningContext$SignedArguments +3M -3M | +1P
```
```
XXX.commands.arguments.ArgumentSignatures +3M -2M
```
```
XXX.commands.arguments.ArgumentSignatures$Signer +1P -1P
```
```
XXX.commands.arguments.MessageArgument$ChatMessage +10M -8M | +1P -2P
```
```
XXX.commands.arguments.SignedArgument +1P -1P
```
```
XXX.network.chat.MessageSignature +1M -1M
```
```
XXX.network.chat.SignedMessageBody +3M -7M | +2P -2P
```
```
XXX.protocol.game.ServerboundChatCommandPacket +2M -1M | +1P
```
```
XXX.server.network.FilteredText +1M
```
```
XXX.server.network.ServerGamePacketListenerImpl +25M -19M | +3P
```
