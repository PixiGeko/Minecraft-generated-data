...
<tr><th>SHA1</th><td>befe6d3afd97ef80fc8ec6ec4d5349f08994f2b7</td></tr>
<tr><th>Url</th><td><a href="https://piston-meta.mojang.com/v1/packages/befe6d3afd97ef80fc8ec6ec4d5349f08994f2b7/1.19.3-pre2.json">https://piston-meta.mojang.com/v1/packages/befe6d3afd97ef80fc8ec6ec4d5349f08994f2b7/1.19.3-pre2.json</a></td></tr>
...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/1.19.3-pre1">1.19.3-pre1</a>
## File structure
...
<details><summary>net.minecraft.client.AttackIndicatorStatus</summary>
...
<details><summary>net.minecraft.client.ParticleStatus</summary>
...
<details><summary>net.minecraft.client.PrioritizeChunkUpdates</summary>
...
```diff
+ Screen$DeferredTooltipRendering deferredTooltipRendering
- List tooltip
+ String lambda$wrapScreenError$2(String)
+ void lambda$renderTooltipInternal$1(BufferBuilder,int,int,int,int,int,int,int)
+ void renderTooltip(Screen$DeferredTooltipRendering,int,int)
+ void renderTooltipInternal(ClientTooltipPositioner)
+ void setTooltipForNextRenderPass(ClientTooltipPositioner,boolean)
+ void setTooltipForNextRenderPass(ClientTooltipPositioner,boolean)
- String lambda$wrapScreenError$1(String)
- void renderTooltipInternal(List,int,int)
...
<details><summary>net.minecraft.world.entity.animal.Rabbit$Variant</summary>
...
+ boolean lambda$getSpawnVariant$0(Axolotl$Variant)
- Axolotl$Variant[] lambda$getSpawnVariant$2(int)
- Axolotl$Variant[] lambda$static$0(int)
- boolean lambda$getSpawnVariant$1(Axolotl$Variant)
```
...
<details><summary>net.minecraft.world.entity.animal.horse.Markings</summary>
...
<details><summary>net.minecraft.world.entity.animal.horse.Variant</summary>
...
<details><summary>net.minecraft.world.entity.monster.SpellcasterIllager$IllagerSpell</summary>
...
<details><summary>net.minecraft.world.entity.ai.gossip.GossipType</summary>
...
<details><summary>net.minecraft.world.entity.animal.Parrot$Variant</summary>

```diff
+ IntFunction BY_ID
- Parrot$Variant[] BY_ID
...
<details><summary>net.minecraft.world.entity.animal.horse.Llama$Variant</summary>
...
<details><summary>net.minecraft.world.entity.player.ChatVisiblity</summary>
...
<details><summary>net.minecraft.world.item.FireworkRocketItem$Shape</summary>
...
```diff
+ int NOTE_VOLUME
+ ResourceLocation getCustomSoundId(BlockPos)
...
<details><summary>net.minecraft.world.level.block.state.properties.ChestType</summary>
