...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/1.19.1">1.19.1</a>
## Version data
...
```diff
- Component INVALID_PUBLIC_KEY
- Component INVALID_SIGNATURE
- Component MISSING_PROFILE_PUBLIC_KEY
```
