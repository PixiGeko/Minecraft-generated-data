...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/1.19.1-pre1">1.19.1-pre1</a>
## Version data
...
- long disableButtonUntil
+ Component getNarrationMessage()
+ GenericWaitingScreen createCompleted(Runnable)
+ GenericWaitingScreen createWaiting(Runnable)
+ void <init>(Runnable,int)
...
<details><summary>net.minecraft.client.gui.screens.TitleScreen$1</summary>

```diff
+ Component val$multiplayerDisabledReason
- Component text
+ void <init>(Component)
...
```diff
+ Component REPORT_ERROR_TITLE
+ Component REPORT_SENT_TITLE
...
<details><summary>net.minecraft.client.gui.screens.reporting.ChatSelectionScreen$ChatSelectionList$Entry</summary>
...
+ int CHECKMARK_WIDTH
+ ResourceLocation CHECKMARK_TEXTURE
+ boolean canReport()
+ void <clinit>()
...
```diff
+ void chatSigned(Component)
+ void chatSigned(String)
+ void commandSigned(Component)
+ void commandUnsigned(String)
- void chat(Component)
- void chat(String)
- void command(Component)
- void command(String)
```
...
+ Dynamic updateChunkTag(OptionalDynamic)
