...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/1.19.1-rc2">1.19.1-rc2</a>
## Mappings
...
```diff
+ Component CHAT_FILTERED_TEXT
+ GuiMessageTag CHAT_FILTERED
...
- Object lambda$logResolutionFailure$1(Throwable)
...
+ void <init>(PacketSendListener)
- void <init>(GenericFutureListener)
```
...
<details><summary>net.minecraft.network.chat.OutgoingPlayerChatMessage</summary>

```diff
+ void sendToPlayer(net.minecraft.server.level.ServerPlayer,boolean,net.minecraft.network.chat.ChatType$Bound)
- ClientboundPlayerChatPacket packetForPlayer(net.minecraft.server.level.ServerPlayer,net.minecraft.network.chat.ChatType$Bound)
...
+ void sendToPlayer(ChatType$Bound)
- ClientboundPlayerChatPacket packetForPlayer(ChatType$Bound)
```
...
- void lambda$disconnect$0(Future)
...
- void send(GenericFutureListener)
```
...
```diff
+ FilterMask parseMask(TextFilterClient$IgnoreStrategy)
```
