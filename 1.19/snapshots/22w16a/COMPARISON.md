## Comparison with [22w15a](https://github.com/PixiGeko/Minecraft-generated-data/tree/22w15a)
...
<br/>
<table><tr><th></th><th align="left">22w15a</th><th>22w16a</th></tr><tr><td>World version</td><td><pre>3089</pre></td><td><pre>3091</pre></td></tr><tr><td>Protocol version</td><td><pre>1073741903</pre></td><td><pre>1073741904</pre></td></tr></table>
<h3>Libraries<a name="version-data-libraries"></a></h3>
<details>
<summary>
Versions
</summary>
<table><tr><th></th><th align="left">22w15a</th><th>22w16a</th></tr><tr><td>org.lwjgl:lwjgl-glfw</td><td><pre>3.2.1</pre></td><td><pre>3.3.1</pre></td></tr><tr><td>org.lwjgl:lwjgl-glfw</td><td><pre>3.2.1</pre></td><td><pre>3.3.1</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc</td><td><pre>3.2.1</pre></td><td><pre>3.3.1</pre></td></tr><tr><td>org.lwjgl:lwjgl-jemalloc</td><td><pre>3.2.1</pre></td><td><pre>3.3.1</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal</td><td><pre>3.2.1</pre></td><td><pre>3.3.1</pre></td></tr><tr><td>org.lwjgl:lwjgl-openal</td><td><pre>3.2.1</pre></td><td><pre>3.3.1</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl</td><td><pre>3.2.1</pre></td><td><pre>3.3.1</pre></td></tr><tr><td>org.lwjgl:lwjgl-opengl</td><td><pre>3.2.1</pre></td><td><pre>3.3.1</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb</td><td><pre>3.2.1</pre></td><td><pre>3.3.1</pre></td></tr><tr><td>org.lwjgl:lwjgl-stb</td><td><pre>3.2.1</pre></td><td><pre>3.3.1</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd</td><td><pre>3.2.1</pre></td><td><pre>3.3.1</pre></td></tr><tr><td>org.lwjgl:lwjgl-tinyfd</td><td><pre>3.2.1</pre></td><td><pre>3.3.1</pre></td></tr><tr><td>org.lwjgl:lwjgl</td><td><pre>3.2.1</pre></td><td><pre>3.3.1</pre></td></tr><tr><td>org.lwjgl:lwjgl</td><td><pre>3.2.1</pre></td><td><pre>3.3.1</pre></td></tr></table>
</details>
</details>
<hr/>
...
<br/>
<table>
<tr><th>Name</th><th>22w15a</th><th>22w16a</th></tr>
<tr><th align="left"><div style="width:290px">subtitles.entity.parrot.imitate.elder_guardian</div></th><td>Parrot flaps</td><td>Parrot moans</td></tr>
<tr><th align="left"><div style="width:290px">subtitles.entity.parrot.imitate.piglin_brute</div></th><td>Parrot snorts mightily</td><td>Parrot snorts</td></tr>
<tr><th align="left"><div style="width:290px">subtitles.entity.parrot.imitate.warden</div></th><td>Parrot roars</td><td>Parrot whines</td></tr>
<tr><th align="left"><div style="width:290px">gamerule.doTraderSpawning</div></th><td>Spawn wandering traders</td><td>Spawn Wandering Traders</td></tr>
</table>
<br/>
</details>
</details>
...
- XXX.network.syncher.EntityDataSerializer$2
...
```
net.minecraft.Util +8M -5M
```
```
XXX.minecraft.core.Registry +57M -58M | +2P -2P
```
```
XXX.network.chat.Component +10M -2M | +1P -3P
```
```
XXX.network.chat.ComponentUtils +2M
```
```
XXX.network.chat.MutableComponent +11M | +5P -2P
```
```
XXX.minecraft.util.RandomSource +1M | +1P
```
```
XXX.entity.animal.Turtle$TurtlePathNavigation -2M
```
```
XXX.animal.allay.AllayAi +3P -1P
```
```
XXX.entity.decoration.Painting +14M -2M | +2P -1P
```
...
```
```
XXX.blaze3d.vertex.BufferBuilder$DrawState +4M
```
```
XXX.blaze3d.vertex.BufferUploader +8M -6M | +1P -4P
```
```
XXX.blaze3d.vertex.VertexBuffer +9M -18M | +2P -2P
```
```
XXX.blaze3d.vertex.VertexFormat +1M -3M | +1P -3P
```
```
XXX.screens.worldselection.WorldSelectionList$WorldListEntry +4M -6M | +1P -1P
```
```
XXX.client.model.AllayModel -3M | +3P
```
```
XXX.protocol.game.ClientGamePacketListener -1P
```
```
XXX.server.level.ChunkMap +44M -36M
```
```
XXX.minecraft.tags.BlockTags +1P
```
```
XXX.world.entity.Entity +3M -3M | +1P -1P
```
```
XXX.world.entity.Mob +1P
```
```
XXX.ai.behavior.StayCloseToTarget +1M -1M | +1P
```
```
XXX.animal.frog.Frog$FrogPathNavigation -2M
```
```
XXX.chunk.storage.EntityStorage +1M -1M
```
```
XXX.level.pathfinder.WalkNodeEvaluator +2M
```
```
XXX.level.storage.LevelResource +3P
```
```
XXX.level.storage.LevelStorageSource +11M -7M | -1P
```
```
XXX.level.storage.LevelSummary +2M -2M | +1P -1P
```
