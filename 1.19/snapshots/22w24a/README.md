...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/1.19">1.19</a>
## Registries
...
<details><summary>net.minecraft.network.chat.ChatType$Narration</summary>

```diff
+ ChatType$Narration decorated(ChatType$Narration$Priority)
+ Component lambda$decorate$1(ChatTypeDecoration)
- ChatType$Narration decorated(ChatType$Narration$Priority)
- Component lambda$decorate$1(ChatDecoration)
```

</details>

<details><summary>net.minecraft.network.chat.ChatType$TextDisplay</summary>
...
```diff
+ void assertEntitiesPresent(BlockPos,int,double)
```
...
```diff
+ BlockPos jukeboxPos
+ DynamicGameEventListener dynamicJukeboxListener
+ DynamicGameEventListener dynamicVibrationListener
+ EntityDataAccessor DATA_CAN_DUPLICATE
+ EntityDataAccessor DATA_DANCING
+ float DANCING_LOOP_DURATION
+ float dancingAnimationTicks
+ float SPINNING_ANIMATION_DURATION
+ float spinningAnimationTicks
+ float spinningAnimationTicks0
+ Ingredient DUPLICATION_ITEM
+ int DUPLICATION_COOLDOWN_TICKS
+ int LIFTING_ITEM_ANIMATION_DURATION
...
+ void duplicateAllay()
+ void removeInteractionItem(ItemStack)
