...
<tr><th>SHA1</th><td>24539d1a26c70cf6afe6f53d0a385610f123ce63</td></tr>
<tr><th>Url</th><td><a href="https://piston-meta.mojang.com/v1/packages/24539d1a26c70cf6afe6f53d0a385610f123ce63/23w05a.json">https://piston-meta.mojang.com/v1/packages/24539d1a26c70cf6afe6f53d0a385610f123ce63/23w05a.json</a></td></tr>
...
# Comparison with <a href="https://github.com/PixiGeko/Minecraft-generated-data/tree/23w04a">23w04a</a>
## File structure
...
```diff
+ trims/color_palettes/diamond_darker.png
+ trims/color_palettes/gold_darker.png
+ trims/color_palettes/iron_darker.png
+ trims/color_palettes/netherite_darker.png
```
...
- void lambda$getString$36(Consumer)
- void lambda$glBindBuffer$38(IntSupplier)
...
- void lambda$glUniform1$43(IntBuffer)
- void lambda$glUniform1$47(FloatBuffer)
- void lambda$glUniform1i$42(int,int)
- void lambda$glUniform2$44(IntBuffer)
- void lambda$glUniform2$48(FloatBuffer)
- void lambda$glUniform3$45(IntBuffer)
- void lambda$glUniform3$49(FloatBuffer)
- void lambda$glUniform4$46(IntBuffer)
- void lambda$glUniform4$50(FloatBuffer)
- void lambda$glUniformMatrix2$51(FloatBuffer)
- void lambda$glUniformMatrix3$52(FloatBuffer)
- void lambda$glUniformMatrix4$53(FloatBuffer)
- void lambda$lineWidth$33(float)
- void lambda$pixelStore$34(int,int)
- void lambda$readPixels$35(ByteBuffer)
...
- void lambda$setShaderTexture$62(ResourceLocation)
...
<details><summary>com.mojang.realmsclient.RealmsMainScreen$CloseButton</summary>
...
<details><summary>com.mojang.realmsclient.RealmsMainScreen$PendingInvitesButton</summary>
...
```diff
+ Component ACCESSIBILITY_TOOLTIP_GLINT_SPEED
+ Component ACCESSIBILITY_TOOLTIP_GLINT_STRENGTH
+ OptionInstance glintSpeed
+ OptionInstance glintStrength
+ Component lambda$new$100(Integer)
+ Component lambda$new$85(Double)
+ Component lambda$new$86(Double)
+ Component lambda$new$88(Integer)
+ Component lambda$new$92(NarratorStatus)
+ Component lambda$new$94(String)
+ Component lambda$new$98(Integer)
+ int lambda$new$89()
+ List lambda$new$95()
...
- Component lambda$new$85(Integer)
- Component lambda$new$89(NarratorStatus)
- Component lambda$new$91(String)
- Component lambda$new$95(Integer)
...
+ Integer lambda$nextFocusPathInDirection$4(GuiEventListener)
...
```diff
+ void lambda$init$2(GuiEventListener)
```
...
<details><summary>net.minecraft.client.model.CamelModel</summary>

```diff
+ float WALK_ANIMATION_SCALE_FACTOR
- float MIN_WALK_ANIMATION_SPEED
- float WALK_ANIMATION_SPEED_FACTOR
```
...
<details><summary>net.minecraft.client.renderer.RenderStateShard</summary>

```diff
+ double MAX_ENCHANTMENT_GLINT_SPEED_MILLIS
```
...
```diff
+ TextureMapping layered(ResourceLocation)
```
...
<details><summary>net.minecraft.world.item.Wearable</summary>

```diff
+ InteractionResultHolder swapWithEquipmentSlot(InteractionHand)
```
...
<details><summary>net.minecraft.world.item.armortrim.TrimMaterial</summary>

```diff
+ Map overrideArmorMaterials
- Optional incompatibleArmorMaterial
+ Map overrideArmorMaterials()
+ TrimMaterial create(Map)
+ void <init>(Component)
- Optional incompatibleArmorMaterial()
- TrimMaterial create(Component)
- void <init>(Component)
```
...
```diff
- boolean isArmorMaterialIncompatible(TrimMaterial)
```
...
<details><summary>net.minecraft.util.FastColor$ABGR32</summary>
...
```diff
- AnimationState walkAnimationState
...
```diff
- AnimationState swimAnimationState
- AnimationState walkAnimationState
+ void updateWalkAnimation(float)
...
+ Function outerTexture
- Supplier innerTexture
- Supplier outerTexture
+ ResourceLocation innerTexture(ArmorMaterial)
+ ResourceLocation lambda$new$2(ArmorMaterial)
+ ResourceLocation lambda$new$4(ArmorMaterial)
+ ResourceLocation outerTexture(ArmorMaterial)
+ String getColorPaletteSuffix(ArmorMaterial)
- ResourceLocation innerTexture()
- ResourceLocation lambda$new$2(Holder)
- ResourceLocation lambda$new$4(Holder)
...
```diff
+ void register(Map)
+ void register(Style,float)
- void register(Optional)
```
