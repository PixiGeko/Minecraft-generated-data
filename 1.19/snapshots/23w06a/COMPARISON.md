## Comparison with [23w05a](https://github.com/PixiGeko/Minecraft-generated-data/tree/23w05a)
...
<br/>
<table><tr><th></th><th align="left">23w05a</th><th>23w06a</th></tr><tr><td>DataPack version</td><td><pre>11</pre></td><td><pre>12</pre></td></tr><tr><td>World version</td><td><pre>3323</pre></td><td><pre>3326</pre></td></tr><tr><td>Protocol version</td><td><pre>1073741941</pre></td><td><pre>1073741942</pre></td></tr></table>
<h3>Libraries<a name="version-data-libraries"></a></h3>
<details>
<summary>
Versions
</summary>
<table><tr><th></th><th align="left">23w05a</th><th>23w06a</th></tr><tr><td>com.mojang:authlib</td><td><pre>3.16.29</pre></td><td><pre>3.17.30</pre></td></tr></table>
</details>
</details>
<hr/>
...
<br/>
<table>
<tr><th>Name</th><th>23w05a</th><th>23w06a</th></tr>
<tr><th align="left"><div style="width:290px">selectWorld.mapFeatures.info</div></th><td>Villages, Shipwrecks etc.</td><td>Villages, Shipwrecks, etc.</td></tr>
<tr><th align="left"><div style="width:290px">selectWorld.experimental.message</div></th><td>Be careful!

Some of the selected packs require features that are still under development. Your world might crash, break or not work with future updates.</td><td>Be careful!

This configuration requires features that are still under development. Your world might crash, break or not work with future updates.</td></tr>
<tr><th align="left"><div style="width:290px">options.notifications.display_time</div></th><td>Notification Display Time</td><td>Notification Time</td></tr>
<tr><th align="left"><div style="width:290px">argument.time.tick_count_too_low</div></th><td>Tick count must not be lower than %s, found %s</td><td>Tick count must not be less than %s, found %s</td></tr>
</table>
<br/>
</details>
</details>
...
```
```
XXX.world.damagesource.CombatTracker +1M | +1P
```
```
XXX.world.entity.Entity +5M -2M
```
```
XXX.world.entity.EntityEvent -6P
```
```
XXX.world.entity.LivingEntity +2M -1M
```
```
XXX.animal.horse.AbstractHorse +1M | +1P -1P
```
```
XXX.entity.decoration.Painting +3M -2M | +1P
```
```
XXX.entity.vehicle.ChestBoat +1M
```
```
XXX.entity.vehicle.ContainerEntity +1M -1M
```
```
XXX.entity.vehicle.MinecartChest +2M
```
```
XXX.world.inventory.InventoryMenu +1M
```
```
XXX.world.inventory.InventoryMenu$2 +2M -1M | +1P
```
```
XXX.world.item.ArmorItem +1M -1M
```
```
XXX.world.item.CreativeModeTab$DisplayItemsGenerator +1P -1P
```
```
XXX.world.item.Item -1M
```
```
XXX.item.alchemy.Potions +1M | +1P
```
```
XXX.level.block.CarvedPumpkinBlock +1M
```
```
XXX.level.block.CaveVines +1M -1M
```
```
XXX.level.block.LecternBlock +3M -3M
```
```
XXX.block.entity.JukeboxBlockEntity +1M
```
```
XXX.level.gameevent.GameEvent +2P
```
...
- XXX.screens.inventory.LegacySmithingScreen
...
```
XXX.blaze3d.systems.RenderSystem +2M | +2P
```
```
XXX.mojang.realmsclient.RealmsMainScreen$ServerEntry -1M
```
```
XXX.gui.screens.RealmsPendingInvitesScreen$Entry -1M
```
```
XXX.realmsclient.util.RealmsTextureManager +3M -5M | -2P
```
```
XXX.realmsclient.util.RealmsUtil +2M -1M | +1P -2P
```
```
XXX.advancements.critereon.DamageSourcePredicate$Builder +1M -8M | +1P -8P
```
```
XXX.gui.components.AccessibilityOnboardingTextWidget -1P
```
```
XXX.client.model.HumanoidModel +2P
```
```
XXX.renderer.debug.BrainDebugRenderer +12M -12M
```
```
XXX.renderer.debug.GameTestDebugRenderer +2M -1M
```
```
XXX.renderer.debug.GoalSelectorDebugRenderer +1M -1M
```
```
XXX.renderer.debug.PathfindingRenderer +2M -3M
```
```
XXX.renderer.debug.VillageSectionsDebugRenderer +2M -3M
```
```
...
```
```
XXX.world.item.SmithingTemplateItem +1P
```
